...
- **Grovel.** The target has the [Prone](Mechanics/rules/conditions.md#Prone) condition and then ends its turn.  
- **Halt.** On its turn, the target doesn't move and takes no action or [Bonus Action](Mechanics/rules/variant-rules/bonus-action-xphb.md).  
