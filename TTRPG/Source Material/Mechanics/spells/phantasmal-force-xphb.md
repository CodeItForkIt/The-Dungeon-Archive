...
The target can take a [Study](Mechanics/rules/actions.md#Study) action to examine the phantasm with an Intelligence ([Investigation](Mechanics/rules/skills.md#Investigation)) check against your spell save DC. If the check succeeds, the target realizes that the phantasm is an illusion, and the spell ends.
