...
You gain `2d4 + 4` [Temporary Hit Points](Mechanics/rules/variant-rules/temporary-hit-points-xphb.md).

**Using a Higher-Level Spell Slot.** You gain 5 additional [Temporary Hit Points](Mechanics/rules/variant-rules/temporary-hit-points-xphb.md) for each spell slot level above 1.
