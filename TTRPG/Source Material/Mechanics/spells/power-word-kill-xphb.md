...
You compel one creature you can see within range to die. If the target has 100 [Hit Points](Mechanics/rules/variant-rules/hit-points-xphb.md) or fewer, it dies. Otherwise, it takes `12d12` Psychic damage.
