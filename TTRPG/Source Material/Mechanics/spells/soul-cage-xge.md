...
A creature that can see the sensor (such as one using [see invisibility](Mechanics/spells/see-invisibility.md) or [truesight](Mechanics/Rules/senses.md#Truesight)) sees a translucent image of the tormented humanoid whose soul you caged.
