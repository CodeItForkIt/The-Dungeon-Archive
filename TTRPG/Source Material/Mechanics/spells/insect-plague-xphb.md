...
Swarming locusts fill a 20-foot-radius Sphere centered on a point you choose within range. The Sphere remains for the duration, and its area is [Lightly Obscured](Mechanics/rules/variant-rules/lightly-obscured-xphb.md) and [Difficult Terrain](Mechanics/rules/variant-rules/difficult-terrain-xphb.md).
