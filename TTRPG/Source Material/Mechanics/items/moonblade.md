...
---
# Moonblade
*Weapon ([longsword](Mechanics/items/longsword.md)), legendary (requires attunement by an elf or half-elf of neutral good alignment)*  
...
| 41-80 | The moonblade gains a randomly determined [minor property](Mechanics/tables/special-features-what-minor-property-does-it-have.md) (see "Special Features" DMG p143). |
| 81-82 | The moonblade gains the finesse property. |
| 83-84 | The moonblade gains the thrown property (range 20/60 feet). |
| 85-86 | The moonblade functions as a [defender](Mechanics/items/defender.md). |
...
| 95-96 | You can use a bonus action to cause the moonblade to flash brightly. Each creature that can see you and is within 30 feet of you must succeed on a DC 15 Constitution saving throw or become [blinded](Mechanics/Rules/conditions.md#Blinded) for 1 minute. A creature can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success. This property can't be used again until you take a short rest while attuned to the weapon. |
| 97-98 | The moonblade functions as a [ring of spell storing](Mechanics/items/ring-of-spell-storing.md). |
...
| 00 | The moonblade functions as a [vorpal sword](Mechanics/items/vorpal-sword.md). |
^moonblade-properties

## Sentience

A moon blade is a sentient neutral good weapon with an Intelligence of 12, a Wisdom of 10, and a Charisma of 12. It has hearing and [darkvision](Mechanics/Rules/senses.md#Darkvision) out to a range of 120 feet.
