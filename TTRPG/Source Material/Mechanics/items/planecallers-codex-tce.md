...
The pages of this book are bound in fiend hide, and its cover is embossed with a diagram of the Great Wheel of the multiverse. When found, the book contains the following spells: [banishment](Mechanics/spells/banishment.md), [find familiar](Mechanics/spells/find-familiar.md), [gate](Mechanics/spells/gate.md), [magic circle](Mechanics/spells/magic-circle.md), [planar binding](Mechanics/spells/planar-binding.md), and [summon elemental](Mechanics/spells/summon-elemental-tce.md). It functions as a spellbook for you.
