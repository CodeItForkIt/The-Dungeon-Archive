...
---
# Rod of Seven Parts
*Weapon ([quarterstaff](Mechanics/items/quarterstaff.md)), rod, artifact (requires attunement)*  
...
Eons ago, a war between the primordials and the gods scarred the planes of existence. A demon lord named [Miska the Wolf-Spider](Mechanics/bestiary/npc/miska-the-wolf-spider-veor.md) eventually pushed the primordials' enemies to the brink of annihilation.
...
| Piece | Spell |
|-------|-------|
| First | [Commune](Mechanics/spells/commune.md) |
| Second | [Arcane Gate](Mechanics/spells/arcane-gate.md) |
| Third | [Reverse Gravity](Mechanics/spells/reverse-gravity.md) (spell save DC 18) |
| Fourth | [Regenerate](Mechanics/spells/regenerate.md) |
| Fifth | [Find the Path](Mechanics/spells/find-the-path.md) |
| Sixth | [Mirage Arcane](Mechanics/spells/mirage-arcane.md) |
| Seventh | [Simulacrum](Mechanics/spells/simulacrum.md) |
^rod-pieces
...
The Rod of Seven Parts has 7 charges and regains `1d4 + 3` expended charges daily at dawn. While holding the rod, you can use an action to expend 1 charge and cast any of the spells in the Rod Pieces table. You can also use an action to cast [Detect Evil and Good](Mechanics/spells/detect-evil-and-good.md) from the rod without using any charges.
