...
While holding the staff, you can use an action to expend 2 or more of its charges to cast one of the following spells from it, using your spell save DC and spell attack bonus: [fortune's favor](Mechanics/spells/fortunes-favor-egw.md) (2 charges), [pulse wave](Mechanics/spells/pulse-wave-egw.md) (3 charges), or [gravity sinkhole](Mechanics/spells/gravity-sinkhole-egw.md) (4 charges).
