...
- You can use an action to cast one of the following spells (save DC 18), using one of the helm's gems of the specified type as a component: [daylight](Mechanics/spells/daylight.md) (opal), [fireball](Mechanics/spells/fireball.md) (fire opal), [prismatic spray](Mechanics/spells/prismatic-spray.md) (diamond), or [wall of fire](Mechanics/spells/wall-of-fire.md) (ruby). The gem is destroyed when the spell is cast and disappears from the helm.  
