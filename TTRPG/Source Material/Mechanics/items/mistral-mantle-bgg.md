...
As an action, you can invoke the mantle's rune to cast the [sleet storm](Mechanics/spells/sleet-storm.md) spell (save DC 14) with it. When you use the mantle to cast the spell, the area of the spell isn't difficult terrain for you, and you can see through the storm, ignoring the normal penalties of a heavily obscured area.
