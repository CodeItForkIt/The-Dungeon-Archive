...
While holding the deck, you can use an action to cast one of the following spells (save DC 18) from it: [comprehend languages](Mechanics/spells/comprehend-languages.md), [detect evil and good](Mechanics/spells/detect-evil-and-good.md), [detect magic](Mechanics/spells/detect-magic.md), [detect poison and disease](Mechanics/spells/detect-poison-and-disease.md), [locate object](Mechanics/spells/locate-object.md), or [scrying](Mechanics/spells/scrying.md). Once you use the deck to cast a spell, you can't cast that spell again from it until the next dawn.

## Enduring Vision

While holding the deck, you automatically succeed on Constitution saving throws made to maintain your [concentration](Mechanics/Rules/conditions.md#Concentration) on divination spells.
...
| dice: d100 | Card | Soul |
|------------|------|------|
| 1 | Artifact | [Flameskull](Mechanics/bestiary/undead/flameskull.md) |
| 2 | Beast | [Wraith](Mechanics/bestiary/undead/wraith.md) |
| 3 | Broken | [Banshee](Mechanics/bestiary/undead/banshee.md) |
| 4 | Darklord | [Vampire](Mechanics/bestiary/undead/vampire.md) |
| 5 | Donjon | [Mummy](Mechanics/bestiary/undead/mummy.md) |
| 6 | Executioner | [Death knight](Mechanics/bestiary/undead/death-knight.md) |
| 7 | Ghost | [Ghost](Mechanics/bestiary/undead/ghost.md) |
| 8 | Horseman | [Mummy lord](Mechanics/bestiary/undead/mummy-lord.md) |
| 9 | Innocent | [Ghost](Mechanics/bestiary/undead/ghost.md) |
| 10 | Marionette | [Mummy](Mechanics/bestiary/undead/mummy.md) |
| 11 | Mists | [Wraith](Mechanics/bestiary/undead/wraith.md) |
| 12 | Raven | [Vampire spawn](Mechanics/bestiary/undead/vampire-spawn.md) |
| 13 | Seer | [Vampire](Mechanics/bestiary/undead/vampire.md) |
| 14 | Tempter | [Vampire spawn](Mechanics/bestiary/undead/vampire-spawn.md) |
| 15-100 | — | — |
^souls-of-the-tarokka
...
Luba's Tarokka of Souls can be destroyed only if all fourteen souls within are released and destroyed. This reveals a fifteenth soul, a [lich](Mechanics/bestiary/undead/lich.md), that inhabits the Nether card, which appears only when the fourteen souls are defeated. If this ancient entity is destroyed, the Nether card vanishes and the deck becomes a normal [tarokka deck](Mechanics/decks/tarokka-deck-cos.md), with no special properties, but it includes a new card of the DM's design.
