...
---
# Mythcarver (Exalted)
*Weapon ([longsword](Mechanics/items/longsword.md)), legendary (requires attunement by a bard)*  

- **Damage**:
  - One-handed: 1d8 S
  - Two-handed: 1d10 S
- **Properties**: [Finesse](Mechanics/Rules/item-properties.md#Finesse), [Versatile](Mechanics/Rules/item-properties.md#Versatile), [Vestige of Divergence](Mechanics/Rules/item-properties.md#Vestige%20of%20Divergence)
- **Weight**: 3.0 lbs.
...
- As an action, you let the spirit of the sword overtake your body and guide your strikes. You make 4 melee attacks with the sword, then gain 1 level of [exhaustion](Mechanics/Rules/conditions.md#Exhaustion). Once this property is used, it can't be used again until you finish a long rest.  
