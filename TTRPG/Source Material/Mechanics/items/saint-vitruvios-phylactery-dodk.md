...
You can use an action to cast one of the following spells from the phylactery: [bless](Mechanics/spells/bless.md), [death ward](Mechanics/spells/death-ward.md), [greater restoration](Mechanics/spells/greater-restoration.md), [prayer of healing](Mechanics/spells/prayer-of-healing.md), or [revivify](Mechanics/spells/revivify.md). The spells use your spellcasting ability and spell save DC. Once the phylactery has been used to cast a spell, it can't be used to cast that spell again until the next dawn.
