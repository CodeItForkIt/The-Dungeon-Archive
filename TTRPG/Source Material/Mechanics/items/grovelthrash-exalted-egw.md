...
- As an action, you can use the warhammer to cast one of the following spells from it (save DC 17): [earthquake](Mechanics/spells/earthquake.md), [meld into stone](Mechanics/spells/meld-into-stone.md), or [stone shape](Mechanics/spells/stone-shape.md). Once a spell has been cast using the warhammer, that spell can't be cast from the warhammer again until the next dawn.  
