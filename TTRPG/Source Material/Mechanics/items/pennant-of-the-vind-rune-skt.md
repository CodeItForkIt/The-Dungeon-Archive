...
While you are attuned to this rune, you can cast [levitate](Mechanics/spells/levitate.md) as a bonus action. Once you use this property, you can't use it again until you finish a short or long rest.
...
- **Armor.** The armor is now an uncommon magic item that requires attunement. You gain a bonus to speed of 5 feet while you wear the armor, and if it normally imposes disadvantage on [Stealth](Mechanics/Rules/skills.md#Stealth) checks, it no longer does so.  
