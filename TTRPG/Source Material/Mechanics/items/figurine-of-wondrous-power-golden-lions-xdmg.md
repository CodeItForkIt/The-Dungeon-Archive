...
# Figurine of Wondrous Power, Golden Lions
*Wondrous item, rare*  
![](Mechanics/items/img/figurine-of-wondrous-power-golden-lions.webp#right)
...
These gold statuettes of lions are always created in pairs. You can use one figurine or both simultaneously. Each can become a [Lion](Mechanics/bestiary/beast/lion-xphb.md) for up to 1 hour. Once a lion has been used, it can't be used again until 7 days have passed.
