...
As an action, you can cast [sleet storm](Mechanics/spells/sleet-storm.md) (spell save DC 17). You regain this ability after you finish a short or long rest.
...
- **Cloak.** The cloak is now a rare magic item that requires attunement. While wearing it, you have resistance to fire damage, and you have advantage on Dexterity ([Stealth](Mechanics/Rules/skills.md#Stealth)) checks made while in snowy terrain.  
