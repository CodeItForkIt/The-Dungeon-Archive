...
You can also use the artifact as [alchemist's supplies](Mechanics/items/alchemists-supplies.md), [brewer's supplies](Mechanics/items/brewers-supplies.md), [cook's utensils](Mechanics/items/cooks-utensils.md), an [herbalism kit](Mechanics/items/herbalism-kit.md), and a [poisoner's kit](Mechanics/items/poisoners-kit.md). You have advantage on any check you make using the artifact as one of these tools.
