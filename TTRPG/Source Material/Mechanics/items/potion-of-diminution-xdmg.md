...
When you drink this potion, you gain the "reduce" effect of the [Enlarge/Reduce](Mechanics/spells/enlarge-reduce-xphb.md) spell for `1d4` hours (no [Concentration](Mechanics/rules/conditions.md#Concentration) required).
