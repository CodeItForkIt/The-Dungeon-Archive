...
You can't be [petrified](Mechanics/Rules/conditions.md#Petrified).

## Earthen Step

You can cast [meld into stone](Mechanics/spells/meld-into-stone.md) as a bonus action. Once you use this property, you can't use it again until you finish a short or long rest.
...
- **Boots.** The pair of boots is now an uncommon magic item that requires attunement. While you wear the boots, you have advantage on Strength saving throws, and you can use your reaction to avoid being knocked [prone](Mechanics/Rules/conditions.md#Prone).  
