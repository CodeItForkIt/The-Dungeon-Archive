...
---
# Sword of Zariel
*Weapon ([longsword](Mechanics/items/longsword.md)), artifact (requires attunement by a creature the sword deems worthy)*  
...
- **Truesight.** Your eyes become luminous pools of silver. You can see in normal and magical darkness, see [invisible](Mechanics/Rules/conditions.md#Invisible) creatures and objects, automatically detect visual illusions and succeed on saving throws against them, perceive the original form of a shapechanger or a creature that is transformed by magic, and see into the Ethereal Plane, all within a range of 60 feet.  
...
The sword has 2 [minor beneficial properties](Mechanics/tables/artifact-properties-minor-beneficial-properties.md).

## Searing Radiance

The sword deals an extra 9 (`2d8`) radiant damage to any creature it hits, or 16 (`3d10`) radiant damage if you're wielding the weapon with two hands. An evil creature that takes this radiant damage must succeed on a DC 17 Constitution saving throw or be [blinded](Mechanics/Rules/conditions.md#Blinded) until the end of its next turn.
...
While holding the sword, you gain advantage on all Wisdom ([Insight](Mechanics/Rules/skills.md#Insight)) checks.
