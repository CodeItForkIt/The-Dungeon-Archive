...
A special container can be crafted to contain a devastation orb and prevent it from detonating. The container must be inscribed with symbols of the orb's opposing element. For example, a case inscribed with earth symbols can be used to contain a [devastation orb of air](Mechanics/items/devastation-orb-of-air-pota.md) and keep it from detonating. While in the container, the orb thrums. If it is removed from the container after the time when it was supposed to detonate, it explodes `1d6` rounds later, unless it is returned to the container.
...
- [Devastation Orb of Air](Mechanics/items/devastation-orb-of-air-pota.md)
- [Devastation Orb of Earth](Mechanics/items/devastation-orb-of-earth-pota.md)
- [Devastation Orb of Fire](Mechanics/items/devastation-orb-of-fire-pota.md)
- [Devastation Orb of Water](Mechanics/items/devastation-orb-of-water-pota.md)
