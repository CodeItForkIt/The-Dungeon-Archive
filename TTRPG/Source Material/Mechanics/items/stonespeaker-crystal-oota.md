...
Created by the stone giant librarians of Gravenhollow, this nineteen-inch-long shard of quartz grants you advantage on Intelligence ([Investigation](Mechanics/Rules/skills.md#Investigation)) checks while it is on your person.

The crystal has 10 charges. While holding it, you can use an action to expend some of its charges to cast one of the following spells from it: [speak with animals](Mechanics/spells/speak-with-animals.md) (2 charges), [speak with dead](Mechanics/spells/speak-with-dead.md) (4 charges), or [speak with plants](Mechanics/spells/speak-with-plants.md) (3 charges).
