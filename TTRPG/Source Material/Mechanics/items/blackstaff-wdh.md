...
While holding this staff, you can use an action to expend 1 or more of its charges to cast one of the following spells from it, using your spell save DC and spell attack bonus: [cone of cold](Mechanics/spells/cone-of-cold.md) (5 charges), [fireball](Mechanics/spells/fireball.md) (5th-level version, 5 charges), [globe of invulnerability](Mechanics/spells/globe-of-invulnerability.md) (6 charges), [hold monster](Mechanics/spells/hold-monster.md) (5 charges), [levitate](Mechanics/spells/levitate.md) (2 charges), [lightning bolt](Mechanics/spells/lightning-bolt.md) (5th-level version, 5 charges), [magic missile](Mechanics/spells/magic-missile.md) (1 charge), [ray of enfeeblement](Mechanics/spells/ray-of-enfeeblement.md) (1 charge), or [wall of force](Mechanics/spells/wall-of-force.md) (5 charges).
...
When you cast an enchantment spell of 1st level or higher while holding the staff, you can make an Intelligence ([Arcana](Mechanics/Rules/skills.md#Arcana)) check with a DC of 10 + the level of the spell. If the check succeeds, you cast the spell without expending a spell slot.

## Sentience

The Blackstaff is a sentient staff of neutral alignment, with an Intelligence of 22, a Wisdom of 15, and a Charisma of 18. It has hearing and [darkvision](Mechanics/Rules/senses.md#Darkvision) out to a range of 120 feet, and it can communicate telepathically with any creature that is holding it.
