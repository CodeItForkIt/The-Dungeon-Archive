...
**Skills**. The docent has a +7 bonus to one of the following skills (roll a `d4`): (1) [Arcana](Mechanics/Rules/skills.md#Arcana), (2) [History](Mechanics/Rules/skills.md#History), (3) [Investigation](Mechanics/Rules/skills.md#Investigation), or (4) [Nature](Mechanics/Rules/skills.md#Nature).

**Spells**. The docent knows one of the following spells and can cast it at will, requiring no components (roll a `d6`): (1–2) [detect evil and good](Mechanics/spells/detect-evil-and-good.md) or (3–6) [detect magic](Mechanics/spells/detect-magic.md). The docent decides when to cast the spell.
