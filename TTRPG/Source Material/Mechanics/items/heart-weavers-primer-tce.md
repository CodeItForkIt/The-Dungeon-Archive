...
This pristine book smells faintly of a random scent you find pleasing. When found, the book contains the following spells: [antipathy/sympathy](Mechanics/spells/antipathy-sympathy.md), [charm person](Mechanics/spells/charm-person.md), [dominate person](Mechanics/spells/dominate-person.md), [enthrall](Mechanics/spells/enthrall.md), [hypnotic pattern](Mechanics/spells/hypnotic-pattern.md), [modify memory](Mechanics/spells/modify-memory.md), and [suggestion](Mechanics/spells/suggestion.md). It functions as a spellbook for you.
