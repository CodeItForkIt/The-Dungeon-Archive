...
- When you cast the [polymorph](Mechanics/spells/polymorph.md) spell using this armor, you can transform into a [guardian wolf](Mechanics/bestiary/monstrosity/guardian-wolf-egw.md).  
