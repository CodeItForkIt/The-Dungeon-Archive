...
- **Equipment.** A set of [traveler's clothes](Mechanics/items/travelers-clothes.md), a diary, an [ink pen](Mechanics/items/ink-pen.md), a [bottle of ink](Mechanics/items/ink-1-ounce-bottle.md), and a [pouch](Mechanics/items/pouch.md) containing 10 gp  
...
You gain the [Magic Initiate feat](Mechanics/feats/magic-initiate.md) from the "Player's Handbook" and must choose cleric for the feat.
