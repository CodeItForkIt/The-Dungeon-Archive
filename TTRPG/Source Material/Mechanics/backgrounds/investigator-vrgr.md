...
- **Skill Proficiencies.** Choose two from among [Insight](Mechanics/Rules/skills.md#Insight), [Investigation](Mechanics/Rules/skills.md#Investigation), or [Perception](Mechanics/Rules/skills.md#Perception)  
- **Tool Proficiencies.** [Disguise kit](Mechanics/items/disguise-kit.md), [Thieves' tools](Mechanics/items/thieves-tools.md)  
- **Equipment.** A [magnifying glass](Mechanics/items/magnifying-glass.md), evidence from a past case (choose one or roll for a trinket from the [Horror Trinkets](Mechanics/items/horror-trinket-vrgr.md) later in this chapter), a [set of common clothes](Mechanics/items/common-clothes.md), and 10 gp  
