...
- **Equipment.** A set of [fine clothes](Mechanics/items/fine-clothes.md), a [signet ring](Mechanics/items/signet-ring.md) or brooch, a scroll of pedigree, a skin of fine zzar or wine, and a purse containing 20 gp  
...
Use the tables for the [noble](Mechanics/backgrounds/noble.md) background in the Player's Handbook as the basis for your traits and motivations, modifying the entries when appropriate to suit your identity as a member of a Waterdhavian family.
