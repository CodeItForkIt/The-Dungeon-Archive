...
- **Equipment.** A set of [fine clothes](Mechanics/items/fine-clothes.md) and a [pouch](Mechanics/items/pouch.md) containing 5 gp  
...
Use the tables for the [guild artisan](Mechanics/backgrounds/guild-artisan.md) background in the Player's Handbook as the basis for your traits and motivations, modifying the entries when appropriate to suit your identity as a courtier.
