...
- **Skill Proficiencies.** [Insight](Mechanics/Rules/skills.md#Insight), [Persuasion](Mechanics/Rules/skills.md#Persuasion)  
- **Tool Proficiencies.** One type of artisan's tools, or [navigator's tools](Mechanics/items/navigators-tools.md), or an additional language  
- **Languages.** One of your choice  
- **Equipment.** A set of artisan's tools (one of your choice) or a [mule](Mechanics/items/mule.md) and [cart](Mechanics/items/cart.md), a letter of introduction from your guild, a set of [traveler's clothes](Mechanics/items/travelers-clothes.md), and a belt [pouch](Mechanics/items/pouch.md) containing 15 gp  
