...
- **Skill Proficiencies.** [Insight](Mechanics/Rules/skills.md#Insight), [Intimidation](Mechanics/Rules/skills.md#Intimidation)  
- **Languages.** Two of your choice  
- **Equipment.** An Azorius insignia, a scroll containing the text of a law important to you, a [bottle of blue ink](Mechanics/items/ink-1-ounce-bottle.md), a [pen](Mechanics/items/ink-pen.md), a set of [fine clothes](Mechanics/items/fine-clothes.md), and a belt [pouch](Mechanics/items/pouch.md) containing 10 gp (Azorius-minted 1-zino coins)  
...
| Spell Level | Spells |
|-------------|--------|
| Cantrip | [friends](Mechanics/spells/friends.md), [message](Mechanics/spells/message.md) |
| 1st | [command](Mechanics/spells/command.md), [ensnaring strike](Mechanics/spells/ensnaring-strike.md) |
| 2nd | [arcane lock](Mechanics/spells/arcane-lock.md), [calm emotions](Mechanics/spells/calm-emotions.md), [hold person](Mechanics/spells/hold-person.md) |
| 3rd | [clairvoyance](Mechanics/spells/clairvoyance.md), [counterspell](Mechanics/spells/counterspell.md) |
| 4th | [compulsion](Mechanics/spells/compulsion.md), [divination](Mechanics/spells/divination.md) |
| 5th | [dominate person](Mechanics/spells/dominate-person.md) |
^azorius-guild-spells

Your magic often takes the form of blue or golden runes floating and glowing in the air in circular patterns or of shimmering azure barriers of magical energy. If you cast [ensnaring strike](Mechanics/spells/ensnaring-strike.md), for example, the vines created by the spell might appear as rune-inscribed glowing bands that wrap around the target and hold it in place.
