...
- **Tool Proficiencies.** One type of gaming set, [thieves' tools](Mechanics/items/thieves-tools.md)  
- **Equipment.** A [crowbar](Mechanics/items/crowbar.md), a set of dark [common clothes](Mechanics/items/common-clothes.md) including a hood, and a belt [pouch](Mechanics/items/pouch.md) containing 15 gp  
