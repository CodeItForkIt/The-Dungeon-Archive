...
- **Skill Proficiencies.** [Arcana](Mechanics/Rules/skills.md#Arcana), [Nature](Mechanics/Rules/skills.md#Nature)  
- **Tool Proficiencies.** One type of artisan's tools  
- **Languages.** One of your choice  
- **Equipment.** A [bottle of black ink](Mechanics/items/ink-1-ounce-bottle.md), an [ink pen](Mechanics/items/ink-pen.md), an [abacus](Mechanics/items/abacus.md), a book of arcane theory, a school uniform, and a [pouch](Mechanics/items/pouch.md) containing 15 gp  
...
You gain the [Strixhaven Initiate](Mechanics/feats/strixhaven-initiate-scc.md) feat and must choose Quandrix within it.
...
| Spell Level | Spells |
|-------------|--------|
| 1st | [Entangle](Mechanics/spells/entangle.md), [Guiding Bolt](Mechanics/spells/guiding-bolt.md) |
| 2nd | [Enlarge/Reduce](Mechanics/spells/enlarge-reduce.md), [Vortex Warp](Mechanics/spells/vortex-warp-scc.md) |
| 3rd | [Aura of Vitality](Mechanics/spells/aura-of-vitality.md), [Haste](Mechanics/spells/haste.md) |
| 4th | [Control Water](Mechanics/spells/control-water.md), [Freedom of Movement](Mechanics/spells/freedom-of-movement.md) |
| 5th | [Circle of Power](Mechanics/spells/circle-of-power.md), [Passwall](Mechanics/spells/passwall.md) |
^quandrix-spells
...
Any spellcasting class or subclass can work well for a Quandrix character. Both the scholarly focus of wizards (especially those who study the Schools of [Abjuration](Mechanics/classes/wizard-school-of-abjuration.md), [Illusion](Mechanics/classes/wizard-school-of-illusion.md), or [Transmutation](Mechanics/classes/wizard-school-of-transmutation.md)) and the metamagic manipulations of sorcerers are welcome in Quandrix, and many druids explore the patterns of nature in Quandrix as well. A few clerics, particularly those with the [Knowledge](Mechanics/classes/cleric-knowledge-domain.md) or [Nature](Mechanics/classes/cleric-nature-domain.md) domains, study in Quandrix as well.
...
When you make your character, you may roll once on the [Quandrix Trinkets](Mechanics/items/quandrix-trinket-scc.md) table, instead of on the [Trinkets table](Mechanics/items/trinket.md) in the "Player's Handbook", for your starting trinket.