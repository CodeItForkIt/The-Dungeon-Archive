...
- **Skill Proficiencies.** [Athletics](Mechanics/Rules/skills.md#Athletics), [Persuasion](Mechanics/Rules/skills.md#Persuasion)  
- **Tool Proficiencies.** One type of gaming set, vehicles (land)  
- **Equipment.** A uniform of your company ([traveler's clothes](Mechanics/items/travelers-clothes.md) in quality), an insignia of your rank, a gaming set of your choice, and a [pouch](Mechanics/items/pouch.md) containing the remainder of your last wages (10 gp).  
...
Use the tables for the [soldier](Mechanics/backgrounds/soldier.md) background in the Player's Handbook as the basis for your traits and motivations, modifying the entries when appropriate to suit your identity as a mercenary.
