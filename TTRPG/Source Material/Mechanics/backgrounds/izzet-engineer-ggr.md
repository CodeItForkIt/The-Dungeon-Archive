...
- **Skill Proficiencies.** [Arcana](Mechanics/Rules/skills.md#Arcana), [Investigation](Mechanics/Rules/skills.md#Investigation)  
- **Tool Proficiencies.** One type of artisan's tools  
- **Languages.** Choose one of Draconic, Goblin, or Vedalken  
- **Equipment.** An Izzet insignia, one set of artisan's tools, the charred and twisted remains of a failed experiment, a [hammer](Mechanics/items/hammer.md), a [block and tackle](Mechanics/items/block-and-tackle.md), a set of [common clothes](Mechanics/items/common-clothes.md), and a belt [pouch](Mechanics/items/pouch.md) containing 5 gp (Azorius 1-zino coins)  
...
| Spell Level | Spells |
|-------------|--------|
| Cantrip | [produce flame](Mechanics/spells/produce-flame.md), [shocking grasp](Mechanics/spells/shocking-grasp.md) |
| 1st | [chaos bolt](Mechanics/spells/chaos-bolt-xge.md), [create or destroy water](Mechanics/spells/create-or-destroy-water.md), [unseen servant](Mechanics/spells/unseen-servant.md) |
| 2nd | [heat metal](Mechanics/spells/heat-metal.md), [rope trick](Mechanics/spells/rope-trick.md) |
| 3rd | [call lightning](Mechanics/spells/call-lightning.md), [elemental weapon](Mechanics/spells/elemental-weapon.md), [glyph of warding](Mechanics/spells/glyph-of-warding.md) |
| 4th | [conjure minor elementals](Mechanics/spells/conjure-minor-elementals.md), [divination](Mechanics/spells/divination.md), [Otiluke's resilient sphere](Mechanics/spells/otilukes-resilient-sphere.md) |
| 5th | [animate objects](Mechanics/spells/animate-objects.md), [conjure elemental](Mechanics/spells/conjure-elemental.md) |
^izzet-guild-spells

Your spells tend to be loud, flashy, or explosive, even when the effect is unremarkable. For example, when you open the portal of a [rope trick](Mechanics/spells/rope-trick.md) spell, the portal might be outlined by harmless, showy sparkles.

If you use an arcane focus, it probably takes the form of an intricate device that could include metal gauntlets, glass canisters, copper tubing, and leather straps attaching it to your body. The [mizzium apparatus](Mechanics/items/mizzium-apparatus-ggr.md) described in "chapter 5" is a magical version of this gear.

The [chaos bolt](Mechanics/spells/chaos-bolt-xge.md) spell is a favorite of Izzet spellcasters because of its unpredictable nature.
