...
- **Equipment.** A [holy symbol](Mechanics/items/holy-symbol.md) (a gift to you when you entered the priesthood), a prayer [book](Mechanics/items/book.md) or prayer wheel, 5 sticks of incense, vestments, a set of [common clothes](Mechanics/items/common-clothes.md), and a belt [pouch](Mechanics/items/pouch.md) containing 15 gp  
