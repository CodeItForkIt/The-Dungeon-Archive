...
- **Tool Proficiencies.** [Carpenter's tools](Mechanics/items/carpenters-tools.md), Vehicles (water)  
- **Equipment.** A set of well-loved [carpenter's tools](Mechanics/items/carpenters-tools.md), a blank [book](Mechanics/items/book.md), [1 ounce of ink](Mechanics/items/ink-1-ounce-bottle.md), an [ink pen](Mechanics/items/ink-pen.md), a set of [traveler's clothes](Mechanics/items/travelers-clothes.md), and a leather [pouch](Mechanics/items/pouch.md) with 10 gp  
