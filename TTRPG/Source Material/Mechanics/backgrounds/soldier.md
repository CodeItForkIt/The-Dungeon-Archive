...
- **Equipment.** An insignia of rank, a trophy taken from a fallen enemy (a [dagger](Mechanics/items/dagger.md), broken blade, or piece of a banner), a bone [dice set](Mechanics/items/dice-set.md) or [playing card set](Mechanics/items/playing-card-set.md), a set of [common clothes](Mechanics/items/common-clothes.md), and a belt [pouch](Mechanics/items/pouch.md) containing 10 gp  
