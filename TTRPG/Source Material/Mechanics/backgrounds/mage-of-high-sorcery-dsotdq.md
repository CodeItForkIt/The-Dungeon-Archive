...
- **Equipment.** A [bottle of colored ink](Mechanics/items/ink-1-ounce-bottle.md), an [ink pen](Mechanics/items/ink-pen.md), a set of [common clothes](Mechanics/items/common-clothes.md), and a [pouch](Mechanics/items/pouch.md) containing 10 gp  
...
You gain the [Initiate of High Sorcery](Mechanics/feats/initiate-of-high-sorcery-dsotdq.md) feat.
...
When you make your character, roll once on the Mage of High Sorcery Trinkets table instead of on the [Trinkets table](Mechanics/items/trinket.md) in the Player's Handbook for your starting trinket.
