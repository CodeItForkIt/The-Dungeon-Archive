...
- **Skill Proficiencies.** [Arcana](Mechanics/Rules/skills.md#Arcana), [Medicine](Mechanics/Rules/skills.md#Medicine)  
- **Languages.** Two of your choice  
- **Equipment.** A Simic insignia, a set of [commoner's clothes](Mechanics/items/common-clothes.md), a [book](Mechanics/items/book.md) of research notes, an [ink pen](Mechanics/items/ink-pen.md), a [bottle of squid ink](Mechanics/items/ink-1-ounce-bottle.md), a [flask of oil](Mechanics/items/oil-flask.md) (made from blubber), a [vial of acid](Mechanics/items/acid-vial.md) (derived from digestive juices), a vial of fish scales, a vial of seaweed, a vial of jellyfish stingers, a glass bottle of unidentified slime, and a belt [pouch](Mechanics/items/pouch.md) containing 10 gp (Azorius 1-zino coins)  
...
| Spell Level | Spells |
|-------------|--------|
| Cantrip | [acid splash](Mechanics/spells/acid-splash.md), [druidcraft](Mechanics/spells/druidcraft.md) |
| 1st | [detect poison and disease](Mechanics/spells/detect-poison-and-disease.md), [expeditious retreat](Mechanics/spells/expeditious-retreat.md), [jump](Mechanics/spells/jump.md) |
| 2nd | [alter self](Mechanics/spells/alter-self.md), [enhance ability](Mechanics/spells/enhance-ability.md), [enlarge/reduce](Mechanics/spells/enlarge-reduce.md) |
| 3rd | [gaseous form](Mechanics/spells/gaseous-form.md), [water breathing](Mechanics/spells/water-breathing.md), [wind wall](Mechanics/spells/wind-wall.md) |
| 4th | [freedom of movement](Mechanics/spells/freedom-of-movement.md), [polymorph](Mechanics/spells/polymorph.md) |
