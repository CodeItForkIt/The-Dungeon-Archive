...
- **Equipment.** A set of [fine clothes](Mechanics/items/fine-clothes.md), house [signet ring](Mechanics/items/signet-ring.md), identification papers, and a purse containing 20 gp.  

**House Tool Proficiencies**

| Your House | Proficiencies |
|------------|---------------|
| Cannith | [Alchemist's supplies](Mechanics/items/alchemists-supplies.md) and [tinker's tools](Mechanics/items/tinkers-tools.md) |
| Deneith | One gaming set and vehicles (land) |
| Ghallanda | [Brewer's supplies](Mechanics/items/brewers-supplies.md) and [cook's utensils](Mechanics/items/cooks-utensils.md) |
| Jorasco | [Alchemist's supplies](Mechanics/items/alchemists-supplies.md) and [herbalism kit](Mechanics/items/herbalism-kit.md) |
| Kundarak | [Thieves' tools](Mechanics/items/thieves-tools.md) and [tinker's tools](Mechanics/items/tinkers-tools.md) |
| Lyrandar | [Navigator's tools](Mechanics/items/navigators-tools.md) and vehicles (sea and air) |
| Medani | [Disguise kit](Mechanics/items/disguise-kit.md) and [thieves' tools](Mechanics/items/thieves-tools.md) |
| Orien | One gaming set and vehicles (land) |
| Phiarlan | [Disguise kit](Mechanics/items/disguise-kit.md) and one musical instrument |
| Sivis | [Calligrapher's supplies](Mechanics/items/calligraphers-supplies.md) and [forgery kit](Mechanics/items/forgery-kit.md) |
| Tharashk | One gaming set and [thieves' tools](Mechanics/items/thieves-tools.md) |
| Thuranni | One musical instrument and [poisoner's kit](Mechanics/items/poisoners-kit.md) |
| Vadalis | [herbalism kit](Mechanics/items/herbalism-kit.md) and vehicles (land) |
^house-tool-proficiencies
