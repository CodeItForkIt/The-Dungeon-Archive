...
- **Skill Proficiencies.** Choose two from among [Deception](Mechanics/Rules/skills.md#Deception), [Insight](Mechanics/Rules/skills.md#Insight), [Persuasion](Mechanics/Rules/skills.md#Persuasion), and [Stealth](Mechanics/Rules/skills.md#Stealth)  
- **Tool Proficiencies.** Choose two from among one type of gaming set, one musical instrument, and [thieves' tools](Mechanics/items/thieves-tools.md)  
- **Equipment.** A set of clothes appropriate to your duties and a [pouch](Mechanics/items/pouch.md) containing 20 gp  
...
Use the tables for the [criminal](Mechanics/backgrounds/criminal.md) background in the Player's Handbook as the basis for your bounty hunter's traits and motivations, modifying the entries when appropriate to suit your identity as a bounty hunter.
