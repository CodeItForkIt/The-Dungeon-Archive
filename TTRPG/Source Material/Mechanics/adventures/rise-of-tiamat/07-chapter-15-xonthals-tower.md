...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/RoT/022-tod-15-01.webp#center)

Though [Severin](Mechanics/bestiary/npc/severin-rot.md)'s hold on the Cult of the Dragon is strong, there remain traditionalist elements within the cult that long for the old ways of reverence for the dracoliches. Many such elements center around scholars and academics, for whom the cult's new focus has made their knowledge and research irrelevant. Others think that [Severin](Mechanics/bestiary/npc/severin-rot.md) is being taken in by devils and that [Tiamat](Mechanics/bestiary/npc/tiamat-rot.md) will play him for a fool—a notion fairly close to the truth.

Two of the leading dracolich traditionalists—a dragonsoul named Jorgen Pawl and his trusted lieutenant [Iskander](Mechanics/bestiary/npc/iskander-rot.md)—have been most vocal in their objections. As the time of the summoning ritual approaches, [Severin](Mechanics/bestiary/npc/severin-rot.md) understands that he can't risk losing loyal troops to infighting and insurrection. He has thus agreed to give Jorgen Pawl and his followers a dragon mask to examine, allowing them to determine whether [Severin](Mechanics/bestiary/npc/severin-rot.md)'s understanding of the masks' power is correct. If [Severin](Mechanics/bestiary/npc/severin-rot.md) is wrong, he will know before risking everything on a do-or-die gamble. If he is right, the traditionalists will give their support to [Severin](Mechanics/bestiary/npc/severin-rot.md)'s plans.

What Jorgen does not know is that [Severin](Mechanics/bestiary/npc/severin-rot.md) asked his [Red Wizard](Mechanics/bestiary/humanoid/red-wizard-rot.md) allies to create a false mask, supplying the scholar with a duplicate of the Blue Dragon Mask that appears both powerful and inscrutable, though it holds little in the way of real magic. [Severin](Mechanics/bestiary/npc/severin-rot.md) knows the scholars will discover the deception eventually, but he hopes that the false mask will keep the traditionalists occupied while he completes his plans.

The Cult of the Dragon recently took control of Xonthal's Tower—an ancient and mysterious wizard's tower on the southern slope of Mount Hlim. Although not all the cult members at Xonthal's Tower are dracolich traditionalists, Jorgen Pawl and [Iskander](Mechanics/bestiary/npc/iskander-rot.md) are in command there, and they have drawn many likeminded individuals under their sway.
...
The adventurers are likely to be suspicious of [Iskander](Mechanics/bestiary/npc/iskander-rot.md), intuiting that his offer is motivated by concern for his own survival than by concern for the world. If divination spells are used to assess the situation, give the characters a strong sense that [Iskander](Mechanics/bestiary/npc/iskander-rot.md) is on the level, and that the Blue Dragon Mask is in his possession.

If the characters ask the members of the Council of Waterdeep their opinions, the NPCs are unanimous: the risk is enormous, but the potential payoff is even greater. Losing one of the five dragon masks will be a huge setback for [Severin](Mechanics/bestiary/npc/severin-rot.md)'s plans.
...
> [!gallery]
> ![Map 15.1: Xonthal's Tower](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/RoT/023-map-15-1-xonthals-tower.webp#gallery)
> ![Player Version](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/RoT/024-map-15-1-xonthals-tower-player.webp#gallery)
...
The bottom of the pool holds the treasure that's been dropped in by various visitors: six [potions of healing](Mechanics/items/potion-of-healing.md), one [potion of growth](Mechanics/items/potion-of-growth.md), one [potion of fire breath](Mechanics/items/potion-of-fire-breath.md), a [wand of fear](Mechanics/items/wand-of-fear.md), three [+1 daggers](Mechanics/items/1-weapon.md), a [driftglobe](Mechanics/items/driftglobe.md), and an [elemental gem (clear sapphire/air elemental)](Mechanics/items/elemental-gem-blue-sapphire.md).
...
The characters can beat this challenge in several ways. The most straightforward solution is to reduce the boulder with an [enlarge/reduce](Mechanics/spells/enlarge-reduce.md) spell, then use the same spell to enlarge a strong character to throw it. Other solutions might involve casting [levitate](Mechanics/spells/levitate.md) on the rock and giving it a push, digging a trench for the rock to roll down the length of the field, or propelling it with magic in some other way. The cyclopes will accept any solution the characters attempt, as long as it propels the stone farther than the cyclops did.

Each [cyclops](Mechanics/bestiary/giant/cyclops.md) defends itself if attacked, and killing them changes nothing. The characters still need to propel a stone farther than the cyclops did to get back to the sundial.
...
The master of the pagoda does not speak, and he waits as long as long as it takes for the adventurers to join him. When they enter the pagoda, he gives a brief smile and proffers silk cushions. He then waves his hand and an iron tea kettle rises up from beneath the embers. The kettle resembles a scowling face with thick features, and a character who studies it may recognize it as a dao with a successful DC 12 Wisdom ([Perception](Mechanics/Rules/skills.md#Perception)) or Intelligence ([Arcana](Mechanics/Rules/skills.md#Arcana)) check. The man pours clear water from a clay jug into the kettle and adds tea leaves. He bows to the kettle and shows great reverence to the vessel, then lowers his head in meditation. Soon steam rises from the kettle.

The tea brewer is a [dao](Mechanics/bestiary/elemental/dao.md) magically disguised as a human, and the pot brews not tea but a deadly gaseous poison. The tea kettle is also the dao's [magic jar](Mechanics/spells/magic-jar.md) (described below).

With a successful DC 15 Intelligence ([Arcana](Mechanics/Rules/skills.md#Arcana)) check, a character realizes that an innate ability lifted the teapot from the coals ([move earth](Mechanics/spells/move-earth.md) acting on a small clay column). Characters who watch the leaves going into the kettle can attempt a DC 13 Intelligence ([Nature](Mechanics/Rules/skills.md#Nature)) or Wisdom ([Medicine](Mechanics/Rules/skills.md#Medicine)) check. Success indicates the character recognizes drakeswort, a potentially lethal herb.

If characters do nothing, the steeping drakeswort fills the pagoda with poisonous vapor, and the dao encloses the pagoda in a [wall of stone](Mechanics/spells/wall-of-stone.md) (including the roof), trapping the poison and the characters inside. He uses Earth Glide to sink into the boulder. With his body safe beneath the ground, his soul jumps into the tea kettle, and he monitors the characters' escape attempts and enjoys watching their suffering. For the next 3 minutes (30 rounds), creatures inside the pagoda (except the dao in his [magic jar](Mechanics/spells/magic-jar.md)) must make a DC 13 Constitution saving throw against poison at the start of each of their turns. On a failed save, a creature takes 14 (`4d6`) poison damage, or half damage on a successful save. Three successful saving throws in a row confer immunity to the poison.
...
- Damaging the tea kettle forces the dao to return to the pagoda. When the dao's soul inhabits the kettle, the face is slightly animated. Anyone touching the kettle notices the eyes looking around the pagoda. The kettle has AC 5 and 20 hit points. If it takes more than 10 points of damage, the dao returns to his body, emerges from the stone, drops the [wall of stone](Mechanics/spells/wall-of-stone.md) (because he can't breathe the poison either), and attacks.  

If characters attack the dao before his trap is sprung, he fights back, making full use of [invisibility](Mechanics/spells/invisibility.md), [move earth](Mechanics/spells/move-earth.md), and his other abilities. He shifts the odds in his favor by killing the weakest characters first. The dao fights to 45 hit points or fewer, then retreats into the earth.
...
When the characters begin exploring the area, two suits of [animated armor](Mechanics/bestiary/construct/animated-armor.md) swing into motion and attack. Each time a suit of armor is destroyed, two more activate.When there are no more suits of armor to activate, the suits reassemble themselves from the components littering the ground. Reassembling takes a suit's entire action—it can do nothing else on that turn. After reforming, the animated armor resumes attacking. This continues as long as any character remains in this area
...
After making their way through the dangers of the hedge maze, the adventurers can enter Xonthal's Tower. Once inside, they learn that [Iskander](Mechanics/bestiary/npc/iskander-rot.md)'s fellow cultists have discovered his treason and are trying to kill him. The characters must figure out the tower's magical teleportation system, then defeat both the cultists and some of Xonthal's original defenses to rescue [Iskander](Mechanics/bestiary/npc/iskander-rot.md) and claim the dragon mask he promised them. Before the characters can leave, however, they must deal with the blue dragon summoned to protect the mask.
...
The structure of the tower muffles sound between levels. Only the loudest shouting or noise can be heard on an adjacent level, and nothing short of an explosion or a [thunderwave](Mechanics/spells/thunderwave.md) spell can be heard more than one level away.
...
The dead cultist was slain by [Iskander](Mechanics/bestiary/npc/iskander-rot.md). They argued, the dead cultist turned to step onto the teleport circle, and [Iskander](Mechanics/bestiary/npc/iskander-rot.md) stabbed her before stepping through the teleporter himself.

A character who inspects the body and makes a successful DC 10 Wisdom ([Medicine](Mechanics/Rules/skills.md#Medicine)) check can tell that the cultist was killed by a [dragontooth dagger](Mechanics/items/dragontooth-dagger-rot.md) (see appendix C).

The balconies are set 8 feet above the floor and can be easily reached by climbing. The floor of each balcony bears a teleport circle similar to those found throughout the tower. The controls are located beneath the railing of the balcony, and can be found with a DC 8 Intelligence ([Investigation](Mechanics/Rules/skills.md#Investigation)) check. These controls can take characters only back to the main circle in this area.
...
When the characters arrive, one [cult fanatic](Mechanics/bestiary/humanoid/cult-fanatic.md) and four [cultists](Mechanics/bestiary/humanoid/cultist.md) are searching the floor for [Iskander](Mechanics/bestiary/npc/iskander-rot.md). The cultists quickly realize they can't defeat the adventurers, and they make a dash for the teleport room. They try to escape to the lounge (area 11), where they expect to find reinforcements.
...
The bodies of three dead cultists lie on the floor here. A successful DC 13 Wisdom ([Medicine](Mechanics/Rules/skills.md#Medicine)) check determines that two of them were killed by bolts of magical force ([Iskander](Mechanics/bestiary/npc/iskander-rot.md)'s handiwork). No check is needed to see that the third was stabbed to death. A trail of blood runs into this room from area 15.

[Iskander](Mechanics/bestiary/npc/iskander-rot.md) was waiting in this chamber for pursuers to appear. He killed two immediately but the third chased him into area 15, where the elementals attacked both of them.
...
![Iskander](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/RoT/025-tod-15-02.webp#center)

The creatures are 2 [earth elementals](Mechanics/bestiary/elemental/earth-elemental.md) and a [fire elemental](Mechanics/bestiary/elemental/fire-elemental.md) Xonthal called forth to guard his workshops. In the absence of new orders, the elementals eternally follow Xonthal's last command to slay intruders. When any character enters the room, the elementals attack. They fight until destroyed, or until the party flees back to area 14 or moves further into the dungeon. The elementals do not pursue outside this area unless attacked from a distance.

A large, round table with four chairs sits in one corner of the room, with shelves and workbenches arranged along the walls. Books and papers are scattered on the table, along with a locked wooden chest about the size of a shoebox. Opening the lock requires [thieves' tools](Mechanics/items/thieves-tools.md) and a successful DC 15 Dexterity check. A failed check sets off a magic [glyph of warding](Mechanics/spells/glyph-of-warding.md) trap that triggers a [slow](Mechanics/spells/slow.md) spell affecting all creatures in the area except elementals. Creatures affected by the spell can attempt the saving throw again at the end of each of their turns. Otherwise, the effect ends after 1 minute.
...
The chest contains three scrolls: two [scroll of protection against fire elementals](Mechanics/items/scroll-of-protection-dmg.md) and one [scroll of protection against earth elementals](Mechanics/items/scroll-of-protection-dmg.md). Characters who claim these scrolls can use them to move safely past the elementals, if they bunch tightly together to keep everyone inside the effect's five-foot radius from the caster. With only one [scroll of protection against earth elementals](Mechanics/items/scroll-of-protection-dmg.md), characters will probably be forced to deal with the earth elementals at least once.
...
The whirlwind is not a creature, but one of Xonthal's experiments. The gemstones swirling inside it are [elemental gems](Mechanics/items/elemental-gem-dmg.md). If a hand or any other material object is pushed into the whirlwind, it disrupts the perfect balance of the airflow, causing an [elemental gem](Mechanics/items/elemental-gem-dmg.md) to spin out and smash on the floor, summoning an angry **elemental**. You can choose the elemental's type or determine it randomly. The whirlwind contains eight gems, two of each elemental type. Every time the whirlwind is disturbed, another gem is ejected and breaks.

The equipment here is now useless, and any reagents or components have long since dried up, decayed, or lost their potency. A character who spends a day poring over the notes can attempt a DC 20 Intelligence ([Arcana](Mechanics/Rules/skills.md#Arcana)) check to understand that Xonthal was involved in a complex attempt to create elementals that fused the best traits of earth, air, fire, and water.
...
The two secret doors in this area are concealed behind swinging bookshelves, and can each be found with a successful DC 15 Intelligence ([Investigation](Mechanics/Rules/skills.md#Investigation)) check. The door to the spellbook study (area 20) is opened by shifting a book at floor level. The door to the observation room (area 19) is located 10 feet above the floor. It is opened by positioning the rolling ladder in front of the door and pushing on the shelf 15 feet above the floor.
...
Treat these paper whirlwinds as [swarms of ravens](Mechanics/bestiary/beast/swarm-of-ravens.md), but they are constructs instead of beasts, and they have vulnerability to fire. When the paper swarms form, they remain on guard in the study for 30 minutes, then collapse to piles of paper once more. They won't pursue characters into the hallway, but will chase them into the two adjoining rooms.
...
A character trained in one of the following skills can make a check to search the library for a work on that subject: [Animal Handling](Mechanics/Rules/skills.md#Animal%20Handling), [Athletics](Mechanics/Rules/skills.md#Athletics), [Arcana](Mechanics/Rules/skills.md#Arcana), [History](Mechanics/Rules/skills.md#History), [Medicine](Mechanics/Rules/skills.md#Medicine), [Nature](Mechanics/Rules/skills.md#Nature), [Performance](Mechanics/Rules/skills.md#Performance), [Persuasion](Mechanics/Rules/skills.md#Persuasion), [Religion](Mechanics/Rules/skills.md#Religion), or [Sleight of Hand](Mechanics/Rules/skills.md#Sleight%20of%20Hand). Multiply the total of the check by 10 to get the gp value of the single most valuable book a character can find on that subject. Each skill check takes 10 minutes, but many characters can be searching at the same time. Characters who search for more books take a cumulative–10 penalty to subsequent checks.
...
Xonthal used this room for writing his spellbooks, but those books went with him when he vanished. The ink pots are dried up, but any character trained in [Arcana](Mechanics/Rules/skills.md#Arcana) will recognize the specific type of ink used for magical writing. The quill pens are exquisitely fashioned and still usable.
...
The creature is an [efreeti](Mechanics/bestiary/elemental/efreeti.md) named Taraz the Fair. The name has nothing to do with his sense of justice or fair play, however, but refers to the light hues of his fiery hair. Xonthal trapped Taraz and was trying to bend or trick the efreeti into service when he disappeared. The trapped creature has had over a century of solitude to rue its fate.

Taraz is held in this area by a thin line of magical salt. Imbued with potent wards by Xonthal, the salt rings the bases of all four walls and extends across the doorway in the joints between paving stones. A character with a passive [Perception](Mechanics/Rules/skills.md#Perception) of 18 or higher notices the salt automatically. Otherwise, a character who looks carefully spots the salt with a successful DC 12 Intelligence ([Arcana](Mechanics/Rules/skills.md#Arcana) or [Investigation](Mechanics/Rules/skills.md#Investigation)) check.

Taraz greets the adventurers with a fiery smile. He assumes correctly that the characters' arrival so soon after [Iskander](Mechanics/bestiary/npc/iskander-rot.md)'s appearance is no coincidence, and he uses the missing mage as leverage for negotiating. Taraz's only concern is escape, and he will do anything to win his freedom.
...
- Taraz saw a human ([Iskander](Mechanics/bestiary/npc/iskander-rot.md)) come down the corridor ahead of the adventurers. He was carrying a mask that resembled a dragon's face, and he looked badly wounded. (All true.)  
...
However much Jorgen Pawl opposed [Severin](Mechanics/bestiary/npc/severin-rot.md), he remained loyal to the Cult of the Dragon. As soon as he understood that the traitorous [Iskander](Mechanics/bestiary/npc/iskander-rot.md) was somehow in league with the adventurers, he used [sending](Mechanics/spells/sending.md) to call an [adult blue dragon](Mechanics/bestiary/dragon/adult-blue-dragon.md) from its nearby lair, telling it of [Iskander](Mechanics/bestiary/npc/iskander-rot.md)'s theft of the dragon mask.

When the characters teleport to the sundial, they are greeted by the terrible sound of villagers screaming, a dragon roaring, and lightning bolts tearing houses to splinters. When they reach the edge of the garden, they see the dragon swooping over the village and terrified villagers fleeing in every direction. A character with passive [Perception](Mechanics/Rules/skills.md#Perception) of 14 or higher recognizes this dragon as Lennithon, the adult blue dragon the party faced in the *Hoard of the Dragon Queen*.
...
This dragon is loyal to the cult, but it has no intention of getting killed before [Tiamat](Mechanics/bestiary/npc/tiamat-rot.md)'s glorious return. It fights until it is reduced to 75 hit points, then flies away to recuperate.

## Conclusion

If any of the cultists in the tower are left alive for questioning, or if the characters use [speak with dead](Mechanics/spells/speak-with-dead.md) to converse with either Jorgen Pawl or [Iskander](Mechanics/bestiary/npc/iskander-rot.md), they learn nothing new of [Severin](Mechanics/bestiary/npc/severin-rot.md)'s plots. The cultists here are motivated primarily by self-interest.

The fact that the Blue Dragon Mask is a forgery is quickly discovered by experts at Waterdeep. It becomes a cause for much concern among the members of the council, some of who see it as a sign that the cult might have placed spies within the council. [Speak with dead](Mechanics/spells/speak-with-dead.md) used to contact either [Iskander](Mechanics/bestiary/npc/iskander-rot.md) or Jorgen Pawl can shed some light on why a false mask might have been supplied to the cultists at Xonthal's Tower, but the false mask might otherwise remain a troubling mystery.
