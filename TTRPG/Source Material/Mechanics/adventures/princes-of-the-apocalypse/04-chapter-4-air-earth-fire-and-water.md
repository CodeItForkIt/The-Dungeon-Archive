...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/PotA/039-poa04-01.webp#center)
...
- Air cult: [Howling Hatred priest](Mechanics/bestiary/humanoid/howling-hatred-priest-pota.md) and four [kenku](Mechanics/bestiary/humanoid/kenku.md)  
- Water cult: [Crushing Wave priest](Mechanics/bestiary/humanoid/crushing-wave-priest-pota.md) and four [bugbears](Mechanics/bestiary/humanoid/bugbear.md)  
- Earth cult: [Black Earth priest](Mechanics/bestiary/humanoid/black-earth-priest-pota.md) and two [ogres](Mechanics/bestiary/giant/ogre.md)  
- Fire cult: [Eternal Flame priest](Mechanics/bestiary/humanoid/eternal-flame-priest-pota.md) and four [hobgoblins](Mechanics/bestiary/humanoid/hobgoblin.md)  
...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/PotA/040-poa04-02.webp#center)

The eradication of one or more of the surface outposts of the elemental cults marks the characters as dangerous enemies. As the party continues the assault on cult strongholds in Tyar-Besil, the elemental prophets look for ways to hit back hard, using their [devastation orbs](Mechanics/items/devastation-orb-pota.md).
...
When the characters defeat a second elemental temple, the offended cult strikes back. Through divinations, spy reports, or visions bestowed by the Elder Elemental Eye, the cultists learn which settlement the player characters are using for a base and send a small force with a [devastation orb](Mechanics/items/devastation-orb-pota.md) to ravage that settlement—preferably with the characters in it. While the characters rest, trouble arrives on their doorstep.
...
The object is a [devastation orb](Mechanics/items/devastation-orb-pota.md), and it's ready to explode. The cultists remove the device from its case and wait for it to detonate. See chapter 7 for descriptions of the devastation orbs and statistics for the cultists. The group's composition depends on which cult is involved:

- One [Howling Hatred priest](Mechanics/bestiary/humanoid/howling-hatred-priest-pota.md), one [hurricane](Mechanics/bestiary/humanoid/hurricane-pota.md), and eight [Howling Hatred initiates](Mechanics/bestiary/humanoid/howling-hatred-initiate-pota.md) armed with a [devastation orb](Mechanics/items/devastation-orb-pota.md) of air  
- One [Black Earth priest](Mechanics/bestiary/humanoid/black-earth-priest-pota.md), two [Black Earth guards](Mechanics/bestiary/humanoid/black-earth-guard-pota.md), and four [Sacred Stone monks](Mechanics/bestiary/humanoid/sacred-stone-monk-pota.md) armed with a [devastation orb](Mechanics/items/devastation-orb-pota.md) of earth  
- One [Eternal Flame priest](Mechanics/bestiary/humanoid/eternal-flame-priest-pota.md), three [Eternal Flame guardians](Mechanics/bestiary/humanoid/eternal-flame-guardian-pota.md), and one [flamewrath](Mechanics/bestiary/humanoid/flamewrath-pota.md) armed with a [devastation orb](Mechanics/items/devastation-orb-pota.md) of fire  
- One [Crushing Wave priest](Mechanics/bestiary/humanoid/crushing-wave-priest-pota.md) and six [Crushing Wave reavers](Mechanics/bestiary/humanoid/crushing-wave-reaver-pota.md) armed with a [devastation orb](Mechanics/items/devastation-orb-pota.md) of water  

### Race to Destruction

After the characters despoil the third shrine in the Temple of Elemental Evil, the remaining cult sends a powerful force with a [devastation orb](Mechanics/items/devastation-orb-pota.md) from the Fane of the Eye (see chapter 5) to destroy another town in the Dessarin Valley. The cultists taunt the party with their intentions, hoping to lure the characters into rushing to stop them, thus being caught in the destruction. Choose a target the characters have to travel to reach and allow enough time that the party can get there just in time.

#### The Warning

While the characters rest, the cultists use a [dream](Mechanics/spells/dream.md) spell to contact the most prominent or recognizable character in the party.
...
The threat to Beliard is real. The cultists wait a couple of miles outside of town, staying out of sight until the specified time of the attack. If the characters search the outskirts of town, they can engage the cultists away from the target. Otherwise, the cultists march on the town with a [devastation orb](Mechanics/items/devastation-orb-pota.md) an hour before sunset. The group depends on which cult is involved.

- Two [Feathergale knights](Mechanics/bestiary/humanoid/feathergale-knight-pota.md) mounted on [hippogriffs](Mechanics/bestiary/monstrosity/hippogriff.md), one [skyweaver](Mechanics/bestiary/humanoid/skyweaver-pota.md), one [hurricane](Mechanics/bestiary/humanoid/hurricane-pota.md), and five [bugbears](Mechanics/bestiary/humanoid/bugbear.md)  
- One [Dark Tide knight](Mechanics/bestiary/humanoid/dark-tide-knight-pota.md) mounted on a [giant crocodile](Mechanics/bestiary/beast/giant-crocodile.md), one [fathomer](Mechanics/bestiary/humanoid/fathomer-pota.md), one [Crushing Wave priest](Mechanics/bestiary/humanoid/crushing-wave-priest-pota.md), and six [bandits](Mechanics/bestiary/humanoid/bandit.md)  
- One [burrowshark](Mechanics/bestiary/humanoid/burrowshark-pota.md) mounted on a [bulette](Mechanics/bestiary/monstrosity/bulette.md), and two [Black Earth guards](Mechanics/bestiary/humanoid/black-earth-guard-pota.md)  
- Three [Eternal Flame guardians](Mechanics/bestiary/humanoid/eternal-flame-guardian-pota.md), two [minotaurs](Mechanics/bestiary/monstrosity/minotaur.md), and four [hell hounds](Mechanics/bestiary/fiend/hell-hound.md)  
...
Beneath a high cavern ceiling, streets connect a number of spacious plazas where wealthy dwarven families built estates. With the aid of a captive djinni, the air cult works to restore the Tyar-Besil palace and transform it into [Aerisi Kalinoth](Mechanics/bestiary/npc/aerisi-kalinoth-pota.md)'s new Temple of Howling Hatred. The area has the following features. Any exceptions are noted in areas to which they apply.
...
> [!gallery]
> ![Map 4.1: Temple of Howling Hatred](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/PotA/041-04-01.webp#gallery)
> ![Player Version](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/PotA/042-pam12_templeofhowlinghatred_dm-zf-0998-75774-1-004.webp#gallery)
...
The tormented screams actually come from four [kenku](Mechanics/bestiary/humanoid/kenku.md) lurking inside the gatehouse (area A2).
...
Two [Howling Hatred priests](Mechanics/bestiary/humanoid/howling-hatred-priest-pota.md) (see chapter 7) supervise as five [commoners](Mechanics/bestiary/humanoid/commoner.md) slowly turn the westernmost wheel (see "Stone Wheels" below). After completing one revolution, they stop and await further instructions.

The commoners are cultists on the brink of becoming initiates. The priests lash these cultists to break their will before final initiation into the cult. If the characters attack, the priests order the commoners to fight to the death. A commoner can be [frightened](Mechanics/Rules/conditions.md#Frightened) into surrendering with a successful DC 15 Charisma ([Intimidation](Mechanics/Rules/skills.md#Intimidation)) check.
...
The figures gathered by the fountain are the Windwyrds, a musical group consisting of [Aerisi Kalinoth](Mechanics/bestiary/npc/aerisi-kalinoth-pota.md)'s minstrel, [Windharrow](Mechanics/bestiary/npc/windharrow-pota.md), and five [Howling Hatred initiates](Mechanics/bestiary/humanoid/howling-hatred-initiate-pota.md) (see chapter 7 for both). None of the initiates possesses an ounce of musical talent.

If the characters approach the Windwyrds peacefully, the cultists stop playing. Frustrated with the mediocre initiates, [Windharrow](Mechanics/bestiary/npc/windharrow-pota.md) asks if the characters are skilled musicians and if they would like to audition for the band.

If a bard character or a character proves his or her ability to [Windharrow](Mechanics/bestiary/npc/windharrow-pota.md), he recruits the characters into the band and offers them the initiates' robes and flutes. [Windharrow](Mechanics/bestiary/npc/windharrow-pota.md) doesn't tell the characters what happens to minstrels who displease [Aerisi Kalinoth](Mechanics/bestiary/npc/aerisi-kalinoth-pota.md).
...
The minstrels' flutes are the hollowed and carved bones of former Windwyrds who failed to please [Aerisi Kalinoth](Mechanics/bestiary/npc/aerisi-kalinoth-pota.md) with their music. A character can tell the instruments are humanoid bones with a successful DC 10 Wisdom ([Medicine](Mechanics/Rules/skills.md#Medicine)) check.

#### Development

If caught in a fight he knows he's going to lose, [Windharrow](Mechanics/bestiary/npc/windharrow-pota.md) flees to area A19.
...
Seven [kenku](Mechanics/bestiary/humanoid/kenku.md) wander the lane behind the hall, searching through the rubble for treasure. As the characters near the lane, the kenku hide and attempt to frighten the party away with ghostly sounds from the gloom.
...
Two [Howling Hatred initiates](Mechanics/bestiary/humanoid/howling-hatred-initiate-pota.md), one [hurricane](Mechanics/bestiary/humanoid/hurricane-pota.md), one [skyweaver](Mechanics/bestiary/humanoid/skyweaver-pota.md), and two [kenku](Mechanics/bestiary/humanoid/kenku.md) are stationed here to watch for incursions by Underdark predators. (See chapter 7 for the cultists' statistics.)
...
The statue of Moradin is made of solid granite except for its eyes and the panels of the lantern, which are fashioned from quartz. A [continual flame](Mechanics/spells/continual-flame.md) spell cast within the lantern's hollow interior brightly lights this plaza.
...
An [umber hulk](Mechanics/bestiary/monstrosity/umber-hulk.md) lairs here among the broken buildings. The air cult drove its usual prey away, and now the umber hulk feasts on cultists that wander into its territory. The umber hulk strikes from behind rock walls to seize its prey before burrowing away again. The air cult suffers at least one loss each week to the umber hulk, which is devious enough to cover its tunnels.

#### Treasure

Searching through the ruined villa uncovers 92 gp, a miniature electrum anvil with etchings of funerary rites in honor of Moradin (150 gp), and an [immovable rod](Mechanics/items/immovable-rod.md).
...
Seven [ghouls](Mechanics/bestiary/undead/ghoul.md) prowl the grounds and attack as soon as they realize the doors have opened. If any cultists remain in area A7, the hear the fighting and retreat to the palace (area A18).
...
A [skyweaver](Mechanics/bestiary/humanoid/skyweaver-pota.md) (see chapter 7) named Kaz Hanar and his [wyvern](Mechanics/bestiary/dragon/wyvern.md) mount perch atop the pyramid, guarding the plaza. They swoop down to attack anyone who isn't dressed as an air cultist.
...
This room contains three [kenku](Mechanics/bestiary/humanoid/kenku.md) and five bound and shackled human [commoners](Mechanics/bestiary/humanoid/commoner.md). One kenku tortures the prisoners while the other two mimic the prisoners' cries of agony.
...
The air cult uses the hall as a meditation area. At any time, five [Howling Hatred initiates](Mechanics/bestiary/humanoid/howling-hatred-initiate-pota.md), one [hurricane](Mechanics/bestiary/humanoid/hurricane-pota.md), and one [skyweaver](Mechanics/bestiary/humanoid/skyweaver-pota.md) can be found here, levitating above the ground and chanting. See chapter 7 for the cultists' statistics. The hurricane carries a [storm boomerang](Mechanics/items/storm-boomerang-pota.md) (see chapter 7) and gains the following action option:

> [!note] 
> 
> **Storm Boomerang.** *Ranged Weapon Attack:* +5 to hit; range 60/120 ft., one target. *Hit*: 4 (`1d4 + 2`) bludgeoning damage plus 7 (`3d4`) thunder damage, and the target must succeed on a DC 10 Constitution saving throw or be [stunned](Mechanics/Rules/conditions.md#Stunned) until the end of its next turn. *Miss*: The boomerang returns to the hurricane's hand.
^2e0
...
| dice: d20 | Encounter |
|-----------|-----------|
| 1–2 | `2d4` [Howling Hatred initiates](Mechanics/bestiary/humanoid/howling-hatred-initiate-pota.md) (see area A3) |
| 3 | `1d4` [hurricanes](Mechanics/bestiary/humanoid/hurricane-pota.md) (see area A20) |
| 4 | `1d2` [skyweavers](Mechanics/bestiary/humanoid/skyweaver-pota.md) (see area A20) |
| 5 | `1d2` [Howling Hatred priests](Mechanics/bestiary/humanoid/howling-hatred-priest-pota.md) (see area A3) |
| 6 | 1 [kenku](Mechanics/bestiary/humanoid/kenku.md) (see area A12) |
| 7–20 | None |
^encounter
...
Ahtayir, a [djinni](Mechanics/bestiary/elemental/djinni.md) in a torn vest and ragged pantaloons, labors here. His noble countenance bears a stoic expression as he carves a boulder with stone carving tools.
...
When [Aerisi Kalinoth](Mechanics/bestiary/npc/aerisi-kalinoth-pota.md) arrived, she took possession of the horn but refused to free the djinni from his previously assigned task. Ahtayir works endlessly at this task, carving stone masonry and statuary and flying them through the cavern, reconstructing the city block by block. He resents this duty, but he can't escape it.

If Ahtayir likes the characters or trusts in their ability to succeed against the air cult, he counsels them to attack [Aerisi Kalinoth](Mechanics/bestiary/npc/aerisi-kalinoth-pota.md) in hopes that she summons him, releasing him from his task.

#### Treasure

If the characters befriend Ahtayir and sunder the horn that summons him, the djinni brings each character a flask of [bottled breath](Mechanics/items/bottled-breath-pota.md) (see chapter 7) from his palace on the Plane of Air.
...
The obelisks are made of granite. They stand 15 feet tall and are 4 feet wide at the base. Lashed to the obelisks with thick ropes are three [Howling Hatred initiates](Mechanics/bestiary/humanoid/howling-hatred-initiate-pota.md) (see chapter 7) suffering from extreme starvation. They suffer from level 4 [exhaustion](Mechanics/Rules/conditions.md#Exhaustion) (see appendix A, "Conditions," in the *Player's Handbook*). Beneath their hollow rib cages, their bellies are little more than concave spaces where the flesh stretches thin across their bones. Their arms, legs, and faces are similarly skeletal, and terrible welts cover their bodies.
...
One [hurricane](Mechanics/bestiary/humanoid/hurricane-pota.md), one [skyweaver](Mechanics/bestiary/humanoid/skyweaver-pota.md), and five [Howling Hatred initiates](Mechanics/bestiary/humanoid/howling-hatred-initiate-pota.md) (see chapter 7 for statistics) guard this room, levitating three feet above the floor as they chant a hymn to [Yan-C-Bin](Mechanics/bestiary/npc/yan-c-bin-pota.md). The levitation effect ends on a cultist if he or she moves or takes damage. Each initiate carries two [seeker darts](Mechanics/items/seeker-dart-pota.md) (see chapter 7) and gains the following attack option:
...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/PotA/043-poa04-03.webp#center)

This chamber once served as a seat of power for the dwarf king of Besilmer and his war council. Engraved on the floor is a map of the ancient dwarven kingdom. The air cult has turned it into a den of vice and depravity. If this is the first of the elemental temples the characters explore, the air prophet [Aerisi Kalinoth](Mechanics/bestiary/npc/aerisi-kalinoth-pota.md) sits upon the high throne overseeing her court, her illusory wings gently fanning the air. She keeps her magic spear, [Windvane](Mechanics/items/windvane-pota.md) (see chapter 7), close to her at all times. If Aerisi is here, her ever-watchful [invisible stalker](Mechanics/bestiary/elemental/invisible-stalker.md) companion, Whisper, glides through the chamber unseen. If he escaped from area A4, [Windharrow](Mechanics/bestiary/npc/windharrow-pota.md) is here as well, kneeling or sitting at Aerisi's feet. Ten [Howling Hatred initiates](Mechanics/bestiary/humanoid/howling-hatred-initiate-pota.md) lay drugged behind the curtains that hang between the pillars to the north and south. Aerisi can command them to attack intruders, but they are effectively [poisoned](Mechanics/Rules/conditions.md#Poisoned). See chapter 7 for the cultists' statistics.

If Aerisi isn't here, a [vrock](Mechanics/bestiary/fiend/vrock.md), whose service was a gift from a demonic envoy, guards the temple alone. It lurks behind the throne and attacks any non-cultists that enter the hall. The drug-addled initiates don't aid the vrock and fight only in self-defense.
...
Aerisi wears a platinum torc (worth 1,600 gp), gold and sapphire rings (four, each worth 1,000 gp), and a diadem (6,400 gp) from Evereska. She carries [Windvane](Mechanics/items/windvane-pota.md) (see chapter 7) and a spellbook containing all of the spells she has prepared (see her statistics in chapter 7).

#### Development

If the characters defeat the djinni and her cultists, Aerisi (and [Windharrow](Mechanics/bestiary/npc/windharrow-pota.md), if he is present) flee to the Howling Caves via the shaft in area A18.

The first time [Aerisi Kalinoth](Mechanics/bestiary/npc/aerisi-kalinoth-pota.md) drops to 0 hit points, she vanishes in a screaming gust of wind, leaving *Windvane behind*.
...
[Gar Shatterkeel](Mechanics/bestiary/npc/gar-shatterkeel-pota.md), the Prophet of Water, instructed his followers to claim as much of the quarter as they could and to entice monsters friendly to the cult's cause to establish lairs nearby.
...
| dice: d20 | Encounter |
|-----------|-----------|
| 1 | `1d6` [darkmantles](Mechanics/bestiary/monstrosity/darkmantle.md) |
| 2 | `1d4 + 1` [piercers](Mechanics/bestiary/monstrosity/piercer.md) |
| 3 | `1d4 + 4` [troglodytes](Mechanics/bestiary/humanoid/troglodyte.md) |
| 4 | `1d4 + 1` [shadows](Mechanics/bestiary/undead/shadow.md) |
| 5 | 1 [water weird](Mechanics/bestiary/elemental/water-weird.md) |
| 6 | 1 [chuul](Mechanics/bestiary/aberration/chuul.md) |
| 7–20 | None |
^encounter
...
Cultists illuminate areas they use frequently with [continual flame](Mechanics/spells/continual-flame.md) spells cast on torches in bronze wall sconces. The rest of the level is dark.
...
> [!gallery]
> ![Map 4.2: Temple of the Crushing Wave](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/PotA/044-04-02.webp#gallery)
> ![Player Version](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/PotA/045-pam13_templeofthecrushingwave_dm-zf-0998-75774-1.webp#gallery)
...
The landing at the east end of the cavern is guarded by four [Crushing Wave reavers](Mechanics/bestiary/humanoid/crushing-wave-reaver-pota.md) and one [fathomer](Mechanics/bestiary/humanoid/fathomer-pota.md) commanded by a [Dark Tide knight](Mechanics/bestiary/humanoid/dark-tide-knight-pota.md) named Eyon (see chapter 7 for the cultists' statistics). Eyon's mount, a [hunter shark](Mechanics/bestiary/beast/hunter-shark.md), swims in the lake nearby. The cultists challenge any strange boats that approach from the east and attack unless the characters convince them to parley.
...
Eyon has a waterproofed leather pouch on her belt that contains 15 gp, 6 pp, five delicately carved coral gemstones worth 80 gp each, and a [potion of healing](Mechanics/items/potion-of-healing.md).
...
| dice: d20 | Encounter |
|-----------|-----------|
| 1 | `1d4 + 1` [ghouls](Mechanics/bestiary/undead/ghoul.md) (see area C4) |
| 2–3 | `1d4 + 4` [lizardfolk](Mechanics/bestiary/humanoid/lizardfolk.md) (see area C13) |
| 4 | `1d2` [trolls](Mechanics/bestiary/giant/troll.md) (see area C12) |
| 5 | 1 [giant octopus](Mechanics/bestiary/beast/giant-octopus.md) (see area C3) |
| 6 | 1 [dragon turtle](Mechanics/bestiary/dragon/dragon-turtle.md) (see area C21) |
| 7–20 | None |
^encounter
...
The lake is home to small blind cave fish. A [giant octopus](Mechanics/bestiary/beast/giant-octopus.md) lurks in a grotto to the south, behind a column of rock that supports the cavern ceiling. The creature attacks swimmers or boaters who approach within 30 feet of its lair.
...
Twelve aquatic [ghouls](Mechanics/bestiary/undead/ghoul.md) (which have a swimming speed of 30 feet) lurk in this chamber—previous victims of the cult's obscene rite. Eight are submerged in the pools where they died, and four more skulk in the shadows of the ruined enclosure at the west end of the room. The monsters hide so they can surprise intruders.

If the ghouls succeed in paralyzing a character, the nearest one uses an action to tie one of the heavy stones to the [paralyzed](Mechanics/Rules/conditions.md#Paralyzed) character's feet. On the following turn, the ghoul shoves the [paralyzed](Mechanics/Rules/conditions.md#Paralyzed) character into one of the drowning pools. Swimming to the surface with a tethered stone requires a successful DC 20 Strength ([Athletics](Mechanics/Rules/skills.md#Athletics)) check, and wriggling free of the tether in the confined space requires a successful DC 15 Dexterity ([Acrobatics](Mechanics/Rules/skills.md#Acrobatics)) check.
...
The cultists currently hold no prisoners in this makeshift jail. If the characters are defeated in the temple, they are stripped of their gear and confined here while [Gar Shatterkeel](Mechanics/bestiary/npc/gar-shatterkeel-pota.md) decides how best to dispose of them.
...
Crushing Wave cultists who guard the lake landing (area C1) bunk here. Six double bunks serve nine reavers, a priest, a fathomer, and a Dark Tide knight named Eyon. At any given time, five [Crushing Wave reavers](Mechanics/bestiary/humanoid/crushing-wave-reaver-pota.md) and one [Crushing Wave priest](Mechanics/bestiary/humanoid/crushing-wave-priest-pota.md) are here (see chapter 7 for the cultists' statistics).
...
This guard post is manned by a [one-eyed shiver](Mechanics/bestiary/humanoid/one-eyed-shiver-pota.md) named Khalt, a [Dark Tide knight](Mechanics/bestiary/humanoid/dark-tide-knight-pota.md) named Gordol, and three [Crushing Wave reavers](Mechanics/bestiary/humanoid/crushing-wave-reaver-pota.md) (see chapter 7 for all). Khalt is in charge, and he runs a tight ship. These reavers are armed with light crossbows instead of javelins (+4 to hit, `1d8 + 2` piercing damage), and Gordol also has a light crossbow (+7 to hit, `1d8 + 3` piercing damage).

#### Treasure

Khalt has a pouch containing 30 gp, 12 pp, four garnets worth 100 gp each, and two [potions of greater healing](Mechanics/items/potion-of-greater-healing.md).
...
Two [nothics](Mechanics/bestiary/aberration/nothic.md) occupy the room, hiding behind the broken columns and rubble choking the eastern part of the chamber. The nothics took up residence here in the hopes that unwary cult members might be easy prey for an ambush or unwittingly yield secrets of power to the monsters' weird insight. They let large and well-armed parties pass through unmolested, but then attempt to pick off a character bringing up the rear.
...
This room is the lair of three aquatic [trolls](Mechanics/bestiary/giant/troll.md), which have a swimming speed of 40 feet and the ability to breathe underwater. Only two are here, since one troll guards area C15 at any given time.
...
Eight [lizardfolk](Mechanics/bestiary/humanoid/lizardfolk.md) are here now, including the leader of the tribe, a warrior with 36 hit points named [Tornscale](Mechanics/bestiary/npc/tornscale-pota.md). They are armed with javelins, maces, and shields. Five more lizardfolk lurk around area C25, keeping guard. [Tornscale](Mechanics/bestiary/npc/tornscale-pota.md) and its followers are loyal to the sea hag Thuluna Maah (area C14). They hate and resent the human members of the cult. If the characters are disguised as water cultists when they venture into this area, the Blackmaws are outraged by the invasion of their privacy and attack just as ferociously as they would attack the cult's enemies.

If the lizardfolk lose at least two of their number in a fight here, [Tornscale](Mechanics/bestiary/npc/tornscale-pota.md) sends one of the remaining warriors to warn Thuluna and summon help.
...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/PotA/046-poa04-05.webp#center)

A [sea hag](Mechanics/bestiary/fey/sea-hag.md) named Thuluna Maah and two [ogres](Mechanics/bestiary/giant/ogre.md) that serve as her bodyguards live in this room. The two ogres stand watch in the outer portion of the room, while Thuluna lurks behind the curtain in the northwest alcove, her personal bedchamber. If the hour is late, Thuluna and her guards are asleep.

#### Roleplaying Thuluna

Thuluna Maah is the second-in-command of the temple, answering only to [Gar Shatterkeel](Mechanics/bestiary/npc/gar-shatterkeel-pota.md). She is a sly, calculating creature, quick to offer bargains and make deals that she can later turn to her advantage. The hag wields great influence over the cult's nonhuman members, mostly because the ogres and trolls do anything she tells them to. Thuluna would like to unseat Shatterkeel and purge the cult of its human fathomers and one-eyed shivers, but she is patient. For now, she tries to convince Shatterkeel to strike against the rival cults, hoping that the air or fire cultists kill him for her and clear the way for her to take over the Crushing Wave cult.

If she knows a fight is coming, Thuluna grabs the potions out of her wooden chest. She hates beauty, so she targets the best-looking character. If the fight goes against her, she pleads for mercy and offers to show the characters a great treasure if they spare her. Thuluna then leads them to [Bronzefume's](Mechanics/bestiary/npc/bronzefume-pota.md) lair in area C21.

#### Treasure

Four chairs are worth 80 gp each but weigh 30 pounds apiece. A wooden chest in the northwest alcove contains 190 gp, 8 pp, a [potion of hill giant strength](Mechanics/items/potion-of-hill-giant-strength.md), and a [potion of fire resistance](Mechanics/items/potion-of-fire-resistance.md). Near the hag's bedding is a [+1 longsword](Mechanics/items/1-weapon.md) made of dragon bone and with a dragon-leather grip. It has rubies in its pommel and hilt. The sword grows warm and the rubies glow slightly when the sword is within 120 feet of a dragon. The sword is warm and its rubies are glowing while here because the weapon is within 120 feet of the dragon turtle in area C21.
...
One aquatic [troll](Mechanics/bestiary/giant/troll.md) from area C12 lurks in the canal underneath the bridge, keeping watch for intruders. The troll surfaces to challenge anyone moving through the area by boat or attempting to cross the bridge. It can be fooled by almost any claim that sounds remotely plausible, although it attacks any intruders who look like they expect a fight. If the characters are in a boat, the troll begins the battle by trying to capsize the vessel, which requires an action and a successful DC 20 Strength check.
...
A [one-eyed shiver](Mechanics/bestiary/humanoid/one-eyed-shiver-pota.md) named Morbeoth makes his home in these rooms. He commands the western portion of the temple and defends it against incursions from the Howling Hatred cultists. Prepared for battle, he carries a [potion of gaseous form](Mechanics/items/potion-of-gaseous-form.md) and a [potion of healing](Mechanics/items/potion-of-healing.md). Six [Crushing Wave reavers](Mechanics/bestiary/humanoid/crushing-wave-reaver-pota.md) serve as his personal guards.

Morbeoth has experimented with devices that rely on elemental power. The device on the table is a disassembled [weird tank](Mechanics/items/weird-tank-pota.md) (see chapter 7). A character with proficiency in [Arcana](Mechanics/Rules/skills.md#Arcana) who makes a careful study of the workshop and the stored ingredients can determine that items powered by the energy of elemental water are assembled here.
...
This chamber once served as the hop silo for the nearby Thunderhammer brewery. It now is a guard post manned by five [bugbears](Mechanics/bestiary/humanoid/bugbear.md) who protect the Temple of the Crushing Wave against any incursion from the west.
...
Three old boats wait by the shore. They are far newer than the rest of the dungeon, having been left here less than a hundred years ago by a previous band of explorers. One is in good enough shape that it could be repaired with an hour's work by stripping planks off the other boats. Any sustained activity in this area attracts the attention of the [giant octopus](Mechanics/bestiary/beast/giant-octopus.md) that lives in area C3. The monster can haul itself up onto the shore in search of a tasty-looking meal.
...
The lake averages 40 feet deep, shallowing to 10 feet near the east end. It houses the strongest monster in the Crushing Wave cult: a [dragon turtle](Mechanics/bestiary/npc/bronzefume-pota.md) with 220 hit points named [Bronzefume](Mechanics/bestiary/npc/bronzefume-pota.md). Young and impressionable, she was lured to the Temple of the Crushing Wave by [Gar Shatterkeel](Mechanics/bestiary/npc/gar-shatterkeel-pota.md)'s offer of riches. [Bronzefume](Mechanics/bestiary/npc/bronzefume-pota.md) stays out of sight in the western end of the lake, waiting for the water prophet to decide the time is right to seize control of the river. Due to her reduced hit points, [Bronzefume](Mechanics/bestiary/npc/bronzefume-pota.md) has a challenge rating of 13 (10,000 XP).

If a boat ventures into her half of the lake, [Bronzefume](Mechanics/bestiary/npc/bronzefume-pota.md) surfaces to investigate. She also answers if the gong in area C22 is struck. The dragon turtle attacks only if she's sure those she meets are intruders, such as if she sees water cultists fighting the characters.

[Bronzefume](Mechanics/bestiary/npc/bronzefume-pota.md) prefers to attack boats rather than people. Given a choice between attacking a character and damaging a boat that character is on, she opts for the boat. Destroying a small skiff takes up her actions for `1d4` rounds, during which she ignores characters who retreat.

#### Treasure

A large wooden chest lies open on the bottom in the western end of the lake. It contains [Bronzefume](Mechanics/bestiary/npc/bronzefume-pota.md)'s hoard of 700 gp, 440 ep, six chrysoprase gemstones worth 40 gp each, and four large onyxes worth 70 gp each.
...
The first time the characters visit, one [fathomer](Mechanics/bestiary/humanoid/fathomer-pota.md) (see chapter 7) and three [cultists](Mechanics/bestiary/humanoid/cultist.md) are here, sorting through the newest pile of looted cargo. The sounds of fighting here alerts the lizardfolk in area C13 or the cultists in area C23, who investigate soon after fighting begins.

If faced with a dangerous band of attackers, the cultists attempt to reach the gong. Striking the gong summons [Bronzefume](Mechanics/bestiary/npc/bronzefume-pota.md) from area C21. She surfaces by the quay on her turn 3 rounds after the gong sounds, then joins the fight.
...
| dice: d20 | Encounter |
|-----------|-----------|
| 1 | `1d4 + 4` [lizardfolk](Mechanics/bestiary/humanoid/lizardfolk.md) (see area C13) |
| 2–3 | `1d4 + 1` [Crushing Wave reavers](Mechanics/bestiary/humanoid/crushing-wave-reaver-pota.md) (see area C7) |
| 4 | `1d3 + 1` [bugbears](Mechanics/bestiary/humanoid/bugbear.md) (see area C18) |
| 5 | 1 [Crushing Wave priest](Mechanics/bestiary/humanoid/crushing-wave-priest-pota.md) and `1d4` [cultists](Mechanics/bestiary/humanoid/cultist.md) (see area C27) |
| 6 | [Thuluna Maah](Mechanics/bestiary/fey/sea-hag.md) and 2 [ogres](Mechanics/bestiary/giant/ogre.md) (see area C14) |
| 7–20 | None |
^encounter
...
The mark on the door is the water cult's symbol. The doors leading to area C25 are unlocked but protected by a [glyph of warding](Mechanics/spells/glyph-of-warding.md). Any creature that opens either door without first making the hand sign of the water cult (an "X" of the forefingers, with thumbs overlapping) triggers the trap. A character searching the door for a trap finds the glyph with a successful DC 14 Wisdom ([Perception](Mechanics/Rules/skills.md#Perception)) check. The glyph deals `5d8` thunder damage on a failed DC 14 Dexterity saving throw or half as much damage on a successful one. Any explosion makes enough noise to alert all of the creatures in the Temple of the Crushing Wave.

#### Culverts

It's possible to enter area C25 through the culverts. Reaching a culvert requires a DC 20 Strength ([Athletics](Mechanics/Rules/skills.md#Athletics)) check to climb 15 feet up the wet, smooth masonry from the canal level. The culverts are about 4 feet high, and the stream is only 1 foot deep where it crosses over the lip. A character who climbs into the culvert mouth can easily crouch and wade forward into area C25, potentially surprising the villains there.

### C25. Temple of Elemental Water

A [glyph of warding](Mechanics/spells/glyph-of-warding.md) (see area C24) protects the double doors at the south end of the room.
...
This shrine was once dedicated to dwarven gods, but the Crushing Wave cultists rededicated it to [Olhydra](Mechanics/bestiary/npc/olhydra-pota.md). Five [lizardfolk](Mechanics/bestiary/humanoid/lizardfolk.md) warriors of the Blackmaw tribe stand guard in the southern part of the shrine.

If this is the first elemental temple the characters explore, they find [Gar Shatterkeel](Mechanics/bestiary/npc/gar-shatterkeel-pota.md) (see chapter 7) here, standing next to the altar in the northern part of the room. Otherwise, he has retreated down to the Fane of the Eye (see chapter 5). In that case, a [hezrou](Mechanics/bestiary/fiend/hezrou.md) demon is on guard with the lizardfolk. The demon lurks in the deep moat in the middle of the shrine.
...
Gar carries [Drown](Mechanics/items/drown-pota.md) (see chapter 7). The water cultists bring treasure here and heap it on the altar. At the moment, only 25 sp, 12 gp, and six small agates worth 10 gp each are strewn across the altar. Shatterkeel regularly gathers the offerings and secures them in area C26.
...
This pool is almost 80 feet deep and fed by an aquifer through porous rock at the bottom. It is the source of the Dark Stream, and it fills the canals and lakes on this level. Its inaccessibility makes it an ideal place for [Gar Shatterkeel](Mechanics/bestiary/npc/gar-shatterkeel-pota.md) to hoard the better part of the water cult's treasure. He is beyond such cares, but he realizes that wealth is a motivation for some who aren't entirely committed to the tenets of the Crushing Wave cult.

#### Treasure

Several rusty iron coffers lie on the dry ledge at the south edge of the chamber. Two contain 730 gp, 900 sp, a silver ewer, a scroll of [tidal wave](Mechanics/spells/tidal-wave-xge.md), and a scroll of [vitriolic sphere](Mechanics/spells/vitriolic-sphere-xge.md) (see appendix B for both spells). Two more hold waterproofed leather satchels that contain nearly fifty heavy old tomes written in Dethek (the Dwarvish script). These are the missing books of Bruldenthar, the sage from Mirabar. The sage is held in the mines below the Sacred Stone Monastery.
...
This room serves as the personal quarters of the cult priests: two [Crushing Wave priests](Mechanics/bestiary/humanoid/crushing-wave-priest-pota.md) (see chapter 7) and four [cultists](Mechanics/bestiary/humanoid/cultist.md). The priests see themselves as the most important members of the cult, and they make sure to look after their creature comforts. They intermittently take care of the Temple of Elemental Water.

On the rare occasions when [Gar Shatterkeel](Mechanics/bestiary/npc/gar-shatterkeel-pota.md) retires to rest for a few hours, he sleeps here. Otherwise, he is found in area C25, attempting to discern the will of [Olhydra](Mechanics/bestiary/npc/olhydra-pota.md) or instructing others in the lore and philosophy of the cult.
...
The Crushing Wave cultists summoned a [mezzoloth](Mechanics/bestiary/fiend/mezzoloth.md) and ordered it to destroy any intruders seeking to use the stairs. To determine whether someone is an intruder, the mezzoloth asks three questions:

*What do you serve?* The answer should be "[Olhydra](Mechanics/bestiary/npc/olhydra-pota.md)," "the Princess of Evil Water," or "water."
...
> [!gallery]
> ![Map 4.3: Temple of Black Earth](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/PotA/047-04-03.webp#gallery)
> ![Player Version](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/PotA/048-pam15_templeofblackearth_dm-zf-0998-75774-1-006-0.webp#gallery)
...
Three [gargoyles](Mechanics/bestiary/elemental/gargoyle.md) guard the area, lurking on ledges in the shadowy upper reaches of this cavern, the ceiling of which is 50 feet higher than the bridge and 100 feet above the cavern floor. Characters with torches or [darkvision](Mechanics/Rules/senses.md#Darkvision) spot the gargoyles if they have a passive Wisdom ([Perception](Mechanics/Rules/skills.md#Perception)) score of 15 or higher. The gargoyles ignore groups exiting the Temple of Black Earth. They attack any strangers approaching from the north unless the strangers pause at the bridge to either give the hand sign of the cult (a triangle formed with thumbs and forefingers of both hands) or call out, "I serve the Black Earth!"
...
[Marlos Urnrayle](Mechanics/bestiary/npc/marlos-urnrayle-pota.md) used [stone shape](Mechanics/spells/stone-shape.md) spells to create a narrow ledge that hugs the walls of the cavern. This ledge isn't visible from the cavern floor, and it starts 5 feet below the ledge leading to area B6 and ends at an arrow slit, beyond which lies area B22. The arrow slit is 4 feet tall but only 6 inches wide.
...
This was formerly the front gate of the stronghold of Tyar-Besil, but many years ago an earthquake finished the destruction begun by orcs and giants. The ceiling here is 30 feet high, and the gate stands 15 feet tall. [Marlos Urnrayle](Mechanics/bestiary/npc/marlos-urnrayle-pota.md) intends to repair it, but he has not yet found anyone sufficiently skilled to do the work.
...
Four [hobgoblins](Mechanics/bestiary/humanoid/hobgoblin.md), a [burrowshark](Mechanics/bestiary/humanoid/burrowshark-pota.md) named Nartham (see chapter 7), and Nartham's [bulette](Mechanics/bestiary/monstrosity/bulette.md) mount guard the Hall of the Gate. Nartham is a violent, short-tempered fellow. If the characters attempt to talk their way into the temple, they need to talk fast, because Nartham craves an excuse to kill.
...
If the characters defeat the guards here and depart the temple, [Marlos Urnrayle](Mechanics/bestiary/npc/marlos-urnrayle-pota.md) replaces the guards in a few hours with the cultists from area B14. In a few days, he augments this force with two ogres.
...
This room served as a guardroom for the Hall of the Gate, but tremors collapsed the doorway that once linked the two rooms and formed the tunnel leading to area B2. A [stonemelder](Mechanics/bestiary/humanoid/stonemelder-pota.md) named Yarsha and her two [Black Earth guards](Mechanics/bestiary/humanoid/black-earth-guard-pota.md) (see chapter 7 for both) dwell here. In addition to normal gear, Yarsha carries a [potion of greater healing](Mechanics/items/potion-of-greater-healing.md), and the guards have light crossbows (+3 to hit, `1d8` piercing damage) if they need to defend area B3, but they don't keep a watch posted at the arrow slit.

Yarsha is murderous, and she has set her sights on assassinating [Miraj Vizann](Mechanics/bestiary/npc/miraj-vizann-pota.md) and taking his place as the cult's second-in-command. If she and her guards are on the verge of defeat, she turns on her own guards and finishes them off so she can try to strike a deal with the characters. Yarsha tells the party that Miraj is the earth prophet, and where they can find him (area B8). She asks nothing for herself other than a temporary truce.

The cultists don't know about the ledge in area B2 that links the northern tunnel to area B22.

#### Treasure

An iron coffer under Yarsha's bunk contains 210 sp, 140 ep, a pouch with six obsidian flakes worth 10 gp each, and a [potion of water breathing](Mechanics/items/potion-of-water-breathing.md).
...
This is the lair and workroom of [Miraj Vizann](Mechanics/bestiary/npc/miraj-vizann-pota.md) (see chapter 7), an earth genasi and second in command of the Cult of the Black Earth. The statues were once animated constructs, though the magic that powered them faded long ago. Miraj managed to reactivate two of the stone warriors. One now stands watch in area B24, and the other is here. The ancient construct is equivalent to a [stone golem](Mechanics/bestiary/construct/stone-golem.md) with 102 hit points and no Multiattack action (challenge rating 4 instead of 8).
...
Miraj calls himself a "mud sorcerer" because he practices earth and water magic, and he reveres both [Ogrémoch](Mechanics/bestiary/npc/ogremoch-pota.md) and [Olhydra](Mechanics/bestiary/npc/olhydra-pota.md). He bears the water cultists no ill will and sometimes acts as an advocate or emissary on their behalf.

In battle, Miraj commands the golem to defend him. He then retreats to the back of the room to cast spells. Miraj turns [invisible](Mechanics/Rules/conditions.md#Invisible) and flees if death seems imminent.
...
A wooden chest stowed under one of the worktables holds a small hoard of 220 gp, nine strange black crystals worth 50 gp each, and a [potion of water breathing](Mechanics/items/potion-of-water-breathing.md).
...
Creatures that make a lot of noise in the vicinity of the natural bridge disturb a [swarm of bats](Mechanics/bestiary/beast/swarm-of-bats.md) roosting on the bridge's underside.
...
This room was the main kitchen for the dwarven soldiers stationed in this part of Tyar-Besil. It is now the lair of Broog and Norb—the two heads of a particularly large and grumpy [ettin](Mechanics/bestiary/giant/ettin.md). Broog-Norb has 130 hit points.
...
This chamber has been equipped with implements to torture defeated enemies, cult servants who fail their insane leaders, or the occasional innocent victim. This grim chamber is the domain of a [stonemelder](Mechanics/bestiary/humanoid/stonemelder-pota.md) (see chapter 7) named Heldorm and the three [cultists](Mechanics/bestiary/humanoid/cultist.md) who assist him.
...
- Orna, a female human [Black Earth guard](Mechanics/bestiary/humanoid/black-earth-guard-pota.md) (see chapter 7) who dared to strike a Black Earth priest a few days ago. Greedy and brutal, she is now enraged against the cult.  
- Droth, a male human mercenary [thug](Mechanics/bestiary/humanoid/thug.md) in the service of the Howling Hatred cult. He is virtually catatonic but shuffles from place to place if led.  
- Wulgreda, a hapless female dwarf [commoner](Mechanics/bestiary/humanoid/commoner.md) who was captured while prospecting in the hills near the Sacred Stone Monastery. She warns the party that Orna is a Black Earth guard.  
- Gervor, a male half-elf [noble](Mechanics/bestiary/humanoid/noble.md) who is all that is left of an adventuring company ambushed by the cult a month ago in the Sumber Hills. He is badly injured and has 1 hit point remaining.  

Wulgreda and Gervor are happy just to be released, although they ask the party to help them get to safety. Orna wants to go her own way, but she is willing to trade information for her freedom. She's willing to guide the characters to [Marlos Urnrayle](Mechanics/bestiary/npc/marlos-urnrayle-pota.md) (area B21).

#### Treasure

Hedorm keeps the best pickings from the prisoners in a locked wooden chest (the key is in his pocket). His trove includes 230 sp, a pouch of six azurites worth 10 gp each, Orna's plate armor, Gervor's studded leather armor and longsword, and a [wand of magic missiles](Mechanics/items/wand-of-magic-missiles.md) (fully charged) left behind by a previous victim.
...
Black Earth cultists have turned this former barracks into a forge where they create elemental devices. The master of the forge is a [dao](Mechanics/bestiary/elemental/dao.md) named Xharva Deem. Two [duergar](Mechanics/bestiary/humanoid/duergar.md) assist her.

#### Roleplaying the Dao

Xharva Deem has no interest in fighting, because her bargain with [Marlos Urnrayle](Mechanics/bestiary/npc/marlos-urnrayle-pota.md) requires her to make implements of elemental power for the cult. That is the extent of her promise. If the characters ask why she is standing aside, she answers, "Urnrayle has not paid me to fight puny mortals. He can look after his own slaves."
...
This room serves as a guard post for the Black Earth cult. It also provides a good place from which the earth cultists can keep an eye on the Cult of the Eternal Flame. To guard this point of access, [Marlos Urnrayle](Mechanics/bestiary/npc/marlos-urnrayle-pota.md) has assigned a garrison of five [ogres](Mechanics/bestiary/giant/ogre.md) with orders to let no one enter from the west without giving the pass sign of the earth cult (a triangle formed by thumbs and forefingers). The ogres have no orders to prevent people from leaving, although they challenge strangers who don't look like members of the cult.
...
If the ogres are defeated, [Marlos Urnrayle](Mechanics/bestiary/npc/marlos-urnrayle-pota.md) replaces them with an [earth elemental myrmidon](Mechanics/bestiary/elemental/earth-elemental-myrmidon-mpmm.md) (see chapter 7) after `1d4` days.
...
An [alarm](Mechanics/spells/alarm.md) spell has been cast on the middle of the bridge. If the characters trigger the alarm, read:
...
The statue depicts [Ogrémoch](Mechanics/bestiary/npc/ogremoch-pota.md), the Prince of Evil Earth. [Marlos Urnrayle](Mechanics/bestiary/npc/marlos-urnrayle-pota.md) sculpted it.
...
| dice: d20 | Encounter |
|-----------|-----------|
| 1–2 | `1d3 + 1` [duergar](Mechanics/bestiary/humanoid/duergar.md) (see area B5) |
| 3 | `1d4` [ogres](Mechanics/bestiary/giant/ogre.md) (see area B16) |
| 4 | 1 [stonemelder](Mechanics/bestiary/humanoid/stonemelder-pota.md) and 2 [Black Earth guards](Mechanics/bestiary/humanoid/black-earth-guard-pota.md) (see area B6) |
| 5 | 1 [burrowshark](Mechanics/bestiary/humanoid/burrowshark-pota.md) and `1d4` [cultists](Mechanics/bestiary/humanoid/cultist.md) (see area B7) |
| 6 | 1 [Black Earth priest](Mechanics/bestiary/humanoid/black-earth-priest-pota.md) and `1d4` [Black Earth guards](Mechanics/bestiary/humanoid/black-earth-guard-pota.md) (see area B18) |
| 7 | [Miraj Vizann](Mechanics/bestiary/npc/miraj-vizann-pota.md) (see area B8) |
| 8–20 | None |
^encounter
...
If this is the first of the elemental temples the characters explore, [Marlos Urnrayle](Mechanics/bestiary/npc/marlos-urnrayle-pota.md) (see chapter 7) is here. Visions have warned the medusa of the characters' arrival, and he prefers to meet visitors in this area. A [shadow demon](Mechanics/bestiary/fiend/shadow-demon.md) that serves as Marlos's messenger and majordomo lurks nearby.
...
In combat, Marlos relies on his petrifying gaze to keep him safe from ranged attacks or spells, as he closes in to use [Ironfang](Mechanics/items/ironfang-pota.md) and his snaky hair. When the battle turns against him, Marlos flees to area B22 and makes his getaway through the hidden path in area B2.

#### Statues

The statues are the [petrified](Mechanics/Rules/conditions.md#Petrified) remains of earth cultists who displeased Urnrayle.

#### Treasure

Marlos carries [Ironfang](Mechanics/items/ironfang-pota.md) (see chapter 7).
...
In the urns, Marlos has stored 1,100 sp and 130 pp. Within the room are a beautiful tapestry of a flying dragon (worth 400 gp), a carved lyre worth 250 gp, and an embroidered silk robe worth 80 gp. A suit of [elven chain](Mechanics/items/elven-chain.md) is folded inside a wooden chest.
...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/PotA/049-poa04-07.webp#center)

A [Black Earth priest](Mechanics/bestiary/humanoid/black-earth-priest-pota.md) (see chapter 7) named Erione is establishing a shrine here atop the wreckage of an ancient dwarven chapel. She is joined by four cultists.

Erione resents the fact that few priests hold high places in the cult, and she intends to demonstrate that worship can bring even greater power. She has coaxed a [black pudding](Mechanics/bestiary/ooze/black-pudding.md) into the porous rock obelisk. It seeps forth on her command.

Erione has manacled a female [deep gnome](Mechanics/bestiary/humanoid/deep-gnome-svirfneblin.md) named Rukhelmoth "Rukh" Glitterstone to the stone post at the foot of the obelisk and intends to offer him as a sacrifice to the black pudding. When the pudding emerges, it seeps out of the obelisk like thick black blood and attacks the gnome first. Only after the gnome has been consumed does it pay attention to the characters.
...
- The leader of the earth cult is a medusa named [Marlos Urnrayle](Mechanics/bestiary/npc/marlos-urnrayle-pota.md). He lairs in a cavern to the northeast.  
...
The statue is a [stone golem](Mechanics/bestiary/construct/stone-golem.md) reactivated by [Miraj Vizann](Mechanics/bestiary/npc/miraj-vizann-pota.md) (see area B8) and placed here. It has 102 hit points and no Multiattack action. (It has a challenge rating 4 instead of 8.)
...
When [Vanifer](Mechanics/bestiary/npc/vanifer-pota.md) was first drawn to the complex, she instructed her minions to stake claims in and around the abandoned foundries. The tiefling knows that controlling the ability to craft the tools of warfare gives her cult a leg up on the others, and she fervently believes that she can use this power to bring the other elemental temples to heel, allowing her to rule over all.
...
> [!gallery]
> ![Map 4.4: Temple of Eternal Flame](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/PotA/050-04-04.webp#gallery)
> ![Player Version](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/PotA/051-pam16_templeofeternalflame_dm-zf-0998-75774-1-007.webp#gallery)
...
Four [hobgoblins](Mechanics/bestiary/humanoid/hobgoblin.md) and one [hobgoblin captain](Mechanics/bestiary/humanoid/hobgoblin-captain.md) stand guard here, dressed in flame-red tabards with the symbol of elemental fire on the chest. They challenge anyone approaching from the west, but they pay little attention to anyone heading in that direction.
...
Two [razerblasts](Mechanics/bestiary/humanoid/razerblast-pota.md) (see chapter 7) keep to the sides of the chamber. How these guards react depends on how the characters arrive. If characters come from within the fire temple and act like they belong there, the guards pay them little mind. Characters who arrive escorted by hobgoblins must convince the guards to let them pass. If they do, one of the razerblasts escorts the party.

If a fight breaks out, one of the razerblasts shouts, "[Imix](Mechanics/bestiary/npc/imix-pota.md) defend us!" When this happens, read the following text aloud:
...
A tripwire stretches across the floor between the westernmost pair of niches. Characters with a passive Wisdom ([Perception](Mechanics/Rules/skills.md#Perception)) score of 15 or higher notice it automatically. Otherwise, a character searching the floor for traps spots the tripwire with a successful DC 10 Wisdom ([Perception](Mechanics/Rules/skills.md#Perception)) check. If the wire is tripped, a spring-loaded greataxe disguised to look like part of the southern statue snaps across the hallway and makes an attack against the creature that triggered the trap (+10 to hit; `1d12 + 5` slashing damage on a hit). The clanging of the axe alerts the guards in area E2, who investigate.

#### Secret Door

A secret door is hidden behind the southeasternmost statue. It can be found with a successful DC 15 Wisdom ([Perception](Mechanics/Rules/skills.md#Perception)) check.
...
Two [ogres](Mechanics/bestiary/giant/ogre.md) in plate armor (AC 17) and four [half-ogres](Mechanics/bestiary/giant/half-ogre-ogrillon.md) challenge anyone coming from outside the temple. Those seeking entrance must make signs like those described in E1. If the characters instead ask to speak with the temple's leaders, one ogre leaves and returns with a razerblast from area E2.
...
A secret door in the north wall can be found with a successful a DC 15 Wisdom ([Perception](Mechanics/Rules/skills.md#Perception)) check. It opens into a tunnel that travels north for 40 feet before ending at an arrow slit that looks out into a lava tube (see area E1).
...
A dozen fire temple cultists bunk here, but only four [Eternal Flame guardians](Mechanics/bestiary/humanoid/eternal-flame-guardian-pota.md) (see chapter 7) are present when the characters arrive. Two must awaken, then stand and move to join any battle; they have AC 12, since they have no time to don armor.
...
This room has been claimed by three cult priests. At any given time, two [Eternal Flame priests](Mechanics/bestiary/humanoid/eternal-flame-priest-pota.md) (see chapter 7) are present. If the characters catch them unaware, one is eating at the table while the other is sitting at a desk, consulting a tome and writing.

#### Treasure

One of the priests carries a [potion of fire breath](Mechanics/items/potion-of-fire-breath.md). The footlockers contain a total of 36 sp and 19 gp.
...
Hobgoblins that serve the fire temple bunk here. Six [hobgoblins](Mechanics/bestiary/humanoid/hobgoblin.md) and one [hobgoblin captain](Mechanics/bestiary/humanoid/hobgoblin-captain.md) are present. Unless they have reason not to be, four hobgoblins are sleeping, while the other two are sitting at the fire with their captain. Sleeping hobgoblins wake and spend their first turn standing and arming themselves, joining the fight on their next turns. Lacking time to don armor, each has AC 13 (shield).

If the hobgoblin captain is reduced to half its hit point maximum, it spends one turn drinking a [potion of greater healing](Mechanics/items/potion-of-greater-healing.md) (see "Treasure").
...
The hobgoblin captain has a small, polished oak box containing three [potions of fire resistance](Mechanics/items/potion-of-fire-resistance.md) and a [potion of greater healing](Mechanics/items/potion-of-greater-healing.md).
...
The symbol on the tapestry is the symbol of fire; show it to the players. Each furnished cell to the north houses an [Eternal Flame guardian](Mechanics/bestiary/humanoid/eternal-flame-guardian-pota.md), and each of the furnished cells to the south houses a [flamewrath](Mechanics/bestiary/humanoid/flamewrath-pota.md) (see chapter 7 for both). Combat in one of the cells attracts the attention of the other cultists nearby.

#### Secret Door Cell

The cell in the southeast corner of the hall is empty. A secret door in the south wall can be found with a successful a DC 15 Wisdom ([Perception](Mechanics/Rules/skills.md#Perception)) check.

#### Prison Cells

The doors of the unfurnished cells—aside from the one with the secret door—are uncomfortably warm to the touch.

Each unfurnished cell north of the hall contains a [salamander](Mechanics/bestiary/elemental/salamander.md)—four salamanders total. If offered freedom, the salamanders can be convinced to fight the fire cultists. If forced to fight alongside azers, however, the salamanders have a twenty-five percent chance each round of turning on the azers during a fight.

Each unfurnished cell south of the hall (not counting the easternmost cell, which is empty) contains two [azers](Mechanics/bestiary/elemental/azer.md)—six azers total. They are eager to fight the fire cultists and the efreeti slaver (see area E13), but they need weapons. If the salamanders attack the azers, the azers fight the salamanders until one side or the other is defeated. If the characters don't help the azers fight the salamanders, the azers turn on the characters as well.
...
This chamber is the heart of the fire cult's domain, the great foundry where they forge weapons and armor. Noise here drowns out any fighting taking place outside the immediate vicinity. An [efreeti](Mechanics/bestiary/elemental/efreeti.md) aided by one [razerblast](Mechanics/bestiary/humanoid/razerblast-pota.md) and two [Eternal Flame guardians](Mechanics/bestiary/humanoid/eternal-flame-guardian-pota.md) (see chapter 7 for both) drives a [salamander](Mechanics/bestiary/elemental/salamander.md) and three [azers](Mechanics/bestiary/elemental/azer.md), forcing them to work the forges.
...
The hanging shield is a [+1 shield](Mechanics/items/1-shield.md) with a sprocket on its front that slowly turns clockwise, making one rotation per hour.
...
Four [ hell hounds](Mechanics/bestiary/fiend/hell-hound.md) lair here. They attack if whoever opened the door isn't Lyzzie (area E29), their mistress.
...
Two [Eternal Flame guardians](Mechanics/bestiary/humanoid/eternal-flame-guardian-pota.md) (see chapter 7) stand guard here.
...
Two [Eternal Flame guardians](Mechanics/bestiary/humanoid/eternal-flame-guardian-pota.md) (see chapter 7) are drinking and playing cards at the table. They attack anyone who isn't wearing cult apparel and suspiciously question anyone disguised as a cult member.
...
Ignatia, a [flamewrath](Mechanics/bestiary/humanoid/flamewrath-pota.md) (see chapter 7), lives here. She leads the warriors outside and serves as the watch commander for the hobgoblins guarding the south barricades (area E27).

#### Prisoner

Unless the characters have somehow set the temple on high alert, Ignatia is questioning a [Crushing Wave reaver](Mechanics/bestiary/humanoid/crushing-wave-reaver-pota.md) who was caught sneaking close to Eternal Flame cult territory. The reaver, Orgaal, is unarmed and has 4 hit points remaining.
...
Eight [cultists](Mechanics/bestiary/humanoid/cultist.md) and two [cult fanatics](Mechanics/bestiary/humanoid/cult-fanatic.md) are here.

#### Reinforcements

Lyzzie and her magmins (area E29) investigate any commotion here. If appropriate, Lyzzie uses [sending](Mechanics/spells/sending.md) to contact the chimera in area E30. The chimera moves to help Lyzzie as soon as it can.
...
If this is the first of the elemental temples the characters explore, [Vanifer](Mechanics/bestiary/npc/vanifer-pota.md) (see chapter 7) is kneeling before the altar, contemplating the higher meaning of her faith. The braziers are receptacles holding two [fire elementals](Mechanics/bestiary/elemental/fire-elemental.md) under [Vanifer](Mechanics/bestiary/npc/vanifer-pota.md)'s command. They appear and attack as soon as their mistress orders them to.

#### Roleplaying Vanifer

[Vanifer](Mechanics/bestiary/npc/vanifer-pota.md) is willing to talk, but only to size up the characters. If the characters seem amenable to conversation, she vows to take her cult far away from the Sumber Hills if they do her the favor of killing [Gar Shatterkeel](Mechanics/bestiary/npc/gar-shatterkeel-pota.md) and delivering his claw as proof of his demise. She honors no such deal.

In combat, [Vanifer](Mechanics/bestiary/npc/vanifer-pota.md) commands the elementals to engage the characters while she casts spells. If the fight seems to be going badly, [Vanifer](Mechanics/bestiary/npc/vanifer-pota.md) flees to the shaft (area E14) and down into the fire node.

#### Secret Door

A secret door is hidden behind one of the tapestries on the east end of the south wall. A character who searches the wall and succeeds on a DC 15 Wisdom ([Perception](Mechanics/Rules/skills.md#Perception)) check locates it. Beyond lies a flight of stairs leading down to area E31.
...
Six [hobgoblins](Mechanics/bestiary/humanoid/hobgoblin.md) stand guard here, dressed in flame-red tabards with the symbol of elemental fire on the chest. They challenge anyone approaching from the south, but they pay little attention to anyone heading in that direction.
...
The hobgoblins who serve Lyzzie (area E29) dwell here. Four [hobgoblins](Mechanics/bestiary/humanoid/hobgoblin.md) and a [hobgoblin captain](Mechanics/bestiary/humanoid/hobgoblin-captain.md) are currently relaxing. Unless the characters look like cultists, the hobgoblins attack.

#### Treasure

The hobgoblin captain carries a [potion of healing](Mechanics/items/potion-of-healing.md) and a pouch containing 60 sp.
...
The dancing creatures are four [magmins](Mechanics/bestiary/elemental/magmin.md). They are curious to know who the characters are and playfully try to set them on fire. If they are harmed, the magmins hiss loud enough to alert their mistress, [Lyzandra "Lyzzie" Calderos](Mechanics/bestiary/npc/lyzandra-lyzzie-calderos-pota.md). She is a human [mage](Mechanics/bestiary/humanoid/mage.md) with [wall of fire](Mechanics/spells/wall-of-fire.md) and [immolation](Mechanics/spells/immolation-xge.md) (see appendix B) prepared instead of [ice storm](Mechanics/spells/ice-storm.md) and [cone of cold](Mechanics/spells/cone-of-cold.md). When the characters first arrive, Lyzzie is relaxing in a smaller room behind the burnt tapestry. Lyzzie's room contains several scorched bunkbeds, a charred desk, but nothing of value.
...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/PotA/052-poa04-09.webp#center)

A [chimera](Mechanics/bestiary/monstrosity/chimera.md) loyal to the fire cult lounges in the western alcove. It emerges from its alcove to taunt and threaten the characters, pacing and snarling. If the characters attack it or try to plunder its hoard, it retaliates. Otherwise, it lets them pass through its lair unmolested.
...
Scattered in the western alcove—among broken bones and scraps of clothing—is the chimera's hoard of 517 cp, 1,048 sp, 432 gp, five polished moonstones (50 gp each), a [potion of water breathing](Mechanics/items/potion-of-water-breathing.md), and a tiny red silk pouch that contains fine sand ([dust of disappearance](Mechanics/items/dust-of-disappearance.md)).
...
[Vanifer](Mechanics/bestiary/npc/vanifer-pota.md) spends very little time here.

#### Treasure

A search of the desk reveals a scroll of [Melf's minute meteors](Mechanics/spells/melfs-minute-meteors-xge.md) and a scroll of [wall of sand](Mechanics/spells/wall-of-sand-xge.md) (see appendix B for descriptions of both spells).

### Conclusion

Three key leaders keep the Cult of the Eternal Flame organized: [Vanifer](Mechanics/bestiary/npc/vanifer-pota.md), [Bastian Thermandar](Mechanics/bestiary/npc/bastian-thermandar-pota.md), and Lyzzie Calderos. If any of these leaders survive after the characters leave the temple, the cultists reorganize their defenses and fight off further incursions. If [Vanifer](Mechanics/bestiary/npc/vanifer-pota.md) retreats to the deeper levels and the characters defeat Bastian and Lyzzie, the Eternal Flame cult loses its cohesion, and the surviving cultists abandon this level. Some retreat to the Fane of the Eye or the Weeping Colossus, while others flee the temple altogether. A few monsters might remain, such as the chimera, which rounds up as much loot as it can and takes to hunting stray cultists once their leaders are all gone.