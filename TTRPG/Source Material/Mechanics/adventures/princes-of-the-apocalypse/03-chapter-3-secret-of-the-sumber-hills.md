...
The person at the arrow slit is Holger, a [thug](Mechanics/bestiary/humanoid/thug.md) who commands the gatehouse. Holger is a high-strung martinet, and no one in the gatehouse likes him. Holger decides whether to open the gate, tell the characters to go away, or order his bandits to open fire. If Holger admits the characters, he orders four [bandits](Mechanics/bestiary/humanoid/bandit.md) (two from area K2, two from area K3) to meet them at the gate and escort them inside.
...
This area serves as a barracks and a defensive post. Holger, a [thug](Mechanics/bestiary/humanoid/thug.md), commands the gatehouse. Three more [bandits](Mechanics/bestiary/humanoid/bandit.md) have bunks here.
...
A secret door behind Grimjaw's seat can be found with a successful DC 10 Wisdom ([Perception](Mechanics/Rules/skills.md#Perception)) check. The door hides a spiral staircase that descends to area K22.
...
During the day, four [Sacred Stone monks](Mechanics/bestiary/humanoid/sacred-stone-monk-pota.md) (see chapter 7) work in this room. At night, they return to their quarters.
...
[Renwick](Mechanics/bestiary/npc/renwick-pota.md) doesn't attack intruders. If he believes the characters are Black Earth cultists, he says, "I have already told you no. Depart." If confronted by characters he believes aren't cultists, he says, "I am not your enemy. Now go." If the characters provoke him, he provides fair warning: "In a moment I will fill this room with deadly poisonous gas. You should leave now." If attacked without warning, [Renwick](Mechanics/bestiary/npc/renwick-pota.md) uses [time stop](Mechanics/spells/time-stop.md), then casts [cloudkill](Mechanics/spells/cloudkill.md) before taking his leave. (The lich has [time stop](Mechanics/spells/time-stop.md) prepared instead of [power word kill](Mechanics/spells/power-word-kill.md). His list of prepared spells is otherwise the same as the lich presented in the *Monster Manual*.)

If the characters recognize [Renwick](Mechanics/bestiary/npc/renwick-pota.md) (perhaps from the stories told at Summit Hall) and remind him of his heroic days, [Renwick](Mechanics/bestiary/npc/renwick-pota.md) might be moved to help them. He doesn't want to fight the cultists since he no longer has any wish to kill, but if persuaded to help, he bestows a gift on any paladin or good-aligned fighter in the party: an [amulet of health](Mechanics/items/amulet-of-health.md). He also promises to keep more cultists from reoccupying the monastery after the characters drive them out, and he might part with some of the potions and scrolls described in the next section.

#### Treasure

[Renwick](Mechanics/bestiary/npc/renwick-pota.md)'s curios and esoteric tomes aren't valuable and hold little magical power. For centuries he has been interested in the philosophy of magic, not bigger and more powerful spells or artifacts. However, scattered among the curios are a [potion of greater healing](Mechanics/items/potion-of-greater-healing.md), a [potion of hill giant strength](Mechanics/items/potion-of-hill-giant-strength.md), a scroll of [invisibility](Mechanics/spells/invisibility.md), and a scroll of [Snilloc's snowball swarm](Mechanics/spells/snillocs-snowball-swarm-xge.md) (see appendix B).
...
When [Renwick](Mechanics/bestiary/npc/renwick-pota.md) first established himself in the old monastery, he claimed this room, though he has no need for the trappings of life. If he decides to help the characters, he allows them to use this room to rest safely.

#### Renwick's Phylactery

[Renwick](Mechanics/bestiary/npc/renwick-pota.md) left his phylactery in a place even he can't easily reach: a tomb beneath Summit Hall. If he should be defeated in combat, he'll re-form there—and see whether he can abscond with his brother's body for reburial in the empty sarcophagus in area M20.
...
This chamber serves as the barracks for the Sacred Stone's subterranean guards: three [orogs](Mechanics/bestiary/humanoid/orog.md) and one [ogre](Mechanics/bestiary/giant/ogre.md). The leader of the orogs is a battle-scarred old veteran named Jurth, who claims the title of "commander." The ogre, a flabby simpleton called Drool, pathetically tries to please Jurth by brutalizing the hapless slaves this band of guards oversees.
...
If the characters kill this group of monsters and leave the dungeon without defeating [Hellenrae](Mechanics/bestiary/npc/hellenrae-pota.md), within `1d3` days she replaces these guards with six [duergar](Mechanics/bestiary/humanoid/duergar.md). The duergar also arrive if the characters kill Jurth in a random encounter in the mine (area M22).
...
The cells hold a total of seventeen [commoners](Mechanics/bestiary/humanoid/commoner.md). Most are human peasants, caravan drivers, merchants, or tribesfolk. However, one is the dwarven sage Bruldenthar, one of the missing members of the delegation from Mirabar.
...
Not all the monsters beneath the monastery belong to the Black Earth cult. The crypt is part of the dungeon claimed by the lich [Renwick](Mechanics/bestiary/npc/renwick-pota.md), who normally can be found in his workshop (area M16). The lich retreats here to avoid confronting determined attackers. Six [zombies](Mechanics/bestiary/undead/zombie.md) guard this place, lying among the remains of the long-dead priests and monks who first built it. The creatures obey [Renwick](Mechanics/bestiary/npc/renwick-pota.md), who ordered them to defend the crypt against all living intruders.
...
Most of the old clerics and monks were buried quite modestly, but one skeleton in the north wall wears a silver ring set with small rubies (600 gp) and a [ring of fire resistance](Mechanics/items/ring-of-fire-resistance.md).
...
The lever in area M9 also causes the stairs leading into this room to collapse, creating a steep slide. A character actively searching the stairs for traps notices the collapsing mechanism with a successful DC 15 Wisdom ([Perception](Mechanics/Rules/skills.md#Perception)) check.
...
| d6;d8 | Encounter |
|-------|-----------|
| 1 | `1d4` [commoners](Mechanics/bestiary/humanoid/commoner.md) (see area M19) |
| 2 | As per result 1, plus 1 [orog](Mechanics/bestiary/humanoid/orog.md) (see area M18) |
| 3 | `1d3` [Sacred Stone monks](Mechanics/bestiary/humanoid/sacred-stone-monk-pota.md) (see area M7) |
| 4 | `1d3` [violet fungi](Mechanics/bestiary/plant/violet-fungus.md) |
| 5 | 1 [grick](Mechanics/bestiary/monstrosity/grick.md) |
| 6 | Jurth and `1d2` [orogs](Mechanics/bestiary/humanoid/orog.md) (see area M18) |
| 7–8 | `1d3 + 1` [duergar](Mechanics/bestiary/humanoid/duergar.md) (see area M5) |
^encounter
...
> [!gallery]
> ![Map 3.5: Scarlet Moon Hall](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/PotA/036-03-05.webp#gallery)
> ![Player Version](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/PotA/037-poa11.webp#gallery)
...
These druids fight only if attacked, spurring their two [elk](Mechanics/bestiary/beast/elk.md) companions into battle. They beg for mercy once half of them (including the elk) are down.
...
The druids have a scroll of [elemental bane](Mechanics/spells/elemental-bane-xge.md) and a scroll of [warding wind](Mechanics/spells/warding-wind-xge.md) (see appendix B for descriptions of both spells) in a wooden case in one of their tents.
...
The humans are two [Eternal Flame priests](Mechanics/bestiary/humanoid/eternal-flame-priest-pota.md) (see chapter 7) claiming to be Aylbrith and Ingulf, posing as druids of the Circle of the Scarlet Moon. They have a captured [brown bear](Mechanics/bestiary/beast/brown-bear.md) with them to improve their disguise. They warmly greet visitors who aren't obviously hostile, asking questions to determine the characters' reason for visiting Scarlet Moon Hall.
...
The humans, Storol and Wiglaf, are [werewolves](Mechanics/bestiary/humanoid/werewolf.md). They are here because they want to know what the druids are up to. They think the Rite of the Wicker Giant is real.
...
These people are an [Eternal Flame priest](Mechanics/bestiary/humanoid/eternal-flame-priest-pota.md) and three [Eternal Flame guardians](Mechanics/bestiary/humanoid/eternal-flame-guardian-pota.md) (see chapter 7 for both). The priest—a half-elf named Lytin—looks like a druid and tries to do all the talking. Her guardians—Biart, Orm, and Malin—look like rangers, and they become more nervous the longer any conversation lasts.
...
This camp has a real [druid](Mechanics/bestiary/humanoid/druid.md), Gariena, and two [sprites](Mechanics/bestiary/fey/sprite.md) named Flix and Afid. They are here to contribute to the rite. Gariena has a sense of anticipation, but she wonders why she never heard of the Rite of the Wicker Giant. She also wonders why the preparations are taking so long.
...
Gariena has a coinpurse with 40 sp and 18 gp in it, plus she wears a silver ring worth 25 gp and carries a scroll of [lesser restoration](Mechanics/spells/lesser-restoration.md) and a scroll of [skywrite](Mechanics/spells/skywrite-xge.md) (see appendix B). If the characters earn her favor, she gives them her scrolls as gifts to help them in their struggle against the cults of Elemental Evil.
...
The three sleeping [druids](Mechanics/bestiary/humanoid/druid.md)—Comnall, Murcadh, and Ragnad—wake if the characters approach openly. The fourth person is Sauruki, a [Crushing Wave priest](Mechanics/bestiary/humanoid/crushing-wave-priest-pota.md) (see chapter 7) sent by the water cult to figure out what the fire cult is up to here. They're suspicious about strangers, but Sauruki is curious about who the characters are.
...
The hooded figures are three [bugbears](Mechanics/bestiary/humanoid/bugbear.md), accompanied by two [worgs](Mechanics/bestiary/monstrosity/worg.md). Until recently, this camp was occupied by druids who didn't pass muster with the fire cult and were fed to the wicker giant. The bugbears are trying to look like druids from a distance until the other camps are cleared out. Knowing they aren't going to fool anyone at close range, they attack immediately.

#### Reinforcements

Camp Hc6 arrives first. The druids aren't sure who to fight at first, though the characters can sway them with a successful DC 10 Charisma ([Persuasion](Mechanics/Rules/skills.md#Persuasion)) check.
...
Bound in the wicker giant is a [fire elemental](Mechanics/bestiary/elemental/fire-elemental.md). It remains quiescent until the tower scaffolding starts to collapse, the priests beckon it forth (see area H1), or the characters damage the wicker giant.
...
Two [hell hounds](Mechanics/bestiary/fiend/hell-hound.md) and one [Eternal Flame guardian](Mechanics/bestiary/humanoid/eternal-flame-guardian-pota.md) (see chapter 7) stand guard here.

### H4. Scaffolding

The tower scaffolding is 30 feet high and equally as long. It is easy to climb and has a walkway about every 7 feet up. Two [Eternal Flame guardians](Mechanics/bestiary/humanoid/eternal-flame-guardian-pota.md) (see chapter 7) cover the courtyard from their perches on the scaffolding, preferring not to get drawn into melee combat.
...
The door to this chamber is reachable only from the top of the scaffolding. The tower wall is rough fieldstone, so it can be climbed with successful DC 10 Strength ([Athletics](Mechanics/Rules/skills.md#Athletics)) checks.
...
Unless they joined the battle in area H2, two [Eternal Flame guardians](Mechanics/bestiary/humanoid/eternal-flame-guardian-pota.md) (see chapter 7) are here, accompanied by an [azer](Mechanics/bestiary/elemental/azer.md) who's acting as an envoy between [Vanifer](Mechanics/bestiary/npc/vanifer-pota.md) and Elizar. They're eager to lure enemies near the hole in the floor, then push them to drop 20 feet into area H6.
...
Rubble covers what was once the main entrance to the tower, but five [magmins](Mechanics/bestiary/elemental/magmin.md) are burning away the debris to make the tunnel in the northern floor larger. They attack anyone who doesn't look like a fire cultist.
...
If they haven't been disturbed, one [Eternal Flame priest](Mechanics/bestiary/humanoid/eternal-flame-priest-pota.md) and two [Eternal Flame guardians](Mechanics/bestiary/humanoid/eternal-flame-guardian-pota.md) (see chapter 7 for both) are asleep when the characters arrive.

#### Reinforcements

If [Elizar Dryflagon](Mechanics/bestiary/npc/elizar-dryflagon-pota.md) is in area H8 and hears a disturbance in this room, he joins the battle as soon as he can.
...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/PotA/038-poa03-10.webp#center)
...
In Elizar's desk are 250 gp, two fire opals (worth 50 gp each), and a scroll of [flame arrows](Mechanics/spells/flame-arrows-xge.md) (see appendix B).
...
Four [giant bats](Mechanics/bestiary/beast/giant-bat.md) roost here. Fire cultists periodically burn them out, but others return within a tenday. The bats are hungry and aggressive, so they attack anyone who comes through the trapdoor.
