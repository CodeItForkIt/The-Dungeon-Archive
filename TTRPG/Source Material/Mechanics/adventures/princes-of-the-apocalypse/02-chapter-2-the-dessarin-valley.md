...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/PotA/013-poa02-01.webp#center)
...
> [!gallery]
> ![Map 2.1: Red Larch](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/PotA/014-02-02.webp#gallery)
> ![Player Version](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/PotA/015-poa1.webp#gallery)
...
The proprietor of the Swinging Sword is Kaylessa Irkell (female Illuskan human [commoner](Mechanics/bestiary/humanoid/commoner.md)). She is the fortyish matriarch of her family and a pleasant, sturdy woman. She is increasingly worried about "what's gathering in the dark" in Red Larch and brings up her concerns with any likely adventurers who stop by (see "Kaylessa's Tale," below).

Kaylessa's staff are uniformly attentive and good at their work. However, two have secret masters. Ghileeda (female Tethyrian human [commoner](Mechanics/bestiary/humanoid/commoner.md)), a maid, secretly reports to Justran Daehl at the Helm for the Cult of the Crushing Wave. The one-eyed stablemaster Iraun Thelder (male Tethyrian human [guard](Mechanics/bestiary/humanoid/guard.md)), a onetime mercenary warrior, is a spy for the Cult of the Howling Hatred. Iraun is entirely passive; he just reports what his normal duties show him.
...
The Helm is run by the jovial but grasping Garlen Harlathurl (male Tethyrian human [commoner](Mechanics/bestiary/humanoid/commoner.md)). He is a cynic bitter from failed Waterdhavian mercantile ventures, but he has turned out to be an attentive tavern-keeper. He has two partners: one has retired to Waterdeep, and the other is the cellarer of the Helm, the gruff and rotund Justran Daehl (male Tethyrian human [bandit](Mechanics/bestiary/humanoid/bandit.md)). Justran is secretly a spy for the Cult of the Crushing Wave.

##### Rumors of Evil

One of the tavern denizens is a very drunk and argumentative caravan guard named Zomith (female half-orc [guard](Mechanics/bestiary/humanoid/guard.md)). She recently quit a caravan that came from Beliard through Westbridge, arriving in Red Larch two days ago. The caravan continued south without Zomith, but she can confirm that she brawled with Mirabaran guards from the missing delegation about fifteen days ago. She couldn't care less what happened to them, but she had nothing to do with their disappearance.

##### Trouble in Red Larch

Stannor Thistlehair (male lightfoot halfling [commoner](Mechanics/bestiary/humanoid/commoner.md)) is a carpenter who works at Waelvur's Wagonworks (area 16). Stannor is a sneaky and unpleasant fellow, but if bribed to talk (10 gp would do the job), he tells the characters that he's seen his boss Ilmeth Waelvur disappear into a hidden tunnel in the back of the work yard. He's also seen other people sneak in after dark and follow Ilmeth to wherever they go, although everyone else shows up hooded or masked.

![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/PotA/016-poa02-03.webp#center)
...
The burly Thorsk Thelorn and the taller but thinner Asdan Thelorn (both male Illuskan human [commoners](Mechanics/bestiary/humanoid/commoner.md)) are the bosses here. They are fair, hard-working men who pay well to keep good workers.
...
The thin, energetic proprietor, Mangobarl Lorren (male Chondathan human [thug](Mechanics/bestiary/humanoid/thug.md)), thrives on gossip and can spin many wild tales. Few are true, and none of the secrets are his own. He is a staunch, discreet ally of the Zhentarim and a useful source of no-questions-asked aid to anyone of that faction. Lorren doesn't volunteer this information, but some of his distant relatives have Zhentarim connections, and he's always willing to help the Black Network.
...
The proprietor and owner, Nahaeliya Drouth (female Tethyrian human [commoner](Mechanics/bestiary/humanoid/commoner.md)), has built up her business by becoming a trusted supplier to inns across the valley. She prefers not to know about "the dangers of the wilderlands" and "such nonsense as dark magic." Nahaeliya inherited the business from her father, who was a respected town elder, but she hasn't yet been approached for membership in the Believers.

#### 11. Jalessa Ornra, Butcher

Next door to Drouth's Fine Poultry stand four identical single-story stone buildings, running back from the street in a line. The front building has a painted sign of a ham being carved by a cleaver, accompanied by no words. This is the workplace and shop of Jalessa Ornra (female Illuskan human [commoner](Mechanics/bestiary/humanoid/commoner.md)), Red Larch's butcher. The second building is her smokehouse, joined to the shop by an underground cold-cellar where meats are stored. The third building often has wash hanging by clothesline outside, and is the home Jalessa shares with the town's constable, Harburk Tuthmarillar (male Tethyrian human [veteran](Mechanics/bestiary/humanoid/veteran.md)).

Red Larch doesn't have a jail or court. The shop is the closest thing. Harburk employs four trusties, who bunk in the fourth building. The trusties are assistant constables (human [guards](Mechanics/bestiary/humanoid/guard.md)) who also work for Jalessa as cutters and preservers, brining and salting meat, then sealing it into small kegs for shipment or storage.
...
Originally from Amn, Haeleeya Hanadroum (female human Tethyrian [commoner](Mechanics/bestiary/humanoid/commoner.md)) operates a bathhouse and dress shop in her large, well-appointed home. Half-barrels planted with aromatic herbs and flowers flank the entrance, and the windows are decorated with flower-filled window boxes. Inside is a tidy room that functions as a dressmaker's shop and fitting room. Beyond two sets of doors are bathing chambers that emanate pleasant smells and warm dampness.
...
This seedy wooden building serves as Red Larch's used tools and goods shop, its barber, and an unofficial second tavern for locals. Inside is a cluttered shop full of lounging customers—most of them men in no particular hurry to be waited on—with old hair clippings trodden underfoot on the sagging board floor. Marlandro Gaelkur (male Tethyrian human [commoner](Mechanics/bestiary/humanoid/commoner.md)) is the shopkeeper and barber. In addition to providing grooming, he deals in used (and sometimes shady) items with no questions asked.
...
The proprietor is Ulhro Luruth (male Chondathan human [commoner](Mechanics/bestiary/humanoid/commoner.md)). He can't smell a thing, thanks to years of working in tanneries. He and his five loyal, terse assistants live and work here.
...
Four identical, well-built warehouses stand here in ground covered in raked gravel and cinders. The moment anyone sets foot past the sign that says "Bethendur's Storage/Rent Space by tenday, month, or year," a tall, smiling man emerges to meet them. This is Aerego Bethendur (male Tethyrian human [noble](Mechanics/bestiary/humanoid/noble.md)). He is assisted by three burly clerks and porters, who are former mercenary thugs.
...
On the other nine days of the tenday, only one Red Larcher is here, a half-orc named Grund. Grund (male half-orc [thug](Mechanics/bestiary/humanoid/thug.md)) is the village simpleton. He ekes out a living by making pickles in vats at the end of the field.
...
Endrith Vallivoe (male Tethyrian human [commoner](Mechanics/bestiary/humanoid/commoner.md)) is a retired caravan merchant who sells new and used goods: furniture, lamps, carpets, mirrors, weapons, shields, helms, and a little bit of everything else. Almost anything might be available to buy here, buried under heaps of other stuff, and Vallivoe carries a good running inventory in his head. He's the only vendor in town selling blank books and parchment.
...
Check for a random encounter in the morning, afternoon, evening, and midnight. Roll ``; an encounter occurs on an 18 or higher.
...
|    |    |    |
|----|----|----|
| 2 | — | [Aarakocra](Mechanics/bestiary/humanoid/aarakocra.md) scouts* |
| — | 2 | `1d4 + 1` [jackalweres](Mechanics/bestiary/humanoid/jackalwere.md) |
| 3 | — | Knights of Samular* |
| 4 | 3 | Pilgrims* |
| — | 4 | `1d2` [owlbears](Mechanics/bestiary/monstrosity/owlbear.md) |
| 5 | 5 | Elk tribe hunters* |
| 6 | 6 | `1d3` [ankhegs](Mechanics/bestiary/monstrosity/ankheg.md) |
| 7 | 7 | `1d3 + 1` [bugbears](Mechanics/bestiary/humanoid/bugbear.md) |
| 8 | 8 | `1d4 + 1` [orcs](Mechanics/bestiary/humanoid/orc.md) |
| 9 | — | Dwarf miners* |
| 10 | — | Caravan* |
| 11 | — | Homestead* |
...
| 16 | 13 | `1d4 + 1` [gnolls](Mechanics/bestiary/humanoid/gnoll.md) |
| 17 | — | Shepherds* |
| 18 | 14 | `1d6 + 2` [wolves](Mechanics/bestiary/beast/wolf.md) |
| 19 | 15 | `1d3` [ogres](Mechanics/bestiary/giant/ogre.md) |
| — | 16 | `1d2` [gargoyles](Mechanics/bestiary/elemental/gargoyle.md) |
| — | 17 | `1d3 + 1` [ghouls](Mechanics/bestiary/undead/ghoul.md) |
| 20 | 18 | `1d2` [perytons](Mechanics/bestiary/monstrosity/peryton.md) |
| — | 19 | `1d3` [wights](Mechanics/bestiary/undead/wight.md) |
...
|    |    |
|----|----|
| 2–3 | [Aarakocra](Mechanics/bestiary/humanoid/aarakocra.md) scouts* |
| 4–5 | Air cult skyriders* |
| 6–9 | River pirates* |
| 10–14 | Keelboat* |
| 15–16 | `1d4` [merrow](Mechanics/bestiary/monstrosity/merrow.md) |
| 17–18 | `2d4` [ghouls](Mechanics/bestiary/undead/ghoul.md) |
| 19–20 | 1 [water elemental](Mechanics/bestiary/elemental/water-elemental.md) |

#### Later Travels

|    |    |    |
|----|----|----|
| 2 | — | [Aarakocra](Mechanics/bestiary/humanoid/aarakocra.md) war band* |
| — | 2 | `2d6` [jackalweres](Mechanics/bestiary/humanoid/jackalwere.md) |
| 3 | 3 | `1d3` [manticores](Mechanics/bestiary/monstrosity/manticore.md) |
| 4 | 4 | `1d3 + 1` [trolls](Mechanics/bestiary/giant/troll.md) |
| 5 | 5 | Elk tribe hunters* |
| — | 6 | `1d8` [will-o'-wisps](Mechanics/bestiary/undead/will-o-wisp.md) |
| 6 | — | Knights of Samular* |
| 7 | — | Homestead* |
| — | 7 | `1d2` [ghasts](Mechanics/bestiary/undead/ghast.md) and `1d4 + 2` [ghouls](Mechanics/bestiary/undead/ghoul.md) |
| 8 | 8 | `1d4 + 1` [gargoyles](Mechanics/bestiary/elemental/gargoyle.md) |
| 9 | 9 | Air cult skyriders* |
| 10 | 10 | Water cult raiders* |
| 11 | 11 | `1d6 + 2` [bugbears](Mechanics/bestiary/humanoid/bugbear.md) |
| 12 | 12 | Fire cult war band* |
| 13 | 13 | Earth cult marauders* |
| 14 | 14 | `2d4` [ogres](Mechanics/bestiary/giant/ogre.md) |
| 15 | — | Caravan* |
| — | 15 | `1d4 + 1` [wights](Mechanics/bestiary/undead/wight.md) |
| 16 | 16 | `2d4` mephits* |
| 17 | — | Dwarf miners* |
| — | 17 | `1d3` [vampire spawn](Mechanics/bestiary/undead/vampire-spawn.md) |
| 18 | 18 | `1d3` elementals* |
| 19 | 19 | 1 [bulette](Mechanics/bestiary/monstrosity/bulette.md) |
| 20 | 20 | `1d2` [hill giants](Mechanics/bestiary/giant/hill-giant.md) |

##### Aarakocra Scouts

These `1d4 + 1` [aarakocra](Mechanics/bestiary/humanoid/aarakocra.md) attack those who appear to be elemental cultists. Otherwise, the aarakocra might be helpful.

##### Aarakocra War Band

A war band consists of `1d6 + 3` [aarakocra](Mechanics/bestiary/humanoid/aarakocra.md) and an [air elemental](Mechanics/bestiary/elemental/air-elemental.md). They interact like the scouts, above.

##### Air Cult Scouts

A group of scouts for the air cult consists of `1d4 + 1` [hurricanes](Mechanics/bestiary/humanoid/hurricane-pota.md) in [wingwear](Mechanics/items/wingwear-pota.md). See chapter 7 for the cultists' statistics and [wingwear](Mechanics/items/wingwear-pota.md) description.

##### Air Cult Skyriders

One [Feathergale knight](Mechanics/bestiary/humanoid/feathergale-knight-pota.md) leads `1d4` [skyweavers](Mechanics/bestiary/humanoid/skyweaver-pota.md). They all ride [giant vultures](Mechanics/bestiary/beast/giant-vulture.md). See chapter 7 for the cultists' statistics

##### Caravan

A caravan consists of a merchant and his or her entourage heading for the nearest settlement. The group consists of `1d4 + 2` [guards](Mechanics/bestiary/humanoid/guard.md), `2d4` [commoners](Mechanics/bestiary/humanoid/commoner.md), and the caravan leader (a spy).

##### Dwarf Miners

A band of dwarf miners consists of `1d4 + 1` shield dwarf [scouts](Mechanics/bestiary/humanoid/scout.md) and a pugnacious leader (a shield dwarf [thug](Mechanics/bestiary/humanoid/thug.md)).

##### Earth Cult Marauders

A band of marauders for the earth cult consists of `1d4 + 1` [Black Earth guards](Mechanics/bestiary/humanoid/black-earth-guard-pota.md), a [Black Earth priest](Mechanics/bestiary/humanoid/black-earth-priest-pota.md), and `1d4`−1 [ogres](Mechanics/bestiary/giant/ogre.md). See chapter 7 for the cultists' statistics.

##### Earth Cult Robbers

These earth cult robbers stake out spots to waylay passersby. The group consists of `1d4 + 1` [bandits](Mechanics/bestiary/humanoid/bandit.md) and `1d4` [Black Earth guard](Mechanics/bestiary/humanoid/black-earth-guard-pota.md)s (see chapter 7).

##### Elementals

A small group of elementals wanders freely. Roll a `d4` to determine the type of elementals: 1, [air](Mechanics/bestiary/elemental/air-elemental.md); 2, [earth](Mechanics/bestiary/elemental/earth-elemental.md); 3, [fire](Mechanics/bestiary/elemental/fire-elemental.md); 4, [water](Mechanics/bestiary/elemental/water-elemental.md).

##### Elk Tribe Hunters

This group includes a [berserker](Mechanics/bestiary/humanoid/berserker.md) and `1d4 + 1` [tribal warriors](Mechanics/bestiary/humanoid/tribal-warrior.md). They are hostile (see "The Uthgardt Tribes" section at the end of this chapter).

##### Fire Cult Raiders

The fire cult sends out raiders that include `2d6` [Eternal Flame guardians](Mechanics/bestiary/humanoid/eternal-flame-guardian-pota.md) and an [Eternal Flame priest](Mechanics/bestiary/humanoid/eternal-flame-priest-pota.md). See chapter 7 for the cultists' statistics.

##### Fire Cult War Band

A war band of the fire cult consists of `1d6` [Eternal Flame guardians](Mechanics/bestiary/humanoid/eternal-flame-guardian-pota.md), an [Eternal Flame priest](Mechanics/bestiary/humanoid/eternal-flame-priest-pota.md), and `1d3` [hell hounds](Mechanics/bestiary/fiend/hell-hound.md). See chapter 7 for the cultists' statistics.

##### Homestead

The party discovers a homestead. Roll a `d6` to determine the race of the people there: 1–3, Tethyrian human; 4, Illuskan human; 5–6, halfling. A homestead consists of `1d6` adult [commoners](Mechanics/bestiary/humanoid/commoner.md) and `1d6`−1 noncombatant children. Residents might provide friendly adventurers with food and shelter.

##### Keelboat

A river trader's keelboat carries `1d4 + 4` [commoners](Mechanics/bestiary/humanoid/commoner.md) (the sailors), `1d4` [guards](Mechanics/bestiary/humanoid/guard.md), and a captain (a [spy](Mechanics/bestiary/humanoid/spy.md)). They are willing to offer passage to adventurers heading in the same direction.

##### Knights of Samular

This armed patrol consists of `1d4` [veterans](Mechanics/bestiary/humanoid/veteran.md) and `1d4` [guards](Mechanics/bestiary/humanoid/guard.md). They hail from Summit Hall and offer a hearty "Well met!" to the characters.

##### Mephits

Several mephits travel in a pack. Roll a `d6` to determine the mephit type: 1, [dust](Mechanics/bestiary/elemental/dust-mephit.md); 2, [ice](Mechanics/bestiary/elemental/ice-mephit.md); 3, [magma](Mechanics/bestiary/elemental/magma-mephit.md); 4, [mud](Mechanics/bestiary/elemental/mud-mephit.md); 5, [smoke](Mechanics/bestiary/elemental/smoke-mephit.md); 6, [steam](Mechanics/bestiary/elemental/steam-mephit.md).

##### Pilgrims

A group of pilgrims includes `2d6` [commoners](Mechanics/bestiary/humanoid/commoner.md), `1d4 + 1` [guards](Mechanics/bestiary/humanoid/guard.md), `1d4` [acolytes](Mechanics/bestiary/humanoid/acolyte.md), and a [priest](Mechanics/bestiary/humanoid/priest.md) bound for a holy or special site. They're happy for company.

##### River Pirates

A keelboat carries `2d4` [bandits](Mechanics/bestiary/humanoid/bandit.md), `1d4` [thugs](Mechanics/bestiary/humanoid/thug.md), and a pirate captain (a [bandit captain](Mechanics/bestiary/humanoid/bandit-captain.md)).

##### Shepherds

A group of shepherds watch over herd animals. Roll a `d6` to determine the shepherds' race: 1–4, human; 5–6, halfling. The group consists of `1d4` [commoners](Mechanics/bestiary/humanoid/commoner.md) and `1d2` leaders (scouts).

##### The Watchful Knight

Once, this [helmed horror](Mechanics/bestiary/construct/helmed-horror.md) stood watch in the common room of the Inn of the Watchful Knight in Beliard. It chooses one character at random, advances to within 5 feet, then studies the target for several seconds. If attacked, it fights back, retreating after it loses half its hit points. Otherwise, it follows the chosen character for `1d3` days, guarding its temporary master in combat. At the end of that time the helmed horror wanders off again.

##### Water Cult Marauders

A marauder gang of the water cult consists of `2d6` [Crushing Wave reavers](Mechanics/bestiary/humanoid/crushing-wave-reaver-pota.md), a [Crushing Wave priest](Mechanics/bestiary/humanoid/crushing-wave-priest-pota.md), and `1d2` [fathomers](Mechanics/bestiary/humanoid/fathomer-pota.md). See chapter 7 for the cultists' statistics.

##### Water Cult Raiders

A group of raiders from the water cult includes `2d6` [Crushing Wave reavers](Mechanics/bestiary/humanoid/crushing-wave-reaver-pota.md), a [Crushing Wave priest](Mechanics/bestiary/humanoid/crushing-wave-priest-pota.md), and a [one-eyed shiver](Mechanics/bestiary/humanoid/one-eyed-shiver-pota.md). The leader is a [Dark Tide knight](Mechanics/bestiary/humanoid/dark-tide-knight-pota.md) mounted on a [giant crocodile](Mechanics/bestiary/beast/giant-crocodile.md). See chapter 7 for the cultists' statistics.
...
> [!gallery]
> ![Map 2.2: The Dessarin Valley](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/PotA/018-poa2-errata.webp#gallery)
> ![Player Version](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/PotA/019-poa2.webp#gallery)
...
Bargewright Inn fell under Zhentarim influence a few years ago. Any member or ally of that faction can find a discreet welcome (and few or low fees) within its walls. The Zhentarim spy on everyone, even each other (or as one merchant put it, "especially each other"). Bargewright Inn is ruled by a plutocracy of business owners, most of whom are in the pockets of the Zhentarim. The unofficial leader is Chalaska Muruin (female Damaran human [veteran](Mechanics/bestiary/humanoid/veteran.md)), the terse, cold-eyed "Senior Sword" and master of the gate guards.

The largest inn, The Old Bargewright, was recently rebuilt as a substantial stone structure with thick walls, secret passages, and private chambers separated from nearby rooms by sealed-off passages. Innkeeper Nalaskur Thaelond (male half-elf [spy](Mechanics/bestiary/humanoid/spy.md)) keeps careful watch over who comes and goes from his inn; it's where Zhentarim meet to broker deals in commerce illicit in Waterdeep, such as smuggled goods, poisons, and certain magic.
...
This is the camp of water cult reavers, described in the "Early Investigations" section of chapter 3. The camp is here only until the characters defeat Jolliver Grimjaw (chapter 3) or [Gar Shatterkeel](Mechanics/bestiary/npc/gar-shatterkeel-pota.md) (chapter 4).
...
Now run by Abbot Ellardin Darovik (male Tethyrian human [priest](Mechanics/bestiary/humanoid/priest.md)), Goldenfields is a stronghold of the Emerald Enclave. Members of that faction are as welcome here as clergy of Chauntea; many of them stay for months at a time to help with the work and the vigilant defense of the farm against insects and blights, as well as would-be vandals and plunderers. Hired adventurers patrol the walls and the land immediately around them, watching for anyone approaching. More than five thousand people live and work in Goldenfields year round, farming more than twenty square miles of tillage in gangs of hard-working gardeners.
...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/PotA/020-poa02-06.webp#center)
...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/PotA/021-poa02-07.webp#center)
...
Summit Hall was established long ago as a fortified monastery by the Knights of Samular, an order dedicated to Tyr, god of justice. A paladin of Tyr named Samular Caradoon founded the order and its monastery. A tomb within the monastery contains Samular's remains as well as the phylactery of his brother, [Renwick](Mechanics/bestiary/npc/renwick-pota.md) Caradoon, who dwells in the Sacred Stone Monastery (see "Haunted Keeps" above) as a lich.

Lady Ushien Stormbanner (female Tethyrian human [knight](Mechanics/bestiary/humanoid/knight.md) of Tyr) oversees Summit Hall. Veterans, many of them scarred and grim, train novices and instruct them in the moral "Rule of the Knights" (an extensive series of "in this situation, a knight shall do this" guidelines). Life here is very regimented. The occupants of Summit Hall grow their own food and keep perpetual watch over nearby lands. They are always ready for battle, and fully armed and armored if encountered outside their walls.
...
The current lord protector is a good-natured Harper and ex-adventurer named [Darathra Shendrel](Mechanics/bestiary/npc/darathra-shendrel-pota.md) (female Tethyrian human [knight](Mechanics/bestiary/humanoid/knight.md)), known for the excellent wine she makes. Darathra enacts and modifies local laws (known as "The Lord's Decree"), which are then enforced by "The Twelve," a dozen mounted [veterans](Mechanics/bestiary/humanoid/veteran.md) drawn from the militia to serve in a tenday cycle.
...
A village strung out along the Long Road between Red Larch and Triboar, Westbridge is home to the Harvest Inn, which stands on the west side of the Long Road facing the wagon road from the Stone Bridge. The inn is run by the affable Herivin Dardragon (male halfling [commoner](Mechanics/bestiary/humanoid/commoner.md)), a curly-haired collector and reseller of paintings and statuettes of questionable taste.
...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/PotA/022-poa02-08.webp#center)
