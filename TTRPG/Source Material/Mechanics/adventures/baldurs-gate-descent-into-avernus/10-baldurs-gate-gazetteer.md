...
|----------|--------------|-------|
| Upper City | `2d4` minutes | `2d4` Watch [guards](Mechanics/bestiary/humanoid/guard.md) |
| Lower City | `4d6` minutes | `2d4` Flaming Fist [veterans](Mechanics/bestiary/humanoid/veteran.md) |
| Outer City | `6d8` minutes | `2d6` Flaming Fist [guards](Mechanics/bestiary/humanoid/guard.md) |
^guard-arrival-times
...
| 3 | The guards already have `1d6` [thugs](Mechanics/bestiary/humanoid/thug.md) with them from a prior arrest and don't want to deal with another problem. |
| 4 | The guards make arrests, but are called away mid process and let everyone go. |
| 5 | The guards merely walk by, as they're already escorting a patriar ([noble](Mechanics/bestiary/humanoid/noble.md)). |
...
> 
> **Livestock Restriction.** By tradition, Baldur's Gate bans animals larger than a [peacock](Mechanics/bestiary/beast/peacock-bgdia.md) within the city walls. Visitors determined not to surrender their beloved pets (or valuable animals they intend to sell) sometimes arrive at the city with large peacocks in tow, to prove their furred companion meets the legal requirement. This has led to a burgeoning, noisy, and particularly cutthroat [peacock](Mechanics/bestiary/beast/peacock-bgdia.md)-breeding industry in the Outer City.
> 
...
> 
> **Vanthampur** specializes in civic engineering under the purview of family matriarch [Duke Thalamra Vanthampur](Mechanics/bestiary/npc/duke-thalamra-vanthampur-bgdia.md).
> 
...
![Murderous servants of the ...](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/BGDIA/111-2brwh-06-04-2k.webp#center "Murderous servants of the Dead Three corner their prey near the statue of Minsc and Boo.")
...
Some commoners claim that something about the city itself sparks violence in its citizens. A popular theory is that the spirits of the vicious pirates that once sailed the harbors still influence the city. Another is that the spirit of the long-executed serial murderer Alhasval Drenz, the Whitkeep Whistler, still stalks the city, possessing innocents to continue her unmatched killing spree. This adventure posits a third possibility: that the presence of the [Shield of the Hidden Lord](Mechanics/items/shield-of-the-hidden-lord-bgdia.md) fuels the avarice and ambitions of evil-minded folk in Baldur's Gate. This magic item lies in a vault under Vanthampur Villa (see chapter 1) and has a pit fiend trapped inside it (see "Shield of the Hidden Lord"). Were the shield to be taken from the city, the murder rate might drop suddenly.
...
East of the city, high above the scattered slums and cut-rate inns that stretch along the trade road, rises the steep yellow granite of Dusthawk Hill. This cliff-skirted hill is one of the last known refuges of the Chionthar dusthawk (use the [hawk](Mechanics/bestiary/beast/hawk.md) statistics), a once-common raptor whose numbers precipitously declined over the last century as regional turmoil and the ever-spreading slums outside Baldur's Gate consumed its habitat.
...
| dice: d10 | Denizens |
|-----------|----------|
| 1 | `2d4` Watch [guards](Mechanics/bestiary/humanoid/guard.md) who demand to see strangers' passage tokens |
| 2 | `1d4` [acolytes](Mechanics/bestiary/humanoid/acolyte.md) of Gond or Tymora |
| 3 | `2d6` patriar servants ([commoners](Mechanics/bestiary/humanoid/commoner.md)) on errands |
| 4 | 1 patriar (human [noble](Mechanics/bestiary/humanoid/noble.md)) and 6 personal bodyguards ([veterans](Mechanics/bestiary/humanoid/veteran.md)) |
| 5 | `1d4 + 1` entitled young patriars (human [nobles](Mechanics/bestiary/humanoid/noble.md)), each with one personal bodyguard ([thug](Mechanics/bestiary/humanoid/thug.md)) |
| 6 | `1d6` visiting dignitaries ([nobles](Mechanics/bestiary/humanoid/noble.md)) and `2d4` [guards](Mechanics/bestiary/humanoid/guard.md) |
| 7 | `1d4` High Hall messengers ([scouts](Mechanics/bestiary/humanoid/scout.md)) |
| 8 | `2d4` entertainers ([commoners](Mechanics/bestiary/humanoid/commoner.md)) |
| 9 | 1 Flaming Fist officer ([knight](Mechanics/bestiary/humanoid/knight.md)) and `2d4` Flaming Fist soldiers ([veterans](Mechanics/bestiary/humanoid/veteran.md)) |
| 10 | `1d4` [commoners](Mechanics/bestiary/humanoid/commoner.md) who shouldn't be in the Upper City |
^table-b-upper-city-denizens
...
| dice: d10 | Threat |
|-----------|--------|
| 1 | `1d4` [imps](Mechanics/bestiary/fiend/imp.md) disguised as ravens |
| 2 | 1 [gargoyle](Mechanics/bestiary/elemental/gargoyle.md) in the service of the Guild |
| 3 | `1d6` [giant centipedes](Mechanics/bestiary/beast/giant-centipede.md) from the sewers |
| 4 | `1d4` suits of [animated armor](Mechanics/bestiary/construct/animated-armor.md) that escaped from the High House of Wonders |
| 5 | 1 [ochre jelly](Mechanics/bestiary/ooze/ochre-jelly.md) in a sewer grate |
...
| 8 | `1d4` [doppelgangers](Mechanics/bestiary/monstrosity/doppelganger.md) |
| 9 | 1 serial killer ([assassin](Mechanics/bestiary/humanoid/assassin.md)) wanted by the Watch |
| 10 | `2d4` [kenku](Mechanics/bestiary/humanoid/kenku.md) muggers in league with the Guild |
^table-c-upper-city-threats
...
The four Eomane siblings are notorious throughout the Upper City for the scandalous masked revels hosted at their manor. Nysene Eomane, a lawful evil female human [noble](Mechanics/bestiary/humanoid/noble.md), likes to extend invitations to hopeful social climbers from other districts, intending to trap them at her parties. Lacking Watch tokens, Nysene's guests face a night in the Citadel's cells or worse if they're caught in the Upper City after dark. They therefore have little choice but to let her and her friends make cruel sport of them until they can escape at daybreak. As yet, none of Nysene's playthings have suffered any real harm, but her games grow ever bolder and more vicious, and it's only a matter of time until someone is seriously hurt.
...
| dice: d10 | Denizens |
|-----------|----------|
| 1 | `2d6` gang members or pirates (both [thugs](Mechanics/bestiary/humanoid/thug.md)) |
| 2 | `1d4 + 1` crass merchants ([commoners](Mechanics/bestiary/humanoid/commoner.md)) |
| 3 | `1d6` [kenku](Mechanics/bestiary/humanoid/kenku.md) minding their own business |
| 4 | `3d6` angry crew members ([commoners](Mechanics/bestiary/humanoid/commoner.md)) protesting the Flaming Fist's brutality |
| 5 | `2d4` Flaming Fist soldiers ([veterans](Mechanics/bestiary/humanoid/veteran.md)) on patrol |
| 6 | `1d4` Guild pickpockets ([spies](Mechanics/bestiary/humanoid/spy.md)) |
| 7 | `1d8` beggars ([commoners](Mechanics/bestiary/humanoid/commoner.md)) |
| 8 | 1 Baldur's Mouth reporter ([commoner](Mechanics/bestiary/humanoid/commoner.md)) |
| 9 | `1d4` patriars ([nobles](Mechanics/bestiary/humanoid/noble.md)) and `3d6` bodyguards ([thugs](Mechanics/bestiary/humanoid/thug.md)) |
| 10 | 1 Guild kingpin ([bandit captain](Mechanics/bestiary/humanoid/bandit-captain.md)) and `2d6` operatives ([bandits](Mechanics/bestiary/humanoid/bandit.md)) |
^table-e-lower-city-denizens
...
| dice: d10 | Threat |
|-----------|--------|
| 1 | `1d4` [swarms of rats](Mechanics/bestiary/beast/swarm-of-rats.md) |
| 2 | `1d4` [invisible](Mechanics/Rules/conditions.md#Invisible) [imps](Mechanics/bestiary/fiend/imp.md) |
...
| 5 | Press gang of `1d4 + 1` [half-ogres](Mechanics/bestiary/giant/half-ogre-ogrillon.md) |
| 6 | `1d6` Guild operatives ([spies](Mechanics/bestiary/humanoid/spy.md)) |
| 7 | `2d4` street brawlers ([thugs](Mechanics/bestiary/humanoid/thug.md)) |
| 8 | `1d6` Flaming Fist mercenaries ([veterans](Mechanics/bestiary/humanoid/veteran.md)) who don't like the look of adventurers |
| 9 | 1 [ghost](Mechanics/bestiary/undead/ghost.md) from Harborside Hospital |
| 10 | `1d4` [mimics](Mechanics/bestiary/monstrosity/mimic.md) posing as cargo |
^table-f-lower-city-threats
...
In secret, the Candulhallows have grown quietly rich off a variety of death-related scams. Chief among these is a secret smuggling arrangement with [Nine-Fingers Keene](Mechanics/bestiary/npc/nine-fingers-keene-bgdia.md) to conceal contraband in corpses' funeral wrappings, which the guards and toll collectors never check. Even less savory is the harvesting and sale of corpses or their parts for the city's cultists and necromancers. Chief among these latter customers is the family matriarch, Leylenna Candulhallow, a neutral evil female moon elf [mage](Mechanics/bestiary/humanoid/mage.md) who takes the choicest and rarest of the deceased for her experiments, replacing them with pauper's corpses and weighted coffins. Should any of the family's misdealing come to light, it would doubtlessly shock the city to the core and potentially force Leylenna to reveal the elaborate necromantic masterpiece—an evolution of both art and life—that she's been slowly patching together for months in her basement.
...
This four-story stone structure constantly streams smoke of unusual colors from various vents and chimneys. From the elaborate showroom spanning the bottom two floors, alchemist Avery Sonshal (neutral male human [mage](Mechanics/bestiary/humanoid/mage.md)) maintains his family's longstanding monopoly on [smokepowder](Mechanics/items/smokepowder-wdh.md) production in Baldur's Gate.

While [smokepowder](Mechanics/items/smokepowder-wdh.md) is reserved for the Council of Four and Gond's High House of Wonders, the shop sells a variety of lesser alchemical items to the public, from torches with colored flames to smoke grenades and fireworks, some of them enhanced with harmless illusions. While the windowless workshop filling the building's upper two stories is strictly off-limits, its stairwell blocked by a massive iron vault door and a [thug](Mechanics/bestiary/humanoid/thug.md) hired from the Bannerless Legion, the mutton-chopped Avery is usually happy to chat with customers and other alchemical enthusiasts on the lower floors.

At the moment, however, Avery is visibly troubled. Recently, someone managed to break into the upper workshop while he was sleeping and steal four kegs of [smokepowder](Mechanics/items/smokepowder-wdh.md). In their place, he found a drawing of a phoenix. Avery is terrified of what the thieves might do with the powder—he's all too aware that someone with that much [smokepowder](Mechanics/items/smokepowder-wdh.md) could blow up a portion of the High Hall, Wyrm's Rock, or any number of other fortifications. Yet as horrifying as he finds those possibilities, he seems more concerned about himself: [smokepowder](Mechanics/items/smokepowder-wdh.md) security is his responsibility, and he can't tell the city government about the theft without getting punished for negligence. Yet if he keeps quiet and the thieves use the powder, he'll obviously be implicated. The only solution is to hire someone discreet and trustworthy to track down and recover the missing kegs of [smokepowder](Mechanics/items/smokepowder-wdh.md) before it's too late.

If [smokepowder](Mechanics/items/smokepowder-wdh.md) is set on fire, dropped, or otherwise handled roughly, it explodes and deals fire damage to each creature or object within 20 feet of it: `1d6` for a handful, `9d6` for a keg. A successful DC 12 Dexterity saving throw halves the damage. Casting [dispel magic](Mechanics/spells/dispel-magic.md) on [smokepowder](Mechanics/items/smokepowder-wdh.md) renders it permanently inert.

#### Garmult's House of Mastery

Part school and part alehouse, this wide three-story building leans precariously over the street in Eastway. Run by an old, agender martial artist named Garmult (neutral good human [gladiator](Mechanics/bestiary/humanoid/gladiator.md)), the House of Mastery offers both martial training of all sorts for the city's would-be warriors and a central hangout for the Bannerless Legion crew. Garmult assists crew leader Dezri "Guts" Lamouer in matching clients with mercenaries. They also hire members to teach classes in the building's open-air atrium while other members lounge on the overlooking balconies. At any given time, there's usually multiple veteran mercenaries here swapping stories and waiting for contracts.
...
Unfortunately, Skoond's apprentices aren't the only ones searching. Drawn up through hidden tunnels by the magical auras of both the tome and neighboring Mandorcai's Mansion, a [nothic](Mechanics/bestiary/aberration/nothic.md) lurks in the house's passages, using them to spy on the wizards and search for the treasure. So far, none of the residents have detected it—the last person to do so was the previous owner, killed by the nothic's rotting gaze. Though evil and unwilling to cede claim to the tome—which it hasn't yet located—the nothic is full of secrets from both its spying and its weird oracular abilities, and might be willing to sell them for the right price.
...
The Sewerkeepers' leader, Genamine Kopali (neutral evil female human [assassin](Mechanics/bestiary/humanoid/assassin.md)), also acts as the Guild kingpin for the Seatower neighborhood. Along with a spectrum of ne'er-do-wells, her crew also contains several actual [druids](Mechanics/bestiary/humanoid/druid.md) who keep the facility running and control the crew's several guardian beasts, including a number of sweet-smelling [shambling mounds](Mechanics/bestiary/plant/shambling-mound.md) that live in the tanks, churning them as part of the purification process. [Mortlock Vanthampur](Mechanics/bestiary/npc/mortlock-vanthampur-bgdia.md) (see "Mortlock Vanthampur") pays Genamine to keep him apprised of strange activities in the sewers. Mortlock, in turn, reports whatever he learns to his mother, [Duke Thalamra Vanthampur](Mechanics/bestiary/npc/duke-thalamra-vanthampur-bgdia.md).

#### Shrine of the Suffering

This simple stone shrine to Ilmater, god of martyrs and patient endurance, stands in a small, quiet square, the edges of its plaza thick with the pallets and meager belongings of the Lower City's homeless population. Here, poor Baldurians can come to receive free meals and enough coppers to pay their way through the city's gates, thanks to the ministrations of Brother Hodges, a lawful good male strongheart halfling [priest](Mechanics/bestiary/humanoid/priest.md). Supported by donations from all ranks of society and beloved by their community, the halfling cleric and his adult children Hansen and Sissa (both lawful good strongheart halfling [acolytes](Mechanics/bestiary/humanoid/acolyte.md)) can inevitably be found here chatting with the city's downtrodden, offering what healing and alms they can.

The church's only source of non-donation income is a twisting series of crypts that extends down from an entrance behind the altar, at several points piercing the city's sewers. For a small fee, anyone can have a corpse brought down into the cramped tomb, where hordes of sewer rats flood in to eat the flesh, leaving (mostly) clean bones to be interred in the attached ossuary by Ilmater's faithful. While a somewhat ignoble end, it's often the only holy-ground burial the city's poor can afford, and Brother Hodges does his best to bring quiet dignity to the practice. However, a fertile [carrion crawler](Mechanics/bestiary/monstrosity/carrion-crawler.md) has recently slithered up from the sewers to feast on the corpses in the tomb, leaving a trail of squirming young wherever it passes. Brother Hodges is incensed by the desecration, but doesn't dare face the beasts himself, and the Flaming Fist has been slow to come to his aid. Though the church can't pay, he would gratefully offer free healing to anyone who dealt with the menace.

#### Smilin' Boar

With its downright ribald menu of salaciously renamed breakfast foods, the Smilin' Boar was always intended to cause a stir in well-to-do Bloomridge. Yet the current buzz is more than owner Jentha Allinamuch, a chaotic good female strongheart halfling [commoner](Mechanics/bestiary/humanoid/commoner.md), ever intended. For the past six months, bodies have been appearing in the alley just behind the halfling's café. More than a dozen have appeared so far, never with any witnesses as to how they go there. The victims have no apparent commonalities—being of all ages, races, genders, and social classes, and having disappeared from points all across the city—yet there's no question in anyone's mind that the same killer is responsible, as each is found with curved slices across their wrists and a heart-piercing wound. The whole district is astir over the murders, but so far the Fist hasn't been able to turn up any leads on what locals have fearfully dubbed the Sickle Man. With business plummeting, Jentha is as eager as any grieving family to find answers, and would happily pay independent investigators to help track down the killer. In fact, the killer is not one person, but a group of Dead Three cultists looking to spread fear in the city (see "Hamhocks Slaughterhouse").

#### Sorcerous Sundries

A dome of stained glass roofs this tall, round shop, casting chaotic shafts of color down across several open-air floors that rise upon wooden pillars, connected by staircases and ladders. While the living quarters upstairs teem with rare plants and bookcases, the bottom floor acts as one of the most popular magic shops in the city. Inside its delicate-looking but magically warded walls, customers can buy and sell all manner of curios and common magic items from the eccentric shopkeeper, Rivalen Blackhand, a neutral male human [mage](Mechanics/bestiary/humanoid/mage.md) with a withered right hand.

Blackhand almost always has [potions of healing](Mechanics/items/potion-of-healing.md) available for sale. He also typically has up to 500 gp on hand to buy items from those with interesting magical wares, though he's a savvy bargainer and rarely pays anything close to full price.

Currently, the wizard finds himself in the grip of an unusual protection racket. His supposed apprentice Gilligunn, a neutral evil female rock gnome [spy](Mechanics/bestiary/humanoid/spy.md), is actually a Guild member. Whenever Blackhand makes a sufficiently large transaction, Gilligunn secretly tracks the customer, leading an appropriately sized group of Guild toughs to ambush them days later, knowing they'll be carrying either a large sum of money or a valuable magic item they can sell back to Blackhand. Though the shopkeeper isn't happy with the arrangement, the Guild varies its patterns enough to keep suspicion away from him, and he has to admit it's a better deal than paying protection money himself.
...
Travelers arriving via the river wait in the center of Gray Harbor, under the watchful eye of the Seatower, until one of the harbormaster's agents approaches in a fast-moving skiff. Protected by coteries of Gray Wavers (Flaming Fist [veterans](Mechanics/bestiary/humanoid/veteran.md)), these customs officials assess the boat's cargo, collect taxes, and sell hourly berth assignments at one of the city's many docks and piers. Large vessels may also pay to make use of the city's marvelous mechanical cranes, dramatically accelerating their unloading process.
...
| 12 | A merchant and gate guard argue over how to accurately measure and compare the sizes of an unusually small donkey and an exceptionally large [peacock](Mechanics/bestiary/beast/peacock-bgdia.md). They ask for a passing party member's opinion. |
^table-g-outer-city-harmless-interactions
...
|-----------|-------------|
| 1 | `2d4` Calishite [thugs](Mechanics/bestiary/humanoid/thug.md) and `2d4` Tethyrian [thugs](Mechanics/bestiary/humanoid/thug.md) curse at each other, ready to brawl |
| 2 | `1d6` gnome [commoners](Mechanics/bestiary/humanoid/commoner.md) from the Whitkeep Hostel throw tomatoes at passersby who flaunt their wealth |
| 3 | `1d4` [bandits](Mechanics/bestiary/humanoid/bandit.md) joyride on [riding horses](Mechanics/bestiary/beast/riding-horse.md) stolen from a corral |
| 4 | `2d4` Flaming Fist [guards](Mechanics/bestiary/humanoid/guard.md), off-duty or headed elsewhere, ignore obvious crimes |
| 5 | `1d4` patriars (human [nobles](Mechanics/bestiary/humanoid/noble.md)) and `2d8` [guards](Mechanics/bestiary/humanoid/guard.md) |
| 6 | `1d4` barkers ([spies](Mechanics/bestiary/humanoid/spy.md)) pass out handbills for the Oasis Theater |
| 7 | `1d4` [commoners](Mechanics/bestiary/humanoid/commoner.md) herding `2d8` [goats](Mechanics/bestiary/beast/goat.md) and one [peacock](Mechanics/bestiary/beast/peacock-bgdia.md) (use the [vulture](Mechanics/bestiary/beast/vulture.md) stat block) |
| 8 | `2d6` beggars ([commoners](Mechanics/bestiary/humanoid/commoner.md)) |
| 9 | 1 Flaming Fist officer ([knight](Mechanics/bestiary/humanoid/knight.md)) and `2d4` Flaming Fist soldiers ([veterans](Mechanics/bestiary/humanoid/veteran.md)) heading to or from Wyrm's Rock |
| 10 | `2d6` members of the Crossers or Gravemakers crew ([commoners](Mechanics/bestiary/humanoid/commoner.md)) on street patrol |
^table-h-outer-city-denizens
...
| dice: d10 | Threat |
|-----------|--------|
| 1 | `2d4` [giant rats](Mechanics/bestiary/beast/giant-rat.md) |
| 2 | 1 [bandit captain](Mechanics/bestiary/humanoid/bandit-captain.md) and `1d6` [bandits](Mechanics/bestiary/humanoid/bandit.md) demand a "street use" tax |
| 3 | `1d6` Guild pickpockets ([spies](Mechanics/bestiary/humanoid/spy.md)) |
| 4 | `1d4` [ghouls](Mechanics/bestiary/undead/ghoul.md) picking at corpses left in the street |
| 5 | `2d6` [skeletons](Mechanics/bestiary/undead/skeleton.md) escaped from the Cliffside Cemetery |
| 6 | A flying, double-bladed axe terrorizing passersby (the illusion-wrapped [stirge](Mechanics/bestiary/beast/stirge.md) from Danthelon's Dancing Axe) |
| 7 | 1 [cockatrice](Mechanics/bestiary/monstrosity/cockatrice.md) that escaped from the Garynmor Menagerie |
| 8 | `1d6` [stirges](Mechanics/bestiary/beast/stirge.md) |
| 9 | `1d4` [jackalweres](Mechanics/bestiary/humanoid/jackalwere.md) that live in Little Calimshan |
...
Watching over all of this is the powerful Gravemakers crew. Far more than simply caretakers and laborers, the Gravemakers guard the dead—and Tumbledown—from threats. With so much death concentrated in one spot, undead are a constant problem. Skeletons and revenants regularly claw spontaneously out of their graves, while ghouls and ghasts burrow into crypts and catacombs, drawn by the scent of decaying flesh. Wights hide in their tombs by day, while ghosts and wraiths terrorize unsuspecting mortals. Putting down such threats before they can prey on citizens is the Gravemakers' primary job, and though rightfully proud of their prowess, their leader Leone Wen, a lawful good female human [knight](Mechanics/bestiary/humanoid/knight.md) and servant of Torm, is always looking for fresh recruits or contractors to join them in their crusade. The crew operates out of the half-burned old Szarr Mansion in the cemetery's center, its moldering halls reputedly still infested by the ghosts of the murdered Szarrs—though stories remain split as to whether the ghosts prey on the Gravemakers or aid them in their duty.
...
Few seek the church's services on their own. Rather, most who come to dwell at the church either have a room rented for them by concerned family or receive a somewhat mysterious—and usually unexpected—invitation from the institute's superintendent, Mother Aramina, a lawful good female human [priest](Mechanics/bestiary/humanoid/priest.md). Aramina is a former Candlekeep scholar who's moved her lifelong study of psychology from the academic to the clinical. How Mother Aramina learns of individuals' distress and under what circumstances she offers free room and board in her facility is something of a mystery, but as of yet, none have discovered any sinister angle to her work. In fact, Mother Aramina has been known to hire empathic intermediaries to help extricate the needful from destructive conditions. Despite its charity, though, the Church of Last Hope is not universally loved. The Faithless, the Guild-associated gang in Twin Songs, see a trove of wealthy city-dwellers and wishy-washy non-priests in their midst, ripe targets for protection schemes, kidnappings, and all manner of other plots. Currently none of the Church's patients have been endangered, but Mother Aramina is cautiously looking for more permanent security solutions.

#### Danthelon's Dancing Axe

This two-story shop sells everything an adventurer might need, from weapons and armor to rowboats and mobile monster cages. Presiding over the crammed shelves is Entharl Danthelon, a neutral good male shield dwarf [commoner](Mechanics/bestiary/humanoid/commoner.md) who claims to have been an adventurer once himself, as evidenced by the magical flying axe that guards his shop at night. Customers are inevitably treated to the story of the grateful elven princess who enchanted the axe for him as a reward for a daring adventure undertaken on her behalf.

In truth, Danthelon's "dancing axe" is actually a tame [stirge](Mechanics/bestiary/beast/stirge.md) wrapped in the illusion of a double-bladed axe, which Danthelon sets loose each night. The illusion is courtesy of Yssra Brackrel, a neutral female half-elf [mage](Mechanics/bestiary/humanoid/mage.md) and brilliant hairstylist who rents out the shop's attic. Yssra's cantankerousness is as legendary as the shop's flying axe, and anyone seeking just her spellcasting is subject to a frank and unflattering critique of their current coiffure.
...
Pasque Enrial, a [black gauntlet of Bane](Mechanics/bestiary/humanoid/black-gauntlet-of-bane-bgdia.md), is the cult's mastermind. He engineered the death of the slaughterhouse's former owner so that he could take over, figuring that constant blood, offal, and animal screams would provide a suitable cover for the cult's murderous activities. Since then, he's been slowly laying off existing workers and replacing them with cultists loyal to the group's mission. Assisting him are Corian Khee, a [death's head of Bhaal](Mechanics/bestiary/humanoid/deaths-head-of-bhaal-bgdia.md) who spends days crushing livestock skulls with a massive hammer and nights leading the cult's murderous field operations, and Jaemus Exheltarion, a half-elf [master of souls](Mechanics/bestiary/humanoid/master-of-souls-bgdia.md). Of the three, Jaemus is the least convincing in his role as the slaughterhouse's new accountant, as he greets customers with an eerie stare, openly reads strange-looking tomes, and spends entirely too much time in the cult's trophy locker, a cold-storage facility where he's using pieces harvested from victims and livestock to construct a ram-headed flesh golem.
...
The commander of Wyrm's Rock, an old brute named Skorpin Crane, died in his sleep recently. Foul play was ruled out, and Grand Duke [Ulder Ravengard](Mechanics/bestiary/npc/ulder-ravengard-bgdia.md) was in the midst of finding Crane's replacement when he was lured away on a diplomatic mission to Elturel. Until a replacement is found, the Mage Defender of Wyrm's Rock, a neutral evil shield dwarf [mage](Mechanics/bestiary/humanoid/mage.md) named Gardak Horn, has taken command. The guards loathe Gardak because he uses a [homunculus](Mechanics/bestiary/construct/homunculus.md) to spy on them.
...
| dice: d12 | Travelers |
|-----------|-----------|
| 1 | `3d4` local farmers or ranchers ([commoners](Mechanics/bestiary/humanoid/commoner.md)) |
| 2 | `1d4` foreign merchants ([commoners](Mechanics/bestiary/humanoid/commoner.md)) and `3d6` [guards](Mechanics/bestiary/humanoid/guard.md) traveling in a caravan |
| 3 | `1d6` scholars ([commoners](Mechanics/bestiary/humanoid/commoner.md)) |
| 4 | `3d6` migrants or refugees ([commoners](Mechanics/bestiary/humanoid/commoner.md)) |
| 5 | `2d4` Flaming Fist soldiers ([veterans](Mechanics/bestiary/humanoid/veteran.md)) |
| 6 | Family of `1d4` patriars ([nobles](Mechanics/bestiary/humanoid/noble.md)) in a coach pulled by two [draft horses](Mechanics/bestiary/beast/draft-horse.md), with `2d6` [guards](Mechanics/bestiary/humanoid/guard.md) on [riding horses](Mechanics/bestiary/beast/riding-horse.md) providing escort |
| 7 | `2d4` mercenaries for hire ([thugs](Mechanics/bestiary/humanoid/thug.md)) |
| 8 | `1d6` religious pilgrims ([acolytes](Mechanics/bestiary/humanoid/acolyte.md)) |
| 9 | `1d6` Guild agents ([bandits](Mechanics/bestiary/humanoid/bandit.md)) |
| 10 | 1 [archmage](Mechanics/bestiary/humanoid/archmage.md) accompanied by a [shield guardian](Mechanics/bestiary/construct/shield-guardian.md) |
| 11 | `1d6` entertainers ([commoners](Mechanics/bestiary/humanoid/commoner.md)) |
| 12 | 1 [gladiator](Mechanics/bestiary/humanoid/gladiator.md) leading an ox, which is hauling a prison wagon that contains a [medusa](Mechanics/bestiary/monstrosity/medusa.md) wearing a burlap hood over her head and shackles on her wrists |
...
| dice: d12 | Encounter |
|-----------|-----------|
| 1 | `1d6` [werewolves](Mechanics/bestiary/humanoid/werewolf.md) disguised as human beggars or a pack of wolves |
| 2 | `2d4` [stirges](Mechanics/bestiary/beast/stirge.md) |
| 3 | `1d4` [ettercaps](Mechanics/bestiary/monstrosity/ettercap.md) and `1d4` [giant spiders](Mechanics/bestiary/beast/giant-spider.md) |
| 4 | `3d6` [kobolds](Mechanics/bestiary/humanoid/kobold.md) |
| 5 | 1 [goblin boss](Mechanics/bestiary/humanoid/goblin-boss.md) and `3d6` [goblins](Mechanics/bestiary/humanoid/goblin.md) |
| 6 | 1 [dryad](Mechanics/bestiary/fey/dryad.md) and `1d4` [sprites](Mechanics/bestiary/fey/sprite.md) lurking in a tree |
| 7 | `1d4` [ankhegs](Mechanics/bestiary/monstrosity/ankheg.md) that burrow up from the ground |
| 8 | 1 [basilisk](Mechanics/bestiary/monstrosity/basilisk.md) |
| 9 | `1d4` [jackalweres](Mechanics/bestiary/humanoid/jackalwere.md) disguised as human beggars, entertainers, or merchants |
| 10 | 1 [hobgoblin captain](Mechanics/bestiary/humanoid/hobgoblin-captain.md) and `3d6` [hobgoblins](Mechanics/bestiary/humanoid/hobgoblin.md) |
| 11 | 1 [gnoll pack lord](Mechanics/bestiary/humanoid/gnoll-pack-lord.md) and `3d6` [gnolls](Mechanics/bestiary/humanoid/gnoll.md) |
| 12 | 1 [wyvern](Mechanics/bestiary/dragon/wyvern.md) |
...
- [Acolyte](Mechanics/backgrounds/baldurs-gate-acolyte-bgdia.md)  
- [Charlatan](Mechanics/backgrounds/baldurs-gate-charlatan-bgdia.md)  
- [Criminal](Mechanics/backgrounds/baldurs-gate-criminal-bgdia.md)  
- [Entertainer](Mechanics/backgrounds/baldurs-gate-entertainer-bgdia.md)  
- [Faceless (new background)](Mechanics/backgrounds/faceless-bgdia.md)  
- [Folk Hero](Mechanics/backgrounds/baldurs-gate-folk-hero-bgdia.md)  
- [Guild Artisan](Mechanics/backgrounds/baldurs-gate-guild-artisan-bgdia.md)  
- [Hermit](Mechanics/backgrounds/baldurs-gate-hermit-bgdia.md)  
- [Noble](Mechanics/backgrounds/baldurs-gate-noble-bgdia.md)  
- [Outlander](Mechanics/backgrounds/baldurs-gate-outlander-bgdia.md)  
- [Sage](Mechanics/backgrounds/baldurs-gate-sage-bgdia.md)  
- [Sailor](Mechanics/backgrounds/baldurs-gate-sailor-bgdia.md)  
- [Soldier](Mechanics/backgrounds/baldurs-gate-soldier-bgdia.md)  
- [Urchin](Mechanics/backgrounds/baldurs-gate-urchin-bgdia.md)  
...
| 2 | [Duke Thalamra Vanthampur](Mechanics/bestiary/npc/duke-thalamra-vanthampur-bgdia.md) |
| 3 | [Thurstwell Vanthampur](Mechanics/bestiary/npc/thurstwell-vanthampur-bgdia.md) |
| 4 | [Amrik Vanthampur](Mechanics/bestiary/npc/amrik-vanthampur-bgdia.md) |
| 5 | [Mortlock Vanthampur](Mechanics/bestiary/npc/mortlock-vanthampur-bgdia.md) |
| 6 | Falaster Fisk (see "Falaster Fisk") |
| 7 | [Nine-Fingers Keene](Mechanics/bestiary/npc/nine-fingers-keene-bgdia.md) |
...
| 3 | Dangerous goods mean hazard pay. You stole four kegs of [smokepowder](Mechanics/items/smokepowder-wdh.md) from Felogyr's Fireworks and sold them to a gang of revolutionaries. Your pay is already spent, but the fireworks have yet to begin. |
