...
These statues are actually two [petrified](Mechanics/Rules/conditions.md#Petrified) [vrocks](Mechanics/bestiary/fiend/vrock.md). If they are attacked, or if the characters bypass the gatehouse, the vrocks revert to flesh and attack, pursuing prey that flees and fighting until slain.
...
A successful casting of [dispel magic](Mechanics/spells/dispel-magic.md) (DC 16) suppresses the curtain for 1 minute. The curtain is also suppressed within an [antimagic field](Mechanics/spells/antimagic-field.md).

### T4. Guard Tower, Ground Floor

The tower door is made of ironbound wood and barred from within. A character can force open the door with a successful DC 22 Strength ([Athletics](Mechanics/Rules/skills.md#Athletics)) check.
...
The forms are six [snow maidens](Mechanics/bestiary/undead/snow-maiden-cos.md). Use the [specter](Mechanics/bestiary/undead/specter.md) statistics, with the following modifications:
...
The snow maidens don't speak, nor are they interested in hearing what the characters have to say. If the characters don't leave at once, the snow maidens attack. When the last [snow maiden](Mechanics/bestiary/undead/snow-maiden-cos.md) is defeated, the treasure that the characters seek magically appears in the swirling snow on the rooftop.
...
The cloaked rider is a manifestation of [Strahd von Zarovich](Mechanics/bestiary/npc/strahd-von-zarovich-cos.md)—a grim warning to proceed no further. If the characters interact with the manifestation in any way, the rider and horse disperse like ash in the wind.
...
As the characters cross the stone bridge (area T8) from east to west—possibly on their way back from the Amber Temple (chapter 13)—they are spotted by a [roc](Mechanics/bestiary/monstrosity/roc.md) that has survived in the mountains for thousands of years. The roc has a great nest on the top of Mount Ghakis to the southeast and feeds on fish in the nearby lake.
...
As the characters make their way along Tsolenka Pass, they encounter a beast that the druids and berserkers of Barovia call [Sangzor](Mechanics/bestiary/npc/sangzor-cos.md) ("Bloodhorn"):
...
If no character has a passive Wisdom ([Perception](Mechanics/Rules/skills.md#Perception)) score of 16 or higher, the party is [surprised](Mechanics/Rules/conditions.md#Surprised). Otherwise, read:
...
[Sangzor](Mechanics/bestiary/npc/sangzor-cos.md) is a [giant goat](Mechanics/bestiary/beast/giant-goat.md) known for its supernatural resilience and evil disposition. Mountain folk have been hunting it for years. Modify its statistics as follows:
...
A character who wears [Sangzor](Mechanics/bestiary/npc/sangzor-cos.md)'s pelt can command the respect of the berserkers who inhabit Strahd's domain. They will not attack the character or that character's companions unless provoked.