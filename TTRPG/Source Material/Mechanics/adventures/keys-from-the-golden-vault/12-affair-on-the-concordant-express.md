...
Wanted for crimes across the multiverse, an outlaw known as [the Stranger](Mechanics/bestiary/npc/the-stranger-kftgv.md) is currently a prisoner aboard the Concordant Express, an interplanar train destined for Mechanus, where the outlaw is set to stand trial. In this heist, the characters must obtain a list of names [the Stranger](Mechanics/bestiary/npc/the-stranger-kftgv.md) has committed to memory. The names in question are the true names of several powerful demons, devils, and yugoloths.

![The Concordant Express roc...](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/KftGV/081-11-001.ch11-splash.webp#center "The Concordant Express rockets through the Outlands on its way to Mechanus")

## Adventure Background

![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/KftGV/082-11-002.ch11-key.webp#center)

The interplanar outlaw known as [the Stranger](Mechanics/bestiary/npc/the-stranger-kftgv.md) had humble origins. [The Stranger](Mechanics/bestiary/npc/the-stranger-kftgv.md) was born into a slum and orphaned as an infant. Early on, they used their knack for magic to masquerade as a lost noble scion and earn patronage as a spellcasting student. Inevitably, the school [the Stranger](Mechanics/bestiary/npc/the-stranger-kftgv.md) was attending discovered the ruse, but [the Stranger](Mechanics/bestiary/npc/the-stranger-kftgv.md) always slipped away and reemerged at an even more prominent academy in another city with a new false identity.

[The Stranger](Mechanics/bestiary/npc/the-stranger-kftgv.md) perpetrated many crimes, none greater than the attempted theft of a book that held the true names of many demons, devils, and yugoloths (see "True Names" below). When [the Stranger](Mechanics/bestiary/npc/the-stranger-kftgv.md) tried to flee with the book, a fiendish ward caused the book to disappear. By then, [the Stranger](Mechanics/bestiary/npc/the-stranger-kftgv.md) had already committed many of the true names to memory. [The Stranger](Mechanics/bestiary/npc/the-stranger-kftgv.md) then set off across the multiverse, making deals with various Fiends in exchange for keeping their true names secret. [The Stranger](Mechanics/bestiary/npc/the-stranger-kftgv.md) survived all these dealings unscathed for years, but their luck eventually ran out.

Fiendish foes set their sights on [the Stranger](Mechanics/bestiary/npc/the-stranger-kftgv.md), forcing [the Stranger](Mechanics/bestiary/npc/the-stranger-kftgv.md) to flee to the Material Plane and take refuge in the city-state of Akharin Sangar, which is ruled by a powerful angelic being. (Akharin Sangar is detailed further in Journeys through the Radiant Citadel). But [the Stranger](Mechanics/bestiary/npc/the-stranger-kftgv.md) underestimated the vigilance of Akharin Sangar's celestial host and was caught impersonating an angel. When [the Stranger](Mechanics/bestiary/npc/the-stranger-kftgv.md) refused to divulge any information about themself, a deva enforcer named Omid was tasked with delivering [the Stranger](Mechanics/bestiary/npc/the-stranger-kftgv.md) to Mechanus to stand trial. The prisoner was clamped in [dimensional shackles](Mechanics/items/dimensional-shackles.md) and taken aboard the Concordant Express for safe transport.
...
> [!readaloud] 
> 
> "Greetings, operatives. The Golden Vault needs you to obtain the true names of three powerful denizens of the Lower Planes: the pit fiend Karnyros, the balor Errtok, and the marilith Hexalanthe. Their true names are known to an outlaw called [the Stranger](Mechanics/bestiary/npc/the-stranger-kftgv.md), who is being transported to Mechanus on an interplanar train called the Concordant Express. This quest, should you choose to undertake it, requires you board the train, locate [the Stranger](Mechanics/bestiary/npc/the-stranger-kftgv.md), and acquire the true names from them. Expect to be contacted shortly by a quadrone named Glitch, a former train operative who now works for us. Good luck, operatives."
^40f
...
> [!readaloud] 
> 
> "Ah, hello! Yes, good, finally—friends looking to catch [the Stranger](Mechanics/bestiary/npc/the-stranger-kftgv.md)—[the Stranger](Mechanics/bestiary/npc/the-stranger-kftgv.md) who has already been caught. Here, take this map. It shows the train cars. Here are your tickets and a pen to write down names. Not ordinary names—secret names! I am Glitch, by the way."
^411
...
- **Location of the Stranger.** [The Stranger](Mechanics/bestiary/npc/the-stranger-kftgv.md) is likely being held in the Jail Car, which has a skylight.  
...
Embedded in Glitch's body is an [amulet of the planes](Mechanics/items/amulet-of-the-planes.md) that turns to dust (along with the rest of the quadrone) if Glitch is reduced to 0 hit points. Glitch uses this built-in amulet to cast [plane shift](Mechanics/spells/plane-shift.md), delivering itself and the characters to a field in "the Outlands" (see the "Dungeon Master's Guide" for more information about this plane of existence). There they must wait for the train to arrive.
...
Glitch exits the adventure at this point, using its [amulet of the planes](Mechanics/items/amulet-of-the-planes.md) to return whence it came.

#### Boarding the Train

The Caboose (area E1) doubles as a train station. Inside it is a booth containing a [duodrone](Mechanics/bestiary/construct/duodrone.md) attendant with a built-in ticket puncher. All passengers must get their tickets punched by this duodrone before they're permitted to explore the rest of the train.

If one or more characters refuse to get their tickets punched, the duodrone whistles (no action required), causing four [tridrones](Mechanics/bestiary/construct/tridrone.md) to emerge from hidden compartments in the walls and act as described in area E1. If the characters then comply to avoid an altercation, the tridrones return to their compartments.
...
To reach [the Stranger](Mechanics/bestiary/npc/the-stranger-kftgv.md), the characters must make their way from the Caboose (area E1) to the Jail Car (area E8).
...
|----------|-----------|
| 1–3 | No encounter |
| 4–5 | Three [tridrones](Mechanics/bestiary/construct/tridrone.md) and one [quadrone](Mechanics/bestiary/construct/quadrone.md) leader |
| 6 | Four [quadrones](Mechanics/bestiary/construct/quadrone.md) and one [pentadrone](Mechanics/bestiary/construct/pentadrone.md) leader |
^guard-patrols
...
| 3 | Mount Celestia. Good-aligned creatures aboard the train gain a benefit of a [bless](Mechanics/spells/bless.md) spell that lasts until the train leaves Mount Celestia. |
...
| 5 | Pandemonium. Howling darkness surrounds the train. Creatures outside the train are [deafened](Mechanics/Rules/conditions.md#Deafened). Outside the train, bright light becomes dim light, and dim light becomes darkness. |
...
The [duodrone](Mechanics/bestiary/construct/duodrone.md) attendant who punched the characters' tickets has another function aboard the train: making minor repairs while the train is in motion. As the train gets underway, the duodrone dons gear from a nearby locker (see "Locker" below). It then departs to perform its duties, whistling as it marches to the next car.

Hidden in the walls of the Caboose are four [tridrones](Mechanics/bestiary/construct/tridrone.md) that emerge from their compartments to attack passengers who refuse to get their tickets punched or who perform an unlawful act, such as threatening the duodrone or plundering the locker.
...
The self-proclaimed Math Wizard is a friendly [duodrone](Mechanics/bestiary/construct/duodrone.md). The Math Wizard speaks both Common and Modron.

The ten [monodrones](Mechanics/bestiary/construct/monodrone.md) speak Modron only and are indifferent toward passengers. Each one holds a stack of ten placards numbered 0 through 9. When a creature inside the Abacus Car asks a mathematical question to which the answer is a number, the Math Wizard taps the podium with its wand and says, "Calculate!" In response, the monodrones select from their placards, shuffle around, and hold up their numerals to display the answer. The Math Wizard cheers "Huzzah!" after every successful calculation.
...
A character who studies the equations for at least 10 minutes can make a DC 25 Intelligence ([Arcana](Mechanics/Rules/skills.md#Arcana)) check at the end of that time. If the check fails, the character takes 3 (`1d6`) psychic damage and suffers a mild headache for the next hour. If the check succeeds, the character discovers a profound equation nestled among the others. Like a key, this equation unlocks something in the character's brain, with the effect determined by rolling on the Mysterious Equation table. A character who experiences this revelation gains no further benefit from studying the chalkboard equations. If any of the equations are erased, the modrons in the car turn hostile and attack, and no one can benefit from studying the equations.
...
| 6 | You gain proficiency in one of the following skills of your choice: [Deception](Mechanics/Rules/skills.md#Deception), [History](Mechanics/Rules/skills.md#History), [Insight](Mechanics/Rules/skills.md#Insight), [Investigation](Mechanics/Rules/skills.md#Investigation), [Medicine](Mechanics/Rules/skills.md#Medicine), or [Performance](Mechanics/Rules/skills.md#Performance). |
...
The alabaster statue is a [petrified](Mechanics/Rules/conditions.md#Petrified) [deva](Mechanics/bestiary/celestial/deva.md) with a [decanter of endless water](Mechanics/items/decanter-of-endless-water.md). If any harm befalls the fish in the aquarium, the deva immediately reverts to flesh and chastises whoever is responsible. If the aquarium's plug was removed, the deva replaces it. If any water was drained from the car, the deva uses the decanter to replenish it. If any fish died, the deva uses [raise dead](Mechanics/spells/raise-dead.md) spells to revive one fish per day for ten days. Once all is set right, the deva flies from the train and casts [plane shift](Mechanics/spells/plane-shift.md) to return to Mount Celestia, taking the decanter with it.
...
A creature that interacts with the war machine spooks six [invisible](Mechanics/Rules/conditions.md#Invisible) [imps](Mechanics/bestiary/fiend/imp.md) lurking in its bent chassis. The imps fly out and attack the source of their fright while yelling, "I can't go back to jail!" in Infernal. If the infernal war machine's acid sprayer hasn't already been used, one of the imps uses it.

A character who sits in the driver's seat notices a glowing [potion of resistance (fire)](Mechanics/items/potion-of-fire-resistance.md) jammed in a dirty glove compartment along with six unpaid infernal parking tickets.
...
If a character inserts something worthless into the donation slot or otherwise tries to fool it with counterfeits and the like, the tube disgorges poisonous gas that quickly fills the compartment. This gas duplicates the effect of a [stinking cloud](Mechanics/spells/stinking-cloud.md) spell that lasts for 1 minute or until it is dispersed.
...
![Ignatius Inkblot, the grea...](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/KftGV/086-11-004.ignatius-inkblot.webp#center "Ignatius Inkblot, the great mind flayer detective, examines a corpse aboard the Concordant Express")

#### Murder Suspects

The suspects aboard the Passenger Car are as follows:

**Abernathy Vernus** (lawful evil [cambion](Mechanics/bestiary/fiend/cambion.md)) is a friendly, ingratiating fellow who claims to have won a free tour aboard the Concordant Express. He insists that others call him Vern. No other passengers occupy his cabin (the one marked "a" on map 11.2), which Vern shares with a [monodrone](Mechanics/bestiary/construct/monodrone.md) valet that answers to the name Higglesworth.

**Ethlynn Stalaczic** (neutral, drow [mage](Mechanics/bestiary/humanoid/mage.md)) is a friendly, somewhat gullible dragonologist on a planar quest to find a "time dragon" (which may or may not be a real thing). Until a few moments ago, Ethlynn and Quintus were cabin mates. Ethlynn currently shares her cabin (the one marked "b" on map 11.2) with a [monodrone](Mechanics/bestiary/construct/monodrone.md) valet called Bot.

**Meldar** (lawful neutral [azer](Mechanics/bestiary/elemental/azer.md)) is indifferent toward others, speaks nothing but Ignan, and provides curt answers to questions put to them. The azer is returning to the City of Brass after attending a smiths' convention in Bytopia. Meldar shares a cabin (the one marked "c" on map 11.2) with [Ignatius Inkblot](Mechanics/bestiary/npc/ignatius-inkblot-kftgv.md) and a monodrone valet known as Orb.
...
- **Examining the Corpse.** A character who examines Quintus and succeeds on a DC 11 Intelligence ([Arcana](Mechanics/Rules/skills.md#Arcana)) or Wisdom ([Medicine](Mechanics/Rules/skills.md#Medicine)) check determines that the aasimar was killed by three bolts of magical force identical to those created by a [magic missile](Mechanics/spells/magic-missile.md) spell. Given where the body fell, the direction Quintus was walking when he died, and where the wounds on the body are located, a character can deduce, with a successful DC 16 Intelligence ([Investigation](Mechanics/Rules/skills.md#Investigation)) check, that the killer likely didn't come from Meldar's cabin.  
- **Raising the Dead.** A character who has the [raise dead](Mechanics/spells/raise-dead.md) spell prepared can use it to restore Quintus to life. (The devas in areas E3 and E8 can also provide this service, if asked nicely.) Quintus is chaotic neutral and uses the [noble](Mechanics/bestiary/humanoid/noble.md) stat block, although he is unarmored and carries no weapons. Alive, the aasimar is less cooperative than when he was dead, for reasons explained in the "Motive" section below. He offers no possible reasons for why someone would want to kill him.  
...
- **Cabin A.** This cabin holds Vern's battered suitcase, which contains two [traveler's outfits](Mechanics/items/travelers-clothes.md), three odd-looking compasses, and a set of [tinker's tools](Mechanics/items/tinkers-tools.md). If asked about the compasses, Vern says he builds and repairs them to pass the time on long trips.  
- **Cabin B.** Ethlynn shared this cabin with the murder victim and knows Quintus was a cartographer. Ethlynn confirms that Quintus left their cabin to use the privy at one end of the train car. Characters who search the cabin find Quintus's satchel, which contains two spare [traveler's outfits](Mechanics/items/travelers-clothes.md), a set of [cartographer's tools](Mechanics/items/cartographers-tools.md), and a [map case](Mechanics/items/map-or-scroll-case.md) containing what look like ancient treasure maps. A similar map, stolen by Ethlynn while Quintus was visiting the privy, is stuffed in her spidersilk handbag. (Ethlynn insists Quintus gave the map to her, which he never did. He did, however, tell her that the map shows the way to a time dragon's lair, which it does not.) A character who spends 1 minute examining any one of Quintus's maps can, with a successful DC 16 Intelligence ([Investigation](Mechanics/Rules/skills.md#Investigation)) check, cast serious doubt on the map's accuracy.  
...
The monodrone Higglesworth killed Quintus using a [wand of magic missiles](Mechanics/items/wand-of-magic-missiles.md), which is hidden in a secret compartment inside the monodrone's spherical body. The monodrone won't subject itself to inspection and attacks anyone who tries to search or dismantle it. Its impeccable valet programming prevents it from incriminating passengers or accusing them of any wrongdoing.
...
A character can use an action to search Higglesworth for a secret compartment, finding it with a successful DC 13 Wisdom ([Perception](Mechanics/Rules/skills.md#Perception)) check, but this can be done only while the monodrone is [incapacitated](Mechanics/Rules/conditions.md#Incapacitated). The same is true for opening the compartment, which requires another action, thieves' tools or tinker's tools, and a successful DC 11 Dexterity check. Opening the compartment causes the wand to tumble out.

If Higglesworth is reduced to 0 hit points, its body disintegrates, but the [wand of magic missiles](Mechanics/items/wand-of-magic-missiles.md) hidden inside it remains.
...
The slaad's master watches the battle unfold through an invisible scrying sensor like the one created by a [scrying](Mechanics/spells/scrying.md) spell. If the characters defeat the slaad, a magically altered voice issues from the invisible sensor and says in Common, "So much for that. Next time you won't be so lucky!" If the characters are working for the Golden Vault, the voice adds, "The Golden Vault won't be able to protect you from our wrath." The scrying sensor then disappears.

### E8: Jail Car

This soundproof car is two stories tall (30 feet high) and encased in thick iron. Four [pentadrones](Mechanics/bestiary/construct/pentadrone.md) guard the rooftop. These guards are positioned near the corners of the roof, allowing them to spot trouble coming from the sides of the car.

The outer doors of the car are locked tight, as is the 10-foot-square skylight in the roof. As an action, a character with thieves' tools can try to open one of the doors or the skylight, doing so with a successful DC 17 Dexterity check. The skylight can also be shattered; it is made of thick glass and has AC 13, 27 hit points, and immunity to poison and psychic damage. Conversely, the doors are too strong to be forced open by anything other than [knock](Mechanics/spells/knock.md) spells or similar magic.
...
The angel guarding the Jail Car is Omid, a [deva](Mechanics/bestiary/celestial/deva.md) with fiery instead of feathery wings. Omid has orders to deliver [the Stranger](Mechanics/bestiary/npc/the-stranger-kftgv.md) safely to Mechanus, where judgment awaits.
...
- **Clever Deception.** The characters can pose as emissaries of a jurisdiction with greater claim to [the Stranger](Mechanics/bestiary/npc/the-stranger-kftgv.md)'s custody. Convincing Omid to release [the Stranger](Mechanics/bestiary/npc/the-stranger-kftgv.md) requires a successful DC 17 group Charisma ([Deception](Mechanics/Rules/skills.md#Deception)) check. If the characters used a forgery kit to create documentation to support their claim, the group check is made with advantage.  
- **Convincing Argument.** Since Omid knows little about [the Stranger](Mechanics/bestiary/npc/the-stranger-kftgv.md), a character can convince the deva that the outlaw has been wrongly accused and should be released. Making the argument might take a minute or two, after which the character must succeed on a DC 17 Charisma ([Persuasion](Mechanics/Rules/skills.md#Persuasion)) check to secure [the Stranger](Mechanics/bestiary/npc/the-stranger-kftgv.md)'s release.  
- **Friendly Game.** A character who has a gaming set can challenge the deva to a friendly game. Omid loves games and is too proud (and bored) not to accept. If the character wins the game, Omid allows the party to speak with [the Stranger](Mechanics/bestiary/npc/the-stranger-kftgv.md) (but not set them free). Determine the game's outcome by having the deva's challenger make a DC 19 Intelligence check. Proficiency with the gaming set allows the character to add their proficiency bonus to their roll. If the check is successful, the character wins. On a failed check, the character can opt to cheat in the late stages of the game and make a DC 19 Charisma ([Deception](Mechanics/Rules/skills.md#Deception)) check. A successful check overrides the earlier failure. If the character loses gracefully and didn't cheat, the deva (a gracious winner) still allows the party to speak with [the Stranger](Mechanics/bestiary/npc/the-stranger-kftgv.md).  
...
- **Cell 1.** This cell contains a hostile [nycaloth](Mechanics/bestiary/fiend/nycaloth.md) known as Dardo (not its true name). If someone opens the door to its cell, Dardo tries to exit the cell on its next turn, attacking anyone who stands in its way. The nycaloth then tries to leave the train. [The Stranger](Mechanics/bestiary/npc/the-stranger-kftgv.md) (see below) happens to know Dardo's true name: a simple math equation. The characters can use this knowledge to keep the nycaloth from attacking them, or to force it to work for them.  
- **Cell 2.** This cell is empty.  
- **Cell 3.** A bench against the far wall has a [+2 rod of the pact keeper](Mechanics/items/2-rod-of-the-pact-keeper.md) resting on it. The cell is otherwise empty.  
- **Cell 4.** This cell contains a friendly [erinyes](Mechanics/bestiary/fiend/erinyes.md) who recently helped an efreeti named Vrakir get his hands on the [Book of Vile Darkness](Mechanics/items/book-of-vile-darkness-variant-kftgv.md). Speaking with this prisoner might kick off "Fire and Darkness," another adventure in this book. [The Stranger](Mechanics/bestiary/npc/the-stranger-kftgv.md) (see below) doesn't know this erinyes's true name.  
- **Cell 5.** This cell is empty.  
- **Cell 6.** This cell is empty.  
- **Cell 7.** A [monodrone](Mechanics/bestiary/construct/monodrone.md) janitor accidentally locked itself in this cell.  
- **Cell 8.** This cell contains [the Stranger](Mechanics/bestiary/npc/the-stranger-kftgv.md) (see below).  

#### The Stranger

This individual looks like a human with a flat-brimmed leather hat and a tattered traveler's cloak. [The Stranger](Mechanics/bestiary/npc/the-stranger-kftgv.md)'s face is permanently obscured behind a shifting blur like that of a deep desert haze. [The Stranger](Mechanics/bestiary/npc/the-stranger-kftgv.md) is chaotic neutral and uses the [archmage](Mechanics/bestiary/humanoid/archmage.md) stat block, though they abhor combat. [The Stranger](Mechanics/bestiary/npc/the-stranger-kftgv.md) wears an invisible [ring of mind shielding](Mechanics/items/ring-of-mind-shielding.md) that thwarts magical attempts to read their thoughts. [The Stranger](Mechanics/bestiary/npc/the-stranger-kftgv.md) also wears [dimensional shackles](Mechanics/items/dimensional-shackles.md) but is eager to be rid of them. One touch from Omid's mace-key causes the shackles to fall off, freeing [the Stranger](Mechanics/bestiary/npc/the-stranger-kftgv.md).

[The Stranger](Mechanics/bestiary/npc/the-stranger-kftgv.md) is initially indifferent to the characters but becomes friendly if presented with the prospect of escape, at which point [the Stranger](Mechanics/bestiary/npc/the-stranger-kftgv.md) replies in a gravelly voice:
...
[The Stranger](Mechanics/bestiary/npc/the-stranger-kftgv.md) promises to recite the true names the characters seek in exchange for freedom but warns them of the heavy toll such knowledge carries.

If the characters are after the true names of Karnyros, Errtok, and Hexalanthe, [the Stranger](Mechanics/bestiary/npc/the-stranger-kftgv.md) reveals the following once free of the [dimensional shackles](Mechanics/items/dimensional-shackles.md) and outside the cell:
...
If the characters are after the true name of some other creature, perhaps a fiendish nemesis or tenuous planar ally, [the Stranger](Mechanics/bestiary/npc/the-stranger-kftgv.md) might know that creature's true name as well and can reveal it to the characters. Even if [the Stranger](Mechanics/bestiary/npc/the-stranger-kftgv.md) doesn't know a particular true name, they can give characters the true names of one or more Fiends who have the power to help the characters in some other way.
...
Inside the car, two [monodrones](Mechanics/bestiary/construct/monodrone.md) stoke the fire in the furnace by shoveling loot into it from a nearby cart (see "Treasure" below). A [shield guardian](Mechanics/bestiary/construct/shield-guardian.md) stands next to the cart, guarding the treasure from thieves. Thanks to its Spell Storing trait, the guardian can cast [sleep](Mechanics/spells/sleep.md) (4th-level version) once.

![A monodrone shovels treasu...](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/KftGV/088-11-006.monodrone-engineer.webp#center "A monodrone shovels treasure into the locomotive's engine")
...
The furnace door can be latched from the outside. A creature trapped inside the furnace can use an action to try to force open the door, doing so with a successful DC 20 Strength ([Athletics](Mechanics/Rules/skills.md#Athletics)) check.

#### Treasure

The treasure cart contains 3,500 gp, 6,000 sp, and 1,200 cp. Scattered among the coins are the following items:

- Five [amethysts](Mechanics/items/amethyst.md) (100 gp each)  
- Gilded mind flayer skull (150 gp)  
- [Horn of Valhalla (silver)](Mechanics/items/horn-of-valhalla-silver.md)  
- Suit of [mithral armor (chainmail)](Mechanics/items/mithral-armor.md)  
- [Potion of healing (greater)](Mechanics/items/potion-of-greater-healing.md)  
- Silvered [+3 greatsword](Mechanics/items/3-weapon.md) that once belonged to a githyanki knight  

## Conclusion

After imparting the true names, the freed Stranger tips their hat and leaps from the train. Once out of range of the train's teleportation ward, [the Stranger](Mechanics/bestiary/npc/the-stranger-kftgv.md) casts [plane shift](Mechanics/spells/plane-shift.md) and disappears. The characters can leave the Concordant Express in a similar fashion, or they can remain on the train until it arrives in Mechanus and secure safe passage home from there. Whether or not they helped solve the murder in the Passenger Car (area E7), characters who disembark in Mechanus see [Ignatius Inkblot](Mechanics/bestiary/npc/ignatius-inkblot-kftgv.md), the mind flayer detective, escorting the cambion Abernathy Vernus off the train and into the waiting arms of a group of modrons.
...
If the characters helped solve the murder mystery aboard the Concordant Express, the mind flayer detective [Ignatius Inkblot](Mechanics/bestiary/npc/ignatius-inkblot-kftgv.md) uses its [plane shift](Mechanics/spells/plane-shift.md) spell to deliver a wrapped parcel to the characters several days later. The parcel contains a token of the illithid's esteem: a masterfully crafted magnifying glass worth 1,000 gp.
...
- **Slayer's Weapon.** A master smith might be able to work the true name of a creature into an [arrow of slaying](Mechanics/items/arrow-of-slaying.md) or other target-specific magic item.  
