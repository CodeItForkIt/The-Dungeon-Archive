...
![Stilt Walker](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/WBtW/040-02-003.stilt-walker.webp#center)
...
A suit becomes inanimate and collapses in a heap if its helmet is removed, if it is reduced to 0 hit points, or if the characters leave the area. Removing a suit's helmet while the armor is animated requires an action and a successful DC 10 Dexterity ([Sleight of Hand](Mechanics/Rules/skills.md#Sleight%20of%20Hand)) check.
...
If the characters are hostile, the trees do what they can to drive the invaders off the hill. If the trees are not met with violence, they shepherd the characters up the hill to [Jingle Jangle](Mechanics/bestiary/npc/jingle-jangle-wbtw.md)'s den, waving them on with their branches. Characters who stray from the path are met by `1d6` additional awakened trees. These trees don't attack but join in coaxing the characters up the hill.
...
Appendix D has additional roleplaying notes for [Jingle Jangle](Mechanics/bestiary/npc/jingle-jangle-wbtw.md).
...
If they are asked about [Bavlorna Blightstraw](Mechanics/bestiary/npc/bavlorna-blightstraw-wbtw.md) or Downfall, the harengons share the following information:
...
Inside the cauldron is a bubbling, frothy, gray-black liquid that radiates an aura of transmutation magic under the scrutiny of a detect magic spell. Any creature that drinks a pint or more of the liquid is targeted by a [polymorph](Mechanics/spells/polymorph.md) spell (save DC 14) that lasts for 1 hour. The creature is transformed into either a [giant frog](Mechanics/bestiary/beast/giant-frog.md) (75 percent chance) or a [giant dragonfly](Mechanics/bestiary/beast/giant-dragonfly-wbtw.md) (25 percent chance; see appendix C).
...
- **Floors and Stairs.** Floors and staircases are made of mossy wooden planks that creak, groan, and bend underfoot. Crossing a floor or using a staircase without making noise requires a successful DC 15 Dexterity ([Stealth](Mechanics/Rules/skills.md#Stealth)) check.  
...
> 
> Bavlorna's paranoia leads her to rely primarily on servants that she creates herself. The most common among them are her lornlings (use the [quickling](Mechanics/bestiary/fey/quickling-mpmm.md) stat block in appendix C). These tiny creatures look like miniature versions of Bavlorna. They are quick and flit about the cottage at her bidding.
^bavlornas-lornlings
...
> [!gallery]
> ![Bavlornas Cottage](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/WBtW/049-map-2.4-bavlornas-cottage.webp#gallery)
> ![Player Version](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/WBtW/050-map-2.4-bavlornas-cottage-player.webp#gallery)
...
Stairs lead down into the pool from one corner of the surrounding walkway. Bavlorna tries to bathe in the pool once a day to keep her skin from drying out and cracking, but the well that supplies the water has stopped working. Characters who peer into the well can see that it is filled with calm water almost to the brim. Bavlorna doesn't know it, but the cause of the faulty well is a 10-foot-high gelatinous cylinder (use the [gelatinous cube](Mechanics/bestiary/ooze/gelatinous-cube.md) stat block) that's blocking the normal flow of water. The creature's presence has also contaminated the water above it, rendering it mildly acidic—not enough to cause damage, but enough to make one's skin tingle uncomfortably. A character who experiences this tingling can, with a successful DC 15 Intelligence ([Nature](Mechanics/Rules/skills.md#Nature)) check, ascertain that something akin to a gelatinous cube has lodged itself in the well.

The gelatinous cylinder lurks 10 feet down inside the well and is [invisible](Mechanics/Rules/conditions.md#Invisible) in the water. It attacks any creature and dissolves any organic material that comes in contact with it. If a creature lowers itself into the water, attacks the ooze from above, and then exits the well, the gelatinous cylinder squirms up the shaft in pursuit, emerging from the well and thus unplugging it. The cylinder is 10 feet high and 10 feet in diameter. When it is lured out of the well or killed, the flow of water resumes in a torrent, filling the pool to a depth of 3 feet in 1 minute.

###### Treasure

The lily pad floating on the water is a magic item called a [bobbing lily pad](Mechanics/items/bobbing-lily-pad-wbtw.md) (see appendix A). Bavlorna is attuned to it currently.
...
Bavlorna's name is scrawled on one side of the crate. Lifting the lid releases a harmless swarm of flies. The crate contains the carcass of a curled-up, eight-legged reptile with spikes running down its back. With a successful DC 15 Intelligence ([Nature](Mechanics/Rules/skills.md#Nature)) check, a character can determine that it's the carcass of a basilisk.

###### Worktable

Along with the tools and specimens, the table has a small box with drawers that contain glass eyes. One of the eyes is made of wood, and it belongs to Bavlorna's sister, [Skabatha Nightshade](Mechanics/bestiary/npc/skabatha-nightshade-wbtw.md) (see chapter 4).
...
If [Sir Talavar](Mechanics/bestiary/npc/sir-talavar-wbtw.md) the faerie dragon was recaptured and brought here, he remains trapped in his cage, which hangs from a hook protruding from a wall next to the cupboard.

The cupboard is locked but can be unlocked by rotating the circular panel so that the hourglass sigil is turned upside down. Characters who examine the sigil can ascertain, with a successful DC 10 Intelligence ([Investigation](Mechanics/Rules/skills.md#Investigation)) check, that it can be manipulated safely.
...
If anyone steps onto the balcony, the hundreds of harmless [frogs](Mechanics/bestiary/beast/frog.md) on the balcony croak in unison, alerting Bavlorna wherever she happens to be in the cottage. If one or more of the frogs are killed, the rest leap into the lake below.

If she hears the croaking frogs, Bavlorna sends three of her lornlings (use the [quickling](Mechanics/bestiary/fey/quickling-mpmm.md) stat block in appendix C) to investigate and report back to her. They avoid combat.
...
A [detect magic](Mechanics/spells/detect-magic.md) spell reveals an aura of transmutation magic around this mirror. The mirror's frame is stuck to the wall with [sovereign glue](Mechanics/items/sovereign-glue.md), and the mirror can't be removed without destroying it. The mirror alters the reflection of any creature that gazes into it, rendering the reflection bereft of expression or emotion, except if a creature smiles into the mirror. In that case, the creature's reflection also smiles, and a secret door in the wall holding the mirror swings inward, revealing a hidden passage (area B9).

Any character who examines the wall behind the mirror and succeeds on a DC 10 Wisdom ([Perception](Mechanics/Rules/skills.md#Perception)) check sees the edges of the secret door, which can also be forced open with a [knock](Mechanics/spells/knock.md) spell or similar magic. Bavlorna can open the secret door without having to smile or use magic.
...
The secret door leading to area B7 is easily spotted from this side but requires a [knock](Mechanics/spells/knock.md) spell or similar magic to open. Only Bavlorna can open the secret door without using magic.
...
The toad-like creature is [Bavlorna Blightstraw](Mechanics/bestiary/npc/bavlorna-blightstraw-wbtw.md) (see appendix B), and she is joined by two of her lornlings (use the [quickling](Mechanics/bestiary/fey/quickling-mpmm.md) stat block in appendix C). Bavlorna has not submerged herself in her preservation pool in some time, and her skin is brittle and cracked. If she has been warned about intruders, Bavlorna fixes her bulging eyes on the characters as they come into view:
...
The tall, slender figure in black is Charm, a [darkling elder](Mechanics/bestiary/fey/darkling-elder-mpmm.md) (see appendix C) who works for [Endelyn Moongrave](Mechanics/bestiary/npc/endelyn-moongrave-wbtw.md) as a thief but poses as a traveling merchant. When the characters arrive, Charm is gossiping with Bavlorna about the hag's sisters, Endelyn and Skabatha. The conversation is a distraction, buying time for Charm's shadow to perpetrate a heist in area B19. Characters who have a passive Wisdom ([Perception](Mechanics/Rules/skills.md#Perception)) score of 13 or higher notice that the black-clad figure doesn't cast a shadow. This is not a trait that darklings possess, but rather the result of Endelyn's using her [scissors of shadow snipping](Mechanics/items/scissors-of-shadow-snipping-wbtw.md) (see appendix A) to cut loose Charm's shadow and transform it into a separate creature. See chapter 4 for more information on Endelyn and her magic scissors.

![Charm, a darkling elder, s...](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/WBtW/051-02-009.charm.webp#center "Charm, a darkling elder, sips tea in Bavlorna's cottage")
...
If Bavlorna feels threatened, or if a fight turns against her, she flees to Thither on her [bobbing lily pad](Mechanics/items/bobbing-lily-pad-wbtw.md) (in area B1) and reluctantly takes refuge with her older sister, Skabatha (see chapter 3 for details).
...
- The bottom shelf holds three magic potions with labels in Elvish: a [potion of diminution](Mechanics/items/potion-of-diminution.md) labeled "Shrink," a [potion of growth](Mechanics/items/potion-of-growth.md) labeled "Grow," and a [potion of invisibility](Mechanics/items/potion-of-invisibility.md) labeled "Vanish."  
- The top shelf holds a stuffed cat that shambles to life when the cabinet is opened. The cat formerly belonged to Bavlorna's sister, Endelyn. (She suspects Bavlorna stole the cat, but she has no proof.) The cat, [Gloam](Mechanics/bestiary/npc/gloam-wbtw.md), is hostile toward all creatures except Bavlorna. It uses the [cat](Mechanics/bestiary/beast/cat.md) stat block, except it is an Undead, has immunity to poison damage, and is immune to [exhaustion](Mechanics/Rules/conditions.md#Exhaustion) and the [poisoned](Mechanics/Rules/conditions.md#Poisoned) condition. On its first turn in combat or when it is reduced to 0 hit points, the cat expels a cloud of dust that acts as [dust of sneezing and choking](Mechanics/items/dust-of-sneezing-and-choking.md).  
...
On the pedestals are cages that hold seven birds, each of which has the head of one avian species and the body of another. They squawk and flutter about anxiously if the drapes covering their cages are removed. Each bird uses the [hawk](Mechanics/bestiary/beast/hawk.md) stat block, except it is an Undead, has immunity to poison damage, and is immune to [exhaustion](Mechanics/Rules/conditions.md#Exhaustion) and the [poisoned](Mechanics/Rules/conditions.md#Poisoned) condition.
...
Two of Bavlorna's lornlings (use the [quickling](Mechanics/bestiary/fey/quickling-mpmm.md) stat block in appendix C) hide in the mouths of the severed goblin heads mounted above the doors. Any character who peers into one of these gaping mouths spots the lornling hidden in it. The lornling stares back at the character but doesn't attack.
...
The ball of light floating near the 20-foot-high ceiling is a [will-o'-wisp](Mechanics/bestiary/undead/will-o-wisp.md), which drifts down toward the characters if they move into the room. It attacks only if they try to remove the chest or any of its contents from the room without first opening the chest using the proper key (see "Thirsty Plants" and "Treasure" below). If reduced to 10 hit points or fewer, the will-o'-wisp turns [invisible](Mechanics/Rules/conditions.md#Invisible) and tries to flee; if it escapes, it flies to Bavlorna and warns her about the intruders in her bedchamber.
...
Bavlorna's sister, [Endelyn Moongrave](Mechanics/bestiary/npc/endelyn-moongrave-wbtw.md), covets the spool of thread and has sent Charm to steal it. The thread is the color of frustration and self-doubt, as perceived by the beholder (meaning that each creature sees the thread's color as the hue it associates most with such emotions), and it confers these feelings on anyone who wears garments sewn with it. Even touching the thread evokes these negative emotions.
...
![What treasures are hidden ...](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/WBtW/052-02-010.treasures.webp#center "What treasures are hidden in the mouth of the bronze frog? There's only one way to find out!")
...
The characters might travel to Thither to fulfill the terms of a bargain they struck with Bavlorna, in which case the hag grants them permission to use the balloon in area D2. (If that balloon was destroyed, an undamaged one just like it arrives in Downfall, piloted by a [bullywug knight](Mechanics/bestiary/humanoid/bullywug-knight-wbtw.md) named Dumphrey Frogart.) Either Dumphrey or Morgort is happy to serve as a balloon pilot, though the bullywug parts company with the characters once they are safely delivered to Thither.

To reach Thither, the characters need [Clapperclaw the scarecrow](Mechanics/bestiary/npc/clapperclaw-the-scarecrow-wbtw.md) (see area D5) to guide them. If Clapperclaw is unable or unwilling to help the characters, substitute another helpful creature, such as Morgort the bullywug knight or Vansel the satyr.