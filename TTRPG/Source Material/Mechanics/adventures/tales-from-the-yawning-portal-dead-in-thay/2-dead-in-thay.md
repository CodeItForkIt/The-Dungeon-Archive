...
![Map 5.2: Player Map](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/TftYP-DiT/002-dit02.webp#center)
...
Issem, a pale human [vampire](Mechanics/bestiary/undead/vampire.md) in lavish clothes, is normally in this area, watching battles.
...
A character who succeeds on a DC 10 Intelligence ([Arcana](Mechanics/Rules/skills.md#Arcana)) check can tell that the rift is channeling elemental forces. If the check succeeds by 5 or more, the character knows that the rift is dangerous and is channeling extraplanar elemental forces.
...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/TftYP-DiT/009-totyp-05-10.webp#center)
...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/TftYP-DiT/010-totyp-05-11a.webp#center)
...
**Cell B**. One Red Wizard [evoker](Mechanics/bestiary/humanoid/evoker-wizard-mpmm.md) sleeps here.
...
Resting in this chamber are a Thayan warrior and a Dread Legion squad made up of five [orcs](Mechanics/bestiary/humanoid/orc.md) and five [gnolls](Mechanics/bestiary/humanoid/gnoll.md). A [troll](Mechanics/bestiary/giant/troll.md) is on post here to keep the other legionnaires in line.
...
![Map 5.6: Far Realm Cysts](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/TftYP-DiT/012-dit06.webp#center)
...
The shimmering light here has affected two [wights](Mechanics/bestiary/undead/wight.md), two dread warriors, and six [zombies](Mechanics/bestiary/undead/zombie.md). They attack if the trap's effect on them ends.
...
A [dispel magic](Mechanics/spells/dispel-magic.md) spell suppresses the light's effect for 10 minutes. Any spell that overwhelms or blocks the light also suppresses it in the spell's area for the duration of the spell.
...
Eight [zombies](Mechanics/bestiary/undead/zombie.md) and two [ogre zombies](Mechanics/bestiary/undead/ogre-zombie.md) attack any intruders. Any combat warns Thaxalia (area 39) of the approach of intruders.

##### Sinkholes

These open sinkholes are 5 feet across and 10 feet deep. A creature that falls into a sinkhole is [restrained](Mechanics/Rules/conditions.md#Restrained) in the narrow bottom. It takes a successful DC 13 Strength check or Dexterity check to work free, and a Small creature has advantage on this check. It's then an easy matter to climb out of the sinkhole.
...
Thaxalia, a reduced-threat [beholder](Mechanics/bestiary/aberration/beholder.md) (see "Reduced-Threat Monsters" above) crippled by Thayan magic, floats near the ceiling, trying to remain unnoticed while intruders enter. Thaxalia's central eye and two of its eyestalks have been maimed by the Red Wizards, rendering those eye rays (death ray and disintegration) powerless. If it has warning or is reduced to 50 hit points or fewer, it withdraws to area 40, leaving its spawn to deal with the threat.
...
Fearing Thaxalia's ability to wreak havoc if it escapes this zone, the Red Wizards cursed the beholder with the inability to use glyph keys. Thaxalia doesn't know the solution, but a [remove curse](Mechanics/spells/remove-curse.md) spell can eliminate the prohibition. The beholder then takes a glyph key from the wight in area 40 and asks the characters to provide it with more attunements. If refused, it becomes hostile and uses its powers to compel the characters to give it more attunements.
...
| 4–5 | *Telekinesis*. The target is pushed 5 feet in a random direction and falls [prone](Mechanics/Rules/conditions.md#Prone). |
...
| 8 | *Sleep*. The target falls [unconscious](Mechanics/Rules/conditions.md#Unconscious) until the start of its next turn. |
^2-eye-ray

##### Slime

Covering the rough floor is 1 foot of thick slime, which is difficult terrain and covers several hidden sinkholes. Any creature that starts its turn [prone](Mechanics/Rules/conditions.md#Prone) in or submerged in the slime takes 4 (`1d8`) poison damage.

##### Sinkholes

These open sinkholes are 5 feet across and 10 feet deep, and they are filled with slime. While moving near a sinkhole, a character who succeeds on a DC 20 [Perception](Mechanics/Rules/skills.md#Perception) check notices the hazard due to the flow of slime in and around it. A creature that falls into a sinkhole is [restrained](Mechanics/Rules/conditions.md#Restrained) in the narrow bottom and submerged in slime, unable to breathe. It takes a successful DC 15 Strength check or Dexterity check to work free, and a Small creature has advantage on this check. It then takes a successful DC 10 Strength check to climb out of the sinkhole.
...
Covering the rough floor is 1 foot of thick slime. Any creature that starts its turn [prone](Mechanics/Rules/conditions.md#Prone) in the slime takes 4 (`1d8`) poison damage.
...
Viewed with [detect magic](Mechanics/spells/detect-magic.md), the area has an aura of necromancy. When non-undead creatures regain hit points in this zone, they regain only half as many.
...
Twenty unarmed [skeletons](Mechanics/bestiary/undead/skeleton.md) stand here, waiting to cart refuse that arrives from other areas through the black gate. They attack only if attacked.
...
Four [gricks](Mechanics/bestiary/monstrosity/grick.md) climb and wander on the top two steps, while two [gibbering mouthers](Mechanics/bestiary/aberration/gibbering-mouther.md) lurk on the third. One [grell](Mechanics/bestiary/aberration/grell.md) starts out flying above area 45. Six prisoners hide among the ledges, trying to avoid the aberrant monsters.
...
The top of the altar slab shows the shadowy outlines of a dozen weapons, pendants, and other objects. An [identify](Mechanics/spells/identify.md) spell reveals that the altar imparts additional power into magic items placed on its surface. The caster must succeed on a DC 20 Intelligence ([Arcana](Mechanics/Rules/skills.md#Arcana)) check to further discern that when an item is empowered, the altar also draws in the life force of creatures near it.
...
When a magic item is transformed, randomly select one character within 50 feet of the altar. That person's soul is drawn into the item, and he or she drops into a deathlike coma, requiring a successful DC 15 Wisdom ([Medicine](Mechanics/Rules/skills.md#Medicine)) check to realize that the victim is still alive. An [identify](Mechanics/spells/identify.md) spell can be used to discern the whereabouts of the soul and how to cure the condition, temporarily or permanently.

Placing the transformed magic item in the victim's hand temporarily ends the coma. Thereafter, the character must continue to hold the object in hand or fall into a coma again. If the character breaks contact with the object for 1 hour, or if the object is destroyed, the character dies. [Remove curse](Mechanics/spells/remove-curse.md), [greater restoration](Mechanics/spells/greater-restoration.md), or equivalent magic breaks the bond, returning the soul to its rightful place.
...
![Map 5.7: Forests of Slaughter](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/TftYP-DiT/013-dit07.webp#center)
...
Eight [cockatrices](Mechanics/bestiary/monstrosity/cockatrice.md) roost on the ledges. They make no attempt to hide, and they attack as soon as they realize the characters have no food for them.
...
Two adult [gorgons](Mechanics/bestiary/monstrosity/gorgon.md) attack intruders on sight, pursuing those who flee into area 46. Any hook horrors there attack only if the intruders slay or drive off the gorgons.
...
Two barghests lurk in the tall grass. A character who succeeds on a DC 20 Wisdom ([Perception](Mechanics/Rules/skills.md#Perception)) check spots one or more of them. These creatures hesitate to attack only if the characters seem to be Thayans.
...
The pool's magic grants non-undead creatures that drink from it the benefits of finishing a short rest. A creature can drink from the pool safely only once per tenday. The second time the creature drinks in a tenday, its hit point maximum is halved for one tenday ([remove curse](Mechanics/spells/remove-curse.md) negates this effect). The third time the creature drinks in a tenday, it suffers the effects of a [harm](Mechanics/spells/harm.md) spell (save DC 15).
...
Two adult [displacer beasts](Mechanics/bestiary/monstrosity/displacer-beast.md) dwell here with three reduced-threat displacer beasts (see "Reduced-Threat Monsters" above). Each creature sits atop a different bone mound, and they all attack when it becomes clear that the characters have not brought food.
...
The four adult [perytons](Mechanics/bestiary/monstrosity/peryton.md) and four reduced-threat perytons (see "Reduced-Threat Monsters" above) that roost here have grown tired of their pork diet. If the characters don't appear to be Thayans, or if they fail to offer food within a few moments, the perytons attack.
...
A [behir](Mechanics/bestiary/monstrosity/behir.md) spends its days sleeping and eating in this chamber. The creature is asleep or otherwise preoccupied when the characters come here. It doesn't attack unless provoked.
...
The ground seems to be covered with the tracks of large deer or elk, but a successful DC 25 Intelligence ([Nature](Mechanics/Rules/skills.md#Nature)) check reveals that these tracks are those of leucrottas.

##### Creatures

Four [leucrottas](Mechanics/bestiary/monstrosity/leucrotta-mpmm.md) lurk here among the trees. They make noises that sound like the calls of pained humans, which their handlers normally ignore. The creatures gleefully attack anyone they succeed in tricking.
...
The gnawed bones of six humans are here. Each has crushed neck vertebrae, which someone can discern with a successful DC 15 Wisdom ([Medicine](Mechanics/Rules/skills.md#Medicine)) check.

##### Creatures

Six [chokers](Mechanics/bestiary/aberration/choker-mpmm.md) live here, two lurking in each of the two treed areas near the pool and two on the walls near the pool. They wait and watch, attacking when the characters move within reach, which their handlers rarely do. The chokers in the trees try to pull victims into the treed areas.
...
Two adult [owlbears](Mechanics/bestiary/monstrosity/owlbear.md) and three reduced-threat owlbear young (see "Reduced-Threat Monsters" above) lurk among the trees here. They wait long enough to see if food is being handed out, and they attack if none seems forthcoming. The young are hidden, and they join the fight from the flanks after their parents attack.
...
![Map 5.8: Ooze Grottos](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/TftYP-DiT/014-dit08.webp#center)
...
Three sentient ochre jellies and a [wight](Mechanics/bestiary/undead/wight.md) guard this area. The wight confronts anyone who enters but stands down if the characters look like Thayans and give a credible reason for being here. Otherwise, the creatures attack.
...
Two [deathlock wights](Mechanics/bestiary/undead/deathlock-wight-mpmm.md) with buckets and stone boots move among dozens of skeletons. They pour steaming ooze over the bones. Two sentient ochre jellies and two sentient gray oozes are pooled near the benches.
...
Two [deathlock wights](Mechanics/bestiary/undead/deathlock-wight-mpmm.md) and four [skeletons](Mechanics/bestiary/undead/skeleton.md) move among the vats, using *ooze prods* to poke the mixtures. They challenge any intruders. If the undead become distracted, oozes might attack (see "Vat System" below).

Sarkalla, a Red Wizard transmuter, is working behind the black curtain, but she peeks out in response to the wights' challenge. She whispers to order the lead wight to attack. A character who succeeds on a DC 20 Wisdom ([Perception](Mechanics/Rules/skills.md#Perception)) check notices Sarkalla while she does so.
...
A creature that enters the necrotic essence for the first time on a turn, or starts its turn there, takes 5 (`2d4`) necrotic damage and must succeed on a DC 11 Constitution saving throw or become [paralyzed](Mechanics/Rules/conditions.md#Paralyzed) until the start of its next turn.
...
Sarkalla's table and shelves contain two pieces of lore, four [spell scrolls](Mechanics/items/spell-scroll-dmg.md) (two each of [dispel magic](Mechanics/spells/dispel-magic.md) and [greater restoration](Mechanics/spells/greater-restoration.md)), a [potion of greater healing](Mechanics/items/potion-of-greater-healing.md), a [potion of heroism](Mechanics/items/potion-of-heroism.md), and six valuable tomes on underground exploration and natural history (worth 120 gp each).
...
The black pillar is infused with psionic energy. Any creature that touches it for the first time on a turn takes 9 (`2d8`) psychic damage and is knocked [prone](Mechanics/Rules/conditions.md#Prone).
...
The Ooze Master is a sort of lich. If destroyed, he remains in the red pillar but doesn't regain consciousness. His [unconscious](Mechanics/Rules/conditions.md#Unconscious) form whispers as if dreaming. The Ooze Master dies only if the Phylactery Vault is disabled at the end of the adventure.
...
Silvery calm water forms this highly reflective, 1-foot-deep pool. Until a character looks into the pool and notices its mirrorlike nature, it takes a successful DC 20 Wisdom ([Perception](Mechanics/Rules/skills.md#Perception)) check to notice that quality.
...
Any character who studies the room for a moment and succeeds on a DC 10 Wisdom ([Perception](Mechanics/Rules/skills.md#Perception)) check notices that all the cots and lights are 10 feet or more away from the walls.

##### Creatures

One Red Wizard transmuter and three Thayan apprentices sleep here. When roused, they tip the cots over and cast their spells from behind cover. They try to force or draw the characters close to the walls and the magic mirrors, hoping to summon the deadly defenders of this area.

##### Cursed Mirrors

Cursed mirrors are on all the walls except those within 5 feet of the exit points, including the black gate and the secret door. Conjuration magic in the mirrors works such that any living humanoid that moves within 5 feet of one must succeed on a DC 15 Wisdom saving throw, or a howling [specter](Mechanics/bestiary/undead/specter.md) emerges from the mirror to attack. Once they have collectively called forth five undead, the mirrors all become dormant for 1 hour.
...
The 3-foot-thick, 15-foot-diameter arch is a former trap imbued with enchantment magic. The Red Wizards suppressed the magic, but they couldn't do away with it completely. Any non-undead creature that starts its turn within 5 feet of the arch must succeed on a DC 15 Wisdom saving throw or be compelled to run through the opening (a creature ignores this effect if immune to being [charmed](Mechanics/Rules/conditions.md#Charmed)).
...
One Red Wizard transmuter oversees two Thayan apprentices in this cavern. They walk a circuit around the pools, carefully jabbing down into them with the *ooze prods* they carry.
...
One Red Wizard transmuter and two dread warriors watch from near the eastern wall as four Thayan warriors battle a [gelatinous cube](Mechanics/bestiary/ooze/gelatinous-cube.md). Two of the four warriors have been engulfed, and all are at half hit points (as is the ooze). If the wizard notices the characters aren't Thayan, he orders the others to attack them instead. The cube views everyone in the area as a foe.
...
![Map 5.9: Predator Pools](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/TftYP-DiT/015-dit09.webp#center)
...
The turtle knows that Ihanvas, the naga overseer of this zone, dwells in area 76. It can be persuaded with a successful DC 17 Charisma ([Persuasion](Mechanics/Rules/skills.md#Persuasion)) check to fight the naga if it is lured into this chamber.

##### Chains

Magic infuses the chains, which are long enough to allow the dragon turtle free run of the chamber. When the dragon turtle moves, any creature within 10 feet of its path must succeed on a DC 12 Dexterity saving throw or be knocked [prone](Mechanics/Rules/conditions.md#Prone).
...
Ihanvas, the [spirit naga](Mechanics/bestiary/monstrosity/spirit-naga.md) overseer of this zone, is eating a prisoner. The naga attacks any intruders. Ten [commoners](Mechanics/bestiary/humanoid/commoner.md) also linger in the pools here. Ihanvas's Charisma, combined with the magic water, has turned them into the naga's willing devotees. They defend their master in any battle.
...
Hidden at the bottom of the pools' connecting tunnel, Ihanvas's treasure includes 200 pp, five tourmaline jewels (100 gp each), [+1 plate](Mechanics/items/1-armor.md) and a sealed ivory case that holds seven [spell scrolls](Mechanics/items/spell-scroll-dmg.md) (two each of [detect magic](Mechanics/spells/detect-magic.md), [identify](Mechanics/spells/identify.md), and [lesser restoration](Mechanics/spells/lesser-restoration.md), and one of [remove curse](Mechanics/spells/remove-curse.md)).
...
Two [trolls](Mechanics/bestiary/giant/troll.md), a male and a larger female, lurk in the pool. These trolls are of an aquatic variety known as scrags. In addition to the statistics of a normal troll, each has a swim speed of 30 feet and can breathe underwater.
...
Eight [ghouls](Mechanics/bestiary/undead/ghoul.md) here float like corpses in the water until they catch the scent of non-undead creatures. These ghouls are of an aquatic variety known as [lacedons](Mechanics/bestiary/undead/lacedon-tftyp.md). In addition to the statistics of a normal ghoul, each has a swim speed of 30 feet.
...
Four [merrow](Mechanics/bestiary/monstrosity/merrow.md) entertain themselves by decorating their lair and chewing bones.

##### Pool

The magic of the pool has failed, and the water is filthy. Any non-undead creature that starts its turn in the pool must succeed on a DC 10 Constitution saving throw or be [poisoned](Mechanics/Rules/conditions.md#Poisoned) until the start of its next turn.
...
Blue glowing water in this zone is spawning essence, the transmutation magic of which causes spawn to grow quickly and strengthens their predatory nature. A creature that drinks spawning essence gains the benefit of finishing a short rest. A humanoid can safely gain this benefit only once per tenday. If a creature drinks again within that time, it gains no benefit and must succeed on a DC 15 Wisdom saving throw or suffer the effects of a [confusion](Mechanics/spells/confusion.md) spell for 1 minute. The creature can repeat the saving throw at the end of each of its turns, ending the effect on itself on a successful save.
...
Five [kuo-toa](Mechanics/bestiary/humanoid/kuo-toa.md) are on guard. Another four are sleeping on the bottom of the pool. All of them are loyal to Thay and expect to be asked to escort those who pass through this area. They attack anyone who makes no such request.
...
A dread warrior, two [wights](Mechanics/bestiary/undead/wight.md), and four [zombies](Mechanics/bestiary/undead/zombie.md) guard this area. They attack anyone who isn't escorted by kuo-toa or the sea hag, pursuing such interlopers to any area of the zone.
...
Two male [merrow](Mechanics/bestiary/monstrosity/merrow.md) dwell in the south pool. A [sea hag](Mechanics/bestiary/fey/sea-hag.md) named Tanjus luxuriates under the surface of the north pool with her pets, six [giant crabs](Mechanics/bestiary/beast/giant-crab.md). She oversees the spawning pools in this zone and yearns to overthrow Ihanvas (area 76) for control of the Predator Pools and theirmonsters.
...
A magic circle is scribed on the bottom of the north pool. It's a combination summoning circle and teleportation circle, but it's currently dormant. A spellcaster who succeeds on three DC 20 Intelligence ([Arcana](Mechanics/Rules/skills.md#Arcana)) checks can reactivate the circle's conjuration magic. The character then becomes aware that the circle allows teleportation to the sea floor off Bezantur, deep down in the Sea of Fallen Stars.

##### Debris Pile

Any creature that starts its turn in this disgusting pile, which is difficult terrain, must succeed on a DC 10 Constitution saving throw or be [poisoned](Mechanics/Rules/conditions.md#Poisoned) until the start of its next turn. Creatures that live in this zone are immune to this effect.
...
Tanjus has a black pearl (500 gp), a golden gorget set with aquamarines (1,000 gp), and a [staff of charming](Mechanics/items/staff-of-charming.md).

A character who succeeds on a DC 15 Wisdom ([Perception](Mechanics/Rules/skills.md#Perception)) check while searching the debris discovers five [potions of water breathing](Mechanics/items/potion-of-water-breathing.md) and two [spell scrolls](Mechanics/items/spell-scroll-dmg.md) of [water walk](Mechanics/spells/water-walk.md).
...
Six [sahuagin](Mechanics/bestiary/humanoid/sahuagin.md) swim along the surface around the edge of the pool, while a [sahuagin baron](Mechanics/bestiary/humanoid/sahuagin-baron.md) and two [hunter sharks](Mechanics/bestiary/beast/hunter-shark.md) swim deeper down.
...
The tops of the pillars are even with the floor around the edge of the pool, so they protrude 1 foot above the surface of the water. The remnants of an old magical trap exist in the three pillars marked with an X on the map. A creature that ends its turn touching the top of one of those pillars must succeed on a DC 15 Constitution saving throw or become [paralyzed](Mechanics/Rules/conditions.md#Paralyzed) for 1 minute. A [paralyzed](Mechanics/Rules/conditions.md#Paralyzed) creature slips into the water and sinks to the bottom of the pool. The creature can repeat the saving throw at the end of each of its turns, ending the effect on itself on a successful save.

##### Treasure

The baron wears [+1 leather armor](Mechanics/items/1-armor.md) (shark skin and chitin) and a crown-like helm of ivory, coral, leather, and gold (worth 500 gp).

At the bottom of the pool is a stone coffer that contains a stash of 100 pp and eight large pearls (100 gp). It also has a crystal phial that contains a [potion of diminution](Mechanics/items/potion-of-diminution.md).
...
Four [sahuagin](Mechanics/bestiary/humanoid/sahuagin.md) stand and chant along with a [sahuagin priestess](Mechanics/bestiary/humanoid/sahuagin-priestess.md) on the altar pillar. Another five sahuagin and two [hunter sharks](Mechanics/bestiary/beast/hunter-shark.md) dwell in the pool. A [commoner](Mechanics/bestiary/humanoid/commoner.md) is bound on the altar.

The chanting that precedes the sacrifice takes 3 rounds to complete. If the characters deal at least 20 damage to the priestess in that time, she breaks off the ritual to lead a counterattack. Otherwise, the prisoner is slain and thrown to the sharks. Any sahuagin on the altar then gains the effects of the [aid](Mechanics/spells/aid.md) and [bless](Mechanics/spells/bless.md) spells.
...
The priestess carries a [dagger of venom](Mechanics/items/dagger-of-venom.md) and wears a headdress of ivory, coral, leather, and gold (worth 500 gp).
...
A dread warrior keeps watch with seven [skeletons](Mechanics/bestiary/undead/skeleton.md). They do little but confront creatures moving toward or appearing from either magic gate. The characters can enter and leave this area from the east without fighting, even with the prisoners in tow.

Part of the deal the Red Wizards struck with the sahuagin involves providing prisoners for dark rites and horrid meals. The magic of the black shrine keeps ten [commoners](Mechanics/bestiary/humanoid/commoner.md) standing around it in a catatonic state.

##### Black Shrine

Any non-undead creature that moves to within 20 feet of the black shrine or ends its turn in such a location must make a DC 15 Intelligence saving throw. On a failed save, the necromancy magic of the shrine lowers the creature's Intelligence, Wisdom, and Charisma scores by `1d6` each (roll once for all three). A creature can be affected only once per round. If any affected score is reduced to 2 or lower, the character becomes [paralyzed](Mechanics/Rules/conditions.md#Paralyzed). A character who leaves the area recovers in 1 minute.
...
![Map 5.10: Golem Laboratories](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/TftYP-DiT/016-dit10.webp#center)

### Golems

If a golem is inactive, it is [unconscious](Mechanics/Rules/conditions.md#Unconscious). If a golem is listed as being a reduced-threat monster, it is because the construct is incomplete.
...
A Red Wizard [necromancer](Mechanics/bestiary/humanoid/necromancer-wizard-mpmm.md) and two Thayan apprentices are in this area, moving among the tables working or selecting parts. Four [skeletons](Mechanics/bestiary/undead/skeleton.md) keep watch from the corners, while a [ghoul](Mechanics/bestiary/undead/ghoul.md) mops gore from the floors. Golems in this area can't be activated and are no threat.

##### Treasure

One table contains special unguents and bindings used in the creation of the golems. A character who succeeds on a DC 15 Intelligence ([Arcana](Mechanics/Rules/skills.md#Arcana)) check realizes that these materials, which weigh 10 pounds, are worth 1,500 gp.
...
A [wight](Mechanics/bestiary/undead/wight.md) commands eight [zombies](Mechanics/bestiary/undead/zombie.md) who guard this chamber while some members of their squad recover in the cages. One [deathlock wight](Mechanics/bestiary/undead/deathlock-wight-mpmm.md) and two wights rest in the cages.
...
If the 800-pound stone block holding these doors open is removed, they magically slam shut. It takes a successful DC 25 Strength ([Athletics](Mechanics/Rules/skills.md#Athletics)) check to force the doors open. A [knock](Mechanics/spells/knock.md) spell disrupts the magic briefly, lowering the check DC to 15 for 1 minute.
...
A creature that starts its turn in a clay pit must succeed on a DC 13 Strength or Dexterity saving throw (creature's choice) or take 5 (`2d4`) bludgeoning damage and become [restrained](Mechanics/Rules/conditions.md#Restrained) in the clay until the start of its next turn. A creature can escape the clay by succeeding on the saving throw or by taking an action to make a successful DC 15 Strength check or Dexterity check. Another creature can try to pull a [restrained](Mechanics/Rules/conditions.md#Restrained) creature free by taking an action to do so and succeeding on a DC 15 Strength check. A creature that dies while trapped in the clay is transformed into a rough clay statue.

##### Teleportation Circles

Set into the floor, these magic teleportation circles have been partially disabled. A creature that enters a circle's area is pushed back 10 feet and knocked [prone](Mechanics/Rules/conditions.md#Prone). The first time a creature does so on a turn, the creature takes 5 (`2d4`) force damage.

##### Treasure

In the eastern corner are a few jars of rare oils and boxes of rare powders used in the creation of the golems, along with some empty containers. A character who succeeds on a DC 15 Intelligence ([Arcana](Mechanics/Rules/skills.md#Arcana)) check realizes that these materials, which weigh 15 pounds, are worth 3,000 gp.
...
The intense bright light, created by evocation magic in the pillars, causes disadvantage on ranged attack rolls and ability checks made to search or see in this area. In addition, whenever a creature starts its turn in the chamber proper (not in an entryway next to the glyphs), it must succeed on a DC 13 Constitution saving throw or become [blinded](Mechanics/Rules/conditions.md#Blinded) until the start of its next turn.

##### Arcane Glyphs

In the entryways, arcane glyphs on the wall can be used to control the pillars. When someone touches the glyphs, the pillars flicker. It takes a successful DC 10 Intelligence ([Arcana](Mechanics/Rules/skills.md#Arcana)) check to understand exactly how the glyphs function. A [detect magic](Mechanics/spells/detect-magic.md) spell shows that the abjuration aura of the glyphs is connected to the evocation magic of the pillars, thereby revealing the function of the glyphs without a check.

A character who understands how the glyphs work can take an action to touch the glyphs and subdue the pillars with a successful DC 10 Intelligence ([Arcana](Mechanics/Rules/skills.md#Arcana)) check or deactivate them with a successful DC 15 Intelligence ([Arcana](Mechanics/Rules/skills.md#Arcana)) check. Subdued pillars shine less intensely for 1 minute, and the DC for the saving throw against them becomes 8. While the pillars are subdued, golems in this area regain 5 (`2d4`) hit points at the start of each of their turns. Deactivated pillars go dark for 1 minute, then are subdued for another minute, and then return to normal function.

##### Creatures

A [clay golem](Mechanics/bestiary/construct/clay-golem.md) in this area activates the first time a character fails a saving throw against the pillars, deactivates them, or subdues them.
...
Any creature that moves within 5 feet of the mist must succeed on a DC 20 Strength saving throw or be pulled into it and shunted violently into area 91, falling [prone](Mechanics/Rules/conditions.md#Prone) and taking 3 (`1d6`) bludgeoning damage.
...
The fiendish skulls are imbued with powerful magic. When any character steps into a skull's mouth, macabre laughter erupts from the northwest corner. The character is teleported to the mouth of a different skull (roll a `d6`) and comes tumbling back into the room, falling [prone](Mechanics/Rules/conditions.md#Prone) and taking 3 (`1d6`) bludgeoning damage.
...
|-------|---------|------------------|
| 1 | Strength | Fall [prone](Mechanics/Rules/conditions.md#Prone) whenever hit by an attack |
| 2 | Constitution | Reduce hit point maximum to three-quarters of normal |
| 3 | Dexterity | Move at half speed or fall [prone](Mechanics/Rules/conditions.md#Prone) at the end of the movement |
| 4 | Intelligence | Unable to speak or understand languages |
| 5 | Wisdom | Unable to perceive anything more than 30 feet away |
| 6 | Charisma | Gain the Stench trait of a [troglodyte](Mechanics/bestiary/humanoid/troglodyte.md) |
^skull-ability-secondary-effect

##### Secret Door

In the northwest corner, 20 feet above the floor, a secret door is hidden. The door is nearly impossible to find from the floor, requiring a successful DC 30 Wisdom ([Perception](Mechanics/Rules/skills.md#Perception)) check. The smooth wall is hard to climb without aid, but the vaulted ceiling provides places where a grappling hook might catch.
...
When any non-undead creature enters this area (which the Thayans avoid), a four-armed gargoyle (as a normal [gargoyle](Mechanics/bestiary/elemental/gargoyle.md) with 63 hit points and one extra claw attack, for a total of three attacks, with Multiattack) emerges from a random pillar and attacks. At the start of each round thereafter, another random pillar transforms until all six gargoyles have emerged.
...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/TftYP-DiT/017-totyp-05-17.webp#center)

##### Deva Statue

Anyone who succeeds on a DC 15 Intelligence ([Religion](Mechanics/Rules/skills.md#Religion)) check recognizes the statue as that of a [deva](Mechanics/bestiary/celestial/deva.md).
...
A character who succeeds on a DC 13 Wisdom ([Insight](Mechanics/Rules/skills.md#Insight)) check understands that the deva is crazed from captivity. The characters can try to influence her to direct her attacks against the gargoyles, but doing so takes a successful DC 15 Charisma ([Persuasion](Mechanics/Rules/skills.md#Persuasion)) check to calm her and refocus her attention. Once she is lucid and able to talk to the characters, she vows to aid them by sowing chaos through the Doomvault on her own.
...
One [stone giant](Mechanics/bestiary/giant/stone-giant.md) operates the pulley system to haul stone out of the pit while a second giant cuts stone away from the pit walls. Both are occupied with their noisy work.
...
A Red Wizard transmuter and two Thayan apprentices are distracted by their work here shaping a reduced-threat stone golem (see "Reduced-Threat Monsters" above), but they do notice if anyone is hurled into the room. These apprentices are armed with light hammers instead of daggers. The wizard can activate the golem by succeeding on a DC 15 Intelligence ([Arcana](Mechanics/Rules/skills.md#Arcana)) check made as an action.
...
Each Thayan has a fine chisel (worth 50 gp). At the feet of the golem are a few jars of rare oils and boxes of rare powders. A character who succeeds on a DC 15 Intelligence ([Arcana](Mechanics/Rules/skills.md#Arcana)) check realizes that these materials, which weigh 10 pounds, are worth 2,500 gp.
...
An [efreeti](Mechanics/bestiary/elemental/efreeti.md) is bound to the smoke at the center of the room. It can't leave this area or use its powers against anyone outside the room.

##### Binding Smoke

The smoke tendrils form chains that have no solidity, but their abjuration magic holds the efreeti in this area. While it is bound in this smoke, the creature is susceptible to the [charm person](Mechanics/spells/charm-person.md) spell and has disadvantage on the saving throw. If it isn't [charmed](Mechanics/Rules/conditions.md#Charmed), the efreeti orders anyone present to grant it freedom and attacks if its demand isn't met.

The efreeti has no means to break the binding smoke. It knows, however, that the feat can be accomplished with spells, such as [dispel magic](Mechanics/spells/dispel-magic.md) (save DC 17), [gust of wind](Mechanics/spells/gust-of-wind.md), [knock](Mechanics/spells/knock.md), or any spell that can push the efreeti out of the area of the pool. The smoke dissipates if the efreeti is slain.
...
Two unbroken funeral urns stand in each corner. Glyphs in the Primordial language on the urns suggest that they are binding vessels for efreet, and [detect magic](Mechanics/spells/detect-magic.md) reveals that they have an aura of abjuration. The wax-seal stopper of an urn is broken easily, and an urn can be broken like any clay vessel of the sort. When an urn is opened or broken, the act releases a gas that causes any creature within 10 feet of the urn to gain resistance to fire damage for 1 hour. Each urn is 1 foot tall and weighs 5 pounds.
...
A Red Wizard conjurer and two Thayan apprentices work on an inactive iron golem in this area.

A [charmed](Mechanics/Rules/conditions.md#Charmed) [efreeti](Mechanics/bestiary/elemental/efreeti.md) (see area 95) is at work boiling metal in the crucible. The efreeti fights for its Thayan friends. If freed of the [charmed](Mechanics/Rules/conditions.md#Charmed) condition, it snatches up a falchion intended for the golem and attacks the Thayans. If the efreeti is alive when the other foes in the area are slain, it rampages like its kin in area 95.
...
A search of the molds throughout the room reveals vials of rare tinctures and admixtures used in the construction of iron golems. A character who succeeds on a DC 15 Intelligence ([Arcana](Mechanics/Rules/skills.md#Arcana)) check realizes that these materials, which weigh 30 pounds, are worth 5,000 gp.
...
![Map 5.11: Temples of Extraction](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/TftYP-DiT/018-dit11.webp#center)
...
> [!readaloud] 
> 
> A three-step stone dais is set with four pillars, all carved of black jet. Glowing arcane runes surround the top edge of this shrine. Between the pillars, an [unconscious](Mechanics/Rules/conditions.md#Unconscious) humanoid is suspended in a roiling field of golden light.
^34b
...
Once a Shrine of Binding has been disabled, a character who closely examines the shrine and succeeds on a DC 15 Intelligence ([Arcana](Mechanics/Rules/skills.md#Arcana)) check discerns how these shrines and the black gates in this sector work together to shield the Phylactery Vault. The character understands that if the black gates in the Temples of Extraction can be overloaded, those gates will attune themselves to the location where the power of the Chosen is being directed—the vault itself.
...
A Red Wizard [necromancer](Mechanics/bestiary/humanoid/necromancer-wizard-mpmm.md) works here, guarded by a [helmed horror](Mechanics/bestiary/construct/helmed-horror.md). They are immune to the Dark Mist, and the Red Wizard has the Venomous Touch trait (see below).

##### Dark Mist

The shrine exudes poisonous mist that makes the area lightly obscured. Any creature that starts its turn in the room must succeed on a DC 15 Constitution saving throw or become [stunned](Mechanics/Rules/conditions.md#Stunned) until the start of its next turn. If the save succeeds, the creature is immune to this effect for a day and gains the following trait. Constructs and undead can't gain this trait.

Venomous Touch. When the creature hits with a weapon attack, that attack also deals 5 (`2d4`) poison damage.

##### Chosen of Zehir

The Chosen of Zehir is a male [yuan-ti malison (type 3)](Mechanics/bestiary/monstrosity/yuan-ti-malison-type-3.md) named Oussa. Zehir is the serpentine god of poison, darkness, and murder. He is worshiped primarily by yuan-ti. If Oussa is rescued and then realizes that the characters aren't Zehir's faithful sent to help him, he uses his unholy power to instantly assume snake form and attacks the party.
...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/TftYP-DiT/019-totyp-05-19.webp#center)

##### Creatures

A Red Wizard enchanter and a Thayan apprentice work here, guarded by two dread warriors.

The Red Wizard here is Mennek Ariz, the rebel wizard who helped assault the Bloodgate. He was captured during the assault and brainwashed. A character who succeeds on a DC 15 Wisdom ([Insight](Mechanics/Rules/skills.md#Insight)) check can discern that he isn't acting of his own volition. Only magic, such as [dispel magic](Mechanics/spells/dispel-magic.md) or [charm person](Mechanics/spells/charm-person.md), can break the effect. If he is freed of the brainwashing, Mennek can reveal two pieces of lore.
...
Mennek carries a [wand of binding](Mechanics/items/wand-of-binding.md).
...
A [deathlock wight](Mechanics/bestiary/undead/deathlock-wight-mpmm.md) keeps watch here. One [wraith](Mechanics/bestiary/undead/wraith.md) and four [shadows](Mechanics/bestiary/undead/shadow.md) circle around the shrine, streaks of crimson trailing from their spectral forms.
...
A Red Wizard transmuter works here, with a [wight](Mechanics/bestiary/undead/wight.md) leading two sentient gray oozes and two sentient ochre jellies to guard her. Sentient oozes are the same as normal versions of such monsters, except that they have Intelligence 5, can understand basic communication in Common, and are no longer immune to being [charmed](Mechanics/Rules/conditions.md#Charmed). Myrra, the Red Wizard, is especially cruel and likely to toy with the characters even when she is losing.
...
If he is freed, Therzt babbles about the weakness he demonstrated in being captured and declares that he must die. As an action, Therzt casts [Melf's acid arrow](Mechanics/spells/melfs-acid-arrow.md) on himself while screaming his devotion to Ghaunadaur. The acid consumes him utterly as unholy energy pulses out to touch the walls, producing two [gray oozes](Mechanics/bestiary/ooze/gray-ooze.md) at the center point of each wall. The oozes treat all creatures remaining here as prey.
...
Six [shadows](Mechanics/bestiary/undead/shadow.md) lurk here.

##### Poisoned Shadows

Whenever a non-undead creature in this area takes damage, it must make a DC 15 Wisdom saving throw. On a failed save, the creature takes 5 (`2d4`) poison damage, and it is [blinded](Mechanics/Rules/conditions.md#Blinded) for 1 minute. A creature can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success.
...
A Red Wizard [necromancer](Mechanics/bestiary/humanoid/necromancer-wizard-mpmm.md) works here, guarded by a [flesh golem](Mechanics/bestiary/construct/flesh-golem.md). Shalok, the Red Wizard, is a coward. If the fight goes badly for him, he surrenders. He offers his skeleton key and one piece of lore if he's allowed to flee to the gatehouse.
...
A Red Wizard [evoker](Mechanics/bestiary/humanoid/evoker-wizard-mpmm.md) has command over two dread warriors here. A [shadow](Mechanics/bestiary/undead/shadow.md) lurks at each pillar on the shrine of binding, for a total of four.
...
This shrine contains a Chosen of Bhaal named Torlin Silvershield, who was formerly a duke of Baldur's Gate. He has become a [wight](Mechanics/bestiary/undead/wight.md). The creature hisses an oath to Bhaal and attacks characters who free it.
...
A Red Wizard [necromancer](Mechanics/bestiary/humanoid/necromancer-wizard-mpmm.md) and a [deathlock wight](Mechanics/bestiary/undead/deathlock-wight-mpmm.md) work here, guarded by a dread warrior and four [zombies](Mechanics/bestiary/undead/zombie.md). Thutai, the Red Wizard, is the overseer of this sector. He cares little for his underlings, including them in area effects if it means harming more characters. If the fight goes badly, he uses the black gate to flee.
...
The shrine exudes poisonous mist that makes the area lightly obscured. Each creature that starts its turn in the room must make a DC 13 Constitution saving throw. On a failed save, the creature takes 5 (`2d4`) poison damage and spends its turn [incapacitated](Mechanics/Rules/conditions.md#Incapacitated) and retching. If a creature accumulates three failed saves against this mist, its hit point maximum is lowered by the amount of poison damage it has taken from the mist. A creature that makes three successful saving throws against the mist becomes immune to its effects for 4 hours.
...
Thutai wears [bracers of defense](Mechanics/items/bracers-of-defense.md) and has [spell scrolls](Mechanics/items/spell-scroll-dmg.md) of [remove curse](Mechanics/spells/remove-curse.md) and [speak with dead](Mechanics/spells/speak-with-dead.md).
...
A [wraith](Mechanics/bestiary/undead/wraith.md) and three [will-o'-wisps](Mechanics/bestiary/undead/will-o-wisp.md) guard this chamber. The wisps start out [invisible](Mechanics/Rules/conditions.md#Invisible).

##### Clutching Vines

While on the ground, a creature that moves more than half its speed or misses with a melee attack causes the branches within 5 feet to elongate and grasp. Each creature on the ground in the area must succeed on a DC 13 Strength saving throw or become [restrained](Mechanics/Rules/conditions.md#Restrained) in the vines. The area becomes difficult terrain. A [restrained](Mechanics/Rules/conditions.md#Restrained) creature can take an action to make a DC 13 Strength check, freeing itself on a success.

##### Chosen of Rillifane Rallathil

A neutral good female wood elf [druid](Mechanics/bestiary/humanoid/druid.md) named Eira is the Chosen of Rillifane Rallathil, the elven god of the woodlands and of the harmony of nature. He is seen as a calm and steady deity, quite unlike his more mercurial fellow elven deities.
...
A Red Wizard [evoker](Mechanics/bestiary/humanoid/evoker-wizard-mpmm.md) and a Thayan apprentice work here, with three trained [yetis](Mechanics/bestiary/monstrosity/yeti.md) as bodyguards. Aduna, the Red Wizard, and her apprentice prefer to stand near the braziers.
...
Hedrun is now a [deathlock wight](Mechanics/bestiary/undead/deathlock-wight-mpmm.md). If freed, she screams an oath to Auril and attacks the characters.
...
> [!gallery]
> ![Map 5.12: The Phylactery Vault—Floor 1 & Floor 2](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/TftYP-DiT/020-dit12.webp#gallery)
> ![Map 5.13: The Phylactery Vault—Floor 3 & Floor 4](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/TftYP-DiT/021-dit13.webp#gallery)
...
A creature flying from one floor to land on another must succeed on a DC 10 Dexterity ([Acrobatics](Mechanics/Rules/skills.md#Acrobatics)) check or fall [prone](Mechanics/Rules/conditions.md#Prone) upon landing.
...
The phylacteries can't be harmed while they are protected by the magic of the sepulcher. However, a successful DC 10 Intelligence ([Arcana](Mechanics/Rules/skills.md#Arcana)) check made while examining a sepulcher reveals that disrupting the flow of eldritch energy within a sepulcher will disable the structure.

Disrupting the energy flow requires intense concentration. It takes three successful DC 15 Intelligence ([Arcana](Mechanics/Rules/skills.md#Arcana) or [Religion](Mechanics/Rules/skills.md#Religion)) checks performed by a character who is proficient in that skill and is touching the target sepulcher. On each failed check, the character takes force damage equal to the amount by which the check failed. After making one check, a character realizes that every glyph key he or she holds will grant a +1 bonus to the check.
...
Kazit Gul, a [demilich](Mechanics/bestiary/undead/demilich.md), has entered the vault and immediately attacks the characters. If the demilich is destroyed, read:
...
A character can make a DC 13 Intelligence ([Arcana](Mechanics/Rules/skills.md#Arcana)) check to assess the failing magic and confirm that the Phylactery Vault is collapsing.
...
With the Phylactery Vault destroyed, Syranna is true to her word and uses [teleport](Mechanics/spells/teleport.md) to send the characters (as well as any NPCs they saved from the Doomvault) to a location of their choice. She invites any characters who proved useful, particularly those with arcane talents, to remain in Thay under her leadership. She promises them power and influence if they throw in support for her.
