...
A second human prisoner, an engineer ([commoner](Mechanics/bestiary/humanoid/commoner.md)), is kept alive to help with the excavation of new areas of the dungeon. He cannot aid his rescuers, but he will repay them with service.
...
Currently, five bugbears—the captain (a [bugbear chief](Mechanics/bestiary/humanoid/bugbear-chief.md)) and four lieutenants ([bugbears](Mechanics/bestiary/humanoid/bugbear.md))—are sitting around a crude table drinking ale and discussing a plan to wipe out the rebel orcs in area 19. All these bugbears have longswords that deal 11 (`2d8 + 2`) slashing damage on a hit. All five are carrying 50 gp each. The captain also has thirty-one 10 gp gems hidden in a pouch under his armor.
...
Two [carrion crawlers](Mechanics/bestiary/monstrosity/carrion-crawler.md) are in the northeast finger of the cavern when the characters first enter. Every 10 minutes, there is a 30 percent chance that `1d3` more of these monsters appear from either the northern or southern sinkhole.
...
If the party is on the floor of the rift and fleeing from pursuing monsters, the blizzard-like conditions in this area makes the characters hard to catch. The characters have advantage on Dexterity ([Stealth](Mechanics/Rules/skills.md#Stealth)) checks to evade pursuit. At the same time, winter wolves are considered to have passive Perception scores 4 higher than normal when they are pursuing the characters.
...
Two [frost giants](Mechanics/bestiary/giant/frost-giant.md) are stationed here; one watches at the cave mouth, while the other naps on a pile of hides. Eight throwing rocks are within reach in the cave.
...
- One [fire giant](Mechanics/bestiary/giant/fire-giant.md) guard  
- One [fire giant](Mechanics/bestiary/giant/fire-giant.md) with 12 [gnoll](Mechanics/bestiary/humanoid/gnoll.md) workers  
- Four young fire giants (use the [ogre](Mechanics/bestiary/giant/ogre.md) statistics, plus immunity to fire damage) with two [hell hounds](Mechanics/bestiary/fiend/hell-hound.md)  
- One [cloud giant](Mechanics/bestiary/giant/cloud-giant.md), one [frost giant](Mechanics/bestiary/giant/frost-giant.md), or one [stone giant](Mechanics/bestiary/giant/stone-giant.md), a visitor looking around  
...
The tapestry that covers the opening to this guard post is of loose weave, allowing the [fire giant](Mechanics/bestiary/giant/fire-giant.md) guard in the dark recess to clearly see whoever enters the corridor. If intruders are spotted, he sounds his great bronze horn to warn the hall (see area 2). The giant has four rocks for throwing.

If the characters are returning after severely defeating the giants, a ballista (from the arsenal at 10A) will be set up at the far end of the hallway in anticipation of a second raid. This weapon is triggered by a nearly invisible tripwire set 30 feet inside the entrance, and someone must succeed on a DC 20 Wisdom ([Perception](Mechanics/Rules/skills.md#Perception)) check to find the wire. Once the wire is found, it can be avoided, but cutting it sets off the ballista. The ballista fires an array of bolts down the length of the hall, so each creature in it is subjected to one attack at a +6 bonus to hit, dealing 11 (`2d10`) piercing damage on a hit.

### 2. Grand Hall

Two [ettins](Mechanics/bestiary/giant/ettin.md) are always in the hall that runs east–west off the entry passage, using their four heads to watch in all directions. If the guard at the gate sounds the alarm, these creatures move to hold the mouth of the entryway until help arrives from area 3, area 18, or areas 21–25.
...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/TftYP-AtG/013-totyp-06-14.webp#center)
...
King Snurre is a [fire giant](Mechanics/bestiary/giant/fire-giant.md) with the following changes, which increase his challenge rating to 11 (7,200 XP):
...
Two [fire giants](Mechanics/bestiary/giant/fire-giant.md) guard the king at all times; their positions are indicated by the circled numbers 1 and 2. Each giant has a carved stone to throw. Crouching at positions 3 and 4 are a pair of [hell hounds](Mechanics/bestiary/fiend/hell-hound.md), the king's constant companions.
...
Queen Frupy, who resides here, is a veritable harridan, a sly and cunning [fire giant](Mechanics/bestiary/giant/fire-giant.md). She is, if anything, uglier than Snurre. Topped by a huge mass of yellow-orange hair that looks like a fright wig, Queen Frupy's face is a mass of jowls and wrinkles set in the middle of a very large head that seems to grow directly out of her shoulders without the benefit of any neck. Her body is lumpy and gross, her skin covered with bristles the color of her hair. Her little pig eyes, however, are bright, suggesting intelligence unusual in a giant.

Her chamber contains a giant-sized bed covered with furs, a table and two chairs, a stool, and a dressing table with a huge *mirror of seeing* (weighing 100 pounds) that functions similarly to a [gem of seeing](Mechanics/items/gem-of-seeing.md), so that even unseen creatures and objects are reflected in it. (Frupy uses it if she suspects [invisible](Mechanics/Rules/conditions.md#Invisible) creatures are about.) Also here are an ebony and mother-of-pearl wardrobe (filled with her clothing), an iron strongbox, a chest of twelve drawers, four small coffers of copper on the table, and two bronze caskets. Each bronze casket has a [poisonous snake](Mechanics/bestiary/beast/poisonous-snake.md) inside, which must be dealt with before the contents can be accessed (see "Treasure").

The queen wears garments of black dragon hide set with iron studs (giving her an AC equivalent to that of plate armor). She wields an iron scepter as a weapon (treat as a maul with the same statistics as a fire giant's greatsword, except that it deals bludgeoning damage). Out of sight under the bed are Frupy's two pets, a pair of [giant weasels](Mechanics/bestiary/beast/giant-weasel.md) that obey her every command.

If intruders enter the place, Queen Frupy will command them to kneel in her august presence and state their business, so that she may fairly address their humble requests. Any who are so foolish as to do so will be sorry, as Frupy will call forth her pets and herself strike at the intruder who appears to be the most powerful. (A kneeling character is considered to be [prone](Mechanics/Rules/conditions.md#Prone) in this situation.) She will then bellow for her servants to come to her aid.

#### Treasure

One of the bronze caskets holds 400 cp, and the other one has 300 pp concealed beneath a layer of 100 cp.

If the lid of the strongbox is opened by anyone but Frupy, a [glyph of warding](Mechanics/spells/glyph-of-warding.md) inside is triggered, producing a [fireball](Mechanics/spells/fireball.md) spell centered on the chest (save DC 15). The strongbox itself holds nothing of value, but it has a trick panel in the side, which requires a successful DC 20 Wisdom ([Perception](Mechanics/Rules/skills.md#Perception)) check to find.

The panel, if opened, allows access to a jade box (worth 500 gp). This box has a false bottom, found with another successful DC 20 Wisdom ([Perception](Mechanics/Rules/skills.md#Perception)) check, that contains [spell scrolls](Mechanics/items/spell-scroll-dmg.md) of two random 7th-level spells of a particular class (DM's choice).
...
The great iron doors to this place bear the blazon of the flaming skull also found in the throne room. The doors open into an outer hall where six [hell hounds](Mechanics/bestiary/fiend/hell-hound.md) roam.
...
**Trunk 8** is unlocked. When it is opened, it initially appears empty because all of its contents are invisible. The chest holds six pieces of jewelry worth 250 gp each as well as nine [poisonous snakes](Mechanics/bestiary/beast/poisonous-snake.md).

**Chest 1** is unlocked and trapped. If its lid is lifted, poisonous gas billows forth and spreads out to fill a 10-foot-radius area around it. Those within the cloud when it erupts must succeed on a DC 15 Constitution saving throw or become [poisoned](Mechanics/Rules/conditions.md#Poisoned) until they finish a short or long rest. The chest is empty.

**Chest 2** is locked. It contains worthless rocks.

**Chest 3** is unlocked and trapped. If its lid is lifted before the trap is disabled, acid sprays out from small holes in the sides, splattering anyone within 10 feet of the chest. Those in the affected area must make a DC 15 Dexterity saving throw, taking 7 (`3d4`) acid damage on a failed save, or half as much damage on a successful one. With a successful DC 20 Wisdom ([Perception](Mechanics/Rules/skills.md#Perception)) check, a character discovers that the hinges are connected to a valve, disguised as a decoration, that pressurizes the acid in the chest walls. The trap can be disabled by someone who uses thieves' tools and succeeds on a DC 20 Dexterity check.

To determine the contents of the chest, consult "chapter 7" of the "Dungeon Master's Guide". Roll four times on [Magic Item Table A](Mechanics/tables/magic-item-table-a.md), two times on [Table B](Mechanics/tables/magic-item-table-b.md), two times on [Table C](Mechanics/tables/magic-item-table-c.md), once on [Table D](Mechanics/tables/magic-item-table-d.md), and once on [Table E](Mechanics/tables/magic-item-table-e.md). Any result that is not a potion or a scroll should be disregarded but not rerolled.

**Chest 4** is unlocked and trapped. It contains 1,600 gp. If its lid is lifted before the trap is disabled, numerous spikes shoot forward, backward, and to each side. Each spike has a range of 15 feet and a +11 bonus to hit, dealing 7 (`2d6`) piercing damage on a hit. Anyone within 15 feet of the chest might be hit. With a successful DC 20 Wisdom ([Perception](Mechanics/Rules/skills.md#Perception)) check, a character notices that the hinges are connected to four valves, disguised as decorations, that pressurize the spikes in the chest walls. Thieves' tools and a successful DC 20 Dexterity check can be used to disable the valves.

**Chest 5** is locked. It contains nothing.

**Chest 6** is locked and trapped. It contains a [cloak of elvenkind](Mechanics/items/cloak-of-elvenkind.md) and a pair of [boots of elvenkind](Mechanics/items/boots-of-elvenkind.md). The lock and the chest's handles are coated with oil of taggit (see ""Sample Poisons"" in chapter 8 of the "Dungeon Master's Guide"). With a successful DC 20 Wisdom ([Perception](Mechanics/Rules/skills.md#Perception)) check, a character spots the oil. A character who succeeds on a DC 15 Intelligence check, or any character who has proficiency with a poisoner's kit, knows that the oil can be wiped off with alcohol, although doing so without wearing protective clothing is risky, requiring a successful DC 15 Dexterity check. On a failed check, the character is exposed to the poison.

**Coffer 1** is unlocked and trapped. It contains thirty gold rings, one of which is a [ring of protection](Mechanics/items/ring-of-protection.md). The others are ordinary rings worth 50 gp each. If the treasure is touched before the trap is disabled, a poison needle shoots from the inner side of the coffer, hitting the extremity that was extended. The needle deals 1 piercing damage and delivers a dose of purple worm poison (see ""Sample Poisons"" in chapter 8 of the "Dungeon Master's Guide"). With a successful DC 20 Wisdom ([Perception](Mechanics/Rules/skills.md#Perception)) check, a character discovers the recess in the coffer wall that holds the needle. A character can remove the needle, thereby disabling the trap, by using thieves' tools and making a successful DC 15 Dexterity check.
...
A [fire giant](Mechanics/bestiary/giant/fire-giant.md) is always at the ready inside the entrance to this storage area. If summoned or attacked, the guard fetches the chimera from area 11. The guard has three throwing rocks at hand. Torches provide light, and a bench offers a place to sit down.
...
Hidden in the far southwestern corner under the spears are a [+1 longbow](Mechanics/items/1-weapon.md) and a quiver of twenty [+1 arrows](Mechanics/items/1-ammunition.md).
...
One of the giant-sized shields is actually a [shield of missile attraction](Mechanics/items/shield-of-missile-attraction.md).

### 11. Chimera Pen

The fire giants keep a [chimera](Mechanics/bestiary/monstrosity/chimera.md) here. This creature attacks intruders on sight, since it hates everyone except fire giants.
...
Eight [gnolls](Mechanics/bestiary/humanoid/gnoll.md) servants/bodyguards are lounging in this area, awaiting orders. They obey only the commands of King Snurre, Queen Frupy, or the Advisor—who is is a grossly fat but very strong and quite fast renegade mountain dwarf named Obmi (see area 12A).
...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/TftYP-AtG/014-totyp-06-15.webp#center)
...
Obmi uses a plain wooden box as a footstool. It seemingly holds only old clothes of his—but beneath a false bottom, which requires a successful DC 15 Wisdom ([Perception](Mechanics/Rules/skills.md#Perception)) check to find, some gems are hidden: two worth 500 gp each, eight worth 100 gp each, twenty-three worth 50 gp each, forty-one worth 10 gp each, and eighteen worth 5 gp each.

### 12B. Obmi's Bedchamber

In a larger chamber adjacent to his study, the renegade dwarf has a soft bed, a small stand, a table and chair, a cabinet, two iron chests, and an arming rack. His [dwarven plate](Mechanics/items/dwarven-plate.md) and [+1 shield](Mechanics/items/1-shield.md) (AC 20, or AC 23 with his shield) are laid on the rack near the door, and his [+1 battleaxe](Mechanics/items/1-weapon.md) and [+1 warhammer](Mechanics/items/1-weapon.md) (each deals `1d8 + 4` damage in Obmi's hands) hang on the wall above. Underneath the armor are his [gauntlets of ogre power](Mechanics/items/gauntlets-of-ogre-power.md) (giving him an additional +1 to attack and damage rolls with melee weapons). His [ring of invisibility](Mechanics/items/ring-of-invisibility.md) is on a small stand near his bed.
...
The holes for the arrows are sealed with a thin crust of mortar. A character who examines the wall spots them with a successful DC 20 Wisdom ([Perception](Mechanics/Rules/skills.md#Perception)) check. Someone who looks carefully at the base of the chest can spot the pressure plate with a successful DC 20 Wisdom ([Perception](Mechanics/Rules/skills.md#Perception)) check. The holes can be blocked by hammering iron pitons or similar objects into them. The pressure plate can be wedged in place with the use of at least two such objects. In either case, a character attempting to disarm the trap must succeed on a DC 10 Strength check. On a failed check, the trap operates anyway when the attempt to block it fails.
...
A [fire giant](Mechanics/bestiary/giant/fire-giant.md) stands guard at all times outside the doors to the council chambers.
...
The place is typically occupied by busy workers: a [fire giant](Mechanics/bestiary/giant/fire-giant.md) matron, two fire giant servants (use the [hill giant](Mechanics/bestiary/giant/hill-giant.md) statistics, plus immunity to fire damage), and seven [gnolls](Mechanics/bestiary/humanoid/gnoll.md) thralls. The servants and the gnolls fight only under the direction of the matron, fleeing or surrendering if she falls.
...
The doors to this room are closed on the outside by a great bar, because King Snurre does not fully trust his guest, a [rakshasa](Mechanics/bestiary/fiend/rakshasa.md), that resides herein. Naturally, most adventurers will assume a creature thus imprisoned might become a trusted associate—an attitude the rakshasa will encourage by taking some benign form (such as that of a fellow adventurer, a kindred soul, who has been deprived of equipment) to gain the characters' confidence before it attacks.
...
The rakshasa carries 50 gp and two gems (worth 100 gp each). The disguised chest holds a jeweled scepter worth 1,000 gp, three potions ([superior healing](Mechanics/items/potion-of-superior-healing.md), [mind reading](Mechanics/items/potion-of-mind-reading.md), and [invulnerability](Mechanics/items/potion-of-invulnerability.md)), and five [spell scrolls](Mechanics/items/spell-scroll-dmg.md) ([zone of truth](Mechanics/spells/zone-of-truth.md), [true seeing](Mechanics/spells/true-seeing.md), [darkness](Mechanics/spells/darkness.md), [cure wounds](Mechanics/spells/cure-wounds.md) cast at 4th level, and [symbol](Mechanics/spells/symbol.md)).

### 18. Barracks

Currently two [fire giants](Mechanics/bestiary/giant/fire-giant.md) and two fire giant servants (use the [hill giant](Mechanics/bestiary/giant/hill-giant.md) statistics, plus immunity to fire damage) are housed here. They typically lounge around sharpening weapons and telling lies about their amatory prowess.
...
Three fire giant servants (use the [hill giant](Mechanics/bestiary/giant/hill-giant.md) statistics, plus immunity to fire damage) care for six young fire giants (use the [ogre](Mechanics/bestiary/giant/ogre.md) statistics, plus immunity to fire damage) in this vast chamber. All have weapons (kids' toys for the youngsters) and will fight with enthusiasm.
...
Four [hell hounds](Mechanics/bestiary/fiend/hell-hound.md) scuffle and play just inside the doors. They are part of the pack at area 22 and will flee thereto by the safest route if threatened.

### 22. Kennel Chamber

Four [hell hounds](Mechanics/bestiary/fiend/hell-hound.md) are here. If those in area 21 are attacked and yelp for assistance, these beasts split into pairs and station themselves in the north and south ends of the open area, from where they spring to the aid of the others. The hell hounds love their handler at area 23 and come to his rescue if he whistles.
...
Herein dwell the Keeper and his mate, two [fire giants](Mechanics/bestiary/giant/fire-giant.md) who will rush to the aid of their charges if they hear a commotion outside. Their chamber contains a large bed, a table, two chairs, a bench, a chest, a cabinet, three barrels (beer, mead, and ale), two buckets (his and hers), and a crate (holding dried meat for the hounds). Burning torches light the place. Pegs on the walls hold wearing apparel and the giants' bags. A shield, a battleaxe, and a javelin lean against the wall to the north. Hides and pelts decorate the floor and walls, and a number of skins and furs are heaped on the bed and the bench.

#### Treasure

The second bucket has a false bottom, which requires a successful DC 15 Wisdom ([Perception](Mechanics/Rules/skills.md#Perception)) check to find. Beneath it are stored 20 pp and eight gems (worth 100 gp each).

The javelin leaning against the wall is actually a [javelin of lightning](Mechanics/items/javelin-of-lightning.md).

One of the six cloaks on the bench is a hell hound cloak (see appendix A). Wrapped inside this cursed cloak is a [sword of vengeance](Mechanics/items/sword-of-vengeance.md). There are three other hell hound hides in the chamber (those of beloved departed pets), all quite normal.

### 24. Guardpost

A [fire giant](Mechanics/bestiary/giant/fire-giant.md) is on duty here at all times with four throwing rocks nearby. An iron cylinder hanging near the north wall is a gong to be sounded if intruders are seen.

### 25. Barracks

Two [fire giant](Mechanics/bestiary/giant/fire-giant.md) warriors and two fire giant servants (use the [hill giant](Mechanics/bestiary/giant/hill-giant.md) statistics, plus immunity to fire damage) are lounging among the cots, chests, and other furniture that fill this place. Several pegs here and there hold cloaks, capes, shields, and four giants' bags. There are only worthless giant-sized items in the chests and other containers.

One warrior has a greatsword, and the other one fights with a human-sized [+2 greataxe](Mechanics/items/2-weapon.md). The weapon gives the giant a +13 bonus to hit and deals 22 (`3d8 + 9`) slashing damage. The room also has twenty-one throwing rocks, which all the giants will use if the opportunity presents itself.
...
> [!gallery]
> ![Map 6.6: Hall of the Fire Giant King—Second Level](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/TftYP-AtG/015-atg06.webp#gallery)
> ![Player Version](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/TftYP-AtG/021-atg06-player.webp#gallery)
...
Secret doors on this level are precisely crafted. Unless otherwise noted, it requires a successful DC 20 Wisdom ([Perception](Mechanics/Rules/skills.md#Perception)) check to find such a door.
...
- One [fire giant](Mechanics/bestiary/giant/fire-giant.md) and one fire giant servant (use the [hill giant](Mechanics/bestiary/giant/hill-giant.md) statistics, plus immunity to fire damage)  
- One [troll](Mechanics/bestiary/giant/troll.md) escorting one [hill giant](Mechanics/bestiary/giant/hill-giant.md), one [stone giant](Mechanics/bestiary/giant/stone-giant.md), or one [frost giant](Mechanics/bestiary/giant/frost-giant.md)  
- One [troll](Mechanics/bestiary/giant/troll.md) with ten [gnolls](Mechanics/bestiary/humanoid/gnoll.md)  
- One [drow mage](Mechanics/bestiary/humanoid/drow-mage.md) with five [wererats](Mechanics/bestiary/humanoid/wererat.md)  
...
This room, illuminated by four torches set in wall cressets, has been cleaned out to serve as quarters for four [hill giants](Mechanics/bestiary/giant/hill-giant.md). If they survived or escaped the assault on the steading, Chief Nosnra and his wife are among the occupants.
...
In this large area are housed a [fire giant](Mechanics/bestiary/giant/fire-giant.md) warrior, three fire giant servants (use the [hill giant](Mechanics/bestiary/giant/hill-giant.md) statistics, plus immunity to fire damage), and four young fire giants (use the [ogre](Mechanics/bestiary/giant/ogre.md) statistics, plus immunity to fire damage). All are armed with various weapons, even the young, and there are twenty throwing rocks in the chamber.
...
A knotty-limbed, burly [fire giant](Mechanics/bestiary/giant/fire-giant.md), King Snurre's weaponsmith, is working here. He uses the molten lava to heat the items he works. With him are two [trolls](Mechanics/bestiary/giant/troll.md) that serve as his assistants. Currently in his forge, in various stages of completion, are three giant-sized swords, some pieces of armor, and several axe and spear heads.

#### Treasure

The weaponsmith has in his possession a special [+2 mace](Mechanics/items/2-weapon.md), made of strange black metal, that he is doing some repair work on. If he is attacked and the fight goes against him, there is a 33 percent chance per round that he uses his action to toss the mace into the lava and destroy it, rather than let it fall into the hands of his enemies.
...
Two [fire giants](Mechanics/bestiary/giant/fire-giant.md), the King's Torturer and the Royal Headsman, are crouched in the center of the room, playing knucklebones on the floor with stakes of jewelry gems scattered in front of them. The headsman has his gigantic [+2 greataxe](Mechanics/items/2-weapon.md) at hand—a weapon that can be employed only by a creature at least as strong and massive as he is. He has a +13 bonus to hit with the weapon, and it deals 28 (`3d12 + 9`) slashing damage on a hit. His friend the torturer has a greatsword nearby.
...
The female elf in this cell is destined for sacrifice in the Temple. She is a [noble](Mechanics/bestiary/humanoid/noble.md), and she promises that if she is rescued, she will send her rescuers a reward of 1,000 gp, twenty [+1 arrows](Mechanics/items/1-ammunition.md), an [arrow of giant slaying](Mechanics/items/arrow-of-slaying.md), a [cloak of elvenkind](Mechanics/items/cloak-of-elvenkind.md), and a pair of [boots of elvenkind](Mechanics/items/boots-of-elvenkind.md). The reward will come to the characters a month or two after she is able to leave the stronghold and return home.

#### Cell 2C

Eight male elf [commoners](Mechanics/bestiary/humanoid/commoner.md) are awaiting sacrifice in the Temple. They have no treasure, but they promise to sing their rescuers' praises.

#### Cell 3C

A merchant is being held for ransom. He is a human [commoner](Mechanics/bestiary/humanoid/commoner.md) whose goods have all been seized by the giants, and thus he can pay his rescuers only with eternal gratitude.
...
Two noble [centaurs](Mechanics/bestiary/monstrosity/centaur.md) imprisoned here are bound for torture and execution. They offer help to any who free them.
...
Three [gnolls](Mechanics/bestiary/humanoid/gnoll.md) being punished for insubordination were thrown in here. One is already dead from the aftereffects of torture; the other two will serve any rescuer who can tolerate their habits.
...
In this cell sits a [troll](Mechanics/bestiary/giant/troll.md) that is used for torture practice from time to time. It is mindless and enraged, so it will attack instantly if given a chance. Otherwise, it remains motionless.

#### Cell 10C

Seven [gnolls](Mechanics/bestiary/humanoid/gnoll.md) caught stealing gold await their fate in this cell. They run away as fast as possible.
...
This place, pitch dark, is the lair of seven [wererats](Mechanics/bestiary/humanoid/wererat.md). If the encounter is going badly for them, survivors flee down the northeast passageway to area 15 on the third level (map 6.7) and warn the drow.
...
The second chest contains a [potion of poison](Mechanics/items/potion-of-poison.md), 800 gp (loose), and a cursed [scroll of protection](Mechanics/items/scroll-of-protection-dmg.md) (lycanthropes). Someone who reads the scroll must succeed on a DC 15 Wisdom saving throw or become afflicted with wererat lycanthropy.

The third chest is empty, but a permanent [invisibility](Mechanics/spells/invisibility.md) spell covers writing on the inside of the lid. If the invisibility is dispelled, the information tells where a stone in the wall along the stairs down can be removed to reveal a [ring of shooting stars](Mechanics/items/ring-of-shooting-stars.md), a [spell scroll](Mechanics/items/spell-scroll-dmg.md) of seven cleric spells (DM's choice), and a metal case holding six potions ([healing](Mechanics/items/potion-of-healing.md), [diminution](Mechanics/items/potion-of-diminution.md), plus four more of the DM's choice).

A secret compartment in the lid of the box that contains the potions holds [pipes of the sewers](Mechanics/items/pipes-of-the-sewers.md). A character who succeeds on a DC 20 Wisdom ([Perception](Mechanics/Rules/skills.md#Perception)) check while examining the box finds the compartment.

### Temple of the Eye (Areas 9–11)

Illusionary walls (represented by dashed lines on the map) screen the temple area from discovery. Making physical contact with these images reveals their illusory nature. Someone who examines either image without touching it can determine that it is an illusion by making a successful DC 15 Intelligence ([Investigation](Mechanics/Rules/skills.md#Investigation)) check. On a successful check, the illusions fade for that character, becoming transparent enough to see through.
...
The large pillar to the east on the first tier is made of malachite and is covered with graven signs and sigils. A casting of [detect magic](Mechanics/spells/detect-magic.md) reveals that the glyphs radiate an aura of conjuration magic. If the correct pair of gylphs are touched, the creature touching them will be transported to area 18 on the third level (see map 6.7). You should devise the twenty-four glyphs upon this pillar and select which two are the trigger mechanism.
...
The third tier is dull black stone with whorls of plum and lavender and splotches of red. The metal triangle stands upon the third tier. If the altar stone is touched by living flesh or hit by a weapon (or any object), it begins to fade in color, and in 3 rounds becomes a translucent amethyst color with a black, amorphous center. A creature that touches or strikes the altar when it is in this form must succeed on a DC 15 Wisdom saving throw or become [paralyzed](Mechanics/Rules/conditions.md#Paralyzed) for 1 hour.

If the drum on the first tier is beaten, the chimes are rung, and the triangle is struck while the altar is in this translucent state, a glowing golden eye swims into view in the stone's writhing center. For each creature that sees the eye, roll a `d12` and consult the following table. The creature is affected as if by a [symbol](Mechanics/spells/symbol.md) spell of the indicated type (save DC 15):
...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/TftYP-AtG/016-totyp-06-18.webp#center)

The entrance to this chamber is protected by a wall of tentacles (not depicted on the map). It appears as rough brown-purple stone. This magic wall is like two [ropers](Mechanics/bestiary/monstrosity/roper.md) combined into one creature, giving it two bite attacks and eight tendrils that it can employ every round (though the tendrils have a range of only 20 feet). The wall has resistance to bludgeoning, piercing, and slashing damage from nonmagical weapons. A casting of [dispel magic](Mechanics/spells/dispel-magic.md) deals the wall 50 damage, and [disintegrate](Mechanics/spells/disintegrate.md) deals it 100 damage.

Drow can freely pass through the wall. If any other creature touches it, the wall attacks and emits a hissing and champing noise to alert the occupants of the chamber beyond it. If its current hit points drop to half its hit point maximum or lower, the wall casts [darkness](Mechanics/spells/darkness.md) on itself (affecting only the outside of the wall, not its inner surface).
...
The antechamber is the quarters of a [drow elite warrior](Mechanics/bestiary/humanoid/drow-elite-warrior.md) and a [drow mage](Mechanics/bestiary/humanoid/drow-mage.md) who assist their priestess, Eclavdra. Each has a [tentacle rod](Mechanics/items/tentacle-rod.md) in addition to its usual gear and weaponry.
...
The jasper basins and ewers are worth 300 gp per set. The first coffer examined holds a [spell scroll](Mechanics/items/spell-scroll-dmg.md) of [word of recall](Mechanics/spells/word-of-recall.md) and three bars of adamantine, each weighing 5 pounds and worth 500 gp each. The second coffer contains 100 cp, 100 sp, 10 ep, 20 gp, and 10 pp, each type of coin in its own black leather pouch, as well as a pouch of ten gems (worth 50 gp each).

#### Inner Chamber

The inner room, lavishly furnished and decorated, is the sanctuary of Eclavdra, the [drow priestess of Lolth](Mechanics/bestiary/humanoid/drow-priestess-of-lolth.md) who has fomented all the trouble with the giants. Like her assistants, she also carries a [tentacle rod](Mechanics/items/tentacle-rod.md) in addition to her other equipment.

![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/TftYP-AtG/017-totyp-06-19.webp#center)
...
A coffer on the low chest between the divans has a [glyph of warding](Mechanics/spells/glyph-of-warding.md) on the inside of the lid, so if anyone other than Eclavdra opens it, the glyph casts [insect plague](Mechanics/spells/insect-plague.md) (spell save DC 14). The container holds three [spell scrolls](Mechanics/items/spell-scroll-dmg.md) ([gate](Mechanics/spells/gate.md), [divine word](Mechanics/spells/divine-word.md), and [greater restoration](Mechanics/spells/greater-restoration.md)).

A coffer near her bed contains six potions: [poison](Mechanics/items/potion-of-poison.md), mind control (fire giant) (see appendix A), [growth](Mechanics/items/potion-of-growth.md), [heroism](Mechanics/items/potion-of-heroism.md), and two [philters of love](Mechanics/items/philter-of-love.md).
...
If Jarl Grugnur and his lady, Estia, survived the assault on the glacial rift, they will be sequestered in this chamber, accompanied by a [frost giant](Mechanics/bestiary/giant/frost-giant.md) that serves as a door guard. If the jarl and his lady are not present, the room contains two [frost giants](Mechanics/bestiary/giant/frost-giant.md), recently arrived messengers.
...
Two [cloud giants](Mechanics/bestiary/giant/cloud-giant.md), a noble and his traveling companion, have come to hear from King Snurre why his warfare will profit them and make them more powerful. The giants have two [lions](Mechanics/bestiary/beast/lion.md) serving as watch-animals at the door. The noble has a chain mail coat (AC 16), and both have their great morningstars and throwing rocks nearby.
...
> [!gallery]
> ![Map 6.7: Hall of the Fire Giant King—Third Level](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/TftYP-AtG/018-atg07.webp#gallery)
> ![Player Version](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/TftYP-AtG/025-atg07-player.webp#gallery)
...
- Two wandering [trolls](Mechanics/bestiary/giant/troll.md)  
- A [fire giant](Mechanics/bestiary/giant/fire-giant.md) patrolling with two [hell hounds](Mechanics/bestiary/fiend/hell-hound.md)  
- One [drow elite warrior](Mechanics/bestiary/humanoid/drow-elite-warrior.md) and three [drow](Mechanics/bestiary/humanoid/drow.md) that use stealth to remain undetected and avoid confrontation  
...
This cavern is fairly colorful, having many reddish, pale yellow, and shining blue-gray rock formations that glisten in the light of torches or lanterns. Three [ropers](Mechanics/bestiary/monstrosity/roper.md) dwell here and conceal themselves among the natural stalagmite formations. They wait until prey approaches the center of the area before attacking.
...
This small offshoot of the larger cavern that runs north and south is filled with luminous plant growth and contains twelve hungry [giant fire beetles](Mechanics/bestiary/beast/giant-fire-beetle.md). Some will be on the ceiling and drop upon any creatures entering their lair. These creatures served as a source of gifts for the frost giants in the past. They have no treasure.
...
In the middle of this place is a permanent illusion of a huge red dragon dozing atop a mound of treasure (appearing like area 7, below). What is actually in that spot is a [gorgon](Mechanics/bestiary/monstrosity/gorgon.md) that obeys drow and has been instructed to ignore the presence of such creatures as hell hounds and fire giants and trolls. If any other kind of creature speaks to it from a distance in Common or Draconic, it has been instructed to stand quietly but then to breathe upon intruders as soon as they are within range. The illusion disappears once the gorgon attacks.

### 7. Treasure Trove Cave

This room is actually an extradimensional space, ten times larger than shown on the map. Anyone entering will notice first the enormous pile of treasure that fills the central part of the area and second the [adult red dragon](Mechanics/bestiary/dragon/adult-red-dragon.md) sleeping upon it.
...
- Seven [spell scrolls](Mechanics/items/spell-scroll-dmg.md) of wizard spells (DM's choice) in a crystal casket worth 500 gp  
- A [dragon slayer](Mechanics/items/dragon-slayer.md) (DM's choice of sword type) in a jeweled scabbard worth 500 gp  
- A [brazier of commanding fire elementals](Mechanics/items/brazier-of-commanding-fire-elementals.md)  
- Four [potions of fire resistance (fire)](Mechanics/items/potion-of-fire-resistance.md) in a coffer  
- Eight jars of rare unguents and perfumes worth 100 gp each  
- A suit of [+2 armor](Mechanics/items/2-armor.md), sized for a human (DM's choice of armor type)  
...
This is a drow guardroom, currently housing three [drow elite warriors](Mechanics/bestiary/humanoid/drow-elite-warrior.md) and six [drow](Mechanics/bestiary/humanoid/drow.md). All are clothed in black capes, shod with soft boots of black hide, and wear hoods over their helmets. Two sentries are on duty at all times near the entrance. The room holds only bedrolls and some miscellaneous gear.
...
Twelve [piercers](Mechanics/bestiary/monstrosity/piercer.md) make their home in a cul de sac, where they patiently await unwary prey. The floor of the place is strewn with shattered skulls and bones.
...
This small place has excellent acoustics, and the drops of water falling into the pool along the southern portion of the wall make a faint, pleasant musical sound that can be heard for 120 feet in silence (or from 60 feet away in normal conditions). The pool's edge is lined by a huge patch of [gray ooze](Mechanics/bestiary/ooze/gray-ooze.md), and another lies along a ledge 11 feet high in the southeast of the place.
...
Three [trolls](Mechanics/bestiary/giant/troll.md) lounge herein, each with the typical messy mound of sticks and bones and other noisome things.

#### 12. Troll Central

Two [trolls](Mechanics/bestiary/giant/troll.md). This room, and its inhabitants, are much the same as those in area 11.

#### 13. Troll Heaven

Four [trolls](Mechanics/bestiary/giant/troll.md), including a dominant one that is particularly large (120 hit points), reside here. Conditions are similar to those in areas 11 and 12, except even more noisome.
...
This dark-walled place is the drow strong point, and a [drow](Mechanics/bestiary/humanoid/drow.md) watches each of the six routes that meet at this cavern. Four more drow are stationed in the chamber itself, for a total of ten.

In addition, the eastern alcove serves as a field headquarters for two [drow elite warriors](Mechanics/bestiary/humanoid/drow-elite-warrior.md) (the female is in command) and a [drow mage](Mechanics/bestiary/humanoid/drow-mage.md). Near this alcove, a narrow passage leads east and then south, ending at a set of rough-hewn stairs that ascend to the second level, emerging near area 8 on map 6.6.
...
The arrows to the north of the entry passage on the map mark the location of a trap. A character must succeed on a DC 20 Wisdom ([Perception](Mechanics/Rules/skills.md#Perception)) check to spot a tripwire made of fine spidersilk that is stretched across the entrance of the cavern. If an intruder steps on the wire, the act triggers a torrent of small iron spheres, each ¼ inch in diameter, that pour out of hidden containers on the eastern wall. These little spheres coat the floor in the final 40 feet of the passageway and the first 20 feet of the cavern itself.

If they fall, the iron balls make a loud noise, and any creature moving across the affected area must succeed on a DC 10 Dexterity saving throw or fall [prone](Mechanics/Rules/conditions.md#Prone). A creature that moves through the area at half speed doesn't need to make the saving throw.

There are nine female drow in the place. Five are normal [drow](Mechanics/bestiary/humanoid/drow.md), and three others are [drow elite warriors](Mechanics/bestiary/humanoid/drow-elite-warrior.md). These eight guards protect Nedylene, a [drow priestess of Lolth](Mechanics/bestiary/humanoid/drow-priestess-of-lolth.md) who is opposed to anything Eclavdra attempts. She is here to check up on her rival, and she will be suspicious of any creature entering her current abode. On the other hand, she will not be averse to seeing her rival's plans go wrong, so negotiation is a possibility.

Nedylene wields a [+2 whip](Mechanics/items/2-weapon.md) and carries a [staff of swarming insects](Mechanics/items/staff-of-swarming-insects.md) in addition to her other gear.

### 17. Jeweled Cavern

If light strikes the walls of this cavern, mineral deposits make the place glitter and sparkle as if it were sown with jewels. This breathtakingly beautiful place is the current lair of two [mind flayers](Mechanics/bestiary/aberration/mind-flayer.md) who have decided to see what is going on with their friendly enemies, the drow. They plan to observe events, and the dark elves ignore them.

#### Treasure

Each mind flayer carries 250 gp (bribe money), and they have a [tome of clear thought](Mechanics/items/tome-of-clear-thought.md) in a black metal box that can be opened only by a creature that has Intelligence 18 or higher.

### 18. Small Cavern

The cave at the end of the passage to the northeast is another drow guardroom, with occupants and contents identical to area 8: three [drow elite warriors](Mechanics/bestiary/humanoid/drow-elite-warrior.md) and six [drow](Mechanics/bestiary/humanoid/drow.md), two of which are on duty at all times near the entrance.
...
Amid this vaporous inferno in the area to the southeast are two [salamanders](Mechanics/bestiary/elemental/salamander.md) enjoying a change of clime. The flames and smoke render the area lightly obscured. The salamanders are totally indifferent with respect to whom they attack, although they know and respect the drow.
...
Currently in this place (at the least) are six [drow](Mechanics/bestiary/humanoid/drow.md) and four [drow elite warriors](Mechanics/bestiary/humanoid/drow-elite-warrior.md), one of which is a female commander who has 110 hit points. The commander has a [+2 shortsword](Mechanics/items/2-weapon.md), a [+1 hand crossbow](Mechanics/items/1-weapon.md), and three magic bolts, as follows:

- A *bolt of holding*, which casts [hold person](Mechanics/spells/hold-person.md) on a target hit with the bolt, as well as up to two other targets within 30 feet of that target  
- A *bolt of blinding*, which casts [blindness/deafness](Mechanics/spells/blindness-deafness.md) to blind on a target hit with the bolt, as well as up to two other targets within 30 feet of that target  
- A *bolt of vapors*, which casts [stinking cloud](Mechanics/spells/stinking-cloud.md) centered on the point it hits  
...
The commander has a small coffer that contains two [potions of speed](Mechanics/items/potion-of-speed.md) and two [potions of superior healing](Mechanics/items/potion-of-superior-healing.md). These will be used by the drow if necessary (and if she is able to dispense them).
