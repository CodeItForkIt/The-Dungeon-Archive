...
|  | + |  |  |  | + |  | + |  | + | [Ontharr Frume](Mechanics/bestiary/npc/ontharr-frume-hotdq.md) supports characters* |
| + |  |  | + |  |  |  |  | + | + | [Leosin Erlanthar](Mechanics/bestiary/npc/leosin-erlanthar-hotdq.md) supports characters* |
| — | + | — |  | — | + | + | + |  | + | Smashed dragon hatchery* |
| + | — | + | + | + | — | — | — |  | — | Left dragon hatchery intact |
| + | + | + | + | + | + | + | + | + | + | Killed [Rezmir](Mechanics/bestiary/npc/rezmir-hotdq.md)* |
| + | + | + | + | + | + | + | + | + | + | Captured [Rezmir](Mechanics/bestiary/npc/rezmir-hotdq.md) |
| — | + | + | + | + | + | + | + | + | + | Killed [Rath Modar](Mechanics/bestiary/npc/rath-modar-hotdq.md) |
| + | + | + | + | + | + | + | + | + | + | Captured [Rath Modar](Mechanics/bestiary/npc/rath-modar-hotdq.md) |
^harpers-order-of-the-gauntlet-emerald-enclave-lady-laeral-silverhand-dagult-neverember-connerad-brawnanvil-king-melandrach-ulder-ravengard-taern-hornblade-sir-isteval-event
