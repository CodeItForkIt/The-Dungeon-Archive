...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/HotDQ/024-tod-05-01.webp#center)
...
The characters have no trouble getting hired as wagon escorts at the supply warehouse. Unlike in the caravan, guards are not hired by individual wagon masters but by the High Road Charter Company, a consortium of guilds and noble houses partnered with Lord Neverember. A human [veteran](Mechanics/bestiary/humanoid/veteran.md) named Ardred Briferhew commands the entire convoy. It consists of six supply wagons, twelve escorts (including the characters and Jamna), and two dozen laborers marching out to relieve a group that is coming back to Waterdeep for some time off. Those cultists who weren't hired as teamsters for their three wagons are coming along as laborers.
...
|-------------------------------|-----------|
| 1–14 | No encounter |
| 15 | 12 human [bandits](Mechanics/bestiary/humanoid/bandit.md) |
| 16 | 1 [troll](Mechanics/bestiary/giant/troll.md) |
| 17 | 4 [orcs](Mechanics/bestiary/humanoid/orc.md) and 1 [ogre](Mechanics/bestiary/giant/ogre.md) |
| 18 | 2 [ogres](Mechanics/bestiary/giant/ogre.md) |
| 19 | 3 [lizardfolk](Mechanics/bestiary/humanoid/lizardfolk.md) and 3 [giant lizards](Mechanics/bestiary/beast/giant-lizard.md) |
| 20 | 6 [lizardfolk](Mechanics/bestiary/humanoid/lizardfolk.md) |
| 21 | 8 [giant frogs](Mechanics/bestiary/beast/giant-frog.md) |
| 22 | 12 [bullywugs](Mechanics/bestiary/humanoid/bullywug.md) |
^modifier-encounter
...
In the floor of the strong room is a camouflaged trapdoor. It can be found with a DC 10 Wisdom ([Perception](Mechanics/Rules/skills.md#Perception)) check. The trapdoor connects to a dripping, slimy tunnel that runs 500 yards into a dense stand of trees and brush at the edge of the Mere of Dead Men. At night, when everyone in the compound is asleep except for a few rooftop guards, lizardfolk creep through the tunnel and take the marked crates to a location in the mere (the subject of chapter 6). They seldom perform this task over a single night unless the shipment is very small. Typically they take one night per wagon.

> [!gallery]
> ![Map 5.1: Carnath Roadhouse](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/HotDQ/025-map-5-1-carnath-roadhouse.webp#gallery)
> ![Player Version](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/HotDQ/026-map-5-1-carnath-roadhouse-player.webp#gallery)
...
The key for this room is always on Bog Luck's belt, but the lock can be opened with a successful DC 10 Dexterity check and a set of [thieves' tools](Mechanics/items/thieves-tools.md).

The trapdoor is located in the southeast corner of the room. An empty crate nailed onto the door covers it; when the door is opened, the whole crate tips toward the north. Being nailed to the floor, the crate feels solid and full to a casual bump or shove. Only when it's tipped does the trick become obvious. It can be discovered with a thorough 20-minute search of the room or with a successful DC 10 Wisdom ([Perception](Mechanics/Rules/skills.md#Perception)) check.

If characters search the strong room during the night, lizardfolk show up to cart away contraband. There are three [lizardfolk](Mechanics/bestiary/humanoid/lizardfolk.md) for every two characters.
...
Bog Luck has this room to himself, so it's more spacious and comfortable than the others. He's seldom here except when sleeping, and he keeps the door locked. A successful DC 10 Dexterity check with [thieves' tools](Mechanics/items/thieves-tools.md) can open it. Despite his crude manner, Bog Luck is a somewhat educated man, as evidenced by the books of philosophy and natural history on his reading shelf.
