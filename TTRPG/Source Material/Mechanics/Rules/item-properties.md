...
Attunement to a cursed item can't be ended voluntarily unless the curse is broken first, such as with the [remove curse](Mechanics/spells/remove-curse-xphb.md) spell.
