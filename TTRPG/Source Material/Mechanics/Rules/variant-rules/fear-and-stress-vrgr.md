...
An overwhelming foe or horrid monster doesn't need magic or some supernatural ability to strike fear into the most stalwart adventurers. During any frightful encounter, you can call on a character to make a saving throw to resist being scared. The character must succeed on a DC 15 Wisdom saving throw or become [frightened](Mechanics/Rules/conditions.md#Frightened) until the end of their next turn.

Any of the following circumstances might be reasons to have one or more characters make saving throws to resist being [frightened](Mechanics/Rules/conditions.md#Frightened):
...
The [calm emotions](Mechanics/spells/calm-emotions.md) spell effect used to suppress the [charmed](Mechanics/Rules/conditions.md#Charmed) and [frightened](Mechanics/Rules/conditions.md#Frightened) conditions also suppresses the effects of one's Stress Score for the spell's duration.

A [lesser restoration](Mechanics/spells/lesser-restoration.md) spell reduces the target's Stress Score by 1, and a [greater restoration](Mechanics/spells/greater-restoration.md) spell reduces a character's Stress Score to 0.