...
In the case of spells that cover an area, such as [fireball](Mechanics/spells/fireball.md) or [lightning bolt](Mechanics/spells/lightning-bolt.md), you might track the exact location of the spell and crew to determine how many sailors it affects. Alternatively, you can roll `1d6` per level of the spell. The total of the dice is the number of crew members caught in the spell's area.
