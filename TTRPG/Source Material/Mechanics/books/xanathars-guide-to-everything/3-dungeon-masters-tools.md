...
Falling from a great height is a significant risk for adventurers and their foes. The rule given in the player's handbook is simple: at the end of a fall, you take `1d6` bludgeoning damage for every 10 feet you fell, to a maximum of `20d6`. You also land [prone](Mechanics/Rules/conditions.md#Prone), unless you somehow avoid taking damage from the fall. Here are two optional rules that expand on that simple rule.

### Rate of Falling

The rule for falling assumes that a creature immediately drops the entire distance when it falls. But what if a creature is at a high altitude when it falls, perhaps on the back of a [griffon](Mechanics/bestiary/monstrosity/griffon.md) or on board an [airship](Mechanics/items/airship.md)? Realistically, a fall from such a height can take more than a few seconds, extending past the end of the turn when the fall occurred. If you'd like high-altitude falls to be properly time-consuming, use the following optional rule.

When you fall from a great height, you instantly descend up to 500 feet. If you're still falling on your next turn, you descend up to 500 feet at the end of that turn. This process continues until the fall ends, either because you hit the ground or the fall is otherwise halted.

### Flying Creatures and Falling

A flying creature in flight falls if it is knocked [prone](Mechanics/Rules/conditions.md#Prone), if its speed is reduced to 0 feet, or if it otherwise loses the ability to move, unless it can hover or it is being held aloft by magic, such as the [fly](Mechanics/spells/fly.md) spell.

If you'd like a flying creature to have a better chance of surviving a fall than a non-flying creature does, use this rule: subtract the creature's current flying speed from the distance it fell before calculating falling damage. This rule is helpful to a flier that is knocked [prone](Mechanics/Rules/conditions.md#Prone) but is still conscious and has a current flying speed that is greater than 0 feet. The rule is designed to simulate the creature flapping its wings furiously or taking similar measures to slow the velocity of its fall.

If you use the rule for rate of falling in the previous section, a flying creature descends 500 feet on the turn when it falls, just as other creatures do. But if that creature starts any of its later turns still falling and is [prone](Mechanics/Rules/conditions.md#Prone), it can halt the fall on its turn by spending half its flying speed to counter the [prone](Mechanics/Rules/conditions.md#Prone) condition (as if it were standing up in midair).

## Sleep

Just as in the real world, D&D characters spend many hours sleeping, most often as part of a long rest. Most monsters also need to sleep. While a creature sleeps, it is subjected to the [unconscious](Mechanics/Rules/conditions.md#Unconscious) condition. Here are a few rules that expand on that basic fact.

### Waking Someone

A creature that is naturally sleeping, as opposed to being in a magically or chemically induced sleep, wakes up if it takes any damage or if someone else uses an action to shake or slap the creature awake. A sudden loud noise-such as yelling, thunder, or a ringing bell-also awakens someone that is sleeping naturally.

Whispers don't disturb sleep, unless a sleeper's passive Wisdom ([Perception](Mechanics/Rules/skills.md#Perception)) score is 20 or higher and the whispers are within 10 feet of the sleeper. Speech at a normal volume awakens a sleeper if the environment is otherwise silent (no wind, birdsong, crickets, street sounds, or the like) and the sleeper has a passive Wisdom ([Perception](Mechanics/Rules/skills.md#Perception)) score of 15 or higher.

### Sleeping in Armor

Sleeping in light armor has no adverse effect on the wearer, but sleeping in medium or heavy armor makes it difficult to recover fully during a long rest.

When you finish a long rest during which you slept in medium or heavy armor, you regain only one quarter of your spent Hit Dice (minimum of one die). If you have any levels of [exhaustion](Mechanics/Rules/conditions.md#Exhaustion), the rest doesn't reduce your [exhaustion](Mechanics/Rules/conditions.md#Exhaustion) level.
...
Whenever you end a 24-hour period without finishing a long rest, you must succeed on a DC 10 Constitution saving throw or suffer one level of [exhaustion](Mechanics/Rules/conditions.md#Exhaustion).

It becomes harder to fight off [exhaustion](Mechanics/Rules/conditions.md#Exhaustion) if you stay awake for multiple days. After the first 24 hours, the DC increases by 5 for each consecutive 24-hour period without a long rest. The DC resets to 10 when you finish a long rest.
...
In addition, consider giving characters who have both a relevant skill and a relevant tool proficiency an added benefit on a successful check. This benefit might be in the form of more detailed information or could simulate the effect of a different sort of successful check. For example, a character proficient with [mason's tools](Mechanics/items/masons-tools.md) makes a successful Wisdom ([Perception](Mechanics/Rules/skills.md#Perception)) check to find a secret door in a stone wall. Not only does the character notice the door's presence, but you decide that the tool proficiency entitles the character to an automatic success on an Intelligence ([Investigation](Mechanics/Rules/skills.md#Investigation)) check to determine how to open the door.
...
See the [Identify a Spell](Mechanics/Rules/actions.md#Identify%20a%20Spell) entry.
...
![Determine Numbers and Challenge Ratings; Solo Monster Challenge Rating](Mechanics/tables/determine-numbers-and-challenge-ratings-solo-monster-challenge-rating-xge.md)
...
![Determine Numbers and Challenge Ratings; Multiple Monsters: 1st-5th Level](Mechanics/tables/determine-numbers-and-challenge-ratings-multiple-monsters-1st-5th-level-xge.md)
...
![Determine Numbers and Challenge Ratings; Multiple Monsters: 6th-10th Level](Mechanics/tables/determine-numbers-and-challenge-ratings-multiple-monsters-6th-10th-level-xge.md)
...
![Determine Numbers and Challenge Ratings; Multiple Monsters: 11th-15th Level](Mechanics/tables/determine-numbers-and-challenge-ratings-multiple-monsters-11th-15th-level-xge.md)
...
![Determine Numbers and Challenge Ratings; Multiple Monsters: 16th-20th Level](Mechanics/tables/determine-numbers-and-challenge-ratings-multiple-monsters-16th-20th-level-xge.md)
...
![Monster Personality](Mechanics/tables/monster-personality-xge.md)
...
![Monster Relationships](Mechanics/tables/monster-relationships-xge.md)
...
![Quick Matchups](Mechanics/tables/quick-matchups-xge.md)
...
To prepare for using a simple trap in play, start by making note of the characters' passive Wisdom ([Perception](Mechanics/Rules/skills.md#Perception)) scores. Most traps allow Wisdom ([Perception](Mechanics/Rules/skills.md#Perception)) checks to detect their triggers or other elements that can tip off their presence. If you stop to ask players for this information, they might suspect a hidden danger.
...
- [Bear Trap](Mechanics/traps-hazards/bear-trap-xge.md)  
- [Crossbow Trap](Mechanics/traps-hazards/crossbow-trap-xge.md)  
- [Falling Portcullis](Mechanics/traps-hazards/falling-portcullis-xge.md)  
- [Fiery Blast Trap](Mechanics/traps-hazards/fiery-blast-trap-xge.md)  
- [Net Trap](Mechanics/traps-hazards/net-trap-xge.md)  
- [Pit Trap](Mechanics/traps-hazards/pit-trap-xge.md)  
- [Poison Needle Trap](Mechanics/traps-hazards/poison-needle-trap-xge.md)  
- [Scything Blade Trap](Mechanics/traps-hazards/scything-blade-trap-xge.md)  
- [Sleep of Ages Trap](Mechanics/traps-hazards/sleep-of-ages-trap-xge.md)  
...
![Level and Lethality; Trap Save DCs and Attack Bonuses](Mechanics/tables/level-and-lethality-trap-save-dcs-and-attack-bonuses-xge.md)

![Level and Lethality; Damage Severity by Level](Mechanics/tables/level-and-lethality-damage-severity-by-level-xge.md)

![Level and Lethality; Spell Equivalent by Level](Mechanics/tables/level-and-lethality-spell-equivalent-by-level-xge.md)
...
A trigger requires a Wisdom ([Perception](Mechanics/Rules/skills.md#Perception)) check if simply spotting it reveals its nature. The characters can foil a pit trap hidden by a leaf-covered net if they spot the pit through a gap in the leaves. A trip wire is foiled if it is spotted, as is a pressure plate.

Other traps require careful inspection and deduction to notice. A doorknob opens a door when turned to the left, but activates a trap when turned to the right. Such a subtle trap requires a successful Intelligence ([Investigation](Mechanics/Rules/skills.md#Investigation)) check to notice. The trigger is obvious. Understanding its nature is not.
...
Once you determine how a trap can be disarmed or avoided, decide the appropriate ability and skill combinations that characters can use. A Dexterity check using [thieves' tools](Mechanics/items/thieves-tools.md), a Strength ([Athletics](Mechanics/Rules/skills.md#Athletics)) check, and an Intelligence ([Arcana](Mechanics/Rules/skills.md#Arcana)) check are all commonly used for this purpose.

A Dexterity check using [thieves' tools](Mechanics/items/thieves-tools.md) can apply to any trap that has a mechanical element. [Thieves' tools](Mechanics/items/thieves-tools.md) can be used to disable a trip wire or a pressure plate, disassemble a poison needle mechanism, or clog a valve that leaks poisonous gas into a room.
...
![Experience for Complex Traps; Complex Trap Experience Awards](Mechanics/tables/experience-for-complex-traps-complex-trap-experience-awards-xge.md)

### Example Complex Traps

The following complex traps can be used to challenge characters or to inspire your own creations.

- [Path of Blades](Mechanics/traps-hazards/path-of-blades-xge.md)  
- [Poisoned Tempest](Mechanics/traps-hazards/poisoned-tempest-xge.md)  
- [Sphere of Crushing Doom](Mechanics/traps-hazards/sphere-of-crushing-doom-xge.md)  
...
The trigger for a complex trap should be as foolproof as you can make it. A complex trap represents a serious expenditure of effort and magical power. No one builds such a trap and makes it easy to avoid. Wisdom ([Perception](Mechanics/Rules/skills.md#Perception)) and Intelligence ([Investigation](Mechanics/Rules/skills.md#Investigation)) checks might be unable to spot a trigger, especially a magical one, but they can still give hints about the trap before it triggers. Bloodstains, ashes, gouges in the floor, and other clues of that sort can serve as evidence of the trap's presence.
...
Not all of the characters' options need to be focused on stopping a trap from operating. Think of what characters can do to mitigate or avoid a trap's effects. Making the trap vulnerable to this sort of effort is a way to engage characters who might be ill-suited to confront the trap directly. A successful Intelligence ([Religion](Mechanics/Rules/skills.md#Religion)) check might provide insight into the imagery displayed by a trap in a temple or shrine, giving other characters a clue about how and where to direct their efforts. A character could stand in front of a dart trap while holding a shield that the darts can target harmlessly, while other characters trigger that element as they work to disable it.
...
![Creating a Rival; Rival](Mechanics/tables/creating-a-rival-rival-xge.md)
...
![Buying a Magic Item; Buying Magic Items](Mechanics/tables/buying-a-magic-item-buying-magic-items-xge.md)

![Buying a Magic Item; Magic Item Price](Mechanics/tables/buying-a-magic-item-magic-item-price-xge.md)
...
A character with the noble background can mingle with the upper class, but other characters can do so only if you judge that the character has made sufficient contacts. Alternatively, a character might use a [disguise kit](Mechanics/items/disguise-kit.md) and the [Deception](Mechanics/Rules/skills.md#Deception) skill to pass as a noble visiting from a distant city.

##### Resolution

After a workweek of carousing, a character stands to make contacts within the selected social class. The character makes a Charisma ([Persuasion](Mechanics/Rules/skills.md#Persuasion)) check using the Carousing table.

![Carousing](Mechanics/tables/carousing-xge.md)
...
![Lower-Class Carousing Complications](Mechanics/tables/lower-class-carousing-complications-xge.md)

![Middle-Class Carousing Complications](Mechanics/tables/middle-class-carousing-complications-xge.md)

![Upper-Class Carousing Complications](Mechanics/tables/upper-class-carousing-complications-xge.md)
...
![Crafting an Item; Resources and Resolution](Mechanics/tables/crafting-an-item-resources-and-resolution-xge.md)
...
![Crafting Magic Items; Magic Item Ingredients](Mechanics/tables/crafting-magic-items-magic-item-ingredients-xge.md)
...
![Brewing Potions of Healing; Potion of Healing Creation](Mechanics/tables/brewing-potions-of-healing-potion-of-healing-creation-xge.md)
...
To attempt a crime, the character makes three checks: Dexterity ([Stealth](Mechanics/Rules/skills.md#Stealth)), Dexterity using [thieves' tools](Mechanics/items/thieves-tools.md), and the player's choice of Intelligence ([Investigation](Mechanics/Rules/skills.md#Investigation)), Wisdom ([Perception](Mechanics/Rules/skills.md#Perception)), or Charisma ([Deception](Mechanics/Rules/skills.md#Deception)).
...
![Crime; Loot Value](Mechanics/tables/crime-loot-value-xge.md)
...
![Crime Complications](Mechanics/tables/crime-complications-xge.md)
...
The character makes three checks: Wisdom ([Insight](Mechanics/Rules/skills.md#Insight)), Charisma ([Deception](Mechanics/Rules/skills.md#Deception)), and Charisma ([Intimidation](Mechanics/Rules/skills.md#Intimidation)). If the character has proficiency with an appropriate gaming set, that tool proficiency can replace the relevant skill in any of the checks. The DC for each of the checks is `5 + 2d10`; generate a separate DC for each one. Consult the Gambling Results table to see how the character did.

![Gambling Results](Mechanics/tables/gambling-results-xge.md)
...
![Gambling Complications](Mechanics/tables/gambling-complications-xge.md)
...
The character makes three checks: Strength ([Athletics](Mechanics/Rules/skills.md#Athletics)), Dexterity ([Acrobatics](Mechanics/Rules/skills.md#Acrobatics)), and a special Constitution check that has a bonus equal to a roll of the character's largest Hit Die (this roll doesn't spend that die). If desired, the character can replace one of these skill checks with an attack roll using one of the character's weapons. The DC for each of the checks is `5 + 2d10`; generate a separate DC for each one. Consult the Pit Fighting Results table to see how the character did.

![Pit Fighting Results](Mechanics/tables/pit-fighting-results-xge.md)
...
![Pit Fighting Complications](Mechanics/tables/pit-fighting-complications-xge.md)
...
At the end of the required time, the character chooses to make either an Intelligence ([Religion](Mechanics/Rules/skills.md#Religion)) check or a Charisma ([Persuasion](Mechanics/Rules/skills.md#Persuasion)) check. The total of the check determines the benefits of service, as shown on the Religious Service table.

![Religious Service](Mechanics/tables/religious-service-xge.md)
...
![Religious Service Complications](Mechanics/tables/religious-service-complications-xge.md)
...
![Research Outcomes](Mechanics/tables/research-outcomes-xge.md)
...
![Research Complications](Mechanics/tables/research-complications-xge.md)
...
Scribing a spell scroll takes an amount of time and money related to the level of the spell the character wants to scribe, as shown in the Spell Scroll Costs table. In addition, the character must have proficiency in the [Arcana](Mechanics/Rules/skills.md#Arcana) skill and must provide any material components required for the casting of the spell. Moreover, the character must have the spell prepared, or it must be among the character's known spells, in order to scribe a scroll of that spell.

If the scribed spell is a cantrip, the version on the scroll works as if the caster were 1st level.

![Resources; Spell Scroll Costs](Mechanics/tables/resources-spell-scroll-costs-xge.md)
...
![Scribe a Scroll Complications](Mechanics/tables/scribe-a-scroll-complications-xge.md)
...
![Magic Item Sale Complications](Mechanics/tables/magic-item-sale-complications-xge.md)
...
![Training Complications](Mechanics/tables/training-complications-xge.md)
...
To determine how much money a character earns, the character makes an ability check: Strength ([Athletics](Mechanics/Rules/skills.md#Athletics)), Dexterity ([Acrobatics](Mechanics/Rules/skills.md#Acrobatics)), Intelligence using a set of tools, Charisma ([Performance](Mechanics/Rules/skills.md#Performance)), or Charisma using a musical instrument. Consult the Wages table to see how much money is generated according to the total of the check.

![Resolution; Wages](Mechanics/tables/resolution-wages-xge.md)
...
![Work Complications](Mechanics/tables/work-complications-xge.md)
...
![Distribution by Rarity; Magic Items Awarded by Tier](Mechanics/tables/distribution-by-rarity-magic-items-awarded-by-tier-xge.md)
...
![Magic Items Awarded by Rarity - Minor](Mechanics/tables/magic-items-awarded-by-rarity-minor-xge.md)

![Magic Items Awarded by Rarity - Major](Mechanics/tables/magic-items-awarded-by-rarity-major-xge.md)
