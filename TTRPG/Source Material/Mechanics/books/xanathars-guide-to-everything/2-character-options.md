...
![Character Options; Subclasses](Mechanics/tables/character-options-subclasses-xge.md)
...
![Parents](Mechanics/tables/parents-xge.md)

![Half-Elf Parents](Mechanics/tables/half-elf-parents-xge.md)

![Half-Orc Parents](Mechanics/tables/half-orc-parents-xge.md)

![Tiefling Parents](Mechanics/tables/tiefling-parents-xge.md)
...
![Birthplace](Mechanics/tables/birthplace-xge.md)
...
![Number of Siblings](Mechanics/tables/number-of-siblings-xge.md)

![Other Details; Birth Order](Mechanics/tables/other-details-birth-order-xge.md)
...
![Supplemental Tables; Family](Mechanics/tables/supplemental-tables-family-xge.md)

![Supplemental Tables; Absent Parent](Mechanics/tables/supplemental-tables-absent-parent-xge.md)

![Supplemental Tables; Family Lifestyle](Mechanics/tables/supplemental-tables-family-lifestyle-xge.md)

![Supplemental Tables; Childhood Home](Mechanics/tables/supplemental-tables-childhood-home-xge.md)

![Supplemental Tables; Childhood Memories](Mechanics/tables/supplemental-tables-childhood-memories-xge.md)
...
![Life Events by Age](Mechanics/tables/life-events-by-age-xge.md)

![Life Events](Mechanics/tables/life-events-xge.md)

#### Secondary Tables

These tables add detail to many of the results on the Life Events table. The tables are in alphabetical order.

![Secondary Tables; Adventures](Mechanics/tables/secondary-tables-adventures-xge.md)

![Secondary Tables; Arcane Matters](Mechanics/tables/secondary-tables-arcane-matters-xge.md)

![Secondary Tables; Boons](Mechanics/tables/secondary-tables-boons-xge.md)

![Secondary Tables; Crime](Mechanics/tables/secondary-tables-crime-xge.md)

![Secondary Tables; Punishment](Mechanics/tables/secondary-tables-punishment-xge.md)

![Secondary Tables; Supernatural Events](Mechanics/tables/secondary-tables-supernatural-events-xge.md)

![Secondary Tables; Tragedies](Mechanics/tables/secondary-tables-tragedies-xge.md)

![Secondary Tables; War](Mechanics/tables/secondary-tables-war-xge.md)

![Secondary Tables; Weird Stuff](Mechanics/tables/secondary-tables-weird-stuff-xge.md)
...
![Supplemental Tables; Alignment](Mechanics/tables/supplemental-tables-alignment-xge.md)

![Supplemental Tables; Cause of Death](Mechanics/tables/supplemental-tables-cause-of-death-xge.md)

![Supplemental Tables; Class](Mechanics/tables/supplemental-tables-class-xge.md)

![Supplemental Tables; Occupation](Mechanics/tables/supplemental-tables-occupation-xge.md)

![Supplemental Tables; Race](Mechanics/tables/supplemental-tables-race-xge.md)

![Supplemental Tables; Relationship](Mechanics/tables/supplemental-tables-relationship-xge.md)

![Supplemental Tables; Status](Mechanics/tables/supplemental-tables-status-xge.md)
...
![Racial Feats](Mechanics/tables/racial-feats-xge.md)
