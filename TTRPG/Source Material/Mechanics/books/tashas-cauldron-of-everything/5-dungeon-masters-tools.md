...
![Tasha prepares to win anot...](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/TCE/090-04-001.webp#center "Tasha prepares to win another game of wizardly chess against her rival Mordenkainen.")
...
![Party Formation; Party Origin](Mechanics/tables/party-formation-party-origin-tce.md)
...
![During a festival below on...](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/TCE/091-04-002.webp#center "During a festival below one of the walking statues of Waterdeep, young friends dream of embarking on adventures together.")
...
Whenever the sidekick gains a level, it gains one Hit Die, and its hit point maximum increases. To determine the amount of the increase, roll the Hit Die (the type of die appears in the sidekick's stat block), and add its Constitution modifier. It gains a minimum of 1 hit point per level.
 ...
 If the sidekick drops to 0 hit points and isn't killed outright, it falls [unconscious](Mechanics/Rules/conditions.md#Unconscious) and subsequently makes death saving throws, just like a player character.
...
- [Expert Sidekick](Mechanics/classes/expert-sidekick-tce.md)  
- [Spellcaster Sidekick](Mechanics/classes/spellcaster-sidekick-tce.md)  
- [Warrior Sidekick](Mechanics/classes/warrior-sidekick-tce.md)  

> [!gallery]
> ![Experts, Left to Right: a ...](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/TCE/092-04-003.webp#gallery "Experts, Left to Right: a Tortle, a Winged Kobold, and a Kenku")
> ![Spellcasters, Left to Righ...](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/TCE/093-04-004.webp#gallery "Spellcasters, Left to Right: a Bullywug, a Goblin, and a Tabaxi")
> ![Warriors, Left to Right: a...](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/TCE/094-04-005.webp#gallery "Warriors, Left to Right: an Aasimar, a Firbolg, and a Wolf")
...
![Monster Research](Mechanics/tables/monster-research-tce.md)

### Monsters' Desires

![Monsters' Desires; Aberrations](Mechanics/tables/monsters-desires-aberrations-tce.md)

![Monsters' Desires; Beasts](Mechanics/tables/monsters-desires-beasts-tce.md)

![Monsters' Desires; Celestials](Mechanics/tables/monsters-desires-celestials-tce.md)

![Monsters' Desires; Constructs](Mechanics/tables/monsters-desires-constructs-tce.md)

![Monsters' Desires; Dragons](Mechanics/tables/monsters-desires-dragons-tce.md)

![Monsters' Desires; Elementals](Mechanics/tables/monsters-desires-elementals-tce.md)

![Monsters' Desires; Fey](Mechanics/tables/monsters-desires-fey-tce.md)

![Monsters' Desires; Fiends](Mechanics/tables/monsters-desires-fiends-tce.md)

![Monsters' Desires; Giants](Mechanics/tables/monsters-desires-giants-tce.md)

![Monsters' Desires; Humanoids](Mechanics/tables/monsters-desires-humanoids-tce.md)

![Monsters' Desires; Monstrosities](Mechanics/tables/monsters-desires-monstrosities-tce.md)

![Monsters' Desires; Oozes](Mechanics/tables/monsters-desires-oozes-tce.md)

![Monsters' Desires; Plants](Mechanics/tables/monsters-desires-plants-tce.md)

![Monsters' Desires; Undead](Mechanics/tables/monsters-desires-undead-tce.md)
...
![Blessed Radiance Effects](Mechanics/tables/blessed-radiance-effects-tce.md)
...
![Far Realm Effects](Mechanics/tables/far-realm-effects-tce.md)
...
- A creature gains the [frightened](Mechanics/Rules/conditions.md#Frightened) condition.  
...
![Haunted Effects](Mechanics/tables/haunted-effects-tce.md)
...
- A creature attacks an insect swarm or a Small or larger insect, such as a [giant centipede](Mechanics/bestiary/beast/giant-centipede.md) or [giant spider](Mechanics/bestiary/beast/giant-spider.md), in the region.  
...
![Infested Effects](Mechanics/tables/infested-effects-tce.md)
...
![Mirror Zone Effects](Mechanics/tables/mirror-zone-effects-tce.md)
...
- A creature becomes [charmed](Mechanics/Rules/conditions.md#Charmed) or [frightened](Mechanics/Rules/conditions.md#Frightened).  
- A creature experiences telepathic communication.  

![Animals converse after gai...](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/TCE/101-04-012.webp#center "Animals converse after gaining sapience from ambient psychic energy.")

![Psychic Resonance Effects](Mechanics/tables/psychic-resonance-effects-tce.md)

> [!note] Awaken Anything
> 
> Legends are filled with natural forces and mundane objects that take on humanoid characteristics to guide or confound heroes: statues that sing, animals that whisper secrets, clouds that speak their mind. While monsters like elementals, [galeb duhr](Mechanics/bestiary/elemental/galeb-duhr.md), and [treants](Mechanics/bestiary/plant/treant.md) represent natural forces brought to life, not every chatty rock or sagacious stream needs a stat block. Perhaps your adventures take a party to a land where plants speak freely or a cursed realm where petrified souls beg for help. Don't feel restricted by the options in the "Monster Manual" or by the limitations of the [animate object](Mechanics/spells/animate-objects.md) spell should you want to breathe extra life into your story. Filling a witch's redoubt with murmuring relics, a fey forest with eavesdropping vegetation, or a sky god's temple with avian choirs makes a place especially memorable. Spells such as [animate objects](Mechanics/spells/animate-objects.md), [awaken](Mechanics/spells/awaken.md), [speak with animals](Mechanics/spells/speak-with-animals.md), [speak with plants](Mechanics/spells/speak-with-plants.md), and the like provide guidance on how to bring commonplace creatures and objects to life.
^awaken-anything
...
![Unraveling Magic Effects](Mechanics/tables/unraveling-magic-effects-tce.md)
...
![Enchanted Springs; Enchanted Spring Effects](Mechanics/tables/enchanted-springs-enchanted-spring-effects-tce.md)
...
Creatures proficient in the [Medicine](Mechanics/Rules/skills.md#Medicine), [Nature](Mechanics/Rules/skills.md#Nature), or [Survival](Mechanics/Rules/skills.md#Survival) skills might be versed on the subject of fungi, especially the magical kind, since the beneficial effects can save lives or bestow unusual powers. But when an unknown variety of fungus is encountered, only an expert can identify it and determine its properties.

To determine the effects of eating such fungus, roll on the Magic Mushroom Effects table.

![Magic Mushrooms; Magic Mushroom Effects](Mechanics/tables/magic-mushrooms-magic-mushroom-effects-tce.md)
...
In wild places brimming with nature's power, gardens meticulously tended by eccentric wizards, and blessed groves touched by divine providence, plants can sometimes produce fruit bursting with primal magic. Not every fruit-bearing plant holds this stored magic, but those that do bear obvious signs: their colors are more vibrant or shift randomly, their skin sparkles in the light or glows in the dark, soft hums emanate from them, or they feel peculiar to the touch.
 ...
 As an action, a creature can eat a piece of primal fruit to gain its effects. This fruit can be squeezed into juice or cooked into a dish and retains its magic. Choose an effect or roll on the Primal Fruit Effects table to determine what happens when a piece of the fruit is consumed. An [identify](Mechanics/spells/identify.md) spell or similar magic reveals the beneficial effect of a piece of fruit before it is eaten, but it doesn't reveal a curse or side effect.
...
![Primal Fruit Effects](Mechanics/tables/primal-fruit-effects-tce.md)
...
![Unearthly Roads; Unearthly Road Keys](Mechanics/tables/unearthly-roads-unearthly-road-keys-tce.md)
...
- [Avalanche](Mechanics/traps-hazards/avalanche-tce.md)  
- [Falling into Water](Mechanics/traps-hazards/falling-into-water-tce.md)  
- [Falling onto a Creature](Mechanics/traps-hazards/falling-onto-a-creature-tce.md)  
...
![Spells as Natural Hazards](Mechanics/tables/spells-as-natural-hazards-tce.md)
...
![Creature Paintings](Mechanics/tables/creature-paintings-tce.md)
...
**Intelligence ([Investigation](Mechanics/Rules/skills.md#Investigation)) DC 10**. The character deduces that the number of creatures in a painting is important and uses that number to determine which letter of the creature's name they should review.

**Wisdom ([Perception](Mechanics/Rules/skills.md#Perception)) DC 10**. When looking at the dedication, the words "count on" alert the character that they should count the creatures.
...
**Intelligence ([Arcana](Mechanics/Rules/skills.md#Arcana)) DC 10**. The character sees one instance of a school of magic on the floor.

**Intelligence ([Investigation](Mechanics/Rules/skills.md#Investigation)) DC 10**. The character interprets the clue in the wall verse: there are eight schools of magic.

**Wisdom ([Perception](Mechanics/Rules/skills.md#Perception)) DC 10**. Each character who succeeds on this check sees an instance of the word "magic" in the floor.
...
- **Abjuration.** The trap casts [dispel magic](Mechanics/spells/dispel-magic.md) on each creature in the room, using a 9th-level spell slot.  
...
- **Enchantment.** The trap casts [suggestion](Mechanics/spells/suggestion.md) (save DC 15) on the creature that triggered it. On a failed save, a gentle voice only the creature can hear tells it to move 5 feet in a random direction. This movement might cause it to trigger another trap.  
...
- **Transmutation.** The trap casts [polymorph](Mechanics/spells/polymorph.md) (save DC 15) on the creature that triggered it. On a failed save, the creature turns into a [giant frog](Mechanics/bestiary/beast/giant-frog.md).  
...
Each lock has a creature molded in iron above it: a bat, snake, spider, or wolf, respectively. These locks can't be picked. If anything other than the correct key is placed inside a lock, creatures corresponding to the image above the lock (`1d4` [giant bats](Mechanics/bestiary/beast/giant-bat.md), `1d4` [giant poisonous snakes](Mechanics/bestiary/beast/giant-poisonous-snake.md), `1d4` [giant wolf spiders](Mechanics/bestiary/beast/giant-wolf-spider.md), or `1d4` [wolves](Mechanics/bestiary/beast/wolf.md)) are summoned into the room. Each summoned creature is hostile and disappears after 10 minutes or when reduced to 0 hit points. These beasts can't be [charmed](Mechanics/Rules/conditions.md#Charmed) or [frightened](Mechanics/Rules/conditions.md#Frightened).
...
![Skeleton Keys Solution](Mechanics/tables/skeleton-keys-solution-tce.md)
...
The statue, which is impervious to damage, depicts Ioun or some other god of knowledge or order. Any character who succeeds on a DC 10 Intelligence ([Religion](Mechanics/Rules/skills.md#Religion)) check can identify the figure being depicted.
...
If a creature attempts to leave the room with any of these stones, the gem disappears and an angry spirit trapped inside it is released. The spirit manifests as a hostile undead creature of your choice, such as a [ghost](Mechanics/bestiary/undead/ghost.md), [specter](Mechanics/bestiary/undead/specter.md), or [skeleton](Mechanics/bestiary/undead/skeleton.md). When this creature is reduced to 0 hit points, its form dissipates, leaving no trace of itself behind.
...
![Solution; Gem Inventory](Mechanics/tables/solution-gem-inventory-tce.md)
...
To make the puzzle easier to solve, a spirit can provide a hint in addition to giving its name. Coaxing a hint from a spirit requires a successful DC 15 Charisma ([Persuasion](Mechanics/Rules/skills.md#Persuasion) or [Intimidation](Mechanics/Rules/skills.md#Intimidation)) check. Consider hints like "A is the first letter in the alphabet" and "The gemstones, in order, will help for a spell."
...
Upon meeting the characters (and to discourage them from attacking), the goblin makes it clear there is no way out of the maze without his help. Characters can determine that the goblin is sincere in wanting to help with a successful DC 10 Wisdom ([Insight](Mechanics/Rules/skills.md#Insight)) check.
...
All around the wizard's study are shelves and cases filled with books, scrolls, and other supplies. A character who makes a successful DC 12 Intelligence ([Arcana](Mechanics/Rules/skills.md#Arcana)) check notices a spell component with no gp value from the list (such as a chip of mica or a bit of bat fur).
...
Wizards and other spellcasters can identify the correct spell components for any spell they know, but they must succeed on the Intelligence ([Arcana](Mechanics/Rules/skills.md#Arcana)) checks noted in the "Hint Checks" section below to recall the correct material components for any less familiar spells.

#### Solution

Drawing a line from a spell to its material component crosses out letters that fall between the columns, as shown in diagram 4.4. Once all spells are connected to components, the untouched letters spell out "presto," which, when said aloud with the paper in hand, causes one or more [spell scrolls](Mechanics/items/spell-scroll-dmg.md) (or some other treasure of your choice) to magically appear.
...
A guard stands on the other side of the door around the clock, and the only way to speak with the guard is through the door's slide window. The guard can be any sort of talking creature, such as an [assassin](Mechanics/bestiary/humanoid/assassin.md), a [cult fanatic](Mechanics/bestiary/humanoid/cult-fanatic.md), or a [thug](Mechanics/bestiary/humanoid/thug.md). More monstrous options include a [bugbear](Mechanics/bestiary/humanoid/bugbear.md), [wereboar](Mechanics/bestiary/humanoid/wereboar.md), or [nycaloth](Mechanics/bestiary/fiend/nycaloth.md).
...
If the characters continue watching the door, they see up to four more visitors approach it. To eavesdrop on each exchange, the characters must succeed on a DC 12 group Dexterity ([Stealth](Mechanics/Rules/skills.md#Stealth)) check to remain hidden; if the group check fails, the visitor notices they're being observed and speaks quietly enough that their answer can't be overheard.
...
![Solution; Potential Passwords](Mechanics/tables/solution-potential-passwords-tce.md)
...
- If the improperly placed tile has an open triangle pointing downward, the [water elemental](Mechanics/bestiary/elemental/water-elemental.md) is freed.  
- If the improperly placed tile has an open triangle pointing upward, the [fire elemental](Mechanics/bestiary/elemental/fire-elemental.md) is freed.  
- If the improperly placed tile has a triangle pointing upward with a horizontal line running through it, the [air elemental](Mechanics/bestiary/elemental/air-elemental.md) is freed.  
- If the improperly placed tile has a triangle pointing downward with a horizontal line running through it, the [earth elemental](Mechanics/bestiary/elemental/earth-elemental.md) is freed.  
...
You can also raise the difficulty by having statues depict genies instead of elementals. In this case, replace the four elementals with a [dao](Mechanics/bestiary/elemental/dao.md), a [djinni](Mechanics/bestiary/elemental/djinni.md), an [efreeti](Mechanics/bestiary/elemental/efreeti.md), and a [marid](Mechanics/bestiary/elemental/marid.md). These genies are compelled to attack the characters and can't be reasoned with.
...
![Solution; Remembered Names](Mechanics/tables/solution-remembered-names-tce.md)
...
![Menu Items](Mechanics/tables/menu-items-tce.md)
...
![What's on the Menu Solution](Mechanics/tables/whats-on-the-menu-solution-tce.md)
...
"Chimera" might not be the password but rather a reference to something or someone else in the tavern. Characters who solve the puzzle and succeed on a DC 15 Wisdom ([Perception](Mechanics/Rules/skills.md#Perception)) check might notice another patron wearing a cloak pin shaped like a chimera, or spot a shield emblazoned with a chimera hanging on a wall that conceals a secret door. Only after speaking to the patron or seeing what's on the other side of the secret door do the characters obtain the actual password, which can be anything you want.
