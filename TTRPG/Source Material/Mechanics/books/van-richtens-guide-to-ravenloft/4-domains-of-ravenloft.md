...
![Dr. Viktra Mordenheim, Dar...](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/VRGR/038-03-001.intro-splash.webp#center "Dr. Viktra Mordenheim, Darklord of Lamordia, crafts the perfect body for her newest band of golem-hunting mercenaries")
...
- A creature that starts its turn in the Mists must succeed on a DC 20 Constitution saving throw or gain 1 level of [exhaustion](Mechanics/Rules/conditions.md#Exhaustion). This [exhaustion](Mechanics/Rules/conditions.md#Exhaustion) can't be removed while the creature is in the Mists.  
...
If a domain's borders are open, the domain is still not easy to escape from. The area within the Mists remains heavily obscured, but the Mists don't cause creatures to gain levels of [exhaustion](Mechanics/Rules/conditions.md#Exhaustion). Characters intent on passing through the Mists travel for `1d6` hours, then roll on the Wandering the Mists table to determine what happens.

![Wandering the Mists](Mechanics/tables/wandering-the-mists-vrgr.md)
...
![Eerie vendors such as thos...](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/VRGR/039-03-002.eerie-vendors.webp#center "Eerie vendors such as those at the Carnival's Litwick Market deal in unique Mist talismans")
...
The Dark Powers influence magical effects, imparting them with sinister qualities. How these changes manifest are for you to decide and can shift from domain to domain. Do summoned creatures appear undead in one domain or violently mutated in another? Do divination spells rasp in the voices of otherworldly ancients? Do the effects of drinking a [potion of healing](Mechanics/items/potion-of-healing.md) feel like grubs weaving wounds shut from within? Magic looks menacing in the Domains of Dread, but descriptive embellishments shouldn't change the actual effects of spells or magic items.
...
When a creature with a soul dies among the Domains of Dread, its spirit becomes caught in the Mists and can't travel to the afterlife. If a creature who has been dead for at least 24 hours returns to life by way of a spell or other supernatural means, it realizes that its spirit is trapped within the Mists, likely forever. Using the rules for "[Fear and Stress](Mechanics/Rules/variant-rules/fear-and-stress-vrgr.md)" from "chapter 4", the creature gains a new Seed of Fear.
...
Each domain is its own demiplane, isolated from all other planes including the Material Plane. No spell—not even [wish](Mechanics/spells/wish.md)—allows escape from the Domains of Dread. Spells such as [astral projection](Mechanics/spells/astral-projection.md), [plane shift](Mechanics/spells/plane-shift.md), [teleport](Mechanics/spells/teleport.md), and similar magic cast for the purpose of escaping a domain simply fail, as do effects that banish a creature to another plane. These restrictions apply to all other effects, including magic items and artifacts that transport or banish creatures to other planes. Magic that allows transit to the Border Ethereal, such as the [etherealness](Mechanics/spells/etherealness.md) spell and the Etherealness feature of ghosts, is the exception to this rule. A creature that enters the Border Ethereal from a domain is pulled back into the domain it left upon leaving the Ethereal.

For the purpose of spells whose effects change across or are blocked by planar boundaries (such as [sending](Mechanics/spells/sending.md)), each domain is considered its own plane. Magic that summons creatures or objects from other planes functions normally, as does magic that involves an extradimensional space. Spells cast within an extradimensional space (such as that created by [Mordenkainen's magnificent mansion](Mechanics/spells/mordenkainens-magnificent-mansion.md)) are subject to the same restrictions as magic cast within a domain.
...
![In the halls of Castle Rav...](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/VRGR/042-03-003.count-strahd.webp#center "In the halls of Castle Ravenloft, Count Strahd von Zarovich clings to ancient obsessions")
...
Little is known of the origins of the Domains of Dread, but what's certain is that they began here. Strahd's villainy, his connection to his land, and his entanglement with the sinister [priests of Osybus](Mechanics/bestiary/humanoid/priest-of-osybus-vrgr.md) (detailed in "chapter 5") drew all of Barovia into the Shadowfell. This began a succession of torments that haunt the Count still and spill forth to drag others into the Land of the Mists.

#### Strahd's Powers and Dominion

Strahd is a patient and dramatic mastermind. His statistics are similar to those of a [vampire](Mechanics/bestiary/undead/vampire.md) and his spellcasting prowess is formidable, enabling him to face most threats directly. Strahd ever seeks to escape his boredom and draws challenges out for as long as it entertains him. However, if insulted, the Darklord can turn all of Barovia against his foes.
...
![Barovia Adventures](Mechanics/tables/barovia-adventures-vrgr.md)
...
![Who Is Tatyana?; Tatyana's Incarnation](Mechanics/tables/who-is-tatyana-tatyanas-incarnation-vrgr.md)
...
![Connection to Strahd; Avoiding Strahd](Mechanics/tables/connection-to-strahd-avoiding-strahd-vrgr.md)

![Connection to Strahd; Hunting Strahd](Mechanics/tables/connection-to-strahd-hunting-strahd-vrgr.md)
...
![Beyond Barovia; Lost Tatyana](Mechanics/tables/beyond-barovia-lost-tatyana-vrgr.md)

![Tatyana might be reborn in...](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/VRGR/043-03-004.tatyana.webp#center "Tatyana might be reborn in any number of guises, such as Ireena Kolyana or Lyssa von Zarovich")

## Bluetspur

![Memories of Bluetspur prov...](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/VRGR/044-03-005.bluetspur.webp#center "Memories of Bluetspur prove as impossible as they are inescapable")
...
The God-Brain commands untold numbers of [mind flayers](Mechanics/bestiary/aberration/mind-flayer.md), [intellect devourers](Mechanics/bestiary/aberration/intellect-devourer.md), and other creatures. Within Bluetspur, it is constantly telepathically linked with all its servants and knows anything that they know. The God-Brain delegates broad goals to its most effective servants, encouraging them to indulge all manner of radical experiments.
...
![Bluetspur Adventures](Mechanics/tables/bluetspur-adventures-vrgr.md)
...
Both the mind flayers of Bluetspur and the Mists surrounding the domain employ methods similar to the [modify memory](Mechanics/spells/modify-memory.md) spell to obscure victims' memories of their abduction, replacing them with hazy events or gaps of missing time. A character's true memories can be restored by a [remove curse](Mechanics/spells/remove-curse.md) or [greater restoration](Mechanics/spells/greater-restoration.md) spell. A victim of the mind flayers might have endured dozens of memory modifications, each requiring its own magical removal, resulting in the recovery of a few traumatic memories at a time.
...
![Alien Artifacts; Aberrant Evidence](Mechanics/tables/alien-artifacts-aberrant-evidence-vrgr.md)
...
![Misericordia and Other Noble Estates; Noble Families and Estates](Mechanics/tables/misericordia-and-other-noble-estates-noble-families-and-estates-vrgr.md)
...
![Ivana Boritsi welcomes gue...](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/VRGR/047-03-007.ivana-boritsi.webp#center "Ivana Boritsi welcomes guests to the poisonous conservatories of Misericordia")
...
Ivana appears to be a young human woman with statistics similar to a [spy](Mechanics/bestiary/humanoid/spy.md). Since her arrival in the Land of the Mists, her blood has been tainted with poison, and angry red-and-black veins visibly show through her pale skin. While this discoloration is unignorable, the toxins grant her immunity to poison damage and being [poisoned](Mechanics/Rules/conditions.md#Poisoned). Her genius and ambition define her manipulations.
...
Ivan isn't a physically or magically powerful Darklord. He's an extremely old man, but supernaturally he remains as physically fit as he was in the prime of life and has the statistics of a human [noble](Mechanics/bestiary/humanoid/noble.md). His menace manifests in the form of psychological manipulation, making others doubt reality, and causing victims to overestimate his control.
...
![Borca Adventures](Mechanics/tables/borca-adventures-vrgr.md)
...
![Ignoble Bonds; Ignoble Request](Mechanics/tables/ignoble-bonds-ignoble-request-vrgr.md)
...
![Lethal Leverage](Mechanics/tables/lethal-leverage-vrgr.md)
...
![Deceitful fey lure the unw...](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/VRGR/050-03-009.deceitful-fey.webp#center "Deceitful fey lure the unwary from the Carnival's midway")
...
> 
> **How did you join the Carnival?** Did you run away to join? Were you an outcast who found a home with the Carnival? Did [Isolde](Mechanics/bestiary/npc/isolde-vrgr.md) or a trouper save you from danger?
^carnival-characters
...
- **Tindal the Barker.** Tindal, the Carnival's cynical, fast-talking lead barker ([mage](Mechanics/bestiary/humanoid/mage.md)), tours the grounds with visitors. At their last stop, he reveals his own uniqueness as the Amazing Soul-less Man: he casts no reflection and claims to lack a soul.  
- **Alti the Werehare.** A quick-tongued rapper and dancer, Alti ([wererat](Mechanics/bestiary/humanoid/wererat.md)) is a bombastic performer who turns into a rabbit on nights of the full moon.  
- **Amelia the Vampire.** Amelia ([scout](Mechanics/bestiary/humanoid/scout.md) with a flying speed of 30 feet) is a cheery acrobat aided in her performances by a pair of leathery wings that allows her to fly. Before stepping on stage, she powders her face, affects a somber accent, and pretends to be undead.  
- **Charlotte the Fire Eater.** This juggling daredevil ([veteran](Mechanics/bestiary/humanoid/veteran.md)) performs with a dizzying array of flaming knives and other deadly objects. She claims that her blood is flammable and that she's burned the hair off eighteen hecklers.  
- **The Organ Grinder.** This somber clown grinds an ornate barrel organ ([scout](Mechanics/bestiary/humanoid/scout.md)). An attendant group of mischievous, half-trained, not-quite-identifiable animals caper to this music. The clown never speaks but allows visitors to guess at the animals' nature for a copper piece.  
- **Silessa the Snake.** A dancer and animal tamer, Silessa ([druid](Mechanics/bestiary/humanoid/druid.md)) performs with a collection of rare serpents. She claims she was born a snake and magically transformed into an elf.  

#### Hall of Horrors

A severe, bespectacled academic, Professor Pacali runs the Carnival's Hall of Horrors. This sizable, sinister tent contains a maze of taxidermic creatures, cabinets of curiosity, peculiar specimens in jars, and the occasional true wonder. Pacali hides a personal unsettling secret. During his time as a researcher at the Brautslava Institute in Darkon, Pacali was cursed: his worst impulses now grow from his body as terrible creatures. He bottles these murderous homunculi and touts them as "Professor Pacali's Pickled Punks," but every now and then one "escapes." Pacali persistently criticizes Hermos and [Isolde](Mechanics/bestiary/npc/isolde-vrgr.md), but rarely acts against them directly.
...
[Isolde](Mechanics/bestiary/npc/isolde-vrgr.md), the Carnival's leader, is an eladrin (an elf native to the Feywild). She is a Fey who otherwise uses the [cambion](Mechanics/bestiary/fiend/cambion.md) stat block. She is never seen without her [holy avenger](Mechanics/items/holy-avenger.md) longsword, [Nepenthe](Mechanics/items/nepenthe-vrgr.md), which glows red with hate. Nepenthe, not [Isolde](Mechanics/bestiary/npc/isolde-vrgr.md), is the Carnival's Darklord.
...
[Isolde](Mechanics/bestiary/npc/isolde-vrgr.md) was a holy warrior devoted to a pantheon of elven deities called the Seldarine. In this role, she defended the Feywild against dragons, demons, and other threats. In time, her heroics caught the eye of an archfey named Zybilna, who had forged secret pacts with some of the fiends [Isolde](Mechanics/bestiary/npc/isolde-vrgr.md) and her companions had slain. Rather than be angry at [Isolde](Mechanics/bestiary/npc/isolde-vrgr.md), Zybilna was impressed by her. She enlisted a powerful fiend known only as "the Caller" to corrupt and slay all of [Isolde](Mechanics/bestiary/npc/isolde-vrgr.md)'s companions, leaving [Isolde](Mechanics/bestiary/npc/isolde-vrgr.md) alone, bitter, and vulnerable. The insidious archfey then befriended [Isolde](Mechanics/bestiary/npc/isolde-vrgr.md) and offered to help her forget her terrible losses. [Isolde](Mechanics/bestiary/npc/isolde-vrgr.md) became the master of a traveling fey carnival that served as a gateway to Zybilna's domain. The carnival did what Zybilna hoped it would do: it brought comfort to [Isolde](Mechanics/bestiary/npc/isolde-vrgr.md) and quelled her thirst for vengeance.

Zybilna and [Isolde](Mechanics/bestiary/npc/isolde-vrgr.md) enjoyed a strong partnership for years, but as time wore on, they grew distant until their relationship finally soured. Eladrin crave change, yet [Isolde](Mechanics/bestiary/npc/isolde-vrgr.md) felt like she was frozen in time. She wished to leave the fey carnival and pursue other dreams, but Zybilna wouldn't hear of it and secretly used [wish](Mechanics/spells/wish.md) spells to make [Isolde](Mechanics/bestiary/npc/isolde-vrgr.md) place her devotion to the carnival above her desire to leave it.

When [Isolde](Mechanics/bestiary/npc/isolde-vrgr.md)'s fey carnival crossed paths with another carnival from the Shadowfell, the eladrin found the escape she longed for. [Isolde](Mechanics/bestiary/npc/isolde-vrgr.md) orchestrated a trade with the other carnival's owners, a pair of shadar-kai (elves native to the Shadowfell). [Isolde](Mechanics/bestiary/npc/isolde-vrgr.md) would become the master of their carnival, and they would become the masters of hers. To appease Zybilna, this arrangement would remain in place only until the two carnivals crossed paths again.

Zybilna was intrigued enough by the shadar-kai to let [Isolde](Mechanics/bestiary/npc/isolde-vrgr.md) go, but not without casting a spell that made [Isolde](Mechanics/bestiary/npc/isolde-vrgr.md) forget about Zybilna and her Feywild domain, thus preventing the eladrin from divulging the archfey's secrets. As a further punishment, Zybilna sent malevolent fey creatures to hound [Isolde](Mechanics/bestiary/npc/isolde-vrgr.md) and her Shadowfell carnival. [Isolde](Mechanics/bestiary/npc/isolde-vrgr.md) doesn't know who is behind this petty torment, nor does she care. Her hunt for the Caller and her thirst for vengeance have become all-consuming.

#### Nepenthe

The [holy avenger](Mechanics/items/holy-avenger.md) named [Nepenthe](Mechanics/items/nepenthe-vrgr.md) was crafted by shadar-kai to mete out justice as an executioner's weapon. In its lifetime, the sword has beheaded thousands of criminals, not all of whom were guilty of the crimes for which they were convicted. The sword cannot distinguish the guilty from the innocent. With each beheading, it hungers for more justice and blood.

Nepenthe came to the Carnival in the hands of a retired half-ogre who moonlighted as a sword-swallower. When the half-ogre died of old age, the sword was deemed the property of the Carnival. It was given to [Isolde](Mechanics/bestiary/npc/isolde-vrgr.md) by the Carnival's previous owners, who claimed that the sword would help her protect the Carnival against any threat.

In [Isolde](Mechanics/bestiary/npc/isolde-vrgr.md), the sword found a partner who shared its blind malice toward the guilty. [Isolde](Mechanics/bestiary/npc/isolde-vrgr.md) uses Nepenthe to behead anyone found guilty of stealing from the Carnival or inflicting harm upon it.

As soon as [Isolde](Mechanics/bestiary/npc/isolde-vrgr.md) took up the blade, it rekindled the grief and fury she had suppressed for so long, awakening the desire to avenge her long-dead companions by slaying the fiend she knows as "the Caller" (see ""Mist Wanderers"" later in this chapter for details). [Isolde](Mechanics/bestiary/npc/isolde-vrgr.md) always chooses the Carnival's stops based on her predictions of the Caller's next steps, and if her pursuit forces the Carnival into danger, so be it. Only by ridding [Isolde](Mechanics/bestiary/npc/isolde-vrgr.md) of Nepenthe can she truly escape the Dark Powers' clutches. But [Isolde](Mechanics/bestiary/npc/isolde-vrgr.md) will never part with the blade willingly, and if it is taken from the Carnival, the sword will always find its way back.

In addition to having the properties of a [holy avenger](Mechanics/items/holy-avenger.md), Nepenthe is a sentient, neutral evil weapon with an Intelligence of 10, a Wisdom of 8, and a Charisma of 18. It has hearing and [darkvision](Mechanics/Rules/senses.md#Darkvision) out to a range of 60 feet. It can read and understand Elvish. It can also speak Elvish, but only through the voice of its wielder, with whom the sword can communicate telepathically. When using its telepathy to speak to [Isolde](Mechanics/bestiary/npc/isolde-vrgr.md), the sword can mimic the voices of [Isolde](Mechanics/bestiary/npc/isolde-vrgr.md)'s fallen companions as it drives her to catch their fiendish killer. Unlike [Isolde](Mechanics/bestiary/npc/isolde-vrgr.md), whose motives are good, the sword is corrupt and irredeemable.

#### Freedom of the Mists

The Carnival travels through the Mists and between other Domains of Dread as [Isolde](Mechanics/bestiary/npc/isolde-vrgr.md) pleases—though the Dark Powers occasionally send it off course. The Carnival provides one of the few means of escaping from another Darklord's domain, since it ignores the closed borders of other domains. Other Darklords cannot travel with the Carnival to escape their own domains, however.

#### Closing the Borders

Nepenthe can close the borders of its domain, as detailed in ""The Mists"" at the start of this chapter. With the sword's consent, [Isolde](Mechanics/bestiary/npc/isolde-vrgr.md) can do the same. When the Carnival's borders close, the Mists are filled with eerie, colorful lights and distant music, echoing memories of past carnivals.

#### Isolde's Torment

[Isolde](Mechanics/bestiary/npc/isolde-vrgr.md) is both protector and prisoner of the Carnival.

The following truths endlessly weigh upon her:

- The Carnival constantly grows, bringing additional souls dependent on [Isolde](Mechanics/bestiary/npc/isolde-vrgr.md)'s guardianship. She's tortured by her obligation toward the Carnival's troupers and her vow to avenge her murdered companions.  
...
- [Isolde](Mechanics/bestiary/npc/isolde-vrgr.md) dreads the day when the Carnival crosses paths with its fey counterpart for a second time. Were that to happen, [Isolde](Mechanics/bestiary/npc/isolde-vrgr.md) would be forced to relinquish the Carnival to its true shadar-kai masters, and Nepenthe along with it.  
...
Alcio is a flashy, passionate, and fantastically violent [vampire](Mechanics/bestiary/undead/vampire.md). As the head of the Kargat and the region's criminal operations, she rules the Jagged Coast using information and intimidation. She's quick to punish incompetence and quicker to reward daring, but she reserves her greatest rewards for those who further her plots for revenge against Rudolph van Richten.
...
Darcalus Rex is a [necrichor](Mechanics/bestiary/undead/necrichor-vrgr.md) (see "chapter 5") who cares little for the survival of Darkon—and might not even be the ancient ruler. The elf [archmage](Mechanics/bestiary/humanoid/archmage.md) Cardinna Artazas desperately believes she's doing what must be done—including corrupting her order—to save her homeland.
...
![Castle Avernus, frozen at ...](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/VRGR/055-03-012.castle-avernus.webp#center "Castle Avernus, frozen at the moment of its destruction")
...
![Darkon Adventures](Mechanics/tables/darkon-adventures-vrgr.md)
...
![Darkon's Salvation](Mechanics/tables/darkons-salvation-vrgr.md)

![Means to Save Darkon](Mechanics/tables/means-to-save-darkon-vrgr.md)
...
![Darkon Allies](Mechanics/tables/darkon-allies-vrgr.md)

![Darkon Rivals](Mechanics/tables/darkon-rivals-vrgr.md)
...
![Dread in Darkon](Mechanics/tables/dread-in-darkon-vrgr.md)
...
![Darkon Finale](Mechanics/tables/darkon-finale-vrgr.md)
...
![Duchess d'Honaire punishes...](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/VRGR/058-03-013.duchess.webp#center "Duchess d'Honaire punishes the unworthy who sneak into the Grand Masquerade")

#### Saidra's Powers and Dominion

Saidra's form is a vaporous as her claims to nobility. She's a crimson spirit with statistics similar to a [wraith](Mechanics/bestiary/undead/wraith.md). She can cast the [disintegrate](Mechanics/spells/disintegrate.md) spell (save DC 18) on any creature that reveals themself to be lying about who they are. In her guise as duchess, Saidra dons a bird-like mask and fashionable scarlet gowns. As the Red Death, she is nothing more than a crimson-tinged shadow.
...
![Dementlieu Adventures](Mechanics/tables/dementlieu-adventures-vrgr.md)
...
![The Grand Masquerade; Grand Masquerade Objectives](Mechanics/tables/the-grand-masquerade-grand-masquerade-objectives-vrgr.md)
...
- Characters can keep a close eye on how other people behave and mimic that behavior. Use Wisdom ([Perception](Mechanics/Rules/skills.md#Perception)) checks to measure how keenly they observe the partygoers' deportment, and Intelligence ([Investigation](Mechanics/Rules/skills.md#Investigation)) checks to deduce the right behavior for a particular situation.  
- Characters can apply magic or intuition to discern the response or behavior that a questioner expects. Use Wisdom ([Insight](Mechanics/Rules/skills.md#Insight)) checks unless characters have access to mind-reading spells such as [detect thoughts](Mechanics/spells/detect-thoughts.md) or similar magic.  
- Characters can fake it 'til they make it. Use Charisma ([Deception](Mechanics/Rules/skills.md#Deception)) checks extensively as characters work their way through the ball. Failed checks draw increased attention; on successful checks, the questioners lose interest.  
- Characters can distract watchers to shift attention if things go badly. Use Charisma ([Deception](Mechanics/Rules/skills.md#Deception)) or Dexterity ([Sleight of Hand](Mechanics/Rules/skills.md#Sleight%20of%20Hand)) checks (or any other reasonable skill checks the players suggest) to determine whether they turn the focus away from their errors.  
...
![Random Complications; Grand Masquerade Complications](Mechanics/tables/random-complications-grand-masquerade-complications-vrgr.md)
...
Vladeska Drakov is an experienced military commander with statistics similar to those of a [knight](Mechanics/bestiary/humanoid/knight.md). While her martial skill is considerable, her true might comes in the form of the obedient army that unquestioningly enacts her every whim.

##### The Falcon's Talons

Vladeska's military forces are both completely overwhelming and entirely outnumbered. As an occupying force, the Talons are terrifying. Their numbers are relatively few, but they're organized enough to oppress Lekar's ragged survivors and enforce Drakov's totalitarian laws. In the face of zombie hordes, though, they're fighting a losing battle against foes whose numbers only grow. And every time a Talon falls, Lekar's final defeat grows closer. Talon soldiers use the [guard](Mechanics/bestiary/humanoid/guard.md) stat block, while commanders are [veterans](Mechanics/bestiary/humanoid/veteran.md).
...
![Vladeska Drakov and her Ta...](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/VRGR/061-03-014.vladeska.webp#center "Vladeska Drakov and her Talons struggle to defend Lekar from endless zombie hordes")
...
![Falkovnia Adventures](Mechanics/tables/falkovnia-adventures-vrgr.md)
...
- **Mindtaker Mists.** The Mists deposit the characters' consciousnesses into soldiers, Talon officers, or unprepared peasants preparing for the siege. Consult the "[Survivors](Mechanics/Rules/variant-rules/survivors-vrgr.md)" section of "chapter 4" for suggestions on how to represent soldiers bound to face the horde.  

#### Before the Siege

However the characters become enlisted in Lekar's defense, they face a hopeless battle. They join hundreds of unprepared defenders, including [commoners](Mechanics/bestiary/humanoid/commoner.md) holding clubs or longbows for the first time.
...
The siege lasts as long as you like. Use frantic rushes between emergencies to describe small horrors and victories while wearing down the characters' resources with brief zombie attacks. If the characters feel completely overwhelmed, Talon [priests](Mechanics/bestiary/humanoid/priest.md) with [potions of healing](Mechanics/items/potion-of-healing.md) might appear, or an officer can enlist characters to deliver orders from General Drakov (likely related to the siege's climax).
...
![During the Siege; Zombie Siege Encounters](Mechanics/tables/during-the-siege-zombie-siege-encounters-vrgr.md)
...
![Concluding the Siege; Zombie Siege Climax](Mechanics/tables/concluding-the-siege-zombie-siege-climax-vrgr.md)

Drakov's scheme might be even more alarming, involving magical or monstrous secret weapons.

Once you've determined how the siege will unfold, start foreshadowing Drakov's scheme, giving the characters the opportunity to aid it, enact a less destructive plan, or save innocents. Use missives intercepted from messengers or a [sending stone](Mechanics/items/sending-stones.md) taken from a fallen Talon officer to clue the party in on Drakov's strategy.
...
A fantastically ancient Undead, Ankhtepot has statistics similar to a [mummy lord](Mechanics/bestiary/undead/mummy-lord.md). Beyond this, he rules as pharaoh, national leader, and voice of the gods. None in Har'Akir, among the living or the dead, denies his will, but the Darklord's wishes are few. He cares only for order and to find his lost ka.

##### Children of Ankhtepot

The Darklord is served by many of the same priests who died alongside him in ages past. He resurrected these [mummies](Mechanics/bestiary/undead/mummy.md) and [mummy lords](Mechanics/bestiary/undead/mummy-lord.md) with the heads of animals, painting them as spirits and harbingers of his fictitious gods of Har'Akir. As Ankhtepot has grown bored with mortal concerns, the Children of Ankhtepot have pursued their own vices. Many dream and despair in their crypts. Others foment small cults of their own. And still others seek to undermine the pharaoh and claim his position—including the treacherous [mummy lord](Mechanics/bestiary/undead/mummy-lord.md) Senmet.
...
![Har'Akir Adventures](Mechanics/tables/harakir-adventures-vrgr.md)
...
![The Soul's Shape; Ankhtepot's Soul](Mechanics/tables/the-souls-shape-ankhtepots-soul-vrgr.md)
...
![The Hunters' Role; Hunt for the Ka](Mechanics/tables/the-hunters-role-hunt-for-the-ka-vrgr.md)
...
![The Pharaoh's Return; Ankhtepot Reborn](Mechanics/tables/the-pharaohs-return-ankhtepot-reborn-vrgr.md)
...
- Creatures warped by magical experiments infest the domain, including magic-hungry [gremishkas](Mechanics/bestiary/monstrosity/gremishka-vrgr.md) (see "chapter 5") and ravenous [purple worms](Mechanics/bestiary/monstrosity/purple-worm.md).  
...
Hazlik is a vain, egotistical overlord, convinced he is the supreme being in his domain. His statistics echo those of an [archmage](Mechanics/bestiary/humanoid/archmage.md), but he favors using an array of magic items rather than his own spells.
...
![Hazlan Adventures](Mechanics/tables/hazlan-adventures-vrgr.md)
...
![Hazlan Wild Magic](Mechanics/tables/hazlan-wild-magic-vrgr.md)

### The Eye of Hazlik

![The wizard Eleni's most re...](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/VRGR/068-03-017.wizard-eleni.webp#center "The wizard Eleni's most recent experiment: dominating the worm Gravedrinker")
...
- At any time, Hazlik can use any Eye of Hazlik in his domain as a stationary eye created by the [arcane eye](Mechanics/spells/arcane-eye.md) spell. He can spy through the eye whenever and for as long as he pleases. The eye radiates magic while Hazlik spies through it.  
...
- [Jiangshi](Mechanics/bestiary/undead/jiangshi-vrgr.md) haunt the streets of I'Cath, tearing down whole districts and rebuilding them.  
...
Tsien Chiang's statistics are similar to those of a [mage](Mechanics/bestiary/humanoid/mage.md) with access to a variety of magic items—her favorite being an ornate robe that functions similarly to a [Heward's handy haversack](Mechanics/items/hewards-handy-haversack.md) and [wings of flying](Mechanics/items/wings-of-flying.md). She uses this robe to store scrolls detailing her most recent plans for I'Cath's renovation. Additionally, Tsien Chiang enforces her will upon her domain in a variety of other ways.
...
![I'Cath Adventures](Mechanics/tables/icath-adventures-vrgr.md)
...
- **Tsien Lei-An.** Voiceless Tsien Lei-An is made entirely of eyes and has the statistics of a [scarecrow](Mechanics/bestiary/construct/scarecrow.md). She wishes for a robe of ghost hair silk or a jiangshi's slippers. She spends much of her time wandering the Mansions, rooting through the possessions of sleeping city-dwellers.  
- **Tsien Man-Yi.** Made of pale wood, Tsien Man-Yi must remain near the willow tree in the courtyard of the Palace of Bones, and has the statistics of a [dryad](Mechanics/bestiary/fey/dryad.md). She wishes for flowers from the Gemstone Garden or for a friend to fall asleep under her tree's boughs.  
- **Tsien Seu-Mei.** Voiceless Tsien Seu-Mei is made entirely of teeth and has the statistics of a [ghoul](Mechanics/bestiary/undead/ghoul.md). She wishes to eat a delicious dessert or care for one of the fish of the Gemstone Gardens. She often wanders the stalls of Gwai-Huit Center.  
- **Tsien Wai-Ching.** Made of living fog, Tsien Wai-Ching is the youngest daughter and has the statistics of a [specter](Mechanics/bestiary/undead/specter.md). She wishes to help a spirit from Ping'On Tower find its family or to play with an incorporeal toy. She regularly explores the memorials in the Gemstone Gardens.  
...
Kalakeri's most fearsome predators inhabit the Backwaters, including [basilisks](Mechanics/bestiary/monstrosity/basilisk.md), [hydras](Mechanics/bestiary/monstrosity/hydra.md), [stone giants](Mechanics/bestiary/giant/stone-giant.md), and [cloud giants](Mechanics/bestiary/giant/cloud-giant.md).
...
![Kalakeri Adventures](Mechanics/tables/kalakeri-adventures-vrgr.md)
...
![Renown in Kalakeri](Mechanics/tables/renown-in-kalakeri-vrgr.md)
...
![Benefits of Renown; Loyalist Benefits](Mechanics/tables/benefits-of-renown-loyalist-benefits-vrgr.md)
...
![Benefits of Renown; Rebel Benefits](Mechanics/tables/benefits-of-renown-rebel-benefits-vrgr.md)
...
![The crowds at the Crystal ...](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/VRGR/075-03-024.the-crowds.webp#center "The crowds at the Crystal Club in Harmonia have a vicious reputation. Some performers learn why firsthand")
...
![Kartakass Adventures](Mechanics/tables/kartakass-adventures-vrgr.md)
...
![Meeting the Darklord; Favors for Harkon Lukas](Mechanics/tables/meeting-the-darklord-favors-for-harkon-lukas-vrgr.md)
...
- **Brain Swap.** Dr. Mordenheim can place a creature's brain or head into another body, moving it from a donor to a recipient. The process requires the donor to have a brain and either be [incapacitated](Mechanics/Rules/conditions.md#Incapacitated) or to have been dead for less than 24 hours. In an operation that takes 1 hour, the doctor transfers the donor's brain or head from their body to the [incapacitated](Mechanics/Rules/conditions.md#Incapacitated) or dead corporeal body of a creature without a brain. The donor awakes 1 hour later with control of the recipient's body.  
...
- [Elise](Mechanics/bestiary/npc/elise-vrgr.md) evades Mordenheim's attempts to find her.  
...
![Lamordia Adventures](Mechanics/tables/lamordia-adventures-vrgr.md)

### Mordenheim's Monsters

The horror at Lamordia's heart is Dr. Mordenheim's bizarre experiments and ceaseless search for [Elise](Mechanics/bestiary/npc/elise-vrgr.md).

#### Elise and the Unbreakable Heart

Above all else, Dr. Mordenheim's objectives are finding [Elise](Mechanics/bestiary/npc/elise-vrgr.md) and recovering or re-creating the Unbreakable Heart.

##### Elise

Dr. Mordenheim's supposed beloved and greatest achievement, [Elise](Mechanics/bestiary/npc/elise-vrgr.md) is a confused, frustrated soul who never wished for her current circumstances. She's now a [flesh golem](Mechanics/bestiary/construct/flesh-golem.md) with the following adjustments:

- [Elise](Mechanics/bestiary/npc/elise-vrgr.md) does not have the Berserk or Aversion of Fire traits.  
- She has immunity to cold damage.  

[Elise](Mechanics/bestiary/npc/elise-vrgr.md)'s heart has been replaced with the Unbreakable Heart. If this device is removed, [Elise](Mechanics/bestiary/npc/elise-vrgr.md) dies, even if it is replaced with another heart. [Elise](Mechanics/bestiary/npc/elise-vrgr.md) is horrified by what Dr. Mordenheim did to her and tries to avoid the doctor and all strangers, fearing they might kill her to learn the Unbreakable Heart's secrets. She roams without destination but keeps a hidden sanctuary at Hope's Heart on the Isles of Agony. Although she has tried to leave Lamordia, the Mists prevent her from doing so.
...
![Within Elise's undying bod...](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/VRGR/083-03-025.dr-mordenheim.webp#center "Within Elise's undying body beats Dr. Mordenheim's greatest creation: the Unbreakable Heart")
...
![Mordenheim's Designs; Serving Dr. Mordenheim](Mechanics/tables/mordenheims-designs-serving-dr-mordenheim-vrgr.md)
...
![Mordent Adventures](Mechanics/tables/mordent-adventures-vrgr.md)
...
![Ghost's History](Mechanics/tables/ghosts-history-vrgr.md)
...
![Tragedy; Tragic Elements](Mechanics/tables/tragedy-tragic-elements-vrgr.md)
...
![Romance; Romantic Elements](Mechanics/tables/romance-romantic-elements-vrgr.md)

![All who die in Mordent bec...](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/VRGR/087-03-028.all-who-die.webp#center "All who die in Mordent become captives to the will of Lord Wilfred Godefroy")
...
Finding like-minded souls took Renier years, but she finally became aware of the mysterious Trueblood Council, a secret society of Richemulot's eldest and most esteemed families. Expending a fortune, Renier aggressively pursued membership. Finally she was granted an invitation to join the society's members at their meeting place hidden among the sewers of Pont-a-Museau. But when Renier arrived, she found a throng of filthy commoners, not the dramatic masterminds she'd expected. As she cursed them and set off to fetch the guards, the council members revealed their true [wererat](Mechanics/bestiary/humanoid/wererat.md) forms. That night, she was inducted into their ranks.
...
Although Jacqueline Renier has statistics similar to those of a [wererat](Mechanics/bestiary/humanoid/wererat.md), she assumes her hybrid or rat form only when forced to defend herself or when pushed to the brink of rage. She is rarely without guards, be they members of the Casques Silencieux, wererat bodyguards, or hidden swarms of rats.

##### Casques Silencieux

The Darklord's silent state police guard Chateau Delanuit and enforce her quarantines across Richemulot. Rather than the soldiers they appear to be, these troops are [animated armor](Mechanics/bestiary/construct/animated-armor.md) filled with rats that mindlessly and mercilessly enact Jacqueline Renier's will. If a guard is defeated, the armor collapses, releasing a [swarm of rats](Mechanics/bestiary/beast/swarm-of-rats.md).
...
When Jacqueline Renier wishes to close her domain's borders, the Mists rise at the edge of the lands, as detailed in ""The Mists"" at the start of this chapter. Additionally, the Mists are filled with [swarms of rats](Mechanics/bestiary/beast/swarm-of-rats.md); endless waves of them attack any creatures that enter the Mists.
...
![Richemulot Adventures](Mechanics/tables/richemulot-adventures-vrgr.md)
...
The Gnaws is spread when a creature is bitten by a [rat](Mechanics/bestiary/beast/rat.md), [giant rat](Mechanics/bestiary/beast/giant-rat.md), [swarm of rats](Mechanics/bestiary/beast/swarm-of-rats.md), or [wererat](Mechanics/bestiary/humanoid/wererat.md) that carries the disease, or by coming into physical contact with an infected creature.
...
It takes `1d2` days for the Gnawing Plague's symptoms to manifest in an infected creature. The infected creature then gains 1 level of [exhaustion](Mechanics/Rules/conditions.md#Exhaustion), regains only half the normal number of hit points from spending Hit Dice, and regains no hit points from finishing a long rest.
...
At the end of each long rest, an infected creature must make a DC 10 Constitution saving throw. On a failed save, the creature gains 1 level of [exhaustion](Mechanics/Rules/conditions.md#Exhaustion). On a successful save, the creature's [exhaustion](Mechanics/Rules/conditions.md#Exhaustion) level decreases by 1. If a successful saving throw reduces the infected creature's level of [exhaustion](Mechanics/Rules/conditions.md#Exhaustion) below 1, the creature recovers from the disease.

#### Immunity

All forms of rats and wererats are immune to the Gnawing Plague.

![Wearing a mask curtails th...](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/VRGR/091-03-030.wearing-a-mask.webp#center "Wearing a mask curtails the plague but not wererats")
...
![Stage Two: Outbreak; Stage Two Encounters](Mechanics/tables/stage-two-outbreak-stage-two-encounters-vrgr.md)
...
![Stage Three: Illness; Stage Three Encounters](Mechanics/tables/stage-three-illness-stage-three-encounters-vrgr.md)
...
![Stage Four: Pestilence; Stage Four Encounters](Mechanics/tables/stage-four-pestilence-stage-four-encounters-vrgr.md)
...
Lorinda is a [green hag](Mechanics/bestiary/fey/green-hag.md) of extreme age. In her true form, she carries her darling family—three grim dolls she calls Laveeda, Leticia, and Laoirse. When dealing with the residents of Viktal, she takes on her benevolent illusory guise as Mother.
...
![Tepest Adventures](Mechanics/tables/tepest-adventures-vrgr.md)
...
![A visitor enjoys the hospi...](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/VRGR/095-03-032.a-visitor.webp#center "A visitor enjoys the hospitality of Viktal during the Tithe")

![Welcome to Viktal; Sights in Viktal](Mechanics/tables/welcome-to-viktal-sights-in-viktal-vrgr.md)
...
![Tithe Events](Mechanics/tables/tithe-events-vrgr.md)
...
![Mother's Blessing; Lorinda's Daughter](Mechanics/tables/mothers-blessing-lorindas-daughter-vrgr.md)
...
- Packs of displacer beasts roam the jungle, led by Yana, a preternaturally cunning [displacer beast](Mechanics/bestiary/monstrosity/displacer-beast.md) that serves Chakuna.  
...
Wildflowers, enticing fruits, and medicinal herbs grow in the forests and upon the shorelines around the Eirubamba River. Most rain forest predators won't approach the river, though, fearing the territorial [giant wasps](Mechanics/bestiary/beast/giant-wasp.md) that swarm among the rare plants.
...
Chakuna gained her status as a Darklord when she defeated Urik von Kharkov. In so doing, though, she discovered a terrible truth about the nature of Valachan, and she now lives to maintain the domain and the cycle of predator and prey. Chakuna has statistics similar to a [weretiger](Mechanics/bestiary/humanoid/weretiger.md), but her animal and hybrid forms have the appearance of a panther.
...
The Trial of Hearts anchors the terror in Valachan, but the domain's dangerous wilderness threatens anyone who explores the land. In addition to natural rain-forest predators, dinosaurs and [displacer beasts](Mechanics/bestiary/monstrosity/displacer-beast.md) roam the domain. Its varied Plant creatures include wicked [twig blights](Mechanics/bestiary/plant/twig-blight.md), cruel [treants](Mechanics/bestiary/plant/treant.md), and manipulative [dryads](Mechanics/bestiary/fey/dryad.md) all expressing the land's underlying blood thirst. The people of the land—the werepanthers of Oselo, the Shuaran, and remote groups of lizardfolk—might provide assistance to outsiders, but they don't tolerate those who insult their ways or bring Chakuna's wrath upon them. Parties without experience exploring dangerous wilds can enlist a guide to aid them, a service that the Oselo are particularly willing to provide.
...
![Valachan Adventures](Mechanics/tables/valachan-adventures-vrgr.md)
...
Characters able to fly find their flight slowed by strong winds (effectively difficult terrain), and might face deadly airborne creatures such as [chimeras](Mechanics/bestiary/monstrosity/chimera.md), [harpies](Mechanics/bestiary/monstrosity/harpy.md), and [pteranodons](Mechanics/bestiary/beast/pteranodon.md). Chakuna might also add rules to the Trial of Hearts that deem flight and magical travel off limits. If she does, the Mists aid in enforcing these rules.
...
![Valachan Hunt Complications](Mechanics/tables/valachan-hunt-complications-vrgr.md)
...
![Domains of Ravenloft](Mechanics/tables/domains-of-ravenloft-vrgr.md)
...
![Cyre 1313, The Mourning Ra...](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/VRGR/099-03-034.cyre-1313.webp#center "Cyre 1313, The Mourning Rail, thunders through domains, ever trying to escape the disaster that slew its passengers")
...
![The Ghost Dancer visits ni...](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/VRGR/100-03-035.ghost-dancer.webp#center "The Ghost Dancer visits nightmares upon a sleeping victim")
...
Each day, the city of Paridon in Zherisia erupts in riots over food scarcity, taxation, and citizens who go missing by the dozens every night. At least one murderer stalks Paridon: the ancient [doppelganger](Mechanics/bestiary/monstrosity/doppelganger.md) Sodo, who has impersonated so many people that it now finds it impossible to hold a form for more than a few days at a time. As Sodo's flesh runs like hot wax, it staves off dissolution by consuming the organs of humanoids. Paridon's streets serve as the doppelganger's hunting ground, and those who enter the sewers risk attracting the notice of countless [carrion stalkers](Mechanics/bestiary/monstrosity/carrion-stalker-vrgr.md) (see "chapter 5") and their monstrous Hive Queen.
...
![Travelers in the Mists; Strangers in the Mists](Mechanics/tables/travelers-in-the-mists-strangers-in-the-mists-vrgr.md)
...
![Keeper Adventures](Mechanics/tables/keeper-adventures-vrgr.md)
...
![Vistani Wayfarers emerge f...](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/VRGR/103-03-037.vistani-wayfarers.webp#center "Vistani Wayfarers emerge from the Mists into a new land.")
...
- **Mother Luba.** The halfling Mother Luba is known for putting unquiet spirits to rest and transporting wayward souls through the Mists to their rightful homes. Those wicked spirits beyond her aid she trapped within her [tarokka deck](Mechanics/decks/tarokka-deck-cos.md), which became known as [Luba's Tarokka of Souls](Mechanics/items/lubas-tarokka-of-souls-tce.md) (detailed in "Tasha's Cauldron of Everything").  
...
Alanik Ray is an exceptional investigator with an uncanny ability to notice detail and make deductive leaps. Despite his experience with the paranormal, he relies on his husband Arthur to keep him out of true supernatural peril. Still, the detectives manage to find trouble wherever they go. Use the statistics of [spies](Mechanics/bestiary/humanoid/spy.md) to approximate both Alanik Ray and Arthur Sedgwick. Consider the following plots when featuring the detectives in your adventures:
...
The Caller uses statistics similar to a [succubus](Mechanics/bestiary/fiend/succubus.md)/ [incubus](Mechanics/bestiary/fiend/incubus.md), and no matter how many times it's defeated, it always returns. Use the Caller to create adventures involving secret histories, domain-spanning conspiracies, and truths hinting at the nature of the Dark Powers. Consider the following plots when featuring the Caller in an adventure:
...
Erasmus is a [ghost](Mechanics/bestiary/undead/ghost.md) and the heart of the van Richten family. Consider the following plots when featuring Erasmus in an adventure:

- Erasmus understands the unquiet dead. Through devices such as [tarokka decks](Mechanics/decks/tarokka-deck-cos.md) and spirit boards, he reveals the histories and intentions of spirits.  
...
Use the statistics of an [assassin](Mechanics/bestiary/humanoid/assassin.md) to represent Ez, or you can use her [stat block](Mechanics/bestiary/npc/ezmerelda-davenir-cos.md) from Curse of Strahd. Consider the following plots when featuring Ez in an adventure:
...
![Firan Zal'honan's mysterio...](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/VRGR/104-03-038.mysterious-research.webp#center "Firan Zal'honan's mysterious research leads him to discover an accursed amber sarcophagus")
...
Firan Zal'honan is an arrogant, pragmatic, amoral genius. Furthering his schemes or adopting him as a patron can draw a party into conflict with the most prominent villains in the Domains of Dread. Use the statistics of a human [archmage](Mechanics/bestiary/humanoid/archmage.md) to represent Firan. He is accompanied by an [imp](Mechanics/bestiary/fiend/imp.md) named Skeever, who appears as a piebald raven. Consider the following plots when featuring Firan in an adventure:
...
Jander Sunstar is a [vampire](Mechanics/bestiary/undead/vampire.md) and one of Ravenloft's foremost experts on vampirism. He aids characters hunting vampires and recruits allies to protect him from others of his kind. Consider the following plots when featuring Jander Sunstar in an adventure:
...
Van Richten readily provides mentorship to characters devoted to fighting the creatures of the night. To represent him, use the stat block for a [priest](Mechanics/bestiary/humanoid/priest.md) from the "Monster Manual" or [Rictavio](Mechanics/bestiary/npc/rictavio-cos.md) from Curse of Strahd. Consider the following plots when featuring van Richten in an adventure:
...
Gennifer and Laurie are skilled and well-prepared adventurers who have the statistics of a [druid](Mechanics/bestiary/humanoid/druid.md) and a [veteran](Mechanics/bestiary/humanoid/veteran.md), respectively. Consider the following plots when featuring the twins in an adventure:
