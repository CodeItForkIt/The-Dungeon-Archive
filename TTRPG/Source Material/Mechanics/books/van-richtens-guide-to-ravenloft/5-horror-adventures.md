...
![During a séance, a spirit ...](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/VRGR/105-04-001.intro-splash.webp#center "During a séance, a spirit makes itself known to the Keepers of the Feather")
...
In both 1983's adventure *Ravenloft* and 2016's adventure Curse of Strahd, the plot changes in accordance with cards drawn from a [tarokka deck](Mechanics/decks/tarokka-deck-cos.md). A tarokka deck contains fifty-four tarot-like, fortune-telling cards, each one bearing one of the following symbols:
...
The tarokka hails from the same world as the domain of Barovia, but it and its users have since spread throughout the Domains of Dread. Further details and a complete [tarokka deck](Mechanics/decks/tarokka-deck-cos.md) appear in the adventure Curse of Strahd.

### Spirit Board

![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/VRGR/107-04-003.webp#center)

Spirit boards are tools to contact and divine the will of spirits or other mysterious forces. Upon placing their fingertips on a planchette set atop the board, assembled users feel forces move the planchette toward letters and symbols, gradually revealing a cryptic message. The spirits boards common in the Land of the Mists were first created by members of the "Keepers of the Feather" (see "chapter 3"), and feature half-understood images from their occult studies and Barovian lore. These markings include symbols from the [tarokka deck](Mechanics/decks/tarokka-deck-cos.md), which carry the same meanings as they do upon those cards. All manner of mysterious beings consider a spirit board's use an invitation to communicate with the living, resulting in messages shared from beyond the grave and frightful revelations.
...
In cases where the curse arises from a creature, such as a dying villain's last breath, the pronouncement of the curse is clear. When there is no wronged party present to lay the curse directly, the curse should be obvious in some way, such as a warning of dire consequences carved into the wall of an ancient crypt or relayed by a spell such as [magic mouth](Mechanics/spells/magic-mouth.md).
...
- The victim gains 3 levels of [exhaustion](Mechanics/Rules/conditions.md#Exhaustion) that can't be removed while the curse endures.  
...
While more general curses can lifted by a [remove curse](Mechanics/spells/remove-curse.md) spell, more specific or dramatic curses can't be permanently lifted through spells. Magic can offer temporary respite, though. A [remove curse](Mechanics/spells/remove-curse.md) spell cast on the victim of such a curse suppresses the burden for 1 hour. A [greater restoration](Mechanics/spells/greater-restoration.md) spell suppresses the burden until the victim finishes a long rest. Death usually ends a curse, but the curse returns in full force if the cursed character returns to life without resolving the curse.

##### Persistent Curses

When a curse is resolved, its effects usually end immediately. Some more insidious curses might linger beyond the resolution but can then be removed by a [remove curse](Mechanics/spells/remove-curse.md) spell or similar magic if the victim succeeds on a DC 15 Charisma saving throw when the spell is cast. If the save fails, it can be repeated after a specific interval passes, usually 1 month, with the curse ending on a successful save. Adjust the DC of a particularly weak curse to 10 or that of a stronger one to 20.
...
The character is plagued by restless sleep and recurring nightmares featuring those the character swore to protect. The character gains 3 levels of [exhaustion](Mechanics/Rules/conditions.md#Exhaustion) that can't be removed until the curse ends.
...
The character is cursed with [loup garou](Mechanics/bestiary/monstrosity/loup-garou-vrgr.md) lycanthropy (see "chapter 5").

#### Resolution

This curse can't be broken until the character is reduced to 0 hit points by a silvered weapon. If the character survives, the curse can be broken as described in the ""Loup Garou Lycanthropy"" section of "chapter 5". Treat the character as a [werewolf](Mechanics/bestiary/humanoid/werewolf.md) whose loup garou progenitor has been killed.

![In Har'Akir, an ancient cu...](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/VRGR/109-04-005.ancient-curse.webp#center "In Har'Akir, an ancient curse awakens the Children of Ankhtepot")

## Fear and Stress

See the [Fear and Stress](Mechanics/Rules/variant-rules/fear-and-stress-vrgr.md) entry.

## Haunted Traps

See the [Haunted Traps](Mechanics/Rules/variant-rules/haunted-traps-vrgr.md) entry.

## Survivors

See the [Survivors](Mechanics/Rules/variant-rules/survivors-vrgr.md) entry.
