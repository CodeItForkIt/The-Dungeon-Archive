...
![Fizban argues with a smug ...](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/FTD/033-04-001.chapter-splash.webp#center "Fizban argues with a smug statue in the lair of an amused brass dragon")
...
![Dragon Lairs; Lair Location](Mechanics/tables/dragon-lairs-lair-location-ftd.md)
...
**Exposing Terrain**. The terrain within 6 miles of the lair actively works to foil stealth, giving creatures other than the dragon disadvantage on Dexterity ([Stealth](Mechanics/Rules/skills.md#Stealth)) checks. Leaves change color to contrast with those trying to hide among them, branches move to reveal creatures, fog clears, and so on.
...
**Draconic Blessing**. Bahamut or Tiamat has placed the lair under the effect of a [hallow](Mechanics/spells/hallow.md) spell.
...
![An ancient dragon's hoard ...](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/FTD/034-04-002.an-ancient-dragons-hoard.webp#center "An ancient dragon's hoard can hold enough wealth to cause the rise and the ruin of dynasties")
...
![Linking Hoards; Hoard Linking Items](Mechanics/tables/linking-hoards-hoard-linking-items-ftd.md)
...
It's not unusual for one or more items in a dragon's hoard to be haunted. Restless spirits might haunt objects that held special significance to them in life, and the death of the dragon who stole those items might be an opportunity for such spirits to find rest at last. A haunting spirit might fully manifest as a [ghost](Mechanics/bestiary/undead/ghost.md), a [specter](Mechanics/bestiary/undead/specter.md), a [wraith](Mechanics/bestiary/undead/wraith.md), or a similar creature, or it might give the haunted item the characteristics of a sentient magic item.
...
![Haunted Hoards; Unfinished Business](Mechanics/tables/haunted-hoards-unfinished-business-ftd.md)
...
![A Dragon's Curse; Hoard Curse Effects](Mechanics/tables/a-dragons-curse-hoard-curse-effects-ftd.md)

In general, ending the curse on a dragon's hoard is not as simple as casting a single spell. Magic can offer temporary respite, though. A [remove curse](Mechanics/spells/remove-curse.md) spell cast on any affected character suppresses the effect of the curse for 1 hour, while a [greater restoration](Mechanics/spells/greater-restoration.md) spell suppresses the curse until the victim finishes a long rest.
...
![A Dragon's Curse; Breaking a Hoard Curse](Mechanics/tables/a-dragons-curse-breaking-a-hoard-curse-ftd.md)
...
![Competition for a Hoard; Hoard Magic](Mechanics/tables/competition-for-a-hoard-hoard-magic-ftd.md)

![While a dragon slumbers, a...](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/FTD/035-04-003.skilled-burglar.webp#center "While a dragon slumbers, a skilled burglar might be able to make off with a treasure or two, but looting the entire hoard is another matter")
...
![Coins; Coin Origins](Mechanics/tables/coins-coin-origins-ftd.md)
...
As described in "Xanathar's Guide to Everything", the items found on [Magic Item Table A](Mechanics/tables/magic-item-table-a.md) through [Magic Item Table E](Mechanics/tables/magic-item-table-e.md) in the "Dungeon Master's Guide" are minor items, a category that includes common items, potions and scrolls (which can be used only once), and other items whose impact on the game is minor or utilitarian. The items on [Magic Item Table F](Mechanics/tables/magic-item-table-f.md) through [Magic Item Table I](Mechanics/tables/magic-item-table-i.md) are major items: permanent items that can have significant long-term impact on the game.

![Green dragons are poison—f...](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/FTD/036-04-004.green-dragons-are-poison.webp#center "Green dragons are poison—from their blood and fangs to the wispy gases of their breath and the sinister insinuations they whisper to the weak-willed")
...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/FTD/037-04-005.gold-coins.webp#center)

![Creating a Hoard; Hoard Mundane Items](Mechanics/tables/creating-a-hoard-hoard-mundane-items-ftd.md)

![Trying to loot a dragon's ...](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/FTD/038-04-006.trying-to-loot.webp#center "Trying to loot a dragon's hoard without waking its owner is a reckless endeavor")

![Creating a Hoard; Hoard Gems](Mechanics/tables/creating-a-hoard-hoard-gems-ftd.md)

![Creating a Hoard; Hoard Art Objects](Mechanics/tables/creating-a-hoard-hoard-art-objects-ftd.md)

![Creating a Hoard; Hoard Magic Items](Mechanics/tables/creating-a-hoard-hoard-magic-items-ftd.md)