...
![Bard](Mechanics/tables/bard-ggr.md)
...
![Cleric](Mechanics/tables/cleric-ggr.md)

![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/GGR/010-c111.webp#center)
...
![Druid](Mechanics/tables/druid-ggr.md)
...
![Fighter](Mechanics/tables/fighter-ggr.md)
...
![Monk](Mechanics/tables/monk-ggr.md)
...
![Paladin](Mechanics/tables/paladin-ggr.md)

*Appears in "Xanathar's Guide to Everything"

![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/GGR/011-c112.webp#center)
...
[Niv-Mizzet](Mechanics/bestiary/npc/niv-mizzet-ggr.md), the guildmaster of the Izzet, is a dragon. Sorcerers who gain their elemental powers from laboratory incidents often claim that they have been infused with some of [Niv-Mizzet](Mechanics/bestiary/npc/niv-mizzet-ggr.md)'s power.

![Sorcerer](Mechanics/tables/sorcerer-ggr.md)
...
![Warlock](Mechanics/tables/warlock-ggr.md)
...
![Wizard](Mechanics/tables/wizard-ggr.md)

## Subclass Options

Two classes receive subclass options in this section: the cleric and the druid.

At 1st level, a cleric chooses a Divine Domain. This source adds the [Order Domain](Mechanics/classes/cleric-order-domain-tce.md) to the options available to the cleric making that choice.

At 2nd level, a druid chooses a Druid Circle. This source adds the [Circle of Spores](Mechanics/classes/druid-circle-of-spores-tce.md) to the options available to the druid making that choice.