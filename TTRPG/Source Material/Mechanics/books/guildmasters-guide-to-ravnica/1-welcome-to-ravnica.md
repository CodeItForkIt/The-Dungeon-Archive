...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/GGR/000-intro01.webp#center)
...
**Azorius Senate**. The Azorius Senate functions as the government of Ravnica, built on the three columns of a legislative, a judicial, and an executive branch under the leadership of [Isperia](Mechanics/bestiary/npc/isperia-ggr.md), the sphinx Supreme Judge.

**Boros Legion**. Led by the angel [Aurelia](Mechanics/bestiary/npc/aurelia-ggr.md), the Boros Legion pursues the cause of justice, not merely law enforcement. Boros serves as Ravnica's standing army.

**House Dimir**. House Dimir is in the business of information, operating an espionage organization behind a facade of messengers, investigators, and archivists. Its enigmatic leader, [Lazav](Mechanics/bestiary/npc/lazav-ggr.md), wears many faces.
...
**Gruul Clans**. Raging against civilization and its defilement of the natural world, the loose alliance of the Gruul Clans is led by the cyclops [Borborygmos](Mechanics/bestiary/npc/borborygmos-ggr.md).

**Izzet League**. Led by the dragon [Niv-Mizzet](Mechanics/bestiary/npc/niv-mizzet-ggr.md), the Izzet League is a guild of scientists and engineers who build and sustain Ravnica's infrastructure while conducting wild experiments in magic—efforts that usually involve barely controlled elemental energy.
...
**Selesnya Conclave**. The Selesnya Conclave is led by [Trostani](Mechanics/bestiary/npc/trostani-ggr.md), three dryads who are fused together with one another and with Mat'Selesnya, a manifestation of the soul of the world. The guild seeks to bring nature and the city into balance.

**Simic Combine**. Under the leadership of Prime Speaker [Zegana](Mechanics/bestiary/npc/zegana-ggr.md), the biomancers of the Simic Combine apply magic to the life sciences. Striving to create a harmonious future where creatures of all kinds are perfectly adapted to their ever-changing environment, the Simic magically hasten the process of evolution and adaptation of life.
...
> 
> ![Random Guilds](Mechanics/tables/random-guilds-ggr.md)
^random-guilds
...
> 
> ![Ravnica's Calendar](Mechanics/tables/ravnicas-calendar-ggr.md)
^ravnicas-calendar
...
![Currency: Zibs and Zinos; Ravnica Currency](Mechanics/tables/currency-zibs-and-zinos-ravnica-currency-ggr.md)
...
![Comforts of Civilization; Cosmopolitan Conveniences](Mechanics/tables/comforts-of-civilization-cosmopolitan-conveniences-ggr.md)
...
![Standard Languages](Mechanics/tables/standard-languages-ggr.md)
...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/GGR/001-intro02.webp#center)