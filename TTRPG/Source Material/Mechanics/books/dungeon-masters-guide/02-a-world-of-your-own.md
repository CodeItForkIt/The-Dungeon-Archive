...
![A Sample Pantheon; Dawn War Deities](Mechanics/tables/a-sample-pantheon-dawn-war-deities.md)
...
![Forms of Government](Mechanics/tables/forms-of-government.md)
...
![Government; Sample Hierarchy of Noble Titles](Mechanics/tables/government-sample-hierarchy-of-noble-titles.md)
...
![World-Shaking Events](Mechanics/tables/world-shaking-events.md)
...
![Rise or Fall of a Leader or an Era; Leader Types](Mechanics/tables/rise-or-fall-of-a-leader-or-an-era-leader-types.md)
...
![Cataclysmic Disasters](Mechanics/tables/cataclysmic-disasters.md)
...
![Assault or Invasion; Invading Forces](Mechanics/tables/assault-or-invasion-invading-forces.md)
...
![Extinction or Depletion](Mechanics/tables/extinction-or-depletion.md)
...
![New Organizations](Mechanics/tables/new-organizations.md)
...
![Discovery, Expansion, Invention; Discoveries](Mechanics/tables/discovery-expansion-invention-discoveries.md)
...
> 
> ![The Calendar of Harptos](Mechanics/tables/the-calendar-of-harptos.md)
...
Dedicated spellcasters learn 3rd-level spells at the start of this tier. Suddenly characters can fly, damage large numbers of foes with [fireball](Mechanics/spells/fireball.md) and [lightning bolt](Mechanics/spells/lightning-bolt.md) spells, and even breathe underwater. They master 5th-level spells by the end of the tier, and spells such as [teleportation circle](Mechanics/spells/teleportation-circle.md), [scrying](Mechanics/spells/scrying.md), [flame strike](Mechanics/spells/flame-strike.md), [legend lore](Mechanics/spells/legend-lore.md), and [raise dead](Mechanics/spells/raise-dead.md) can have a significant impact on their adventures. They start acquiring more permanent magic items (uncommon and rare ones) as well, which will serve them for the rest of their careers.
...
Dedicated spellcasters gain access to 6th-level spells at 11th level, including spells that completely change the way adventurers interact with the world. Their big, flashy spells are significant in combat-[disintegrate](Mechanics/spells/disintegrate.md), [blade barrier](Mechanics/spells/blade-barrier.md), and [heal](Mechanics/spells/heal.md), for example-but behind-the-scenes spells such as [word of recall](Mechanics/spells/word-of-recall.md), [find the path](Mechanics/spells/find-the-path.md), [contingency](Mechanics/spells/contingency.md), [teleport](Mechanics/spells/teleport.md), and [true seeing](Mechanics/spells/true-seeing.md) alter the way players approach their adventures. Each spell level after that point introduces new effects with an equally large impact. The adventurers find rare magic items (and very rare ones) that bestow similarly powerful abilities.
...
Dedicated spellcasters at this tier wield earthshaking 9th-level spells such as [wish](Mechanics/spells/wish.md), [gate](Mechanics/spells/gate.md), [storm of vengeance](Mechanics/spells/storm-of-vengeance.md), and [astral projection](Mechanics/spells/astral-projection.md). Characters have several rare and very rare magic items at their disposal, and begin discovering legendary items such as a [vorpal sword](Mechanics/items/vorpal-sword.md) or a [staff of the magi](Mechanics/items/staff-of-the-magi.md).
...
![Starting at Higher Level; Starting Equipment](Mechanics/tables/starting-at-higher-level-starting-equipment.md)
...
![Wuxia Weapon Names](Mechanics/tables/wuxia-weapon-names.md)
