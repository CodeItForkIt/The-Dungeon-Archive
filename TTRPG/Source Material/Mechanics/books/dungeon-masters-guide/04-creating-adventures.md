...
![Identify the Party's Goals; Dungeon Goals](Mechanics/tables/identify-the-partys-goals-dungeon-goals.md)

![Identify the Party's Goals; Wilderness Goals](Mechanics/tables/identify-the-partys-goals-wilderness-goals.md)

![Identify the Party's Goals; Other Goals](Mechanics/tables/identify-the-partys-goals-other-goals.md)
...
![Identify Important NPCs; Adventure Villains](Mechanics/tables/identify-important-npcs-adventure-villains.md)

![Identify Important NPCs; Adventure Allies](Mechanics/tables/identify-important-npcs-adventure-allies.md)

![Identify Important NPCs; Adventure Patrons](Mechanics/tables/identify-important-npcs-adventure-patrons.md)
...
![Find the Ideal Introduction; Adventure Introduction](Mechanics/tables/find-the-ideal-introduction-adventure-introduction.md)
...
![Consider the Ideal Climax; Adventure Climax](Mechanics/tables/consider-the-ideal-climax-adventure-climax.md)
...
![Determine the Villain's Actions; Event-Based Villain Actions](Mechanics/tables/determine-the-villains-actions-event-based-villain-actions.md)
...
![Determine the Party's Goals; Event-Based Goals](Mechanics/tables/determine-the-partys-goals-event-based-goals.md)
...
![Framing Events](Mechanics/tables/framing-events.md)
...
![Moral Quandaries](Mechanics/tables/moral-quandaries.md)
...
![Twists](Mechanics/tables/twists.md)
...
![Side Quests](Mechanics/tables/side-quests.md)
...
![Combat Encounter Difficulty; XP Thresholds by Character Level](Mechanics/tables/combat-encounter-difficulty-xp-thresholds-by-character-level.md)
...
![Modify Total XP for Multiple Monsters; Encounter Multipliers](Mechanics/tables/modify-total-xp-for-multiple-monsters-encounter-multipliers.md)
...
![The Adventuring Day; Adventuring Day XP](Mechanics/tables/the-adventuring-day-adventuring-day-xp.md)
...
- The whole party is [surprised](Mechanics/Rules/conditions.md#Surprised), and the enemy isn't.  
...
![Sylvan Forest Encounters](Mechanics/tables/sylvan-forest-encounters.md)
