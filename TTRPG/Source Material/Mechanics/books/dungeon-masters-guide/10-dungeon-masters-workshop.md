...
![Proficiency Dice](Mechanics/tables/proficiency-dice.md)
...
![Ability Check Proficiency by Class](Mechanics/tables/ability-check-proficiency-by-class.md)
...
Consider using the <span title="">New Ability Scores: Honor and Sanity</span> if your campaign revolves around entities of an utterly alien and unspeakable nature, such as Great Cthulhu, whose powers and minions can shatter a character's mind.
...
When adventurers confront threats they have no hope of overcoming, you can call for them to make a Wisdom saving throw. Set the DC according to the circumstances. A character who fails the save becomes [frightened](Mechanics/Rules/conditions.md#Frightened) for 1 minute. The character can repeat the saving throw at the end of each of his or her turns, ending the effect on the character on a successful save.
...
![Explosives](Mechanics/tables/explosives.md)
...
![Figuring Out Alien Technology](Mechanics/tables/figuring-out-alien-technology.md)
...
![Speed Factor Initiative Modifiers](Mechanics/tables/speed-factor-initiative-modifiers.md)
...
- [Climb onto a Bigger Creature](Mechanics/Rules/actions.md#Climb%20onto%20a%20Bigger%20Creature)  
- [Disarm](Mechanics/Rules/actions.md#Disarm)  
- [Mark](Mechanics/Rules/actions.md#Mark)  
- [Overrun](Mechanics/Rules/actions.md#Overrun)  
- [Shove Aside](Mechanics/Rules/actions.md#Shove%20Aside)  
- [Tumble](Mechanics/Rules/actions.md#Tumble)  
...
![Lingering Injuries](Mechanics/tables/lingering-injuries.md)
...
![Massive Damage; System Shock](Mechanics/tables/massive-damage-system-shock.md)
...
- The creature is [surprised](Mechanics/Rules/conditions.md#Surprised).  
...
- All the creatures in the group are [surprised](Mechanics/Rules/conditions.md#Surprised).  
- The group's leader is reduced to 0 hit points, [incapacitated](Mechanics/Rules/conditions.md#Incapacitated), taken prisoner, or removed from battle.  
...
![Creating Quick Monster Stats; Monster Statistics by Challenge Rating](Mechanics/tables/creating-quick-monster-stats-monster-statistics-by-challenge-rating.md)
...
![Final Challenge Rating; Experience Points by Challenge Rating](Mechanics/tables/final-challenge-rating-experience-points-by-challenge-rating.md)
...
![Assign Hit Dice; Hit Dice by Size](Mechanics/tables/assign-hit-dice-hit-dice-by-size.md)
...
![Damage Vulnerabilities, Resistances, and Immunities; Effective Hit Points Based on Resistances and Immunities](Mechanics/tables/damage-vulnerabilities-resistances-and-immunities-effective-hit-points-based-on-resistances-and-immunities.md)
...
If you want a monster to be proficient in a skill, you can give it a bonus equal to its proficiency bonus on ability checks related to that skill. For example, a monster with sharp senses might have a bonus on Wisdom ([Perception](Mechanics/Rules/skills.md#Perception)) checks, while a duplicitous monster might have a bonus on Charisma ([Deception](Mechanics/Rules/skills.md#Deception)) checks.

You can double the proficiency bonus to account for heightened mastery. For example, a doppelganger is so good at deceiving others that its bonus on Charisma ([Deception](Mechanics/Rules/skills.md#Deception)) checks is equal to double its proficiency bonus + its Charisma modifier.
...
All monsters have a passive Wisdom ([Perception](Mechanics/Rules/skills.md#Perception)) score, which is most often used to determine whether a monster detects approaching or hidden enemies. A monster's passive Wisdom ([Perception](Mechanics/Rules/skills.md#Perception)) score is 10 + its Wisdom modifier. If the monster has proficiency in the Perception skill, its score is 10 + its Wisdom ([Perception](Mechanics/Rules/skills.md#Perception)) bonus.
...
![Creating a Monster Stat Block; Monster Features](Mechanics/tables/creating-a-monster-stat-block-monster-features.md)
...
![Creating NPCs from Scratch; NPC Features](Mechanics/tables/creating-npcs-from-scratch-npc-features.md)
...
![Spell Damage](Mechanics/tables/spell-damage.md)
...
![Power Level; Magic Item Power by Rarity](Mechanics/tables/power-level-magic-item-power-by-rarity.md)
...
Filling in the remaining details, we end up with the following [racial traits for the aasimar](Mechanics/races/aasimar-dmg.md).
