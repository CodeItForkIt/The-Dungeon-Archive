...
![NPC Appearance](Mechanics/tables/npc-appearance.md)
...
![NPC Abilities](Mechanics/tables/npc-abilities.md)

![NPC Low Abilities](Mechanics/tables/npc-low-abilities.md)
...
![NPC Talents](Mechanics/tables/npc-talents.md)
...
![NPC Mannerisms](Mechanics/tables/npc-mannerisms.md)
...
![Interactions with Others; NPC Interaction Traits](Mechanics/tables/interactions-with-others-npc-interaction-traits.md)
...
![Ideals](Mechanics/tables/ideals.md)
...
![NPC Bonds](Mechanics/tables/npc-bonds.md)
...
![Flaw or Secret; NPC Flaws and Secrets](Mechanics/tables/flaw-or-secret-npc-flaws-and-secrets.md)
...
![Villains; Villain's Scheme](Mechanics/tables/villains-villains-scheme.md)

![Villains; Villain's Methods](Mechanics/tables/villains-villains-methods.md)
...
![Villain's Secret Weakness; Villain's Weakness](Mechanics/tables/villains-secret-weakness-villains-weakness.md)
...
See the [Death Domain classes page entry](Mechanics/classes/cleric-death-domain.md) for more information.
...
See the [Oathbreaker classes page entry](Mechanics/classes/paladin-oathbreaker.md) for more information.