...
You know the [thaumaturgy](Mechanics/spells/thaumaturgy.md) cantrip. Once you reach 3rd level, you can cast the [burning hands](Mechanics/spells/burning-hands.md) spell once per day as a 2nd-level spell; you must finish a long rest in order to cast the spell again using this trait. Once you reach 5th level, you can also cast the [darkness](Mechanics/spells/darkness.md) spell; you must finish a long rest in order to cast the spell again using this trait. Charisma is your spellcasting ability for these spells.
