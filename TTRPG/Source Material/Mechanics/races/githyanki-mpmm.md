...
Starting at 3rd level, you can cast the [jump](Mechanics/spells/jump.md) spell with this trait. Starting at 5th level, you can also cast [misty step](Mechanics/spells/misty-step.md) with it. Once you cast [jump](Mechanics/spells/jump.md) or [misty step](Mechanics/spells/misty-step.md) with this trait, you can't cast that spell with it again until you finish a long rest. You can also cast either of those spells using any spell slots you have of the appropriate level.
