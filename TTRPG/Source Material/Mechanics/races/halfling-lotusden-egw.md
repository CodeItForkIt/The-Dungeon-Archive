...
You know the [druidcraft](Mechanics/spells/druidcraft.md) cantrip. When you reach 3rd level, you can cast the [entangle](Mechanics/spells/entangle.md) spell once with this trait and regain the ability to do so when you finish a long rest. When you reach 5th level, you can cast the [spike growth](Mechanics/spells/spike-growth.md) spell once with this trait and regain the ability to do so when you finish a long rest. Casting these spells with this trait doesn't require material components. Wisdom is your spellcasting ability for these spells.
