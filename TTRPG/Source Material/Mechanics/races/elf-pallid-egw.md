...
You have advantage on Intelligence ([Investigation](Mechanics/Rules/skills.md#Investigation)) and Wisdom ([Insight](Mechanics/Rules/skills.md#Insight)) checks.

### Blessing of the Moon Weaver

You know the [light](Mechanics/spells/light.md) cantrip. When you reach 3rd level, you can cast the [sleep](Mechanics/spells/sleep.md) spell once with this trait and regain the ability to do so when you finish a long rest. When you reach 5th level, you can cast the [invisibility](Mechanics/spells/invisibility.md) spell (targeting yourself only) once with this trait and regain the ability to do so when you finish a long rest. Casting these spells with this trait doesn't require material components. Wisdom is your spellcasting ability for these spells.
