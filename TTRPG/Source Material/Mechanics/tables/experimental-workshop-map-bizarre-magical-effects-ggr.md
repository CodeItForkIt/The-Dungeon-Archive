...
| dice: d6 | Effect |
|----------|--------|
| 1 | Every spell cast in the area triggers a wild magic surge. (Roll on the [Wild Magic Surge](Mechanics/tables/wild-magic-surge.md) table in the "Sorcerer" section of the *Player's Handbook*.) |
...
| 3 | The area is affected by a [guards and wards](Mechanics/spells/guards-and-wards.md)*spell*. |
...
| 6 | Random sections of the area are affected by an [antimagic field](Mechanics/spells/antimagic-field.md) spell. |
^bizarre-magical-effects