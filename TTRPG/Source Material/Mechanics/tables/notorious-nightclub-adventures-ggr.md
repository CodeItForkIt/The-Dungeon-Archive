...
| 9 | Acquire a magic item the [Rakdos](Mechanics/bestiary/npc/rakdos-ggr.md) are using as part of a performance. |
| 10 | Investigate rumors that the [Rakdos](Mechanics/bestiary/npc/rakdos-ggr.md) have a wingless angel in their show. |
| 11 | Find an escaped convict who is rumored to be hiding behind [Rakdos](Mechanics/bestiary/npc/rakdos-ggr.md) makeup. |
| 12 | Stop a [Rakdos](Mechanics/bestiary/npc/rakdos-ggr.md) member who is blackmailing an important person with embarrassing information. |
^notorious-nightclub-adventures