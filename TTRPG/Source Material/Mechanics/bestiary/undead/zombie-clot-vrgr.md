...
aliases: ["Zombie Clot"]
---
# [Zombie Clot](Mechanics\bestiary\undead/zombie-clot-vrgr.md)
...
- "desc": "Any creature that starts its turn within 10 feet of the zombie must succeed\
    ...
    \ [poisoned](Mechanics/Rules/conditions.md#Poisoned) until the start of the creature's\
    \ next turn."
  "name": "Deathly Stench"
...
- "desc": "The zombie flings a detached clump of corpses at a creature it can see\
    ...
    \ flesh is [restrained](Mechanics/Rules/conditions.md#Restrained), has total cover\
...
"source":
- "VRGR"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/VRGR/Zombie%20Clot.webp"
```
^statblock