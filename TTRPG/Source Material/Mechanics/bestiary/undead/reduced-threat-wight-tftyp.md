...
- **Armor Class** 14 ([studded leather](Mechanics/items/studded-leather-armor.md))
...
***Sunlight Sensitivity.*** While in sunlight, the wight has disadvantage on attack rolls, as well as on Wisdom ([Perception](Mechanics/Rules/skills.md#Perception)) checks that rely on sight.
...
A humanoid slain by this attack rises 24 hours later as a [zombie](Mechanics/bestiary/undead/zombie.md) under the wight's control, unless the humanoid is restored to life or its body is destroyed. The wight can have no more than twelve zombies under its control at one time.
