...
- "desc": "The death knight is a 19th-level spellcaster. Its spellcasting ability\
    ...
    \ [compelled duel](Mechanics/spells/compelled-duel.md), [searing smite](Mechanics/spells/searing-smite.md)\n\
    \n2nd level (3 slots): [hold person](Mechanics/spells/hold-person.md), [magic\
    \ weapon](Mechanics/spells/magic-weapon.md)\n\n3rd level (3 slots): [dispel\
    \ magic](Mechanics/spells/dispel-magic.md), [elemental weapon](Mechanics/spells/elemental-weapon.md)\n\
    \n4th level (3 slots): [banishment](Mechanics/spells/banishment.md), [staggering\
    \ smite](Mechanics/spells/staggering-smite.md)\n\n5th level (2 slots): [destructive\
    \ wave](Mechanics/spells/destructive-wave.md) (necrotic)"
  "name": "Spellcasting"
- "desc": "The death knight has advantage on saving throws against spells and other\
    \ magical effects."
  "name": "Magic Resistance"
- "desc": "Unless the death knight is [incapacitated](Mechanics/Rules/conditions.md#Incapacitated),\
...
- "SatO"
- "VEoR"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MM/Death%20Knight.webp"
```
^statblock