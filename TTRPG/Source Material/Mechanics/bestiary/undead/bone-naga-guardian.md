...
- "desc": "The naga is a 5th-level spellcaster (spell save DC 12, +4 to hit with\
    ...
    \ (at will): [mending](Mechanics/spells/mending.md), [sacred flame](Mechanics/spells/sacred-flame.md),\
    ...
    \n3rd level (2 slots): [bestow curse](Mechanics/spells/bestow-curse.md)"
  "name": "Spellcasting"
"actions":
...
- "ToA"
- "WDMM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MM/Bone%20Naga%20%28Guardian%29.webp"
```
^statblock
