...
---
# [Parasite-infested Behir](Mechanics\bestiary\undead/parasite-infested-behir-cm.md)
...
- "desc": "The behir makes one bite attack against a Medium or smaller target it is\
    ...
    \ turn or regurgitate the creature, which falls [prone](Mechanics/Rules/conditions.md#Prone)\
...
"source":
- "CM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/CM/Parasite-infested%20Behir.webp"
```
^statblock