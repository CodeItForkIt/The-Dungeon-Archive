...
---
# [Priest of Osybus (Blazing Boon)](Mechanics\bestiary\undead/priest-of-osybus-blazing-boon-vrgr.md)
...
- "desc": "The priest sloughs off its flesh, and its skeleton crumbles away, leaving\
    \ only its skull. Its stat block is replaced by that of a [flameskull](Mechanics/bestiary/undead/flameskull.md),\
