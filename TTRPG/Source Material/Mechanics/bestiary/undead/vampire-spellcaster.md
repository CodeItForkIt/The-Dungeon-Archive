...
- "desc": "The vampire is a 9th-level spellcaster. Its spellcasting ability is Intelligence\
    ...
    \n3rd level (3 slots): [animate dead](Mechanics/spells/animate-dead.md), [bestow\
    \ curse](Mechanics/spells/bestow-curse.md), [nondetection](Mechanics/spells/nondetection.md)\n\
...
- "MM"
- "RoT"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MM/Vampire%20Spellcaster.webp"
```
^statblock
