...
aliases: ["False Lich"]
---
# [False Lich](Mechanics\bestiary\undead/false-lich-veor.md)
...
- "desc": "The false lich casts one of the following spells, requiring no material\
    ...
    \ 22):\n\nAt will: [Detect Magic](Mechanics/spells/detect-magic.md), [Fly](Mechanics/spells/fly.md),\
...
- "desc": "The false lich emits a hideous shriek charged with malignant energy. Each\
    ...
    \ this way, a creature also has the [unconscious](Mechanics/Rules/conditions.md#Unconscious)\
...
- "desc": "The false lich targets one creature it can see within 120 feet of itself.\
    \ The target must make a DC 22 Charisma saving throw; if the target has the [unconscious](Mechanics/Rules/conditions.md#Unconscious)\
