...
aliases: ["Atropal"]
---
# [Atropal](Mechanics\bestiary\undead/atropal-toa.md)
...
- "desc": "Creatures within 30 feet of the atropal can't regain hit points, and any\
    ...
    \ necrotic damage. If the atropal is struck by a [vorpal sword](Mechanics/items/vorpal-sword.md),\
...
- "desc": "The atropal targets one creature it can see within 120 feet of it. The\
    ...
    \ dealt."
  "name": "Life Drain"
- "desc": "The atropal summons a [wraith](Mechanics/bestiary/undead/wraith.md) which\
...
- "desc": "The atropal lets out a withering wail. Any creature within 120 feet of\
    ...
    \ throw or gain 1 level of [exhaustion](Mechanics/Rules/conditions.md#Exhaustion)."
  "name": "Wail (Costs 3 Actions)"
"source":
- "ToA"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/ToA/Atropal.webp"
```
^statblock