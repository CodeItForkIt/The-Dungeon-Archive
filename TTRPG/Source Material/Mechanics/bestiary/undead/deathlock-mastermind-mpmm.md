...
- "desc": "The deathlock casts one of the following spells, using Charisma as the\
    ...
    \ [fly](Mechanics/spells/fly.md), [invisibility](Mechanics/spells/invisibility.md)"
  "name": "Spellcasting"
- "desc": "Magical darkness doesn't impede the deathlock's [darkvision](Mechanics/Rules/senses.md#Darkvision)."
  "name": "Devil's Sight"
...
- "desc": "Ranged Spell Attack: +6 to hit, range 120 ft., one target. Hit: 13\
    ...
    \ on a DC 16 Strength saving throw or become [restrained](Mechanics/Rules/conditions.md#Restrained)\
    \ as shadowy tendrils wrap around it for 1 minute. A [restrained](Mechanics/Rules/conditions.md#Restrained)\
