...
- "desc": "Melee Spell Attack: +4 to hit, reach 5 ft., one creature. Hit: 9\
  ...
  "name": "Shock"
- "desc": "The will-o'-wisp and its light magically become [invisible](Mechanics/Rules/conditions.md#Invisible)\
    \ until it attacks or uses its Consume Life, or until its [concentration](Mechanics/Rules/conditions.md#Concentration)\
...
- "VEoR"
- "QftIS"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MM/Will-o%27-Wisp.webp"
```
^statblock
