...
aliases: ["Dullahan"]
---
# [Dullahan](Mechanics\bestiary\undead/dullahan-vrgr.md)
...
"cr": "10"
"traits":
- "desc": "If the dullahan is reduced to 0 hit points, it doesn't die or fall [unconscious](Mechanics/Rules/conditions.md#Unconscious).\
    \ Instead, it regains 97 hit points. In addition, it summons three [death's heads](Mechanics/bestiary/undead/deaths-head-vrgr.md),\
...
"source":
- "VRGR"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/VRGR/Dullahan.webp"
```
^statblock