...
aliases: ["Necrichor"]
---
# [Necrichor](Mechanics\bestiary\undead/necrichor-vrgr.md)
...
- "desc": "Unless its lifeless remains are splashed with holy water or placed in a\
    \ vessel under the effects of the [hallow](Mechanics/spells/hallow.md) spell,\
...
- "VRGR"
- "AATM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/VRGR/Necrichor.webp"
```
^statblock