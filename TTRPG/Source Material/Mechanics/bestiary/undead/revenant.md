...
- "desc": "The revenant targets one creature it can see within 30 feet of it and against\
    ...
    \ turn. When the paralysis ends, the target is [frightened](Mechanics/Rules/conditions.md#Frightened)\
    \ of the revenant for 1 minute. The [frightened](Mechanics/Rules/conditions.md#Frightened)\
    \ target can repeat the saving throw at the end of each of its turns, with disadvantage\
    \ if it can see the revenant, ending the [frightened](Mechanics/Rules/conditions.md#Frightened)\
...
- "PaBTSO"
- "SatO"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MM/Revenant.webp"
```
^statblock
