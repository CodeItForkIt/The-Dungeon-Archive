...
- "desc": "A creature dies if reduced to 0 hit points by the nightwalker and can't\
    \ be revived except by a [wish](Mechanics/spells/wish.md) spell."
  "name": "Life Eater"
...
- "desc": "The nightwalker points at one creature it can see within 300 feet of it.\
    ...
    \ damage and become [frightened](Mechanics/Rules/conditions.md#Frightened) until\
    \ the end of the nightwalker's next turn. While [frightened](Mechanics/Rules/conditions.md#Frightened)\
    \ in this way, the creature is also [paralyzed](Mechanics/Rules/conditions.md#Paralyzed).\
