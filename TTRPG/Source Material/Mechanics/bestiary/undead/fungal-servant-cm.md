...
---
# [Fungal Servant](Mechanics\bestiary\undead/fungal-servant-cm.md)
...
- "desc": "The fungal servant is a 10th-level spellcaster. Its spellcasting ability\
    ...
    \n1st level (4 slots): [command](Mechanics/spells/command.md), [guiding bolt](Mechanics/spells/guiding-bolt.md),\
...
- "desc": "Melee Weapon Attack: +9 to hit, reach 5 ft., one target. Hit: 14\
    ...
    \ to spores. The curse lasts until removed by the [remove curse](Mechanics/spells/remove-curse.md)\
...
- "desc": "The fungal servant targets one creature it can see within 60 feet of it.\
    ...
    \ saving throw against this magic or become [frightened](Mechanics/Rules/conditions.md#Frightened)\
    \ until the end of the fungal servant's next turn. If the target fails the saving\
    \ throw by 5 or more, it is also [paralyzed](Mechanics/Rules/conditions.md#Paralyzed)\
...
- "desc": "The fungal servant utters a blasphemous word. Each non-undead creature\
    ...
    \ succeed on a DC 16 Constitution saving throw or be [stunned](Mechanics/Rules/conditions.md#Stunned)\
...
- "desc": "The fungal servant magically transforms into a whirlwind of spores, moves\
    ...
    \ fungal servant is immune to all damage, and it can't be [grappled](Mechanics/Rules/conditions.md#Grappled),\
...
"source":
- "CM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/CM/Fungal%20Servant.webp"
```
^statblock