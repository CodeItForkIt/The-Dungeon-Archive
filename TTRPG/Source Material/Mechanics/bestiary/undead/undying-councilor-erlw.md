...
- "desc": "The councilor is a 13th-level spellcaster. Its spellcasting ability is\
    ...
    \ level (3 slots): [augury](Mechanics/spells/augury.md), [calm emotions](Mechanics/spells/calm-emotions.md),\
    \ [hold person](Mechanics/spells/hold-person.md)\n\n3rd level (3 slots): [daylight](Mechanics/spells/daylight.md),\
    ...
    \ slots): [dispel evil and good](Mechanics/spells/dispel-evil-and-good.md),\
    \ [flame strike](Mechanics/spells/flame-strike.md) (see \"Actions\" below), [scrying](Mechanics/spells/scrying.md)\n\
    \n6th level (1 slots): [forbiddance](Mechanics/spells/forbiddance.md), [planar\
    \ ally](Mechanics/spells/planar-ally.md)\n\n7th level (1 slots): [plane shift](Mechanics/spells/plane-shift.md)"
  "name": "Spellcasting"
...
- "desc": "The councilor channels positive energy into its Aura of Radiance. Until\
    ...
    \ the bright light must succeed on a DC 17 Constitution saving throw or be [blinded](Mechanics/Rules/conditions.md#Blinded)\
