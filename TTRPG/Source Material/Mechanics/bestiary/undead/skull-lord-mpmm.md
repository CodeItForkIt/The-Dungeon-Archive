...
- "desc": "The skull, lord casts one of the following spells, using Charisma as the\
    ...
    \ [message](Mechanics/spells/message.md)\n\n1/day each: [cloudkill](Mechanics/spells/cloudkill.md),\
    \ [cone of cold](Mechanics/spells/cone-of-cold.md)\n\n2/day each: [dimension\
    \ door](Mechanics/spells/dimension-door.md), [fear](Mechanics/spells/fear.md)"
  "name": "Spellcasting"
...
- "desc": "The skull lord moves up to its speed without provoking opportunity attacks."
  "name": "Move"
- "desc": "The skull lord summons up to five [skeletons](Mechanics/bestiary/undead/skeleton.md)\
    \ or [zombies](Mechanics/bestiary/undead/zombie.md) in unoccupied spaces within\
