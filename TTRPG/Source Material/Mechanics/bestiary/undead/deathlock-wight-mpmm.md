...
- "desc": "The deathlock casts one of the following spells, using Charisma as the\
    ...
    \n1/day each: [fear](Mechanics/spells/fear.md), [hold person](Mechanics/spells/hold-person.md)"
  "name": "Spellcasting"
...
- "desc": "Melee Weapon Attack: +4 to hit, reach 5 ft., one creature. Hit: 6\
    ...
    \ this attack rises 24 hours later as a [zombie](Mechanics/bestiary/undead/zombie.md)\
