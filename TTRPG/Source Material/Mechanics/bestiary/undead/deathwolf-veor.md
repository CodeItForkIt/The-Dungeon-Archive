...
aliases: ["Deathwolf"]
---
# [Deathwolf](Mechanics\bestiary\undead/deathwolf-veor.md)
...
- "desc": "Melee Weapon Attack: +10 to hit, reach 5 ft., one target. Hit: 14\
    ...
    \ against the [frightened](Mechanics/Rules/conditions.md#Frightened) condition.\
    \ This curse lasts until removed by the [Remove Curse](Mechanics/spells/remove-curse.md)\
...
- "desc": "The deathwolf creates a terrifying phantom of itself in the mind of a creature\
    ...
    \ DC 17 Intelligence saving throw or have the [frightened](Mechanics/Rules/conditions.md#Frightened)\
    \ condition for 1 minute.\n\nWhile the target is [frightened](Mechanics/Rules/conditions.md#Frightened),\
    \ the phantom deals 21 (6d6) psychic damage to the target at the start of each\
    \ of the target's turns. A [frightened](Mechanics/Rules/conditions.md#Frightened)\
