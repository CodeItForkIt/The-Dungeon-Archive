...
- "desc": "The devourer chooses a living Humanoid with 0 hit points that it can see\
    ...
    \ and imprisoned there. While imprisoned in this way, the creature is [restrained](Mechanics/Rules/conditions.md#Restrained)\
    ...
    \ fewer Hit Dice, it becomes a [zombie](Mechanics/bestiary/undead/zombie.md).\
    \ If it had 3 to 5 Hit Dice, it becomes a [ghoul](Mechanics/bestiary/undead/ghoul.md).\
    \ Otherwise, it becomes a [wight](Mechanics/bestiary/undead/wight.md). A devourer\
