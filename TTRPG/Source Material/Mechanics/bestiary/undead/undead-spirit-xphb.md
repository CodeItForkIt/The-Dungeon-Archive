...
---
# [Undead Spirit](Mechanics/bestiary/undead/undead-spirit-xphb.md)
...
- "desc": "Constitution Saving Throw: DC equals your spell save DC, any creature\
    ...
    \ from the spirit. Failure: The creature has the [Poisoned](Mechanics/rules/conditions.md#Poisoned)\
...
- "desc": "Melee Attack: YourSpellAttack Bonus equals your spell attack modifier,\
    ...
    \ has the [Frightened](Mechanics/rules/conditions.md#Frightened) condition until\
...
- "desc": "Melee Attack: YourSpellAttack Bonus equals your spell attack modifier,\
    ...
    \ has the [Poisoned](Mechanics/rules/conditions.md#Poisoned) condition, it has\
    \ the [Paralyzed](Mechanics/rules/conditions.md#Paralyzed) condition until the\
    \ end of its next turn."
  "name": "Rotting Claw (Putrid Only)"
"source":
- "XPHB"
"image": "Mechanics/bestiary/undead/token/undead-spirit-xphb.webp"
```
^statblock