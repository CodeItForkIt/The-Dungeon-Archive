...
---
# [Priest of Osybus (Deathly Boon)](Mechanics\bestiary\undead/priest-of-osybus-deathly-boon-vrgr.md)
...
- "desc": "The priest casts one of the following spells, requiring no components and\
    ...
    \ \n\n1/day each: [animate dead](Mechanics/spells/animate-dead.md), [create\
    \ undead](Mechanics/spells/create-undead.md)"
