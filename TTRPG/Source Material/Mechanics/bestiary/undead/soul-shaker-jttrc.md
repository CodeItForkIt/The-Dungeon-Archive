...
aliases: ["Soul Shaker"]
---
# [Soul Shaker](Mechanics\bestiary\undead/soul-shaker-jttrc.md)
...
"cr": "4"
"traits":
- "desc": "The soul shaker can cast the [geas](Mechanics/spells/geas.md) spell, requiring\
...
- "desc": "Melee Weapon Attack: +7 to hit, reach 5 ft., one target. Hit: 14\
    ...
    \ soul shaker can have only one creature [grappled](Mechanics/Rules/conditions.md#Grappled)\
...
"source":
- "JttRC"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/JttRC/Soul%20Shaker.webp"
```
^statblock