...
---
# [Otherworldly Steed](Mechanics/bestiary/otherworldly-steed-xphb.md)
...
- "desc": "Wisdom Saving Throw: DC equals your spell save DC, one creature within\
    \ 60 feet the steed can see. Failure: The target has the [Frightened](Mechanics/rules/conditions.md#Frightened)\
...
"source":
- "XPHB"
"image": "Mechanics/bestiary/token/otherworldly-steed-xphb.webp"
```
^statblock