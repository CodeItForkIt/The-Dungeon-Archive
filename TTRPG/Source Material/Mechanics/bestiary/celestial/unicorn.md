...
- "desc": "- Open flames of a non magical nature are extinguished within the unicorn's\
    ...
    \ have advantage on all Dexterity ([Stealth](Mechanics/Rules/skills.md#Stealth))\
...
- "VEoR"
- "QftIS"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MM/Unicorn.webp"
```
^statblock
