...
*Source: Monster Manual p. 130, Waterdeep: Dungeon of the Mad Mage, Baldur's Gate: Descent Into Avernus, Mythic Odysseys of Theros, Sigil and the Outlands, Turn of Fortune's Wheel, Quests from the Infinite Staircase*  
...
- "desc": "The empyrean bolsters all nonhostile creatures within 120 feet of it until\
    \ the end of its next turn. Bolstered creatures can't be [charmed](Mechanics/Rules/conditions.md#Charmed)\
...
- "desc": "The empyrean strikes the ground with its maul, triggering an earth tremor.\
    ...
    \ on a DC 25 Strength saving throw or be knocked [prone](Mechanics/Rules/conditions.md#Prone)."
...
- "ToFW"
- "QftIS"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MM/Empyrean.webp"
```
^statblock