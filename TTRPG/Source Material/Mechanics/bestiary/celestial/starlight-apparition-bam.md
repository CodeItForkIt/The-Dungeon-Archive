...
- "desc": "Melee or Ranged Spell Attack: +6 to hit, reach 5 ft. or range 120 ft.,\
    ...
    \ it must succeed on a DC 14 Wisdom saving throw or be [blinded](Mechanics/Rules/conditions.md#Blinded)\
...
- "desc": "One Humanoid that the apparition can see within 5 feet of itself must succeed\
    ...
    \ then disappears, and the target is [incapacitated](Mechanics/Rules/conditions.md#Incapacitated)\
    ...
    \ to 0 hit points, the apparition ends it as a bonus action, the body leaves the\
