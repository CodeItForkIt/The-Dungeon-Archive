...
- "desc": "The archon's spellcasting ability is Wisdom (spell save DC 17, +9 to\
    ...
    \ [guiding bolt](Mechanics/spells/guiding-bolt.md), [spare the dying](Mechanics/spells/spare-the-dying.md)\n\
    \n1/day each: [crusader's mantle](Mechanics/spells/crusaders-mantle.md), [spirit\
    \ guardians](Mechanics/spells/spirit-guardians.md)"
...
- "desc": "If the archon isn't mounted, it can use a bonus action to magically teleport\
    ...
    \ its mount have advantage on Dexterity saving throws. If the archon is reduced\
...
- "desc": "If the archon is reduced to 0 hit points, it regains 30 hit points and\
    ...
    \ or the creature takes 13 (3d8) radiant damage and is [blinded](Mechanics/Rules/conditions.md#Blinded)\
...
- "desc": "Melee Weapon Attack: +9 to hit, reach 10 ft., one target. Hit: 12\
  ...
  "name": "Radiant Spear"
"legendary_actions":
- "desc": "The archon makes a radiant spear attack or casts [guiding bolt](Mechanics/spells/guiding-bolt.md)."
  "name": "Attack"
