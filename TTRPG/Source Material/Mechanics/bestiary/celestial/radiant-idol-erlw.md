...
- "desc": "The radiant idol's spellcasting ability is Charisma (spell save DC 17).\
    ...
    \ [dominate person](Mechanics/spells/dominate-person.md), [insect plague](Mechanics/spells/insect-plague.md),\
    \ [mass suggestion](Mechanics/spells/mass-suggestion.md), [raise dead](Mechanics/spells/raise-dead.md)"
  "name": "Innate Spellcasting"
- "desc": "A creature that starts its turn within 30 feet of the radiant idol must\
    \ make a DC 17 Wisdom saving throw, provided the radiant idol isn't [incapacitated](Mechanics/Rules/conditions.md#Incapacitated).\
    \ On a failed save, the creature is [charmed](Mechanics/Rules/conditions.md#Charmed)\
    \ by the radiant idol. A creature [charmed](Mechanics/Rules/conditions.md#Charmed)\
