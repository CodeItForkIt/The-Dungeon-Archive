...
---
# [Inquisitor of the Mind Fire](Mechanics\bestiary\humanoid/inquisitor-of-the-mind-fire-vrgr.md)
...
- "desc": "The inquisitor casts one of the following spells, requiring no components\
    ...
    \ [arcane eye](Mechanics/spells/arcane-eye.md), [calm emotions](Mechanics/spells/calm-emotions.md),\
    \ [detect magic](Mechanics/spells/detect-magic.md), [detect thoughts](Mechanics/spells/detect-thoughts.md),\
    \ [dispel magic](Mechanics/spells/dispel-magic.md), [sending](Mechanics/spells/sending.md),\
    \ [suggestion](Mechanics/spells/suggestion.md)\n\n1/day each: [mass suggestion](Mechanics/spells/mass-suggestion.md),\
...
- "desc": "The inquisitor targets one creature it can see within 120 feet of it. The\
    ...
    \ 4) psychic damage and be [stunned](Mechanics/Rules/conditions.md#Stunned) until\
    \ the start of the inquisitor's next turn."
  "name": "Mind Fire"
- "desc": "Each creature of the inquisitor's choice that it can see within 60 feet\
    \ of it must succeed on a DC 15 Wisdom saving throw or be [charmed](Mechanics/Rules/conditions.md#Charmed)\
    \ until the start of the inquisitor's next turn. On the [charmed](Mechanics/Rules/conditions.md#Charmed)\
...
"source":
- "VRGR"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/VRGR/Inquisitor%20of%20the%20Mind%20Fire.webp"
```
^statblock