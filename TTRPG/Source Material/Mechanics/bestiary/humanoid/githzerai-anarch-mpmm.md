...
- "desc": "The githzerai casts one of the following spells, requiring no spell components\
    ...
    \ each: [globe of invulnerability](Mechanics/spells/globe-of-invulnerability.md),\
    \ [plane shift](Mechanics/spells/plane-shift.md), [wall of force](Mechanics/spells/wall-of-force.md)\n\
    \n3/day each: [see invisibility](Mechanics/spells/see-invisibility.md), [telekinesis](Mechanics/spells/telekinesis.md)"
...
- "desc": "The githzerai teleports, along with any equipment it is wearing or carrying,\
  ...
  "name": "Teleport"
- "desc": "The githzerai casts the [reverse gravity](Mechanics/spells/reverse-gravity.md)\
...
- "desc": "- Create Object. The anarch casts the creation spell (as a 9th-level\
    ...
    \ used in Limbo, the object remains until the anarch's [concentration](Mechanics/Rules/conditions.md#Concentration)\
    \ is broken, regardless of its composition. If the anarch moves more than 120\
    \ feet from the object, the anarch's [concentration](Mechanics/Rules/conditions.md#Concentration)\
