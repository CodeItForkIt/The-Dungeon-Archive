...
---
# [Mapach Brute](Mechanics\bestiary\humanoid/mapach-brute-hwcs.md)
...
"cr": "3"
"traits":
- "desc": "The brute has advantage on saving throws against being [poisoned](Mechanics/Rules/conditions.md#Poisoned)."
  "name": "Resilience"
- "desc": "The brute has advantage on [Stealth](Mechanics/Rules/skills.md#Stealth)\
...
"source":
- "HWCS"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/HWCS/Mapach%20Brute.webp"
```
^statblock