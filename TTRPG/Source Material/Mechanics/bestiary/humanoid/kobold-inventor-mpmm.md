...
---
# [Kobold Inventor](Mechanics\bestiary\humanoid/kobold-inventor-mpmm.md)
...
- "desc": "The kobold uses one of the following options (choose one or roll a d8);\
    ...
    \ kobold hurls a [flask of acid](Mechanics/items/acid-vial.md). Ranged Weapon\
    \ Attack: +4 to hit, range 5/20 ft., one target. Hit: 7 (2d6) acid damage.\
    \  \n- 2 Alchemist's Fire. The kobold throws a [flask of alchemist's fire](Mechanics/items/alchemists-fire-flask.md).\
    ...
    \ a 5-foot-square space within 20 feet of it. A [swarm of insects (centipedes)](Mechanics/bestiary/beast/swarm-of-centipedes.md)\
    ...
    \ A [swarm of rot grubs](Mechanics/bestiary/beast/swarm-of-rot-grubs-mpmm.md)\
    \ (in this book) emerges from the shattered pot and remains a hazard in that square.\
    \  \n- 6 Scorpion on a Stick. The kobold makes a melee attack with a [scorpion](Mechanics/bestiary/beast/scorpion.md)\
    ...
    \ saving throw, or it retches and is [incapacitated](Mechanics/Rules/conditions.md#Incapacitated)\
    ...
    \ bag into a 5-foot-square space within 20 feet of it. A [swarm of insects (wasps)](Mechanics/bestiary/beast/swarm-of-wasps.md)\
