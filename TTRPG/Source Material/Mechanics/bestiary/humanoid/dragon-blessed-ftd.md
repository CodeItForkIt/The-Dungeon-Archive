...
- "desc": "The blessed casts one of the following spells, using Wisdom as the spellcasting\
    ...
    \ [thaumaturgy](Mechanics/spells/thaumaturgy.md)\n\n1/day each: [enhance ability](Mechanics/spells/enhance-ability.md),\
    \ [flame strike](Mechanics/spells/flame-strike.md), [mass cure wounds](Mechanics/spells/mass-cure-wounds.md),\
    \ [revivify](Mechanics/spells/revivify.md), [tongues](Mechanics/spells/tongues.md)"
  "name": "Spellcasting"
"actions":
