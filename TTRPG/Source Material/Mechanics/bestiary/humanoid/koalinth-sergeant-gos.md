...
---
# [Koalinth Sergeant](Mechanics\bestiary\humanoid/koalinth-sergeant-gos.md)
...
- "desc": "Once per turn, the sergeant can deal an extra 7 (2d6) damage to a creature\
    ...
    \ the sergeant that isn't [incapacitated](Mechanics/Rules/conditions.md#Incapacitated)."
...
- "desc": "Ranged Weapon Attack: +4 to hit, range 10/30 ft., one target. Hit:\
    \ 4 (1d4 + 2) piercing damage, and the target is [restrained](Mechanics/Rules/conditions.md#Restrained).\
  ...
  "name": "Hooked Net"
"reactions":
- "desc": "Whenever a creature within 30 feet of the sergeant becomes [restrained](Mechanics/Rules/conditions.md#Restrained),\
    \ the sergeant can move its speed toward the [restrained](Mechanics/Rules/conditions.md#Restrained)\
    \ creature. If the sergeant ends its move within reach of the [restrained](Mechanics/Rules/conditions.md#Restrained)\
    \ creature, it can make a melee attack against it."
  "name": "Spear the Helpless (2/Day)"
"source":
- "GoS"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/GoS/Koalinth%20Sergeant.webp"
```
^statblock