...
```ad-statblock
title: Warrior
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/ESK/Warrior.webp#token)
*Medium humanoid, Unaligned*

- **Armor Class** 16 ([chain shirt](Mechanics/items/chain-shirt.md), [shield](Mechanics/items/shield.md))
- **Hit Points** 13 (`2d8 + 4`)
- **Speed** 30 ft.
