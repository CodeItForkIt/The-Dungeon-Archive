...
---
# [Luma Cleric of Ardea](Mechanics\bestiary\humanoid/luma-cleric-of-ardea-hwcs.md)
...
- "desc": "The cleric is a 5th-level spellcaster. Their spellcasting ability is Wisdom\
    ...
    \n3rd level (2 slots): [beacon of hope](Mechanics/spells/beacon-of-hope.md),\
...
- "desc": "The cleric can cast [charm person](Mechanics/spells/charm-person.md). Charisma\
    \ is their spellcasting ability (spell save DC 12) and the spell does not require\
    \ any somatic components to cast."
  "name": "Songbird (Recharges after a Long Rest)"
"source":
- "HWCS"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/HWCS/Luma%20Cleric%20of%20Ardea.webp"
```
^statblock