...
- "desc": "The tortle casts one of the following spells, using Wisdom as the spellcasting\
    ...
    \ [hold person](Mechanics/spells/hold-person.md), [speak with animals](Mechanics/spells/speak-with-animals.md),\
    \ [thunderwave](Mechanics/spells/thunderwave.md)"
  "name": "Spellcasting"
- "desc": "The tortle can hold its breath for 1 hour."
  "name": "Hold Breath"
"actions":
- "desc": "The tortle makes four Claw attacks or two [Nature](Mechanics/Rules/skills.md#Nature)'s\
    \ Wrath attacks."
  "name": "Multiattack"
...
- "desc": "The tortle withdraws into its shell. Until it emerges, it gains a +4 bonus\
    ...
    \ its shell, the tortle is [prone](Mechanics/Rules/conditions.md#Prone), its speed\
    \ is 0 and can't increase, it has disadvantage on Dexterity saving throws, it\
    \ can't take reactions, and the only action it can take is a bonus action to emerge."
  "name": "Shell Defense"
"source":
- "MPMM"
- "MTF"
