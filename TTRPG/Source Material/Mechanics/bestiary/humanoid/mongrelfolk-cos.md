...
aliases: ["Mongrelfolk"]
---
# [Mongrelfolk](Mechanics\bestiary\humanoid/mongrelfolk-cos.md)
...
- "desc": "The mongrelfolk has one of the following extraordinary features, determined\
    ...
    \ has advantage on Wisdom ([Perception](Mechanics/Rules/skills.md#Perception))\
    ...
    \ start.\n\n20: Two-Headed. The mongrelfolk has advantage on Wisdom ([Perception](Mechanics/Rules/skills.md#Perception))\
...
- "desc": "The mongrelfolk can mimic any sounds it has heard, including voices. A\
    ...
    \ DC 12 Wisdom ([Insight](Mechanics/Rules/skills.md#Insight)) check."
  "name": "Mimicry"
"actions":
...
"source":
- "CoS"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/CoS/Mongrelfolk.webp"
```
^statblock