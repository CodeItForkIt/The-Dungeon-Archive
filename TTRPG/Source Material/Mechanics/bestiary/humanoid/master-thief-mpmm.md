...
- "desc": "If the thief is subjected to an effect that allows it to make a Dexterity\
    ...
    \ thief isn't [incapacitated](Mechanics/Rules/conditions.md#Incapacitated)."
  "name": "Evasion"
"actions":
...
- "desc": "Ranged Weapon Attack: +7 to hit, range 80/320 ft., one target. Hit:\
  ...
  "name": "Shortbow"
"bonus_actions":
- "desc": "The thief takes the [Dash](Mechanics/Rules/actions.md#Dash), [Disengage](Mechanics/Rules/actions.md#Disengage),\
