...
- "desc": "The professor casts one of the following spells, requiring no material\
    ...
    \ [comprehend languages](Mechanics/spells/comprehend-languages.md), [dancing lights](Mechanics/spells/dancing-lights.md),\
    \ [guidance](Mechanics/spells/guidance.md)\n\n2/day each: [locate object](Mechanics/spells/locate-object.md),\
    \ [mage armor](Mechanics/spells/mage-armor.md), [passwall](Mechanics/spells/passwall.md)"
  "name": "Spellcasting"
- "desc": "The professor can cast the [contact other plane](Mechanics/spells/contact-other-plane.md)\
...
- "desc": "The professor makes two Spectral Scroll attacks. It can also use Weight\
    \ of [History](Mechanics/Rules/skills.md#History), if available."
  "name": "Multiattack"
- "desc": "Melee Spell Attack: +7 to hit, reach 30 ft., one target. Hit: 15\
    ...
    \ DC 15 Strength saving throw or be knocked [prone](Mechanics/Rules/conditions.md#Prone)."
...
- "desc": "The professor magically compresses time around up to six creatures of its\
    ...
    \ a DC 15 Wisdom saving throw or be [restrained](Mechanics/Rules/conditions.md#Restrained)\
    \ for 1 minute, but the [restrained](Mechanics/Rules/conditions.md#Restrained)\
    \ target's speed is halved instead of being reduced to 0. At the start of each\
    \ of its turns, the [restrained](Mechanics/Rules/conditions.md#Restrained) target\
    \ takes 4 (1d8) force damage. A [restrained](Mechanics/Rules/conditions.md#Restrained)\
