...
*Source: Monster Manual p. 199, Princes of the Apocalypse, Waterdeep: Dragon Heist, Waterdeep: Dungeon of the Mad Mage, Ghosts of Saltmarsh, Explorer's Guide to Wildemount, Plane Shift: Innistrad, Sigil and the Outlands*  
...
- "desc": "The kuo-toa can sense the presence of any creature within 30 feet of it\
    \ that is [invisible](Mechanics/Rules/conditions.md#Invisible) or on the Ethereal\
...
- "desc": "Ranged Weapon Attack: +3 to hit, range 5/15 ft., one Large or smaller\
    \ creature. Hit: The target is [restrained](Mechanics/Rules/conditions.md#Restrained).\
...
- "desc": "When a creature misses the kuo-toa with a melee weapon attack, the kuo-toa\
    ...
    \ [grappled](Mechanics/Rules/conditions.md#Grappled) while the weapon is stuck.\
...
- "PSI"
- "SatO"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MM/Kuo-toa.webp"
```
^statblock
