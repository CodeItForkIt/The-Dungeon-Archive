...
Supreme commanders lead armies, each one commanding ten kith'raks, who in turn lead the rest of their forces. Most supreme commanders ride [red dragons](Mechanics/bestiary/dragon/adult-red-dragon.md) into battle.
...
- "desc": "The githyanki casts one of the following spells, requiring no spell components\
    ...
    \n1/day each: [Bigby's hand](Mechanics/spells/bigbys-hand.md), [mass suggestion](Mechanics/spells/mass-suggestion.md),\
    \ [plane shift](Mechanics/spells/plane-shift.md), [telekinesis](Mechanics/spells/telekinesis.md)\n\
    \n3/day each: [levitate](Mechanics/spells/levitate.md) (self only), [nondetection](Mechanics/spells/nondetection.md)\
    \ (self only)"
...
- "desc": "Melee Weapon Attack: +12 to hit, reach 5 ft., one target. Hit: 14\
    ...
    \ against a target in an astral body (as with the [astral projection](Mechanics/spells/astral-projection.md)\
