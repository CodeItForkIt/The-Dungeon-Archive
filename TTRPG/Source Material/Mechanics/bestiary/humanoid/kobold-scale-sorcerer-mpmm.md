...
---
# [Kobold Scale Sorcerer](Mechanics\bestiary\humanoid/kobold-scale-sorcerer-mpmm.md)
...
- "desc": "The kobold casts one of the following spells, requiring no material components\
    ...
    \n2/day each: [charm person](Mechanics/spells/charm-person.md), [fog cloud](Mechanics/spells/fog-cloud.md),\
