...
---
# [Inquisitor of the Sword](Mechanics\bestiary\humanoid/inquisitor-of-the-sword-vrgr.md)
...
- "desc": "The inquisitor casts one of the following spells, requiring no components\
    ...
    \n1/day each: [dimension door](Mechanics/spells/dimension-door.md), [fly](Mechanics/spells/fly.md),\
...
"source":
- "VRGR"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/VRGR/Inquisitor%20of%20the%20Sword.webp"
```
^statblock