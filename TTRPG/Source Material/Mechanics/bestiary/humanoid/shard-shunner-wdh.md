...
---
# [Shard Shunner](Mechanics\bestiary\humanoid/shard-shunner-wdh.md)
...
- "desc": "The Shard Shunner can use their action to polymorph into a rat-humanoid\
    ...
    \ if they die."
  "name": "Shapechanger"
- "desc": "The Shard Shunner has advantage on Wisdom ([Perception](Mechanics/Rules/skills.md#Perception))\
    \ checks that rely on smell."
  "name": "Keen Smell"
- "desc": "The Shard Shunner can move through the space of creatures that is of a\
    \ size larger than them."
  "name": "Halfling Nimbleness"
- "desc": "The Shard Shunner has advantage on saving throws against being [frightened](Mechanics/Rules/conditions.md#Frightened)."
  "name": "Brave"
"actions":
...
"source":
- "WDH"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/WDH/Shard%20Shunner.webp"
```
^statblock