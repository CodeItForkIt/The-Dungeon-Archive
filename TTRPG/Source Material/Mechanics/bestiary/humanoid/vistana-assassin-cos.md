...
---
# [Vistana Assassin](Mechanics\bestiary\humanoid/vistana-assassin-cos.md)
...
- "desc": "During its first turn, the assassin has advantage on attack rolls against\
    ...
    \ [surprised](Mechanics/Rules/conditions.md#Surprised) creature is a critical\
    \ hit."
  "name": "Assassinate"
...
- "desc": "The assassin deals an extra 14 (4d6) damage when it hits a target with\
    ...
    \ within 5 feet of an ally of the assassin that isn't [incapacitated](Mechanics/Rules/conditions.md#Incapacitated)\
...
- "desc": "11\n\n- The target is unable to perform a certain kind of act involving\
    ...
    \ psychic damage.  \n- The target is [blinded](Mechanics/Rules/conditions.md#Blinded),\
    \ [deafened](Mechanics/Rules/conditions.md#Deafened), or both. When this curse\
    \ ends, the Vistana takes 5d6 psychic damage.  \n\nThe curse lasts until ended\
    \ with a [greater restoration](Mechanics/spells/greater-restoration.md) spell,\
    \ a [remove curse](Mechanics/spells/remove-curse.md) spell, or similar magic.\
...
"source":
- "CoS"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/CoS/Vistana%20Assassin.webp"
```
^statblock