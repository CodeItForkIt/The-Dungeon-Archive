...
---
# [Shadar-kai Soul Monger](Mechanics\bestiary\humanoid/shadar-kai-soul-monger-mpmm.md)
...
- "desc": "The shadar-kai casts one of the following spells, requiring no material\
    ...
    \ 16):\n\n1/day each: [bestow curse](Mechanics/spells/bestow-curse.md), [finger\
    \ of death](Mechanics/spells/finger-of-death.md), [gaseous form](Mechanics/spells/gaseous-form.md),\
...
- "desc": "The shadar-kai emits weariness in a 60-foot cube. Each creature in that\
    ...
    \ takes 45 (10d8) psychic damage and suffers 1 level of [exhaustion](Mechanics/Rules/conditions.md#Exhaustion).\
