...
---
# [Uthgardt Shaman (Elk)](Mechanics\bestiary\humanoid/uthgardt-shaman-elk-skt.md)
...
- "desc": "The shaman casts one of the following spells, using Wisdom as the spellcasting\
    ...
    \ [spirit guardians](Mechanics/spells/spirit-guardians.md), [find steed](Mechanics/spells/find-steed.md)\
    \ (cast as 1 action; elk only), [haste](Mechanics/spells/haste.md)"
