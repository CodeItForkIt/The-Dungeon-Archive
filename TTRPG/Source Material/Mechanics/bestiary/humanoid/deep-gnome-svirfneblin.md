...
- "desc": "The gnome's innate spellcasting ability is Intelligence (spell save DC\
    ...
    \ [blur](Mechanics/spells/blur.md), [disguise self](Mechanics/spells/disguise-self.md)"
  "name": "Innate Spellcasting"
- "desc": "The gnome has advantage on Dexterity ([Stealth](Mechanics/Rules/skills.md#Stealth))\
...
- "PaBTSO"
- "QftIS"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MM/Deep%20Gnome%20%28Svirfneblin%29.webp"
```
^statblock
