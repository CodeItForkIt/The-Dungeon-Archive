...
---
# [Black Earth Priest](Mechanics\bestiary\humanoid/black-earth-priest-pota.md)
...
- "desc": "The priest is a 5th-level spellcaster. Its spellcasting ability is Charisma\
    ...
    \n1st level (4 slots): [earth tremor](Mechanics/spells/earth-tremor-xge.md),\
    \ [expeditious retreat](Mechanics/spells/expeditious-retreat.md), [shield](Mechanics/spells/shield.md)\n\
    \n2nd level (3 slots): [shatter](Mechanics/spells/shatter.md), [spider climb](Mechanics/spells/spider-climb.md)\n\
    \n3rd level (2 slots): [slow](Mechanics/spells/slow.md)"
  "name": "Spellcasting"
"actions":
...
- "desc": "When the priest is subjected to an effect that would move it, knock it\
    \ [prone](Mechanics/Rules/conditions.md#Prone), or both, it can use its reaction\
    \ to be neither moved nor knocked [prone](Mechanics/Rules/conditions.md#Prone)."
  "name": "Unyielding"
"source":
- "PotA"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/PotA/Black%20Earth%20Priest.webp"
```
^statblock