...
- "desc": "The kuo-toa is a 10th-level spellcaster. Its spellcasting ability is Wisdom\
    ...
    \n1st level (4 slots): [detect magic](Mechanics/spells/detect-magic.md), [sanctuary](Mechanics/spells/sanctuary.md),\
    ...
    \n3rd level (3 slots): [spirit guardians](Mechanics/spells/spirit-guardians.md),\
    \ [tongues](Mechanics/spells/tongues.md)\n\n4th level (3 slots): [control\
    \ water](Mechanics/spells/control-water.md), [divination](Mechanics/spells/divination.md)\n\
    \n5th level (2 slots): [mass cure wounds](Mechanics/spells/mass-cure-wounds.md),\
...
- "PotA"
- "WDMM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MM/Kuo-toa%20Archpriest.webp"
```
^statblock
