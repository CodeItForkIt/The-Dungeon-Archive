...
aliases: ["Werebat"]
---
# [Werebat](Mechanics\bestiary\humanoid/werebat-wdmm.md)
...
A player character who becomes a werebat gains a Dexterity of 17 if their score isn't already higher. [Attack](Mechanics/Rules/actions.md#Attack) and damage rolls for the werebat's bite attack are based on the character's Strength or Dexterity score, whichever is higher.
...
- "desc": "The werebat has advantage on Wisdom ([Perception](Mechanics/Rules/skills.md#Perception))\
...
"source":
- "WDMM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/WDMM/Werebat.webp"
```
^statblock