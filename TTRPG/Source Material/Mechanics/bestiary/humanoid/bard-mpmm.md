...
aliases: ["Bard"]
---
# [Bard](Mechanics\bestiary\humanoid/bard-mpmm.md)
...
Each bard is a master of at least one type of performance. You may choose a bard's main type, or you may roll on the Bard [Performance](Mechanics/Rules/skills.md#Performance) Types table to determine it.
...
- "desc": "The bard casts one of the following spells, using Charisma as the spellcasting\
    ...
    \n1/day each: [charm person](Mechanics/spells/charm-person.md), [invisibility](Mechanics/spells/invisibility.md),\
