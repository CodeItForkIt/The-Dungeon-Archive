...
aliases: ["Vistana Spy"]
---
# [Vistana Spy](Mechanics\bestiary\humanoid/vistana-spy-cos.md)
...
- "desc": "The spy deals an extra 7 (2d6) damage when it hits a target with a weapon\
    ...
    \ feet of an ally of the spy that isn't [incapacitated](Mechanics/Rules/conditions.md#Incapacitated)\
...
"source":
- "CoS"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/CoS/Vistana%20Spy.webp"
```
^statblock