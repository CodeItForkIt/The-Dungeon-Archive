...
- "desc": "The elf casts one of the following spells, using Wisdom as the spellcasting\
    ...
    \ [sending](Mechanics/spells/sending.md), [word of recall](Mechanics/spells/word-of-recall.md)\n\
    \n2/day each: [cure wounds](Mechanics/spells/cure-wounds.md) (8th-level version),\
