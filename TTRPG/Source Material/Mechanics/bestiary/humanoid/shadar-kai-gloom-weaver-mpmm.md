...
---
# [Shadar-kai Gloom Weaver](Mechanics\bestiary\humanoid/shadar-kai-gloom-weaver-mpmm.md)
...
- "desc": "The shadar-kai casts one of the following spells, requiring no material\
    ...
    \nAt will: [arcane eye](Mechanics/spells/arcane-eye.md), [mage armor](Mechanics/spells/mage-armor.md),\
    ...
    \ gate](Mechanics/spells/arcane-gate.md), [bane](Mechanics/spells/bane.md), [confusion](Mechanics/spells/confusion.md),\
    \ [darkness](Mechanics/spells/darkness.md), [fear](Mechanics/spells/fear.md),\
    \ [major image](Mechanics/spells/major-image.md), [true seeing](Mechanics/spells/true-seeing.md)"
  "name": "Spellcasting"
...
- "desc": "Melee or Ranged Weapon Attack: +8 to hit, reach 5 ft. or range 30/120,\
  ...
  "name": "Shadow Spear"
"reactions":
- "desc": "When the shadar-kai takes damage, it turns [invisible](Mechanics/Rules/conditions.md#Invisible)\
