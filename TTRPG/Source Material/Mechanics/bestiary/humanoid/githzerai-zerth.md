...
Githzerai revere Zerthimon, the founder of their race. Although Gith won their people's freedom, Zerthimon saw her as unfit to lead. He believed that her warmongering would soon make her a tyrant no better than the [mind flayers](Mechanics/bestiary/aberration/mind-flayer.md).
...
- "desc": "The githzerai's innate spellcasting ability is Wisdom. It can innately\
    ...
    \ (the hand is invisible)\n\n1/day each: [phantasmal killer](Mechanics/spells/phantasmal-killer.md),\
    \ [plane shift](Mechanics/spells/plane-shift.md)\n\n3/day each: [feather fall](Mechanics/spells/feather-fall.md),\
    \ [jump](Mechanics/spells/jump.md), [see invisibility](Mechanics/spells/see-invisibility.md),\
...
- "SatO"
- "ToFW"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MM/Githzerai%20Zerth.webp"
```
^statblock