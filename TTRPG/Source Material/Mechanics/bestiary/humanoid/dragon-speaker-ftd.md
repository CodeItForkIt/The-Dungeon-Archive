...
- "desc": "The speaker casts one of the following spells, using Charisma as the spellcasting\
    ...
    \n1/day each: [calm emotions](Mechanics/spells/calm-emotions.md), [charm person](Mechanics/spells/charm-person.md),\
    \ [command](Mechanics/spells/command.md), [comprehend languages](Mechanics/spells/comprehend-languages.md)"
  "name": "Spellcasting"
"actions":
