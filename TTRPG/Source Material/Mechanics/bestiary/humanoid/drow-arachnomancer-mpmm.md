...
- "desc": "The drow casts one of the following spells, requiring no material components\
    ...
    \ will: [dancing lights](Mechanics/spells/dancing-lights.md), [mage hand](Mechanics/spells/mage-hand.md)\n\
    \n1/day each: [darkness](Mechanics/spells/darkness.md), [dispel magic](Mechanics/spells/dispel-magic.md),\
    \ [etherealness](Mechanics/spells/etherealness.md), [faerie fire](Mechanics/spells/faerie-fire.md),\
    \ [fly](Mechanics/spells/fly.md), [insect plague](Mechanics/spells/insect-plague.md),\
