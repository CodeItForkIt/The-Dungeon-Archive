...
- "desc": "The duergar targets one creature it can see within 60 feet of it. The target\
    ...
    \ of the duergar's choice. Creatures that can't be [charmed](Mechanics/Rules/conditions.md#Charmed)\
...
- "desc": "For 1 minute, the duergar magically decreases in size, along with anything\
    ...
    \ disadvantage if they use Strength. It gains a +5 bonus to all Dexterity ([Stealth](Mechanics/Rules/skills.md#Stealth))\
    \ checks and a +5 bonus to its AC. It can also take a bonus action on each of\
    \ its turns to take the [Hide](Mechanics/Rules/actions.md#Hide) action."
