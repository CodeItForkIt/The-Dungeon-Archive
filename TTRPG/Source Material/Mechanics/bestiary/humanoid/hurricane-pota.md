...
aliases: ["Hurricane"]
---
# [Hurricane](Mechanics\bestiary\humanoid/hurricane-pota.md)
...
- "desc": "The hurricane is a 3rd-level spellcaster. Its spellcasting ability is Wisdom\
    ...
    \n1st level (4 slots): [feather fall](Mechanics/spells/feather-fall.md), [jump](Mechanics/spells/jump.md),\
    \ [thunderwave](Mechanics/spells/thunderwave.md)\n\n2nd level (2 slots): [gust\
    \ of wind](Mechanics/spells/gust-of-wind.md)"
  "name": "Spellcasting"
...
"source":
- "PotA"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/PotA/Hurricane.webp"
```
^statblock