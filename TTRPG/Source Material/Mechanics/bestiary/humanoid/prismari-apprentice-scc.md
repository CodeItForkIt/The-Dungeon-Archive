...
- "desc": "The apprentice casts one of the following spells, requiring no material\
    ...
    \ each: [gust of wind](Mechanics/spells/gust-of-wind.md), [mage armor](Mechanics/spells/mage-armor.md),\
...
- "desc": "The apprentice moves up to its speed, surrounding itself with elemental\
    ...
    \ or be knocked [prone](Mechanics/Rules/conditions.md#Prone). If the apprentice\
