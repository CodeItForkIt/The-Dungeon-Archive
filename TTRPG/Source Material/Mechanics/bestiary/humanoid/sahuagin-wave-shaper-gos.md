...
---
# [Sahuagin Wave Shaper](Mechanics\bestiary\humanoid/sahuagin-wave-shaper-gos.md)
...
- "desc": "The wave shaper's spellcasting ability is Intelligence (spell save DC 14,\
    ...
    \n1/day: [comprehend languages](Mechanics/spells/comprehend-languages.md)"
...
- "desc": "The wave shaper targets a body of water at least 50 feet square and 25\
    ...
    \ 25 feet tall, and lasts for 1 minute or until the wave shaper is [incapacitated](Mechanics/Rules/conditions.md#Incapacitated).\
    ...
    \ a DC 14 Strength ([Athletics](Mechanics/Rules/skills.md#Athletics)) check.\n\
    ...
    \ ([Athletics](Mechanics/Rules/skills.md#Athletics)) check to do so.\n\nThe first\
...
"source":
- "GoS"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/GoS/Sahuagin%20Wave%20Shaper.webp"
```
^statblock