...
- "desc": "The duergar casts one of the following spells, requiring no spell components\
    ...
    \n1/day: [stinking cloud](Mechanics/spells/stinking-cloud.md)"
...
- "desc": "Melee Weapon Attack: +9 to hit, reach 5 ft., one target. Hit: 23\
    ...
    \ away in a straight line and be knocked [prone](Mechanics/Rules/conditions.md#Prone)."
  "name": "Iron Fist"
- "desc": "Melee Weapon Attack: +9 to hit, reach 5 ft., one target. Hit: 10\
    \ (1d10 + 5) bludgeoning damage, or 21 (3d10 + 5) to a [prone](Mechanics/Rules/conditions.md#Prone)\
    \ target."
  "name": "Stomping Foot"
