...
```ad-statblock
title: Spellcaster
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/ESK/Spellcaster.webp#token)
*Medium humanoid, Unaligned*

- **Armor Class** 12 ([leather armor](Mechanics/items/leather-armor.md))
- **Hit Points** 9 (`2d8`)
- **Speed** 30 ft.
...
**Cantrips (at will)**: [guidance](Mechanics/spells/guidance.md), [sacred flame](Mechanics/spells/sacred-flame.md)
...
**1st level (2 slots)**: [sleep](Mechanics/spells/sleep.md)
