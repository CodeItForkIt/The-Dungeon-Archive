...
aliases: ["Expert"]
---
# [Expert](Mechanics\bestiary\humanoid/expert-dc.md)
...
- "desc": "The expert can take the Help action as a bonus action, and the creature\
    ...
    \ one target."
  "name": "Helpful"
- "desc": "When the expert is not [incapacitated](Mechanics/Rules/conditions.md#Incapacitated)\
...
- "desc": "The expert has [thieves' tools](Mechanics/items/thieves-tools.md) and a\
    \ musical instrument."
  "name": "Tools"
"actions":
...
"source":
- "DC"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/DC/Expert.webp"
```
^statblock