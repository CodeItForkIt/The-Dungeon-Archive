...
---
# [Sahuagin High Priestess](Mechanics\bestiary\humanoid/sahuagin-high-priestess-gos.md)
...
- "desc": "The high priestess is a 7th-level spellcaster. Her spellcasting ability\
    ...
    \ [detect magic](Mechanics/spells/detect-magic.md), [guiding bolt](Mechanics/spells/guiding-bolt.md)\n\
    \n2nd level (3 slots): [hold person](Mechanics/spells/hold-person.md), [spiritual\
    \ weapon](Mechanics/spells/spiritual-weapon.md) (trident)\n\n3rd level (3 slots):\
    \ [bestow curse](Mechanics/spells/bestow-curse.md), [fear](Mechanics/spells/fear.md),\
    \ [mass healing word](Mechanics/spells/mass-healing-word.md), [tongues](Mechanics/spells/tongues.md)\n\
...
- "GoS"
- "SDW"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/GoS/Sahuagin%20High%20Priestess.webp"
```
^statblock