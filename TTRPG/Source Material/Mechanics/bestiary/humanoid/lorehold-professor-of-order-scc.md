...
- "desc": "The professor casts one of the following spells, requiring no material\
    ...
    \n2/day each: [dimension door](Mechanics/spells/dimension-door.md), [locate\
...
- "desc": "Melee Spell Attack: +7 to hit, reach 30 ft., one target. Hit: 13\
    ...
    \ away from the professor and become [restrained](Mechanics/Rules/conditions.md#Restrained)\
