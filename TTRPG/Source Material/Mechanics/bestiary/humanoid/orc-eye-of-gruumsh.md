...
"ac": !!int "16"
"ac_class": "[ring mail](Mechanics/items/ring-mail.md), [shield](Mechanics/items/shield.md)"
"hp": !!int "45"
"hit_dice": "6d8 + 18"
"stats":
- !!int "16"
...
- "desc": "The orc is a 3rd-level spellcaster. Its spellcasting ability is Wisdom\
    ...
    \ [resistance](Mechanics/spells/resistance.md), [thaumaturgy](Mechanics/spells/thaumaturgy.md)\n\
    \n1st level (4 slots): [bless](Mechanics/spells/bless.md), [command](Mechanics/spells/command.md)\n\
    \n2nd level (2 slots): [augury](Mechanics/spells/augury.md), [spiritual weapon](Mechanics/spells/spiritual-weapon.md)\
    \ (spear)"
  "name": "Spellcasting"
...
- "EGW"
- "IDRotF"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MM/Orc%20Eye%20of%20Gruumsh.webp"
```
^statblock
