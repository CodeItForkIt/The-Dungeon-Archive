...
---
# [Inquisitor of the Tome](Mechanics\bestiary\humanoid/inquisitor-of-the-tome-vrgr.md)
...
- "desc": "The inquisitor casts one of the following spells, requiring no components\
    ...
    \ [mage hand](Mechanics/spells/mage-hand.md), [sending](Mechanics/spells/sending.md)\n\
    \n1/day each: [Otiluke's resilient sphere](Mechanics/spells/otilukes-resilient-sphere.md),\
...
- "desc": "Each creature in a 20-foot-radius sphere centered on a point the inquisitor\
    ...
    \ or take 31 (6d8 + 4) force damage and be knocked [prone](Mechanics/Rules/conditions.md#Prone)\
...
- "VRGR"
- "VEoR"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/VRGR/Inquisitor%20of%20the%20Tome.webp"
```
^statblock