...
---
# [Werewolf (Mondronen)](Mechanics\bestiary\humanoid/werewolf-mondronen-psi.md)
*Source: Plane Shift: Innistrad p. 15*  

```statblock
"name": "Werewolf (Mondronen) (PSI)"
"size": "Medium"
"type": "humanoid"
...
- "desc": "While it has 10 hit points or fewer, the werewolf has advantage on attack\
