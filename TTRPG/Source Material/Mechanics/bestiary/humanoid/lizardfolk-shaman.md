...
- "desc": "The lizardfolk is a 5th-level spellcaster. Its spellcasting ability is\
    ...
    \n2nd level (3 slots): [heat metal](Mechanics/spells/heat-metal.md), [spike\
    \ growth](Mechanics/spells/spike-growth.md)\n\n3rd level (2 slots): [conjure\
    \ animals](Mechanics/spells/conjure-animals.md) (reptiles only), [plant growth](Mechanics/spells/plant-growth.md)"
...
- "desc": "Melee Weapon Attack: +4 to hit, reach 5 ft., one target. Hit: 5 (1d6\
    \ + 2) piercing damage, or 7 (1d10 + 2) piercing damage in [crocodile](Mechanics/bestiary/beast/crocodile.md)\
...
- "desc": "The lizardfolk magically polymorphs into a [crocodile](Mechanics/bestiary/beast/crocodile.md),\
...
- "IMR"
- "EGW"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MM/Lizardfolk%20Shaman.webp"
```
^statblock
