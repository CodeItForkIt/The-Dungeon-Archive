...
Jackalweres kidnap humanoids for their lamia masters, condemning victims to a lifetime of slavery or an agonizing death. A jackalwere's magical gaze renders a foe [unconscious](Mechanics/Rules/conditions.md#Unconscious), allowing the monster to bind a creature or drag it away.
...
- "desc": "The jackalwere can use its action to polymorph into a specific Medium human\
    ...
    \ it dies."
  "name": "Shapechanger"
- "desc": "The jackalwere has advantage on Wisdom ([Perception](Mechanics/Rules/skills.md#Perception))\
...
- "desc": "The jackalwere gazes at one creature it can see within 30 feet of it. The\
    ...
    \ to a magical slumber, falling [unconscious](Mechanics/Rules/conditions.md#Unconscious)\
    ...
    \ gaze for the next 24 hours. Undead and creatures immune to being [charmed](Mechanics/Rules/conditions.md#Charmed)\
...
- "JttRC"
- "QftIS"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MM/Jackalwere.webp"
```
^statblock
