...
---
# [Thri-kreen (Weapons and Psionics)](Mechanics\bestiary\humanoid/thri-kreen-weapons-and-psionics.md)
...
- "desc": "The thri-kreen's innate spellcasting ability is Wisdom. The thri-kreen\
    ...
    \ [mage hand](Mechanics/spells/mage-hand.md) (the hand is [invisible](Mechanics/Rules/conditions.md#Invisible))\n\
    \n1/day: [invisibility](Mechanics/spells/invisibility.md) (self only)\n\n\
    2/day each: [blur](Mechanics/spells/blur.md), [magic weapon](Mechanics/spells/magic-weapon.md)"
...
- "desc": "The thri-kreen can change the color of its carapace to match the color\
    ...
    \ ([Stealth](Mechanics/Rules/skills.md#Stealth)) checks made to hide."
...
- "desc": "Melee Weapon Attack: +3 to hit, reach 5 ft., one creature. Hit: 4\
    ...
    \ minute. If the saving throw fails by 5 or more, the target is also [paralyzed](Mechanics/Rules/conditions.md#Paralyzed)\
