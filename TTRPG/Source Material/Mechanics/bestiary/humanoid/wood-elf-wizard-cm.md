...
---
# [Wood Elf Wizard](Mechanics\bestiary\humanoid/wood-elf-wizard-cm.md)
...
- "desc": "The wood elf is a 10th-level spellcaster. Its spellcasting ability is Intelligence\
  ...
  "name": "Spellcasting"
- "desc": "The wood elf has advantage on saving throws against being [charmed](Mechanics/Rules/conditions.md#Charmed),\
...
- "desc": "Melee Weapon Attack: +2 to hit, reach 5 ft., one target. Hit: 2 (1d6\
  ...
  "name": "Staff"
- "desc": "The wood elf magically summons a [quasit](Mechanics/bestiary/fiend/quasit.md),\
...
"source":
- "CM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/CM/Wood%20Elf%20Wizard.webp"
```
^statblock