...
*Source: Monster Manual p. 180, The Rise of Tiamat, Ghosts of Saltmarsh, Storm Lord's Wrath, Infernal Machine Rebuild. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>*  
...
Here the half-dragon template has been applied to a human [veteran](Mechanics/bestiary/humanoid/veteran.md) to create a half-red dragon veteran. [Splint armor](Mechanics/items/splint-armor.md) has been replaced with [plate](Mechanics/items/plate-armor.md).
...
- "SLW"
- "IMR"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MM/Half-Red%20Dragon%20Veteran.webp"
```
^statblock