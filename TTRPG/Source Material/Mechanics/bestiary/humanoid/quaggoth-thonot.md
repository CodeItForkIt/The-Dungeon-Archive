...
- "desc": "The quaggoth's innate spellcasting ability is Wisdom (spell save DC 11).\
    ...
    \nAt will: [feather fall](Mechanics/spells/feather-fall.md), [mage hand](Mechanics/spells/mage-hand.md)\
    \ (the hand is invisible)\n\n1/day each: [cure wounds](Mechanics/spells/cure-wounds.md),\
    \ [enlarge/reduce](Mechanics/spells/enlarge-reduce.md), [heat metal](Mechanics/spells/heat-metal.md),\
...
- "WDMM"
- "IDRotF"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MM/Quaggoth%20Thonot.webp"
```
^statblock
