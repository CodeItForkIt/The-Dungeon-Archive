...
---
# [Aarakocra Simulacrum](Mechanics\bestiary\humanoid/aarakocra-simulacrum-skt.md)
...
- "desc": "When a simulacrum drops to 0 hit points or is subjected to a successful\
    \ [dispel magic](Mechanics/spells/dispel-magic.md) spell (DC 17), it reverts to\
    \ ice and snow and is destroyed."
  "name": "Simulacra"
"actions":
...
- "desc": "Five aarakocra within 30 feet of each other can magically summon an air\
    ...
    \ turns to perform an aerial dance and must maintain [concentration](Mechanics/Rules/conditions.md#Concentration)\
...
"source":
- "SKT"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/SKT/Aarakocra%20Simulacrum.webp"
```
^statblock