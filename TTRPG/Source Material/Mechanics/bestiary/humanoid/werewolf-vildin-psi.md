...
statblock: inline
aliases: ["Werewolf (Vildin)"]
---
# [Werewolf (Vildin)](Mechanics\bestiary\humanoid/werewolf-vildin-psi.md)
*Source: Plane Shift: Innistrad p. 15*  

```statblock
"name": "Werewolf (Vildin) (PSI)"
"size": "Medium"
"type": "humanoid"
...
- "desc": "When the werewolf reduces a creature to 0 hit points with a melee attack\
