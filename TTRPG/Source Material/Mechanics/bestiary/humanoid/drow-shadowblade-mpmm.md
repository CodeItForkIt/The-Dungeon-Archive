...
- "desc": "The drow casts one of the following spells, requiring no material components\
    ...
    \n1/day each: [faerie fire](Mechanics/spells/faerie-fire.md), [levitate](Mechanics/spells/levitate.md)\
    \ (self only)"
  "name": "Spellcasting"
- "desc": "Magical darkness doesn't impede the drow's [darkvision](Mechanics/Rules/senses.md#Darkvision)."
  "name": "Devil's Sight"
