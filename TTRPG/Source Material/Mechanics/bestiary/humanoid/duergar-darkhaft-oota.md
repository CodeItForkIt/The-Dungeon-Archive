...
---
# [Duergar Darkhaft](Mechanics\bestiary\humanoid/duergar-darkhaft-oota.md)
...
- "desc": "The darkhaft's innate spellcasting ability is Intelligence (spell save\
    ...
    \nAt will: [friends](Mechanics/spells/friends.md), [mage hand](Mechanics/spells/mage-hand.md)\n\
    \n1/day each: [disguise self](Mechanics/spells/disguise-self.md), [sleep](Mechanics/spells/sleep.md)"
...
"source":
- "OotA"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/OotA/Duergar%20Darkhaft.webp"
```
^statblock