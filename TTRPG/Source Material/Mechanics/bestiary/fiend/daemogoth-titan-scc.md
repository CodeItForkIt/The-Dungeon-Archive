...
- "desc": "Using a 10-minute long ritual, the titan can forge a magical bond with\
    ...
    \ by the pact until it dies, the titan dies, or the pact is broken by a [wish](Mechanics/spells/wish.md)\
    ...
    \ which can't break the creature's [concentration](Mechanics/Rules/conditions.md#Concentration)\
...
- "desc": "The titan targets one creature it can see within 120 feet of itself. The\
    ...
    \ 38 (7d10) psychic damage and is [frightened](Mechanics/Rules/conditions.md#Frightened)\
    ...
    \ isn't [frightened](Mechanics/Rules/conditions.md#Frightened), and the titan\
    \ doesn't heal."
