...
- "desc": "One creature of the quasit's choice within 20 feet of it must succeed on\
    \ a DC 10 Wisdom saving throw or be [frightened](Mechanics/Rules/conditions.md#Frightened)\
    \ for 1 minute. The target can repeat the saving throw at the end of each of its\
    \ turns, with disadvantage if the quasit is within line of sight, ending the effect\
    \ on itself on a success."
  "name": "Scare (1/Day)"
- "desc": "The quasit magically turns [invisible](Mechanics/Rules/conditions.md#Invisible)\
...
- "DoDk"
- "VEoR"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MM/Quasit.webp"
```
^statblock