...
aliases: ["Quasit"]
---
# [Quasit](Mechanics/bestiary/fiend/quasit-xphb.md)
...
"cr": "1"
"traits":
- "desc": "The quasit casts [Invisibility](Mechanics/spells/invisibility-xphb.md)\
    \ on itself, requiring no spell components and using Charisma as the spellcasting\
    \ ability.\n\nAt will: [Invisibility](Mechanics/spells/invisibility-xphb.md)"
  "name": "Invisibility"
...
- "desc": "Melee Attack: +5, reach 5 ft. Hit: 5 (1d4 + 3) Slashing damage,\
    \ and the target has the [Poisoned](Mechanics/rules/conditions.md#Poisoned) condition\
...
- "desc": "Wisdom Saving Throw: DC 10, one creature within 20 feet. Failure: The\
    \ target has the [Frightened](Mechanics/rules/conditions.md#Frightened) condition.\
    \ At the end of each of its turns, the target repeats the save, ending the effect\
    \ on itself on a success. After 1 minute, it succeeds automatically"
  "name": "Scare (1/Day)"
"source":
- "XPHB"
"image": "Mechanics/bestiary/fiend/token/quasit-xphb.webp"
```
^statblock