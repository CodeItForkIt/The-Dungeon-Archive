...
- "desc": "The mezzoloth's innate spellcasting ability is Charisma (spell save DC\
    ...
    \ components:\n\n1/day: [cloudkill](Mechanics/spells/cloudkill.md)\n\n2/day\
    \ each: [darkness](Mechanics/spells/darkness.md), [dispel magic](Mechanics/spells/dispel-magic.md)"
...
- "PaBTSO"
- "ToFW"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MM/Mezzoloth.webp"
```
^statblock