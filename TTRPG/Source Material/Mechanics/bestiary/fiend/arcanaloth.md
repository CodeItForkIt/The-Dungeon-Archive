...
- "desc": "The arcanaloth's innate spellcasting ability is Charisma (spell save DC\
    ...
    \ components:\n\nAt will: [alter self](Mechanics/spells/alter-self.md), [darkness](Mechanics/spells/darkness.md),\
    \ [heat metal](Mechanics/spells/heat-metal.md), [invisibility](Mechanics/spells/invisibility.md)\
    \ (self only), [magic missile](Mechanics/spells/magic-missile.md)"
...
- "desc": "The arcanaloth is a 16th-level spellcaster. Its spellcasting ability is\
    ...
    \ [shield](Mechanics/spells/shield.md), [Tenser's floating disk](Mechanics/spells/tensers-floating-disk.md)\n\
    ...
    \ [fear](Mechanics/spells/fear.md), [fireball](Mechanics/spells/fireball.md)\n\
    ...
    \ other plane](Mechanics/spells/contact-other-plane.md), [hold monster](Mechanics/spells/hold-monster.md)\n\
...
- "AATM"
- "SatO"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MM/Arcanaloth.webp"
```
^statblock