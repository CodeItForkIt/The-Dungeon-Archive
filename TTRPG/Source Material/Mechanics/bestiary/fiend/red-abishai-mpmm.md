...
- "desc": "Each creature of the abishai's choice that is within 120 feet and aware\
    \ of the abishai must succeed on a DC 18 Wisdom saving throw or become [frightened](Mechanics/Rules/conditions.md#Frightened)\
...
- "desc": "The abishai chooses up to four other creatures within 60 feet of it that\
    ...
    \ makes attack rolls with advantage and can't be [frightened](Mechanics/Rules/conditions.md#Frightened)."
...
- "desc": "The abishai targets one Dragon it can see within 120 feet of it. The Dragon\
    ...
    \ Power of the Dragon Queen for 1 hour. On a failed save, the target is [charmed](Mechanics/Rules/conditions.md#Charmed)\
    \ by the abishai for 1 hour. While [charmed](Mechanics/Rules/conditions.md#Charmed)\
