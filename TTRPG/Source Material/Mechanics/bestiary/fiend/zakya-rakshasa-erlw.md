...
- "desc": "The rakshasa's innate spellcasting ability is Charisma (spell save DC 11).\
    ...
    \nAt will: [detect thoughts](Mechanics/spells/detect-thoughts.md), [disguise\
    \ self](Mechanics/spells/disguise-self.md)\n\n1/day: [shield](Mechanics/spells/shield.md)"
...
- "desc": "When the rakshasa hits a creature with a melee weapon attack, the attack\
    ...
    \ creature up to 10 feet away from it, knock the creature [prone](Mechanics/Rules/conditions.md#Prone),\
