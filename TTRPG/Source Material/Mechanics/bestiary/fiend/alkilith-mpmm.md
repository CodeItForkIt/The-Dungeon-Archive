...
- "desc": "Any creature that isn't a demon that starts its turn within 30 feet of\
    ...
    \ fails by 5 or more, the creature is instead subjected to the [confusion](Mechanics/spells/confusion.md)\
    \ spell for 1 minute (no [concentration](Mechanics/Rules/conditions.md#Concentration)\
