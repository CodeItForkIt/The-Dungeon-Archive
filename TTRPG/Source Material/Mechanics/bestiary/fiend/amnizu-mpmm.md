...
- "desc": "The amnizu casts one of the following spells, requiring no material components\
    ...
    \ will: [command](Mechanics/spells/command.md)\n\n1/day: [feeblemind](Mechanics/spells/feeblemind.md)\n\
    \n3/day: [dominate monster](Mechanics/spells/dominate-monster.md)"
  "name": "Spellcasting"
- "desc": "Magical darkness doesn't impede the amnizu's [darkvision](Mechanics/Rules/senses.md#Darkvision)."
  "name": "Devil's Sight"
...
- "desc": "The amnizu targets one or two creatures that it can see within 60 feet\
    ...
    \ necrotic damage and be [blinded](Mechanics/Rules/conditions.md#Blinded) until\
...
- "desc": "The amnizu targets one creature it can see within 60 feet of it. That creature\
    ...
    \ damage and become [stunned](Mechanics/Rules/conditions.md#Stunned) for 1 minute.\
    \ A [stunned](Mechanics/Rules/conditions.md#Stunned) creature repeats the saving\
    \ throw at the end of each of its turns, ending the effect on itself on a success.\
    \ If the target is [stunned](Mechanics/Rules/conditions.md#Stunned) for the full\
    \ minute, it forgets everything it sensed, experienced, and learned during the\
    \ last 5 hours."
