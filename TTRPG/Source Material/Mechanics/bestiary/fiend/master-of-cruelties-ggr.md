...
---
# [Master of Cruelties](Mechanics\bestiary\fiend/master-of-cruelties-ggr.md)
...
- "desc": "The master's innate spellcasting ability is Charisma (spell save DC 17).\
    ...
    \nAt will: [charm person](Mechanics/spells/charm-person.md) (as a 3rd-level\
    \ spell), [crown of madness](Mechanics/spells/crown-of-madness.md)\n\n1/day:\
...
- "desc": "Each creature within 120 feet of the master must succeed on a DC 17 Wisdom\
    \ saving throw or be [charmed](Mechanics/Rules/conditions.md#Charmed) by the master\
    \ for 1 hour. While [charmed](Mechanics/Rules/conditions.md#Charmed) in this way,\
    \ a creature's speed is 0. If the [charmed](Mechanics/Rules/conditions.md#Charmed)\
