...
---
# [Relentless Juggernaut](Mechanics\bestiary\fiend/relentless-juggernaut-vrgr.md)
...
- "desc": "Melee Weapon Attack: +10 to hit, reach 5 ft., one target. Hit: 11\
    ...
    \ it must succeed on a DC 18 Strength saving throw or be knocked [prone](Mechanics/Rules/conditions.md#Prone)."
  "name": "Fist"
...
- "desc": "The target takes 22 (5d8) bludgeoning damage and is [incapacitated](Mechanics/Rules/conditions.md#Incapacitated)\
...
- "desc": "The target takes 14 (4d6) slashing damage, and the implement vanishes.\
    ...
    \ a successful DC 15 Wisdom ([Medicine](Mechanics/Rules/skills.md#Medicine)) check."
...
"source":
- "VRGR"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/VRGR/Relentless%20Juggernaut.webp"
```
^statblock