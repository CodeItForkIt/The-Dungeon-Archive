...
*Source: Monster Manual p. 257, Waterdeep: Dungeon of the Mad Mage, Ghosts of Saltmarsh, Eberron: Rising from the Last War, Tasha's Cauldron of Everything, Candlekeep Mysteries, Vecna: Eve of Ruin. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>*  
...
- "desc": "The rakshasa's innate spellcasting ability is Charisma (spell save DC 18,\
    ...
    \ person](Mechanics/spells/dominate-person.md), [fly](Mechanics/spells/fly.md),\
    \ [plane shift](Mechanics/spells/plane-shift.md), [true seeing](Mechanics/spells/true-seeing.md)\n\
    \n3/day each: [charm person](Mechanics/spells/charm-person.md), [detect magic](Mechanics/spells/detect-magic.md),\
    \ [invisibility](Mechanics/spells/invisibility.md), [major image](Mechanics/spells/major-image.md),\
...
- "desc": "Melee Weapon Attack: +7 to hit, reach 5 ft., one target. Hit: 9 (2d6\
    ...
    \ by a [remove curse](Mechanics/spells/remove-curse.md) spell or similar magic."
  "name": "Claw"
"source":
- "MM"
- "WDMM"
...
- "CM"
- "VEoR"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MM/Rakshasa.webp"
```
^statblock
