...
- "desc": "The merrenoloth casts one of the following spells, requiring no material\
    ...
    \ 13):\n\nAt will: [charm person](Mechanics/spells/charm-person.md), [darkness](Mechanics/spells/darkness.md),\
    \ [detect magic](Mechanics/spells/detect-magic.md), [dispel magic](Mechanics/spells/dispel-magic.md),\
    \ [gust of wind](Mechanics/spells/gust-of-wind.md)\n\n3/day: [control water](Mechanics/spells/control-water.md)"
  "name": "Spellcasting"
...
- "desc": "The merrenoloth targets one creature it can see within 60 feet of it. The\
    \ target must succeed on a DC 13 Wisdom saving throw or become [frightened](Mechanics/Rules/conditions.md#Frightened)\
    \ of the merrenoloth for 1 minute. The [frightened](Mechanics/Rules/conditions.md#Frightened)\
...
- "desc": "- Gale. The air within 60 feet of the vessel is filled with wind. Until\
    ...
    \ there, it must succeed on a DC 13 Strength saving throw or be knocked [prone](Mechanics/Rules/conditions.md#Prone).\
