...
*Source: Monster Manual p. 58, Waterdeep: Dungeon of the Mad Mage, Ghosts of Saltmarsh, Baldur's Gate: Descent Into Avernus, Explorer's Guide to Wildemount, Critical Role: Call of the Netherdeep, Sigil and the Outlands, Dungeons of Drakkenheim, Vecna: Eve of Ruin. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>*  
...
> 
> Though demons all have common names, every demon lord and every demon of type 1 through 6 has a true name that it keeps secret. A demon can be forced to disclose its true name if [charmed](Mechanics/Rules/conditions.md#Charmed), and ancient scrolls and tomes are said to exist that list the true names of the most powerful demons.
> 
...
- "desc": "The glabrezu's spellcasting ability is Intelligence (spell save DC 16).\
    ...
    \nAt will: [darkness](Mechanics/spells/darkness.md), [detect magic](Mechanics/spells/detect-magic.md),\
    \ [dispel magic](Mechanics/spells/dispel-magic.md)\n\n1/day each: [confusion](Mechanics/spells/confusion.md),\
    \ [fly](Mechanics/spells/fly.md), [power word stun](Mechanics/spells/power-word-stun.md)"
...
- "desc": "Melee Weapon Attack: +9 to hit, reach 10 ft., one target. Hit: 16\
    ...
    \ it is [grappled](Mechanics/Rules/conditions.md#Grappled) (escape DC 15). The\
...
- "DoDk"
- "VEoR"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MM/Glabrezu.webp"
```
^statblock