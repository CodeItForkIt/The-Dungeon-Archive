...
- "desc": "The yochlol's spellcasting ability is Charisma (spell save DC 14). The\
    ...
    \nAt will: [detect thoughts](Mechanics/spells/detect-thoughts.md), [web](Mechanics/spells/web.md)\n\
...
- "desc": "The yochlol transforms into toxic mist or reverts to its true form. Any\
    ...
    \ form if it dies.\n\nWhile in mist form, the yochlol is [incapacitated](Mechanics/Rules/conditions.md#Incapacitated)\
    ...
    \ in this way, the target is [incapacitated](Mechanics/Rules/conditions.md#Incapacitated)."
  "name": "Mist Form"
"source":
- "MM"
- "WDMM"
...
- "PaBTSO"
- "VEoR"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MM/Yochlol.webp"
```
^statblock