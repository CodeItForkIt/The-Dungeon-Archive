...
- "desc": "If the goristro moves at least 15 feet straight toward a target and then\
    ...
    \ saving throw or be pushed up to 20 feet away and knocked [prone](Mechanics/Rules/conditions.md#Prone)."
  "name": "Charge"
...
- "VEoR"
- "QftIS"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MM/Goristro.webp"
```
^statblock