...
- "desc": "The hydroloth casts one of the following spells, requiring no material\
    ...
    \ (self only)\n\n3/day each: [control water](Mechanics/spells/control-water.md),\
    \ [crown of madness](Mechanics/spells/crown-of-madness.md), [fear](Mechanics/spells/fear.md),\
...
- "desc": "The hydroloth targets one creature it can see within 60 feet of it. The\
    ...
    \ a success. A [greater restoration](Mechanics/spells/greater-restoration.md)\
    \ or [remove curse](Mechanics/spells/remove-curse.md) spell cast on the target\
