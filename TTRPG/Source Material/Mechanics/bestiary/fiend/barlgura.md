...
- "desc": "The barlgura's spellcasting ability is Wisdom (spell save DC 13). The barlgura\
    ...
    1/day each: [entangle](Mechanics/spells/entangle.md), [phantasmal force](Mechanics/spells/phantasmal-force.md)\n\
...
- "VEoR"
- "QftIS"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MM/Barlgura.webp"
```
^statblock