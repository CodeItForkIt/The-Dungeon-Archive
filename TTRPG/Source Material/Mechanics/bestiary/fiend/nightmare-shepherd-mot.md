...
- "desc": "The shepherd's spellcasting ability is Charisma (spell save DC 17). It\
    ...
    1/day each: [confusion](Mechanics/spells/confusion.md), [dispel magic](Mechanics/spells/dispel-magic.md),\
    \ [hold person](Mechanics/spells/hold-person.md), [suggestion](Mechanics/spells/suggestion.md)"
...
- "desc": "Melee Weapon Attack: +8 to hit, reach 5 ft., one target. Hit: 11\
  ...
  "name": "Staff"
- "desc": "The shepherd pulls twisted souls from the Underworld; 1d6 [shadows](Mechanics/bestiary/undead/shadow.md)\
