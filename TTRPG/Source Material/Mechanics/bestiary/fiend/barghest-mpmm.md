...
aliases: ["Barghest"]
---
# [Barghest](Mechanics\bestiary\fiend/barghest-mpmm.md)
...
- "desc": "The barghest casts one of the following spells, requiring no material components\
    ...
    \ [levitate](Mechanics/spells/levitate.md), [minor illusion](Mechanics/spells/minor-illusion.md),\
    \ [pass without trace](Mechanics/spells/pass-without-trace.md)\n\n1/day each:\
    \ [charm person](Mechanics/spells/charm-person.md), [dimension door](Mechanics/spells/dimension-door.md),\
