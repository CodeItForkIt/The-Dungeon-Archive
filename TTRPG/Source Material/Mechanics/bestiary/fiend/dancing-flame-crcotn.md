...
---
# [Dancing Flame](Mechanics\bestiary\fiend/dancing-flame-crcotn.md)
...
- "desc": "One humanoid the flame can see within 30 feet of it must succeed on a DC\
    ...
    \ the flame's verbal or telepathic commands. If the target suffers any harm or\
    ...
    \ hours.\n\nThe flame can have only one target [charmed](Mechanics/Rules/conditions.md#Charmed)\
    \ at a time. If it charms another, the effect on the previous target ends."
  "name": "Charm"
- "desc": "The flame kisses a creature [charmed](Mechanics/Rules/conditions.md#Charmed)\
...
"source":
- "CRCotN"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/CRCotN/Dancing%20Flame.webp"
```
^statblock