...
- "desc": "The devil magically forms an opaque wall of ice on a solid surface it can\
    ...
    \ creature is [incapacitated](Mechanics/Rules/conditions.md#Incapacitated). The\
    \ creature then makes a DC 17 Dexterity saving throw, taking 35 (10d6) cold\
    \ damage on a failed save, or half as much damage on a successful one.\n\nThe\
    \ wall lasts for 1 minute or until the devil is [incapacitated](Mechanics/Rules/conditions.md#Incapacitated)\
...
- "SatO"
- "VEoR"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MM/Ice%20Devil.webp"
```
^statblock