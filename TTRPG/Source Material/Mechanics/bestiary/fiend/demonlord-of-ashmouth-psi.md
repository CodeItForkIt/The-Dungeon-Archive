...
```statblock
"name": "Demonlord of Ashmouth (PSI)"
"size": "Large"
"type": "fiend"
"subtype": "devil"
...
"actions":
- "desc": "The demon makes three melee attacks: two with its battleaxe and one with\
...
- "desc": "Melee Weapon Attack: +10 to hit, reach 10 ft., one target. Hit: 15\
    \ (2d8 + 6) slashing damage, or 17 (2d10 + 6) slashing damage if used with\
    \ two hands."
  "name": "Battleaxe"
- "desc": "Melee Weapon Attack: +10 to hit, reach 10 ft., one target. Hit: 10\
    ...
    \ Each time the demon hits the wounded target with this attack, the damage dealt\
...
"source":
- "PSI"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/PSI/Demonlord%20of%20Ashmouth.webp"
```
^statblock