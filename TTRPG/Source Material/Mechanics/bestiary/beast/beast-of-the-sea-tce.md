...
---
# [Beast of the Sea](Mechanics\bestiary\beast/beast-of-the-sea-tce.md)
...
- "desc": "Melee Weapon Attack: YourSpellAttack to hit, reach 5 ft., one target.\
    ...
    \ choice), and the target is [grappled](Mechanics/Rules/conditions.md#Grappled)\
    \ (escape DC equal to your spellcasting save DC). Until this grapple ends, the\
    \ beast can't use this attack on another target."
  "name": "Binding Strike"
"source":
- "TCE"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/TCE/Beast%20of%20the%20Sea.webp"
```
^statblock