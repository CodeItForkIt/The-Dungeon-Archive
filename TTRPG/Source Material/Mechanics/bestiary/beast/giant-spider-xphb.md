...
---
# [Giant Spider](Mechanics/bestiary/beast/giant-spider-xphb.md)
...
- "desc": "Dexterity Saving Throw: DC 13, one creature the spider can see within\
    \ 60 feet. Failure: The target has the [Restrained](Mechanics/rules/conditions.md#Restrained)\
    \ condition until the web is destroyed (AC 10; HP 5; Vulnerability to Fire damage;\
    \ Immunity to Poison and Psychic damage)."
  "name": "Web (Recharge 5-6)"
"source":
- "XPHB"
"image": "Mechanics/bestiary/beast/token/giant-spider-xphb.webp"
```
^statblock