...
*Source: Monster Manual p. 80, Tomb of Annihilation, Turn of Fortune's Wheel. Available in the <span title='Systems Reference Document (5.1)'>SRD</span> and the Basic Rules (2014)*  
...
- "desc": "If the triceratops moves at least 20 feet straight toward a creature and\
    ...
    \ If the target is [prone](Mechanics/Rules/conditions.md#Prone), the triceratops\
...
- "ToA"
- "ToFW"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MM/Triceratops.webp"
```
^statblock
