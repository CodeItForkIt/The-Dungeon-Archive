...
- "desc": "Melee Weapon Attack: +7 to hit, reach 10 ft., one target. Hit: 14\
    \ (2d8 + 5) slashing damage, and the target is [grappled](Mechanics/Rules/conditions.md#Grappled)\
...
- "desc": "When the relic sloth is subjected to an effect that would move it out of\
    \ its current space or knock it [prone](Mechanics/Rules/conditions.md#Prone),\
    \ it is neither moved nor knocked [prone](Mechanics/Rules/conditions.md#Prone)."
