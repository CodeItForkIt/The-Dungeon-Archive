...
aliases: ["Boar"]
---
# [Boar](Mechanics/bestiary/beast/boar-xphb.md)
...
- "desc": "Melee Attack: +3, reach 5 ft. Hit: 4 (1d6 + 1) Piercing damage.\
    ...
    \ or smaller, has the [Prone](Mechanics/rules/conditions.md#Prone) condition."
  "name": "Gore"
"source":
- "XPHB"
"image": "Mechanics/bestiary/beast/token/boar-xphb.webp"
```
^statblock