...
---
# [Ice Spider Queen](Mechanics\bestiary\beast/ice-spider-queen-skt.md)
...
- "desc": "Ranged Weapon Attack: +5 to hit, range 30/60 ft., one creature. Hit:\
    ...
    \ and takes 2 (1d4) cold damage at the start of each of its turns. As an action,\
    \ the [restrained](Mechanics/Rules/conditions.md#Restrained) target can make a\
...
"source":
- "SKT"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/SKT/Ice%20Spider%20Queen.webp"
```
^statblock