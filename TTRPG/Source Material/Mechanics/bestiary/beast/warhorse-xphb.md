...
aliases: ["Warhorse"]
---
# [Warhorse](Mechanics/bestiary/beast/warhorse-xphb.md)
...
- "desc": "Melee Attack: +6, reach 5 ft. Hit: 9 (2d4 + 4) Bludgeoning damage.\
    ...
    \ Huge or smaller, has the [Prone](Mechanics/rules/conditions.md#Prone) condition."
  "name": "Hooves"
"source":
- "XPHB"
"image": "Mechanics/bestiary/beast/token/warhorse-xphb.webp"
```
^statblock