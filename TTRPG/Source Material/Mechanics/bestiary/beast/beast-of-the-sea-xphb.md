...
---
# [Beast of the Sea](Mechanics/bestiary/beast/beast-of-the-sea-xphb.md)
...
- "desc": "Melee Attack: YourSpellAttack Bonus equals your spell attack modifier,\
    ...
    \ damage (your choice when you summon the beast), and the target has the [Grappled](Mechanics/rules/conditions.md#Grappled)\
    \ condition (escape DC equals your spell save DC)."
  "name": "Beast's Strike"
"source":
- "XPHB"
"image": "Mechanics/bestiary/beast/token/beast-of-the-sea-xphb.webp"
```
^statblock