...
- "desc": "Melee Weapon Attack: +11 to hit, reach 5 ft., one target. Hit: 21\
    ...
    \ end of that turn or regurgitate all swallowed creatures, which fall [prone](Mechanics/Rules/conditions.md#Prone)\
...
"source":
- "IDRotF"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/IDRotF/Sperm%20Whale.webp"
```
^statblock