...
- "desc": "While the crab remains motionless with its eyestalks and pincers tucked\
    ...
    \ DC 15 Intelligence ([Nature](Mechanics/Rules/skills.md#Nature)) check."
...
- "desc": "Melee Weapon Attack: +7 to hit, reach 10 ft., one target. Hit: 20\
    \ (3d10 + 4) bludgeoning damage, and the target is [grappled](Mechanics/Rules/conditions.md#Grappled)\
    \ (escape DC 15). The crab has two claws, each of which can grapple only one target"
  "name": "Claw"
"source":
- "SKT"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/SKT/Hulking%20Crab.webp"
```
^statblock