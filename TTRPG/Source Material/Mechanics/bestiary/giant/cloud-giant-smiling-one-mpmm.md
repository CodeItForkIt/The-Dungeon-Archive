...
---
# [Cloud Giant Smiling One](Mechanics\bestiary\giant/cloud-giant-smiling-one-mpmm.md)
...
- "desc": "The giant casts one of the following spells, requiring no material components\
    ...
    \n1/day each: [gaseous form](Mechanics/spells/gaseous-form.md), [major image](Mechanics/spells/major-image.md)\n\
    \n3/day each: [invisibility](Mechanics/spells/invisibility.md), [silent image](Mechanics/spells/silent-image.md),\
    \ [suggestion](Mechanics/spells/suggestion.md), [tongues](Mechanics/spells/tongues.md)"
  "name": "Spellcasting"
- "desc": "The giant can cast the [control weather](Mechanics/spells/control-weather.md)\
