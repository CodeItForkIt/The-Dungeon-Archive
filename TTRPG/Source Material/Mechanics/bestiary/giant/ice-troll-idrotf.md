...
- If buried in the ground under a foot or more of earth, the heart melts away and summons a blizzard like that created by the [control weather](Mechanics/spells/control-weather.md) spell. It takes 10 minutes for the heart to melt and the blizzard to form. The blizzard lasts for 8 hours.  
- A hag or similar creature can perform a ritual that turns the heart into a magical talisman that acts like a patch of brown mold (see "[Brown Mold](Mechanics/traps-hazards/brown-mold.md)" in the "Dungeon Master's Guide"). This effect lasts until the heart is destroyed.  
- A creature proficient with alchemist's supplies can squeeze enough residual fluid out of the heart to mix with other alchemical ingredients, creating one [potion of resistance (cold)](Mechanics/items/potion-of-cold-resistance.md). It takes 1 hour to create this potion.   
...
- "desc": "While it's alive, the troll generates an aura of bitter cold that fills\
  ...
  "name": "Cold Aura"
- "desc": "The ice troll has advantage on Wisdom ([Perception](Mechanics/Rules/skills.md#Perception))\
...
"source":
- "IDRotF"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/IDRotF/Ice%20Troll.webp"
```
^statblock