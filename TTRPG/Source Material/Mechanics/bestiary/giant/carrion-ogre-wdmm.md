...
---
# [Carrion Ogre](Mechanics\bestiary\giant/carrion-ogre-wdmm.md)
...
"cr": "2"
"traits":
- "desc": "While lashed to the floor, the creature is [prone](Mechanics/Rules/conditions.md#Prone)\
    \ and [restrained](Mechanics/Rules/conditions.md#Restrained). It also suffers\
    \ from two levels of [exhaustion](Mechanics/Rules/conditions.md#Exhaustion)."
  "name": "Tied Down"
"actions":
...
"source":
- "WDMM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/WDMM/Carrion%20Ogre.webp"
```
^statblock