...
*Source: Monster Manual p. 156, Storm King's Thunder, Ghosts of Saltmarsh, Mythic Odysseys of Theros, Journeys through the Radiant Citadel, Sigil and the Outlands. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>*  
...
- "desc": "The giant's innate spellcasting ability is Charisma (spell save DC 17).\
    ...
    \nAt will: [detect magic](Mechanics/spells/detect-magic.md), [feather fall](Mechanics/spells/feather-fall.md),\
    \ [levitate](Mechanics/spells/levitate.md), [light](Mechanics/spells/light.md)\n\
...
- "JttRC"
- "SatO"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MM/Storm%20Giant.webp"
```
^statblock
