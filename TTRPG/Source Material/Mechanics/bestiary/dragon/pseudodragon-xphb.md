...
---
# [Pseudodragon](Mechanics/bestiary/dragon/pseudodragon-xphb.md)
...
- "desc": "Constitution Saving Throw: DC 12, one creature the pseudodragon can see\
    \ within 5 feet. Failure: 5 (2d4) Poison damage, and the target has the [Poisoned](Mechanics/rules/conditions.md#Poisoned)\
    \ condition for 1 hour. Failure by 5 or More: The [Poisoned](Mechanics/rules/conditions.md#Poisoned)\
    \ target also has the [Unconscious](Mechanics/rules/conditions.md#Unconscious)\
    \ condition until it takes damage or another creature takes an action to shake\
    \ it awake."
  "name": "Sting"
"source":
- "XPHB"
"image": "Mechanics/bestiary/dragon/token/pseudodragon-xphb.webp"
```
^statblock