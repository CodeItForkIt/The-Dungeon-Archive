...
---
# [Deep Dragon Wyrmling](Mechanics\bestiary\dragon/deep-dragon-wyrmling-ftd.md)
...
| 6 | An orphaned deep dragon wyrmling is cared for by a giant constrictor snake that is the recipient of a druid's [awaken](Mechanics/spells/awaken.md) spell. |
^connected-creatures
...
- "desc": "The dragon exhales a cloud of spores in a 15-foot cone. Each creature in\
    ...
    \ takes 5 (1d10) psychic damage, and it is [frightened](Mechanics/Rules/conditions.md#Frightened)\
...
"source":
- "FTD"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/FTD/Deep%20Dragon%20Wyrmling.webp"
```
^statblock