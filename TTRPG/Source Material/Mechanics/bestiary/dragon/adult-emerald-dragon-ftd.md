...
---
# [Adult Emerald Dragon](Mechanics\bestiary\dragon/adult-emerald-dragon-ftd.md)
...
- "desc": "The dragon casts one of the following spells, requiring no spell components\
    ...
    \ thoughts](Mechanics/spells/detect-thoughts.md), [dispel magic](Mechanics/spells/dispel-magic.md),\
    \ [invisibility](Mechanics/spells/invisibility.md), [major image](Mechanics/spells/major-image.md)"
  "name": "Spellcasting (Psionics)"
- "desc": "If the dragon fails a saving throw, it can choose to succeed instead."
  "name": "Legendary Resistance (3/Day)"
- "desc": "The dragon can cast [hallucinatory terrain](Mechanics/spells/hallucinatory-terrain.md),\
...
- "desc": "- Beguiling Whisper. The dragon telepathically whispers to one creature\
    ...
    \ next turn.  \n- Vanish. The dragon becomes [invisible](Mechanics/Rules/conditions.md#Invisible)\
...
- "desc": "- Crystal Profusion. Natural stone within 6 miles of the lair grows\
    ...
    \ presence. As an action, the dragon can cast the [clairvoyance](Mechanics/spells/clairvoyance.md)\
    ...
    \ into rivers.  \n- Thriving Wildlife. [Giant lizards](Mechanics/bestiary/beast/giant-lizard.md)\
