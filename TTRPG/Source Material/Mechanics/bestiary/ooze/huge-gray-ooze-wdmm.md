...
---
# [Huge Gray Ooze](Mechanics\bestiary\ooze/huge-gray-ooze-wdmm.md)
...
- "desc": "The ooze magically turns [invisible](Mechanics/Rules/conditions.md#Invisible)\
    \ for up to 1 hour until it attacks, it uses its Enlarge, or its [concentration](Mechanics/Rules/conditions.md#Concentration)\
    \ is broken (as if concentrating on a spell)."
  "name": "Invisibility (Recharges after a Short or Long Rest)"
"source":
- "WDMM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/WDMM/Huge%20Gray%20Ooze.webp"
```
^statblock