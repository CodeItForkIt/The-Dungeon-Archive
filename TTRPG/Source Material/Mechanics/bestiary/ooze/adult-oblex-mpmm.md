...
- "desc": "The oblex casts one of the following spells, requiring no spell components\
    ...
    \ each: [charm person](Mechanics/spells/charm-person.md) (as 5th-level spell),\
    \ [detect thoughts](Mechanics/spells/detect-thoughts.md), [hypnotic pattern](Mechanics/spells/hypnotic-pattern.md)"
...
- "desc": "The oblex targets one creature it can see within 5 feet of it. The target\
    ...
    \ increases by one: the d4 becomes a d6, the d6 becomes a d8, and so on\
    \ until the die becomes a d20, at which point the target becomes [unconscious](Mechanics/Rules/conditions.md#Unconscious)\
