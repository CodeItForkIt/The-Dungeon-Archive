...
*Source: Monster Manual p. 201, Ghosts of Saltmarsh, Mythic Odysseys of Theros, Candlekeep Mysteries, The Wild Beyond the Witchlight, Quests from the Infinite Staircase. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>*  

Ruined desert cities and the tombs of forgotten monarchs make perfect lairs for the wicked lamias. These decadent monsters take what has been forgotten and make it the seat of their hedonistic rule, surrounding themselves with sycophants. Lamias rely on [jackalweres](Mechanics/bestiary/humanoid/jackalwere.md) to perform various tasks, sending them across the wastes to capture slaves or steal treasures from caravans, encampments, or villages, concealed by the lamia's magic as they attack.
...
Using its intoxicating touch, a lamia weakens the minds of its enemies, making them more susceptible to its enchantment spells and turning them into its slaves. Those it beguiles with [geas](Mechanics/spells/geas.md) spells are pitted against each other in elaborate contests for the lamia's amusement.

## Vain Predators

Always anxious to gain more wealth and slaves, a lamia uses a pool of water or a mirror in conjunction with a [scrying](Mechanics/spells/scrying.md) spell to view its domain. A lamia uses this power to watch over trade routes and nearby settlements, or to seek out objects and creatures it fancies.
...
- "desc": "The lamia's innate spellcasting ability is Charisma (spell save DC 13).\
    ...
    \nAt will: [disguise self](Mechanics/spells/disguise-self.md) (any humanoid\
    \ form), [major image](Mechanics/spells/major-image.md)\n\n1/day: [geas](Mechanics/spells/geas.md)\n\
    \n3/day each: [charm person](Mechanics/spells/charm-person.md), [mirror image](Mechanics/spells/mirror-image.md),\
...
- "WBtW"
- "QftIS"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MM/Lamia.webp"
```
^statblock
