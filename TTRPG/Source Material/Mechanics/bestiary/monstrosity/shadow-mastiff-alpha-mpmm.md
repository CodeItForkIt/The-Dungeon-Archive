...
---
# [Shadow Mastiff Alpha](Mechanics\bestiary\monstrosity/shadow-mastiff-alpha-mpmm.md)
...
- "desc": "The shadow mastiff howls. Any Beast or Humanoid within 300 feet of it must\
    \ succeed on a DC 11 Wisdom saving throw or be [frightened](Mechanics/Rules/conditions.md#Frightened)\
    \ of it for 1 minute. A [frightened](Mechanics/Rules/conditions.md#Frightened)\
...
"bonus_actions":
- "desc": "While in dim light or darkness, the shadow mastiff becomes [invisible](Mechanics/Rules/conditions.md#Invisible),\
    ...
    \ attacks, is in bright light, or is [incapacitated](Mechanics/Rules/conditions.md#Incapacitated)."
  "name": "Shadow Blend"
"source":
- "MPMM"
