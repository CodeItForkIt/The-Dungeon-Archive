...
- "desc": "Melee Weapon Attack: +7 to hit, reach 10 ft., one target. Hit: 22\
    \ (4d8 + 4) piercing damage, and the target is [grappled](Mechanics/Rules/conditions.md#Grappled)\
...
- "desc": "The hunter emits a pulse of energy that helps it better locate its magical\
    ...
    \ the hunter and gains no benefit from the [invisible](Mechanics/Rules/conditions.md#Invisible)\
