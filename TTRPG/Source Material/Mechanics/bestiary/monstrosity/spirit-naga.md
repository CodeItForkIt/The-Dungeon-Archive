...
*Source: Monster Manual p. 234, Waterdeep: Dungeon of the Mad Mage, Ghosts of Saltmarsh, Explorer's Guide to Wildemount, Mythic Odysseys of Theros, Journeys through the Radiant Citadel, Phandelver and Below: The Shattered Obelisk, Vecna: Eve of Ruin. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>*  
...
- "desc": "The naga is a 10th-level spellcaster. Its spellcasting ability is Intelligence\
    ...
    \ bolt](Mechanics/spells/lightning-bolt.md), [water breathing](Mechanics/spells/water-breathing.md)\n\
...
- "desc": "If it dies, the naga returns to life in 1d6 days and regains all its\
    \ hit points. Only a [wish](Mechanics/spells/wish.md) spell can prevent this trait\
    \ from functioning."
  "name": "Rejuvenation"
"actions":
...
- "PaBTSO"
- "VEoR"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MM/Spirit%20Naga.webp"
```
^statblock
