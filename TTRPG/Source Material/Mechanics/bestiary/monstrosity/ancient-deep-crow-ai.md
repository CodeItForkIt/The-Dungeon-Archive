...
- "desc": "Melee Weapon Attack: +11 to hit, reach 10 ft., one target. Hit: 17\
    \ (2d10 + 6) piercing damage, and the target is [grappled](Mechanics/Rules/conditions.md#Grappled)\
...
- "desc": "The ancient deep crow releases an ear-splitting caw. Each creature within\
  ...
  "name": "Shadow Caw"
"legendary_actions":
- "desc": "The deep crow makes a Wisdom ([Perception](Mechanics/Rules/skills.md#Perception))\
    \ check."
  "name": "Detect"
...
- "desc": "The ancient deep crow beats its wings. Each creature within 10 feet of\
    ...
    \ + 6) bludgeoning damage and be knocked [prone](Mechanics/Rules/conditions.md#Prone).\
