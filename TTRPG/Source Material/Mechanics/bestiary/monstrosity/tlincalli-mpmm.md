...
aliases: ["Tlincalli"]
---
# [Tlincalli](Mechanics\bestiary\monstrosity/tlincalli-mpmm.md)
...
- "desc": "Melee Weapon Attack: +6 to hit, reach 10 ft., one target. Hit: 6\
    \ (1d6 + 3) piercing damage, and the target is [grappled](Mechanics/Rules/conditions.md#Grappled)\
...
- "desc": "Melee Weapon Attack: +6 to hit, reach 5 ft., one creature. Hit: 6\
    ...
    \ succeed on a DC 14 Constitution saving throw or be [poisoned](Mechanics/Rules/conditions.md#Poisoned)\
    \ for 1 minute. If it fails the saving throw by 5 or more, the target is also\
    \ [paralyzed](Mechanics/Rules/conditions.md#Paralyzed) while [poisoned](Mechanics/Rules/conditions.md#Poisoned).\
