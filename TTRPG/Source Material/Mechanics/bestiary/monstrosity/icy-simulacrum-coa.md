...
---
# [Icy Simulacrum](Mechanics\bestiary\monstrosity/icy-simulacrum-coa.md)
...
"cr": "3"
"traits":
- "desc": "The simulacrum can use its action to polymorph into a Small or Medium humanoid\
...
- "desc": "The simulacrum magically reads the surface thoughts of one creature within\
    ...
    \ the target is in range, the simulacrum can continue reading its thoughts, as\
    \ long as the simulacrum's [concentration](Mechanics/Rules/conditions.md#Concentration)\
    \ isn't broken (as if concentrating on a spell). While reading the target's mind,\
    \ the simulacrum has advantage on Wisdom ([Insight](Mechanics/Rules/skills.md#Insight))\
...
"source":
- "CoA"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/CoA/Icy%20Simulacrum.webp"
```
^statblock