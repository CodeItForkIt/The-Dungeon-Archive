...
- "desc": "The thessalkraken ignores difficult terrain, and magical effects can't\
    \ reduce its speed or cause it to be [restrained](Mechanics/Rules/conditions.md#Restrained).\
...
- "desc": "Melee Weapon Attack: +12 to hit, reach 5 ft., one target. Hit: 20\
    ...
    \ Medium or smaller creature [grappled](Mechanics/Rules/conditions.md#Grappled)\
    ...
    \ against attacks and other effects outside the thessalkraken, and it takes 21\
    \ (6d6) acid damage at the start of each of the thessalkraken's turns.\n\nIf\
    \ the thessalkraken takes 35 damage or more on a single turn from a creature inside\
    \ it, it must succeed on a DC 23 Constitution saving throw at the end of that\
    \ turn or regurgitate all swallowed creatures, which fall [prone](Mechanics/Rules/conditions.md#Prone)\
    \ in a space within 10 feet of the thessalkraken. If the thessalkraken dies, a\
    \ swallowed creature is no longer [restrained](Mechanics/Rules/conditions.md#Restrained)\
    \ by it and can escape from the corpse using 10 feet of movement, exiting [prone](Mechanics/Rules/conditions.md#Prone)."
  "name": "Bite"
- "desc": "Melee Weapon Attack: +12 to hit, reach 20 ft., one target. Hit: 17\
  ...
  "name": "Tentacle"
- "desc": "One Medium or smaller object held or creature [grappled](Mechanics/Rules/conditions.md#Grappled)\
    \ by the thessalkraken is thrown up to 40 feet in a random direction and knocked\
    \ [prone](Mechanics/Rules/conditions.md#Prone). If a thrown target strikes a solid\
...
"source":
- "IMR"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/IMR/Thessalkraken.webp"
```
^statblock