...
---
# [Vecna Impersonator](Mechanics\bestiary\monstrosity/vecna-impersonator-tofw.md)
...
- "desc": "Melee Weapon Attack: +6 to hit, reach 5 ft., one target. Hit: 7 (1d6\
  ...
  "name": "Slam"
- "desc": "The impersonator magically reads the surface thoughts of one creature within\
    ...
    \ the target is in range, the impersonator can continue reading its thoughts,\
    \ as long as the impersonator's [concentration](Mechanics/Rules/conditions.md#Concentration)\
    \ isn't broken (as if concentrating on a spell). While reading the target's mind,\
    \ the impersonator has advantage on Wisdom ([Insight](Mechanics/Rules/skills.md#Insight))\
...
"source":
- "ToFW"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/ToFW/Vecna%20Impersonator.webp"
```
^statblock