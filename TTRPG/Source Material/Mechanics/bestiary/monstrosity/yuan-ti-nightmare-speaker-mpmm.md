...
---
# [Yuan-ti Nightmare Speaker](Mechanics\bestiary\monstrosity/yuan-ti-nightmare-speaker-mpmm.md)
...
- "desc": "The yuan-ti casts one of the following spells, requiring no material components\
    ...
    \ [animal friendship](Mechanics/spells/animal-friendship.md) (snakes only), [mage\
    \ hand](Mechanics/spells/mage-hand.md), [message](Mechanics/spells/message.md),\
...
- "desc": "Melee Weapon Attack: +5 to hit, reach 10 ft., one target. Hit: 10\
    ...
    \ the target is [restrained](Mechanics/Rules/conditions.md#Restrained). The yuan-ti\
