...
aliases: ["Strigoi"]
---
# [Strigoi](Mechanics\bestiary\monstrosity/strigoi-vrgr.md)
...
"cr": "4"
"traits":
- "desc": "The strigoi can magically command any [stirge](Mechanics/bestiary/beast/stirge.md)\
...
- "desc": "Melee Weapon Attack: +5 to hit, reach 5 ft., one creature. Hit: 8\
  ...
  "name": "Proboscis"
- "desc": "The strigoi magically summons 1d4 + 2 [stirges](Mechanics/bestiary/beast/stirge.md)\
...
"source":
- "VRGR"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/VRGR/Strigoi.webp"
```
^statblock