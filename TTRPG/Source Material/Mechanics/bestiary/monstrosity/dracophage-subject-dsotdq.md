...
---
# [Dracophage Subject](Mechanics\bestiary\monstrosity/dracophage-subject-dsotdq.md)
...
- "desc": "When the subject is reduced to 0 hit points, it dissolves into acid that\
    ...
    \ or another creature."
  "name": "Death Throes"
- "desc": "When the subject falls and isn't [incapacitated](Mechanics/Rules/conditions.md#Incapacitated),\
...
"source":
- "DSotDQ"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/DSotDQ/Dracophage%20Subject.webp"
```
^statblock