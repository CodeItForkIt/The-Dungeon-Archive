...
- "desc": "The nagpa casts one of the following spells, using Intelligence as the\
    ...
    \ person](Mechanics/spells/dominate-person.md), [etherealness](Mechanics/spells/etherealness.md),\
    \ [feeblemind](Mechanics/spells/feeblemind.md)\n\n2/day each: [fireball](Mechanics/spells/fireball.md),\
    \ [fly](Mechanics/spells/fly.md), [hold person](Mechanics/spells/hold-person.md),\
...
- "desc": "The nagpa targets one creature it can see within 90 feet of it. The target\
    ...
    \ disadvantage. On a failed save, the target is [charmed](Mechanics/Rules/conditions.md#Charmed)\
...
- "desc": "The nagpa forces each creature within 30 feet of it to make a DC 20 Wisdom\
    ...
    \ [paralyzed](Mechanics/Rules/conditions.md#Paralyzed) for 1 minute. A [paralyzed](Mechanics/Rules/conditions.md#Paralyzed)\
