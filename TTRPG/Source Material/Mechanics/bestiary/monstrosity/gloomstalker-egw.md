...
- "desc": "Melee Weapon Attack: +9 to hit, reach 5 ft., one Medium or smaller\
    ...
    \ DC 17). While [grappled](Mechanics/Rules/conditions.md#Grappled) in this way,\
    \ the target is [restrained](Mechanics/Rules/conditions.md#Restrained)."
  "name": "Snatch"
