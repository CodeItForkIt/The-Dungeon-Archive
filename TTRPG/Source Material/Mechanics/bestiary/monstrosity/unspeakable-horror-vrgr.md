...
---
# [Unspeakable Horror](Mechanics\bestiary\monstrosity/unspeakable-horror-vrgr.md)
...
- "desc": "The horror can move through the space of another creature. The first time\
    ...
    \ must succeed on a DC 16 Strength saving throw or be knocked [prone](Mechanics/Rules/conditions.md#Prone)."
...
"source":
- "VRGR"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/VRGR/Unspeakable%20Horror.webp"
```
^statblock