...
- "desc": "The draconian casts one of the following spells, requiring no material\
    ...
    \n1/day each: [enlarge/reduce](Mechanics/spells/enlarge-reduce.md), [invisibility](Mechanics/spells/invisibility.md),\
    \ [stinking cloud](Mechanics/spells/stinking-cloud.md), [web](Mechanics/spells/web.md)"
  "name": "Spellcasting"
...
"source":
- "DSotDQ"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/DSotDQ/Bozak%20Draconian.webp"
```
^statblock