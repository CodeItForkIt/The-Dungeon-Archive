...
---
# [Yuan-ti Mind Whisperer](Mechanics\bestiary\monstrosity/yuan-ti-mind-whisperer-mpmm.md)
...
- "desc": "The yuan-ti casts one of the following spells, requiring no material components\
    ...
    \ [animal friendship](Mechanics/spells/animal-friendship.md) (snakes only), [message](Mechanics/spells/message.md),\
    \ [minor illusion](Mechanics/spells/minor-illusion.md), [prestidigitation](Mechanics/spells/prestidigitation.md)\n\
    \n2/day each: [detect thoughts](Mechanics/spells/detect-thoughts.md), [hypnotic\
    \ pattern](Mechanics/spells/hypnotic-pattern.md)\n\n3/day: [suggestion](Mechanics/spells/suggestion.md)"
