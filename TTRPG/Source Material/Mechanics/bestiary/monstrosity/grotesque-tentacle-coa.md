...
statblock: inline
aliases: ["Grotesque Tentacle"]
---
# [Grotesque Tentacle](Mechanics\bestiary\monstrosity/grotesque-tentacle-coa.md)
...
- "desc": "If it dies, the tentacle returns to life in 1d6 days and regains all\
    \ its hit points. Only a [wish](Mechanics/spells/wish.md) spell can prevent this\
...
"source":
- "CoA"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/CoA/Grotesque%20Tentacle.webp"
```
^statblock