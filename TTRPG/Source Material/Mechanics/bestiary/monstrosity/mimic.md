...
- "desc": "The mimic adheres to anything that touches it. A Huge or smaller creature\
    \ adhered to the mimic is also [grappled](Mechanics/Rules/conditions.md#Grappled)\
...
- "desc": "The mimic has advantage on attack rolls against any creature [grappled](Mechanics/Rules/conditions.md#Grappled)\
    \ by it."
  "name": "Grappler"
"actions":
...
- "VEoR"
- "QftIS"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MM/Mimic.webp"
```
^statblock
