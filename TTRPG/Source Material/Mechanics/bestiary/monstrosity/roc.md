...
- "desc": "Melee Weapon Attack: +13 to hit, reach 5 ft., one target. Hit: 23\
    \ (4d6 + 9) slashing damage, and the target is [grappled](Mechanics/Rules/conditions.md#Grappled)\
...
- "SatO"
- "VEoR"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MM/Roc.webp"
```
^statblock
