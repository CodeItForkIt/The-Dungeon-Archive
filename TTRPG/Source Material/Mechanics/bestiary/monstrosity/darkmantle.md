...
*Source: Monster Manual p. 46, Princes of the Apocalypse, Waterdeep: Dungeon of the Mad Mage, The Wild Beyond the Witchlight, Keys from the Golden Vault. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>*  
...
"cr": "1/2"
"traits":
- "desc": "The darkmantle can't use its blindsight while [deafened](Mechanics/Rules/conditions.md#Deafened)."
  "name": "Echolocation"
...
- "desc": "Melee Weapon Attack: +5 to hit, reach 5 ft., one creature. Hit: 6\
    ...
    \ roll, it attaches by engulfing the target's head, and the target is also [blinded](Mechanics/Rules/conditions.md#Blinded)\
...
- "WBtW"
- "KftGV"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MM/Darkmantle.webp"
```
^statblock
