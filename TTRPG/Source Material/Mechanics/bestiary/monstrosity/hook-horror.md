...
*Source: Monster Manual p. 189, Princes of the Apocalypse, Waterdeep: Dungeon of the Mad Mage, Light of Xaryxis, Keys from the Golden Vault, Phandelver and Below: The Shattered Obelisk, Quests from the Infinite Staircase*  
...
"cr": "3"
"traits":
- "desc": "The hook horror can't use its blindsight while [deafened](Mechanics/Rules/conditions.md#Deafened)."
  "name": "Echolocation"
- "desc": "The hook horror has advantage on Wisdom ([Perception](Mechanics/Rules/skills.md#Perception))\
...
- "PaBTSO"
- "QftIS"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MM/Hook%20Horror.webp"
```
^statblock
