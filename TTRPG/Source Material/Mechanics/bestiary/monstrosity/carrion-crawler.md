...
*Source: Monster Manual p. 37, Tomb of Annihilation, Waterdeep: Dragon Heist, Waterdeep: Dungeon of the Mad Mage, Dragon of Icespire Peak, Baldur's Gate: Descent Into Avernus, Icewind Dale: Rime of the Frostmaiden, Quests from the Infinite Staircase*  
...
"cr": "2"
"traits":
- "desc": "The carrion crawler has advantage on Wisdom ([Perception](Mechanics/Rules/skills.md#Perception))\
...
- "IDRotF"
- "QftIS"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MM/Carrion%20Crawler.webp"
```
^statblock
