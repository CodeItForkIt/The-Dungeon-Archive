...
aliases: ["Choldrith"]
---
# [Choldrith](Mechanics\bestiary\monstrosity/choldrith-mpmm.md)
...
- "desc": "The choldrith casts one of the following spells, using Wisdom as the spellcasting\
    ...
    \ [thaumaturgy](Mechanics/spells/thaumaturgy.md)\n\n1/day each: [bane](Mechanics/spells/bane.md),\
    \ [hold person](Mechanics/spells/hold-person.md)"
  "name": "Spellcasting"
- "desc": "The choldrith has advantage on saving throws against being [charmed](Mechanics/Rules/conditions.md#Charmed),\
...
- "desc": "Ranged Weapon Attack: +5 to hit, range 30/60 ft., one Large or smaller\
    ...
    \ by webbing. As an action, the [restrained](Mechanics/Rules/conditions.md#Restrained)\
