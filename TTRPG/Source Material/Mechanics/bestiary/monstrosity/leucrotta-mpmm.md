...
- "desc": "Any creature other than a leucrotta or gnoll that starts its turn within\
    ...
    \ be [poisoned](Mechanics/Rules/conditions.md#Poisoned) until the start of the\
...
- "desc": "Melee Weapon Attack: +6 to hit, reach 5 ft., one target. Hit: 11\
  ...
  "name": "Hooves"
"bonus_actions":
- "desc": "Immediately after the leucrotta makes a Hooves attack, it takes the [Disengage](Mechanics/Rules/actions.md#Disengage)\
    \ action."
