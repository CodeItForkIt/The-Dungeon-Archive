...
*Source: Monster Manual p. 282, Infernal Machine Rebuild, Mythic Odysseys of Theros, Journeys through the Radiant Citadel, Quests from the Infinite Staircase. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>*  
...
- "desc": "- The flow of time is altered such that every creature in the lair must\
    ...
    \ Constitution saving throw or become  years older or younger (the sphinx's\
    \ choice), but never any younger than 1 year old. A [greater restoration](Mechanics/spells/greater-restoration.md)\
    ...
    \ change. A [wish](Mechanics/spells/wish.md) spell can return the caster and up\
    \ to seven other creatures designated by the caster to their normal time.  \n\
    - The sphinx shifts itself and up to seven other creatures it can see within in\
    \ its lair to another plane of existence. Once outside its lair, the sphinx can't\
    \ use lair actions, but it can return to its lair as a bonus action on its turn,\
    \ taking up to seven creatures with it.  "
  "name": ""
"source":
- "MM"
- "IMR"
...
- "JttRC"
- "QftIS"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MM/Gynosphinx.webp"
```
^statblock
