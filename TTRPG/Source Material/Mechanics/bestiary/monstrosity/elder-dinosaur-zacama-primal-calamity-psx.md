...
```statblock
"name": "Elder Dinosaur (Zacama, Primal Calamity) (PSX)"
"size": "Gargantuan"
"type": "monstrosity"
"subtype": "titan"
"alignment": "Unaligned"
...
- "desc": "The elder dinosaur can use its Frightful Presence. It then makes five attacks:\
    \ three with its bite, one with its stomp, and one with its tail ^[<span class='note'>Note:\
    \ This statblock does not have these actions available.</span>]. It can use its\
...
- "desc": "Melee Weapon Attack: +19 to hit, reach 10 ft., one target. Hit: 36\
    ...
    \ If the elder dinosaur has three targets [restrained](Mechanics/Rules/conditions.md#Restrained)\
...
"source":
- "PSX"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/PSX/Elder%20Dinosaur%20%28Zacama%2C%20Primal%20Calamity%29.webp"
```
^statblock