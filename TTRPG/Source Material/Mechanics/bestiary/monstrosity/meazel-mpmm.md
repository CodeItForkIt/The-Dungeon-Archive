...
- "desc": "Melee Weapon Attack: +5 to hit, reach 5 ft., one target of the meazel's\
    ...
    \ [grappled](Mechanics/Rules/conditions.md#Grappled) (escape DC 13 with disadvantage).\
...
- "desc": "The meazel, any equipment it is wearing or carrying, and any creature it\
    ...
    \ becomes cursed for 1 hour or until the curse is ended by [remove curse](Mechanics/spells/remove-curse.md)\
    \ or [greater restoration](Mechanics/spells/greater-restoration.md). Until this\
...
"bonus_actions":
- "desc": "While in dim light or darkness, the meazel takes the [Hide](Mechanics/Rules/actions.md#Hide)\
    \ action."
  "name": "Shadow Stealth"
"source":
- "MPMM"
