...
aliases: ["Pterafolk"]
---
# [Pterafolk](Mechanics\bestiary\monstrosity/pterafolk-toa.md)
...
- "desc": "If the pterafolk is flying and dives at least 30 feet straight toward a\
    ...
    \ [frightened](Mechanics/Rules/conditions.md#Frightened) until the end of its\
    \ next turn."
  "name": "Terror Dive"
"actions":
...
"source":
- "ToA"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/ToA/Pterafolk.webp"
```
^statblock