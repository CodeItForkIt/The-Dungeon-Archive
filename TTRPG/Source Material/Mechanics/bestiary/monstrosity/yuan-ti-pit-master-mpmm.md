...
---
# [Yuan-ti Pit Master](Mechanics\bestiary\monstrosity/yuan-ti-pit-master-mpmm.md)
...
- "desc": "The yuan-ti casts one of the following spells, requiring no material components\
    ...
    \ [animal friendship](Mechanics/spells/animal-friendship.md) (snakes only), [guidance](Mechanics/spells/guidance.md),\
    \ [mage hand](Mechanics/spells/mage-hand.md), [message](Mechanics/spells/message.md)\n\
    \n2/day each: [hold person](Mechanics/spells/hold-person.md), [invisibility](Mechanics/spells/invisibility.md)\n\
    \n3/day: [suggestion](Mechanics/spells/suggestion.md)"
  "name": "Spellcasting (Yuan-ti Form Only)"
- "desc": "Magical darkness doesn't impede the yuan-ti's [darkvision](Mechanics/Rules/senses.md#Darkvision)."
  "name": "Devil's Sight"
...
- "desc": "The yuan-ti targets up to five creatures that it can see within 60 feet\
    ...
    \ into a magical sleep and be [unconscious](Mechanics/Rules/conditions.md#Unconscious)\
    ...
    \ immune to being [charmed](Mechanics/Rules/conditions.md#Charmed)."
