...
*Source: Monster Manual p. 305, Storm King's Thunder, Explorer's Guide to Wildemount, Icewind Dale: Rime of the Frostmaiden, Light of Xaryxis, Turn of Fortune's Wheel. Available in the Basic Rules (2014)*  
...
- "desc": "If the yeti takes fire damage, it has disadvantage on attack rolls and\
  ...
  "name": "Fear of Fire"
- "desc": "The yeti has advantage on Wisdom ([Perception](Mechanics/Rules/skills.md#Perception))\
    \ checks that rely on smell."
  "name": "Keen Smell"
- "desc": "The yeti has advantage on Dexterity ([Stealth](Mechanics/Rules/skills.md#Stealth))\
...
- "desc": "The yeti targets one creature it can see within 30 feet of it. If the target\
    ...
    \ against this magic or take 10 (3d6) cold damage and then be [paralyzed](Mechanics/Rules/conditions.md#Paralyzed)\
...
- "LoX"
- "ToFW"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MM/Yeti.webp"
```
^statblock
