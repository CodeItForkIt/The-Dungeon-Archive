...
---
# [Harpy Matriarch](Mechanics\bestiary\monstrosity/harpy-matriarch-gos.md)
...
- "desc": "The matriarch sings a magical melody. Every humanoid and giant within 300\
    ...
    \ song ends. The matriarch must take a bonus action on its subsequent turns to\
    \ continue singing. It can stop singing at any time. The song ends if the matriarch\
    \ is [incapacitated](Mechanics/Rules/conditions.md#Incapacitated).\n\nWhile [charmed](Mechanics/Rules/conditions.md#Charmed)\
    \ by the matriarch, a target is [incapacitated](Mechanics/Rules/conditions.md#Incapacitated)\
    \ and ignores the songs of other harpies. If the [charmed](Mechanics/Rules/conditions.md#Charmed)\
    ...
    \ than the matriarch, the target can repeat the saving throw. A [charmed](Mechanics/Rules/conditions.md#Charmed)\
...
- "desc": "The matriarch projects a vision into the minds of creatures within 30 feet\
    ...
    \ throw or drop whatever it is holding and become [paralyzed](Mechanics/Rules/conditions.md#Paralyzed)\
    \ until the end of its next turn."
  "name": "Visage of Desire (1/Day)"
"source":
- "GoS"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/GoS/Harpy%20Matriarch.webp"
```
^statblock