...
aliases: ["Aurumvorax"]
---
# [Aurumvorax](Mechanics\bestiary\monstrosity/aurumvorax-jttrc.md)
...
- "desc": "Melee Weapon Attack: +5 to hit, reach 5 ft., one target. Hit: 5 (1d6\
    ...
    \ [grappled](Mechanics/Rules/conditions.md#Grappled) (escape DC 12). Until this\
    \ grapple ends, the aurumvorax can't use its Claw attack on another target, and\
    \ when it moves, it can drag the [grappled](Mechanics/Rules/conditions.md#Grappled)\
    \ creature with it, without the aurumvorax's speed being halved."
  "name": "Claw"
"source":
- "JttRC"
- "QftIS"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/JttRC/Aurumvorax.webp"
```
^statblock