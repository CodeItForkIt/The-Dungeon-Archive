...
*Source: Monster Manual p. 42, Baldur's Gate: Descent Into Avernus, Eberron: Rising from the Last War, Mythic Odysseys of Theros, The Wild Beyond the Witchlight. Available in the <span title='Systems Reference Document (5.1)'>SRD</span> and the Basic Rules (2014)*  
...
- "desc": "Melee Weapon Attack: +3 to hit, reach 5 ft., one creature. Hit: 3\
    ...
    \ saving throw against being magically [petrified](Mechanics/Rules/conditions.md#Petrified).\
    \ On a failed save, the creature begins to turn to stone and is [restrained](Mechanics/Rules/conditions.md#Restrained).\
...
- "MOT"
- "WBtW"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MM/Cockatrice.webp"
```
^statblock
