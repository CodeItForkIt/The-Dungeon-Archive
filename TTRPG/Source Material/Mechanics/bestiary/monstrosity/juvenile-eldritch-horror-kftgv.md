...
---
# [Juvenile Eldritch Horror](Mechanics\bestiary\monstrosity/juvenile-eldritch-horror-kftgv.md)
...
- "desc": "The eldritch horror casts one of the following spells, requiring no components\
    ...
    \ [project image](Mechanics/spells/project-image.md)\n\n2/day each: [blindness/deafness](Mechanics/spells/blindness-deafness.md),\
...
- "desc": "Melee Weapon Attack: +10 to hit, reach 5 ft., one Large or smaller\
    ...
    \ target is [restrained](Mechanics/Rules/conditions.md#Restrained) until this\
    \ grapple ends."
  "name": "Constrict"
...
- "desc": "The eldritch horror makes one bite attack against a Medium or smaller target\
    ...
    \ against attacks and other effects outside the eldritch horror, and it takes\
    \ 21 (6d6) acid damage at the start of each of the eldritch horror's turns.\
    ...
    \ at the end of that turn or regurgitate the creature, which falls [prone](Mechanics/Rules/conditions.md#Prone)\
...
"source":
- "KftGV"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/KftGV/Juvenile%20Eldritch%20Horror.webp"
```
^statblock