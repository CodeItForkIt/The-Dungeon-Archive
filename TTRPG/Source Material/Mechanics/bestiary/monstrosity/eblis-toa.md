...
aliases: ["Eblis"]
---
# [Eblis](Mechanics\bestiary\monstrosity/eblis-toa.md)
...
- "desc": "The eblis's innate spellcasting ability is Intelligence (spell save DC\
    ...
    \n1/day each: [blur](Mechanics/spells/blur.md), [hypnotic pattern](Mechanics/spells/hypnotic-pattern.md),\
...
"source":
- "ToA"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/ToA/Eblis.webp"
```
^statblock