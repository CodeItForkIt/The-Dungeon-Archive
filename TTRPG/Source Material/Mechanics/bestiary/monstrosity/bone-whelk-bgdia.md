...
aliases: ["Bone Whelk"]
---
# [Bone Whelk](Mechanics\bestiary\monstrosity/bone-whelk-bgdia.md)
...
- "desc": "The bone whelk can cause Medium or smaller objects to adhere to it. A Medium\
    \ or smaller creature that touches the bone whelk is [grappled](Mechanics/Rules/conditions.md#Grappled)\
    \ by it (escape DC 10)."
  "name": "Adhesive"
