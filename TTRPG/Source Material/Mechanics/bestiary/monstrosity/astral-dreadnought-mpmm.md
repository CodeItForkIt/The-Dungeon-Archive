...
- "desc": "The dreadnought's eye creates an area of antimagic, as in the [antimagic\
    ...
    \ function while the eye is closed or while the dreadnought is [blinded](Mechanics/Rules/conditions.md#Blinded)."
  "name": "Antimagic Cone"
...
- "desc": "Anything the dreadnought swallows is transported to a demiplane that can\
    \ be entered by no other means except a [wish](Mechanics/spells/wish.md) spell\
    \ or the dreadnought's Bite and Donjon Visit. A creature can leave the demiplane\
    \ only by using magic that enables planar travel, such as the [plane shift](Mechanics/spells/plane-shift.md)\
...
- "desc": "If the dreadnought scores a critical hit against a creature traveling by\
    \ means of the [astral projection](Mechanics/spells/astral-projection.md) spell,\
...
- "desc": "Melee Weapon Attack: +16 to hit, reach 10 ft., one target. Hit: 36\
    ...
    \ damage reduces it to 0 hit points or it is [incapacitated](Mechanics/Rules/conditions.md#Incapacitated),\
