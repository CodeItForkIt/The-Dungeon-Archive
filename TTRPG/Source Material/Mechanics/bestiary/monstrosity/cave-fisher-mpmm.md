...
aliases: ["Cave Fisher"]
---
# [Cave Fisher](Mechanics\bestiary\monstrosity/cave-fisher-mpmm.md)
...
- "desc": "Melee Weapon Attack: +5 to hit, reach 5 ft., one target. Hit: 10\
  ...
  "name": "Claw"
- "desc": "One Large or smaller creature [grappled](Mechanics/Rules/conditions.md#Grappled)\
...
- "desc": "The cave fisher extends a sticky filament up to 60 feet, and the filament\
    \ adheres to anything that touches it. A creature the filament adheres to is [grappled](Mechanics/Rules/conditions.md#Grappled)\
