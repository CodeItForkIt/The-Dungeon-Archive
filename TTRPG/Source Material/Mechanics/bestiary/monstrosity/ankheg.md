...
- "desc": "Melee Weapon Attack: +5 to hit, reach 5 ft., one target. Hit: 10\
    ...
    \ (escape DC 13). Until this grapple ends, the ankheg can bite only the [grappled](Mechanics/Rules/conditions.md#Grappled)\
...
- "desc": "The ankheg spits acid in a line that is 30 feet long and 5 feet wide, provided\
    \ that it has no creature [grappled](Mechanics/Rules/conditions.md#Grappled).\
...
- "KftGV"
- "QftIS"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MM/Ankheg.webp"
```
^statblock
