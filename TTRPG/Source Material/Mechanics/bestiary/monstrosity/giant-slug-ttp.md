...
- "desc": "The slug's innate spellcasting ability is Wisdom (spell save DC 11, +3\
    ...
    \ no material components:\n\n1/day each: [guiding bolt](Mechanics/spells/guiding-bolt.md),\
    \ [sanctuary](Mechanics/spells/sanctuary.md), [spiritual weapon](Mechanics/spells/spiritual-weapon.md)"
  "name": "Innate Spellcasting"
- "desc": "The slug has advantage on Wisdom ([Perception](Mechanics/Rules/skills.md#Perception))\
...
"source":
- "TTP"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/TTP/Giant%20Slug.webp"
```
^statblock