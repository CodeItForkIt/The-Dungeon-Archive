...
---
# [Xvart Warlock of Raxivort](Mechanics\bestiary\monstrosity/xvart-warlock-of-raxivort-mpmm.md)
...
- "desc": "The xvart casts one of the following spells, requiring no material components\
    ...
    \ [burning hands](Mechanics/spells/burning-hands.md), [invisibility](Mechanics/spells/invisibility.md)"
  "name": "Spellcasting"
- "desc": "When the xvart reduces an enemy to 0 hit points, the xvart gains 4 temporary\
    \ hit points."
  "name": "Raxivort's Blessing"
- "desc": "The xvart can communicate with ordinary [bats](Mechanics/bestiary/beast/bat.md)\
    \ and [rats](Mechanics/bestiary/beast/rat.md), as well as [giant bats](Mechanics/bestiary/beast/giant-bat.md)\
    \ and [giant rats](Mechanics/bestiary/beast/giant-rat.md)."
...
"bonus_actions":
- "desc": "The xvart takes the [Disengage](Mechanics/Rules/actions.md#Disengage) action."
  "name": "Low Cunning"
"source":
- "MPMM"
