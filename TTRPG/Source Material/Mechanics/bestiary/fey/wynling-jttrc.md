...
aliases: ["Wynling"]
---
# [Wynling](Mechanics\bestiary\fey/wynling-jttrc.md)
...
- "desc": "Melee Weapon Attack: +7 to hit, reach 5 ft., one target. Hit: 7 (1d4\
  ...
  "name": "Slam"
- "desc": "The wynling magically turns [invisible](Mechanics/Rules/conditions.md#Invisible),\
...
"source":
- "JttRC"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/JttRC/Wynling.webp"
```
^statblock