...
- "desc": "The sea fury's innate spellcasting ability is Charisma (spell save DC 16,\
    ...
    \ requiring no material components:\n\nAt will: [witch bolt](Mechanics/spells/witch-bolt.md)\n\
    \n1/day each: [bestow curse](Mechanics/spells/bestow-curse.md), [fear](Mechanics/spells/fear.md),\
...
- "desc": "Melee Weapon Attack: +8 to hit, reach 5 ft., one target. Hit: 13\
  ...
  "name": "Claws"
- "desc": "The sea fury targets one [frightened](Mechanics/Rules/conditions.md#Frightened)\
...
- "desc": "The sea fury transforms into a wave of foaming seawater, along with whatever\
    ...
    \ attacks. While in this form, it can't be [grappled](Mechanics/Rules/conditions.md#Grappled)\
    \ or [restrained](Mechanics/Rules/conditions.md#Restrained). It reverts to its\
...
- "desc": "The sea fury conjures an apparition of one of its dead sisters, which appears\
    ...
    \ throw or be [frightened](Mechanics/Rules/conditions.md#Frightened) of it until\
    \ it vanishes at the end of the sea fury's next turn."
  "name": "Fearsome Apparition (Costs 2 Actions)"
- "desc": "The sea fury disgorges a [swarm of poisonous snakes](Mechanics/bestiary/beast/swarm-of-poisonous-snakes.md),\
...
- "desc": "- Caverns, tunnels, and pools of water within 120 feet of the sea fury\
    ...
    \ contact with the rushing [wave](Mechanics/items/wave.md) must succeed on a DC\
    ...
    \ has the statistics of a [specter](Mechanics/bestiary/undead/specter.md) and\
    \ lasts until the sea fury uses another lair action. The specter appears in an\
    \ unoccupied space within 30 feet of the sea fury and obeys the sea fury's commands.\
    \  "
  "name": ""
"regional_effects":
...
- "desc": "- Sea water within 5 miles of the lair becomes coarse and choppy, as if\
    ...
    \ within 5 feet of it.  \n- Ordinary [crabs](Mechanics/bestiary/beast/crab.md)\
    \ and [octopi](Mechanics/bestiary/beast/octopus.md) within 1 mile of the lair\
    \ grow in size to become [giant crabs](Mechanics/bestiary/beast/giant-crab.md)\
    \ and [giant octopi](Mechanics/bestiary/beast/giant-octopus.md), respectively.\
