...
aliases: ["Sprite"]
---
# [Sprite](Mechanics/bestiary/fey/sprite-xphb.md)
*Source: Player's Handbook (2024) p. 358*  
...
"cr": "1/4"
"traits":
- "desc": "The sprite casts [Invisibility](Mechanics/spells/invisibility-xphb.md)\
...
- "desc": "Ranged Attack: +6, range 40/160 ft. Hit: 1 Piercing damage, and the\
    \ target has the [Charmed](Mechanics/rules/conditions.md#Charmed) condition until\
...
"source":
- "XPHB"
"image": "Mechanics/bestiary/fey/token/sprite-xphb.webp"
```
^statblock