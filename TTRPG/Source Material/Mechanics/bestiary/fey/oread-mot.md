...
- "desc": "The oread's spellcasting ability is Charisma (spell save DC 14, +6 to\
    ...
    \ (see \"Actions\" below)\n\n1/day each: [hellish rebuke](Mechanics/spells/hellish-rebuke.md)\
    \ (see \"Reactions\" below), [scorching ray](Mechanics/spells/scorching-ray.md)\n\
    \n3/day: [burning hands](Mechanics/spells/burning-hands.md)"
  "name": "Innate Spellcasting"
- "desc": "The oread is [invisible](Mechanics/Rules/conditions.md#Invisible) while\
