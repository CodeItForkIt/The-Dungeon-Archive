...
aliases: ["Fey Spirit"]
---
# [Fey Spirit](Mechanics/bestiary/fey/fey-spirit-xphb.md)
...
- "desc": "The spirit magically teleports up to 30 feet to an unoccupied space it\
    ...
    \ Failure: The target is [Charmed](Mechanics/rules/conditions.md#Charmed) by\
...
"source":
- "XPHB"
"image": "Mechanics/bestiary/fey/token/fey-spirit-xphb.webp"
```
^statblock