...
aliases: ["Korred"]
---
# [Korred](Mechanics\bestiary\fey/korred-mpmm.md)
...
Korreds prefer to keep their own company but occasionally consort with creatures of elemental earth such as [galeb duhr](Mechanics/bestiary/elemental/galeb-duhr.md). They often gather with other korreds to perform ceremonial dances, beating out rhythms on stone with their hooves and clubs. In the depths of the Material Plane, korreds typically flee from other creatures, but they become aggressive when they feel insulted or are annoyed by the sounds of mining.
...
- "desc": "The korred casts one of the following spells, requiring no spell components\
    ...
    \ [meld into stone](Mechanics/spells/meld-into-stone.md), [stone shape](Mechanics/spells/stone-shape.md)\n\
    \n1/day: [Otto's irresistible dance](Mechanics/spells/ottos-irresistible-dance.md)"
  "name": "Spellcasting"
- "desc": "The korred has advantage on Dexterity ([Stealth](Mechanics/Rules/skills.md#Stealth))\
...
- "desc": "The korred has at least one 50-foot-long rope woven out of its hair. The\
    ...
    \ succeed on a DC 13 Dexterity saving throw or become [grappled](Mechanics/Rules/conditions.md#Grappled)\
    \ by the rope (escape DC 13). Until this grapple ends, the target is [restrained](Mechanics/Rules/conditions.md#Restrained).\
    \ The korred can use a bonus action to release the target, which is also freed\
    \ if the korred dies or becomes [incapacitated](Mechanics/Rules/conditions.md#Incapacitated).\n\
