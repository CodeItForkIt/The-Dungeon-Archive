...
---
# [Sea Hag (Coven)](Mechanics\bestiary\fey/sea-hag-coven.md)
...
- "desc": "Any humanoid that starts its turn within 30 feet of the hag and can see\
    ...
    \ the creature is [frightened](Mechanics/Rules/conditions.md#Frightened) for 1\
    ...
    \ 24 hours.\n\nUnless the target is [surprised](Mechanics/Rules/conditions.md#Surprised)\
...
- "desc": "Melee Weapon Attack: +5 to hit, reach 5 ft., one target. Hit: 10\
  ...
  "name": "Claws"
- "desc": "The hag targets one [frightened](Mechanics/Rules/conditions.md#Frightened)\
...
- "desc": "The hag covers herself and anything she is wearing or carrying with a magical\
    ...
    \ inspect the illusion and succeed on a DC 16 Intelligence ([Investigation](Mechanics/Rules/skills.md#Investigation))\
...
- "desc": "- The hag fills up to four 10-foot cubes of water with ink. The inky areas\
    ...
    \ creates a simulacrum of that creature (as if created with the [simulacrum](Mechanics/spells/simulacrum.md)\
