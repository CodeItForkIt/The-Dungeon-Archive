...
- "desc": "Ranged Weapon Attack: +6 to hit, range 40/160 ft., one target. Hit:\
    ...
    \ If its saving throw result is 5 or lower, the [poisoned](Mechanics/Rules/conditions.md#Poisoned)\
    \ target falls [unconscious](Mechanics/Rules/conditions.md#Unconscious) for the\
...
- "desc": "The sprite touches a creature and magically knows the creature's current\
  ...
  "name": "Heart Sight"
- "desc": "The sprite magically turns [invisible](Mechanics/Rules/conditions.md#Invisible)\
...
- "SatO"
- "QftIS"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MM/Sprite.webp"
```
^statblock
