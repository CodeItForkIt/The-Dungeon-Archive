...
---
# [Hobgoblin Devastator](Mechanics\bestiary\fey/hobgoblin-devastator-mpmm.md)
...
- "desc": "The hobgoblin casts one of the following spells, using Intelligence as\
    ...
    \ [fireball](Mechanics/spells/fireball.md), [fly](Mechanics/spells/fly.md), [fog\
    \ cloud](Mechanics/spells/fog-cloud.md), [gust of wind](Mechanics/spells/gust-of-wind.md),\
...
- "desc": "Ranged Spell Attack: +5 to hit, range 60 ft., one target. Hit: 21\
    \ (4d8 + 3) force damage, and the target is knocked [prone](Mechanics/Rules/conditions.md#Prone)."
