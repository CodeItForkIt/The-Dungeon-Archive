...
aliases: ["Brigganock"]
---
# [Brigganock](Mechanics\bestiary\fey/brigganock-wbtw.md)
...
- "desc": "The brigganock casts one of the following spells, requiring no material\
    ...
    \nAt will: [minor illusion](Mechanics/spells/minor-illusion.md), [spare the\
    \ dying](Mechanics/spells/spare-the-dying.md)\n\n1/day each: [animal friendship](Mechanics/spells/animal-friendship.md),\
    \ [faerie fire](Mechanics/spells/faerie-fire.md), [meld into stone](Mechanics/spells/meld-into-stone.md),\
    \ [silence](Mechanics/spells/silence.md)"
  "name": "Spellcasting"
- "desc": "The brigganock has advantage on saving throws against being [charmed](Mechanics/Rules/conditions.md#Charmed),\
...
"source":
- "WBtW"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/WBtW/Brigganock.webp"
```
^statblock