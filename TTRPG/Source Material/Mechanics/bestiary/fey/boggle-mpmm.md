...
aliases: ["Boggle"]
---
# [Boggle](Mechanics\bestiary\fey/boggle-mpmm.md)
...
- "desc": "The boggle creates a puddle of nonflammable oil. The puddle is 1 inch deep\
    ...
    \ succeed on a DC 11 Dexterity saving throw or fall [prone](Mechanics/Rules/conditions.md#Prone).\
    \  \n- Sticky Oil. Any non-boggle creature that enters the puddle or starts\
    \ its turn there must succeed on a DC 11 Strength saving throw or be [restrained](Mechanics/Rules/conditions.md#Restrained).\
...
- "desc": "The boggle excretes nonflammable oil from its pores, giving itself one\
    ...
    \n- Slippery Oil. The boggle has advantage on Dexterity ([Acrobatics](Mechanics/Rules/skills.md#Acrobatics))\
    ...
    \ boggle has advantage on Strength ([Athletics](Mechanics/Rules/skills.md#Athletics))\
    ...
    \  "
  "name": "Boggle Oil"
- "desc": "The boggle creates an [invisible](Mechanics/Rules/conditions.md#Invisible)\
