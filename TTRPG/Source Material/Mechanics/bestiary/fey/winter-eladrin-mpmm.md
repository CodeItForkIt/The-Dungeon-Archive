...
- "desc": "The eladrin casts one of the following spells, requiring no material components\
    ...
    \ will: [fog cloud](Mechanics/spells/fog-cloud.md), [gust of wind](Mechanics/spells/gust-of-wind.md),\
...
- "desc": "Any non-eladrin creature that starts its turn within 60 feet of the eladrin\
    ...
    \ has disadvantage on ability checks and saving throws. The [charmed](Mechanics/Rules/conditions.md#Charmed)\
    ...
    \ [charmed](Mechanics/Rules/conditions.md#Charmed) creature, the [charmed](Mechanics/Rules/conditions.md#Charmed)\
