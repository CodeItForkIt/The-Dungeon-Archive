...
aliases: ["Annis Hag"]
---
# [Annis Hag](Mechanics\bestiary\fey/annis-hag-mpmm.md)
...
Much as annis hags befriend children in order to corrupt them, they may adopt a group of ogres, trolls, or other creatures ([ogres](Mechanics/bestiary/giant/ogre.md) and [trolls](Mechanics/bestiary/giant/troll.md)), ruling them through brute strength, insults, and superstition.
...
- "desc": "The hag casts one of the following spells, using Charisma as the spellcasting\
    \ ability (spell save DC 13):\n\n3/day each: [disguise self](Mechanics/spells/disguise-self.md)\
    \ (including the form of a Medium Humanoid), [Fog cloud](Mechanics/spells/fog-cloud.md)"
  "name": "Spellcasting"
"actions":
...
- "desc": "Melee Weapon Attack: +8 to hit, reach 5 ft., one target. Hit: 36\
    \ (9d6 + 5) bludgeoning damage, and the target is [grappled](Mechanics/Rules/conditions.md#Grappled)\
