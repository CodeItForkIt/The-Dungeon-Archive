...
aliases: ["Redcap"]
---
# [Redcap](Mechanics\bestiary\fey/redcap-mpmm.md)
...
"cr": "3"
"traits":
- "desc": "The redcap has disadvantage on Dexterity ([Stealth](Mechanics/Rules/skills.md#Stealth))\
    \ checks."
  "name": "Iron Boots"
...
- "desc": "The redcap moves up to its speed to a creature it can see and kicks with\
    ...
    \ take 20 (3d10 + 4) bludgeoning damage and be knocked [prone](Mechanics/Rules/conditions.md#Prone)."
