...
---
# [Deadbark Dryad](Mechanics\bestiary\fey/deadbark-dryad-veor.md)
...
- "desc": "The dryad casts one of the following spells, requiring no material components\
    ...
    \n2/day each: [Pass without Trace](Mechanics/spells/pass-without-trace.md),\
...
- "desc": "Melee Weapon Attack: +8 to hit, reach 30 ft., one target. Hit: The\
    \ target has the [grappled](Mechanics/Rules/conditions.md#Grappled) condition\
    \ (escape DC 16). Until the grapple ends, the target has the [restrained](Mechanics/Rules/conditions.md#Restrained)\
    \ condition, and the dryad can't use the same vine on another target. A creature\
    \ [restrained](Mechanics/Rules/conditions.md#Restrained) in this way takes 13\
    ...
    \ damage). Destroying a vine deals no damage to the dryad, but any creature [grappled](Mechanics/Rules/conditions.md#Grappled)\
    \ by that vine no longer has the [grappled](Mechanics/Rules/conditions.md#Grappled)\
