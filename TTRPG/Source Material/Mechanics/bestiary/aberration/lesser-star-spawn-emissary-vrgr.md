...
---
# [Lesser Star Spawn Emissary](Mechanics\bestiary\aberration/lesser-star-spawn-emissary-vrgr.md)
...
- "desc": "The emissary targets a creature it can see within 30 feet of it and psychically\
    ...
    \ throw or take 36 (8d8) psychic damage and be [stunned](Mechanics/Rules/conditions.md#Stunned)\
    \ until the start of its next turn."
  "name": "Psychic Lash (Costs 3 Actions)"
"source":
- "VRGR"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/VRGR/Lesser%20Star%20Spawn%20Emissary.webp"
```
^statblock