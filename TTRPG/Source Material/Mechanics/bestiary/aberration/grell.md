...
- "desc": "Melee Weapon Attack: +4 to hit, reach 10 ft., one creature. Hit:\
    ...
    \ minute. The [poisoned](Mechanics/Rules/conditions.md#Poisoned) target is [paralyzed](Mechanics/Rules/conditions.md#Paralyzed),\
    \ and it can repeat the saving throw at the end of each of its turns, ending the\
    \ effect on a success.\n\nThe target is also [grappled](Mechanics/Rules/conditions.md#Grappled)\
    \ (escape DC 15). If the target is Medium or smaller, it is also [restrained](Mechanics/Rules/conditions.md#Restrained)\
...
- "VEoR"
- "QftIS"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MM/Grell.webp"
```
^statblock
