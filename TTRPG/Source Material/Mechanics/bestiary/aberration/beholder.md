...
As alien as their creator, the rooms in a beholder's lair reflect the creature's arrogance. It festoons its chambers with trophies from the battles it has won, including [petrified](Mechanics/Rules/conditions.md#Petrified) adventurers standing frozen in their horrified final moments, pieces of other beholders, and magic items wrested from powerful foes. A beholder judges its own worth by its acquisitions, and it never willingly parts with its treasures.
...
- "desc": "The beholder shoots three of the following magical eye rays at random (reroll\
    ...
    \ throw or be [charmed](Mechanics/Rules/conditions.md#Charmed) by the beholder\
    ...
    \ [paralyzed](Mechanics/Rules/conditions.md#Paralyzed) for 1 minute. The target\
    ...
    \ direction. It is [restrained](Mechanics/Rules/conditions.md#Restrained) by the\
    \ ray's telekinetic grip until the start of the beholder's next turn or until\
    \ the beholder is [incapacitated](Mechanics/Rules/conditions.md#Incapacitated).\
...
- "SatO"
- "ToFW"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MM/Beholder.webp"
```
^statblock
