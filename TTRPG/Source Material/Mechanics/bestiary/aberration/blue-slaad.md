...
- "desc": "Melee Weapon Attack: +8 to hit, reach 5 ft., one target. Hit: 12\
    ...
    \ slaad](Mechanics/bestiary/aberration/red-slaad.md) or, if it has the ability\
    \ to cast spells of 3rd level or higher, a [green slaad](Mechanics/bestiary/aberration/green-slaad.md).\
    \ Only a [wish](Mechanics/spells/wish.md) spell can reverse the transformation."
  "name": "Claw"
"source":
- "MM"
- "WDMM"
...
- "SatO"
- "QftIS"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MM/Blue%20Slaad.webp"
```
^statblock