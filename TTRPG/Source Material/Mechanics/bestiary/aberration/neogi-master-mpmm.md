...
---
# [Neogi Master](Mechanics\bestiary\aberration/neogi-master-mpmm.md)
...
- "desc": "The neogi casts one of the following spells, using Charisma as the spellcasting\
    ...
    \ [dimension door](Mechanics/spells/dimension-door.md), [hold person](Mechanics/spells/hold-person.md),\
    \ [hunger of Hadar](Mechanics/spells/hunger-of-hadar.md)"
  "name": "Spellcasting"
- "desc": "Magical darkness doesn't impede the neogi's [darkvision](Mechanics/Rules/senses.md#Darkvision)."
  "name": "Devil's Sight"
