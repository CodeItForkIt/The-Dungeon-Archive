...
---
# [Aberrant Spirit](Mechanics/bestiary/aberration/aberrant-spirit-xphb.md)
...
- "desc": "At the start of each of the spirit's turns, the spirit emits psionic energy\
    \ if it doesn't have the [Incapacitated](Mechanics/rules/conditions.md#Incapacitated)\
...
"source":
- "XPHB"
"image": "Mechanics/bestiary/aberration/token/aberrant-spirit-xphb.webp"
```
^statblock