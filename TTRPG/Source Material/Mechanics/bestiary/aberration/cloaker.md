...
- "desc": "Melee Weapon Attack: +6 to hit, reach 5 ft., one creature. Hit: 10\
    ...
    \ attaches to the target's head, and the target is [blinded](Mechanics/Rules/conditions.md#Blinded)\
...
- "desc": "Each creature within 60 feet of the cloaker that can hear its moan and\
    ...
    \ [frightened](Mechanics/Rules/conditions.md#Frightened) until the end of the\
...
- "VEoR"
- "QftIS"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MM/Cloaker.webp"
```
^statblock
