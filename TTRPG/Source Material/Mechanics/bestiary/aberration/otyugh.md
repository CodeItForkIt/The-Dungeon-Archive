...
- "desc": "Melee Weapon Attack: +6 to hit, reach 5 ft., one target. Hit: 12\
    ...
    \ a DC 15 Constitution saving throw against disease or become [poisoned](Mechanics/Rules/conditions.md#Poisoned)\
...
- "desc": "Melee Weapon Attack: +6 to hit, reach 10 ft., one target. Hit: 7\
    ...
    \ is Medium or smaller, it is [grappled](Mechanics/Rules/conditions.md#Grappled)\
    \ (escape DC 13) and [restrained](Mechanics/Rules/conditions.md#Restrained) until\
    \ the grapple ends. The otyugh has two tentacles, each of which can grapple one\
    \ target."
  "name": "Tentacle"
- "desc": "The otyugh slams creatures [grappled](Mechanics/Rules/conditions.md#Grappled)\
    ...
    \ [stunned](Mechanics/Rules/conditions.md#Stunned) until the end of the otyugh's\
...
- "ToFW"
- "DoDk"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MM/Otyugh.webp"
```
^statblock
