...
aliases: ["Gauth"]
---
# [Gauth](Mechanics\bestiary\aberration/gauth-mpmm.md)
...
A [beholder](Mechanics/bestiary/aberration/beholder.md) usually drives away or kills any gauths that enter its territory, but it might choose to force them to serve it as lieutenants. Gauths are less xenophobic than beholders, so they might form small clusters and work together, though they're just as likely to ignore each other entirely.
...
- "desc": "When a creature that can see the gauth's central eye starts its turn within\
    ...
    \ if the gauth isn't [incapacitated](Mechanics/Rules/conditions.md#Incapacitated)\
    \ and can see the creature. A creature that fails the save is [stunned](Mechanics/Rules/conditions.md#Stunned)\
...
- "desc": "The gauth shoots three of the following magical eye rays at random (roll\
    ...
    \ on a DC 14 Constitution saving throw or be [paralyzed](Mechanics/Rules/conditions.md#Paralyzed)\
    ...
    \ throw or fall asleep and remain [unconscious](Mechanics/Rules/conditions.md#Unconscious)\
