...
---
# [Flying Horror](Mechanics\bestiary\aberration/flying-horror-ggr.md)
...
| 2 | Indomitable Mind. The horror is immune to the [charmed](Mechanics/Rules/conditions.md#Charmed) condition. |
| 3 | Keen Senses. The horror has advantage on Wisdom ([Perception](Mechanics/Rules/skills.md#Perception)) checks that rely on sight, sound, or smell. |
| 4 | Mind Sight. Magical darkness doesn't impede the horror's [darkvision](Mechanics/Rules/senses.md#Darkvision). |
^secondary-features
...
"cr": "3"
"traits":
- "desc": "The horror has advantage on attack rolls against [frightened](Mechanics/Rules/conditions.md#Frightened)\
    \ creatures."
  "name": "Fear Frenzy"
...
- "desc": "The horror screeches. Each creature within 30 feet of it that can hear\
    \ it must succeed on a DC 13 Wisdom saving throw or be [frightened](Mechanics/Rules/conditions.md#Frightened)\
    \ of it for 1 minute. The [frightened](Mechanics/Rules/conditions.md#Frightened)\
