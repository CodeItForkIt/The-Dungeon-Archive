...
- "desc": "Melee Weapon Attack: +9 to hit, reach 10 ft., one target. Hit: 12\
    ...
    \ only by [heal](Mechanics/spells/heal.md) or another disease-curing spell of\
...
- "desc": "The aboleth targets one creature it can see within 30 feet of it. The target\
    \ must succeed on a DC 14 Wisdom saving throw or be magically [charmed](Mechanics/Rules/conditions.md#Charmed)\
    ...
    \ the target can repeat the saving throw. On a success, the effect ends. No more\
    \ than once every 24 hours, the target can also repeat the saving throw when it\
    \ is at least 1 mile away from the aboleth."
  "name": "Enslave (3/Day)"
"legendary_actions":
- "desc": "The aboleth makes a Wisdom ([Perception](Mechanics/Rules/skills.md#Perception))\
    \ check."
  "name": "Detect"
...
- "desc": "When fighting inside its lair, an aboleth can invoke the ambient magic\
  ...
  "name": ""
- "desc": "- The aboleth casts [phantasmal force](Mechanics/spells/phantasmal-force.md)\
    \ (no components required) on any number of creatures it can see within 60 feet\
    \ of it. While maintaining [concentration](Mechanics/Rules/conditions.md#Concentration)\
    ...
    \ up to 20 feet into the water and knocked [prone](Mechanics/Rules/conditions.md#Prone).\
...
- "desc": "- Underground surfaces within 1 mile of the aboleth's lair are slimy and\
    ...
    \ aboleth has seen before or in any location a creature [charmed](Mechanics/Rules/conditions.md#Charmed)\
    \ by the aboleth can currently see. Once created, the image lasts for as long\
    \ as the aboleth maintains [concentration](Mechanics/Rules/conditions.md#Concentration),\
...
- "DoDk"
- "QftIS"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MM/Aboleth.webp"
```
^statblock
