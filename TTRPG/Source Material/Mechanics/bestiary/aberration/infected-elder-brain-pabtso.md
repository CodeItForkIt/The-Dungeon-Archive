...
---
# [Infected Elder Brain](Mechanics\bestiary\aberration/infected-elder-brain-pabtso.md)
...
- "desc": "Melee Weapon Attack: +6 to hit, reach 30 ft., one target. Hit: 15\
    ...
    \ until the grapple ends. The elder brain can have up to four targets [grappled](Mechanics/Rules/conditions.md#Grappled)\
    \ at a time."
  "name": "Tentacle"
...
"bonus_actions":
- "desc": "The elder brain targets one creature with the [incapacitated](Mechanics/Rules/conditions.md#Incapacitated)\
    ...
    \ to its mind once it no longer has the [incapacitated](Mechanics/Rules/conditions.md#Incapacitated)\
...
"source":
- "PaBTSO"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/PaBTSO/Infected%20Elder%20Brain.webp"
```
^statblock