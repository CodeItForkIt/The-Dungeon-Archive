...
- "desc": "Melee Weapon Attack: +15 to hit, reach 15 ft., one creature. Hit:\
    \ 12 (1d8 + 8) psychic damage. If the target is Huge or smaller, it is [grappled](Mechanics/Rules/conditions.md#Grappled)\
    \ (escape DC 18). The dragon can have up to four targets [grappled](Mechanics/Rules/conditions.md#Grappled)\
    \ at a time."
  "name": "Tentacle"
- "desc": "The dragon exhales brine in a 120-foot line that is 15 feet wide. Each\
    ...
    \ but remains [unconscious](Mechanics/Rules/conditions.md#Unconscious) for 6d12\
    \ hours. When the period of unconsciousness ends, the creature transforms into\
    \ a [mind flayer](Mechanics/bestiary/aberration/mind-flayer.md) (see the Monster\
    \ Manual) with all its hit points. Casting a [wish](Mechanics/spells/wish.md)\
    \ spell on the [unconscious](Mechanics/Rules/conditions.md#Unconscious) creature\
...
- "desc": "The dragon makes one Tentacle attack."
  "name": "Tentacle"
- "desc": "The dragon targets a creature it is grappling. The target's [concentration](Mechanics/Rules/conditions.md#Concentration)\
