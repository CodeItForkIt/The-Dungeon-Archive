...
- "desc": "The slaad's innate spellcasting ability is Charisma (spell save DC 15,\
    ...
    \ [detect thoughts](Mechanics/spells/detect-thoughts.md), [invisibility](Mechanics/spells/invisibility.md)\
    \ (self only), [mage hand](Mechanics/spells/mage-hand.md), [major image](Mechanics/spells/major-image.md)\n\
    \n1/day each: [cloudkill](Mechanics/spells/cloudkill.md), [plane shift](Mechanics/spells/plane-shift.md)\n\
    \n2/day each: [fear](Mechanics/spells/fear.md), [fireball](Mechanics/spells/fireball.md),\
    \ [fly](Mechanics/spells/fly.md), [tongues](Mechanics/spells/tongues.md)"
...
- "PSI"
- "VEoR"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MM/Death%20Slaad.webp"
```
^statblock