...
aliases: ["Podling"]
---
# [Podling](Mechanics\bestiary\plant/podling-vrgr.md)
...
- "desc": "The podling is a physical copy of a creature digested by a bodytaker plant.\
    ...
    \ can recognize the discrepancies with a successful DC 20 Wisdom ([Insight](Mechanics/Rules/skills.md#Insight))\
...
"source":
- "VRGR"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/VRGR/Podling.webp"
```
^statblock