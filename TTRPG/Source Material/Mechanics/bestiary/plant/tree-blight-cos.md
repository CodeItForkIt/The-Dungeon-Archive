...
aliases: ["Tree Blight"]
---
# [Tree Blight](Mechanics\bestiary\plant/tree-blight-cos.md)
...
- "desc": "Melee Weapon Attack: +9 to hit, reach 15 ft., one target. Hit: 16\
  ...
  "name": "Branch"
- "desc": "Melee Weapon Attack: +9 to hit, reach 15 ft., one creature not [grappled](Mechanics/Rules/conditions.md#Grappled)\
    \ by the blight. Hit: The target is [grappled](Mechanics/Rules/conditions.md#Grappled)\
  ...
  "name": "Grasping Root"
"bonus_actions":
- "desc": "Melee Weapon Attack: +9 to hit, reach 5 ft., one creature [grappled](Mechanics/Rules/conditions.md#Grappled)\
    \ by the blight. Hit: 19 (3d8 + 6) piercing damage."
  "name": "Bite"
"source":
- "CoS"
- "WBtW"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/CoS/Tree%20Blight.webp"
```
^statblock