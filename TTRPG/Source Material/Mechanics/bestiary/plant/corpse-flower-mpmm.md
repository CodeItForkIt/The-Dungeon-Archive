...
- "desc": "Each creature that starts its turn within 10 feet of the corpse flower\
    ...
    \ creature is a Construct or an Undead. On a failed save, the creature is [poisoned](Mechanics/Rules/conditions.md#Poisoned)\
...
- "desc": "The corpse flower digests one corpse in its body and instantly regains\
  ...
  "name": "Digest"
- "desc": "The corpse flower animates one corpse in its body, turning it into a [zombie](Mechanics/bestiary/undead/zombie.md).\
