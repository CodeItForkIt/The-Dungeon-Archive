...
---
# [Carnivorous Flower](Mechanics\bestiary\plant/carnivorous-flower-rot.md)
...
- "desc": "Melee Weapon Attack: +6 to hit, reach 10 ft., one target. Hit: 7\
    ...
    \ the grapple ends. The plant has two tentacles, each of which can grapple one\
    \ target."
  "name": "Tentacle"
- "desc": "The plant slams creatures [grappled](Mechanics/Rules/conditions.md#Grappled)\
    ...
    \ [stunned](Mechanics/Rules/conditions.md#Stunned) until the end of the plant's\
