...
---
# [Astral Blight](Mechanics\bestiary\plant/astral-blight-lox.md)
...
- "desc": "Melee Weapon Attack: +5 to hit, reach 10 ft., one target. Hit: 6\
    ...
    \ it is [grappled](Mechanics/Rules/conditions.md#Grappled) (escape DC 13). Until\
    \ this grapple ends, the target takes 3 (1d6) cold damage at the start of each\
    \ of its turns. The blight has two vines, each of which can grapple one creature."
  "name": "Heat-Draining Vine"
"source":
- "LoX"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/LoX/Astral%20Blight.webp"
```
^statblock