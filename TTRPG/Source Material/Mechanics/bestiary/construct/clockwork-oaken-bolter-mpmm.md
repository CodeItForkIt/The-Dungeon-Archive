...
---
# [Clockwork Oaken Bolter](Mechanics\bestiary\construct/clockwork-oaken-bolter-mpmm.md)
...
|-----------|-------------|
| 1 | **Camouflaged.** The clockwork gains proficiency in [Stealth](Mechanics/Rules/skills.md#Stealth) if it lacks that proficiency. While motionless, it is indistinguishable from a stopped machine. |
| 2 | **Sensors.** The range of the clockwork's [darkvision](Mechanics/Rules/senses.md#Darkvision) increases by 60 feet, and it gains proficiency in [Perception](Mechanics/Rules/skills.md#Perception) if it lacks that proficiency. |
...
| dice: d8 | Malfunction |
|----------|-------------|
| 1 | **Faulty Sensors.** Roll a `d6` at the start of the clock work's turn. If you roll a 1, the clockwork is [blinded](Mechanics/Rules/conditions.md#Blinded) until the end of its turn. |
...
| 7 | **Overheats.** Roll a `d6` at the start of the clockwork's turn. If you roll a 1, the clockwork is [incapacitated](Mechanics/Rules/conditions.md#Incapacitated) until the end of its turn. |
...
- "desc": "Ranged Weapon Attack: +7 to hit, range 50/200 ft., one target. Hit:\
    \ 9 (1d10 + 4) piercing damage, and the target is [grappled](Mechanics/Rules/conditions.md#Grappled)\
    \ (escape DC 12). While [grappled](Mechanics/Rules/conditions.md#Grappled) in\
...
"bonus_actions":
- "desc": "The clockwork pulls the creature [grappled](Mechanics/Rules/conditions.md#Grappled)\
