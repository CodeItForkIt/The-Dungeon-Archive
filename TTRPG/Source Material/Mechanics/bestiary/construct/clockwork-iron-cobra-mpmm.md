...
---
# [Clockwork Iron Cobra](Mechanics\bestiary\construct/clockwork-iron-cobra-mpmm.md)
...
- "desc": "Melee Weapon Attack: +5 to hit, reach 5 ft., one target. Hit: 6 (1d6\
    ...
    \ is visible within 30 feet, it takes the [Dash](Mechanics/Rules/actions.md#Dash)\
    \ action, moving toward the nearest creature.  \n- 3–4 Paralysis. The target\
    \ is [paralyzed](Mechanics/Rules/conditions.md#Paralyzed) until the end of its\
