...
statblock: inline
aliases: ["Android Medic"]
---
# [Android Medic](Mechanics\bestiary\construct/android-medic-qftis.md)
*Source: Quests from the Infinite Staircase p. 194*  

```statblock
"name": "Android Medic (QftIS)"
"size": "Medium"
"type": "construct"
...
- "desc": "The android casts one of the following spells, requiring no material components\
    ...
    \ Wounds](Mechanics/spells/cure-wounds.md) (as a 3rd-level spell), [Identify](Mechanics/spells/identify.md)"
  "name": "Spellcasting"
...
"source":
- "QftIS"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/QftIS/Android%20Medic.webp"
```
^statblock