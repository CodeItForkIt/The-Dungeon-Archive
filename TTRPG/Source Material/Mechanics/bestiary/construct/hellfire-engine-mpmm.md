...
- "desc": "The hellfire engine moves up to its speed in a straight line. During this\
    ...
    \ path. On a failed save, the creature falls [prone](Mechanics/Rules/conditions.md#Prone)\
    \ and takes 28 (8d6) bludgeoning damage.\n\nIf the hellfire engine remains in\
    \ the [prone](Mechanics/Rules/conditions.md#Prone) creature's space, the creature\
    \ is also [restrained](Mechanics/Rules/conditions.md#Restrained) until it's no\
    \ longer in the same space as the hellfire engine. While [restrained](Mechanics/Rules/conditions.md#Restrained)\
    ...
    \ space of its choice within 5 feet of the hellfire engine and is no longer [restrained](Mechanics/Rules/conditions.md#Restrained)."
...
- "desc": "The hellfire engine uses one of the following options (choose one or roll\
    ...
    \ the creature's soul rises from the River Styx as a [lemure](Mechanics/bestiary/fiend/lemure.md)\
    \ in Avernus in 1d4 hours. If the creature isn't revived before then, only a\
    \ [wish](Mechanics/spells/wish.md) spell or killing the [lemure](Mechanics/bestiary/fiend/lemure.md)\
