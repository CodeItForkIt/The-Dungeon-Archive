...
***Antimagic Susceptibility.*** The table is [incapacitated](Mechanics/Rules/conditions.md#Incapacitated) while in the area of an [antimagic field](Mechanics/spells/antimagic-field.md). If targeted by [dispel magic](Mechanics/spells/dispel-magic.md), the table must succeed on a Constitution saving throw against the caster's spell save DC or fall [unconscious](Mechanics/Rules/conditions.md#Unconscious) for 1 minute.
