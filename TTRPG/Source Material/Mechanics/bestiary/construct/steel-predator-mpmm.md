...
- "desc": "The steel predator casts one of the following spells, requiring no spell\
    ...
    \ [dimension door](Mechanics/spells/dimension-door.md) (self only), [plane shift](Mechanics/spells/plane-shift.md)\
    \ (self only)"
  "name": "Spellcasting"
...
- "desc": "The steel predator emits a roar in a 60-foot cone. Each creature in that\
    ...
    \ takes 33 (6d10) thunder damage, drops everything it's holding, and is [stunned](Mechanics/Rules/conditions.md#Stunned)\
    ...
    \ damage and isn't [stunned](Mechanics/Rules/conditions.md#Stunned)."
