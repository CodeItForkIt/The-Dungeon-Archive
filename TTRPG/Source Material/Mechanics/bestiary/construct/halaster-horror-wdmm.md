...
---
# [Halaster Horror](Mechanics\bestiary\construct/halaster-horror-wdmm.md)
...
- "desc": "The Halaster horror is immune to the [cone of cold](Mechanics/spells/cone-of-cold.md),\
    \ [disintegrate](Mechanics/spells/disintegrate.md), and [fireball](Mechanics/spells/fireball.md)\
    \ spells."
  "name": "Spell Immunity"
"actions":
...
"source":
- "WDMM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/WDMM/Halaster%20Horror.webp"
```
^statblock