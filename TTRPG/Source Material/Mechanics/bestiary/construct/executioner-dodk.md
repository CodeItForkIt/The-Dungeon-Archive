...
- "desc": "If the Executioner is destroyed, it returns with all its hit points in\
    \ 24 hours unless a [disintegrate](Mechanics/spells/disintegrate.md) spell is\
    \ cast on its remains."
  "name": "Rejuvenation"
"actions":
...
"source":
- "DoDk"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/DoDk/Executioner.webp"
```
^statblock