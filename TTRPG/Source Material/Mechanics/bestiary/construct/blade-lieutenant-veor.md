...
---
# [Blade Lieutenant](Mechanics\bestiary\construct/blade-lieutenant-veor.md)
...
- "desc": "Ranged Weapon Attack: +8 to hit, range 30/120 ft., one target. Hit:\
    \ 14 (3d6 + 4) piercing damage, and the target has the [prone](Mechanics/Rules/conditions.md#Prone)\
    \ condition."
...
- "desc": "The lieutenant targets one ally it can see within 30 feet of itself. If\
  ...
  "name": "Command Ally"
- "desc": "The lieutenant ends the [charmed](Mechanics/Rules/conditions.md#Charmed)\
