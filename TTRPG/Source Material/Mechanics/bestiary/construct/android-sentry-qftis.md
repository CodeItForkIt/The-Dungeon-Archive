...
statblock: inline
aliases: ["Android Sentry"]
---
# [Android Sentry](Mechanics\bestiary\construct/android-sentry-qftis.md)
*Source: Quests from the Infinite Staircase p. 194*  

```statblock
"name": "Android Sentry (QftIS)"
"size": "Medium"
"type": "construct"
...
"source":
- "QftIS"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/QftIS/Android%20Sentry.webp"
```
^statblock