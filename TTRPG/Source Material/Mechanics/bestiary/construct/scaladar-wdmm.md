...
aliases: ["Scaladar"]
---
# [Scaladar](Mechanics\bestiary\construct/scaladar-wdmm.md)
...
- "desc": "Melee Weapon Attack: +7 to hit, reach 10 ft., one target. Hit: 10\
    \ (1d12 + 4) bludgeoning damage, and the target is [grappled](Mechanics/Rules/conditions.md#Grappled)\
...
"source":
- "WDMM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/WDMM/Scaladar.webp"
```
^statblock