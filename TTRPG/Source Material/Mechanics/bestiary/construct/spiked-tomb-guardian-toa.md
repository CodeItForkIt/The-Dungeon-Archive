...
---
# [Spiked Tomb Guardian](Mechanics\bestiary\construct/spiked-tomb-guardian-toa.md)
...
- "desc": "Whenever the tomb guardian starts its turn with 40 hit points or fewer,\
    ...
    \ to hear its creator, who must take an action to make a DC 15 Charisma ([Persuasion](Mechanics/Rules/skills.md#Persuasion))\
...
"source":
- "ToA"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/ToA/Spiked%20Tomb%20Guardian.webp"
```
^statblock