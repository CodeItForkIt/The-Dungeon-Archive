...
---
# [Animated Wand](Mechanics\bestiary\construct/animated-wand-wdmm.md)
...
- "desc": "The animated wand can expend 1 of its charges and target a random creature\
    \ with one of its [randomly determined effects](Mechanics/items/wand-of-wonder.md).\
...
"source":
- "WDMM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/WDMM/Animated%20Wand.webp"
```
^statblock