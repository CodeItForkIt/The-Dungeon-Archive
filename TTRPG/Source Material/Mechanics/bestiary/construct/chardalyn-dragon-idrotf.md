...
- "desc": "Any creature with an Intelligence of 4 or more that is within 30 feet of\
    \ the dragon must succeed on a DC 16 Wisdom saving throw or be [charmed](Mechanics/Rules/conditions.md#Charmed)\
    ...
    \ dragon's Malevolent Presence for the next 24 hours. A creature [charmed](Mechanics/Rules/conditions.md#Charmed)\
    ...
    \ target, the [charmed](Mechanics/Rules/conditions.md#Charmed) creature can act\
    \ normally on its turn."
...
"source":
- "IDRotF"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/IDRotF/Chardalyn%20Dragon.webp"
```
^statblock