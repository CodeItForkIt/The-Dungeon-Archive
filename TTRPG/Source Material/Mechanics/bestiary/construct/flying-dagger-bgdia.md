...
---
# [Flying Dagger](Mechanics\bestiary\construct/flying-dagger-bgdia.md)
...
"cr": "1/8"
"traits":
- "desc": "The dagger is [incapacitated](Mechanics/Rules/conditions.md#Incapacitated)\
    \ while in the area of an [antimagic field](Mechanics/spells/antimagic-field.md).\
    \ If targeted by [dispel magic](Mechanics/spells/dispel-magic.md), the dagger\
