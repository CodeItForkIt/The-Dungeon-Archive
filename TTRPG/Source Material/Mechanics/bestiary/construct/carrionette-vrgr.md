...
aliases: ["Carrionette"]
---
# [Carrionette](Mechanics\bestiary\construct/carrionette-vrgr.md)
...
- "desc": "If the carrionette is motionless at the start of combat, it has advantage\
    ...
    \ move or act, that creature must succeed on a DC 15 Wisdom ([Perception](Mechanics/Rules/skills.md#Perception))\
...
- "desc": "The carrionette targets a creature it can see within 15 feet of it that\
    ...
    \ from evil and good](Mechanics/spells/protection-from-evil-and-good.md) spell,\
    ...
    \ the target is [unconscious](Mechanics/Rules/conditions.md#Unconscious) for 1\
    \ hour, after which it gains control of the carrionette's body. While controlling\
...
"source":
- "VRGR"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/VRGR/Carrionette.webp"
```
^statblock