...
aliases: ["Living Doll"]
---
# [Living Doll](Mechanics\bestiary\construct/living-doll-wbtw.md)
...
- "desc": "Melee Weapon Attack: +2 to hit, reach 5 ft., one creature. Hit: The\
    \ target is [grappled](Mechanics/Rules/conditions.md#Grappled) (escape DC 6) and\
    \ takes 11 (2d10) psychic damage at the start of each of its turns until this\
    \ grapple ends. The doll can grapple only one creature at a time."
  "name": "Grabby Hands"
"bonus_actions":
- "desc": "The doll cackles as it targets one or two creatures it can see within 30\
    ...
    \ as it is overcome by a fit of laughter. At the end of each of its turns, the\
...
"source":
- "WBtW"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/WBtW/Living%20Doll.webp"
```
^statblock