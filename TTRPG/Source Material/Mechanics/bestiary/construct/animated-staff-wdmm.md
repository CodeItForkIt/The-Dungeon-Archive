...
---
# [Animated Staff](Mechanics\bestiary\construct/animated-staff-wdmm.md)
...
- "desc": "A creature can grab the staff out of the air with a successful grapple\
    ...
    \ 12 Charisma saving throw or be [charmed](Mechanics/Rules/conditions.md#Charmed)\
    \ by the staff until the staff is no longer in its grasp. While the creature is\
    \ [charmed](Mechanics/Rules/conditions.md#Charmed), the staff can issue commands\
    \ to it, which the creature does its best to obey. The creature can repeat the\
    \ saving throw each time it takes damage, ending the effect on itself on a success.\
    \ A creature that successfully resists the staff's control can't be [charmed](Mechanics/Rules/conditions.md#Charmed)\
    ...
    \ a solid surface, doing so with a successful DC 17 Strength ([Athletics](Mechanics/Rules/skills.md#Athletics))\
...
- "desc": "The staff has 10 charges. It can expend 1 or more of its charges to cast\
    \ one of the following spells (save DC 12): [cone of cold](Mechanics/spells/cone-of-cold.md)\
...
"source":
- "WDMM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/WDMM/Animated%20Staff.webp"
```
^statblock