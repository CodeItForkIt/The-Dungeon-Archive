...
---
# [Alyxian the Hunter](Mechanics\bestiary\construct/alyxian-the-hunter-crcotn.md)
...
- "desc": "The golem can conjure a magic dart made of ruidium and hurl it at another\
    ...
    \ 1 level of [exhaustion](Mechanics/Rules/conditions.md#Exhaustion). In addition,\
    \ if the target is not already suffering from ruidium corruption, it becomes corrupted\
...
"source":
- "CRCotN"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/CRCotN/Alyxian%20the%20Hunter.webp"
```
^statblock