...
- "desc": "Melee Weapon Attack: +3 to hit, reach 5 ft., one target. Hit: 6 (2d4\
    ...
    \ 11 Wisdom saving throw or be [frightened](Mechanics/Rules/conditions.md#Frightened)\
...
- "desc": "The scarecrow targets one creature it can see within 30 feet of it. If\
    ...
    \ saving throw or be magically [frightened](Mechanics/Rules/conditions.md#Frightened)\
    \ until the end of the scarecrow's next turn. The [frightened](Mechanics/Rules/conditions.md#Frightened)\
    \ target is [paralyzed](Mechanics/Rules/conditions.md#Paralyzed)."
...
- "CM"
- "KftGV"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MM/Scarecrow.webp"
```
^statblock
