...
---
# [Sapphire Sentinel](Mechanics\bestiary\construct/sapphire-sentinel-cm.md)
...
- "desc": "The sapphire has 3 charges. As an action, the golem can expend 1 charge\
    \ to cast [dispel magic](Mechanics/spells/dispel-magic.md) (as a 9th-level spell)\
...
"source":
- "CM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/CM/Sapphire%20Sentinel.webp"
```
^statblock