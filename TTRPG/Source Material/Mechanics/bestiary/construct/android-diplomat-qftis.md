...
statblock: inline
aliases: ["Android Diplomat"]
---
# [Android Diplomat](Mechanics\bestiary\construct/android-diplomat-qftis.md)
*Source: Quests from the Infinite Staircase p. 194*  

```statblock
"name": "Android Diplomat (QftIS)"
"size": "Medium"
"type": "construct"
...
- "desc": "The android casts one of the following spells, requiring no material components\
    \ and using Intelligence as the spellcasting ability:\n\n2/day each: [Identify](Mechanics/spells/identify.md),\
...
"source":
- "QftIS"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/QftIS/Android%20Diplomat.webp"
```
^statblock