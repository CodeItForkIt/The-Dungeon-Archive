...
- "desc": "Melee Weapon Attack: +13 to hit (with advantage if the colossus is\
    ...
    \ the colossus, it has the [grappled](Mechanics/Rules/conditions.md#Grappled)\
    \ condition (escape DC 17), and it has the [restrained](Mechanics/Rules/conditions.md#Restrained)\
    \ condition until this grapple ends. The colossus can have up to two creatures\
    \ [grappled](Mechanics/Rules/conditions.md#Grappled) this way at a time."
  "name": "Fist"
...
- "desc": "Melee Weapon Attack: +13 to hit, reach 5 ft., one Large or smaller\
    \ creature [grappled](Mechanics/Rules/conditions.md#Grappled) by the colossus.\
    \ Hit: 20 (3d8 + 7) bludgeoning damage, and the creature is swallowed. A swallowed\
    \ creature has the [restrained](Mechanics/Rules/conditions.md#Restrained) condition,\
    ...
    \ colossus and has the [prone](Mechanics/Rules/conditions.md#Prone) condition,\
    \ and the colossus can no longer swallow a creature. If the colossus dies, any\
    \ swallowed creature no longer has the [restrained](Mechanics/Rules/conditions.md#Restrained)\
