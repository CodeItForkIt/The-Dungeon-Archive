...
- **Simulacrum.** Fraz-Urb'luu chooses one Humanoid within the lair and instantly creates a simulacrum of that creature (as if created with the [simulacrum](Mechanics/spells/simulacrum.md) spell). This simulacrum obeys Fraz-Urb'luu's commands and is destroyed on the next initiative count 20.  
...
- **Beguiling Realm.** Within 6 miles of the lair, all Charisma ([Persuasion](Mechanics/Rules/skills.md#Persuasion)) and Wisdom ([Insight](Mechanics/Rules/skills.md#Insight)) checks have disadvantage, and all Charisma ([Deception](Mechanics/Rules/skills.md#Deception)) and Charisma ([Performance](Mechanics/Rules/skills.md#Performance)) checks have advantage.  
