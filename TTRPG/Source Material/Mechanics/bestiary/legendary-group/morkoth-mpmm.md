...
- **Cast a Spell.** The morkoth casts [darkness](Mechanics/spells/darkness.md), [dispel magic](Mechanics/spells/dispel-magic.md), or [misty step](Mechanics/spells/misty-step.md), using Intelligence as its spellcasting ability and without expending a spell slot.  
