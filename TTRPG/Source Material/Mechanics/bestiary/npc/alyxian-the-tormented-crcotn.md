...
---
# [Alyxian the Tormented](Mechanics\bestiary\npc/alyxian-the-tormented-crcotn.md)
...
- "desc": "Melee Weapon Attack: +9 to hit, reach 5 ft., one target. Hit: 15\
    ...
    \ it is [grappled](Mechanics/Rules/conditions.md#Grappled) (escape DC 15). Alyxian\
    \ has six hands, each of which can grapple one target."
  "name": "Grasping Hand"
...
"source":
- "CRCotN"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/CRCotN/Alyxian%20the%20Tormented.webp"
```
^statblock