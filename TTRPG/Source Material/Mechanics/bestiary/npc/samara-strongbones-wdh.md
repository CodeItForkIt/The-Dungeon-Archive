...
---
# [Samara Strongbones](Mechanics\bestiary\npc/samara-strongbones-wdh.md)
...
- "desc": "Samara deals an extra 7 (2d6) damage when it hits a target with a weapon\
    ...
    \ feet of an ally of Samara that isn't [incapacitated](Mechanics/Rules/conditions.md#Incapacitated)\
...
"source":
- "WDH"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/WDH/Samara%20Strongbones.webp"
```
^statblock