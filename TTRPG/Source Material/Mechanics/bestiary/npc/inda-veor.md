...
- "desc": "Inda's spellcasting ability is Charisma (spell save DC 17). Inda can innately\
    ...
    \ each: [commune](Mechanics/spells/commune.md), [raise dead](Mechanics/spells/raise-dead.md)"
...
"source":
- "VEoR"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/VEoR/Inda.webp"
```
^statblock