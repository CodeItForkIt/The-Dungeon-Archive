...
- "desc": "Vaeve is a 10th-level spellcaster. Its spellcasting ability is Intelligence\
  ...
  "name": "Spellcasting"
- "desc": "Vaeve has advantage on saving throws against being [charmed](Mechanics/Rules/conditions.md#Charmed),\
...
- "desc": "Melee Weapon Attack: +2 to hit, reach 5 ft., one target. Hit: 2 (1d6\
  ...
  "name": "Staff"
- "desc": "Vaeve magically summons a [quasit](Mechanics/bestiary/fiend/quasit.md),\
...
"source":
- "VEoR"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/VEoR/Vaeve.webp"
```
^statblock