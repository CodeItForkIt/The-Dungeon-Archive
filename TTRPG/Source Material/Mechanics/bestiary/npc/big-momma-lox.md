...
- "desc": "Melee Weapon Attack: +10 to hit, reach 10 ft., one target. Hit: 45\
    ...
    \ feet of Big Momma. If Big Momma dies, a swallowed creature is no longer [restrained](Mechanics/Rules/conditions.md#Restrained)\
...
"bonus_actions":
- "desc": "Big Momma's eye emits an [invisible](Mechanics/Rules/conditions.md#Invisible),\
    \ magical ray that targets one creature Big Momma can see within 60 feet of itself.\
    \ The target must succeed on a DC 16 Wisdom saving throw or be [frightened](Mechanics/Rules/conditions.md#Frightened)\
    \ of Big Momma until the start of Big Momma's next turn."
  "name": "Ray of Fear (Recharge 4-6)"
"source":
- "LoX"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/LoX/Big%20Momma.webp"
```
^statblock