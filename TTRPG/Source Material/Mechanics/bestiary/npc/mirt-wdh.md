...
"cr": "9"
"traits":
- "desc": "Mirt wears [bracers of defense](Mechanics/items/bracers-of-defense.md)\
    \ and a [ring of regeneration](Mechanics/items/ring-of-regeneration.md). He wields\
    \ a [+1 longsword](Mechanics/items/1-weapon.md) and a [+1 dagger](Mechanics/items/1-weapon.md)."
...
- "desc": "Mirt deals an extra 14 (4d6) damage when he hits a target with a weapon\
    ...
    \ feet of an ally of Mirt's that isn't [incapacitated](Mechanics/Rules/conditions.md#Incapacitated)\
...
"source":
- "WDH"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/WDH/Mirt.webp"
```
^statblock