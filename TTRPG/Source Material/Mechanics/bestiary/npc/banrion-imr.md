...
- "desc": "Banrion's innate spellcasting ability is Charisma (spell save DC 14). Banrion\
    ...
    \ [detect evil and good](Mechanics/spells/detect-evil-and-good.md), [druidcraft](Mechanics/spells/druidcraft.md),\
    \ [pass without trace](Mechanics/spells/pass-without-trace.md)\n\n1/day each:\
    \ [calm emotions](Mechanics/spells/calm-emotions.md), [dispel evil and good](Mechanics/spells/dispel-evil-and-good.md),\
...
"source":
- "IMR"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/IMR/Banrion.webp"
```
^statblock