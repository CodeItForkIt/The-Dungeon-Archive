...
- "desc": "Shemshime targets one creature it can see within 30 feet of it. The creature\
    ...
    \ 3) psychic damage and is [stunned](Mechanics/Rules/conditions.md#Stunned) until\
...
"source":
- "CM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/CM/Shemshime.webp"
```
^statblock