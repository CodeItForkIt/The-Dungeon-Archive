...
"cr": "1/4"
"traits":
- "desc": "Myla can cast [detect magic](Mechanics/spells/detect-magic.md), requiring\
...
- "desc": "Myla has advantage on an attack roll against a creature if at least one\
    \ of its allies is within 5 feet of the creature and the ally isn't [incapacitated](Mechanics/Rules/conditions.md#Incapacitated)."
  "name": "Pack Tactics"
...
"source":
- "DoSI"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/DoSI/Myla.webp"
```
^statblock