...
---
# [Ludmilla Vilisevic](Mechanics\bestiary\npc/ludmilla-vilisevic-cos.md)
...
- "desc": "Ludmilla has the following flaws:\n\nForbiddance. Ludmilla can't enter\
    ...
    \ is driven into its heart while it is [incapacitated](Mechanics/Rules/conditions.md#Incapacitated)\
...
- "desc": "Melee Weapon Attack: +6 to hit, reach 5 ft., one willing creature,\
    ...
    \ Ludmilla, [incapacitated](Mechanics/Rules/conditions.md#Incapacitated), or [restrained](Mechanics/Rules/conditions.md#Restrained).\
...
"source":
- "CoS"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/CoS/Ludmilla%20Vilisevic.webp"
```
^statblock