...
---
# [Anastrasya Karelova](Mechanics\bestiary\npc/anastrasya-karelova-cos.md)
...
- "desc": "Anastrasya has the following flaws:\n\nForbiddance. Anastrasya can't\
    ...
    \ weapon made of wood is driven into its heart while it is [incapacitated](Mechanics/Rules/conditions.md#Incapacitated)\
...
- "desc": "Melee Weapon Attack: +6 to hit, reach 5 ft., one willing creature,\
    ...
    \ Anastrasya, [incapacitated](Mechanics/Rules/conditions.md#Incapacitated), or\
    ...
    \ is reduced by an amount equal to the necrotic damage taken, and Anastrasya regains\
...
"source":
- "CoS"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/CoS/Anastrasya%20Karelova.webp"
```
^statblock