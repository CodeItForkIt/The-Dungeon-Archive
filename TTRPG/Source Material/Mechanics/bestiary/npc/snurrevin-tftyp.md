...
- **Armor Class** 16 ([scale mail](Mechanics/items/scale-mail.md), [shield](Mechanics/items/shield.md))
...
***Duergar Resilience.*** The duergar has advantage on saving throws against poison, spells, and illusions, as well as to resist being [charmed](Mechanics/Rules/conditions.md#Charmed) or [paralyzed](Mechanics/Rules/conditions.md#Paralyzed).

***Sunlight Sensitivity.*** While in sunlight, the duergar has disadvantage on attack rolls, as well as on Wisdom ([Perception](Mechanics/Rules/skills.md#Perception)) checks that rely on sight.
