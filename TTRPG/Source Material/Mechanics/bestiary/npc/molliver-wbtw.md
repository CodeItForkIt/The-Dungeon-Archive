...
"ac": !!int "15"
"ac_class": "[+1 leather armor](Mechanics/items/1-armor.md)"
"hp": !!int "60"
"hit_dice": "8d8 + 24"
"stats":
- !!int "9"
...
- "desc": "When subjected to an effect that allows a Dexterity saving throw to take\
    ...
    \ on a failed one, provided Molliver is not [incapacitated](Mechanics/Rules/conditions.md#Incapacitated)."
  "name": "Evasion"
- "desc": "Molliver wears +1 leather armor and [boots of levitation](Mechanics/items/boots-of-levitation.md)."
...
- "desc": "Melee Weapon Attack: +5 to hit, reach 5 ft., one creature. Hit: 6\
  ...
  "name": "Shortsword"
- "desc": "While wearing boots of levitation, Molliver casts [levitate](Mechanics/spells/levitate.md)\
    \ (self only)."
  "name": "Levitate"
"reactions":
...
"source":
- "WBtW"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/WBtW/Molliver.webp"
```
^statblock