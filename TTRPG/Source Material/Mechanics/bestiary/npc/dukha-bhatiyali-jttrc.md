...
---
# [Dukha Bhatiyali](Mechanics\bestiary\npc/dukha-bhatiyali-jttrc.md)
...
- "desc": "Dukha can use its action to polymorph into a tiger-humanoid hybrid or into\
  ...
  "name": "Shapechanger"
- "desc": "Dukha has advantage on Wisdom ([Perception](Mechanics/Rules/skills.md#Perception))\
...
- "desc": "If Dukha moves at least 15 feet straight toward a creature and then hits\
    ...
    \ If the target is [prone](Mechanics/Rules/conditions.md#Prone), Dukha can make\
...
"source":
- "JttRC"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/JttRC/Dukha%20Bhatiyali.webp"
```
^statblock