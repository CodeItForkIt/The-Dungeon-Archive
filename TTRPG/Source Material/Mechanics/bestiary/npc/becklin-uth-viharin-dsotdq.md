...
---
# [Becklin Uth Viharin](Mechanics\bestiary\npc/becklin-uth-viharin-dsotdq.md)
...
"cr": "3"
"traits":
- "desc": "Becklin has advantage on saving throws against being [frightened](Mechanics/Rules/conditions.md#Frightened)."
  "name": "Brave"
"actions":
...
- "desc": "For 1 minute, Becklin can utter a special command or warning whenever a\
    ...
    \ at a time. This effect ends if Becklin is [incapacitated](Mechanics/Rules/conditions.md#Incapacitated)."
...
"source":
- "DSotDQ"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/DSotDQ/Becklin%20Uth%20Viharin.webp"
```
^statblock