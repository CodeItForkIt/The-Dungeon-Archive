...
"cr": "1"
"traits":
- "desc": "Shalfey casts one of the following spells, using Intelligence as the spellcasting\
  ...
  "name": "Spellcasting"
"actions":
- "desc": "Shalfey makes two Arcane Burst attacks and can use Starry Radiance if available."
  "name": "Multiattack"
- "desc": "Melee or Ranged Spell Attack: +5 to hit, reach 5 ft. or range 120 ft.,\
    \ one target. Hit: 8 (1d10 + 3) radiant damage."
  "name": "Arcane Burst"
- "desc": "Dazzling light bursts from Shalfey's fingertips in a 15-foot cone. Each\
    ...
    \ of Shalfey's next turn."
  "name": "Starry Radiance (Recharge 5-6)"
"source":
- "QftIS"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/QftIS/Shalfey.webp"
```
^statblock