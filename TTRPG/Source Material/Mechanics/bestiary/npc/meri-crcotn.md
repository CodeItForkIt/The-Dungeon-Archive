...
- "desc": "One humanoid that Meri can see within 5 feet of it must succeed on a DC\
    ...
    \ loses control of its body. Meri now controls the body but doesn't deprive the\
    \ target of awareness. Meri can't be targeted by any attack, spell, or other effect,\
    ...
    \ to 0 hit points, Meri ends it as a bonus action, or Meri is turned or forced\
...
"source":
- "CRCotN"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/CRCotN/Meri.webp"
```
^statblock