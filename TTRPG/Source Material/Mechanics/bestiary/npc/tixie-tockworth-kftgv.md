...
---
# [Tixie Tockworth](Mechanics\bestiary\npc/tixie-tockworth-kftgv.md)
...
- "desc": "Tockworth casts one of the following spells, requiring no material components\
    ...
    \ will: [nondetection](Mechanics/spells/nondetection.md) (self only)\n\n1/day\
    \ each: [blindness/deafness](Mechanics/spells/blindness-deafness.md), [blur](Mechanics/spells/blur.md)\n\
    \n2/day: [dimension door](Mechanics/spells/dimension-door.md)"
  "name": "Spellcasting"
- "desc": "Tockworth generates a magical force field around herself. This force field\
    ...
    \ [grappled](Mechanics/Rules/conditions.md#Grappled), [restrained](Mechanics/Rules/conditions.md#Restrained),\
    \ and [stunned](Mechanics/Rules/conditions.md#Stunned)."
  "name": "Force Field"
"actions":
...
"source":
- "KftGV"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/KftGV/Tixie%20Tockworth.webp"
```
^statblock