...
---
# [Burney the Barber](Mechanics\bestiary\npc/burney-the-barber-bgdia.md)
...
- "desc": "Burney has the benefits of the [healer](Mechanics/feats/healer.md) feat\
    \ as well as proficiency with both the [healer's kit](Mechanics/items/healers-kit.md)\
    \ and the [herbalism kit](Mechanics/items/herbalism-kit.md)."
  "name": "Healer"
- "desc": "Burney has received several blessings in her service to Bahamut:\n\n- Unless\
    ...
    \ her specifically.  \n- Burney is under the effect of a permanent [mind blank](Mechanics/spells/mind-blank.md)\
    ...
    \ and can transport herself there as though by a [word of recall](Mechanics/spells/word-of-recall.md)\
    ...
    \ to the court of Bahamut via a powerful blessing akin to the [plane shift](Mechanics/spells/plane-shift.md)\
    \ spell.  "
...
- "desc": "Each creature of Burney's choice that is within 120 feet of Burney and\
    \ aware of it must succeed on a DC 19 Wisdom saving throw or become [frightened](Mechanics/Rules/conditions.md#Frightened)\
...
- "desc": "Burney magically polymorphs into a humanoid or beast that has a challenge\
  ...
  "name": "Change Shape"
"legendary_actions":
- "desc": "Burney makes a Wisdom ([Perception](Mechanics/Rules/skills.md#Perception))\
    \ check."
  "name": "Detect"
...
- "desc": "Burney beats its wings. Each creature within 15 feet of Burney must succeed\
    ...
    \ and be knocked [prone](Mechanics/Rules/conditions.md#Prone). Burney can then\
