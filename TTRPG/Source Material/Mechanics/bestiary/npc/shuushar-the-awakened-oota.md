...
---
# [Shuushar the Awakened](Mechanics\bestiary\npc/shuushar-the-awakened-oota.md)
...
- "desc": "Shuushar can sense the presence of any creature within 30 feet of it that\
    \ is [invisible](Mechanics/Rules/conditions.md#Invisible) or on the Ethereal Plane.\
...
- "desc": "When a creature misses Shuushar with a melee weapon attack, Shuushar uses\
    ...
    \ the weapon's wielder can't or won't let go of the weapon, the wielder is [grappled](Mechanics/Rules/conditions.md#Grappled)\
...
"source":
- "OotA"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/OotA/Shuushar%20the%20Awakened.webp"
```
^statblock