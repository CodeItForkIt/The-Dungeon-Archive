...
- "desc": "When a creature misses Ougalop with a melee weapon attack, Ougalop uses\
    ...
    \ weapon's wielder can't or won't let go of the weapon, the wielder is [grappled](Mechanics/Rules/conditions.md#Grappled)\
...
"source":
- "OotA"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/OotA/Ougalop.webp"
```
^statblock