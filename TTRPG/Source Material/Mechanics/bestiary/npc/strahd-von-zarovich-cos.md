...
---
# [Strahd von Zarovich](Mechanics\bestiary\npc/strahd-von-zarovich-cos.md)
...
| 13–15 | `1d4 + 1` [vampire spawn](Mechanics/bestiary/undead/vampire-spawn.md) |
...
- "desc": "Strahd has the following flaws:\n\nForbiddance. He can't enter a residence\
    ...
    \ is [incapacitated](Mechanics/Rules/conditions.md#Incapacitated) in his coffin,\
    \ he is [paralyzed](Mechanics/Rules/conditions.md#Paralyzed) until the stake is\
    \ removed.\n\nSunlight Hypersensitivity. While in sunlight, Strahd takes 20\
    \ radiant damage at the start of his turn, and he has disadvantage on attack rolls\
    \ and ability checks."
...
- "desc": "Melee Weapon Attack: +9 to hit, reach 5 ft., one willing creature,\
    ...
    \ Strahd, [incapacitated](Mechanics/Rules/conditions.md#Incapacitated), or [restrained](Mechanics/Rules/conditions.md#Restrained).\
...
- "desc": "Strahd targets one humanoid he can see within 30 feet of him. If the target\
  ...
  "name": "Charm"
- "desc": "Strahd magically calls 2d4 [swarms of bats](Mechanics/bestiary/beast/swarm-of-bats.md)\
    \ or [swarms of rats](Mechanics/bestiary/beast/swarm-of-rats.md), provided that\
    \ the sun isn't up. While outdoors, Strahd can call 3d6 [wolves](Mechanics/bestiary/beast/wolf.md)\
...
- "desc": "While Strahd is in Castle Ravenloft, he can take lair actions as long as\
    \ he isn't [incapacitated](Mechanics/Rules/conditions.md#Incapacitated)."
  "name": ""
...
- "desc": "- Until initiative count 20 of the next round, Strahd can pass through\
    ...
    \ and then disappears. The apparition has the statistics of a [specter](Mechanics/bestiary/undead/specter.md).\
    ...
    \ becomes a [shadow](Mechanics/bestiary/undead/shadow.md) that obeys Strahd's\
    \ commands, acting on initiative count 20. A [greater restoration](Mechanics/spells/greater-restoration.md)\
    \ spell or a [remove curse](Mechanics/spells/remove-curse.md) spell cast on the\
    \ target restores its natural shadow, but only if its undead shadow has been destroyed.\
    \  "
  "name": ""
"source":
- "CoS"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/CoS/Strahd%20von%20Zarovich.webp"
```
^statblock