...
---
# [Emil Toranescu](Mechanics\bestiary\npc/emil-toranescu-cos.md)
...
- "desc": "Emil can use its action to polymorph into a wolf-humanoid hybrid or into\
  ...
  "name": "Shapechanger"
- "desc": "Emil has advantage on Wisdom ([Perception](Mechanics/Rules/skills.md#Perception))\
...
"source":
- "CoS"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/CoS/Emil%20Toranescu.webp"
```
^statblock