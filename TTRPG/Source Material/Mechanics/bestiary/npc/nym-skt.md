...
- "desc": "Nym's innate spellcasting ability is Charisma (spell save DC 17). It can\
    ...
    \ will: [detect magic](Mechanics/spells/detect-magic.md), [feather fall](Mechanics/spells/feather-fall.md),\
...
"source":
- "SKT"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/SKT/Nym.webp"
```
^statblock