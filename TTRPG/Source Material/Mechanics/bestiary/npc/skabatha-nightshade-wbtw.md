...
---
# [Skabatha Nightshade](Mechanics\bestiary\npc/skabatha-nightshade-wbtw.md)
...
- "desc": "Skabatha casts one of the following spells, requiring no material components\
    ...
    \ [detect magic](Mechanics/spells/detect-magic.md), [druidcraft](Mechanics/spells/druidcraft.md),\
    \ [speak with animals](Mechanics/spells/speak-with-animals.md)\n\n1/day: [awaken](Mechanics/spells/awaken.md)\
    \ (as an action), [plane shift](Mechanics/spells/plane-shift.md) (self only)\n\
    \n2/day each: [polymorph](Mechanics/spells/polymorph.md), [remove curse](Mechanics/spells/remove-curse.md),\
...
- "desc": "The first creature that Skabatha sees after she finishes a long rest is\
    \ [invisible](Mechanics/Rules/conditions.md#Invisible) to her. She can't remember\
    \ seeing the creature or perceive it using her truesight until the end of her\
    \ next long rest."
  "name": "Forgetfulness"
"actions":
...
- "desc": "Skabatha magically shrinks herself to Tiny size (between 4 and 8 inches\
    ...
    \ She has advantage on Dexterity ([Stealth](Mechanics/Rules/skills.md#Stealth))\
    \ checks, and disadvantage on Strength checks and Strength saving throws. Her\
    \ statistics otherwise remain unchanged."
  "name": "Alter Size"
"source":
- "WBtW"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/WBtW/Skabatha%20Nightshade.webp"
```
^statblock