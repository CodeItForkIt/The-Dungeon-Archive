...
- "desc": "Lorthuun's central eye creates an area of antimagic, as in the [antimagic\
    ...
    \ start of each of its turns, Lorthuun decides which way the cone faces and whether\
    \ the cone is active. The area works against Lorthuun's own eye rays."
  "name": "Antimagic Cone"
"actions":
...
"source":
- "OotA"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/OotA/Lorthuun.webp"
```
^statblock