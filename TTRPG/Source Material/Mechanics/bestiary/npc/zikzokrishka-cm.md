...
---
# [Zikzokrishka](Mechanics\bestiary\npc/zikzokrishka-cm.md)
...
"legendary_actions":
- "desc": "Zikzokrishka makes a Wisdom ([Perception](Mechanics/Rules/skills.md#Perception))\
    \ check."
  "name": "Detect"
...
- "desc": "- Part of the ceiling collapses above one creature that Zikzokrishka can\
    ...
    \ (6d6) bludgeoning damage and be knocked [prone](Mechanics/Rules/conditions.md#Prone)\
    \ and buried under rubble. A buried creature is [restrained](Mechanics/Rules/conditions.md#Restrained)\
    ...
    \ must succeed on a DC 15 Constitution saving throw or be [blinded](Mechanics/Rules/conditions.md#Blinded)\
    \ for 1 minute. A creature can repeat the saving throw at the end of each of its\
...
"source":
- "CM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/CM/Zikzokrishka.webp"
```
^statblock