...
- "desc": "Moloch casts one of the following spells, requiring no material components\
    ...
    \ his appearance), [confusion](Mechanics/spells/confusion.md), [detect magic](Mechanics/spells/detect-magic.md),\
    \ [fly](Mechanics/spells/fly.md), [major image](Mechanics/spells/major-image.md),\
    \ [stinking cloud](Mechanics/spells/stinking-cloud.md), [suggestion](Mechanics/spells/suggestion.md),\
...
- "desc": "Moloch exhales in a 30-foot cube. Each creature in that area must succeed\
    ...
    \ it is holding, and become [frightened](Mechanics/Rules/conditions.md#Frightened)\
    \ of Moloch for 1 minute. While [frightened](Mechanics/Rules/conditions.md#Frightened)\
    \ in this way, a creature must take the [Dash](Mechanics/Rules/actions.md#Dash)\
    \ action and move away from Moloch by the safest available route on each of its\
    \ turns, unless there is nowhere to move, in which case it needn't take the [Dash](Mechanics/Rules/actions.md#Dash)\
