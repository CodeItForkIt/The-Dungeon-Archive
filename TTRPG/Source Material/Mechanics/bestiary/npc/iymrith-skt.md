...
- "desc": "Iymrith casts one of the following spells, requiring no spell components\
    ...
    \ each: [detect magic](Mechanics/spells/detect-magic.md), [dispel magic](Mechanics/spells/dispel-magic.md),\
    \ [ice storm](Mechanics/spells/ice-storm.md), [stone shape](Mechanics/spells/stone-shape.md),\
    \ [teleport](Mechanics/spells/teleport.md)\n\nWhen she casts her [stone shape](Mechanics/spells/stone-shape.md)\
    \ spell, Iymrith can shape the targeted stone into a living [gargoyle](Mechanics/bestiary/elemental/gargoyle.md)\
...
- "desc": "Each creature of Iymrith's choice that is within 120 feet of Iymrith and\
    \ aware of it must succeed on a DC 20 Wisdom saving throw or become [frightened](Mechanics/Rules/conditions.md#Frightened)\
...
- "desc": "Iymrith magically polymorphs into a female [storm giant](Mechanics/bestiary/giant/storm-giant.md)\
  ...
  "name": "Change Shape"
"legendary_actions":
- "desc": "Iymrith makes a Wisdom ([Perception](Mechanics/Rules/skills.md#Perception))\
    \ check."
  "name": "Detect"
...
- "desc": "Iymrith beats her wings. Each creature within 15 feet of Iymrith must succeed\
    ...
    \ and be knocked [prone](Mechanics/Rules/conditions.md#Prone). Iymrith can then\
    \ fly up to half her flying speed."
...
- "desc": "- Part of the ceiling collapses above one creature that the dragon can\
    ...
    \ throw or take 10 (3d6) bludgeoning damage and be knocked [prone](Mechanics/Rules/conditions.md#Prone)\
    \ and buried. The buried target is [restrained](Mechanics/Rules/conditions.md#Restrained)\
    ...
    \ cloud must succeed on a DC 15 Constitution saving throw or be [blinded](Mechanics/Rules/conditions.md#Blinded)\
    \ for 1 minute. A creature can repeat the saving throw at the end of each of its\
  ...
  "name": ""
- "desc": "At your discretion, a legendary ([adult](Mechanics/bestiary/dragon/adult-blue-dragon.md)\
    \ or [ancient](Mechanics/bestiary/dragon/ancient-blue-dragon.md)) blue dragon\
    ...
    \ to the bottom of the pit, taking 7 (2d6) bludgeoning damage and landing [prone](Mechanics/Rules/conditions.md#Prone).\
...
- "desc": "- Thunderstorms rage within 6 miles of the lair.  \n- Dust devils scour\
    ...
    \ Wisdom ([Perception](Mechanics/Rules/skills.md#Perception)) check. Otherwise,\
...
- "desc": "Any of these effects might appear in the area around a blue dragon's lair,\
    ...
    \ attempt a DC 15 Intelligence ([Investigation](Mechanics/Rules/skills.md#Investigation))\
...
"source":
- "SKT"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/SKT/Iymrith.webp"
```
^statblock