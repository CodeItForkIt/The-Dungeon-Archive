...
- "desc": "Glyster magically polymorphs into a humanoid or beast that has a challenge\
  ...
  "name": "Change Shape"
"legendary_actions":
- "desc": "Glyster makes a Wisdom ([Perception](Mechanics/Rules/skills.md#Perception))\
    \ check."
  "name": "Detect"
...
- "desc": "Glyster beats its wings. Each creature within 10 feet of Glyster must succeed\
    ...
    \ and be knocked [prone](Mechanics/Rules/conditions.md#Prone). Glyster can then\
    \ fly up to half its flying speed."
  "name": "Wing Attack (Costs 2 Actions)"
"source":
- "WDMM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/WDMM/Glyster.webp"
```
^statblock