...
---
# [Khalessa Draga](Mechanics\bestiary\npc/khalessa-draga-oota.md)
...
- "desc": "Khalessa owns a [hat of disguise](Mechanics/items/hat-of-disguise.md),\
...
- "desc": "Khalessa deals an extra 7 (2d6) damage when it hits a target with a weapon\
    ...
    \ feet of an ally of Khalessa that isn't [incapacitated](Mechanics/Rules/conditions.md#Incapacitated)\
...
"source":
- "OotA"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/OotA/Khalessa%20Draga.webp"
```
^statblock