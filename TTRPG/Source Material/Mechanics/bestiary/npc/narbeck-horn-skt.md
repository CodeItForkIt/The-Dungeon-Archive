...
---
# [Narbeck Horn](Mechanics\bestiary\npc/narbeck-horn-skt.md)
...
"cr": "3"
"traits":
- "desc": "Narbeck has advantage on saving throws against being [frightened](Mechanics/Rules/conditions.md#Frightened)."
  "name": "Brave"
"actions":
...
- "desc": "For 1 minute, Narbeck can utter a special command or warning whenever a\
    ...
    \ at a time. This effect ends if Narbeck is [incapacitated](Mechanics/Rules/conditions.md#Incapacitated)."
...
"source":
- "SKT"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/SKT/Narbeck%20Horn.webp"
```
^statblock