...
- "desc": "Mr. Dory's innate spellcasting ability is Charisma (save DC 15, +7 to\
    ...
    \ (self only)\n\n1/day each: [cloudkill](Mechanics/spells/cloudkill.md), [etherealness](Mechanics/spells/etherealness.md)\n\
...
"source":
- "GoS"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/GoS/Mr.%20Dory.webp"
```
^statblock