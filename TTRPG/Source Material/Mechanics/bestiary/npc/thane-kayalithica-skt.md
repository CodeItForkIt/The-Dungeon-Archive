...
---
# [Thane Kayalithica](Mechanics\bestiary\npc/thane-kayalithica-skt.md)
...
- "desc": "The giant's innate spellcasting ability is Wisdom. It can innately cast\
    \ the following spells, requiring no material components:\n\n1/day each: [stoneskin](Mechanics/spells/stoneskin.md),\
    \ [time stop](Mechanics/spells/time-stop.md)\n\n3/day each: [meld into stone](Mechanics/spells/meld-into-stone.md),\
...
- "desc": "The giant meditates for 1 hour, during which time it can do nothing else.\
    ...
    \ it becomes [petrified](Mechanics/Rules/conditions.md#Petrified) for 8 hours.\
    \ At the end of this time, the giant is no longer [petrified](Mechanics/Rules/conditions.md#Petrified)\
...
- "desc": "The giant tries to throw a Small or Medium creature within 10 feet of it.\
    ...
    \ 60 feet horizontally in a direction of the giant's choice. and land [prone](Mechanics/Rules/conditions.md#Prone),\
...
- "desc": "The giant sends a rock tumbling along the ground in a 30-foot line that\
    ...
    \ throw, taking 22 (3d10 + 6) bludgeoning damage and falling [prone](Mechanics/Rules/conditions.md#Prone)\
    \ on a failed save"
  "name": "Rolling Rock"
...
"source":
- "SKT"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/SKT/Thane%20Kayalithica.webp"
```
^statblock