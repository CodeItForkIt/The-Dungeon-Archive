...
---
# [Hew Hackinstone](Mechanics\bestiary\npc/hew-hackinstone-toa.md)
...
- "desc": "Hew has resistance to poison damage and advantage on saving throws against\
    \ being [poisoned](Mechanics/Rules/conditions.md#Poisoned)."
...
"source":
- "ToA"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/ToA/Hew%20Hackinstone.webp"
```
^statblock