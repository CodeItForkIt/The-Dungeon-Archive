...
- "desc": "Lazav's innate spellcasting ability is Intelligence (spell save DC 20).\
    ...
    \nAt will: [detect thoughts](Mechanics/spells/detect-thoughts.md), [encode\
    \ thoughts](Mechanics/spells/encode-thoughts-ggr.md) (see chapter 2), [freedom\
    \ of movement](Mechanics/spells/freedom-of-movement.md), [vicious mockery](Mechanics/spells/vicious-mockery.md)\
    \ (4d4 psychic damage)\n\n1/day each: [modify memory](Mechanics/spells/modify-memory.md),\
    \ [Rary's telepathic bond](Mechanics/spells/rarys-telepathic-bond.md)\n\n3/day\
    \ each: [blur](Mechanics/spells/blur.md), [confusion](Mechanics/spells/confusion.md),\
    \ [mirror image](Mechanics/spells/mirror-image.md)"
  "name": "Innate Spellcasting"
- "desc": "No attack roll has advantage against Lazav unless he is [incapacitated](Mechanics/Rules/conditions.md#Incapacitated)."
  "name": "Elusive"
...
- "desc": "Unless Lazav is [incapacitated](Mechanics/Rules/conditions.md#Incapacitated),\
