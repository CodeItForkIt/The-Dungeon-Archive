...
---
# [Themberchaud](Mechanics\bestiary\npc/themberchaud-oota.md)
...
"legendary_actions":
- "desc": "Themberchaud makes a Wisdom ([Perception](Mechanics/Rules/skills.md#Perception))\
    \ check."
  "name": "Detect"
...
- "desc": "Themberchaud beats its wings. Each creature within 10 feet of Themberchaud\
    ...
    \ damage and be knocked [prone](Mechanics/Rules/conditions.md#Prone). Themberchaud\
    \ can then fly up to half its flying speed."
  "name": "Wing Attack (Costs 2 Actions)"
"source":
- "OotA"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/OotA/Themberchaud.webp"
```
^statblock