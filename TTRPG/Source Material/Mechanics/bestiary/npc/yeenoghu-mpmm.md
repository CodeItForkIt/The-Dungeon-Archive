...
- "desc": "Melee Weapon Attack: +16 to hit, reach 15 ft., one target. Hit: 22\
    ...
    \ or be [paralyzed](Mechanics/Rules/conditions.md#Paralyzed) until the start of\
...
- "desc": "- Incite the Pack. Until the next initiative count 20, all gnolls and\
    ...
    \ and is [restrained](Mechanics/Rules/conditions.md#Restrained) by being impaled\
