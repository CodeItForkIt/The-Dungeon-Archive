...
---
# [Kiril Stoyanovich](Mechanics\bestiary\npc/kiril-stoyanovich-cos.md)
...
- "desc": "Kiril can use its action to polymorph into a wolf-humanoid hybrid or into\
  ...
  "name": "Shapechanger"
- "desc": "Kiril has advantage on Wisdom ([Perception](Mechanics/Rules/skills.md#Perception))\
...
"source":
- "CoS"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/CoS/Kiril%20Stoyanovich.webp"
```
^statblock