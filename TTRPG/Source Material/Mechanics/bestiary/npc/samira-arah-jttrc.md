...
aliases: ["Samira Arah"]
---
# [Samira Arah](Mechanics\bestiary\npc/samira-arah-jttrc.md)
...
- "desc": "Samira deals an extra 7 (2d6) damage when it hits a target with a weapon\
    ...
    \ feet of an ally of Samira that isn't [incapacitated](Mechanics/Rules/conditions.md#Incapacitated)\
...
"source":
- "JttRC"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/JttRC/Samira%20Arah.webp"
```
^statblock