...
- "desc": "Barbatos is a 6th-level spellcaster. His spellcasting ability is Wisdom\
    ...
    \ spells prepared:\n\n1st level (4 slots): [ensnaring strike](Mechanics/spells/ensnaring-strike.md),\
    \ [hail of thorns](Mechanics/spells/hail-of-thorns.md), [hunter's mark](Mechanics/spells/hunters-mark.md)\n\
    \n2nd level (2 slots): [locate animals or plants](Mechanics/spells/locate-animals-or-plants.md)"
  "name": "Spellcasting"
...
"source":
- "IMR"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/IMR/Barbatos.webp"
```
^statblock