...
"cr": "16"
"traits":
- "desc": "The Sigarda's spellcasting ability is Charisma (spell save DC 20). The\
    \ Sigarda can innately cast the following spells, requiring no material components:\n\
...
- "desc": "The Sigarda's weapon attacks are magical. When the Sigarda hits with any\
    \ weapon, the weapon deals an extra 5d8 radiant damage (included in the attack)."
  "name": "Angelic Weapons"
- "desc": "The Sigarda knows if it hears a lie."
  "name": "Divine Awareness"
- "desc": "The Sigarda has advantage on saving throws against spells and other magical\
    \ effects."
...
"actions":
- "desc": "The Sigarda makes two melee attacks."
  "name": "Multiattack"
- "desc": "Melee Weapon Attack: +12 to hit, reach 5 ft., one target. Hit: 21\
    \ (4d6 + 7) slashing damage plus 22 (5d8) radiant damage."
  "name": "Greatsword"
- "desc": "The Sigarda touches another creature. The target magically regains 30 (6d8\
    \ + 3) hit points and is freed from any curse, disease, poison, blindness, or\
    \ deafness."
  "name": "Healing Touch (4/Day)"
"source":
- "PSI"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/PSI/Sigarda.webp"
```
^statblock