...
---
# [Portia Dzuth](Mechanics\bestiary\npc/portia-dzuth-wdmm.md)
...
- "desc": "Portia suffers from Shadowfell despair manifesting as unshakable dread.\
    ...
    \ with a successful DC 15 Wisdom saving throw. A [calm emotions](Mechanics/spells/calm-emotions.md)\
...
"source":
- "WDMM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/WDMM/Portia%20Dzuth.webp"
```
^statblock