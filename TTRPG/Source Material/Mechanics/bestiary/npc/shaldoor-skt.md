...
- "desc": "Shaldoor casts one of the following spells, requiring no material spell\
    ...
    \nAt will: [detect magic](Mechanics/spells/detect-magic.md), [levitate](Mechanics/spells/levitate.md),\
    \ [light](Mechanics/spells/light.md)\n\n1/day each: [control weather](Mechanics/spells/control-weather.md)\
    \ (cast as 1 action), [water breathing](Mechanics/spells/water-breathing.md)"
  "name": "Spellcasting"
...
"source":
- "SKT"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/SKT/Shaldoor.webp"
```
^statblock