...
---
# [Hanne Hallen](Mechanics\bestiary\npc/hanne-hallen-oota.md)
...
- "desc": "Hanne is a 1st-level spellcaster. Her spellcasting ability is Intelligence\
    ...
    \ [shield](Mechanics/spells/shield.md), [mage armor](Mechanics/spells/mage-armor.md)"
  "name": "Spellcasting"
- "desc": "Hanne has advantage on saving throws against being [charmed](Mechanics/Rules/conditions.md#Charmed),\
...
"source":
- "OotA"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/OotA/Hanne%20Hallen.webp"
```
^statblock