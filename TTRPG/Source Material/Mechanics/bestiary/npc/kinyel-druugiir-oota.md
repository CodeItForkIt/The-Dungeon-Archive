...
---
# [Kinyel Druu'giir](Mechanics\bestiary\npc/kinyel-druugiir-oota.md)
...
- "desc": "During its first turn, Kinyel has advantage on attack rolls against any\
    \ creature that hasn't taken a turn. Any hit Kinyel scores against a [surprised](Mechanics/Rules/conditions.md#Surprised)\
...
- "desc": "Kinyel deals an extra 14 (4d6) damage when it hits a target with a weapon\
    ...
    \ feet of an ally of Kinyel that isn't [incapacitated](Mechanics/Rules/conditions.md#Incapacitated)\
...
"source":
- "OotA"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/OotA/Kinyel%20Druu%27giir.webp"
```
^statblock