...
statblock: inline
aliases: ["Andir Valmakos (3rd Level)"]
---
# [Andir Valmakos (3rd Level)](Mechanics\bestiary\npc/andir-valmakos-3rd-level-dsotdq.md)
...
- "desc": "Andir's spellcasting ability is Intelligence (spell save DC 12, +4 to\
    ...
    \n1st level (3 slots): [thunderwave](Mechanics/spells/thunderwave.md), [longstrider](Mechanics/spells/longstrider.md),\
