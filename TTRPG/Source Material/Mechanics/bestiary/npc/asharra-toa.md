...
- "desc": "Asharra is a 5th-level spellcaster. Her spellcasting ability is Wisdom\
    ...
    \n1st level (4 slots): [detect magic](Mechanics/spells/detect-magic.md), [faerie\
    \ fire](Mechanics/spells/faerie-fire.md), [thunderwave](Mechanics/spells/thunderwave.md)\n\
    \n2nd level (3 slots): [gust of wind](Mechanics/spells/gust-of-wind.md), [hold\
    \ person](Mechanics/spells/hold-person.md), [lesser restoration](Mechanics/spells/lesser-restoration.md)\n\
    \n3rd level (2 slots): [call lightning](Mechanics/spells/call-lightning.md),\
...
- "desc": "Five aarakocra within 30 feet of each other can magically summon an [air\
    \ elemental](Mechanics/bestiary/elemental/air-elemental.md). Each of the five\
    \ must use its action and movement on three consecutive turns to perform an aerial\
    \ dance and must maintain [concentration](Mechanics/Rules/conditions.md#Concentration)\
...
"source":
- "ToA"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/ToA/Asharra.webp"
```
^statblock