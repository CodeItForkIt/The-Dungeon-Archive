...
- "desc": "Sekelok\n\nAt will: [animal friendship](Mechanics/spells/animal-friendship.md)\
    \ (snakes only), [poison spray](Mechanics/spells/poison-spray.md)\n\n3/day each:\
...
"source":
- "ToA"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/ToA/Sekelok.webp"
```
^statblock