...
---
# [Darrett Highwater](Mechanics\bestiary\npc/darrett-highwater-dsotdq.md)
...
"cr": "3"
"traits":
- "desc": "Darrett has advantage on saving throws against being [frightened](Mechanics/Rules/conditions.md#Frightened)."
  "name": "Brave"
"actions":
...
- "desc": "For 1 minute, Darrett can utter a special command or warning whenever a\
    ...
    \ at a time. This effect ends if Darrett is [incapacitated](Mechanics/Rules/conditions.md#Incapacitated)."
...
"source":
- "DSotDQ"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/DSotDQ/Darrett%20Highwater.webp"
```
^statblock