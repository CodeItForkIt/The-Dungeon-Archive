...
---
# [The Stranger](Mechanics\bestiary\npc/the-stranger-kftgv.md)
...
- "desc": "The Stranger is an 18th-level spellcaster. Its spellcasting ability is\
  ...
  "name": "Spellcasting"
- "desc": "The Stranger wears an invisible [ring of mind shielding](Mechanics/items/ring-of-mind-shielding.md)\
    \ that thwarts magical attempts to read their thoughts. The Stranger also wears\
    \ [dimensional shackles](Mechanics/items/dimensional-shackles.md) but is eager\
    \ to be rid of them. One touch from Omid's mace-key causes the shackles to fall\
    \ off, freeing the Stranger."
...
"source":
- "KftGV"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/KftGV/The%20Stranger.webp"
```
^statblock