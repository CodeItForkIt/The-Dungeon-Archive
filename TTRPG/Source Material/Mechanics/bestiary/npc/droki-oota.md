...
- "desc": "Droki wears [boots of speed](Mechanics/items/boots-of-speed.md)."
  "name": "Special Equipment"
- "desc": "Droki has advantage on saving throws against being [charmed](Mechanics/Rules/conditions.md#Charmed)\
...
- "desc": "Droki deals an extra 7 (2d6) damage when he hits a target with a weapon\
    ...
    \ feet of an ally of Droki that isn't [incapacitated](Mechanics/Rules/conditions.md#Incapacitated)\
...
"source":
- "OotA"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/OotA/Droki.webp"
```
^statblock