...
---
# [Sir Godfrey Gwilym](Mechanics\bestiary\npc/sir-godfrey-gwilym-cos.md)
...
- "desc": "Sir Godfrey is a 16th-level spellcaster. His spellcasting ability is Wisdom\
    ...
    \ [divine favor](Mechanics/spells/divine-favor.md), [thunderous smite](Mechanics/spells/thunderous-smite.md)\n\
    \n2nd level (3 slots): [branding smite](Mechanics/spells/branding-smite.md),\
    \ [magic weapon](Mechanics/spells/magic-weapon.md)\n\n3rd level (3 slots):\
    \ [blinding smite](Mechanics/spells/blinding-smite.md), [dispel magic](Mechanics/spells/dispel-magic.md)\n\
...
- "desc": "When the knight's body is destroyed, its soul lingers. After 24 hours,\
    ...
    \ existence and regains all its hit points. While the soul is bodiless, a [wish](Mechanics/spells/wish.md)\
...
- "desc": "The knight targets one creature it can see within 30 feet of it and against\
    ...
    \ On a failure, the target is [paralyzed](Mechanics/Rules/conditions.md#Paralyzed)\
    \ until the knight deals damage to it, or until the end of the knight's next turn.\
    \ When the paralysis ends, the target is [frightened](Mechanics/Rules/conditions.md#Frightened)\
    \ of the knight for 1 minute. The [frightened](Mechanics/Rules/conditions.md#Frightened)\
    \ target can repeat the saving throw at the end of each of its turns, with disadvantage\
    \ if it can see the knight, ending the [frightened](Mechanics/Rules/conditions.md#Frightened)\
    \ condition on itself on a success."
  "name": "Vengeful Glare"
"source":
- "CoS"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/CoS/Sir%20Godfrey%20Gwilym.webp"
```
^statblock