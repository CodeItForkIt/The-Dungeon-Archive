...
- "desc": "Belephaion magically transforms into an [eagle](Mechanics/bestiary/beast/eagle.md)\
    \ or a [priest](Mechanics/bestiary/humanoid/priest.md), while retaining his alignment,\
    \ damage immunities, hit points, Hit Dice, and Intelligence, Wisdom, and Charisma\
    \ scores. This transformation ends if he is reduced to 0 hit points or uses a\
    \ bonus action to end it."
  "name": "Alter Shape"
"source":
- "DSotDQ"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/DSotDQ/Belephaion.webp"
```
^statblock