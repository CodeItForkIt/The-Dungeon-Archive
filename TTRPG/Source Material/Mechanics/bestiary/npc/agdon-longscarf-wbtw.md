...
---
# [Agdon Longscarf](Mechanics\bestiary\npc/agdon-longscarf-wbtw.md)
...
- "desc": "If Agdon is subjected to an effect that allows him to make a Dexterity\
    ...
    \ on the saving throw and only half damage if he fails, provided he isn't [incapacitated](Mechanics/Rules/conditions.md#Incapacitated)."
  "name": "Evasion"
...
- "desc": "Melee Weapon Attack: +7 to hit, reach 5 ft., one target. Hit: 10\
    \ (3d6) fire damage, and the target is magically branded. Agdon is [invisible](Mechanics/Rules/conditions.md#Invisible)\
...
- "desc": "Agdon targets one creature within 5 feet of him that he can see and makes\
    ...
    \ check, with a DC equal to 1 + the target's passive Wisdom ([Perception](Mechanics/Rules/skills.md#Perception))\
...
"source":
- "WBtW"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/WBtW/Agdon%20Longscarf.webp"
```
^statblock