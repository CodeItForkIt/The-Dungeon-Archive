...
- "desc": "During its first turn, Diva Luma has advantage on attack rolls against\
    \ any creature that hasn't taken a turn. Any hit Diva Luma scores against a [surprised](Mechanics/Rules/conditions.md#Surprised)\
...
- "desc": "Diva Luma deals an extra 14 (4d6) damage when it hits a target with a\
    ...
    \ 5 feet of an ally of Diva Luma that isn't [incapacitated](Mechanics/Rules/conditions.md#Incapacitated)\
...
"source":
- "JttRC"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/JttRC/Diva%20Luma.webp"
```
^statblock