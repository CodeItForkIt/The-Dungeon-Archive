...
- "desc": "Muiral is a 13th-level spellcaster. His spellcasting ability is Intelligence\
    ...
    \ [fog cloud](Mechanics/spells/fog-cloud.md), [magic missile](Mechanics/spells/magic-missile.md),\
    \ [shield](Mechanics/spells/shield.md)\n\n2nd level (3 slots): [darkness](Mechanics/spells/darkness.md),\
    \ [knock](Mechanics/spells/knock.md), [see invisibility](Mechanics/spells/see-invisibility.md),\
    ...
    \ [create undead](Mechanics/spells/create-undead.md), [flesh to stone](Mechanics/spells/flesh-to-stone.md)\n\
...
"source":
- "WDMM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/WDMM/Muiral.webp"
```
^statblock