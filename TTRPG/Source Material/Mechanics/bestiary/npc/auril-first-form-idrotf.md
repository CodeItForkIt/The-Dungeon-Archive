...
---
# [Auril (First Form)](Mechanics\bestiary\npc/auril-first-form-idrotf.md)
...
- "desc": "Auril's innate spellcasting ability is Charisma (spell save DC 21, +13\
    ...
    \ no material components:\n\nAt will: [chromatic orb](Mechanics/spells/chromatic-orb.md)\
    \ (cold orb only; see \"Actions\" below), [detect magic](Mechanics/spells/detect-magic.md),\
...
- "desc": "When Auril drops to 0 hit points, her body turns to slush and melts away.\
    \ Auril instantly reappears in her [second form](Mechanics/bestiary/npc/auril-second-form-idrotf.md),\
...
"source":
- "IDRotF"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/IDRotF/Auril%20%28First%20Form%29.webp"
```
^statblock