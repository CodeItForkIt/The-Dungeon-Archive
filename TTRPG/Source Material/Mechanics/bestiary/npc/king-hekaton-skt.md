...
---
# [King Hekaton](Mechanics\bestiary\npc/king-hekaton-skt.md)
...
- "desc": "Hekaton stomps the ground, triggering a thunderclap. All other creatures\
    ...
    \ 33 (6d10) thunder damage and be [deafened](Mechanics/Rules/conditions.md#Deafened)\
    \ until the start of Hekaton's next turn. On a successful save, a creature takes\
    \ half as much damage and isn't [deafened](Mechanics/Rules/conditions.md#Deafened).\
    \ The thunderclap can be heard out to a range of 1,200 feet."
  "name": "Thunderous Stomp (Recharge 6)"
"source":
- "SKT"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/SKT/King%20Hekaton.webp"
```
^statblock