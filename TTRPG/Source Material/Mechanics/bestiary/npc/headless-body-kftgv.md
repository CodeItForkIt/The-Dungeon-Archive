...
---
# [Headless Body](Mechanics\bestiary\npc/headless-body-kftgv.md)
...
"cr": "3"
"traits":
- "desc": "The headless body has advantage on saving throws against being [frightened](Mechanics/Rules/conditions.md#Frightened)."
  "name": "Brave"
"actions":
...
- "desc": "For 1 minute, the headless body can utter a special command or warning\
    ...
    \ one Leadership die at a time. This effect ends if the headless body is [incapacitated](Mechanics/Rules/conditions.md#Incapacitated)."
...
"source":
- "KftGV"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/KftGV/Headless%20Body.webp"
```
^statblock