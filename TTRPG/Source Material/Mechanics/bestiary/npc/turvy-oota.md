...
- "desc": "Turvy can use its action to polymorph into a rat-humanoid hybrid or into\
  ...
  "name": "Shapechanger"
- "desc": "Turvy has advantage on Wisdom ([Perception](Mechanics/Rules/skills.md#Perception))\
...
"source":
- "OotA"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/OotA/Turvy.webp"
```
^statblock