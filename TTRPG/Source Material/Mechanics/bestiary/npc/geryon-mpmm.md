...
- "desc": "Geryon casts one of the following spells, requiring no material components\
    ...
    \ his appearance), [detect magic](Mechanics/spells/detect-magic.md), [ice storm](Mechanics/spells/ice-storm.md),\
    \ [invisibility](Mechanics/spells/invisibility.md) (self only), [locate object](Mechanics/spells/locate-object.md),\
    \ [suggestion](Mechanics/spells/suggestion.md), [wall of ice](Mechanics/spells/wall-of-ice.md)\n\
...
- "desc": "Melee Weapon Attack: +16 to hit, reach 15 ft., one target. Hit: 23\
    \ (4d6 + 9) cold damage. If the target is Large or smaller, it is [grappled](Mechanics/Rules/conditions.md#Grappled)\
    \ (DC 24), and it is [restrained](Mechanics/Rules/conditions.md#Restrained) until\
    \ the grapple ends. Geryon can grapple one creature at a time. If the target is\
    \ already [grappled](Mechanics/Rules/conditions.md#Grappled) by Geryon, the target\
    \ takes an extra 27 (6d8) cold damage."
  "name": "Claw"
- "desc": "Melee Weapon Attack: +16 to hit, reach 20 ft., one creature. Hit:\
    ...
    \ saving throw or take 13 (2d12) poison damage and become [poisoned](Mechanics/Rules/conditions.md#Poisoned)\
    ...
    \ the [poisoned](Mechanics/Rules/conditions.md#Poisoned) condition is removed.\
...
- "desc": "Geryon targets one creature he can see within 60 feet of him. The target\
    \ must succeed on a DC 23 Wisdom saving throw or become [frightened](Mechanics/Rules/conditions.md#Frightened)\
...
- "desc": "- Banish. Geryon casts the banishment spell.  \n- Chill Blast.\
    ...
    \ on a DC 21 Wisdom saving throw or become [restrained](Mechanics/Rules/conditions.md#Restrained)\
