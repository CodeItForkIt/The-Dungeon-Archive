...
---
# [Xazax the Eyemonger](Mechanics\bestiary\npc/xazax-the-eyemonger-oota.md)
...
- "desc": "Xazax's central eye creates an area of antimagic, as in the [antimagic\
    ...
    \ start of each of its turns, Xazax decides which way the cone faces and whether\
...
- "desc": "Xazax shoots three of the following magical eye rays at random (reroll\
    ...
    \ throw or be [charmed](Mechanics/Rules/conditions.md#Charmed) by Xazax for 1\
    \ hour, or until Xazax harms the creature.  \n- 2. Paralyzing Ray. The targeted\
    \ creature must succeed on a DC 16 Constitution saving throw or be [paralyzed](Mechanics/Rules/conditions.md#Paralyzed)\
    ...
    \ grip until the start of Xazax's next turn or until Xazax is [incapacitated](Mechanics/Rules/conditions.md#Incapacitated).\
...
"source":
- "OotA"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/OotA/Xazax%20the%20Eyemonger.webp"
```
^statblock