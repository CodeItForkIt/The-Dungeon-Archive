...
aliases: ["Sul Khatesh"]
---
# [Sul Khatesh](Mechanics\bestiary\npc/sul-khatesh-erlw.md)
...
- "desc": "Sul Khatesh's spellcasting ability is Intelligence (spell save DC 26, +18\
    ...
    \ no material components:\n\nAt will: [counterspell](Mechanics/spells/counterspell.md),\
    \ [detect magic](Mechanics/spells/detect-magic.md), [detect thoughts](Mechanics/spells/detect-thoughts.md),\
    \ [dispel magic](Mechanics/spells/dispel-magic.md), [eyebite](Mechanics/spells/eyebite.md),\
    \ [fireball](Mechanics/spells/fireball.md), [lightning bolt](Mechanics/spells/lightning-bolt.md),\
    \ [shield](Mechanics/spells/shield.md)\n\n1/day each: [foresight](Mechanics/spells/foresight.md),\
    \ [gate](Mechanics/spells/gate.md), [power word kill](Mechanics/spells/power-word-kill.md),\
    \ [teleport](Mechanics/spells/teleport.md)\n\n3/day each: [chain lightning](Mechanics/spells/chain-lightning.md),\
    \ [create undead](Mechanics/spells/create-undead.md), [dream](Mechanics/spells/dream.md),\
    \ [hold monster](Mechanics/spells/hold-monster.md), [mass suggestion](Mechanics/spells/mass-suggestion.md),\
...
- "desc": "Sul Khatesh has advantage on Constitution saving throws to maintain [concentration](Mechanics/Rules/conditions.md#Concentration)."
...
- "desc": "Sul Khatesh conjures orbs of magical energy that plummet to the ground\
    ...
    \ field](Mechanics/spells/antimagic-field.md) for 1 hour. Sul Khatesh and spells\
...
- "desc": "Sul Khatesh targets a creature within 120 feet of her who is concentrating\
    ...
    \ its [concentration](Mechanics/Rules/conditions.md#Concentration) is broken on\
    \ the spell, and Sul Khatesh gains 5 temporary hit points per level of that spell."
...
- "desc": "Sul Khatesh whispers an arcane secret into the mind of a creature she can\
    ...
    \ saving throw but can't expend a spell slot is instead [stunned](Mechanics/Rules/conditions.md#Stunned)\
