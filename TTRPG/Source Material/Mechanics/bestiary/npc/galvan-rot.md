...
"ac": !!int "16"
"ac_class": "[studded leather](Mechanics/items/studded-leather-armor.md); 17 with\
...
- "desc": "While Galvan is not presented in an encounter in The Rise of Tiamat, the\
    \ [dragonsoul](Mechanics/bestiary/humanoid/dragonsoul-rot.md) stat block has been\
...
- "desc": "Galvan has advantage on saving throws against being [charmed](Mechanics/Rules/conditions.md#Charmed)\
    \ or [frightened](Mechanics/Rules/conditions.md#Frightened). While Galvan can\
    \ see a dragon or higher-ranking Cult of the Dragon cultist friendly to it, Galvan\
    \ ignores the effects of being [charmed](Mechanics/Rules/conditions.md#Charmed)\
...
- "desc": "Galvan has advantage on an attack roll against a creature if at least one\
    \ of Galvan's allies is within 5 feet of the creature and the ally isn't [incapacitated](Mechanics/Rules/conditions.md#Incapacitated)."
  "name": "Pack Tactics"
"actions":
