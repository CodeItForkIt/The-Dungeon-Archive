...
- "desc": "Graz'zt casts one of the following spells, requiring no material components\
    ...
    \ monster](Mechanics/spells/dominate-monster.md), [greater invisibility](Mechanics/spells/greater-invisibility.md)\n\
    \n3/day each: [darkness](Mechanics/spells/darkness.md), [dominate person](Mechanics/spells/dominate-person.md),\
...
- "desc": "Graz'zt makes one Wave of Sorrow attack."
  "name": "Attack"
- "desc": "One creature [charmed](Mechanics/Rules/conditions.md#Charmed) by Graz'zt\
...
- "desc": "- Command. Graz'zt casts the command spell on every creature of his\
    ...
    \ within the lair have disadvantage on Dexterity ([Stealth](Mechanics/Rules/skills.md#Stealth))\
    \ checks made to hide.  "
  "name": ""
"regional_effects":
...
- "desc": "- Agitated Beasts. Wild beasts within 6 miles of the lair break into\
    ...
    \ ([Insight](Mechanics/Rules/skills.md#Insight)) checks have disadvantage, and\
    \ all Charisma ([Deception](Mechanics/Rules/skills.md#Deception)) and Charisma\
    \ ([Persuasion](Mechanics/Rules/skills.md#Persuasion)) checks have advantage.\
