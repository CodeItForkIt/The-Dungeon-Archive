...
---
# [Davil Starsong](Mechanics\bestiary\npc/davil-starsong-wdh.md)
...
- "desc": "Davil is a 12th-level spellcaster. His spellcasting ability is Charisma\
    ...
    \ [mending](Mechanics/spells/mending.md), [minor illusion](Mechanics/spells/minor-illusion.md),\
    \ [vicious mockery](Mechanics/spells/vicious-mockery.md)\n\n1st level (4 slots):\
    \ [cure wounds](Mechanics/spells/cure-wounds.md), [disguise self](Mechanics/spells/disguise-self.md),\
    \ [sleep](Mechanics/spells/sleep.md)\n\n2nd level (3 slots): [crown of madness](Mechanics/spells/crown-of-madness.md),\
    \ [invisibility](Mechanics/spells/invisibility.md), [suggestion](Mechanics/spells/suggestion.md)\n\
    \n3rd level (3 slots): [nondetection](Mechanics/spells/nondetection.md), [sending](Mechanics/spells/sending.md),\
    \ [tongues](Mechanics/spells/tongues.md)\n\n4th level (3 slots): [compulsion](Mechanics/spells/compulsion.md),\
    ...
    \ (1 slots): [Otto's irresistible dance](Mechanics/spells/ottos-irresistible-dance.md)"
  "name": "Spellcasting"
- "desc": "Davil has advantage on saving throws against being [charmed](Mechanics/Rules/conditions.md#Charmed),\
...
"source":
- "WDH"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/WDH/Davil%20Starsong.webp"
```
^statblock