...
- "desc": "Rictavio is a 9th-level spellcaster. His spellcasting ability is Wisdom\
    ...
    \ wounds](Mechanics/spells/cure-wounds.md), [detect evil and good](Mechanics/spells/detect-evil-and-good.md),\
    ...
    \ [magic circle](Mechanics/spells/magic-circle.md), [remove curse](Mechanics/spells/remove-curse.md),\
  ...
  "name": "Spellcasting"
- "desc": "In addition to his sword cane, Rictavio wears a [hat of disguise](Mechanics/items/hat-of-disguise.md)\
    \ and a [ring of mind shielding](Mechanics/items/ring-of-mind-shielding.md), and\
    \ he carries a [spell scroll](Mechanics/items/spell-scroll-5th-level.md) of [raise\
...
"source":
- "CoS"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/CoS/Rictavio.webp"
```
^statblock