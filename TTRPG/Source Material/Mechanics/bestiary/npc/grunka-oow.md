...
- "desc": "Once per turn, Grunka can deal an extra 7 (2d6) damage to a creature\
    ...
    \ Grunka that isn't [incapacitated](Mechanics/Rules/conditions.md#Incapacitated)."
...
- "desc": "The hobgoblin sprays acid in a 10-foot cone. Each creature in the area\
    ...
    \ a tank that can be filled with ten standard vials of acid mixed with water,\
    \ allowing it to be used five times."
  "name": "Acid Spray Gun (Recharge 5-6)"
"source":
- "OoW"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/OoW/Grunka.webp"
```
^statblock