...
---
# [Zilchyn Q'Leptin](Mechanics\bestiary\npc/zilchyn-qleptin-oota.md)
...
- "desc": "Zilchyn is a 10th-level spellcaster. Its spellcasting ability is Intelligence\
  ...
  "name": "Spellcasting"
- "desc": "Zilchyn has advantage on saving throws against being [charmed](Mechanics/Rules/conditions.md#Charmed),\
...
- "desc": "Melee Weapon Attack: +2 to hit, reach 5 ft., one target. Hit: 2 (1d6\
  ...
  "name": "Staff"
- "desc": "Zilchyn magically summons a [quasit](Mechanics/bestiary/fiend/quasit.md),\
...
"source":
- "OotA"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/OotA/Zilchyn%20Q%27Leptin.webp"
```
^statblock