...
- "desc": "Juiblex spews out a corrosive slime, targeting one creature that it can\
    ...
    5, the object is destroyed. The penalty on an object can be removed by the [mending](Mechanics/spells/mending.md)\
    \ spell."
...
- "desc": "Melee Weapon Attack: +14 to hit, reach 10 ft., one creature. Hit:\
    ...
    \ off with an action, the target is [poisoned](Mechanics/Rules/conditions.md#Poisoned),\
    \ and any creature, other than an Ooze, is [poisoned](Mechanics/Rules/conditions.md#Poisoned)\
...
- "desc": "On initiative count 20 (losing initiative ties), Juiblex can take one of\
    ...
    \ a row:"
  "name": ""
- "desc": "- Green Slime. A [green slime](Mechanics/traps-hazards/green-slime.md)\
    ...
    \ on it must succeed on a DC 21 Dexterity saving throw or fall [prone](Mechanics/Rules/conditions.md#Prone)\
    ...
    \ throw or become [restrained](Mechanics/Rules/conditions.md#Restrained). When\
    \ a creature enters the area for the first time on a turn or ends its turn there,\
    \ that creature must make the same save.  \n\n    A [restrained](Mechanics/Rules/conditions.md#Restrained)\
    \ creature is stuck as long as it remains in the slimy area or until it breaks\
    \ free. The [restrained](Mechanics/Rules/conditions.md#Restrained) creature, or\
...
- "desc": "- Acidic Water. Small bodies of water, such as ponds or wells, within\
    ...
    \  \n- Corrupted Nature. Within 6 miles of the lair, all Wisdom ([Medicine](Mechanics/Rules/skills.md#Medicine))\
    \ and Wisdom ([Survival](Mechanics/Rules/skills.md#Survival)) checks have disadvantage.\
