...
aliases: ["Tromokratis"]
---
# [Tromokratis](Mechanics\bestiary\npc/tromokratis-mot.md)
...
"condition_immunities": "[charmed](Mechanics/Rules/conditions.md#Charmed), [frightened](Mechanics/Rules/conditions.md#Frightened),\
  \ [paralyzed](Mechanics/Rules/conditions.md#Paralyzed), [restrained](Mechanics/Rules/conditions.md#Restrained)"
...
- "desc": "Tromokratis can breathe air and water."
  "name": "Amphibious"
- "desc": "When Tromokratis is reduced to 0 hit points, it doesn't die or fall [unconscious](Mechanics/Rules/conditions.md#Unconscious).\
...
- "desc": "Melee Weapon Attack: +18 to hit, reach 20 ft., one target. Hit: 20\
    \ (3d6 + 10) bludgeoning damage, and if the target is a creature, it is [grappled](Mechanics/Rules/conditions.md#Grappled)\
    \ (escape DC 26). Until the grapple ends, the target is [restrained](Mechanics/Rules/conditions.md#Restrained),\
...
- "desc": "Melee Weapon Attack: +18 to hit, reach 20 ft., one creature. Hit:\
    \ 20 (3d6 + 10) bludgeoning damage, and the target is [grappled](Mechanics/Rules/conditions.md#Grappled)\
    \ (escape DC 26). If the target doesn't escape by the end of its next turn, Tromokratis\
    \ throws the target up to 60 feet in a straight line. The target lands [prone](Mechanics/Rules/conditions.md#Prone)\
...
- "desc": "Melee Weapon Attack: +18 to hit, reach 5 ft., one target. Hit: 29\
    ...
    \ [grappled](Mechanics/Rules/conditions.md#Grappled) by Tromokratis, that creature\
    ...
    \ against attacks and other effects outside Tromokratis, and it takes 42 (12d6)\
    \ acid damage at the start of each of Tromokratis's turns. If Tromokratis takes\
    \ 50 damage or more on a single turn from a creature inside it, Tromokratis must\
