...
---
# [Kevetta Dolindar](Mechanics\bestiary\npc/kevetta-dolindar-veor.md)
...
- "desc": "Melee Weapon Attack: +7 to hit, reach 60 ft., one target. Hit: 21\
    \ (4d8 + 3) piercing damage, and the target is [grappled](Mechanics/Rules/conditions.md#Grappled)\
  ...
  "name": "Harpoon Arm"
- "desc": "Each creature [grappled](Mechanics/Rules/conditions.md#Grappled) by Kevetta\
    \ must make a DC 15 Wisdom saving throw, taking 18 (4d8) psychic damage on a\
    \ failed save, or half as much damage on a successful one. In either case, Kevetta\
