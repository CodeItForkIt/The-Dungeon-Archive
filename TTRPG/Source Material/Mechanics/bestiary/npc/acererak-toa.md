...
- "desc": "Acererak is a 20th-level spellcaster. His spellcasting ability is Intelligence\
    ...
    \n1st level: [ray of sickness](Mechanics/spells/ray-of-sickness.md), [shield](Mechanics/spells/shield.md)\n\
    \n2nd level: [arcane lock](Mechanics/spells/arcane-lock.md), [knock](Mechanics/spells/knock.md)\n\
    \n3rd level: [animate dead](Mechanics/spells/animate-dead.md), [counterspell](Mechanics/spells/counterspell.md)\n\
    \n4th level (3 slots): [blight](Mechanics/spells/blight.md), [ice storm](Mechanics/spells/ice-storm.md),\
    \ [phantasmal killer](Mechanics/spells/phantasmal-killer.md)\n\n5th level (3\
    \ slots): [cloudkill](Mechanics/spells/cloudkill.md), [hold monster](Mechanics/spells/hold-monster.md),\
    \ [wall of force](Mechanics/spells/wall-of-force.md)\n\n6th level (3 slots):\
    \ [chain lightning](Mechanics/spells/chain-lightning.md), [circle of death](Mechanics/spells/circle-of-death.md),\
    ...
    \ [teleport](Mechanics/spells/teleport.md)\n\n8th level (2 slots): [maze](Mechanics/spells/maze.md),\
    \ [mind blank](Mechanics/spells/mind-blank.md)\n\n9th level (2 slots): [power\
    \ word kill](Mechanics/spells/power-word-kill.md), [time stop](Mechanics/spells/time-stop.md)"
  "name": "Spellcasting"
- "desc": "Acererak carries the [Staff of the Forgotten One](Mechanics/items/staff-of-the-forgotten-one-toa.md).\
    \ He wears a [Talisman of the Sphere](Mechanics/items/talisman-of-the-sphere.md)\
    \ and has a [Sphere of Annihilation](Mechanics/items/sphere-of-annihilation.md)\
    \ under his control."
...
- "desc": "While holding the Staff of the Forgotten One, Acererak expends 1 charge\
    ...
    \ damage. [Greater restoration](Mechanics/spells/greater-restoration.md), [remove\
    \ curse](Mechanics/spells/remove-curse.md), or similar magic ends the curse on\
    \ the target."
  "name": "Invoke Curse"
"legendary_actions":
...
- "desc": "Acererak fixes his gaze on one creature he can see within 10 feet of him.\
    ...
    \ it, the target its immune to Acererak's gaze for the next 24 hours."
  "name": "Frightening Gaze (Costs 2 Actions)"
- "desc": "Acererak uses his [Talisman of the Sphere](Mechanics/items/talisman-of-the-sphere.md)\
    \ to move the [Sphere of Annihilation](Mechanics/items/sphere-of-annihilation.md)\
...
"source":
- "ToA"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/ToA/Acererak.webp"
```
^statblock