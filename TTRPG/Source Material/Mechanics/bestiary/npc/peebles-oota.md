...
- "desc": "Peebles deals an extra 7 (2d6) damage when it hits a target with a weapon\
    ...
    \ feet of an ally of Peebles that isn't [incapacitated](Mechanics/Rules/conditions.md#Incapacitated)\
...
"source":
- "OotA"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/OotA/Peebles.webp"
```
^statblock