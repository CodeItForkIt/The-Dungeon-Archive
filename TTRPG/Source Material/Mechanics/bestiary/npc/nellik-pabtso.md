...
- "desc": "Nellik's innate spellcasting ability is Charisma. Nellik can innately cast\
    \ the following spells, requiring no material components:\n\nAt will: [darkness](Mechanics/spells/darkness.md),\
    \ [detect magic](Mechanics/spells/detect-magic.md), [dispel magic](Mechanics/spells/dispel-magic.md),\
    \ [invisibility](Mechanics/spells/invisibility.md) (self only), [mirror image](Mechanics/spells/mirror-image.md)"
...
- "desc": "Melee Weapon Attack: +9 to hit, reach 5 ft., one target. Hit: 12\
    ...
    \ Wisdom ([Medicine](Mechanics/Rules/skills.md#Medicine)) check. The wound also\
