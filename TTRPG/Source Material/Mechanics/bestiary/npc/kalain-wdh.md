...
- "desc": "Kalain is a 4th-level spellcaster. Her spellcasting ability is Charisma.\
    ...
    \ [mage hand](Mechanics/spells/mage-hand.md), [vicious mockery](Mechanics/spells/vicious-mockery.md)\n\
    \n1st level (4 slots): [charm person](Mechanics/spells/charm-person.md), [healing\
    \ word](Mechanics/spells/healing-word.md), [heroism](Mechanics/spells/heroism.md),\
    \ [sleep](Mechanics/spells/sleep.md), [thunderwave](Mechanics/spells/thunderwave.md)\n\
    \n2nd level (3 slots): [invisibility](Mechanics/spells/invisibility.md), [shatter](Mechanics/spells/shatter.md)"
  "name": "Spellcasting"
- "desc": "Kalain has advantage on saving throws against being [charmed](Mechanics/Rules/conditions.md#Charmed)\
...
- "desc": "Kalain touches one of her paintings and causes its subject to spring forth,\
    ...
    \ when it is reduced to 0 hit points, or when Kalain dies or falls [unconscious](Mechanics/Rules/conditions.md#Unconscious)."
...
"source":
- "WDH"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/WDH/Kalain.webp"
```
^statblock