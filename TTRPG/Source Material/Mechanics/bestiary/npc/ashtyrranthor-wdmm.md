...
---
# [Ashtyrranthor](Mechanics\bestiary\npc/ashtyrranthor-wdmm.md)
...
- "desc": "Ashtyrranthor's spellcasting ability is Charisma. She can innately cast\
    \ the following spells, requiring no material components:\n\n1/day each: [alarm](Mechanics/spells/alarm.md),\
    \ [detect magic](Mechanics/spells/detect-magic.md), [gaseous form](Mechanics/spells/gaseous-form.md),\
    \ [misty step](Mechanics/spells/misty-step.md), [passwall](Mechanics/spells/passwall.md),\
...
"legendary_actions":
- "desc": "Ashtyrranthor makes a Wisdom ([Perception](Mechanics/Rules/skills.md#Perception))\
    \ check."
  "name": "Detect"
...
- "desc": "Ashtyrranthor beats its wings. Each creature within 10 feet of Ashtyrranthor\
    ...
    \ damage and be knocked [prone](Mechanics/Rules/conditions.md#Prone). Ashtyrranthor\
    \ can then fly up to half its flying speed."
  "name": "Wing Attack (Costs 2 Actions)"
"source":
- "WDMM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/WDMM/Ashtyrranthor.webp"
```
^statblock