...
- "desc": "Melee Weapon Attack: +7 to hit, reach 5 ft., one [incapacitated](Mechanics/Rules/conditions.md#Incapacitated)\
    \ humanoid [grappled](Mechanics/Rules/conditions.md#Grappled) by Nihiloor. Hit:\
    \ The target takes 55 (10d10) piercing damage. If this damage reduces the target\
    \ to 0 hit points, Nihiloor kills the target by extracting and devouring its brain."
  "name": "Extract Brain"
...
"source":
- "WDH"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/WDH/Nihiloor.webp"
```
^statblock