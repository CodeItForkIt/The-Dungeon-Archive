...
- "desc": "Siren's innate spellcasting ability is Charisma (spell save DC 13). She\
    ...
    1/day each: [charm person](Mechanics/spells/charm-person.md), [fog cloud](Mechanics/spells/fog-cloud.md),\
...
- "desc": "Siren touches one creature she can see within 5 feet of her. The creature\
    ...
    \ damage and be [stunned](Mechanics/Rules/conditions.md#Stunned) until the start\
    \ of Siren's next turn."
