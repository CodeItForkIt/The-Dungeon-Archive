...
- "desc": "Tiamat can innately cast the following spell, her spellcasting ability\
    \ is Charisma (spell save DC 26):\n\n3/day: [divine word](Mechanics/spells/divine-word.md)"
...
- "desc": "Tiamat can take one reaction per turn, rather than only one per round.\
    \ She also has advantage on saving throws against being knocked [unconscious](Mechanics/Rules/conditions.md#Unconscious).\
...
- "desc": "Each creature of Tiamat's choice that is within 240 feet of Tiamat and\
    \ aware of her must succeed on a DC 26 Wisdom saving throw or become [frightened](Mechanics/Rules/conditions.md#Frightened)\
