...
- "desc": "Flapjack casts one of the following spells, requiring no material components\
    ...
    \ will: [mage hand](Mechanics/spells/mage-hand.md), [minor illusion](Mechanics/spells/minor-illusion.md)\n\
    \n1/day each: [magic missile](Mechanics/spells/magic-missile.md), [unseen\
...
- "desc": "If Flapjack is knocked [prone](Mechanics/Rules/conditions.md#Prone), roll\
    \ a die. On an odd result, Flapjack lands upside-down and is [incapacitated](Mechanics/Rules/conditions.md#Incapacitated).\
...
"source":
- "LoX"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/LoX/Flapjack.webp"
```
^statblock