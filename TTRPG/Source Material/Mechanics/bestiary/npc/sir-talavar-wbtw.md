...
aliases: ["Sir Talavar"]
---
# [Sir Talavar](Mechanics\bestiary\npc/sir-talavar-wbtw.md)
...
- "desc": "Sir Talavar's innate spellcasting ability is Charisma (spell save DC 13).\
    ...
    \n1/day: [color spray](Mechanics/spells/color-spray.md) (Orange), [mirror\
    \ image](Mechanics/spells/mirror-image.md) (Yellow), [suggestion](Mechanics/spells/suggestion.md)\
    \ (Green), [major image](Mechanics/spells/major-image.md) (Blue), [hallucinatory\
    \ terrain](Mechanics/spells/hallucinatory-terrain.md) (Indigo), [polymorph](Mechanics/spells/polymorph.md)\
    \ (Violet)\n\n1/day each: [dancing lights](Mechanics/spells/dancing-lights.md),\
    \ [mage hand](Mechanics/spells/mage-hand.md), [minor illusion](Mechanics/spells/minor-illusion.md)"
  "name": "Innate Spellcasting"
- "desc": "As a bonus action, Sir Talavar can magically turn [invisible](Mechanics/Rules/conditions.md#Invisible)\
    \ until his [concentration](Mechanics/Rules/conditions.md#Concentration) ends\
    \ (as if concentrating on a spell). Any equipment Sir Talavar wears or carries\
    \ is [invisible](Mechanics/Rules/conditions.md#Invisible) with him."
...
"source":
- "WBtW"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/WBtW/Sir%20Talavar.webp"
```
^statblock