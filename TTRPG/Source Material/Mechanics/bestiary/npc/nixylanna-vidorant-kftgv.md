...
---
# [Nixylanna Vidorant](Mechanics\bestiary\npc/nixylanna-vidorant-kftgv.md)
...
- "desc": "During its first turn, Nixylanna Vidorant has advantage on attack rolls\
    ...
    \ against a [surprised](Mechanics/Rules/conditions.md#Surprised) creature is a\
    \ critical hit."
  "name": "Assassinate"
...
- "desc": "Nixylanna Vidorant deals an extra 14 (4d6) damage when it hits a target\
    ...
    \ is within 5 feet of an ally of Nixylanna Vidorant that isn't [incapacitated](Mechanics/Rules/conditions.md#Incapacitated)\
...
"source":
- "KftGV"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/KftGV/Nixylanna%20Vidorant.webp"
```
^statblock