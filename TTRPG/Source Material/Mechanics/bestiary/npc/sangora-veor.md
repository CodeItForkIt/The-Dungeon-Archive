...
- "desc": "Sangora has the following flaws:\n\nForbiddance. Sangora can't enter\
    ...
    \ heart while Sangora is [incapacitated](Mechanics/Rules/conditions.md#Incapacitated)\
    \ in its resting place, Sangora is [paralyzed](Mechanics/Rules/conditions.md#Paralyzed)\
...
- "desc": "Melee Weapon Attack: +9 to hit, reach 5 ft., one willing creature,\
    ...
    \ Sangora, [incapacitated](Mechanics/Rules/conditions.md#Incapacitated), or [restrained](Mechanics/Rules/conditions.md#Restrained).\
...
- "desc": "Sangora targets one humanoid it can see within 30 feet of it. If the target\
    ...
    \ this magic or be [charmed](Mechanics/Rules/conditions.md#Charmed) by Sangora.\
    \ The [charmed](Mechanics/Rules/conditions.md#Charmed) target regards Sangora\
  ...
  "name": "Charm"
- "desc": "Sangora magically calls 2d4 swarms of [bats](Mechanics/bestiary/beast/swarm-of-bats.md)\
    \ or [rats](Mechanics/bestiary/beast/swarm-of-rats.md), provided that the sun\
    \ isn't up. While outdoors, Sangora can call 3d6 [wolves](Mechanics/bestiary/beast/wolf.md)\
