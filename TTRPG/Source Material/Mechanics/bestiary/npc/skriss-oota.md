...
"cr": "1/4"
"traits":
- "desc": "Skriss can innately cast can cast the [teleport](Mechanics/spells/teleport.md)\
    ...
    \ from their fellows.\n\n1/day each: [teleport](Mechanics/spells/teleport.md)"
  "name": "Innate Spellcasting"
- "desc": "Skriss has advantage on Dexterity ([Stealth](Mechanics/Rules/skills.md#Stealth))\
    \ checks made to hide."
  "name": "Chameleon Skin"
- "desc": "Any creature other than a troglodyte that starts its turn within 5 feet\
    \ of Skriss must succeed on a DC 12 Constitution saving throw or be [poisoned](Mechanics/Rules/conditions.md#Poisoned)\
...
"source":
- "OotA"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/OotA/Skriss.webp"
```
^statblock