...
---
# [Countess Sansuri](Mechanics\bestiary\npc/countess-sansuri-skt.md)
...
- "desc": "Sansuri casts one of the following spells, requiring no material components\
    ...
    \ invulnerability](Mechanics/spells/globe-of-invulnerability.md), [haste](Mechanics/spells/haste.md),\
    \ [hypnotic pattern](Mechanics/spells/hypnotic-pattern.md), [ice storm](Mechanics/spells/ice-storm.md),\
    \ [lightning bolt](Mechanics/spells/lightning-bolt.md), [Mordenkainen's sword](Mechanics/spells/mordenkainens-sword.md),\
    \ [wall of force](Mechanics/spells/wall-of-force.md)\n\n2/day each: [arcane\
    \ lock](Mechanics/spells/arcane-lock.md), [gust of wind](Mechanics/spells/gust-of-wind.md),\
  ...
  "name": "Spellcasting"
- "desc": "Sansuri has advantage on Wisdom ([Perception](Mechanics/Rules/skills.md#Perception))\
...
- "desc": "Sansuri tries to throw a Small or Medium creature within 10 feet of her.\
    ...
    \ 60 feet horizontally in a direction of Sansuri's choice and land [prone](Mechanics/Rules/conditions.md#Prone),\
...
- "desc": "A magical aura of wind surrounds Sansuri. The aura is a 10-foot-radius\
    \ sphere that lasts as long as Sansuri maintains [concentration](Mechanics/Rules/conditions.md#Concentration)\
...
"source":
- "SKT"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/SKT/Countess%20Sansuri.webp"
```
^statblock