...
- "desc": "Mordakhesh's spellcasting ability is Charisma (spell save DC 18, +10\
    ...
    \ smite](Mechanics/spells/banishing-smite.md), [destructive wave](Mechanics/spells/destructive-wave.md),\
    \ [fly](Mechanics/spells/fly.md), [mass suggestion](Mechanics/spells/mass-suggestion.md),\
    \ [staggering smite](Mechanics/spells/staggering-smite.md), [suggestion](Mechanics/spells/suggestion.md),\
...
- "desc": "Ranged Spell Attack: +10 to hit, range 120 ft., one creature. Hit:\
  ...
  "name": "Chromatic Orb"
"legendary_actions":
- "desc": "Mordakhesh makes one weapon attack or casts [chromatic orb](Mechanics/spells/chromatic-orb.md)."
  "name": "Attack"
