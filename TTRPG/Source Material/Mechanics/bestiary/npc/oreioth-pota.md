...
- "desc": "Oreioth is a 6th-level spellcaster. His spellcasting ability is Intelligence\
    ...
    \ dead](Mechanics/spells/animate-dead.md), [vampiric touch](Mechanics/spells/vampiric-touch.md)"
  "name": "Spellcasting"
...
- "desc": "When a living Medium or Small humanoid within 30 feet of Oreioth dies,\
    \ he can use an action on his next turn to cast [animate dead](Mechanics/spells/animate-dead.md)\
...
"source":
- "PotA"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/PotA/Oreioth.webp"
```
^statblock