...
---
# [Azaka Stormfang](Mechanics\bestiary\npc/azaka-stormfang-toa.md)
...
- "desc": "The Azaka can use its action to polymorph into a tiger-humanoid hybrid\
  ...
  "name": "Shapechanger"
- "desc": "The Azaka has advantage on Wisdom ([Perception](Mechanics/Rules/skills.md#Perception))\
...
- "desc": "If the Azaka moves at least 15 feet straight toward a creature and then\
    ...
    \ If the target is [prone](Mechanics/Rules/conditions.md#Prone), the Azaka can\
