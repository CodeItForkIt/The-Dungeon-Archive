...
---
# [Zuleika Toranescu](Mechanics\bestiary\npc/zuleika-toranescu-cos.md)
...
- "desc": "Zuleika can use its action to polymorph into a wolf-humanoid hybrid or\
  ...
  "name": "Shapechanger"
- "desc": "Zuleika has advantage on Wisdom ([Perception](Mechanics/Rules/skills.md#Perception))\
...
"source":
- "CoS"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/CoS/Zuleika%20Toranescu.webp"
```
^statblock