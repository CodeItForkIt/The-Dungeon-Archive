...
---
# [Glinda Nightseed](Mechanics\bestiary\npc/glinda-nightseed-hwcs.md)
...
- "desc": "Glinda is a 9th level spellcaster. Her spellcasting ability is Intelligence\
    ...
    \ [magic missile](Mechanics/spells/magic-missile.md), [sleep](Mechanics/spells/sleep.md)\n\
    \n2nd level (3 slots): [misty step](Mechanics/spells/misty-step.md), [ray\
    \ of enfeeblement](Mechanics/spells/ray-of-enfeeblement.md), [web](Mechanics/spells/web.md)\n\
    ...
    \ level (1 slots): [passwall](Mechanics/spells/passwall.md)"
  "name": "Spellcasting"
...
"source":
- "HWCS"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/HWCS/Glinda%20Nightseed.webp"
```
^statblock