...
- "desc": "Withers is a 9th-level spellcaster. His spellcasting ability is Intelligence\
    ...
    \ [detect magic](Mechanics/spells/detect-magic.md), [expeditious retreat](Mechanics/spells/expeditious-retreat.md),\
    \ [feather fall](Mechanics/spells/feather-fall.md), [thunderwave](Mechanics/spells/thunderwave.md)\n\
    \n2nd level (4 slots): [darkness](Mechanics/spells/darkness.md), [hold person](Mechanics/spells/hold-person.md),\
    \ [rope trick](Mechanics/spells/rope-trick.md)\n\n3rd level (3 slots): [dispel\
    \ magic](Mechanics/spells/dispel-magic.md), [lightning bolt](Mechanics/spells/lightning-bolt.md)\n\
    \n4th level (3 slots): [blight](Mechanics/spells/blight.md), [wall of fire](Mechanics/spells/wall-of-fire.md)\n\
    \n5th level (1 slots): [telekinesis](Mechanics/spells/telekinesis.md)"
  "name": "Spellcasting"
- "desc": "Withers carries the [amulet of the black skull](Mechanics/items/amulet-of-the-black-skull-toa.md)."
...
"source":
- "ToA"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/ToA/Withers.webp"
```
^statblock