...
---
# [Vajra Safahr](Mechanics\bestiary\npc/vajra-safahr-wdh.md)
...
- "desc": "Vajra is an 18th-level spellcaster. Her spellcasting ability is Intelligence\
    ...
    \n2nd level (3 slots): [invisibility](Mechanics/spells/invisibility.md), [misty\
    \ step](Mechanics/spells/misty-step.md), [web](Mechanics/spells/web.md)\n\n3rd\
    \ level (3 slots): [counterspell](Mechanics/spells/counterspell.md), [fly](Mechanics/spells/fly.md),\
    \ [sending](Mechanics/spells/sending.md)\n\n4th level (3 slots): [banishment](Mechanics/spells/banishment.md),\
    \ [fire shield](Mechanics/spells/fire-shield.md), [stoneskin](Mechanics/spells/stoneskin.md)\n\
    ...
    \ lightning](Mechanics/spells/chain-lightning.md), [globe of invulnerability](Mechanics/spells/globe-of-invulnerability.md)\n\
    \n7th level (1 slots): [forcecage](Mechanics/spells/forcecage.md), [prismatic\
    \ spray](Mechanics/spells/prismatic-spray.md)\n\n8th level (1 slots): [antimagic\
    \ field](Mechanics/spells/antimagic-field.md), [power word stun](Mechanics/spells/power-word-stun.md)\n\
    \n9th level (1 slots): [imprisonment](Mechanics/spells/imprisonment.md)"
  "name": "Spellcasting"
- "desc": "Vajra wields the [Blackstaff](Mechanics/items/blackstaff-wdh.md), accounted\
    \ for in her statistics. Roll 2d10 to determine how many charges the staff has\
    \ remaining."
...
- "desc": "While holding the blackstaff, Vajra can use an action to expend 1 or more\
    ...
    \ save DC and spell attack bonus: [cone of cold](Mechanics/spells/cone-of-cold.md)\
    \ (5 charges), [fireball](Mechanics/spells/fireball.md) (5th-level version, 5\
    \ charges), [globe of invulnerability](Mechanics/spells/globe-of-invulnerability.md)\
    \ (6 charges), [hold monster](Mechanics/spells/hold-monster.md) (5 charges), [levitate](Mechanics/spells/levitate.md)\
    \ (2 charges), [lightning bolt](Mechanics/spells/lightning-bolt.md) (5th-level\
    \ version, 5 charges), [magic missile](Mechanics/spells/magic-missile.md) (1 charge),\
    \ [ray of enfeeblement](Mechanics/spells/ray-of-enfeeblement.md) (1 charge), or\
    \ [wall of force](Mechanics/spells/wall-of-force.md) (5 charges)."
  "name": "Staff Spells"
"actions":
...
"source":
- "WDH"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/WDH/Vajra%20Safahr.webp"
```
^statblock