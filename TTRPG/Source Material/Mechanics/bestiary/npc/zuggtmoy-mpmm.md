...
- "desc": "Zuggtmoy casts one of the following spells, requiring no material components\
    ...
    \ [detect magic](Mechanics/spells/detect-magic.md), [locate animals or plants](Mechanics/spells/locate-animals-or-plants.md)\n\
    \n1/day each: [etherealness](Mechanics/spells/etherealness.md), [teleport](Mechanics/spells/teleport.md)\n\
    \n3/day each: [dispel magic](Mechanics/spells/dispel-magic.md), [entangle](Mechanics/spells/entangle.md),\
...
- "desc": "Zuggtmoy releases spores that burst out in a cloud that fills a 20-foot-radius\
    ...
    \ reanimated as a [spore servant](Mechanics/bestiary/plant/quaggoth-spore-servant.md)\
...
- "desc": "Zuggtmoy releases spores that burst out in a cloud that fills a 20-foot-radius\
    ...
    \ is [charmed](Mechanics/Rules/conditions.md#Charmed) by her and can't be reinfected\
    \ by these spores."
  "name": "Mind Control Spores (Recharge 5-6)"
"reactions":
- "desc": "When Zuggtmoy is hit by an attack roll, one creature within 10 feet of\
    \ her that is [charmed](Mechanics/Rules/conditions.md#Charmed) by her is hit by\
    \ the attack instead."
  "name": "Protective Thrall"
"legendary_actions":
- "desc": "Zuggtmoy makes one Pseudopod attack."
  "name": "Attack"
- "desc": "One creature [charmed](Mechanics/Rules/conditions.md#Charmed) by Zuggtmoy\
...
- "desc": "- Rally Plants. Up to four plant creatures that are friendly to Zuggtmoy\
    ...
    \ spores](Mechanics/bestiary/plant/gas-spore.md) or [violet fungi](Mechanics/bestiary/plant/violet-fungus.md)\
...
- "desc": "The region containing Zuggtmoy's lair is warped by his magic, creating\
  ...
  "name": ""
- "desc": "- Corrupted Nature. Within 6 miles of the lair, all Wisdom ([Medicine](Mechanics/Rules/skills.md#Medicine))\
