...
---
# [Ezmerelda d'Avenir](Mechanics\bestiary\npc/ezmerelda-davenir-cos.md)
...
Ezmerelda keeps a [deck of tarokka cards](Mechanics/decks/tarokka-deck-cos.md) in her wagon (chapter 11, area V1). Although the cards aren't magical, Ezmerelda can use them to perform a card reading for the characters (see chapter 1), like the one that can be performed by Madam Eva.
...
"ac": !!int "17"
"ac_class": "[+1 studded leather armor](Mechanics/items/1-armor.md)"
"hp": !!int "82"
"hit_dice": "11d8 + 33"
"stats":
- !!int "14"
...
- "desc": "Ezmerelda is a 7th-level spellcaster. Her spellcasting ability is Intelligence\
    ...
    \n2nd level (3 slots): [darkvision](Mechanics/spells/darkvision.md), [knock](Mechanics/spells/knock.md),\
    \ [mirror image](Mechanics/spells/mirror-image.md)\n\n3rd level (3 slots):\
    \ [clairvoyance](Mechanics/spells/clairvoyance.md), [lightning bolt](Mechanics/spells/lightning-bolt.md),\
...
- "desc": "In addition to her magic armor and weapons, Ezmerelda has two [potions\
    \ of greater healing](Mechanics/items/potion-of-greater-healing.md), six [vials\
    \ of holy water](Mechanics/items/holy-water-flask.md), and three wooden stakes."
...
- "desc": "Ezmerelda targets one creature that she can see within 30 feet of her.\
    ...
    \ curse lasts until ended with a [greater restoration](Mechanics/spells/greater-restoration.md)\
...
- "desc": "Ezmerelda targets one creature that she can see within 10 feet of her and\
    ...
    \ [blinded](Mechanics/Rules/conditions.md#Blinded) until the end of her next turn.\
    \ Once a target succeeds on a saving throw against this effect, it is immune to\
    \ the Evil Eye power of all Vistani for 24 hours."
  "name": "Evil Eye (Recharges after a Short or Long Rest)"
"source":
- "CoS"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/CoS/Ezmerelda%20d%27Avenir.webp"
```
^statblock