...
- "desc": "Zephyros casts one of the following spells, requiring no material components\
    ...
    \n1/day each: [cone of cold](Mechanics/spells/cone-of-cold.md), [contact other\
    \ plane](Mechanics/spells/contact-other-plane.md) (cast as 1 action), [greater\
    \ invisibility](Mechanics/spells/greater-invisibility.md), [mass suggestion](Mechanics/spells/mass-suggestion.md),\
    \ [nondetection](Mechanics/spells/nondetection.md), [Otiluke's resilient sphere](Mechanics/spells/otilukes-resilient-sphere.md),\
    \ [protection from energy](Mechanics/spells/protection-from-energy.md), [tongues](Mechanics/spells/tongues.md)\n\
    \n2/day each: [gust of wind](Mechanics/spells/gust-of-wind.md), [levitate](Mechanics/spells/levitate.md),\
    \ [magic missile](Mechanics/spells/magic-missile.md)"
  "name": "Spellcasting"
- "desc": "Zephyros has advantage on Wisdom ([Perception](Mechanics/Rules/skills.md#Perception))\
...
- "desc": "Zephyros tries to throw a Small or Medium creature within 10 feet of it.\
    ...
    \ 60 feet horizontally in a direction of Zephyros's choice and land [prone](Mechanics/Rules/conditions.md#Prone),\
...
- "desc": "A magical aura of wind surrounds Zephyros. The aura is a 10-foot-radius\
    \ sphere that lasts as long as he maintains [concentration](Mechanics/Rules/conditions.md#Concentration)\
...
"source":
- "SKT"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/SKT/Zephyros.webp"
```
^statblock