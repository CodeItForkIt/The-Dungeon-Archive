...
- "desc": "Rahadin's innate spellcasting ability is Intelligence. He can innately\
    \ cast the following spells, requiring no components:\n\n1/day: [magic weapon](Mechanics/spells/magic-weapon.md),\
    \ [nondetection](Mechanics/spells/nondetection.md)\n\n3/day: [misty step](Mechanics/spells/misty-step.md),\
...
- "desc": "Any creature within 10 feet of Rahadin that isn't protected by a [mind\
    \ blank](Mechanics/spells/mind-blank.md) spell hears in its mind the screams of\
    \ the thousands of people Rahadin has killed. As a bonus action, Rahadin can force\
    \ all creatures that can hear the screams to make a DC 16 Wisdom saving throw.\
    \ Each creature takes 16 (3d10) psychic damage on a failed save, or half as\
    \ much damage on a successful one."
  "name": "Deathly Choir"
- "desc": "Rahadin has advantage on saving throws against being [charmed](Mechanics/Rules/conditions.md#Charmed),\
...
"actions":
- "desc": "Rahadin attacks three times with his scimitar, or twice with his [poisoned](Mechanics/Rules/conditions.md#Poisoned)\
    \ darts."
  "name": "Multiattack"
...
"source":
- "CoS"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/CoS/Rahadin.webp"
```
^statblock