...
- "desc": "Each non-undead creature within 60 feet of Ebondeath that can see it must\
    ...
    \ restoration](Mechanics/spells/greater-restoration.md) spell, but only within\
...
- "desc": "One humanoid that Ebondeath can see within 5 feet of it must succeed on\
    ...
    \ the possessed target's statistics, including gaining access to the target's\
...
"source":
- "DC"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/DC/Ebondeath.webp"
```
^statblock