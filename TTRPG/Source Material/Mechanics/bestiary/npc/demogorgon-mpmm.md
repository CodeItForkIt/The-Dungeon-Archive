...
- "desc": "Demogorgon casts one of the following spells, requiring no material components\
    ...
    \ [detect magic](Mechanics/spells/detect-magic.md), [major image](Mechanics/spells/major-image.md)\n\
    \n1/day each: [feeblemind](Mechanics/spells/feeblemind.md), [project image](Mechanics/spells/project-image.md)\n\
    \n3/day each: [dispel magic](Mechanics/spells/dispel-magic.md), [fear](Mechanics/spells/fear.md),\
...
- "desc": "Demogorgon has advantage on saving throws against being [blinded](Mechanics/Rules/conditions.md#Blinded),\
    \ [deafened](Mechanics/Rules/conditions.md#Deafened), [stunned](Mechanics/Rules/conditions.md#Stunned),\
...
- "desc": "Demogorgon turns his magical gaze toward one creature he can see within\
    ...
    \ Gaze. The target is [stunned](Mechanics/Rules/conditions.md#Stunned) until\
    ...
    \ the [confusion](Mechanics/spells/confusion.md) spell without making a saving\
    ...
    \ is [charmed](Mechanics/Rules/conditions.md#Charmed) by Demogorgon until the\
    \ start of Demogorgon's next turn. Demogorgon chooses how the [charmed](Mechanics/Rules/conditions.md#Charmed)\
...
- "desc": "On initiative count 20 (losing initiative ties), Demogorgon can take one\
    ...
    \ in a row:"
  "name": ""
- "desc": "- Darkness. Demogorgon casts the [darkness](Mechanics/spells/darkness.md)\
...
- "desc": "- Beguiling Realm. Within 6 miles of the lair, all Charisma ([Persuasion](Mechanics/Rules/skills.md#Persuasion))\
    \ and Charisma ([Performance](Mechanics/Rules/skills.md#Performance)) checks have\
    \ disadvantage, and all Charisma ([Deception](Mechanics/Rules/skills.md#Deception))\
    \ and Charisma ([Intimidation](Mechanics/Rules/skills.md#Intimidation)) checks\
    ...
    \ with [poisonous snakes](Mechanics/bestiary/beast/poisonous-snake.md) and other\
    \ venomous Beasts.  "
  "name": ""
