...
---
# [Markos Delphi](Mechanics\bestiary\npc/markos-delphi-kftgv.md)
...
- "desc": "Markos casts one of the following spells, requiring no material components\
    ...
    \ each: [arms of Hadar](Mechanics/spells/arms-of-hadar.md), [charm person](Mechanics/spells/charm-person.md),\
...
- "desc": "Melee Weapon Attack: +4 to hit, reach 5 ft., one target. Hit: 5 (1d6\
    ...
    \ it must succeed on a DC 13 Constitution saving throw or become [poisoned](Mechanics/Rules/conditions.md#Poisoned)\
...
"source":
- "KftGV"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/KftGV/Markos%20Delphi.webp"
```
^statblock