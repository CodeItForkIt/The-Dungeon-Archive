...
- "desc": "Each creature of Aurinax's choice that is within 120 feet of Aurinax and\
    \ aware of it must succeed on a DC 21 Wisdom saving throw or become [frightened](Mechanics/Rules/conditions.md#Frightened)\
...
- "desc": "Aurinax magically polymorphs into a humanoid or beast that has a challenge\
  ...
  "name": "Change Shape"
"legendary_actions":
- "desc": "Aurinax makes a Wisdom ([Perception](Mechanics/Rules/skills.md#Perception))\
    \ check."
  "name": "Detect"
...
- "desc": "Aurinax beats its wings. Each creature within 10 feet of Aurinax must succeed\
    ...
    \ and be knocked [prone](Mechanics/Rules/conditions.md#Prone). Aurinax can then\
    \ fly up to half its flying speed."
  "name": "Wing Attack (Costs 2 Actions)"
"source":
- "WDH"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/WDH/Aurinax.webp"
```
^statblock