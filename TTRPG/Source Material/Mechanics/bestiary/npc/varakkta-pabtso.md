...
- "desc": "Melee Weapon Attack: +9 to hit, reach 5 ft., one target. Hit: 13\
    ...
    \ the [astral projection](Mechanics/spells/astral-projection.md) spell), Varakkta\
    \ can cut the silvery cord that tethers the target to its material body, instead\
    \ of dealing damage."
  "name": "Silver Greatsword"
"source":
- "PaBTSO"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/PaBTSO/Varakkta.webp"
```
^statblock