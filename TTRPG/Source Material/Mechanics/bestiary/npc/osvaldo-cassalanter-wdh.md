...
---
# [Osvaldo Cassalanter](Mechanics\bestiary\npc/osvaldo-cassalanter-wdh.md)
...
- "desc": "Up to four chains Osvaldo can see within 60 feet of it magically sprout\
    ...
    \ reverts to its inanimate state if reduced to 0 hit points or if Osvaldo is [incapacitated](Mechanics/Rules/conditions.md#Incapacitated)\
    \ or dies."
...
- "desc": "When a creature Osvaldo can see starts its turn within 30 feet of Osvaldo,\
    ...
    \ on a DC 14 Wisdom saving throw or be [frightened](Mechanics/Rules/conditions.md#Frightened)\
    \ until the end of its turn."
  "name": "Unnerving Mask"
"source":
- "WDH"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/WDH/Osvaldo%20Cassalanter.webp"
```
^statblock