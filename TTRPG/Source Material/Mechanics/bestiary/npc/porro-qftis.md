...
- "desc": "Melee or Ranged Spell Attack: +5 to hit, reach 5 ft. or range 120 ft.,\
  ...
  "name": "Arcane Burst"
- "desc": "Dazzling light bursts from Porro's fingertips in a 15-foot cone. Each creature\
    \ in that area must succeed on a DC 13 Constitution saving throw or have the [blinded](Mechanics/Rules/conditions.md#Blinded)\
    \ condition until the end of Porro's next turn."
  "name": "Starry Radiance (Recharge 5-6)"
"source":
- "QftIS"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/QftIS/Porro.webp"
```
^statblock