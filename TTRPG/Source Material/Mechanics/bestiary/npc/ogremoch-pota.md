...
- "desc": "Ogrémoch's innate spellcasting ability is Charisma (spell save DC 20, +12\
    ...
    \ no material components:\n\nAt will: [meld into stone](Mechanics/spells/meld-into-stone.md),\
    \ [move earth](Mechanics/spells/move-earth.md), [wall of stone](Mechanics/spells/wall-of-stone.md)"
...
- "desc": "Ranged Weapon Attack: +6 to hit, range 500 ft., one target. Hit:\
    ...
    \ on a DC 23 Strength saving throw or be knocked [prone](Mechanics/Rules/conditions.md#Prone)."
  "name": "Boulder"
- "desc": "Ogrémoch summons up to three [earth elementals](Mechanics/bestiary/elemental/earth-elemental.md)\
...
- "desc": "Ogrémoch's crystalline protrusions flare. Each creature within 30 feet\
    ...
    \ can see it, and the affected creature can't benefit from being [invisible](Mechanics/Rules/conditions.md#Invisible)."
...
- "desc": "Ogrémoch stomps the ground, creating an earth tremor that extends in a\
    ...
    \ on a DC 23 Dexterity saving throw or fall [prone](Mechanics/Rules/conditions.md#Prone)."
...
- "desc": "Ogrémoch's hit points are reduced by 50 as he breaks off a chunk of his\
    ...
    \ The chunk of rock instantly transforms into a [gargoyle](Mechanics/bestiary/elemental/gargoyle.md)\
...
- "desc": "- A 10-foot-radius area of rocky or earthy ground within 60 feet of Ogré\
    ...
    \ on a DC 15 Dexterity saving throw or sink 5 feet into the mud and be [restrained](Mechanics/Rules/conditions.md#Restrained).\
    ...
    \ that are knocked [prone](Mechanics/Rules/conditions.md#Prone) in the area also\
...
- "desc": "- Earth tremors strike the region within 10 miles of Ogrémoch's location\
    ...
    \ be spotted from a safe distance by any creature with a passive Wisdom ([Perception](Mechanics/Rules/skills.md#Perception))\
    \ score of 15 or higher or spotted with a successful DC 15 Wisdom ([Survival](Mechanics/Rules/skills.md#Survival))\
...
"source":
- "PotA"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/PotA/Ogremoch.webp"
```
^statblock