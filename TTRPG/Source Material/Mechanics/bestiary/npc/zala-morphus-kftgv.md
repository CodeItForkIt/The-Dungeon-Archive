...
---
# [Zala Morphus](Mechanics\bestiary\npc/zala-morphus-kftgv.md)
...
"cr": "2"
"traits":
- "desc": "Zala Morphus has advantage on Wisdom ([Perception](Mechanics/Rules/skills.md#Perception))\
...
- "desc": "Zala Morphus targets one creature it can see within 30 feet of it. The\
  ...
  "name": "Rotting Gaze"
- "desc": "Zala Morphus targets one creature it can see within 30 feet of it. The\
    \ target must contest its Charisma ([Deception](Mechanics/Rules/skills.md#Deception))\
    \ check against Zala Morphus's Wisdom ([Insight](Mechanics/Rules/skills.md#Insight))\
...
"source":
- "KftGV"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/KftGV/Zala%20Morphus.webp"
```
^statblock