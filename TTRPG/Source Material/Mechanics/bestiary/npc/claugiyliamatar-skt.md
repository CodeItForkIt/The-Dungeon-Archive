...
---
# [Claugiyliamatar](Mechanics\bestiary\npc/claugiyliamatar-skt.md)
...
- "desc": "Claugiyliamatar casts one of the following spells, requiring no material\
    ...
    \nAt will: [detect magic](Mechanics/spells/detect-magic.md), [druidcraft](Mechanics/spells/druidcraft.md),\
    \ [speak with animals](Mechanics/spells/speak-with-animals.md)\n\n1/day each:\
    \ [blight](Mechanics/spells/blight.md), [legend lore](Mechanics/spells/legend-lore.md)\
    \ (cast as 1 action), [locate creature](Mechanics/spells/locate-creature.md),\
    \ [pass without trace](Mechanics/spells/pass-without-trace.md), [protection from\
    \ energy](Mechanics/spells/protection-from-energy.md), [true seeing](Mechanics/spells/true-seeing.md)\n\
    \n2/day each: [animal messenger](Mechanics/spells/animal-messenger.md), [cure\
    \ wounds](Mechanics/spells/cure-wounds.md), [dispel magic](Mechanics/spells/dispel-magic.md),\
    \ [entangle](Mechanics/spells/entangle.md), [invisibility](Mechanics/spells/invisibility.md)"
  "name": "Spellcasting"
...
- "SLW"
- "SDW"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/SKT/Claugiyliamatar.webp"
```
^statblock