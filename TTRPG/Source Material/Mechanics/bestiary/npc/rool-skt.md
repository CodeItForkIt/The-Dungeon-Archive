...
- "desc": "During its first turn, Rool has advantage on attack rolls against any creature\
    \ that hasn't taken a turn. Any hit Rool scores against a [surprised](Mechanics/Rules/conditions.md#Surprised)\
...
- "desc": "Rool deals an extra 14 (4d6) damage when it hits a target with a weapon\
    ...
    \ feet of an ally of Rool that isn't [incapacitated](Mechanics/Rules/conditions.md#Incapacitated)\
...
"source":
- "SKT"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/SKT/Rool.webp"
```
^statblock