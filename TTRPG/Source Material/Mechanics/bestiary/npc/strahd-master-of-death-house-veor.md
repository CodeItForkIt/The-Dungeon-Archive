...
---
# [Strahd, Master of Death House](Mechanics\bestiary\npc/strahd-master-of-death-house-veor.md)
...
- "desc": "Strahd casts one of the following spells, using Intelligence as the spellcasting\
    ...
    \ [Fog Cloud](Mechanics/spells/fog-cloud.md), [Mage Hand](Mechanics/spells/mage-hand.md)\n\
    \n1/day each: [Greater Invisibility](Mechanics/spells/greater-invisibility.md),\
    \ [Polymorph](Mechanics/spells/polymorph.md), [Scrying](Mechanics/spells/scrying.md)\
    \ (as an action)\n\n2/day each: [Animate Dead](Mechanics/spells/animate-dead.md)\
    \ (as an action), [Gust of Wind](Mechanics/spells/gust-of-wind.md), [Mirror Image](Mechanics/spells/mirror-image.md),\
...
- "desc": "Melee Weapon Attack: +9 to hit, reach 5 ft., one target. Hit: 8 (1d8\
    ...
    \ Strahd can forgo dealing slashing damage; the target then has the [grappled](Mechanics/Rules/conditions.md#Grappled)\
...
- "desc": "Strahd targets one Humanoid he can see within 30 feet of himself. The target\
    \ must succeed on a DC 17 Wisdom saving throw or have the [charmed](Mechanics/Rules/conditions.md#Charmed)\
    \ condition. The [charmed](Mechanics/Rules/conditions.md#Charmed) target regards\
...
- "desc": "Melee Weapon Attack: +9 to hit, reach 5 ft., one creature that has\
    \ the [charmed](Mechanics/Rules/conditions.md#Charmed) or [grappled](Mechanics/Rules/conditions.md#Grappled)\
