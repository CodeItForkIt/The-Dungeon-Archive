...
---
# [Lorry Wanwillow](Mechanics\bestiary\npc/lorry-wanwillow-dsotdq.md)
...
- "desc": "Lorry has the following flaws:\n\nForbiddance. Lorry can't enter a residence\
    ...
    \ Lorry is [incapacitated](Mechanics/Rules/conditions.md#Incapacitated) in its\
    \ resting place, Lorry is [paralyzed](Mechanics/Rules/conditions.md#Paralyzed)\
...
- "desc": "Melee Weapon Attack: +9 to hit, reach 5 ft., one willing creature,\
    ...
    \ Lorry, [incapacitated](Mechanics/Rules/conditions.md#Incapacitated), or [restrained](Mechanics/Rules/conditions.md#Restrained).\
...
- "desc": "Lorry targets one humanoid it can see within 30 feet of it. If the target\
    ...
    \ this magic or be [charmed](Mechanics/Rules/conditions.md#Charmed) by Lorry.\
    \ The [charmed](Mechanics/Rules/conditions.md#Charmed) target regards Lorry as\
    \ a trusted friend to be heeded and protected. Although the target isn't under\
    \ Lorry's control, it takes Lorry's requests or actions in the most favorable\
  ...
  "name": "Charm"
- "desc": "Lorry magically calls 2d4 swarms of [bats](Mechanics/bestiary/beast/swarm-of-bats.md)\
    \ or [rats](Mechanics/bestiary/beast/swarm-of-rats.md), provided that the sun\
    \ isn't up. While outdoors, Lorry can call 3d6 [wolves](Mechanics/bestiary/beast/wolf.md)\
...
"source":
- "DSotDQ"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/DSotDQ/Lorry%20Wanwillow.webp"
```
^statblock