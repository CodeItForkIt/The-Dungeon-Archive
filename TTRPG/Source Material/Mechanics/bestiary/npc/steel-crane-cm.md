...
aliases: ["Steel Crane"]
---
# [Steel Crane](Mechanics\bestiary\npc/steel-crane-cm.md)
...
- "desc": "Melee Weapon Attack: +7 to hit, reach 5 ft., one target. Hit: 8 (1d8\
    ...
    \ 15 Constitution saving throw or be [stunned](Mechanics/Rules/conditions.md#Stunned)\
...
- "desc": "Melee Weapon Attack: +7 to hit, reach 10 ft., one target. Hit: 6\
    ...
    \ a creature [grappled](Mechanics/Rules/conditions.md#Grappled) by the whip (no\
    \ action required)."
  "name": "Whip"
- "desc": "Steel Crane regains 2d8 + 4 hit points, and all levels of [exhaustion](Mechanics/Rules/conditions.md#Exhaustion)\
    \ end on him."
...
"source":
- "CM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/CM/Steel%20Crane.webp"
```
^statblock