...
- "desc": "Elister is a 5th-level spellcaster. His spellcasting ability is Wisdom\
    ...
    \ [dispel magic](Mechanics/spells/dispel-magic.md), [create food and water](Mechanics/spells/create-food-and-water.md)"
  "name": "Spellcasting"
...
"source":
- "SKT"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/SKT/Elister.webp"
```
^statblock