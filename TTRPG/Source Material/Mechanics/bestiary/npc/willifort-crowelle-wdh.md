...
---
# [Willifort Crowelle](Mechanics\bestiary\npc/willifort-crowelle-wdh.md)
...
- "desc": "In the first round of a combat, Willifort has advantage on attack rolls\
    \ against any creature it [surprised](Mechanics/Rules/conditions.md#Surprised)."
  "name": "Ambusher"
...
- "desc": "Willifort magically reads the surface thoughts of one creature within 60\
    ...
    \ Willifort's [concentration](Mechanics/Rules/conditions.md#Concentration) isn't\
    \ broken (as if concentrating on a spell). While reading the target's mind, Willifort\
...
"source":
- "WDH"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/WDH/Willifort%20Crowelle.webp"
```
^statblock