...
- "desc": "In the first round of a combat, Bonnie has advantage on attack rolls against\
    \ any creature it [surprised](Mechanics/Rules/conditions.md#Surprised)."
  "name": "Ambusher"
...
- "desc": "Bonnie magically reads the surface thoughts of one creature within 60 feet\
    ...
    \ is in range, Bonnie can continue reading its thoughts, as long as Bonnie's [concentration](Mechanics/Rules/conditions.md#Concentration)\
    \ isn't broken (as if concentrating on a spell). While reading the target's mind,\
    \ Bonnie has advantage on Wisdom ([Insight](Mechanics/Rules/skills.md#Insight))\
...
"source":
- "WDH"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/WDH/Bonnie.webp"
```
^statblock