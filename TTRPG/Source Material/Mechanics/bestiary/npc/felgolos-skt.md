...
- "desc": "Felgolos magically polymorphs into a humanoid or beast that has a challenge\
  ...
  "name": "Change Shape"
"legendary_actions":
- "desc": "Felgolos makes a Wisdom ([Perception](Mechanics/Rules/skills.md#Perception))\
    \ check."
  "name": "Detect"
...
- "desc": "Felgolos beats its wings. Each creature within 10 feet of Felgolos must\
    ...
    \ damage and be knocked [prone](Mechanics/Rules/conditions.md#Prone). Felgolos\
    \ can then fly up to half its flying speed."
  "name": "Wing Attack (Costs 2 Actions)"
"source":
- "SKT"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/SKT/Felgolos.webp"
```
^statblock