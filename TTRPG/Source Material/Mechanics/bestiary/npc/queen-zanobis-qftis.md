...
---
# [Queen Zanobis](Mechanics\bestiary\npc/queen-zanobis-qftis.md)
*Source: Quests from the Infinite Staircase*  

```statblock
"name": "Queen Zanobis (QftIS)"
"size": "Medium"
"type": "undead"
...
"cr": "3"
"traits":
- "desc": "While in sunlight, Queen Zanobis has disadvantage on attack rolls, as well\
    \ as on Wisdom ([Perception](Mechanics/Rules/skills.md#Perception)) checks that\
    \ rely on sight."
  "name": "Sunlight Sensitivity"
"actions":
- "desc": "The wight makes two scepter attacks or two longbow attacks. It can use\
    \ its Life Drain in place of one scepter attack."
  "name": "Multiattack"
- "desc": "Melee Weapon Attack: +4 to hit, reach 5 ft., one creature. Hit: 5\
    ...
    \ under Queen Zanobis's control, unless the humanoid is restored to life or its\
    \ body is destroyed. Queen Zanobis can have no more than twelve zombies under\
...
"source":
- "QftIS"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/QftIS/Queen%20Zanobis.webp"
```
^statblock