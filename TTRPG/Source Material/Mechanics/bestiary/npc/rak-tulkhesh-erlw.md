...
---
# [Rak Tulkhesh](Mechanics\bestiary\npc/rak-tulkhesh-erlw.md)
...
- "desc": "Rak Tulkhesh's spellcasting ability is Charisma (spell save DC 24). He\
    ...
    At will: [detect thoughts](Mechanics/spells/detect-thoughts.md), [dispel magic](Mechanics/spells/dispel-magic.md),\
    \ [spirit guardians](Mechanics/spells/spirit-guardians.md)\n\n1/day each:\
    \ [banishing smite](Mechanics/spells/banishing-smite.md), [blinding smite](Mechanics/spells/blinding-smite.md),\
...
- "desc": "Rak Tulkhesh makes one weapon attack."
  "name": "Attack"
- "desc": "Rak Tulkhesh casts [dispel magic](Mechanics/spells/dispel-magic.md)."
