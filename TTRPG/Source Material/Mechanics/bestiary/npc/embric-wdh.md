...
- "desc": "Embric's spellcasting ability is Constitution (+4 to hit with spell attacks).\
    ...
    \nAt will: [produce flame](Mechanics/spells/produce-flame.md)"
...
"source":
- "WDH"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/WDH/Embric.webp"
```
^statblock