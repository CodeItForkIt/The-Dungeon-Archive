...
---
# [Joster Mareet](Mechanics\bestiary\npc/joster-mareet-kftgv.md)
...
- "desc": "One humanoid Joster Mareet can see within 30 feet of it must succeed on\
    \ a DC 15 Wisdom saving throw or be magically [charmed](Mechanics/Rules/conditions.md#Charmed)\
    \ for 1 day. The [charmed](Mechanics/Rules/conditions.md#Charmed) target obeys\
    \ Joster Mareet's verbal or telepathic commands. If the target suffers any harm\
    ...
    \ hours.\n\nJoster Mareet can have only one target [charmed](Mechanics/Rules/conditions.md#Charmed)\
    \ at a time. If it charms another, the effect on the previous target ends."
  "name": "Charm"
- "desc": "Joster Mareet kisses a creature [charmed](Mechanics/Rules/conditions.md#Charmed)\
...
"source":
- "KftGV"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/KftGV/Joster%20Mareet.webp"
```
^statblock