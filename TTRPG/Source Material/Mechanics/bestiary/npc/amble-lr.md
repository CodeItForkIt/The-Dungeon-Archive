...
"ac": !!int "18"
"ac_class": "natural armor, [ring of protection](Mechanics/items/ring-of-protection.md)"
"hp": !!int "90"
"hit_dice": "12d8 + 36"
"stats":
- !!int "14"
...
- "desc": "Amble is a 12th-level spellcaster. Their spellcasting ability is Wisdom\
    ...
    \ [mending](Mechanics/spells/mending.md), [shape water](Mechanics/spells/shape-water-xge.md),\
    \ [shillelagh](Mechanics/spells/shillelagh.md)\n\n1st level (4 slots): [absorb\
    \ elements](Mechanics/spells/absorb-elements-xge.md), [cure wounds](Mechanics/spells/cure-wounds.md),\
    \ [entangle](Mechanics/spells/entangle.md), [speak with animals](Mechanics/spells/speak-with-animals.md)\n\
    \n2nd level (3 slots): [darkvision](Mechanics/spells/darkvision.md), [hold\
    \ person](Mechanics/spells/hold-person.md), [lesser restoration](Mechanics/spells/lesser-restoration.md),\
    \ [moonbeam](Mechanics/spells/moonbeam.md)\n\n3rd level (3 slots): [conjure\
    \ animals](Mechanics/spells/conjure-animals.md), [dispel magic](Mechanics/spells/dispel-magic.md),\
    \ [water breathing](Mechanics/spells/water-breathing.md)\n\n4th level (3 slots):\
    \ [charm monster](Mechanics/spells/charm-monster-xge.md), [freedom of movement](Mechanics/spells/freedom-of-movement.md)\n\
    \n5th level (2 slots): [greater restoration](Mechanics/spells/greater-restoration.md),\
...
- "desc": "At the start of a short or long rest, Amble can touch a point in space,\
    \ and an [invisible](Mechanics/Rules/conditions.md#Invisible), 30-foot-radius\
    ...
    \ ([Stealth](Mechanics/Rules/skills.md#Stealth)) and Wisdom ([Perception](Mechanics/Rules/skills.md#Perception))\
...
- "desc": "Amble magically polymorphs into a beast with a challenge rating of 1 or\
    ...
    \ with their new form. Amble reverts to their true form if they die or fall [unconscious](Mechanics/Rules/conditions.md#Unconscious).\
    ...
    \ doesn't break Amble's [concentration](Mechanics/Rules/conditions.md#Concentration)\
...
"source":
- "LR"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/LR/Amble.webp"
```
^statblock