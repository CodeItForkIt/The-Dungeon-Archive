...
"cr": "21"
"traits":
- "desc": "If Arasta is reduced to 0 hit points, she doesn't die or fall [unconscious](Mechanics/Rules/conditions.md#Unconscious).\
...
- "desc": "Arasta unleashes her hair in the form of webbing that fills a 30-foot cube\
    ...
    \ is [restrained](Mechanics/Rules/conditions.md#Restrained) while in the web.\
    \ A creature can use an action to make a DC 21 Strength check. On a success, it\
    \ can free itself or a creature within 5 feet of it that is [restrained](Mechanics/Rules/conditions.md#Restrained)\
...
- "desc": "Arasta makes one attack with her claws."
  "name": "Claws"
- "desc": "Arasta causes two [swarms of spiders](Mechanics/bestiary/beast/swarm-of-spiders.md)\
...
- "desc": "Each creature [restrained](Mechanics/Rules/conditions.md#Restrained) by\
    \ Arasta's Web of Hair takes 18 (4d8) poison damage."
...
- "desc": "On initiative count 20 (losing initiative ties), Arasta can take a lair\
    ...
    \ two rounds in a row."
  "name": ""
- "desc": "- Arasta learns about any creature touching her webs. Each creature [restrained](Mechanics/Rules/conditions.md#Restrained)\
    ...
    \ insect](Mechanics/spells/giant-insect.md) spell (spiders only). It lasts until\
    \ she uses this lair action again or until she dies.  "
  "name": ""
"regional_effects":
...
- "desc": "\n> The nightmarish arachnid unleashes a shriek that sounds like a thousand\
    ...
    \ over the monster, revealing itself as a [wave](Mechanics/items/wave.md) of countless\
    \ spiders. The tiny arachnids swarm the larger horror, girding it in skittering\
    \ bodies."
  "name": ""
