...
- "desc": "Piyarz casts one of the following spells, using Intelligence as the spellcasting\
  ...
  "name": "Spellcasting"
- "desc": "Piyarz wears a [Ring of Fire Resistance](Mechanics/items/ring-of-fire-resistance.md),\
    \ granting him resistance to fire damage."
  "name": "Special Equipment"
"actions":
- "desc": "Piyarz makes two Arcane Burst attacks and can use Starry Radiance if available."
  "name": "Multiattack"
...
- "desc": "Dazzling light bursts from Piyarz's fingertips in a 15-foot cone. Each\
    ...
    \ of Piyarz's next turn."
  "name": "Starry Radiance (Recharge 5-6)"
"source":
- "QftIS"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/QftIS/Piyarz.webp"
```
^statblock