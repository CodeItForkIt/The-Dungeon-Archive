...
---
# [Alyxian the Callous](Mechanics\bestiary\npc/alyxian-the-callous-crcotn.md)
...
- "desc": "Alyxian releases divine energy in a 60-foot cone. Each creature of his\
    ...
    \ saving throw, the creature takes 31 (7d8) radiant damage and is knocked [prone](Mechanics/Rules/conditions.md#Prone).\
...
- "desc": "Alyxian targets one creature he can see within 120 feet of himself. The\
    \ target must succeed on a DC 17 Strength saving throw or be [restrained](Mechanics/Rules/conditions.md#Restrained)\
    \ by magical chains for 1 minute. While [restrained](Mechanics/Rules/conditions.md#Restrained)\
...
"source":
- "CRCotN"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/CRCotN/Alyxian%20the%20Callous.webp"
```
^statblock