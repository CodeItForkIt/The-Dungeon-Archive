...
"cr": "4"
"traits":
- "desc": "Amun can see 60 feet into the Ethereal Plane when it is on the Material\
    \ Plane, and vice versa."
  "name": "Ethereal Sight"
- "desc": "Amun can move through other creatures and objects as if they were difficult\
...
- "desc": "Amun enters the Ethereal Plane from the Material Plane, or vice versa.\
  ...
  "name": "Etherealness"
- "desc": "Each non-undead creature within 60 feet of Amun that can see it must succeed\
...
- "desc": "One humanoid that Amun can see within 5 feet of it must succeed on a DC\
    \ 13 Charisma saving throw or be possessed by Amun; Amun then disappears, and\
    \ the target is [incapacitated](Mechanics/Rules/conditions.md#Incapacitated) and\
    \ loses control of its body. Amun now controls the body but doesn't deprive the\
    \ target of awareness. Amun can't be targeted by any attack, spell, or other effect,\
    \ except ones that turn undead, and it retains its alignment, Intelligence, Wisdom,\
    \ Charisma, and immunity to being [charmed](Mechanics/Rules/conditions.md#Charmed)\
    ...
    \ to 0 hit points, Amun ends it as a bonus action, or Amun is turned or forced\
    \ out by an effect like the [dispel evil and good](Mechanics/spells/dispel-evil-and-good.md)\
    \ spell. When the possession ends, Amun reappears in an unoccupied space within\
...
"source":
- "QftIS"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/QftIS/Amun%20Sa.webp"
```
^statblock