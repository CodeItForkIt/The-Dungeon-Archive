...
"cr": "3"
"traits":
- "desc": "Kellikilli is [invisible](Mechanics/Rules/conditions.md#Invisible) while\
...
- "desc": "Melee Weapon Attack: +5 to hit, reach 10 ft., one creature. Hit:\
    ...
    \ 5 feet toward Kellikilli. Until this grapple ends, the target is [restrained](Mechanics/Rules/conditions.md#Restrained),\
    \ Kellikilli tries to drown it, and Kellikilli can't constrict another target."
  "name": "Constrict"
"source":
- "PaBTSO"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/PaBTSO/Kellikilli.webp"
```
^statblock