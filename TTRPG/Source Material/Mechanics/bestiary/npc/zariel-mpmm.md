...
- "desc": "Zariel casts one of the following spells, requiring no material components\
  ...
  "name": "Spellcasting"
- "desc": "Magical darkness doesn't impede Zariel's [darkvision](Mechanics/Rules/senses.md#Darkvision)."
  "name": "Devil's Sight"
...
- "desc": "Zariel touches one creature within 10 feet of her. The target must succeed\
    ...
    \ in this way, the target is [blinded](Mechanics/Rules/conditions.md#Blinded)\
...
- "desc": "On initiative count 20 (losing initiative ties), Zariel can take one of\
    ...
    \ a row:"
  "name": ""
- "desc": "- Fireball. Zariel casts the [fireball](Mechanics/spells/fireball.md)\
    \ spell.  \n- Infernal Illusions. Zariel casts the [major image](Mechanics/spells/major-image.md)\
    ...
    \ become [frightened](Mechanics/Rules/conditions.md#Frightened) of the illusion\
