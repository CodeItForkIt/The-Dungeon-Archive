...
---
# [Rosavalda "Rose" Durst](Mechanics\bestiary\npc/rosavalda-rose-durst-cos.md)
...
- "desc": "One humanoid that Rose can see within 5 feet of it must succeed on a DC\
    ...
    \ loses control of its body. Rose now controls the body but doesn't deprive the\
    \ target of awareness. Rose can't be targeted by any attack, spell, or other effect,\
...
"source":
- "CoS"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/CoS/Rosavalda%20Rose%20Durst.webp"
```
^statblock