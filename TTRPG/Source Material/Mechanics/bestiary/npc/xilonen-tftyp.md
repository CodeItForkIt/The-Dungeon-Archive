...
***Tendril.*** *Melee Weapon Attack:* `+7` to hit, reach 50 ft., one creature. *Hit:* The target is [grappled](Mechanics/Rules/conditions.md#Grappled) (escape DC 15). Until the grapple ends, the target is [restrained](Mechanics/Rules/conditions.md#Restrained) and has disadvantage on Strength checks and Strength saving throws, and Xilonen can't use the same tendril on another target.

***Reel.*** Xilonen pulls each creature [grappled](Mechanics/Rules/conditions.md#Grappled) by it up to 25 feet straight toward it.
```
^statblock