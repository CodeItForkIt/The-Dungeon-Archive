...
---
# [Gloine Nathair-Nathair](Mechanics\bestiary\npc/gloine-nathair-nathair-llk.md)
...
- "desc": "When a creature that can see Gloine's eyes starts its turn within 30 feet\
    ...
    \ Gloine isn't [incapacitated](Mechanics/Rules/conditions.md#Incapacitated) and\
    ...
    \ creature that fails the save begins to turn to glass and is [restrained](Mechanics/Rules/conditions.md#Restrained).\
    ...
    \ turn. If the creature does so, it can't see Gloine until the start of its next\
    \ turn, when it can avert its eyes again. If the creature looks at Gloine in the\
    \ meantime, it must immediately make the save.\n\nIf Gloine sees itself reflected\
    \ on a polished surface within 30 feet of it and in an area of bright light, Gloine\
...
"source":
- "LLK"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/LLK/Gloine%20Nathair-Nathair.webp"
```
^statblock