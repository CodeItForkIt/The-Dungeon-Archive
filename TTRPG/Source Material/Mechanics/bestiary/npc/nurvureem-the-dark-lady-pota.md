...
---
# [Nurvureem, The Dark Lady](Mechanics\bestiary\npc/nurvureem-the-dark-lady-pota.md)
...
- "desc": "While in dim light or darkness, the dragon has resistance to damage that\
  ...
  "name": "Living Shadow"
- "desc": "While in dim light or darkness, the dragon can take the [Hide](Mechanics/Rules/actions.md#Hide)\
...
"legendary_actions":
- "desc": "Nurvureem makes a Wisdom ([Perception](Mechanics/Rules/skills.md#Perception))\
    \ check."
  "name": "Detect"
...
- "desc": "Nurvureem beats its wings. Each creature within 10 feet of Nurvureem must\
    ...
    \ damage and be knocked [prone](Mechanics/Rules/conditions.md#Prone). Nurvureem\
    \ can then fly up to half its flying speed."
  "name": "Wing Attack (Costs 2 Actions)"
"source":
- "PotA"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/PotA/Nurvureem%2C%20The%20Dark%20Lady.webp"
```
^statblock