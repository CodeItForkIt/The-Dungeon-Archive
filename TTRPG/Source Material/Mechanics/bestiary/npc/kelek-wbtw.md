...
- "desc": "Kelek casts one of the following spells, using Charisma as the spellcasting\
    ...
    \n1/day each: [dominate beast](Mechanics/spells/dominate-beast.md), [fly](Mechanics/spells/fly.md),\
    \ [mirror image](Mechanics/spells/mirror-image.md), [web](Mechanics/spells/web.md)"
  "name": "Spellcasting"
- "desc": "Kelek wears [bracers of defense](Mechanics/items/bracers-of-defense.md)\
    \ and carries a [staff of striking](Mechanics/items/staff-of-striking.md) with\
    \ 10 charges. The staff regains 1d6 + 4 expended charges daily at dawn. If its\
...
"reactions":
- "desc": "When he is hit by an attack, Kelek protects himself with an [invisible](Mechanics/Rules/conditions.md#Invisible)\
...
"source":
- "WBtW"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/WBtW/Kelek.webp"
```
^statblock