...
statblock: inline
aliases: ["Hrigg Roundrook (3rd Level)"]
---
# [Hrigg Roundrook (3rd Level)](Mechanics\bestiary\npc/hrigg-roundrook-3rd-level-dsotdq.md)
...
- "desc": "Hrigg's spellcasting ability is Wisdom (spell save DC 12, +4 to hit with\
    ...
    \n1st level (3 slots): [cure wounds](Mechanics/spells/cure-wounds.md), [bless](Mechanics/spells/bless.md),\
