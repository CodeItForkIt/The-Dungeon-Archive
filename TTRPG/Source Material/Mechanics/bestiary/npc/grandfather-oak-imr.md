...
---
# [Grandfather Oak](Mechanics\bestiary\npc/grandfather-oak-imr.md)
...
- "desc": "Grandfather Oak magically animates one or two trees it can see within 60\
    \ feet of it. These trees have the same statistics as a [treant](Mechanics/bestiary/plant/treant.md),\
...
- "desc": "Grandfather Oak ejects spores at one creature it can see within 5 feet\
    \ of it. The target must succeed on a DC 17 Constitution saving throw or be [stunned](Mechanics/Rules/conditions.md#Stunned)\
    \ for 1 minute. The target can repeat the saving throw at the end of each of its\
    \ turns, ending the effect on itself on a success."
  "name": "Pacifying Spores (3/Day)"
"source":
- "IMR"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/IMR/Grandfather%20Oak.webp"
```
^statblock