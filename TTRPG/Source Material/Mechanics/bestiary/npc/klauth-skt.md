...
- "desc": "Klauth casts one of the following spells, requiring no material components\
    ...
    \ [banishment](Mechanics/spells/banishment.md), [cloudkill](Mechanics/spells/cloudkill.md),\
    \ [disintegrate](Mechanics/spells/disintegrate.md), [etherealness](Mechanics/spells/etherealness.md),\
    \ [find the path](Mechanics/spells/find-the-path.md) (cast as 1 action), [greater\
    \ invisibility](Mechanics/spells/greater-invisibility.md), [haste](Mechanics/spells/haste.md),\
    \ [locate object](Mechanics/spells/locate-object.md), [mass suggestion](Mechanics/spells/mass-suggestion.md),\
    \ [mirage arcane](Mechanics/spells/mirage-arcane.md) (cast as 1 action), [prismatic\
    \ spray](Mechanics/spells/prismatic-spray.md)\n\n2/day each: [darkness](Mechanics/spells/darkness.md),\
    \ [detect thoughts](Mechanics/spells/detect-thoughts.md), [ice storm](Mechanics/spells/ice-storm.md)"
  "name": "Spellcasting"
...
- "desc": "Klauth carries a [wand of fireballs](Mechanics/items/wand-of-fireballs.md)\
    \ and a [wand of lightning bolts](Mechanics/items/wand-of-lightning-bolts.md),\
    \ and he wears a [ring of cold resistance](Mechanics/items/ring-of-cold-resistance.md)."
...
- "desc": "Each creature of Klauth's choice that is within 120 feet of Klauth and\
    \ aware of him must succeed on a DC 21 Wisdom saving throw or become [frightened](Mechanics/Rules/conditions.md#Frightened)\
...
"legendary_actions":
- "desc": "Klauth makes a Wisdom ([Perception](Mechanics/Rules/skills.md#Perception))\
    \ check."
  "name": "Detect"
...
- "desc": "Klauth beats his wings. Each creature within 15 feet of Klauth must succeed\
    ...
    \ and be knocked [prone](Mechanics/Rules/conditions.md#Prone). Klauth can then\
...
"source":
- "SKT"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/SKT/Klauth.webp"
```
^statblock