...
aliases: ["Prisoner 13"]
---
# [Prisoner 13](Mechanics\bestiary\npc/prisoner-13-kftgv.md)
...
- "desc": "Prisoner 13 magically unleashes flame from the tattoo across her back,\
    ...
    \ takes 13 (3d8) fire damage and is knocked [prone](Mechanics/Rules/conditions.md#Prone).\
...
- "desc": "Prisoner 13 magically ends any effects causing the [grappled](Mechanics/Rules/conditions.md#Grappled)\
    \ or [restrained](Mechanics/Rules/conditions.md#Restrained) conditions on herself.\
    \ If she is bound with nonmagical restraints, she slips out of them."
  "name": "River Tattoo"
"reactions":
...
"source":
- "KftGV"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/KftGV/Prisoner%2013.webp"
```
^statblock