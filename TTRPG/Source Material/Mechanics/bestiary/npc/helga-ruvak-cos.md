...
aliases: ["Helga Ruvak"]
---
# [Helga Ruvak](Mechanics\bestiary\npc/helga-ruvak-cos.md)
...
- "desc": "Helga has the following flaws:\n\nForbiddance. Helga can't enter a residence\
    ...
    \ into its heart while it is [incapacitated](Mechanics/Rules/conditions.md#Incapacitated)\
...
- "desc": "Melee Weapon Attack: +6 to hit, reach 5 ft., one willing creature,\
    ...
    \ Helga, [incapacitated](Mechanics/Rules/conditions.md#Incapacitated), or [restrained](Mechanics/Rules/conditions.md#Restrained).\
...
"source":
- "CoS"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/CoS/Helga%20Ruvak.webp"
```
^statblock