...
- "desc": "Bel's spellcasting ability is Charisma (spell save DC 23). Bel can innately\
    ...
    \n3/day each: [dispel magic](Mechanics/spells/dispel-magic.md), [hold monster](Mechanics/spells/hold-monster.md),\
...
- "desc": "Any creature hostile to Bel that starts its turn within 20 feet of him\
    ...
    \ Unless the save succeeds, the creature is [frightened](Mechanics/Rules/conditions.md#Frightened)\
...
- "desc": "Melee Weapon Attack: +16 to hit, reach 10 ft., one target. Hit: 25\
    ...
    \ on a DC 23 Constitution saving throw or be [stunned](Mechanics/Rules/conditions.md#Stunned)\
