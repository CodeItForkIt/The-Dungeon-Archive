...
- **Armor Class** 17 ([splint armor](Mechanics/items/splint-armor.md))
...
***Duergar Resilience.*** Nimira has advantage on saving throws against poison, spells, and illusions, as well as to resist being [charmed](Mechanics/Rules/conditions.md#Charmed) or [paralyzed](Mechanics/Rules/conditions.md#Paralyzed).

***Sunlight Sensitivity.*** While in sunlight, Nimira has disadvantage on attack rolls, as well as on Wisdom ([Perception](Mechanics/Rules/skills.md#Perception)) checks that rely on sight.
...
***Invisibility (Recharges after a Short or Long Rest).*** Nimira magically turns [invisible](Mechanics/Rules/conditions.md#Invisible) until it attacks, casts a spell, or uses its Enlarge, or until its [concentration](Mechanics/Rules/conditions.md#Concentration) is broken, up to 1 hour (as if concentrating on a spell). Any equipment Nimira wears or carries is [invisible](Mechanics/Rules/conditions.md#Invisible) with it.
```
^statblock