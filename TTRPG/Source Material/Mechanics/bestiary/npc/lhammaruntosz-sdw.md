...
---
# [Lhammaruntosz](Mechanics\bestiary\npc/lhammaruntosz-sdw.md)
...
- "desc": "Lhammaruntosz's spellcasting ability is Charisma (spell save DC 17). She\
    ...
    \ [detect thoughts](Mechanics/spells/detect-thoughts.md), [fog cloud](Mechanics/spells/fog-cloud.md),\
...
- "desc": "Lhammaruntosz is an 8th-level spellcaster. Her spellcasting ability is\
    ...
    \ magic](Mechanics/spells/detect-magic.md), [expeditious retreat](Mechanics/spells/expeditious-retreat.md),\
    \ [sleep](Mechanics/spells/sleep.md)\n\n2nd level (3 slots): [darkness](Mechanics/spells/darkness.md),\
    \ [invisibility](Mechanics/spells/invisibility.md), [suggestion](Mechanics/spells/suggestion.md)\n\
    \n3rd level (3 slots): [dispel magic](Mechanics/spells/dispel-magic.md), [protection\
    \ from energy](Mechanics/spells/protection-from-energy.md)\n\n4th level (2 slots):\
    \ [dimension door](Mechanics/spells/dimension-door.md), [stoneskin](Mechanics/spells/stoneskin.md)"
  "name": "Spellcasting"
...
- "desc": "Each creature of Lhammaruntosz's choice that is within 120 feet of her\
    \ and aware of her must succeed on a DC 17 Wisdom saving throw or become [frightened](Mechanics/Rules/conditions.md#Frightened)\
...
- "desc": "Lhammaruntosz magically polymorphs into a humanoid or beast that has a\
  ...
  "name": "Change Shape"
"legendary_actions":
- "desc": "Lhammaruntosz makes a Wisdom ([Perception](Mechanics/Rules/skills.md#Perception))\
    \ check."
  "name": "Detect"
...
- "desc": "Lhammaruntosz beats its wings. Each creature within 10 feet of Lhammaruntosz\
    ...
    \ damage and be knocked [prone](Mechanics/Rules/conditions.md#Prone). Lhammaruntosz\
...
- "desc": "On initiative count 20 (losing initiative ties), the dragon takes a lair\
  ...
  "name": ""
- "desc": "- The dragon creates fog as though it had cast the [fog cloud](Mechanics/spells/fog-cloud.md)\
    ...
    \ saving throw or take 5 (1d10) thunder damage and be [deafened](Mechanics/Rules/conditions.md#Deafened)\
    \ until the end of its next turn.  "
  "name": ""
- "desc": "At your discretion, a legendary ([adult](Mechanics/bestiary/dragon/adult-bronze-dragon.md)\
    \ or [ancient](Mechanics/bestiary/dragon/ancient-bronze-dragon.md)) bronze dragon\
    ...
    \ take 10 (3d6) slashing damage.  \n- Whelming Water. The dragon causes\
    \ a strong current to course through the water in its lair. The dragon chooses\
    \ any number of creatures it can see that are standing or swimming in water within\
...
- "desc": "- Once per day, the dragon can alter the weather in a 6-mile radius centered\
    ...
    \ identical to the [control weather](Mechanics/spells/control-weather.md) spell.\
...
"source":
- "SDW"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/SDW/Lhammaruntosz.webp"
```
^statblock