...
- "desc": "Mwaxanaré is a 2nd-level spellcaster. Her spellcasting ability is Charisma\
    ...
    \ [mage hand](Mechanics/spells/mage-hand.md)\n\n1st-1st level (2 slots): [charm\
    \ person](Mechanics/spells/charm-person.md), [protection from evil and good](Mechanics/spells/protection-from-evil-and-good.md),\
...
"source":
- "ToA"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/ToA/Mwaxanare.webp"
```
^statblock