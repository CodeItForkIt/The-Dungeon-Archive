...
---
# [Zorak Lightdrinker](Mechanics\bestiary\npc/zorak-lightdrinker-wdmm.md)
...
- "desc": "When he drops to 0 hit points outside his resting place, Zorak transforms\
    ...
    \ then [paralyzed](Mechanics/Rules/conditions.md#Paralyzed) until he regains at\
    \ least 1 hit point. After spending 1 hour in his resting place with 0 hit points,\
...
- "desc": "Zorak has the following flaws:\n\nForbiddance. Zorak can't enter a residence\
    ...
    \ Zorak is [incapacitated](Mechanics/Rules/conditions.md#Incapacitated) in his\
    \ resting place, Zorak is [paralyzed](Mechanics/Rules/conditions.md#Paralyzed)\
...
"actions":
- "desc": "Zorak makes two attacks with his [dwarven thrower](Mechanics/items/dwarven-thrower.md),\
...
- "desc": "Melee Weapon Attack: +9 to hit, reach 5 ft., one willing creature,\
    ...
    \ Zorak, [incapacitated](Mechanics/Rules/conditions.md#Incapacitated), or [restrained](Mechanics/Rules/conditions.md#Restrained).\
...
- "desc": "Zorak targets one humanoid he can see within 30 feet of it. If the target\
    ...
    \ this magic or be [charmed](Mechanics/Rules/conditions.md#Charmed) by Zorak.\
    \ The [charmed](Mechanics/Rules/conditions.md#Charmed) target regards Zorak as\
    \ a trusted friend to be heeded and protected. Although the target isn't under\
    \ Zorak's control, it takes Zorak's requests or actions in the most favorable\
  ...
  "name": "Charm"
- "desc": "Zorak magically calls 2d4 swarms of [bats](Mechanics/bestiary/beast/swarm-of-bats.md)\
    \ or [rats](Mechanics/bestiary/beast/swarm-of-rats.md), provided that the sun\
    \ isn't up. While outdoors, Zorak can call 3d6 [wolves](Mechanics/bestiary/beast/wolf.md)\
...
"source":
- "WDMM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/WDMM/Zorak%20Lightdrinker.webp"
```
^statblock