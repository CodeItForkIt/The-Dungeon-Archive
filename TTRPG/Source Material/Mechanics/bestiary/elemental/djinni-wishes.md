...
---
# [Djinni (Wishes)](Mechanics\bestiary\elemental/djinni-wishes.md)
...
- "desc": "The djinni's innate spellcasting ability is Charisma (spell save DC 17,\
    ...
    \ [detect magic](Mechanics/spells/detect-magic.md), [thunderwave](Mechanics/spells/thunderwave.md)\n\
    \n1/day each: [conjure elemental](Mechanics/spells/conjure-elemental.md) ([air\
    \ elemental](Mechanics/bestiary/elemental/air-elemental.md) only), [creation](Mechanics/spells/creation.md),\
    ...
    \ (can create wine instead of water), [tongues](Mechanics/spells/tongues.md),\
...
- "desc": "The genie power to grant wishes is legendary among mortals. Only the most\
    ...
    \ the genie states a desired effect to it. The genie can then cast the [wish](Mechanics/spells/wish.md)\
...
- "desc": "A 5-foot-radius, 30-foot-tall cylinder of swirling air magically forms\
    ...
    \ long as the djinni maintains [concentration](Mechanics/Rules/conditions.md#Concentration)\
    \ (as if concentrating on a spell). Any creature but the djinni that enters the\
    \ whirlwind must succeed on a DC 18 Strength saving throw or be [restrained](Mechanics/Rules/conditions.md#Restrained)\
    \ by it. The djinni can move the whirlwind up to 60 feet as an action, and creatures\
    \ [restrained](Mechanics/Rules/conditions.md#Restrained) by the whirlwind move\
    \ with it. The whirlwind ends if the djinni loses sight of it.\n\nA creature can\
    \ use its action to free a creature [restrained](Mechanics/Rules/conditions.md#Restrained)\
    \ by the whirlwind, including itself, by succeeding on a DC 18 Strength check.\
    \ If the check succeeds, the creature is no longer [restrained](Mechanics/Rules/conditions.md#Restrained)\
