...
- "desc": "The tempest is always at the center of a storm 1d6 + 4 miles in diameter.\
    ...
    \ imposes disadvantage on Wisdom ([Perception](Mechanics/Rules/skills.md#Perception))\
...
- "desc": "Each creature within 120 feet of the tempest must make a DC 21 Dexterity\
    ...
    \ the creature is also [stunned](Mechanics/Rules/conditions.md#Stunned) until\
...
- "desc": "The tempest releases a blast of thunder and wind in a line that is 300\
    ...
    \ or take the same impact damage and be knocked [prone](Mechanics/Rules/conditions.md#Prone)."
