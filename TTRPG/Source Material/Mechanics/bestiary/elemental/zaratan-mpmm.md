...
- "desc": "The zaratan exhales rocky debris in a 90-foot cube. Each creature in that\
    ...
    \ one. A creature that fails the save by 5 or more is knocked [prone](Mechanics/Rules/conditions.md#Prone)."
...
- "desc": "After moving at least 10 feet on the ground, the zaratan sends a shock\
    ...
    \ [concentration](Mechanics/Rules/conditions.md#Concentration) is broken. The\
    ...
    \ 17 (5d6) bludgeoning damage, is knocked [prone](Mechanics/Rules/conditions.md#Prone),\
    \ and is trapped in the rubble. A trapped creature is [restrained](Mechanics/Rules/conditions.md#Restrained),\
    \ requiring a successful DC 20 Strength ([Athletics](Mechanics/Rules/skills.md#Athletics))\
    ...
    \ [prone](Mechanics/Rules/conditions.md#Prone) or become trapped."
...
- "desc": "The zaratan retracts into its shell. Until it takes its Emerge action,\
    \ it has resistance to all damage, and it is [restrained](Mechanics/Rules/conditions.md#Restrained).\
