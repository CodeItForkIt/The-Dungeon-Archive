...
"cr": "1/2"
"traits":
- "desc": "The mephit can innately cast [sleep](Mechanics/spells/sleep.md), requiring\
    \ no material components. Its innate spellcasting ability is Charisma.\n\nAt\
    \ will: [sleep](Mechanics/spells/sleep.md)"
  "name": "Innate Spellcasting (1/Day)"
- "desc": "When the mephit dies, it explodes in a burst of dust. Each creature within\
    \ 5 feet of it must then succeed on a DC 10 Constitution saving throw or be [blinded](Mechanics/Rules/conditions.md#Blinded)\
...
- "DoDk"
- "QftIS"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MM/Dust%20Mephit.webp"
```
^statblock
