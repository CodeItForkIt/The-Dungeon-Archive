...
aliases: ["Dao (Wishes)"]
---
# [Dao (Wishes)](Mechanics\bestiary\elemental/dao-wishes.md)
...
- "desc": "The dao's innate spellcasting ability is Charisma (spell save DC 14, +6\
    ...
    \ [detect magic](Mechanics/spells/detect-magic.md), [stone shape](Mechanics/spells/stone-shape.md)\n\
    \n1/day each: [conjure elemental](Mechanics/spells/conjure-elemental.md) ([earth\
    \ elemental](Mechanics/bestiary/elemental/earth-elemental.md) only), [gaseous\
    \ form](Mechanics/spells/gaseous-form.md), [invisibility](Mechanics/spells/invisibility.md),\
    \ [phantasmal killer](Mechanics/spells/phantasmal-killer.md), [plane shift](Mechanics/spells/plane-shift.md),\
    \ [wall of stone](Mechanics/spells/wall-of-stone.md)\n\n3/day each: [passwall](Mechanics/spells/passwall.md),\
    \ [move earth](Mechanics/spells/move-earth.md), [tongues](Mechanics/spells/tongues.md)"
...
- "desc": "Melee Weapon Attack: +10 to hit, reach 5 ft., one target. Hit: 20\
    ...
    \ it must succeed on a DC 18 Strength check or be knocked [prone](Mechanics/Rules/conditions.md#Prone)."
  "name": "Maul"
"source":
- "MM"
- "PotA"
