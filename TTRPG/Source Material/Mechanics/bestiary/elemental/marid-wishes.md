...
---
# [Marid (Wishes)](Mechanics\bestiary\elemental/marid-wishes.md)
...
- "desc": "The marid's innate spellcasting ability is Charisma (spell save DC 16,\
    ...
    \ [fog cloud](Mechanics/spells/fog-cloud.md), [purify food and drink](Mechanics/spells/purify-food-and-drink.md)\n\
    \n1/day each: [conjure elemental](Mechanics/spells/conjure-elemental.md) ([water\
    \ elemental](Mechanics/bestiary/elemental/water-elemental.md) only), [control\
    \ water](Mechanics/spells/control-water.md), [gaseous form](Mechanics/spells/gaseous-form.md),\
    \ [invisibility](Mechanics/spells/invisibility.md), [plane shift](Mechanics/spells/plane-shift.md)\n\
    \n3/day each: [tongues](Mechanics/spells/tongues.md), [water breathing](Mechanics/spells/water-breathing.md),\
...
- "desc": "The marid magically shoots water in a 60-foot line that is 5 feet wide.\
    ...
    \ is pushed up to 20 feet away from the marid and knocked [prone](Mechanics/Rules/conditions.md#Prone).\
    \ On a success, a target takes half the bludgeoning damage, but is neither pushed\
    \ nor knocked [prone](Mechanics/Rules/conditions.md#Prone)."
  "name": "Water Jet"
"source":
- "MM"
- "WDMM"
