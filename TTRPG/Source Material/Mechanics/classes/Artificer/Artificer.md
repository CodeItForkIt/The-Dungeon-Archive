...
- **Weapons**: simple
- **Tools**: [thieves' tools](TTRPG/Source%20Material/Mechanics/items/thieves-tools.md), [tinker's tools](TTRPG/Source%20Material/Mechanics/items/tinkers-tools.md), one type of [artisan's tools](TTRPG/Source%20Material/Mechanics/items/artisans-tools.md) of your choice
- **Skills**: Choose 2 from *Arcana*, *History*, *Investigation*, *Medicine*, *Nature*, *Perception*, *Sleight of Hand*

You begin play with the following equipment, in addition to any equipment provided by your background.

- any two simple weapons of your choice  
- a [light crossbow](TTRPG/Source%20Material/Mechanics/items/light-crossbow.md) and [20 bolts](TTRPG/Source%20Material/Mechanics/items/crossbow-bolts-20.md)  
- (a) [studded leather armor](TTRPG/Source%20Material/Mechanics/items/studded-leather-armor.md) or (b) [scale mail](TTRPG/Source%20Material/Mechanics/items/scale-mail.md)  
- [thieves' tools](TTRPG/Source%20Material/Mechanics/items/thieves-tools.md) and a [dungeoneer's pack](TTRPG/Source%20Material/Mechanics/items/dungeoneers-pack.md)  
...
- **Armor**: light, medium, shield
- **Weapons**: none
- **Tools**: [thieves' tools](TTRPG/Source%20Material/Mechanics/items/thieves-tools.md), [tinker's tools](TTRPG/Source%20Material/Mechanics/items/tinkers-tools.md)
...
If artificer isn't your initial class, here are the proficiencies you gain when you take your first level as an artificer: light armor, medium armor, shields, [thieves' tools](TTRPG/Source%20Material/Mechanics/items/thieves-tools.md), [tinker's tools](TTRPG/Source%20Material/Mechanics/items/tinkers-tools.md).
...
Masters of unlocking magic in everyday objects, artificers are supreme inventors. They see magic as a complex system waiting to be decoded and controlled. Artificers use tools to channel arcane power, crafting magical objects. To cast a spell, an artificer could use [alchemist's supplies](TTRPG/Source%20Material/Mechanics/items/alchemists-supplies.md) to create a potent elixir, [calligrapher's supplies](TTRPG/Source%20Material/Mechanics/items/calligraphers-supplies.md) to inscribe a sigil of power on an ally's armor, or [tinker's tools](TTRPG/Source%20Material/Mechanics/items/tinkers-tools.md) to craft a temporary charm. The magic of artificers is tied to their tools and their talents.
...
You produce your artificer spell effects through your tools. You must have a spellcasting focus—specifically [thieves' tools](TTRPG/Source%20Material/Mechanics/items/thieves-tools.md) or some kind of [artisan's tool](TTRPG/Source%20Material/Mechanics/items/artisans-tools.md)—in hand when you cast any spell with this Spellcasting feature (meaning the spell has an 'M' component when you cast it). You must be proficient with the tool to use it in this way. See "chapter 5", "Equipment," in the "Player's Handbook" for descriptions of these tools.

After you gain the Infuse Item feature at 2nd level, you can also use any item bearing one of your infusions as a spellcasting focus.

> [!note] The Magic of Artifice
> 
> As an artificer, you use tools when you cast your spells. When describing your spellcasting, think about how you're using a tool to perform the spell effect. If you cast [cure wounds](TTRPG/Source%20Material/Mechanics/spells/cure-wounds.md) using [alchemist's supplies](TTRPG/Source%20Material/Mechanics/items/alchemists-supplies.md), you could be quickly producing a salve. If you cast it using [tinker's tools](TTRPG/Source%20Material/Mechanics/items/tinkers-tools.md), you might have a miniature mechanical spider that binds wounds. When you cast [poison spray](TTRPG/Source%20Material/Mechanics/spells/poison-spray.md), you could fling foul chemicals or use a wand that spits venom. The effect of the spell is the same as for a spellcaster of any other class, but your method of spellcasting is special.
> 
> The same principle applies when you prepare your spells. As an artificer, you don't study a spellbook or pray to prepare your spells. Instead, you work with your tools and create the specialized items you'll use to produce your effects. If you replace [cure wounds](TTRPG/Source%20Material/Mechanics/spells/cure-wounds.md) with [heat metal](TTRPG/Source%20Material/Mechanics/spells/heat-metal.md), you might be altering the device you use to heal—perhaps modifying a tool so that it channels heat instead of healing energy.
> 
...
If an infusion ends on an item that contains other things, like a [bag of holding](TTRPG/Source%20Material/Mechanics/items/bag-of-holding.md), its contents harmlessly appear in and around its space.
...
You've learned how to produce exactly the tool you need: with [thieves' tools](TTRPG/Source%20Material/Mechanics/items/thieves-tools.md) or [artisan's tools](TTRPG/Source%20Material/Mechanics/items/artisans-tools.md) in hand, you can magically create one set of [artisan's tools](TTRPG/Source%20Material/Mechanics/items/artisans-tools.md) in an unoccupied space within 5 feet of you. This creation requires 1 hour of uninterrupted work, which can coincide with a short or long rest. Though the product of magic, the tools are nonmagical, and they vanish when you use this feature again.
...
While holding the object, a creature can take an action to produce the spell's effect from it, using your spellcasting ability modifier. If the spell requires [concentration](TTRPG/Source%20Material/Mechanics/Rules/conditions.md#Concentration), the creature must concentrate. The spell stays in the object until it's been used a number of times equal to twice your Intelligence modifier (minimum of twice) or until you use this feature again to store a spell in an object.
