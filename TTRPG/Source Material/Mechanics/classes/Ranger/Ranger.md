...
- **Skill Proficiencies**: *Choose 3:* [Animal Handling](Mechanics/rules/skills.md#Animal%20Handling), [Athletics](Mechanics/rules/skills.md#Athletics), [Insight](Mechanics/rules/skills.md#Insight), [Investigation](Mechanics/rules/skills.md#Investigation), [Nature](Mechanics/rules/skills.md#Nature), [Perception](Mechanics/rules/skills.md#Perception), [Stealth](Mechanics/rules/skills.md#Stealth), or [Survival](Mechanics/rules/skills.md#Survival)
...
The Ranger Features table shows how many spell slots you have to cast your level 1+ spells. You regain all expended slots when you finish a [Long Rest](Mechanics/rules/variant-rules/long-rest-xphb.md).

#### Prepared Spells of Level 1+

You prepare the list of level 1+ spells that are available for you to cast with this feature. To start, choose two level 1 Ranger spells. [Cure Wounds](Mechanics/spells/cure-wounds-xphb.md) and [Ensnaring Strike](Mechanics/spells/ensnaring-strike-xphb.md) are recommended.
...
Whenever you finish a [Long Rest](Mechanics/rules/variant-rules/long-rest-xphb.md), you can replace one spell on your list with another Ranger spell for which you have spell slots.
...
You can use a [Druidic Focus](Mechanics/items/druidic-focus-xphb.md) as a [Spellcasting Focus](Mechanics/rules/variant-rules/spellcasting-focus-xphb.md) for your Ranger spells.

### Favored Enemy (Level 1)

You always have the [Hunter's Mark](Mechanics/spells/hunters-mark-xphb.md) spell prepared. You can cast it twice without expending a spell slot, and you regain all expended uses of this ability when you finish a [Long Rest](Mechanics/rules/variant-rules/long-rest-xphb.md).

The number of times you can cast the spell without a spell slot increases when you reach certain Ranger levels, as shown in the Favored [Enemy](Mechanics/rules/variant-rules/enemy-xphb.md) column of the Ranger Features table.

### Weapon Mastery (Level 1)

Your training with weapons allows you to use the [weapon mastery properties](Mechanics/rules/variant-rules/weapon-mastery-properties-xphb.md) of two kinds of weapons of your choice with which you have proficiency, such as [Longbows](Mechanics/items/longbow-xphb.md) and [Shortswords](Mechanics/items/shortsword-xphb.md).

Whenever you finish a [Long Rest](Mechanics/rules/variant-rules/long-rest-xphb.md), you can change the kinds of weapons you chose. For example, you could switch to using the [weapon mastery properties](Mechanics/rules/variant-rules/weapon-mastery-properties-xphb.md) of [Scimitars](Mechanics/items/scimitar-xphb.md) and [Longswords](Mechanics/items/longsword-xphb.md).
...
Choose one of your skill proficiencies with which you lack [Expertise](Mechanics/rules/variant-rules/expertise-xphb.md). You gain [Expertise](Mechanics/rules/variant-rules/expertise-xphb.md) in that skill.
...
You gain the [Ability Score Improvement](Mechanics/feats/ability-score-improvement-xphb.md) feat or another feat of your choice for which you qualify. You gain this feature again at Ranger levels 8, 12, and 16.
...
Your [Speed](Mechanics/rules/variant-rules/speed-xphb.md) increases by 10 feet while you aren't wearing Heavy armor. You also have a [Climb Speed](Mechanics/rules/variant-rules/climb-speed-xphb.md) and a [Swim Speed](Mechanics/rules/variant-rules/swim-speed-xphb.md) equal to your [Speed](Mechanics/rules/variant-rules/speed-xphb.md).
...
Choose two of your skill proficiencies with which you lack [Expertise](Mechanics/rules/variant-rules/expertise-xphb.md). You gain [Expertise](Mechanics/rules/variant-rules/expertise-xphb.md) in those skills.
...
As a [Magic](Mechanics/rules/actions.md#Magic) action, you can give yourself a number of [Temporary Hit Points](Mechanics/rules/variant-rules/temporary-hit-points-xphb.md) equal to `1d8` plus your Wisdom modifier (minimum of 1). You can use this action a number of times equal to your Wisdom modifier (minimum of once), and you regain all expended uses when you finish a [Long Rest](Mechanics/rules/variant-rules/long-rest-xphb.md).

#### Decrease Exhaustion

Whenever you finish a [Short Rest](Mechanics/rules/variant-rules/short-rest-xphb.md), your [Exhaustion](Mechanics/rules/conditions.md#Exhaustion) level, if any, decreases by 1.
...
Taking damage can't break your [Concentration](Mechanics/rules/conditions.md#Concentration) on Hunter's Mark.

### Nature's Veil (Level 14)

You invoke spirits of nature to magically hide yourself. As a [Bonus Action](Mechanics/rules/variant-rules/bonus-action-xphb.md), you can give yourself the [Invisible](Mechanics/rules/conditions.md#Invisible) condition until the end of your next turn.
...
You have [Advantage](Mechanics/rules/variant-rules/advantage-xphb.md) on attack rolls against the creature currently marked by your Hunter's Mark.

### Feral Senses (Level 18)

Your connection to the forces of nature grants you [Blindsight](Mechanics/rules/senses.md#Blindsight) with a range of 30 feet.
