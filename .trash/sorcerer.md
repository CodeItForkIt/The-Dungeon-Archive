...
- **Armor**: none
- **Weapons**: [daggers](Mechanics/items/dagger.md), [darts](Mechanics/items/dart.md), [slings](Mechanics/items/sling.md), [quarterstaffs](Mechanics/items/quarterstaff.md), [light crossbows](Mechanics/items/light-crossbow.md)
- **Tools**: none
- **Skills**: Choose 2 from *Arcana*, *Deception*, *Insight*, *Intimidation*, *Persuasion*, *Religion*

You begin play with the following equipment, in addition to any equipment provided by your background.

- (a) a [light crossbow](Mechanics/items/light-crossbow.md) and [20 bolts](Mechanics/items/crossbow-bolts-20.md) or (b) any simple weapon  
- (a) a [component pouch](Mechanics/items/component-pouch.md) or (b) an [arcane focus](Mechanics/items/arcane-focus.md)  
- (a) a [dungeoneer's pack](Mechanics/items/dungeoneers-pack.md) or (b) an [explorer's pack](Mechanics/items/explorers-pack.md)  
- Two [daggers](Mechanics/items/dagger.md)  
...
You can make a sorcerer quickly by following these suggestions. First, Charisma should be your highest ability score, followed by Constitution. Second, choose the hermit background. Third, choose the [light](Mechanics/spells/light.md), [prestidigitation](Mechanics/spells/prestidigitation.md), [ray of frost](Mechanics/spells/ray-of-frost.md), and [shocking grasp](Mechanics/spells/shocking-grasp.md) cantrips, along with the 1st-level spells [shield](Mechanics/spells/shield.md) and [magic missile](Mechanics/spells/magic-missile.md).
...
For example, if you know the 1st-level spell [burning hands](Mechanics/spells/burning-hands.md) and have a 1st-level and a 2nd-level spell slot available, you can cast [burning hands](Mechanics/spells/burning-hands.md) using either slot.
...
You can use an [arcane focus](Mechanics/items/arcane-focus.md) as a spellcasting focus for your sorcerer spells.
...
- [Careful Spell](Mechanics/optional-features/careful-spell.md)  
- [Distant Spell](Mechanics/optional-features/distant-spell.md)  
- [Empowered Spell](Mechanics/optional-features/empowered-spell.md)  
- [Extended Spell](Mechanics/optional-features/extended-spell.md)  
- [Heightened Spell](Mechanics/optional-features/heightened-spell.md)  
- [Quickened Spell](Mechanics/optional-features/quickened-spell.md)  
- [Subtle Spell](Mechanics/optional-features/subtle-spell.md)  
- [Twinned Spell](Mechanics/optional-features/twinned-spell.md)  

### Metamagic Options (Level 3)
_Source: Tasha's Cauldron of Everything p. 65_

*3rd-level sorcerer [optional class features](Mechanics/Rules/variant-rules/optional-class-features-tce.md)*
...
*4th-level sorcerer [optional class features](Mechanics/Rules/variant-rules/optional-class-features-tce.md)*
...
- Replace one of the options you chose for the Metamagic feature with a different [Metamagic option](Mechanics/optional-features/list-metamagic.md) available to you.  
...
*5th-level sorcerer [optional class features](Mechanics/Rules/variant-rules/optional-class-features-tce.md)*
...
> [!example]- Metamagic
> ![Metamagic](Mechanics/optional-features/list-metamagic.md#Metamagic)
^list-metamagic