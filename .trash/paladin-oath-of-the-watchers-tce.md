...
|---------------|--------|
| 3rd | [alarm](Mechanics/spells/alarm.md), [detect magic](Mechanics/spells/detect-magic.md) |
| 5th | [moonbeam](Mechanics/spells/moonbeam.md), [see invisibility](Mechanics/spells/see-invisibility.md) |
| 9th | [counterspell](Mechanics/spells/counterspell.md), [nondetection](Mechanics/spells/nondetection.md) |
| 13th | [aura of purity](Mechanics/spells/aura-of-purity.md), [banishment](Mechanics/spells/banishment.md) |
...
A turned creature must spend its turns trying to move as far away from you as it can, and it can't willingly end its move in a space within 30 feet of you. For its action, it can use only the [Dash](Mechanics/Rules/actions.md#Dash) action or try to escape from an effect that prevents it from moving. If there's nowhere to move, the creature can take the [Dodge](Mechanics/Rules/actions.md#Dodge) action.

### Aura of the Sentinel (Level 7)

*7th-level Oath of the Watchers feature*

You emit an aura of alertness while you aren't [incapacitated](Mechanics/Rules/conditions.md#Incapacitated). When you and any creatures of your choice within 10 feet of you roll initiative, you all gain a bonus to initiative equal to your proficiency bonus.
...
- You gain [truesight](Mechanics/Rules/senses.md#Truesight) with a range of 120 feet.  
