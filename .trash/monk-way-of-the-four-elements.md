...
Once you reach 5th level in this class, you can spend additional ki points to increase the level of an elemental discipline spell that you cast, provided that the spell has an enhanced effect at a higher level, as [burning hands](Mechanics/spells/burning-hands.md) does. The spell's level increases by 1 for each additional ki point you spend. For example, if you are a 5th-level monk and use Sweeping Cinder Strike to cast [burning hands](Mechanics/spells/burning-hands.md), you can spend 3 ki points to cast it as a 2nd-level spell (the discipline's base cost of 2 ki points plus 1).
...
- [Breath of Winter](Mechanics/optional-features/breath-of-winter.md)  
- [Clench of the North Wind](Mechanics/optional-features/clench-of-the-north-wind.md)  
- [Elemental Attunement](Mechanics/optional-features/elemental-attunement.md)  
- [Eternal Mountain Defense](Mechanics/optional-features/eternal-mountain-defense.md)  
- [Fangs of the Fire Snake](Mechanics/optional-features/fangs-of-the-fire-snake.md)  
- [Fist of Four Thunders](Mechanics/optional-features/fist-of-four-thunders.md)  
- [Unbroken Air](Mechanics/optional-features/unbroken-air.md)  
- [Flames of the Phoenix](Mechanics/optional-features/flames-of-the-phoenix.md)  
- [Gong of the Summit](Mechanics/optional-features/gong-of-the-summit.md)  
- [Mist Stance](Mechanics/optional-features/mist-stance.md)  
- [Ride the Wind](Mechanics/optional-features/ride-the-wind.md)  
- [River of Hungry Flame](Mechanics/optional-features/river-of-hungry-flame.md)  
- [Rush of the Gale Spirits](Mechanics/optional-features/rush-of-the-gale-spirits.md)  
- [Shape the Flowing River](Mechanics/optional-features/shape-the-flowing-river.md)  
- [Sweeping Cinder Strike](Mechanics/optional-features/sweeping-cinder-strike.md)  
- [Water Whip](Mechanics/optional-features/water-whip.md)  
- [Wave of Rolling Earth](Mechanics/optional-features/wave-of-rolling-earth.md)  
...
> ![Elemental Discipline](Mechanics/optional-features/list-elemental-discipline.md#Elemental%20Discipline)
