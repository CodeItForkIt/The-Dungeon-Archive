...
In addition, the sidekick gains proficiency in two skills of your choice from the following list: [Acrobatics](Mechanics/Rules/skills.md#Acrobatics), [Animal Handling](Mechanics/Rules/skills.md#Animal%20Handling), [Athletics](Mechanics/Rules/skills.md#Athletics), [Intimidation](Mechanics/Rules/skills.md#Intimidation), [Nature](Mechanics/Rules/skills.md#Nature), [Perception](Mechanics/Rules/skills.md#Perception), and [Survival](Mechanics/Rules/skills.md#Survival).
...
The sidekick can attack twice, instead of once, whenever it takes the [Attack](Mechanics/Rules/actions.md#Attack) action on its turn.
