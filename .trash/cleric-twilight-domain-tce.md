...
| Cleric Level | Spells |
|--------------|--------|
| 1st | [faerie fire](Mechanics/spells/faerie-fire.md), [sleep](Mechanics/spells/sleep.md) |
| 3rd | [moonbeam](Mechanics/spells/moonbeam.md), [see invisibility](Mechanics/spells/see-invisibility.md) |
| 5th | [aura of vitality](Mechanics/spells/aura-of-vitality.md), [Leomund's tiny hut](Mechanics/spells/leomunds-tiny-hut.md) |
| 7th | [aura of life](Mechanics/spells/aura-of-life.md), [greater invisibility](Mechanics/spells/greater-invisibility.md) |
| 9th | [circle of power](Mechanics/spells/circle-of-power.md), [mislead](Mechanics/spells/mislead.md) |
^twilight-domain-spells
...
You can see through the deepest gloom. You have [darkvision](Mechanics/Rules/senses.md#Darkvision) out to a range of 300 feet. In that radius, you can see in dim light as if it were bright light and in darkness as if it were dim light.

As an action, you can magically share the [darkvision](Mechanics/Rules/senses.md#Darkvision) of this feature with willing creatures you can see within 10 feet of you, up to a number of creatures equal to your Wisdom modifier (minimum of one creature). The shared [darkvision](Mechanics/Rules/senses.md#Darkvision) lasts for 1 hour. Once you share it, you can't do so again until you finish a long rest, unless you expend a spell slot of any level to share it again.
...
As an action, you present your holy symbol, and a sphere of twilight emanates from you. The sphere is centered on you, has a 30-foot radius, and is filled with dim light. The sphere moves with you, and it lasts for 1 minute or until you are [incapacitated](Mechanics/Rules/conditions.md#Incapacitated) or die. Whenever a creature (including you) ends its turn in the sphere, you can grant that creature one of these benefits:

- You grant it temporary hit points equal to `1d6` plus your cleric level.  
- You end one effect on it causing it to be [charmed](Mechanics/Rules/conditions.md#Charmed) or [frightened](Mechanics/Rules/conditions.md#Frightened).  
