...
When you use this feature, you gain one level of [exhaustion](2-Mechanics/CLI/rules/conditions.md#Exhaustion). Only by finishing a long rest can you remove a level of [exhaustion](2-Mechanics/CLI/rules/conditions.md#Exhaustion) gained in this way.