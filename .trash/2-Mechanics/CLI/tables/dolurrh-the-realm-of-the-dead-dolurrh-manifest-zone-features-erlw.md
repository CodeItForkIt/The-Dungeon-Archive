...
| dice: d4 | Feature |
|----------|---------|
| 1 | Bodies buried here reanimate in `dice:1d4\\|noform\\|avg` (`1d4`) days, possessed by restless spirits. These spirits might be malevolent or benign. |
...
| 3 | Spells and abilities that raise the dead have a 50 percent chance to bring back `dice:1d4\\|noform\\|avg` (`1d4`) angry spirits as well. These might be banshees, ghosts, shadows, specters, wraiths, or other incorporeal undead. |
