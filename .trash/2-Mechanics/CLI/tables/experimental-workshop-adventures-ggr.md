...
| 6 | Capture or kill an elemental or an Izzet weird (a [blistercoil weird](2-Mechanics/CLI/bestiary/elemental/blistercoil-weird-ggr.md) or [galvanice weird](2-Mechanics/CLI/bestiary/elemental/galvanice-weird-ggr.md)) that is running amok in the workshop, and make sure it doesn't escape out into the city. |
