...
| 8–9 | A number (`dice:2d4\\|noform\\|avg` (`2d4`)) of the Staring Cats of Uldun-dar appear within 30 feet of the character. These sapient, hyperdimensional [cats](2-Mechanics/CLI/bestiary/beast/cat.md) have uneven numbers of eyes and are not hostile, but they ominously share reports on how the character died in multiple parallel dimensions. The cats vanish after the character's next long rest. |
