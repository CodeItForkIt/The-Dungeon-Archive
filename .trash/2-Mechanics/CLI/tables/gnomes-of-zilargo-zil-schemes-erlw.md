...
| 2 | You have an anonymous contact who sends you missions via the [sending](2-Mechanics/CLI/spells/sending.md) spell. When you do as you're asked, you receive handsome rewards. |
...
| 5 | You've acquired a [spellshard](2-Mechanics/CLI/items/spellshard-erlw.md) (described in "chapter 5") that contains a vast amount of text in a strange code. |
...
| 10 | You're peddling a life-extension scheme where clients are [petrified](2-Mechanics/CLI/rules/conditions.md#Petrified) by a medusa and then restored later. |
^zil-schemes