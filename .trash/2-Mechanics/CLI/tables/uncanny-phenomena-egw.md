...
| 7 | There is no sound here. This area is permanently under the effects of the [silence](2-Mechanics/CLI/spells/silence.md) spell. |
| 8 | This place is supernaturally unlucky. Attack rolls, ability checks, and saving throws cannot be rerolled in this area. |
| 9 | Water turns to acid here. Water introduced to this area becomes acid in `dice:1d4\\|noform\\|avg` (`1d4`) days. |
