...
| 2 | The area is a wild magic zone. Whenever a creature casts a spell of 1st level or higher or activates a magic item, roll a `dice:d10\\|noform\\|avg` (`d10`). On a 1, roll on the [Wild Magic Surge](2-Mechanics/CLI/tables/wild-magic-surge.md) table in the "Player's Handbook". |
