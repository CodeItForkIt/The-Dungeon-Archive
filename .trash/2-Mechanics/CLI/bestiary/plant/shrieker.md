...
```ad-statblock
title: Shrieker
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MM/Shrieker.webp#token)
...
***Shriek.*** When bright light or a creature is within 30 feet of the shrieker, it emits a shriek audible within 300 feet of it. The shrieker continues to shriek until the disturbance moves out of range and for `dice:1d4|noform|avg` (`1d4`) of the shrieker's turns afterward.
```
^statblock
