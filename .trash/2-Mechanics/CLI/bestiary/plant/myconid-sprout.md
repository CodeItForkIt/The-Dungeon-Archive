...
***Fist.*** *Melee Weapon Attack:* `dice:1d20+1|noform|text(+1)` to hit, reach 5 ft., one target. *Hit:* `dice:1d4-1|noform|avg|text(1)` (`1d4 - 1`) bludgeoning damage plus `dice:1d4|noform|avg|text(2)` (`1d4`) poison damage.
