...
***Plant Camouflage.*** The wood woad has advantage on Dexterity ([Stealth](2-Mechanics/CLI/rules/skills.md#Stealth)) checks it makes in any terrain with ample obscuring vegetation.
...
***Club.*** *Melee Weapon Attack:* `dice:1d20+7|noform|text(+7)` to hit, reach 5 ft., one target. *Hit:* `dice:4d4+4|noform|avg|text(14)` (`4d4 + 4`) force damage.
```
^statblock
