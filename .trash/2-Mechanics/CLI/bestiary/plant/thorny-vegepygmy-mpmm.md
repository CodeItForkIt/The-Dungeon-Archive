...
***Plant Camouflage.*** The thorny has advantage on Dexterity ([Stealth](2-Mechanics/CLI/rules/skills.md#Stealth)) checks it makes in any terrain with ample obscuring vegetation.
...
***Thorny Body.*** At the start of its turn, the thorny deals `dice:1d4|noform|avg|text(2)` (`1d4`) piercing damage to any creature grappling it.

## Actions

***Bite.*** *Melee Weapon Attack:* `dice:1d20+3|noform|text(+3)` to hit, reach 5 ft., one target. *Hit:* `dice:2d8+1|noform|avg|text(10)` (`2d8 + 1`) piercing damage.
```
^statblock
