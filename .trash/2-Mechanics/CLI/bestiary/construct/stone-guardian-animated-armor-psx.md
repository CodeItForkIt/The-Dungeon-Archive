...
```ad-statblock
title: Stone Guardian (Animated Armor)
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/PSX/Stone%20Guardian%20%28Animated%20Armor%29.webp#token)
...
***Antimagic Susceptibility.*** The stone guardian is [incapacitated](2-Mechanics/CLI/rules/conditions.md#Incapacitated) while in the area of an [antimagic field](2-Mechanics/CLI/spells/antimagic-field.md). If targeted by [dispel magic](2-Mechanics/CLI/spells/dispel-magic.md), the stone guardian must succeed on a Constitution saving throw against the caster's spell save DC or fall [unconscious](2-Mechanics/CLI/rules/conditions.md#Unconscious) for 1 minute.

***False Appearance.*** While the stone guardian remains motionless, it is indistinguishable from a normal suit of stone guardian.

## Actions

***Multiattack.*** The stone guardian makes two melee attacks.
