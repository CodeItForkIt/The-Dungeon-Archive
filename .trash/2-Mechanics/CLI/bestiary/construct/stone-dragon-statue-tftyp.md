...
***Steam Breath.*** The statue exhales steam in a line that is 30 feet long and 10 feet wide. Each creature in that area must make a DC 15 Constitution saving throw, taking `dice:2d4+2|noform|avg|text(7)` (`2d4 + 2`) fire damage on a failed save, or half as much damage on a successful one.
```
^statblock