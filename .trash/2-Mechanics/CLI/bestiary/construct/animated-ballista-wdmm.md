...
```ad-statblock
title: Animated Ballista
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/WDMM/Animated%20Ballista.webp#token)
...
***Magic Bolt.*** *Ranged Weapon Attack:* `dice:1d20+6|noform|text(+6)` to hit, range 120 ft., one target. *Hit:* `dice:3d10|noform|avg|text(16)` (`3d10`) fire damage
```
^statblock