...
***Fist.*** *Melee Weapon Attack:* `dice:1d20+13|noform|text(+13)` to hit (with advantage if the colossus is berserk), reach 20 ft., one target. *Hit:* `dice:3d6+7|noform|avg|text(17)` (`3d6 + 7`) bludgeoning damage. If the target is a Large or smaller creature, it is pulled up to 15 feet toward the colossus, it has the [grappled](2-Mechanics/CLI/rules/conditions.md#Grappled) condition (escape DC 17), and it has the [restrained](2-Mechanics/CLI/rules/conditions.md#Restrained) condition until this grapple ends. The colossus can have up to two creatures [grappled](2-Mechanics/CLI/rules/conditions.md#Grappled) this way at a time.

***Elemental Breath (Recharge 5-6).*** The colossus exhales a cloud swirling with elemental energy in a 90-foot cone. Each creature in that area must make a DC 21 Dexterity saving throw. On a failed save, a creature takes `dice:9d8|noform|avg|text(40)` (`9d8`) damage of a type of the colossus's choosing: acid, cold, fire, or lightning. On a successful save, a creature takes half as much damage.

At the same time as the colossus releases this exhalation, creatures inside the colossus's chest cavity take `dice:9d8|noform|avg|text(40)` (`9d8`) force damage from churning elemental energy.

## Bonus Actions

***Bite.*** *Melee Weapon Attack:* `dice:1d20+13|noform|text(+13)` to hit, reach 5 ft., one Large or smaller creature [grappled](2-Mechanics/CLI/rules/conditions.md#Grappled) by the colossus. *Hit:* `dice:3d8+7|noform|avg|text(20)` (`3d8 + 7`) bludgeoning damage, and the creature is swallowed. A swallowed creature has the [restrained](2-Mechanics/CLI/rules/conditions.md#Restrained) condition, has total cover against attacks and other effects outside the colossus, and takes `dice:3d6|noform|avg|text(10)` (`3d6`) force damage at the start of each of the colossus's turns.
