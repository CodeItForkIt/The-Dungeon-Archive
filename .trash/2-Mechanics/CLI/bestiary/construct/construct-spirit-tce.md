...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/TCE/Construct%20Spirit.webp#token)
...
***Heated Body (Metal Only).*** A creature that touches the construct or hits it with a melee attack while within 5 feet of it takes `dice:1d10|noform|avg` (`1d10`) fire damage.
