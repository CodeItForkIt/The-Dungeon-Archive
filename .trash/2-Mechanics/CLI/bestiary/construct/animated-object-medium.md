...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/PHB/Animated%20Object%20%28Medium%29.webp#token)
...
***Slam.*** *Melee Weapon Attack:* `dice:1d20+5|noform|text(+5)` to hit, reach 5 ft., one target. *Hit:* `dice:2d6+1|noform|avg|text(7)` (`2d6 + 1`) bludgeoning damage.
```
^statblock