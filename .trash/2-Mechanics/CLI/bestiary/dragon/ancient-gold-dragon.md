...
- **Fire Breath.** The dragon exhales fire in a 90-foot cone. Each creature in that area must make a DC 24 Dexterity saving throw, taking `dice:13d10|noform|avg|text(71)` (`13d10`) fire damage on a failed save, or half as much damage on a successful one.  
...
![Gold Dragon](2-Mechanics/CLI/bestiary/legendary-group/gold-dragon.md)
```
^statblock
