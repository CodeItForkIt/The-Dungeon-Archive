...
*Source: Monster Manual p. 109, Dragons of Stormwreck Isle. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>*  
...
- **Lightning Breath.** The dragon exhales lightning in a 40-foot line that is 5 feet wide. Each creature in that line must make a DC 12 Dexterity saving throw, taking `dice:3d10|noform|avg|text(16)` (`3d10`) lightning damage on a failed save, or half as much damage on a successful one.  
