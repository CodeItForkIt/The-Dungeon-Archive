...
---
# Young Black Dragon
*Source: Monster Manual p. 88, The Rise of Tiamat, Tales from the Yawning Portal, Ghosts of Saltmarsh, Baldur's Gate: Descent Into Avernus, Lightning Keep. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>*  
...
***Bite.*** *Melee Weapon Attack:* `dice:1d20+7|noform|text(+7)` to hit, reach 10 ft., one target. *Hit:* `dice:2d10+4|noform|avg|text(15)` (`2d10 + 4`) piercing damage plus `dice:1d8|noform|avg|text(4)` (`1d8`) acid damage.
...
***Acid Breath (Recharge 5-6).*** The dragon exhales acid in a 30-foot line that is 5 feet wide. Each creature in that line must make a DC 14 Dexterity saving throw, taking `dice:11d8|noform|avg|text(49)` (`11d8`) acid damage on a failed save, or half as much damage on a successful one.
```
^statblock
