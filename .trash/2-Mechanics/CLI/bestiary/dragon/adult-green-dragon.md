...
---
# Adult Green Dragon
*Source: Monster Manual p. 94, The Rise of Tiamat, Ghosts of Saltmarsh, Candlekeep Mysteries. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>*  
...
***Bite.*** *Melee Weapon Attack:* `dice:1d20+11|noform|text(+11)` to hit, reach 10 ft., one target. *Hit:* `dice:2d10+6|noform|avg|text(17)` (`2d10 + 6`) piercing damage plus `dice:2d6|noform|avg|text(7)` (`2d6`) poison damage.
...
***Poison Breath (Recharge 5-6).*** The dragon exhales poisonous gas in a 60-foot cone. Each creature in that area must make a DC 18 Constitution saving throw, taking `dice:16d6|noform|avg|text(56)` (`16d6`) poison damage on a failed save, or half as much damage on a successful one.
...
![Green Dragon](2-Mechanics/CLI/bestiary/legendary-group/green-dragon.md)
```
^statblock
