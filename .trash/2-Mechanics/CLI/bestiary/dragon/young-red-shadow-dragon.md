...
*Source: Monster Manual p. 85, Adventure Atlas: The Mortuary, Quests from the Infinite Staircase*  
...
***Bite.*** *Melee Weapon Attack:* `dice:1d20+11|noform|text(+11)` to hit, reach 10 ft., one target. *Hit:* `dice:2d10+6|noform|avg|text(17)` (`2d10 + 6`) piercing damage plus `dice:1d6|noform|avg|text(3)` (`1d6`) necrotic damage.
...
***Shadow Breath (Recharge 5-6).*** The dragon exhales shadowy fire in a 30-foot cone. Each creature in that area must make a DC 18 Dexterity saving throw, taking `dice:16d6|noform|avg|text(56)` (`16d6`) necrotic damage on a failed save, or half as much damage on a successful one. A humanoid reduced to 0 hit points by this damage dies, and an undead [shadow](2-Mechanics/CLI/bestiary/undead/shadow.md) rises from its corpse and acts immediately after the dragon in the initiative count. The shadow is under the dragon's control.
```
^statblock
