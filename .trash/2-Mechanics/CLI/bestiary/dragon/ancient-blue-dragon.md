...
***Lightning Breath (Recharge 5-6).*** The dragon exhales lightning in a 120-foot line that is 10 feet wide. Each creature in that line must make a DC 23 Dexterity saving throw, taking `dice:16d10|noform|avg|text(88)` (`16d10`) lightning damage on a failed save, or half as much damage on a successful one.
