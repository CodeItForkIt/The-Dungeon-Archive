...
- **Fire Breath.** The dragon exhales fire in a 30-foot cone. Each creature in that area must make a DC 17 Dexterity saving throw, taking `dice:10d10|noform|avg|text(55)` (`10d10`) fire damage on a failed save, or half as much damage on a successful one.  
