...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/ToB1-2023/Ancient%20Flame%20Dragon.webp#token)
...
***Heated Body.*** A creature that touches the flame dragon or hits it with a melee attack while within 5 feet of it takes `dice:4d6|noform|avg|text(14)` (`4d6`) fire damage.
...
***Bite.*** *Melee Weapon Attack:* `dice:1d20+13|noform|text(+13)` to hit, reach 15 ft., one target. *Hit:* `dice:2d10+6|noform|avg|text(17)` (`2d10 + 6`) piercing damage plus `dice:4d6|noform|avg|text(14)` (`4d6`) fire damage.
...
***Tail.*** *Melee Weapon Attack:* `dice:1d20+13|noform|text(+13)` to hit, reach 20 ft., one target. *Hit:* `dice:2d8+6|noform|avg|text(15)` (`2d8 + 6`) bludgeoning damage.
