...
- **Cold Breath.** The dragon exhales an icy blast in a 90-foot cone. Each creature in that area must make a DC 24 Constitution saving throw, taking `dice:15d8|noform|avg|text(67)` (`15d8`) cold damage on a failed save, or half as much damage on a successful one.  
