...
---
# Adult Copper Dragon
*Source: Monster Manual p. 112, Ghosts of Saltmarsh, Candlekeep Mysteries, Sigil and the Outlands, Turn of Fortune's Wheel. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>*  
...
***Bite.*** *Melee Weapon Attack:* `dice:1d20+11|noform|text(+11)` to hit, reach 10 ft., one target. *Hit:* `dice:2d10+6|noform|avg|text(17)` (`2d10 + 6`) piercing damage.
...
- **Acid Breath.** The dragon exhales acid in a 60-foot line that is 5 feet wide. Each creature in that line must make a DC 18 Dexterity saving throw, taking `dice:12d8|noform|avg|text(54)` (`12d8`) acid damage on a failed save, or half as much damage on a successful one.  
...
![Copper Dragon](2-Mechanics/CLI/bestiary/legendary-group/copper-dragon.md)
```
^statblock
