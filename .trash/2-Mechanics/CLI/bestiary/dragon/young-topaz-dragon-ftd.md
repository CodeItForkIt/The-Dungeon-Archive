...
**1/day each**: [bane](2-Mechanics/CLI/spells/bane.md), [create or destroy water](2-Mechanics/CLI/spells/create-or-destroy-water.md)

## Actions

***Multiattack.*** The dragon makes one Bite attack and two Claw attacks.

***Bite.*** *Melee Weapon Attack:* `dice:1d20+6|noform|text(+6)` to hit, reach 10 ft., one target. *Hit:* `dice:2d10+3|noform|avg|text(14)` (`2d10 + 3`) piercing damage plus `dice:1d6|noform|avg|text(3)` (`1d6`) necrotic damage.
