...
**1/day each**: [blink](2-Mechanics/CLI/spells/blink.md), [control water](2-Mechanics/CLI/spells/control-water.md), [dispel magic](2-Mechanics/CLI/spells/dispel-magic.md), [protection from evil and good](2-Mechanics/CLI/spells/protection-from-evil-and-good.md), [sending](2-Mechanics/CLI/spells/sending.md)

## Actions

***Multiattack.*** The dragon makes one Bite attack and two Claw attacks.

***Bite.*** *Melee Weapon Attack:* `dice:1d20+12|noform|text(+12)` to hit, reach 10 ft., one target. *Hit:* `dice:2d10+7|noform|avg|text(18)` (`2d10 + 7`) piercing damage plus `dice:2d8|noform|avg|text(9)` (`2d8`) force damage.

***Claw.*** *Melee Weapon Attack:* `dice:1d20+12|noform|text(+12)` to hit, reach 10 ft., one target. *Hit:* `dice:1d8+7|noform|avg|text(11)` (`1d8 + 7`) slashing damage.
