...
---
# Young Copper Dragon
*Source: Monster Manual p. 112, Storm King's Thunder, Sigil and the Outlands. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>*  
...
- **Acid Breath.** The dragon exhales acid in a 40-foot line that is 5 feet wide. Each creature in that line must make a DC 14 Dexterity saving throw, taking `dice:9d8|noform|avg|text(40)` (`9d8`) acid damage on a failed save, or half as much damage on a successful one.  
