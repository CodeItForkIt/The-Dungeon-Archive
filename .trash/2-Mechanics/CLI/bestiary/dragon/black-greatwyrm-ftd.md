...
***Breath Weapon (Recharge 5-6).*** The greatwyrm exhales a blast of energy in a 300-foot cone. Each creature in that area must make a DC 26 Dexterity saving throw. On a failed save, the creature takes `dice:12d12|noform|avg|text(78)` (`12d12`) acid damage. On a successful save, the creature takes half as much damage.
