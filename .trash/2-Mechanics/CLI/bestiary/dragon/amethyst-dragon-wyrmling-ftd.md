...
**1/day each**: [protection from evil and good](2-Mechanics/CLI/spells/protection-from-evil-and-good.md), [Tenser's floating disk](2-Mechanics/CLI/spells/tensers-floating-disk.md), [unseen servant](2-Mechanics/CLI/spells/unseen-servant.md)

## Actions

***Bite.*** *Melee Weapon Attack:* `dice:1d20+6|noform|text(+6)` to hit, reach 5 ft., one target. *Hit:* `dice:1d10+4|noform|avg|text(9)` (`1d10 + 4`) piercing damage plus `dice:1d8|noform|avg|text(4)` (`1d8`) force damage.

***Singularity Breath (Recharge 5-6).*** The dragon creates a shining bead of gravitational force in its mouth, then releases the energy in a 15-foot cone. Each creature in that area must make a DC 13 Strength saving throw. On a failed save, the creature takes `dice:5d8|noform|avg|text(22)` (`5d8`) force damage, and its speed becomes 0 until the start of the dragon's next turn. On a successful save, the creature takes half as much damage, and its speed isn't reduced.
```
^statblock