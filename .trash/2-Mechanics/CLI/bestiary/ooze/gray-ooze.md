...
---
# Gray Ooze
*Source: Monster Manual p. 243, Curse of Strahd, Hoard of the Dragon Queen, Tales from the Yawning Portal, Waterdeep: Dragon Heist, Ghosts of Saltmarsh, Keys from the Golden Vault, Phandelver and Below: The Shattered Obelisk. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>*  
...
***Pseudopod.*** *Melee Weapon Attack:* `dice:1d20+3|noform|text(+3)` to hit, reach 5 ft., one target. *Hit:* `dice:1d6+1|noform|avg|text(4)` (`1d6 + 1`) bludgeoning damage plus `dice:2d6|noform|avg|text(7)` (`2d6`) acid damage, and if the target is wearing nonmagical metal armor, its armor is partly corroded and takes a permanent and cumulative −1 penalty to the AC it offers. The armor is destroyed if the penalty reduces its AC to 10.
```
^statblock
