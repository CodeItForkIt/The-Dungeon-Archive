...
```ad-statblock
title: Swarm of Rats
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MM/Swarm%20of%20Rats.webp#token)
...
***Keen Smell.*** The swarm has advantage on Wisdom ([Perception](2-Mechanics/CLI/rules/skills.md#Perception)) checks that rely on smell.

***Swarm.*** The swarm can occupy another creature's space and vice versa, and the swarm can move through any opening large enough for a Tiny rat. The swarm can't regain hit points or gain temporary hit points.

## Actions

***Bites.*** *Melee Weapon Attack:* `dice:1d20+2|noform|text(+2)` to hit, reach 0 ft., one target in the swarm's space. *Hit:* `dice:2d6|noform|avg|text(7)` (`2d6`) piercing damage, or `dice:1d6|noform|avg|text(3)` (`1d6`) piercing damage if the swarm has half of its hit points or fewer.
```
^statblock
