...
---
# Swarm of Centipedes
*Source: Monster Manual p. 338, Curse of Strahd, Hoard of the Dragon Queen, Waterdeep: Dungeon of the Mad Mage. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>*  
...
A creature reduced to 0 hit points by a swarm of centipedes is stable but [poisoned](2-Mechanics/CLI/rules/conditions.md#Poisoned) for 1 hour, even after regaining hit points, and [paralyzed](2-Mechanics/CLI/rules/conditions.md#Paralyzed) while [poisoned](2-Mechanics/CLI/rules/conditions.md#Poisoned) in this way.
```
^statblock
