...
```ad-statblock
title: Vaal
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/SKT/Vaal.webp#token)
...
***Keen Smell.*** Vaal has advantage on Wisdom ([Perception](2-Mechanics/CLI/rules/skills.md#Perception)) checks that rely on smell.
