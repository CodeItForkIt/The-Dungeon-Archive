...
```ad-statblock
title: Buer
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/CoA/Buer.webp#token)
...
- **Proficiency Bonus** +7
- **Saving Throws** Strength +15, Dexterity +13, Constitution +14
...
***Contractually Obligated.*** Buer has advantage to hit creatures under an infernal contract and when she hits such creatures she delivers an additional `dice:2d8|noform|avg|text(9)` (`2d8`) damage of a type the target is most vulnerable to. A creature bound under an infernal contract also makes all saving throws against effects originating from Buer with disadvantage.
...
***Claw.*** *Melee Weapon Attack:* `dice:1d20+13|noform|text(+13)` to hit, reach 10 ft., one target. *Hit:* `dice:3d10+6|noform|avg|text(22)` (`3d10 + 6`) slashing damage.

***Cleansing Bite.*** *Melee Weapon Attack:* `dice:1d20+13|noform|text(+13)` to hit, reach 5 ft., one target. *Hit:* `dice:2d12+6|noform|avg|text(19)` (`2d12 + 6`) bludgeoning damage, healing Buer for an amount equal to the damage dealt.

***Spectral Reaping (Recharge 6).*** Buer focuses her ethereal form, dashing up to 50 feet in a straight line through the ethereal plane. Any creatures in the line must make a DC 21 Constitution saving throw, taking `dice:12d6|noform|avg|text(42)` (`12d6`) force damage on a failed save, or half as much damage on a successful one. Buer may reappear at any unoccupied space along the line. For 1 minute after using Spectral Reaping, Buer is empowered by ethereal essence. Her Cleansing Bite attack now deals force damage instead of bludgeoning.
...
***Backdoor Clause.*** Buer wreathes energy around a creature she can see within 60 feet of her. Until the end of Buer's next turn, the target is covered in fire or cold energy, Buer's choice. Each time the target is struck with a melee attack, the attacker takes `dice:2d8|noform|avg|text(9)` (`2d8`) fire or cold damage.
