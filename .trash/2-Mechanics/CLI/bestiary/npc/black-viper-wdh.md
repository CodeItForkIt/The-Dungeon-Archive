...
***Sneak Attack (1/Turn).*** The Black Viper deals an extra `dice:4d6|noform|avg|text(14)` (`4d6`) damage when she hits a target with a weapon attack and has advantage on the attack roll, or when the target is within 5 feet of an ally of the Black Viper that isn't [incapacitated](2-Mechanics/CLI/rules/conditions.md#Incapacitated) and the Black Viper doesn't have disadvantage on the attack roll.

## Actions

***Multiattack.*** The Black Viper makes three attacks with her rapier.

***Rapier.*** *Melee Weapon Attack:* `dice:1d20+7|noform|text(+7)` to hit, reach 5 ft., one target. *Hit:* `dice:1d8+4|noform|avg|text(7)` (`1d8 + 4`) piercing damage.

***Hand Crossbow.*** *Ranged Weapon Attack:* `dice:1d20+7|noform|text(+7)` to hit, range 30/120 ft., one target. *Hit:* `dice:1d6+4|noform|avg|text(7)` (`1d6 + 4`) piercing damage.
