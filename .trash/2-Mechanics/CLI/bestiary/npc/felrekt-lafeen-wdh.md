...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/WDH/Fel%27rekt%20Lafeen.webp#token)
...
***Fey Ancestry.*** Fel'rekt has advantage on saving throws against being [charmed](2-Mechanics/CLI/rules/conditions.md#Charmed), and magic can't put Fel'rekt to sleep.
...
***Sunlight Sensitivity.*** While in sunlight, Fel'rekt has disadvantage on attack rolls, as well as on Wisdom ([Perception](2-Mechanics/CLI/rules/skills.md#Perception)) checks that rely on sight.
