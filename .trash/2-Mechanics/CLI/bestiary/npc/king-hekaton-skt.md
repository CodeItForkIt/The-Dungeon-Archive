...
**At will**: [detect magic](2-Mechanics/CLI/spells/detect-magic.md), [feather fall](2-Mechanics/CLI/spells/feather-fall.md), [levitate](2-Mechanics/CLI/spells/levitate.md), [light](2-Mechanics/CLI/spells/light.md)
...
***Broken Chain.*** *Melee Weapon Attack:* `dice:1d20+14|noform|text(+14)` to hit, reach 10 ft., one target. *Hit:* `dice:3d6+9|noform|avg|text(18)` (`3d6 + 9`) bludgeoning damage.

***Ballista.*** *Ranged Weapon Attack:* `dice:1d20+6|noform|text(+6)` to hit, range 120/480 ft., one target. *Hit:* `dice:3d10+2|noform|avg|text(18)` (`3d10 + 2`) piercing damage.
...
***Thunderous Stomp (Recharge 6).*** Hekaton stomps the ground, triggering a thunderclap. All other creatures within 15 feet of him must succeed on a DC 17 Constitution saving throw or take `dice:6d10|noform|avg|text(33)` (`6d10`) thunder damage and be [deafened](2-Mechanics/CLI/rules/conditions.md#Deafened) until the start of Hekaton's next turn. On a successful save, a creature takes half as much damage and isn't [deafened](2-Mechanics/CLI/rules/conditions.md#Deafened). The thunderclap can be heard out to a range of 1,200 feet.
```
^statblock