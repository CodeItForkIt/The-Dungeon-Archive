...
***Ambusher.*** In the first round of a combat, Bonnie has advantage on attack rolls against any creature it [surprised](2-Mechanics/CLI/rules/conditions.md#Surprised).

***Surprise Attack.*** If Bonnie surprises a creature and hits it with an attack during the first round of combat, the target takes an extra `dice:3d6|noform|avg|text(10)` (`3d6`) damage from the attack.
