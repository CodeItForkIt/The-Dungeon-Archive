...
```ad-statblock
title: Figaro
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/VEoR/Figaro.webp#token)
...
***Spellcasting.*** Figaro is a 9th-level spellcaster. Its spellcasting ability is Intelligence (spell save DC 14, `dice:1d20+6|noform|text(+6)` to hit with spell attacks). Figaro has the following wizard spells prepared:
