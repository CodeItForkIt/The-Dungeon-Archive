...
***Dread.*** Any creature, other than a devil, that starts its turn within 10 feet of Bael must succeed on a DC 22 Wisdom saving throw or be [frightened](2-Mechanics/CLI/rules/conditions.md#Frightened) of him until the start of its next turn. A creature succeeds on this saving throw automatically if Bael wishes it or if he is [incapacitated](2-Mechanics/CLI/rules/conditions.md#Incapacitated).
...
**At will**: [alter self](2-Mechanics/CLI/spells/alter-self.md) (can become Medium), [charm person](2-Mechanics/CLI/spells/charm-person.md), [detect magic](2-Mechanics/CLI/spells/detect-magic.md), [invisibility](2-Mechanics/CLI/spells/invisibility.md), [major image](2-Mechanics/CLI/spells/major-image.md)

**1/day**: [dominate monster](2-Mechanics/CLI/spells/dominate-monster.md)

**3/day each**: [dispel magic](2-Mechanics/CLI/spells/dispel-magic.md), [fly](2-Mechanics/CLI/spells/fly.md), [suggestion](2-Mechanics/CLI/spells/suggestion.md), [wall of fire](2-Mechanics/CLI/spells/wall-of-fire.md)

## Actions

***Multiattack.*** Bael makes two Hellish Morningstar attacks.

***Hellish Morningstar.*** *Melee Weapon Attack:* `dice:1d20+13|noform|text(+13)` to hit, reach 20 ft., one target. *Hit:* `dice:2d8+7|noform|avg|text(16)` (`2d8 + 7`) force damage plus `dice:2d8|noform|avg|text(9)` (`2d8`) necrotic damage.

***Infernal Command.*** Each of Bael's allies within 60 feet of him can't be [charmed](2-Mechanics/CLI/rules/conditions.md#Charmed) or [frightened](2-Mechanics/CLI/rules/conditions.md#Frightened) until the end of his next turn.
