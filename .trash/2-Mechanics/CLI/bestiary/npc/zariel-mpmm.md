...
***Devil's Sight.*** Magical darkness doesn't impede Zariel's [darkvision](2-Mechanics/CLI/rules/senses.md#Darkvision).
...
![Zariel](2-Mechanics/CLI/bestiary/legendary-group/zariel-mpmm.md)
```
^statblock