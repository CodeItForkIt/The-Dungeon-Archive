...
```ad-statblock
title: Yinra Emberwind
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/EGW/Yinra%20Emberwind.webp#token)
...
***Fey Ancestry.*** Yinra has advantage on saving throws against being [charmed](2-Mechanics/CLI/rules/conditions.md#Charmed), and magic can't put her to sleep.

***Keen Hearing and Sight.*** Yinra has advantage on Wisdom ([Perception](2-Mechanics/CLI/rules/skills.md#Perception)) checks that rely on hearing or sight.
