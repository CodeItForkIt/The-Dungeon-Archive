...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/CoS/Kasimir%20Velikov.webp#token)
...
***Fey Ancestry.*** Kasimir has advantage on saving throws against being [charmed](2-Mechanics/CLI/rules/conditions.md#Charmed), and magic can't put the him to sleep.

***Special Equipment.*** Kasimir wears a [ring of warmth](2-Mechanics/CLI/items/ring-of-warmth.md) and carries a spellbook containing all the spells he has prepared plus the following spells: [arcane lock](2-Mechanics/CLI/spells/arcane-lock.md), [comprehend languages](2-Mechanics/CLI/spells/comprehend-languages.md), [hold person](2-Mechanics/CLI/spells/hold-person.md), [identify](2-Mechanics/CLI/spells/identify.md), [locate object](2-Mechanics/CLI/spells/locate-object.md), [nondetection](2-Mechanics/CLI/spells/nondetection.md), [polymorph](2-Mechanics/CLI/spells/polymorph.md), [protection from evil and good](2-Mechanics/CLI/spells/protection-from-evil-and-good.md), and [wall of stone](2-Mechanics/CLI/spells/wall-of-stone.md).

***Spellcasting.*** Kasimir is a 9th-level spellcaster. His spellcasting ability is Intelligence (spell save DC 14, `dice:1d20+6|noform|text(+6)` to hit with spell attacks). Kasimir has the following wizard spells prepared:
