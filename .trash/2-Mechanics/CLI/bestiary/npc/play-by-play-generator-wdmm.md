...
```ad-statblock
title: Play-by-Play Generator
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/WDMM/Play-by-Play%20Generator.webp#token)
...
***Magic Dart.*** The generator hurls a magic dart at a target it can see up to 60 feet away from it. The dart hits its target automatically (no attack roll required) for `dice:2d4|noform|avg|text(5)` (`2d4`) force damage.
```
^statblock