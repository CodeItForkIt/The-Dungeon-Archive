...
```ad-statblock
title: Xocopol
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/JttRC/Xocopol.webp#token)
*Huge giant, Neutral*
...
***Multiattack.*** The giant makes two greathammer attacks.

***Greathammer.*** *Melee Weapon Attack:* `dice:1d20+11|noform|text(+11)` to hit, reach 10 ft., one target. *Hit:* `dice:6d6+7|noform|avg|text(28)` (`6d6 + 7`) bludgeoning damage.
