...
```ad-statblock
title: Otto Belview
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/CoS/Otto%20Belview.webp#token)
...
***Mimicry.*** Otto can mimic any sounds it has heard, including voices. A creature that hears the sounds can tell they are imitations with a successful DC 12 Wisdom ([Insight](2-Mechanics/CLI/rules/skills.md#Insight)) check.
