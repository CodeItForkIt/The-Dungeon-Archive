...
***Special Equipment.*** Zalto wears a [ring of lightning resistance](2-Mechanics/CLI/items/ring-of-lightning-resistance.md).

***Tackle.*** When Zalto enters any enemy's space for the first time on a turn, the enemy must succeed on a DC 19 Strength saving throw or be knocked [prone](2-Mechanics/CLI/rules/conditions.md#Prone).

## Actions

***Multiattack.*** Zalto makes two maul attacks.

***Maul.*** *Melee Weapon Attack:* `dice:1d20+11|noform|text(+11)` to hit, reach 10 ft., one target. *Hit:* `dice:6d6+7|noform|avg|text(28)` (`6d6 + 7`) bludgeoning damage.
