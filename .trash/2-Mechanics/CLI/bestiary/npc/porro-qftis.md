...
```ad-statblock
title: Porro
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/QftIS/Porro.webp#token)
...
***Halfling Nimbleness.*** Porro

***Brave.*** Porro

***Spellcasting.*** Porro casts one of the following spells, using Intelligence as the spellcasting ability (spell save DC 13):
...
***Multiattack.*** Porro makes two Arcane Burst attacks and can use Starry Radiance if available.
...
***Starry Radiance (Recharge 5-6).*** Dazzling light bursts from Porro's fingertips in a 15-foot cone. Each creature in that area must succeed on a DC 13 Constitution saving throw or have the [blinded](2-Mechanics/CLI/rules/conditions.md#Blinded) condition until the end of Porro's next turn.
```
^statblock