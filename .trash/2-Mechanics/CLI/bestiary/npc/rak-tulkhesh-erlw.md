...
***Whirlwind of Weapons.*** A magical aura of weapons surrounds Rak Tulkhesh in a 10 foot radius. At the start of each of his turns, any other creature in the aura takes `dice:4d6|noform|avg|text(14)` (`4d6`) force damage.
...
**At will**: [detect thoughts](2-Mechanics/CLI/spells/detect-thoughts.md), [dispel magic](2-Mechanics/CLI/spells/dispel-magic.md), [spirit guardians](2-Mechanics/CLI/spells/spirit-guardians.md)

**1/day each**: [banishing smite](2-Mechanics/CLI/spells/banishing-smite.md), [blinding smite](2-Mechanics/CLI/spells/blinding-smite.md), [staggering smite](2-Mechanics/CLI/spells/staggering-smite.md)

## Actions

***Multiattack.*** Rak Tulkhesh makes four weapon attacks.

***Spawned Melee Weapon.*** *Melee Weapon Attack:* `dice:1d20+17|noform|text(+17)` to hit, reach 10 ft., one target. *Hit:* `dice:3d12+9|noform|avg|text(28)` (`3d12 + 9`) force damage.

***Spawned Ranged Weapon.*** *Ranged Weapon Attack:* `dice:1d20+12|noform|text(+12)` to hit, range 150/600 ft., one target. *Hit:* `dice:3d8+4|noform|avg|text(17)` (`3d8 + 4`) force damage.
...
***End Magic (Costs 2 Actions).*** Rak Tulkhesh casts [dispel magic](2-Mechanics/CLI/spells/dispel-magic.md).
