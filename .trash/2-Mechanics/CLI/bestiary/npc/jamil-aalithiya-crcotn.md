...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/CRCotN/Jamil%20A%27alithiya.webp#token)
*Medium humanoid (human, monk, wizard), Chaotic Good*
...
***Unarmored Defense.*** While Jamil is wearing no armor and wielding no shield, its AC includes its Wisdom modifier.

***Spellcasting.*** Jamil casts one of the following spells, requiring no material components and using Wisdom as the spellcasting ability (spell save DC 18):
...
***Multiattack.*** Jamil makes three Force Strike attacks and uses Brain Burn (if available).
