...
```ad-statblock
title: Corrin Delmaco
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/ERLW/Corrin%20Delmaco.webp#token)
...
***Sneak Attack (1/Turn).*** Corrin deals an extra `dice:2d6|noform|avg|text(7)` (`2d6`) damage when it hits a target with a weapon attack and has advantage on the attack roll, or when the target is within 5 feet of an ally of Corrin that isn't [incapacitated](2-Mechanics/CLI/rules/conditions.md#Incapacitated) and Corrin doesn't have disadvantage on the attack roll.

***Halfling Nimbleness.*** Corrin
