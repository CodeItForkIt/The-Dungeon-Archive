...
***Sneak Attack (1/Turn).*** Samira deals an extra `dice:2d6|noform|avg|text(7)` (`2d6`) damage when it hits a target with a weapon attack and has advantage on the attack roll, or when the target is within 5 feet of an ally of Samira that isn't [incapacitated](2-Mechanics/CLI/rules/conditions.md#Incapacitated) and Samira doesn't have disadvantage on the attack roll.
