...
***Special Equipment.*** Kaevja carries a yellow [elemental gem](2-Mechanics/CLI/items/elemental-gem-dmg.md). As an action she can break the gem releasing an earth elemental under her command.
...
**3rd level (3 slots)**: [counterspell](2-Mechanics/CLI/spells/counterspell.md), [fireball](2-Mechanics/CLI/spells/fireball.md), [sending](2-Mechanics/CLI/spells/sending.md)
