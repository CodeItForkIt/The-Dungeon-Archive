...
```ad-statblock
title: Estia
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/TftYP/Estia.webp#token)
...
***Morningstar +2.*** *Melee Weapon Attack:* `dice:1d20+14|noform|text(+14)` to hit, reach 10 ft., one target. *Hit:* `dice:3d8+10|noform|avg|text(23)` (`3d8 + 10`) piercing damage.
