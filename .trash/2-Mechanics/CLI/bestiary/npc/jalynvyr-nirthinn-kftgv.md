...
***Innate Spellcasting (1/Day).*** Jalynvyr Nir'Thinn can innately cast [dancing lights](2-Mechanics/CLI/spells/dancing-lights.md), requiring no material components. Its innate spellcasting ability is Charisma.
...
***Cinder Breath (Recharge 6).*** Jalynvyr Nir'Thinn exhales a 15-foot cone of smoldering ash. Each creature in that area must succeed on a DC 10 Dexterity saving throw or be [blinded](2-Mechanics/CLI/rules/conditions.md#Blinded) until the end of Jalynvyr Nir'Thinn's next turn.
```
^statblock