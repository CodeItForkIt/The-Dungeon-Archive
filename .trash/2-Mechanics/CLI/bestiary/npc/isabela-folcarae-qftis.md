...
```ad-statblock
title: Isabela Folcarae
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/QftIS/Isabela%20Folcarae.webp#token)
...
***Multiattack.*** Isabela makes three melee attacks: two with its scimitar and one with its dagger. Or Isabela makes two ranged attacks with its daggers.
...
***Parry.*** Isabela adds 2 to its AC against one melee attack that would hit it. To do so, Isabela must see the attacker and be wielding a melee weapon.
```
^statblock