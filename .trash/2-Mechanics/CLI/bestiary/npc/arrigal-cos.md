...
***Assassinate.*** During its first turn, Arrigal has advantage on attack rolls against any creature that hasn't taken a turn. Any hit Arrigal scores against a [surprised](2-Mechanics/CLI/rules/conditions.md#Surprised) creature is a critical hit.
...
***Sneak Attack (1/Turn).*** Arrigal deals an extra `dice:4d6|noform|avg|text(14)` (`4d6`) damage when it hits a target with a weapon attack and has advantage on the attack roll, or when the target is within 5 feet of an ally of Arrigal that isn't [incapacitated](2-Mechanics/CLI/rules/conditions.md#Incapacitated) and Arrigal doesn't have disadvantage on the attack roll.
