...
```ad-statblock
title: Vilnius
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/CoS/Vilnius.webp#token)
...
***Spellcasting.*** Vilnius is a 9th-level spellcaster. Its spellcasting ability is Intelligence (spell save DC 14, `dice:1d20+6|noform|text(+6)` to hit with spell attacks). Vilnius has the following wizard spells prepared:
