...
***Innate Spellcasting.*** Embric's spellcasting ability is Constitution (`dice:1d20+4|noform|text(+4)` to hit with spell attacks). He can innately cast the following spells, requiring no material components:
