...
```ad-statblock
title: Grunka
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/OoW/Grunka.webp#token)
...
***Martial Advantage.*** Once per turn, Grunka can deal an extra `dice:2d6|noform|avg|text(7)` (`2d6`) damage to a creature it hits with a weapon attack if that creature is within 5 feet of an ally of Grunka that isn't [incapacitated](2-Mechanics/CLI/rules/conditions.md#Incapacitated).
...
***Acid Spray Gun (Recharge 5-6).*** The hobgoblin sprays acid in a 10-foot cone. Each creature in the area must make a DC 10 Dexterity saving throw, taking `dice:2d6|noform|avg|text(7)` (`2d6`) acid damage on a failed save, or half as much damage on a successful one.
