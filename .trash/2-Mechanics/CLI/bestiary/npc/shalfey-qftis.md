...
***Starry Radiance (Recharge 5-6).*** Dazzling light bursts from Shalfey's fingertips in a 15-foot cone. Each creature in that area must succeed on a DC 13 Constitution saving throw or have the [blinded](2-Mechanics/CLI/rules/conditions.md#Blinded) condition until the end of Shalfey's next turn.
```
^statblock