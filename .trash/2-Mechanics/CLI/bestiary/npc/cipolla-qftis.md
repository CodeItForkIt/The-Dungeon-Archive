...
```ad-statblock
title: Cipolla
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/QftIS/Cipolla.webp#token)
...
***Starry Radiance (Recharge 5-6).*** Dazzling light bursts from Cipolla's fingertips in a 15-foot cone. Each creature in that area must succeed on a DC 13 Constitution saving throw or have the [blinded](2-Mechanics/CLI/rules/conditions.md#Blinded) condition until the end of Cipolla's next turn.
```
^statblock