...
```ad-statblock
title: Losser Mirklav
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/WDH/Losser%20Mirklav.webp#token)
...
***Brave.*** Losser has advantage on saving throws against being [frightened](2-Mechanics/CLI/rules/conditions.md#Frightened).
...
**3rd level (3 slots)**: [animate dead](2-Mechanics/CLI/spells/animate-dead.md), [fireball](2-Mechanics/CLI/spells/fireball.md), [fly](2-Mechanics/CLI/spells/fly.md)
