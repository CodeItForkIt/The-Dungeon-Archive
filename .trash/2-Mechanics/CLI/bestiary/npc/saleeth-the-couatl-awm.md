...
***Bite.*** *Melee Weapon Attack:* `dice:1d20+8|noform|text(+8)` to hit, reach 5 ft., one creature. *Hit:* `dice:1d6+5|noform|avg|text(8)` (`1d6 + 5`) piercing damage, Target must make a DC 13 Constitution save, or fall [unconscious](2-Mechanics/CLI/rules/conditions.md#Unconscious). Another creature can use an action to shake the target awake.

***Constrict.*** *Melee Weapon Attack:* `dice:1d20+6|noform|text(+6)` to hit, reach 10 ft., one Medium or smaller creature. *Hit:* `dice:2d6+3|noform|avg|text(10)` (`2d6 + 3`) bludgeoning damage, Target is [grappled](2-Mechanics/CLI/rules/conditions.md#Grappled) (escape DC 15). The couatl can constrain only one target at a time.
