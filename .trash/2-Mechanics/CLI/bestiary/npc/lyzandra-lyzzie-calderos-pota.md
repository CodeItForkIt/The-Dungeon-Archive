...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/PotA/Lyzandra%20Lyzzie%20Calderos.webp#token)
...
***Spellcasting.*** Lyzandra is a 9th-level spellcaster. Her spellcasting ability is Intelligence (spell save DC 14, `dice:1d20+6|noform|text(+6)` to hit with spell attacks). Lyzandra has the following wizard spells prepared:
...
**4th level (3 slots)**: [greater invisibility](2-Mechanics/CLI/spells/greater-invisibility.md), [wall of fire](2-Mechanics/CLI/spells/wall-of-fire.md)

**5th level (1 slots)**: [immolation](2-Mechanics/CLI/spells/immolation-xge.md)
