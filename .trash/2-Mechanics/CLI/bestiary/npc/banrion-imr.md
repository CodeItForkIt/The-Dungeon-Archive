...
***Healing Touch (3/Day).*** Banrion touches another creature with its horn. The target magically regains `dice:2d8+2|noform|avg|text(11)` (`2d8 + 2`) hit points. In addition, the touch removes all diseases and neutralizes all poisons afflicting the target.
...
***Heal Self (Costs 3 Actions).*** Banrion magically regains `dice:2d8+2|noform|avg|text(11)` (`2d8 + 2`) hit points.
```
^statblock