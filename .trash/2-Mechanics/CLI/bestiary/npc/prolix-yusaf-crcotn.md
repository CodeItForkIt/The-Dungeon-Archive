...
```ad-statblock
title: Prolix Yusaf
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/CRCotN/Prolix%20Yusaf.webp#token)
*Medium humanoid (tiefling, wizard), Lawful Neutral*
...
***Spellcasting.*** Prolix casts one of the following spells, using Intelligence as the spellcasting ability:
...
***Glyph of Shielding.*** Prolix adds 2 to its AC against one attack that would hit it. To do so, Prolix must be able to see the attacker and have a free hand.
```
^statblock