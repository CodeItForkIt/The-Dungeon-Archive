...
***Acid Breath (Recharge 5-6).*** The dracolich exhales acid in a 90-foot line that is 10 feet wide. Each creature in that line must make a DC 22 Dexterity saving throw, taking `dice:15d8|noform|avg|text(67)` (`15d8`) acid damage on a failed save, or half as much damage on a successful one.
