...
***Greatsword.*** *Melee Weapon Attack:* `dice:1d20+11|noform|text(+11)` to hit, reach 10 ft., one target. *Hit:* `dice:6d6+7|noform|avg|text(28)` (`6d6 + 7`) slashing damage plus `dice:2d6|noform|avg|text(7)` (`2d6`) fire damage.
