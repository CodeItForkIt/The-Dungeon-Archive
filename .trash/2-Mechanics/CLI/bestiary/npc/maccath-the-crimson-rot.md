...
```ad-statblock
title: Maccath the Crimson
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/RoT/Maccath%20the%20Crimson.webp#token)
...
***5etools Note.*** Maccath the Crimson is presented in The Rise of Tiamat as a female tiefling sorcerer and member of the Arcane Brotherhood. The [mage](2-Mechanics/CLI/bestiary/humanoid/mage.md) stat block, modified with tiefling racial traits, has been provided here for ease of use.
