...
```ad-statblock
title: Jingle Jangle
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/WBtW/Jingle%20Jangle.webp#token)
...
***Flail of Locks.*** *Melee Weapon Attack:* `dice:1d20+5|noform|text(+5)` to hit, reach 5 ft., one target. *Hit:* `dice:3d4|noform|avg|text(7)` (`3d4`) bludgeoning damage.
```
^statblock