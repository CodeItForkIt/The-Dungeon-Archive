...
***Magic Resistance Aura.*** While holding [Nepenthe](2-Mechanics/CLI/items/nepenthe-vrgr.md), Isolde creates an aura in a 10-foot radius around her. While this aura is active, Isolde and all creatures friendly to her in the aura have advantage on saving throws against spells and other magical effects.
...
***Nepenthe.*** *Melee Weapon Attack:* `dice:1d20+10|noform|text(+10)` to hit, reach 5 ft.., one target. *Hit:* `dice:1d8+7|noform|avg|text(11)` (`1d8 + 7`) slashing damage, or `dice:1d10+7|noform|avg|text(12)` (`1d10 + 7`) slashing damage if used with two hands to make a melee attack. If the target is a fiend or an undead, it takes an extra `dice:2d10|noform|avg|text(11)` (`2d10`) radiant damage.
