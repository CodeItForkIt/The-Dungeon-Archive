...
- **Armor Class** 21 ([+3 plate armor](2-Mechanics/CLI/items/3-armor.md))
...
***Gurt's Greataxe.*** *Melee Weapon Attack:* `dice:1d20+11|noform|text(+11)` to hit, reach 10 ft., one target. *Hit:* `dice:3d12+7|noform|avg|text(26)` (`3d12 + 7`) slashing damage, or `dice:5d12+7|noform|avg|text(39)` (`5d12 + 7`) slashing damage if the target is human.
