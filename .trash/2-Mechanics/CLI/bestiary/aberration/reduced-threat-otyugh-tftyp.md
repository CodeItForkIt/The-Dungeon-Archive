...
***Tentacle.*** *Melee Weapon Attack:* `dice:1d20+4|noform|text(+4)` to hit, reach 10 ft., one target. *Hit:* `dice:1d8+3|noform|avg|text(7)` (`1d8 + 3`) bludgeoning damage plus `dice:1d8|noform|avg|text(4)` (`1d8`) piercing damage.
```
^statblock