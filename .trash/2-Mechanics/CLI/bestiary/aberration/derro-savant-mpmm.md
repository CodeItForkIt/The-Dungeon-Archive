...
***Sunlight Sensitivity.*** While in sunlight, the derro has disadvantage on attack rolls, as well as on Wisdom ([Perception](2-Mechanics/CLI/rules/skills.md#Perception)) checks that rely on sight.
...
**1/day each**: [invisibility](2-Mechanics/CLI/spells/invisibility.md), [sleep](2-Mechanics/CLI/spells/sleep.md), [spider climb](2-Mechanics/CLI/spells/spider-climb.md)

## Actions

***Quarterstaff.*** *Melee Weapon Attack:* `dice:1d20+1|noform|text(+1)` to hit, reach 5 ft., one target. *Hit:* `dice:1d6-1|noform|avg|text(2)` (`1d6 - 1`) bludgeoning damage.

***Chromatic Beam.*** The derro launches a brilliant beam of magical energy in a 5-foot-wide line that is 60 feet long. Each creature in the line must make a DC 12 Dexterity saving throw, taking `dice:6d6|noform|avg|text(21)` (`6d6`) radiant damage on a failed save, or half as much damage on a successful one.
```
^statblock
