...
***Claws.*** *Melee Weapon Attack:* `YourSpellAttack` to hit, reach 5 ft., one target. *Hit:* `1d10 + 3` + the spell's level slashing damage. If the target is a creature, it can't regain hit points until the start of the aberration's next turn.
```
^statblock