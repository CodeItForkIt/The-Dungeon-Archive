...
---
# Neogi Hatchling
*Source: Mordenkainen Presents: Monsters of the Multiverse p. 191, Spelljammer Academy*  
...
***Bite.*** *Melee Weapon Attack:* `dice:1d20+3|noform|text(+3)` to hit, reach 5 ft., one target. *Hit:* `dice:1d4+1|noform|avg|text(3)` (`1d4 + 1`) piercing damage plus `dice:1d6|noform|avg|text(3)` (`1d6`) poison damage, and the target must succeed on a DC 10 Constitution saving throw or become [poisoned](2-Mechanics/CLI/rules/conditions.md#Poisoned) for 1 minute. A target can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success.
```
^statblock
