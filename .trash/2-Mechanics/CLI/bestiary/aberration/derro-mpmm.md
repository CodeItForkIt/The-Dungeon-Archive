...
***Hooked Spear.*** *Melee Weapon Attack:* `dice:1d20+2|noform|text(+2)` to hit, reach 5 ft., one target. *Hit:* `dice:1d6|noform|avg|text(3)` (`1d6`) piercing damage. If the target is Medium or smaller, the derro can choose to deal no damage and knock it [prone](2-Mechanics/CLI/rules/conditions.md#Prone).
