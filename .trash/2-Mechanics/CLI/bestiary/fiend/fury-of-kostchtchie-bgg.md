...
***Chilling Aura.*** A creature that starts its turn within 10 feet of the fury must succeed on a DC 20 Constitution saving throw or take `dice:2d10|noform|avg|text(11)` (`2d10`) cold damage.
...
***Fist.*** *Melee Weapon Attack:* `dice:1d20+13|noform|text(+13)` to hit, reach 10 ft., one target. *Hit:* `dice:2d8+8|noform|avg|text(17)` (`2d8 + 8`) bludgeoning damage plus `dice:3d6|noform|avg|text(10)` (`3d6`) cold damage, or `dice:5d6|noform|avg|text(17)` (`5d6`) cold damage if the target took damage from the fury's Chilling Aura since the end of the fury's last turn.
