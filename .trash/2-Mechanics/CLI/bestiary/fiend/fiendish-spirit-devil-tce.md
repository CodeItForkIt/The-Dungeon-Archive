...
***Hurl Flame.*** *Ranged Spell Attack:* `YourSpellAttack` to hit, range 150 ft., one target. *Hit:* `2d6 + 3` + the spell's level fire damage. If the target is a flammable object that isn't being worn or carried, it also catches fire.
```
^statblock