...
**At will**: [charm person](2-Mechanics/CLI/spells/charm-person.md), [darkness](2-Mechanics/CLI/spells/darkness.md), [detect magic](2-Mechanics/CLI/spells/detect-magic.md), [dispel magic](2-Mechanics/CLI/spells/dispel-magic.md), [gust of wind](2-Mechanics/CLI/spells/gust-of-wind.md)
...
***Oar.*** *Melee Weapon Attack:* `dice:1d20+5|noform|text(+5)` to hit, reach 5 ft., one target. *Hit:* `dice:2d4+3|noform|avg|text(8)` (`2d4 + 3`) fire damage.

***Fear Gaze.*** The merrenoloth targets one creature it can see within 60 feet of it. The target must succeed on a DC 13 Wisdom saving throw or become [frightened](2-Mechanics/CLI/rules/conditions.md#Frightened) of the merrenoloth for 1 minute. The [frightened](2-Mechanics/CLI/rules/conditions.md#Frightened) target can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success.
...
![Merrenoloth](2-Mechanics/CLI/bestiary/legendary-group/merrenoloth-mpmm.md)
```
^statblock
