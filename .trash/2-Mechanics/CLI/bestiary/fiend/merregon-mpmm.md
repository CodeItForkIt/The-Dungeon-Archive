...
***Devil's Sight.*** Magical darkness doesn't impede the merregon's [darkvision](2-Mechanics/CLI/rules/senses.md#Darkvision).
...
***Halberd.*** *Melee Weapon Attack:* `dice:1d20+6|noform|text(+6)` to hit, reach 10 ft., one target. *Hit:* `dice:1d10+4|noform|avg|text(9)` (`1d10 + 4`) slashing damage.
