...
**At will**: [darkness](2-Mechanics/CLI/spells/darkness.md), [detect magic](2-Mechanics/CLI/spells/detect-magic.md), [dispel magic](2-Mechanics/CLI/spells/dispel-magic.md), [invisibility](2-Mechanics/CLI/spells/invisibility.md) (self only)

**3/day each**: [control water](2-Mechanics/CLI/spells/control-water.md), [crown of madness](2-Mechanics/CLI/spells/crown-of-madness.md), [fear](2-Mechanics/CLI/spells/fear.md), [suggestion](2-Mechanics/CLI/spells/suggestion.md)

## Actions

***Multiattack.*** The hydroloth makes two Bite or Claw attacks. It can replace one attack with a use of Spellcasting.

***Bite.*** *Melee Weapon Attack:* `dice:1d20+9|noform|text(+9)` to hit, reach 5 ft., one target. *Hit:* `dice:2d10+5|noform|avg|text(16)` (`2d10 + 5`) force damage plus `dice:2d10|noform|avg|text(9)` (`2d10`) psychic damage.

***Claw.*** *Melee Weapon Attack:* `dice:1d20+9|noform|text(+9)` to hit, reach 5 ft., one target.  *Hit:* `dice:2d8+5|noform|avg|text(14)` (`2d8 + 5`) force damage plus `dice:2d10|noform|avg|text(9)` (`2d10`) psychic damage.

***Steal Memory (1/Day).*** The hydroloth targets one creature it can see within 60 feet of it. The target takes `dice:4d6|noform|avg|text(14)` (`4d6`) psychic damage, and it must make a DC 16 Intelligence saving throw. On a successful save, the target becomes immune to this hydroloth's Steal Memory for 24 hours. On a failed save, the target loses all proficiencies; it can't cast spells; it can't understand language; and if its Intelligence and Charisma scores are higher than 5, they become 5. Each time the target finishes a long rest, it can repeat the saving throw, ending the effect on itself on a success. A [greater restoration](2-Mechanics/CLI/spells/greater-restoration.md) or [remove curse](2-Mechanics/CLI/spells/remove-curse.md) spell cast on the target ends this effect early.
