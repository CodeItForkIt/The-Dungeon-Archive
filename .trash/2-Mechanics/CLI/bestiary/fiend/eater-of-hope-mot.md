...
***Claws.*** *Melee Weapon Attack:* `dice:1d20+7|noform|text(+7)` to hit, reach 5 ft., one target. *Hit:* `dice:1d8+4|noform|avg|text(8)` (`1d8 + 4`) slashing damage plus `dice:2d6|noform|avg|text(7)` (`2d6`) necrotic damage.

***Breath of Hopelessness (Recharge 5-6).*** The eater of hope exhales a miasma of Underworld winds in a 30-foot cone. Each creature in that area must make a DC 14 Charisma saving throw. On a failed save, the target takes `dice:4d12|noform|avg|text(26)` (`4d12`) necrotic damage and is cursed for 1 minute. While cursed in this way, the target takes an extra `dice:1d12|noform|avg|text(6)` (`1d12`) necrotic damage whenever the eater of hope hits it with an attack. On a successful save, the target takes half as much damage and isn't cursed.
```
^statblock