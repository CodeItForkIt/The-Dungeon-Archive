...
***Disgorge (Recharge 6).*** The demon vomits in a 15-foot cube. Each creature in that area must succeed on a DC 11 Dexterity saving throw or take `dice:2d10|noform|avg|text(11)` (`2d10`) acid damage and fall [prone](2-Mechanics/CLI/rules/conditions.md#Prone) in the spew.
```
^statblock
