...
**2/day each**: [disguise self](2-Mechanics/CLI/spells/disguise-self.md), [invisibility](2-Mechanics/CLI/spells/invisibility.md) (self only)
...
***Fist.*** *Melee Weapon Attack:* `dice:1d20+7|noform|text(+7)` to hit, reach 5 ft., one target. *Hit:* `dice:1d10+4|noform|avg|text(9)` (`1d10 + 4`) bludgeoning damage.
```
^statblock