...
***Bite.*** *Melee Weapon Attack:* `dice:1d20+2|noform|text(+2)` to hit, reach 5 ft., one target. *Hit:* `dice:2d4|noform|avg|text(5)` (`2d4`) slashing damage.

***Fork.*** *Melee Weapon Attack:* `dice:1d20+2|noform|text(+2)` to hit, reach 5 ft., one target. *Hit:* `dice:1d6|noform|avg|text(3)` (`1d6`) piercing damage.

***Tail Spine.*** *Ranged Weapon Attack:* `dice:1d20+4|noform|text(+4)` to hit, range 20/80 ft., one target. *Hit:* `dice:1d4+2|noform|avg|text(4)` (`1d4 + 2`) piercing damage plus `dice:1d6|noform|avg|text(3)` (`1d6`) fire damage.
```
^statblock