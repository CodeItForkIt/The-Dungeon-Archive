...
**At will**: [detect thoughts](2-Mechanics/CLI/spells/detect-thoughts.md), [web](2-Mechanics/CLI/spells/web.md)
...
***Slam (Bite in Spider Form).*** *Melee Weapon Attack:* `dice:1d20+6|noform|text(+6)` to hit, reach 5 ft. (10 feet in demon form), one target. *Hit:* `dice:1d6+2|noform|avg|text(5)` (`1d6 + 2`) bludgeoning (piercing in spider form) damage plus `dice:6d6|noform|avg|text(21)` (`6d6`) poison damage.
