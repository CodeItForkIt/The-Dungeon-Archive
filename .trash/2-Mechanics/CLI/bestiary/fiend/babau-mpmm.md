...
**At will**: [darkness](2-Mechanics/CLI/spells/darkness.md), [dispel magic](2-Mechanics/CLI/spells/dispel-magic.md), [fear](2-Mechanics/CLI/spells/fear.md), [heat metal](2-Mechanics/CLI/spells/heat-metal.md), [levitate](2-Mechanics/CLI/spells/levitate.md)

## Actions

***Multiattack.*** The babau makes two Claw attacks. It can replace one attack with a use of Spellcasting or Weakening Gaze.

***Claw.*** *Melee Weapon Attack:* `dice:1d20+6|noform|text(+6)` to hit, reach 5 ft., one target. *Hit:* `dice:1d4+4|noform|avg|text(6)` (`1d4 + 4`) slashing damage plus `dice:1d4|noform|avg|text(2)` (`1d4`) acid damage.
