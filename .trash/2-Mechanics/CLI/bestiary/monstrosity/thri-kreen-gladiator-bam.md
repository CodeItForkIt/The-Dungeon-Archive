...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/BAM/Thri-kreen%20Gladiator.webp#token)
...
***Gythka.*** *Melee Weapon Attack:* `dice:1d20+7|noform|text(+7)` to hit (with advantage if the thri-kreen is missing any hit points), reach 5 ft., one target. *Hit:* `dice:2d8+4|noform|avg|text(13)` (`2d8 + 4`) slashing damage.

***Chatkcha.*** *Ranged Weapon Attack:* `dice:1d20+7|noform|text(+7)` to hit (with advantage if the thri-kreen is missing any hit points), range 30/120 ft., one target. *Hit:* `dice:1d6+4|noform|avg|text(7)` (`1d6 + 4`) slashing damage.
