...
***Claw.*** *Melee Weapon Attack:* `dice:1d20+2|noform|text(+2)` to hit, reach 5 ft., one target. *Hit:* `dice:1d4|noform|avg|text(2)` (`1d4`) slashing damage plus `dice:1d4|noform|avg|text(2)` (`1d4`) cold damage.
```
^statblock