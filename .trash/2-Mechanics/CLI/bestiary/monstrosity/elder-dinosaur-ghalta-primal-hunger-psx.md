...
```ad-statblock
title: Elder Dinosaur (Ghalta, Primal Hunger)
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/PSX/Elder%20Dinosaur%20%28Ghalta%2C%20Primal%20Hunger%29.webp#token)
...
***Uniqueness.*** These statistics are shared by all six elder dinosaurs: [Etali, Primal Storm](2-Mechanics/CLI/bestiary/monstrosity/elder-dinosaur-etali-primal-storm-psx.md), [Ghalta, Primal Hunger](2-Mechanics/CLI/bestiary/monstrosity/elder-dinosaur-ghalta-primal-hunger-psx.md), [Nezahal, Primal Tide](2-Mechanics/CLI/bestiary/monstrosity/elder-dinosaur-nezahal-primal-tide-psx.md), [Tetzimoc, Primal Death](2-Mechanics/CLI/bestiary/monstrosity/elder-dinosaur-tetzimoc-primal-death-psx.md), [Zacama, Primal Calamity](2-Mechanics/CLI/bestiary/monstrosity/elder-dinosaur-zacama-primal-calamity-psx.md), [Zetalpa, Primal Dawn](2-Mechanics/CLI/bestiary/monstrosity/elder-dinosaur-zetalpa-primal-dawn-psx.md)
...
***Bite.*** *Melee Weapon Attack:* `dice:1d20+19|noform|text(+19)` to hit, reach 10 ft., one target. *Hit:* `dice:8d12+10|noform|avg|text(62)` (`8d12 + 10`) piercing damage. If the target is a creature, it is [grappled](2-Mechanics/CLI/rules/conditions.md#Grappled) (escape DC 20). Until this grapple ends, the target is [restrained](2-Mechanics/CLI/rules/conditions.md#Restrained), and the elder dinosaur can't bite another target.

***Stomp.*** *Melee Weapon Attack:* `dice:1d20+19|noform|text(+19)` to hit, reach 5 ft., one target. *Hit:* `dice:8d8+10|noform|avg|text(46)` (`8d8 + 10`) bludgeoning damage.

***Tail.*** *Melee Weapon Attack:* `dice:1d20+19|noform|text(+19)` to hit, reach 20 ft., one target. *Hit:* `dice:8d6+10|noform|avg|text(38)` (`8d6 + 10`) bludgeoning damage. If the target is a creature, it must succeed on a DC 20 Strength saving throw or be knocked [prone](2-Mechanics/CLI/rules/conditions.md#Prone).
