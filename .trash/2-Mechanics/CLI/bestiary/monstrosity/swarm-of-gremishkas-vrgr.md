...
***Bites.*** *Melee Weapon Attack:* `dice:1d20+4|noform|text(+4)` to hit, reach 0 ft., one target in the swarm's space. *Hit:* `dice:3d6+2|noform|avg|text(12)` (`3d6 + 2`) piercing damage, or `dice:1d6+2|noform|avg|text(5)` (`1d6 + 2`) piercing damage if the swarm has half of its hit points or fewer, plus `dice:2d6|noform|avg|text(7)` (`2d6`) force damage.
