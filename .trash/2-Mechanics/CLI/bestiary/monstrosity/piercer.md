...
***Drop.*** *Melee Weapon Attack:* `dice:1d20+3|noform|text(+3)` to hit, one creature directly underneath the piercer. *Hit:* `dice:1d6|noform|avg|text(3)` (`1d6`) piercing damage per 10 feet fallen, up to `dice:6d6|noform|avg|text(21)` (`6d6`). Miss: The piercer takes half the normal falling damage for the distance fallen.
```
^statblock
