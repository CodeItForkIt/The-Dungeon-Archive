...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/PSX/Elder%20Dinosaur%20%28Tetzimoc%2C%20Primal%20Death%29.webp#token)
...
***Spiny Carapace.*** The elder dinosaur is covered in an armored carapace bristling with thick, sharp spines. Any creature that hits or misses Tetzimoc with a melee attack takes `dice:2d6|noform|avg|text(7)` (`2d6`) piercing damage.
...
***Tail.*** *Melee Weapon Attack:* `dice:1d20+19|noform|text(+19)` to hit, reach 20 ft., one target. *Hit:* `dice:4d6+10|noform|avg|text(24)` (`4d6 + 10`) piercing damage. If the target is a creature, it must succeed on a DC 20 Strength saving throw or be knocked [prone](2-Mechanics/CLI/rules/conditions.md#Prone).

***Tail Spikes.*** *Ranged Weapon Attack:* `dice:1d20+9|noform|text(+9)` to hit, range 100/300 ft., two targets. *Hit:* `dice:2d6|noform|avg|text(7)` (`2d6`) piercing damage.
