...
***Constrict.*** *Melee Weapon Attack:* `dice:1d20+3|noform|text(+3)` to hit, reach 10 ft., one target. *Hit:* `dice:2d6|noform|avg|text(7)` (`2d6`) bludgeoning damage, and the target is [grappled](2-Mechanics/CLI/rules/conditions.md#Grappled) (escape DC 11). Until this grapple ends, the target is [restrained](2-Mechanics/CLI/rules/conditions.md#Restrained), and the medusa can't constrict another target.
```
^statblock