...
***Fallible Invisibility.*** The skulk is [invisible](2-Mechanics/CLI/rules/conditions.md#Invisible). This invisibility can be circumvented by three things:
...
***Claw.*** *Melee Weapon Attack:* `dice:1d20+6|noform|text(+6)` to hit, reach 5 ft., one target. *Hit:* `dice:1d4+4|noform|avg|text(6)` (`1d4 + 4`) slashing damage plus `dice:1d6|noform|avg|text(3)` (`1d6`) necrotic damage.
```
^statblock
