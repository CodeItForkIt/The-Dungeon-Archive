...
***Tentacle.*** *Melee Weapon Attack:* `dice:1d20+4|noform|text(+4)` to hit, reach 10 ft., one target. *Hit:* `dice:1d6+4|noform|avg|text(7)` (`1d6 + 4`) bludgeoning damage plus `dice:1d6|noform|avg|text(3)` (`1d6`) piercing damage.
```
^statblock