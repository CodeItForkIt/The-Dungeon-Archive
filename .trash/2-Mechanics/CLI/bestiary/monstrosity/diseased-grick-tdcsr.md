...
***Stone Camouflage.*** The diseased grick has advantage on Dexterity ([Stealth](2-Mechanics/CLI/rules/skills.md#Stealth)) checks made to hide in rocky terrain.

***Innate Spellcasting.*** The diseased grick's spellcasting ability is Wisdom (spell save DC 12 `dice:1d20+4|noform|text(+4)` to hit with spell attacks). It can innately cast the following spells, requiring no material components:

**1/day**: [contagion](2-Mechanics/CLI/spells/contagion.md)
