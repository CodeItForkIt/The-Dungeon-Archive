...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/PSX/Elder%20Dinosaur%20%28Zetalpa%2C%20Primal%20Dawn%29.webp#token)
...
***Wing.*** *Melee Weapon Attack:* `dice:1d20+19|noform|text(+19)` to hit, reach 20 ft., one target. *Hit:* `dice:4d8+10|noform|avg|text(28)` (`4d8 + 10`) bludgeoning damage.
