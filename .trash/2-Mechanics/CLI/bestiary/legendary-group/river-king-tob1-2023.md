...
- **Rushing Rapids.** The currents of rivers and streams within 3 miles of the lair become strong and erratic. Each creature swimming in these rivers and streams has disadvantage on Strength ([Athletics](2-Mechanics/CLI/rules/skills.md#Athletics)) checks to swim, unless it has a swimming speed.  
...
If the River King dies, these effects fade over the course of `dice:1d10|noform|avg` (`1d10`) days.