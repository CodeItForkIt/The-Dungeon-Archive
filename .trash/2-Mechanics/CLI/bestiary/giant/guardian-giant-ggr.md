...
- **Armor Class** 19 ([half plate armor](2-Mechanics/CLI/items/half-plate-armor.md), [shield](2-Mechanics/CLI/items/shield.md))
...
***Spear.*** *Melee or Ranged Weapon Attack:* `dice:1d20+10|noform|text(+10)` to hit, reach 10 ft. or range 60/240 ft., one target. *Hit:* `dice:3d6+7|noform|avg|text(17)` (`3d6 + 7`) piercing damage, or `dice:3d8+7|noform|avg|text(20)` (`3d8 + 7`) piercing damage if used with two hands to make a melee attack.
