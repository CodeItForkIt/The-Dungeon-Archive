...
***Scythe.*** *Melee Weapon Attack:* `dice:1d20+12|noform|text(+12)` to hit, reach 15 ft., one target. *Hit:* `dice:3d8+8|noform|avg|text(21)` (`3d8 + 8`) slashing damage plus `dice:2d10|noform|avg|text(11)` (`2d10`) necrotic damage.

***Soul Bolt.*** *Ranged Spell Attack:* `dice:1d20+8|noform|text(+8)` to hit, range 120 ft., one creature. *Hit:* `dice:4d10+4|noform|avg|text(26)` (`4d10 + 4`) necrotic damage. If the target has the [frightened](2-Mechanics/CLI/rules/conditions.md#Frightened) condition, the giant gains temporary hit points equal to the damage dealt.
