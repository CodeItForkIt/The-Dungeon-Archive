...
**At will**: [mage armor](2-Mechanics/CLI/spells/mage-armor.md) (self only), [mage hand](2-Mechanics/CLI/spells/mage-hand.md), [prestidigitation](2-Mechanics/CLI/spells/prestidigitation.md)

**1/day each**: [chain lightning](2-Mechanics/CLI/spells/chain-lightning.md), [cone of cold](2-Mechanics/CLI/spells/cone-of-cold.md) (6th-level version), [fireball](2-Mechanics/CLI/spells/fireball.md) (6th-level version), [fly](2-Mechanics/CLI/spells/fly.md), [plane shift](2-Mechanics/CLI/spells/plane-shift.md) (self only)

## Actions

***Multiattack.*** The fomorian makes three Rod attacks.

***Rod.*** *Melee Weapon Attack:* `dice:1d20+11|noform|text(+11)` to hit, reach 10 ft., one target. *Hit:* `dice:3d6+6|noform|avg|text(16)` (`3d6 + 6`) bludgeoning damage plus `dice:2d10|noform|avg|text(11)` (`2d10`) force damage.
