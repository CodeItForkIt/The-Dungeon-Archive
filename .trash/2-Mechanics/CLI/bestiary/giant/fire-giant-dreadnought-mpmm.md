...
- **Armor Class** 21 ([plate](2-Mechanics/CLI/items/plate-armor.md), [Dual Shields](2-Mechanics/CLI/items/shield.md))
...
***Fireshield.*** *Melee Weapon Attack:* `dice:1d20+13|noform|text(+13)` to hit, reach 5 ft., one target. *Hit:* `dice:4d6+8|noform|avg|text(22)` (`4d6 + 8`) bludgeoning damage plus `dice:2d6|noform|avg|text(7)` (`2d6`) fire damage plus `dice:2d6|noform|avg|text(7)` (`2d6`) piercing damage.

***Rock.*** *Ranged Weapon Attack:* `dice:1d20+13|noform|text(+13)` to hit, range 60/240 ft., one target. *Hit:* `dice:4d10+8|noform|avg|text(30)` (`4d10 + 8`) bludgeoning damage.

***Shield Charge (Recharge 5-6).*** The giant moves up to 30 feet in a straight line and can move through the space of any creature smaller than Huge. The first time it enters a creature's space during this move, that creature must succeed on a DC 21 Strength saving throw or take `dice:8d6+8|noform|avg|text(36)` (`8d6 + 8`) bludgeoning damage plus `dice:4d6|noform|avg|text(14)` (`4d6`) fire damage and be pushed up to 30 feet and knocked [prone](2-Mechanics/CLI/rules/conditions.md#Prone).
```
^statblock
