...
***Bash.*** *Melee Weapon Attack:* `dice:1d20+6|noform|text(+6)` to hit, reach 5 ft., one target. *Hit:* `dice:2d10+4|noform|avg|text(15)` (`2d10 + 4`) bludgeoning damage, and the ogre can push the target 5 feet away if the target is Huge or smaller.
