...
**At will**: [Tasha's hideous laughter](2-Mechanics/CLI/spells/tashas-hideous-laughter.md)
...
***Longsword.*** *Melee Weapon Attack:* `dice:1d20+6|noform|text(+6)` to hit, reach 5 ft., one target. *Hit:* `dice:1d8+2|noform|avg|text(6)` (`1d8 + 2`) slashing damage, or `dice:1d10+2|noform|avg|text(7)` (`1d10 + 2`) slashing damage if used with two hands, plus `dice:5d8|noform|avg|text(22)` (`5d8`) psychic damage.
