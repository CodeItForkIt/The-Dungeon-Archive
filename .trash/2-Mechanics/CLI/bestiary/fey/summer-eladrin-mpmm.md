...
***Longsword.*** *Melee Weapon Attack:* `dice:1d20+8|noform|text(+8)` to hit, reach 5 ft., one target. *Hit:* `dice:2d8+4|noform|avg|text(13)` (`2d8 + 4`) slashing damage, or `dice:2d10+4|noform|avg|text(15)` (`2d10 + 4`) slashing damage if used with two hands, plus `dice:2d8|noform|avg|text(9)` (`2d8`) fire damage.

***Longbow.*** *Ranged Weapon Attack:* `dice:1d20+9|noform|text(+9)` to hit, range 150/600 ft., one target. *Hit:* `dice:2d8+5|noform|avg|text(14)` (`2d8 + 5`) piercing damage plus `dice:2d8|noform|avg|text(9)` (`2d8`) fire damage.
