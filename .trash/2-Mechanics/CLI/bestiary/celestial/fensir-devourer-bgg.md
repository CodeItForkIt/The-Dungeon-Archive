...
While cursed in this way, an affected creature gains no benefit from finishing a short or long rest. At the end of every hour, the creature must succeed on a DC 13 Charisma saving throw or take `dice:2d10|noform|avg|text(11)` (`2d10`) psychic damage.
...
***Rend.*** *Melee Weapon Attack:* `dice:1d20+8|noform|text(+8)` to hit, reach 10 ft., one target. *Hit:* `dice:3d10+5|noform|avg|text(21)` (`3d10 + 5`) slashing damage.

***Boulder.*** *Ranged Weapon Attack:* `dice:1d20+8|noform|text(+8)` to hit, range 60/240 ft., one target. *Hit:* `dice:2d12+5|noform|avg|text(18)` (`2d12 + 5`) bludgeoning damage. If the target is a Large or smaller creature, it must succeed on a DC 16 Strength saving throw or have the [prone](2-Mechanics/CLI/rules/conditions.md#Prone) condition. After the fensir throws the boulder, roll a `dice:d6|noform|avg` (`d6`); on a roll of 4 or lower, the fensir has no more boulders to throw.
```
^statblock