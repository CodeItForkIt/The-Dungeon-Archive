...
---
# Planetar
*Source: Monster Manual p. 17, Baldur's Gate: Descent Into Avernus, Critical Role: Call of the Netherdeep, Journeys through the Radiant Citadel, Adventure Atlas: The Mortuary, Sigil and the Outlands, Dungeons of Drakkenheim. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>*  
...
***Angelic Weapons.*** The planetar's weapon attacks are magical. When the planetar hits with any weapon, the weapon deals an extra `dice:5d8|noform|avg` (`5d8`) radiant damage (included in the attack).
...
***Healing Touch (4/Day).*** The planetar touches another creature. The target magically regains `dice:6d8+3|noform|avg|text(30)` (`6d8 + 3`) hit points and is freed from any curse, disease, poison, blindness, or deafness.
```
^statblock