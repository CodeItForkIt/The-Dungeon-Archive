...
---
# Lich
*Source: Monster Manual p. 202, Curse of Strahd, Ghosts of Saltmarsh, Icewind Dale: Rime of the Frostmaiden, Tasha's Cauldron of Everything, Plane Shift: Innistrad, Sigil and the Outlands, Turn of Fortune's Wheel, Quests from the Infinite Staircase. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>*  
...
```ad-statblock
title: Lich
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MM/Lich.webp#token)
...
***Spellcasting.*** The lich is an 18th-level spellcaster. Its spellcasting ability is Intelligence (spell save DC 20, `dice:1d20+12|noform|text(+12)` to hit with spell attacks). The lich has the following wizard spells prepared:
...
***Disrupt Life (Costs 3 Actions).*** Each non-undead creature within 20 feet of the lich must make a DC 18 Constitution saving throw against this magic, taking `dice:6d6|noform|avg|text(21)` (`6d6`) necrotic damage on a failed save, or half as much damage on a successful one.

![Lich](2-Mechanics/CLI/bestiary/legendary-group/lich.md)
```
^statblock