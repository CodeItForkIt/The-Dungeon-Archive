...
```ad-statblock
title: Ghoul
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MM/Ghoul.webp#token)
...
***Bite.*** *Melee Weapon Attack:* `dice:1d20+2|noform|text(+2)` to hit, reach 5 ft., one creature. *Hit:* `dice:2d6+2|noform|avg|text(9)` (`2d6 + 2`) piercing damage.
