...
***Spellcasting.*** The naga is a 5th-level spellcaster (spell save DC 12, `dice:1d20+4|noform|text(+4)` to hit with spell attacks) that needs only verbal components to cast its spells. Its spellcasting ability is Wisdom, and it has the following cleric spells prepared:
...
**1st level (4 slots)**: [command](2-Mechanics/CLI/spells/command.md), [shield of faith](2-Mechanics/CLI/spells/shield-of-faith.md)
