...
***Freezing Touch.*** *Melee Weapon Attack:* `dice:1d20+10|noform|text(+10)` to hit, reach 5 ft., one creature. *Hit:* `dice:4d8|noform|avg|text(18)` (`4d8`) cold damage plus `dice:4d8|noform|avg|text(18)` (`4d8`) necrotic damage. If this damage would reduce the target to 0 hit points, the target drops to 1 hit point instead and has the [petrified](2-Mechanics/CLI/rules/conditions.md#Petrified) condition, turning into a frozen statue.
...
***Icy Axe.*** *Melee Weapon Attack:* `dice:1d20+10|noform|text(+10)` to hit, reach 10 ft., one target. *Hit:* `dice:3d8+6|noform|avg|text(19)` (`3d8 + 6`) slashing damage plus `dice:2d6|noform|avg|text(7)` (`2d6`) cold damage.

***Polar Ray.*** *Ranged Spell Attack:* `dice:1d20+8|noform|text(+8)` to hit, range 120 ft., one target. *Hit:* `dice:5d10+4|noform|avg|text(31)` (`5d10 + 4`) cold damage, and the target's speed is reduced by 10 feet until the end of its next turn.
