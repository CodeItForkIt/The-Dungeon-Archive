...
***Water Susceptibility.*** For every 5 feet the myrmidon moves in 1 foot or more of water, it takes `dice:1d4|noform|avg|text(2)` (`1d4`) cold damage.

## Actions

***Multiattack.*** The myrmidon makes three Scimitar attacks.

***Scimitar.*** *Melee Weapon Attack:* `dice:1d20+7|noform|text(+7)` to hit, reach 5 ft., one target. *Hit:* `dice:1d6+4|noform|avg|text(7)` (`1d6 + 4`) force damage.

***Fiery Strikes (Recharge 6).*** The myrmidon uses Multiattack. Each attack that hits deals an extra `dice:2d6|noform|avg|text(7)` (`2d6`) fire damage.
```
^statblock