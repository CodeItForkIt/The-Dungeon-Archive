...
---
# Xorn
*Source: Monster Manual p. 304, Princes of the Apocalypse, Waterdeep: Dungeon of the Mad Mage, Phandelver and Below: The Shattered Obelisk, Sigil and the Outlands, Quests from the Infinite Staircase. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>*  
...
***Stone Camouflage.*** The xorn has advantage on Dexterity ([Stealth](2-Mechanics/CLI/rules/skills.md#Stealth)) checks made to hide in rocky terrain.
...
***Bite.*** *Melee Weapon Attack:* `dice:1d20+6|noform|text(+6)` to hit, reach 5 ft., one target. *Hit:* `dice:3d6+3|noform|avg|text(13)` (`3d6 + 3`) piercing damage.
