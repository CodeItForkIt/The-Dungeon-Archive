...
***Invisibility.*** The stalker is [invisible](2-Mechanics/CLI/rules/conditions.md#Invisible).
...
***Slam.*** *Melee Weapon Attack:* `dice:1d20+6|noform|text(+6)` to hit, reach 5 ft., one target. *Hit:* `dice:2d6+3|noform|avg|text(10)` (`2d6 + 3`) bludgeoning damage.
```
^statblock
