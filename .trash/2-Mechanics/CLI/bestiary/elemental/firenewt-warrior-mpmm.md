...
- **Armor Class** 13 ([shield](2-Mechanics/CLI/items/shield.md))
- **Hit Points** 27 (`5d8 + 5`)
- **Speed** 30 ft.
...
***Spit Fire (Recharges after a Short or Long Rest).*** The firenewt spits fire at a creature within 10 feet of it. The creature must make a DC 11 Dexterity saving throw, taking `dice:2d8|noform|avg|text(9)` (`2d8`) fire damage on a failed save, or half as much damage on a successful one.
```
^statblock
