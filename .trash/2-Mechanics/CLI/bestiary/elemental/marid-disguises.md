...
**At will**: [create or destroy water](2-Mechanics/CLI/spells/create-or-destroy-water.md), [detect evil and good](2-Mechanics/CLI/spells/detect-evil-and-good.md), [detect magic](2-Mechanics/CLI/spells/detect-magic.md), [fog cloud](2-Mechanics/CLI/spells/fog-cloud.md), [purify food and drink](2-Mechanics/CLI/spells/purify-food-and-drink.md), [disguise self](2-Mechanics/CLI/spells/disguise-self.md) (often with a longer duration than is normal for that spell; see Disguises)
...
**3/day each**: [tongues](2-Mechanics/CLI/spells/tongues.md), [water breathing](2-Mechanics/CLI/spells/water-breathing.md), [water walk](2-Mechanics/CLI/spells/water-walk.md), [true polymorph](2-Mechanics/CLI/spells/true-polymorph.md) (mightier genies only; see Disguises)
