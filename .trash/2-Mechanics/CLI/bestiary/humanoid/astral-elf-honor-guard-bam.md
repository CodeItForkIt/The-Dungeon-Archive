...
***Longsword.*** *Melee Weapon Attack:* `dice:1d20+5|noform|text(+5)` to hit, reach 5 ft., one target. *Hit:* `dice:2d8+2|noform|avg|text(11)` (`2d8 + 2`) slashing damage, or `dice:2d10+2|noform|avg|text(13)` (`2d10 + 2`) slashing damage when used with two hands, plus `dice:3d6|noform|avg|text(10)` (`3d6`) radiant damage.

***Radiant Ray.*** *Ranged Spell Attack:* `dice:1d20+6|noform|text(+6)` to hit, range 120 ft., one target. *Hit:* `dice:4d10|noform|avg|text(22)` (`4d10`) radiant damage.
```
^statblock