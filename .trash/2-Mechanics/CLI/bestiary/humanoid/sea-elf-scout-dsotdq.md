...
```ad-statblock
title: Sea Elf Scout
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/DSotDQ/Sea%20Elf%20Scout.webp#token)
...
***Fey Ancestry.*** The scout has advantage on saving throws against being [charmed](2-Mechanics/CLI/rules/conditions.md#Charmed), and magic can't put it to sleep.
