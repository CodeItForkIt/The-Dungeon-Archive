...
***Otherworldly Perception.*** The kuo-toa can sense the presence of any creature within 30 feet of it that is [invisible](2-Mechanics/CLI/rules/conditions.md#Invisible) or on the Ethereal Plane. It can pinpoint such a creature that is moving.

***Slippery.*** The kuo-toa has advantage on ability checks and saving throws made to escape a grapple.

***Sunlight Sensitivity.*** While in sunlight, the kuo-toa has disadvantage on attack rolls, as well as on Wisdom ([Perception](2-Mechanics/CLI/rules/skills.md#Perception)) checks that rely on sight.

***Spellcasting.*** The kuo-toa is a 10th-level spellcaster. Its spellcasting ability is Wisdom (spell save DC 14, `dice:1d20+6|noform|text(+6)` to hit with spell attacks). The kuo-toa has the following cleric spells prepared:
...
**1st level (4 slots)**: [detect magic](2-Mechanics/CLI/spells/detect-magic.md), [sanctuary](2-Mechanics/CLI/spells/sanctuary.md), [shield of faith](2-Mechanics/CLI/spells/shield-of-faith.md)
...
**3rd level (3 slots)**: [spirit guardians](2-Mechanics/CLI/spells/spirit-guardians.md), [tongues](2-Mechanics/CLI/spells/tongues.md)

**4th level (3 slots)**: [control water](2-Mechanics/CLI/spells/control-water.md), [divination](2-Mechanics/CLI/spells/divination.md)

**5th level (2 slots)**: [mass cure wounds](2-Mechanics/CLI/spells/mass-cure-wounds.md), [scrying](2-Mechanics/CLI/spells/scrying.md)

## Actions

***Multiattack.*** The kuo-toa makes two melee attacks.

***Scepter.*** *Melee Weapon Attack:* `dice:1d20+6|noform|text(+6)` to hit, reach 5 ft., one target. *Hit:* `dice:1d6+3|noform|avg|text(6)` (`1d6 + 3`) bludgeoning damage plus `dice:4d6|noform|avg|text(14)` (`4d6`) lightning damage.

***Unarmed Strike.*** *Melee Weapon Attack:* `dice:1d20+6|noform|text(+6)` to hit, reach 5 ft., one target. *Hit:* `dice:1d4+3|noform|avg|text(5)` (`1d4 + 3`) bludgeoning damage.
```
^statblock
