...
***Spellcasting.*** The aarakocra is a 9th-level spellcaster. Its spellcasting ability is Intelligence (spell save DC 14, `dice:1d20+6|noform|text(+6)` to hit with spell attacks). The aarakocra has the following wizard spells prepared:
