...
***Spellcasting.*** The acolyte is a 1st-level spellcaster. Its spellcasting ability is Wisdom (spell save DC 12, `dice:1d20+4|noform|text(+4)` to hit with spell attacks). The acolyte has following cleric spells prepared:
...
**1st level (3 slots)**: [bless](2-Mechanics/CLI/spells/bless.md), [cure wounds](2-Mechanics/CLI/spells/cure-wounds.md), [sanctuary](2-Mechanics/CLI/spells/sanctuary.md)
