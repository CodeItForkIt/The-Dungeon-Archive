...
```ad-statblock
title: Hedge Bard
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/HWCS/Hedge%20Bard.webp#token)
...
**Cantrips (at will)**: [gust barrier](2-Mechanics/CLI/spells/gust-barrier-hwcs.md), [prestidigitation](2-Mechanics/CLI/spells/prestidigitation.md), [vicious mockery](2-Mechanics/CLI/spells/vicious-mockery.md)

**1st level (4 slots)**: [charm person](2-Mechanics/CLI/spells/charm-person.md), [healing word](2-Mechanics/CLI/spells/healing-word.md), [tasha's hideous laughter](2-Mechanics/CLI/spells/tashas-hideous-laughter.md), [thunderwave](2-Mechanics/CLI/spells/thunderwave.md)

**2nd level (3 slots)**: [invisibility](2-Mechanics/CLI/spells/invisibility.md), [shatter](2-Mechanics/CLI/spells/shatter.md), [suggestion](2-Mechanics/CLI/spells/suggestion.md)

## Actions

***Multiattack.*** he bard makes two weapon attacks, one with their rapier and one with their dagger.

***Rapier.*** *Melee Weapon Attack:* `dice:1d20+4|noform|text(+4)` to hit, reach 5 ft., one target. *Hit:* `dice:1d6+2|noform|avg|text(5)` (`1d6 + 2`) piercing damage.
