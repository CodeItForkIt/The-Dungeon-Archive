...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/DIP/Anchorite%20of%20Talos.webp#token)
...
**1/day each**: [augury](2-Mechanics/CLI/spells/augury.md), [bless](2-Mechanics/CLI/spells/bless.md), [lightning bolt](2-Mechanics/CLI/spells/lightning-bolt.md) (`dice:8d6|noform|avg` (`8d6`) damage), [revivify](2-Mechanics/CLI/spells/revivify.md)

**3/day**: [thunderwave](2-Mechanics/CLI/spells/thunderwave.md) (`dice:2d8|noform|avg` (`2d8`) damage)

## Actions

***Clawed Gauntlet (Humanoid Form Only).*** *Melee Weapon Attack:* `dice:1d20+5|noform|text(+5)` to hit, reach 5 ft., one target. *Hit:* `dice:1d4+3|noform|avg|text(5)` (`1d4 + 3`) slashing damage.

***Tusk (Boar Form Only).*** *Melee Weapon Attack:* `dice:1d20+5|noform|text(+5)` to hit, reach 5 ft., one target. *Hit:* `dice:1d6+3|noform|avg|text(6)` (`1d6 + 3`) slashing damage.
```
^statblock