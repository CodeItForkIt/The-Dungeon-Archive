...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MPMM/Drow%20Favored%20Consort.webp#token)
...
**At will**: [dancing lights](2-Mechanics/CLI/spells/dancing-lights.md), [mage armor](2-Mechanics/CLI/spells/mage-armor.md), [mage hand](2-Mechanics/CLI/spells/mage-hand.md), [message](2-Mechanics/CLI/spells/message.md)
...
**3/day each**: [dimension door](2-Mechanics/CLI/spells/dimension-door.md), [fireball](2-Mechanics/CLI/spells/fireball.md), [invisibility](2-Mechanics/CLI/spells/invisibility.md)
...
***Scimitar.*** *Melee Weapon Attack:* `dice:1d20+11|noform|text(+11)` to hit, reach 5 ft., one target. *Hit:* `dice:1d6+5|noform|avg|text(8)` (`1d6 + 5`) slashing damage plus `dice:6d8|noform|avg|text(27)` (`6d8`) poison damage.

***Arcane Eruption.*** *Ranged Spell Attack:* `dice:1d20+10|noform|text(+10)` to hit, range 120 ft., one target. *Hit:* `dice:8d8|noform|avg|text(36)` (`8d8`) force damage, and the drow can push the target up to 10 feet away if it is a Large or smaller creature.
