...
```ad-statblock
title: Dragon Hunter
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/JttRC/Dragon%20Hunter.webp#token)
...
***Longbow.*** *Ranged Weapon Attack:* `dice:1d20+3|noform|text(+3)` to hit, ranged 150/600 ft., one target. *Hit:* `dice:1d8+1|noform|avg|text(5)` (`1d8 + 1`) piercing damage.
```
^statblock