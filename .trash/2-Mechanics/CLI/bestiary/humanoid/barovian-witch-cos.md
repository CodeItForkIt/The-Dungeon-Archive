...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/CoS/Barovian%20Witch.webp#token)
...
***Spellcasting.*** The witch is a 3rd-level spellcaster. Its spellcasting ability is Intelligence (spell save DC 12, `dice:1d20+4|noform|text(+4)` to hit with spell attacks). The witch has the following wizard spells prepared:
...
**1st level (4 slots)**: [ray of sickness](2-Mechanics/CLI/spells/ray-of-sickness.md), [sleep](2-Mechanics/CLI/spells/sleep.md), [Tasha's hideous laughter](2-Mechanics/CLI/spells/tashas-hideous-laughter.md)

**2nd level (2 slots)**: [alter self](2-Mechanics/CLI/spells/alter-self.md), [invisibility](2-Mechanics/CLI/spells/invisibility.md)

## Actions

***Claws (Requires Alter Self).*** *Melee Weapon Attack:* `dice:1d20+3|noform|text(+3)` to hit, reach 5 ft., one target. *Hit:* `dice:1d6+1|noform|avg|text(4)` (`1d6 + 1`) slashing damage. This attack is magical.
