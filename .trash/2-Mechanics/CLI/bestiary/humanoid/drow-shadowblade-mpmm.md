...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MPMM/Drow%20Shadowblade.webp#token)
...
***Devil's Sight.*** Magical darkness doesn't impede the drow's [darkvision](2-Mechanics/CLI/rules/senses.md#Darkvision).
...
**1/day each**: [faerie fire](2-Mechanics/CLI/spells/faerie-fire.md), [levitate](2-Mechanics/CLI/spells/levitate.md) (self only)
...
***Shadow Sword.*** *Melee or Ranged Weapon Attack:* `dice:1d20+9|noform|text(+9)` to hit, reach 5 ft. or range 30/60 ft., one target. *Hit:* `dice:7d6+5|noform|avg|text(27)` (`7d6 + 5`) necrotic damage.

***Hand Crossbow.*** *Ranged Weapon Attack:* `dice:1d20+9|noform|text(+9)` to hit, range 30/120 ft., one target. *Hit:* `dice:1d6+5|noform|avg|text(8)` (`1d6 + 5`) piercing damage, and the target must succeed on a DC 13 Constitution saving throw or be [poisoned](2-Mechanics/CLI/rules/conditions.md#Poisoned) for 1 hour. If the saving throw fails by 5 or more, the target is also [unconscious](2-Mechanics/CLI/rules/conditions.md#Unconscious) while [poisoned](2-Mechanics/CLI/rules/conditions.md#Poisoned) in this way. The target regains consciousness if it takes damage or if another creature takes an action to shake it.
