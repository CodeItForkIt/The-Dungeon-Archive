...
***Martial Advantage.*** Once per turn, the sergeant can deal an extra `dice:2d6|noform|avg|text(7)` (`2d6`) damage to a creature it hits with a weapon attack if that creature is within 5 feet of an ally of the sergeant that isn't [incapacitated](2-Mechanics/CLI/rules/conditions.md#Incapacitated).
