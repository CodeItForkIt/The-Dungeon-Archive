...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/ToB1-2023/Deep%20One%20Priest.webp#token)
...
**1/day each**: [spirit guardians](2-Mechanics/CLI/spells/spirit-guardians.md)

**3/day each**: [command](2-Mechanics/CLI/spells/command.md), [sleep](2-Mechanics/CLI/spells/sleep.md)
...
***Jolting Touch.*** *Melee Spell Attack:* `dice:1d20+5|noform|text(+5)` to hit, reach 5 ft., one target. *Hit:* `dice:2d6+3|noform|avg|text(10)` (`2d6 + 3`) lightning damage, and the target's speed is reduced by 10 until the end of its next turn.
```
^statblock
