...
***Spellcasting.*** The sahuagin is a 6th-level spellcaster. Her spellcasting ability is Wisdom (spell save DC 12, `dice:1d20+4|noform|text(+4)` to hit with spell attacks). She has the following cleric spells prepared:

**Cantrips (at will)**: [guidance](2-Mechanics/CLI/spells/guidance.md), [thaumaturgy](2-Mechanics/CLI/spells/thaumaturgy.md)
...
**3rd level (3 slots)**: [mass healing word](2-Mechanics/CLI/spells/mass-healing-word.md), [tongues](2-Mechanics/CLI/spells/tongues.md)
