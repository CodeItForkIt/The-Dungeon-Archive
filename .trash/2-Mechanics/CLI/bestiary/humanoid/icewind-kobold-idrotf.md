...
***Javelin.*** *Melee or Ranged Weapon Attack:* `dice:1d20+0|noform|text(+0)` to hit, reach 5 ft. or range 30/120 ft., one target. *Hit:* `dice:1d6-2|noform|avg|text(1)` (`1d6 - 2`) piercing damage.
```
^statblock