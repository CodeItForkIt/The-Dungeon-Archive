...
***Spellcasting (Lizardfolk Form Only).*** The lizardfolk is a 5th-level spellcaster. Its spellcasting ability is Wisdom (spell save DC 12, `dice:1d20+4|noform|text(+4)` to hit with spell attacks). The lizardfolk has the following druid spells prepared:
...
**2nd level (3 slots)**: [heat metal](2-Mechanics/CLI/spells/heat-metal.md), [spike growth](2-Mechanics/CLI/spells/spike-growth.md)

**3rd level (2 slots)**: [conjure animals](2-Mechanics/CLI/spells/conjure-animals.md) (reptiles only), [plant growth](2-Mechanics/CLI/spells/plant-growth.md)

## Actions

***Multiattack (Lizardfolk Form Only).*** The lizardfolk makes two attacks: one with its bite and one with its claws.

***Bite.*** *Melee Weapon Attack:* `dice:1d20+4|noform|text(+4)` to hit, reach 5 ft., one target. *Hit:* `dice:1d6+2|noform|avg|text(5)` (`1d6 + 2`) piercing damage, or `dice:1d10+2|noform|avg|text(7)` (`1d10 + 2`) piercing damage in [crocodile](2-Mechanics/CLI/bestiary/beast/crocodile.md) form. If the lizardfolk is in crocodile form and the target is a Large or smaller creature, the target is [grappled](2-Mechanics/CLI/rules/conditions.md#Grappled) (escape DC 12). Until this grapple ends, the target is [restrained](2-Mechanics/CLI/rules/conditions.md#Restrained), and the lizardfolk can't bite another target. If the lizardfolk reverts to its true form, the grapple ends.
