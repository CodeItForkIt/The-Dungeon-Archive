...
***Psychic-Attuned Hammer.*** *Melee Weapon Attack:* `dice:1d20+7|noform|text(+7)` to hit, reach 5 ft., one target. *Hit:* `dice:1d10+4|noform|avg|text(9)` (`1d10 + 4`) bludgeoning damage, or `dice:2d10+4|noform|avg|text(15)` (`2d10 + 4`) bludgeoning damage while under the effect of Enlarge, plus `dice:1d10|noform|avg|text(5)` (`1d10`) psychic damage.

***Javelin.*** *Melee or Ranged Weapon Attack:* `dice:1d20+7|noform|text(+7)` to hit, reach 5 ft. or range 30/120 ft., one target. *Hit:* `dice:1d6+4|noform|avg|text(7)` (`1d6 + 4`) piercing damage, or `dice:2d6+4|noform|avg|text(11)` (`2d6 + 4`) piercing damage while under the effect of Enlarge.
...
***Scouring Instruction.*** When an ally that the duergar can see makes a `dice:d20|noform|avg` (`d20`) roll, the duergar can roll a `dice:d6|noform|avg` (`d6`), and the ally can add the number rolled to the `dice:d20|noform|avg` (`d20`) by taking `dice:1d6|noform|avg|text(3)` (`1d6`) psychic damage.
```
^statblock
