...
***Psychic Engine.*** When the duergar suffers a critical hit or is reduced to 0 hit points, psychic energy erupts from its frame to deal `dice:4d6|noform|avg|text(14)` (`4d6`) psychic damage to each creature within 5 feet of it.
...
***Iron Fist.*** *Melee Weapon Attack:* `dice:1d20+9|noform|text(+9)` to hit, reach 5 ft., one target. *Hit:* `dice:4d8+5|noform|avg|text(23)` (`4d8 + 5`) bludgeoning damage. If the target is a Large or smaller creature, it must succeed on a DC 17 Strength saving throw or be pushed up to 30 feet away in a straight line and be knocked [prone](2-Mechanics/CLI/rules/conditions.md#Prone).

***Stomping Foot.*** *Melee Weapon Attack:* `dice:1d20+9|noform|text(+9)` to hit, reach 5 ft., one target. *Hit:* `dice:1d10+5|noform|avg|text(10)` (`1d10 + 5`) bludgeoning damage, or `dice:3d10+5|noform|avg|text(21)` (`3d10 + 5`) to a [prone](2-Mechanics/CLI/rules/conditions.md#Prone) target.

***Flame Jet.*** The duergar spews flames in a line 100 feet long and 5 feet wide. Each creature in the line must make a DC 16 Dexterity saving throw, taking `dice:4d8|noform|avg|text(18)` (`4d8`) fire damage on a failed save, or half as much damage on a successful one.
```
^statblock
