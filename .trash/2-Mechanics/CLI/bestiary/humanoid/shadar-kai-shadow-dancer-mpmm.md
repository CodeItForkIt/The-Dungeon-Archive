...
***Spiked Chain.*** *Melee Weapon Attack:* `dice:1d20+6|noform|text(+6)` to hit, reach 10 ft., one target. *Hit:* `dice:2d6+3|noform|avg|text(10)` (`2d6 + 3`) piercing damage. The target must succeed on a DC 14 Dexterity saving throw or suffer one of the following effects (choose one or roll a `dice:d6|noform|avg` (`d6`)):

- **1–2 Decay.** The target takes `dice:4d10|noform|avg|text(22)` (`4d10`) necrotic damage.  
- **3–4 Grapple.** The target is [grappled](2-Mechanics/CLI/rules/conditions.md#Grappled) (escape DC 14) if it is a Medium or smaller creature. Until the grapple ends, the target is [restrained](2-Mechanics/CLI/rules/conditions.md#Restrained), and the shadar-kai can't grapple another target.  
