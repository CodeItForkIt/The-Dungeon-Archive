...
***Keen Smell.*** The Shard Shunner has advantage on Wisdom ([Perception](2-Mechanics/CLI/rules/skills.md#Perception)) checks that rely on smell.

***Halfling Nimbleness.*** The Shard Shunner can move through the space of creatures that is of a size larger than them.

***Brave.*** The Shard Shunner has advantage on saving throws against being [frightened](2-Mechanics/CLI/rules/conditions.md#Frightened).
