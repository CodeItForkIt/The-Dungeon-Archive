...
```ad-statblock
title: Inspired (Quori Vessel; Kalaraq)
...
***All Around Vision.*** The Inspired can't be [surprised](2-Mechanics/CLI/rules/conditions.md#Surprised).
...
**3/day each**: [arcane eye](2-Mechanics/CLI/spells/arcane-eye.md)
