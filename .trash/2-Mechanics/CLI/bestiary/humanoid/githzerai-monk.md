...
***Unarmed Strike.*** *Melee Weapon Attack:* `dice:1d20+4|noform|text(+4)` to hit, reach 5 ft., one target. *Hit:* `dice:1d8+2|noform|avg|text(6)` (`1d8 + 2`) bludgeoning damage plus `dice:2d8|noform|avg|text(9)` (`2d8`) psychic damage. This is a magic weapon attack.
```
^statblock