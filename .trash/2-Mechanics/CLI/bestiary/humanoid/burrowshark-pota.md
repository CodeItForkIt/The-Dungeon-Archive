...
```ad-statblock
title: Burrowshark
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/PotA/Burrowshark.webp#token)
...
***Unyielding.*** When the burrowshark is subjected to an effect that would move it, knock it [prone](2-Mechanics/CLI/rules/conditions.md#Prone), or both, it can use its reaction to be neither moved nor knocked [prone](2-Mechanics/CLI/rules/conditions.md#Prone).
```
^statblock