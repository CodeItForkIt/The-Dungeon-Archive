...
***Mind-Poison Dagger.*** *Melee Weapon Attack:* `dice:1d20+5|noform|text(+5)` to hit, reach 5 ft., one target. *Hit:* `dice:1d4+3|noform|avg|text(5)` (`1d4 + 3`) piercing damage plus `dice:3d6|noform|avg|text(10)` (`3d6`) psychic damage, or 1 piercing damage plus `dice:3d6|noform|avg|text(10)` (`3d6`) psychic damage while under the effect of Reduce.
