...
aliases: ["Werewolf (Mondronen)"]
---
# Werewolf (Mondronen)
*Source: Plane Shift: Innistrad p. 15*  

```ad-statblock
title: Werewolf (Mondronen)
...
***Mondronen Wounded Fury.*** While it has 10 hit points or fewer, the werewolf has advantage on attack rolls. In addition, it deals an extra `dice:2d6|noform|avg|text(7)` (`2d6`) damage to any target it hits with a melee attack.
