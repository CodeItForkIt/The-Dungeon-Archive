...
***Simulacra.*** When a simulacrum drops to 0 hit points or is subjected to a successful [dispel magic](2-Mechanics/CLI/spells/dispel-magic.md) spell (DC 17), it reverts to ice and snow and is destroyed.
