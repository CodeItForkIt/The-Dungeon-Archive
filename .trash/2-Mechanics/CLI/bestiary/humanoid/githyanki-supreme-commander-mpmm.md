...
**1/day each**: [Bigby's hand](2-Mechanics/CLI/spells/bigbys-hand.md), [mass suggestion](2-Mechanics/CLI/spells/mass-suggestion.md), [plane shift](2-Mechanics/CLI/spells/plane-shift.md), [telekinesis](2-Mechanics/CLI/spells/telekinesis.md)

**3/day each**: [levitate](2-Mechanics/CLI/spells/levitate.md) (self only), [nondetection](2-Mechanics/CLI/spells/nondetection.md) (self only)

## Actions

***Multiattack.*** The githyanki makes two Silver Greatsword attacks.

***Silver Greatsword.*** *Melee Weapon Attack:* `dice:1d20+12|noform|text(+12)` to hit, reach 5 ft., one target. *Hit:* `dice:2d6+7|noform|avg|text(14)` (`2d6 + 7`) slashing damage plus `dice:5d6|noform|avg|text(17)` (`5d6`) psychic damage. On a critical hit against a target in an astral body (as with the [astral projection](2-Mechanics/CLI/spells/astral-projection.md) spell), the githyanki can cut the silvery cord that tethers the target to its material body, instead of dealing damage.
