...
**2/day each**: [charm person](2-Mechanics/CLI/spells/charm-person.md), [fog cloud](2-Mechanics/CLI/spells/fog-cloud.md), [levitate](2-Mechanics/CLI/spells/levitate.md)
...
***Chromatic Bolt.*** *Ranged Spell Attack:* `dice:1d20+4|noform|text(+4)` to hit, range 60 feet, one target. *Hit:* `dice:2d6+2|noform|avg|text(9)` (`2d6 + 2`) of a type of the kobold's choice: acid, cold, fire, lightning, poison, or thunder.
```
^statblock
