...
***Dropped Rock.*** *Ranged Weapon Attack:* `dice:1d20+5|noform|text(+5)` to hit, one target directly below the kobold. *Hit:* `dice:1d6+3|noform|avg|text(6)` (`1d6 + 3`) bludgeoning damage.
```
^statblock
