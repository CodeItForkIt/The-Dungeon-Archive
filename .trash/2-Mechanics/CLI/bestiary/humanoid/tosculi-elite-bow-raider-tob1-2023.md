...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/ToB1-2023/Tosculi%20Elite%20Bow%20Raider.webp#token)
...
***Claw.*** *Melee Weapon Attack:* `dice:1d20+10|noform|text(+10)` to hit, reach 5 ft., one target. *Hit:* `dice:4d4+7|noform|avg|text(17)` (`4d4 + 7`) slashing damage.

***Longbow.*** *Ranged Weapon Attack:* `dice:1d20+10|noform|text(+10)` to hit, range 150/600 ft., one target. *Hit:* `dice:2d8+7|noform|avg|text(16)` (`2d8 + 7`) piercing damage.
