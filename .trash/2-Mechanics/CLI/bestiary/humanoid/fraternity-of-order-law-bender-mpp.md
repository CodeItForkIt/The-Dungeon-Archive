...
**At will**: [dispel magic](2-Mechanics/CLI/spells/dispel-magic.md), [fly](2-Mechanics/CLI/spells/fly.md), [mage armor](2-Mechanics/CLI/spells/mage-armor.md), [mage hand](2-Mechanics/CLI/spells/mage-hand.md), [prestidigitation](2-Mechanics/CLI/spells/prestidigitation.md)

## Actions

***Multiattack.*** The law bender makes three Arcane Burst attacks and uses Power of Authority or Spellcasting.

***Arcane Burst.*** *Melee or Ranged Spell Attack:* `dice:1d20+8|noform|text(+8)` to hit, reach 5 ft. or range 90 ft., one target. *Hit:* `dice:2d12+4|noform|avg|text(17)` (`2d12 + 4`) force damage.

***Power of Authority.*** The law bender targets a creature it can see within 60 feet of itself. The target must succeed on a DC 16 Intelligence saving throw or take `dice:3d6|noform|avg|text(10)` (`3d6`) psychic damage and have the [incapacitated](2-Mechanics/CLI/rules/conditions.md#Incapacitated) condition for 1 minute. At the end of each of the target's turns, it can repeat the saving throw, ending the [incapacitated](2-Mechanics/CLI/rules/conditions.md#Incapacitated) condition on itself on a success. A target that succeeds on the saving throw becomes immune to this law bender's Power of Authority for 24 hours.
