...
***Spiked Club.*** *Melee Weapon Attack:* `dice:1d20+4|noform|text(+4)` to hit, reach 5 ft., one target. *Hit:* `dice:1d8+2|noform|avg|text(6)` (`1d8 + 2`) piercing damage, or `dice:1d10+2|noform|avg|text(7)` (`1d10 + 2`) piercing damage if used with two hands.
```
^statblock