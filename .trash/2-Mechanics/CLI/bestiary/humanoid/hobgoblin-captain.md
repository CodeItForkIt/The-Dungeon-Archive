...
***Martial Advantage.*** Once per turn, the hobgoblin can deal an extra `dice:3d6|noform|avg|text(10)` (`3d6`) damage to a creature it hits with a weapon attack if that creature is within 5 feet of an ally of the hobgoblin that isn't [incapacitated](2-Mechanics/CLI/rules/conditions.md#Incapacitated).
