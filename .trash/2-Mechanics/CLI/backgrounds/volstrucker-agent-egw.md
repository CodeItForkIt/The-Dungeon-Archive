...
- **Equipment.** A set of [common clothes](2-Mechanics/CLI/items/common-clothes.md), a black cloak with a hood, a [poisoner's kit](2-Mechanics/CLI/items/poisoners-kit.md), and a [pouch](2-Mechanics/CLI/items/pouch.md) containing 10 gp  
