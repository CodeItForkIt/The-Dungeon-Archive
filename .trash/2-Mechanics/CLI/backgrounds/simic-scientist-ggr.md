...
- **Skill Proficiencies.** [Arcana](2-Mechanics/CLI/rules/skills.md#Arcana), [Medicine](2-Mechanics/CLI/rules/skills.md#Medicine)  
- **Languages.** Two of your choice  
- **Equipment.** A Simic insignia, a set of [commoner's clothes](2-Mechanics/CLI/items/common-clothes.md), a [book](2-Mechanics/CLI/items/book.md) of research notes, an [ink pen](2-Mechanics/CLI/items/ink-pen.md), a [bottle of squid ink](2-Mechanics/CLI/items/ink-1-ounce-bottle.md), a [flask of oil](2-Mechanics/CLI/items/oil-flask.md) (made from blubber), a [vial of acid](2-Mechanics/CLI/items/acid-vial.md) (derived from digestive juices), a vial of fish scales, a vial of seaweed, a vial of jellyfish stingers, a glass bottle of unidentified slime, and a belt [pouch](2-Mechanics/CLI/items/pouch.md) containing 10 gp (Azorius 1-zino coins)  
...
As a Simic researcher, you are part of a clade—a diverse group of individuals combining disparate talents in pursuit of a common goal—or a researcher on a specialized, short-term project focused on addressing an immediate need. You can roll a `dice:d6|noform|avg` (`d6`) or choose from the options in the Research Options table to determine your area of research.
...
| Spell Level | Spells |
|-------------|--------|
| Cantrip | [acid splash](2-Mechanics/CLI/spells/acid-splash.md), [druidcraft](2-Mechanics/CLI/spells/druidcraft.md) |
| 1st | [detect poison and disease](2-Mechanics/CLI/spells/detect-poison-and-disease.md), [expeditious retreat](2-Mechanics/CLI/spells/expeditious-retreat.md), [jump](2-Mechanics/CLI/spells/jump.md) |
| 2nd | [alter self](2-Mechanics/CLI/spells/alter-self.md), [enhance ability](2-Mechanics/CLI/spells/enhance-ability.md), [enlarge/reduce](2-Mechanics/CLI/spells/enlarge-reduce.md) |
| 3rd | [gaseous form](2-Mechanics/CLI/spells/gaseous-form.md), [water breathing](2-Mechanics/CLI/spells/water-breathing.md), [wind wall](2-Mechanics/CLI/spells/wind-wall.md) |
| 4th | [freedom of movement](2-Mechanics/CLI/spells/freedom-of-movement.md), [polymorph](2-Mechanics/CLI/spells/polymorph.md) |
