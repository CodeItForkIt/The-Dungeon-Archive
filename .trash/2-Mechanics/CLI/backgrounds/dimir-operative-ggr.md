...
- **Equipment.** A Dimir insignia, three small knives, a set of dark-colored [common clothes](2-Mechanics/CLI/items/common-clothes.md), and the starting equipment of the background described in this chapter for your secondary guild  
...
| Spell Level | Spells |
|-------------|--------|
| Cantrip | [encode thoughts](2-Mechanics/CLI/spells/encode-thoughts-ggr.md), [mage hand](2-Mechanics/CLI/spells/mage-hand.md) |
| 1st | [disguise self](2-Mechanics/CLI/spells/disguise-self.md), [sleep](2-Mechanics/CLI/spells/sleep.md) |
| 2nd | [detect thoughts](2-Mechanics/CLI/spells/detect-thoughts.md), [pass without trace](2-Mechanics/CLI/spells/pass-without-trace.md) |
| 3rd | [gaseous form](2-Mechanics/CLI/spells/gaseous-form.md), [meld into stone](2-Mechanics/CLI/spells/meld-into-stone.md), [nondetection](2-Mechanics/CLI/spells/nondetection.md) |
| 4th | [arcane eye](2-Mechanics/CLI/spells/arcane-eye.md), [freedom of movement](2-Mechanics/CLI/spells/freedom-of-movement.md) |
| 5th | [modify memory](2-Mechanics/CLI/spells/modify-memory.md) |
^dimir-guild-spells

Your magic is meant to be subtle and undetectable, but it might pull shadows or clouds of mist around you as you cast your spells. Using the [encode thoughts](2-Mechanics/CLI/spells/encode-thoughts-ggr.md) cantrip described below, you can turn a creature's thoughts (including your own) into a thought strand that others can potentially read, share, or steal. These thought strands are treated as valuable currency among the Dimir.
