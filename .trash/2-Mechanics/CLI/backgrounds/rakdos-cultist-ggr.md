...
- **Equipment.** A Rakdos insignia, a musical instrument (one of your choice), a [costume](2-Mechanics/CLI/items/costume-clothes.md), a [hooded lantern](2-Mechanics/CLI/items/hooded-lantern.md) made of wrought iron, a 10-foot length of chain with sharply spiked links, a [tinderbox](2-Mechanics/CLI/items/tinderbox.md), 10 [torches](2-Mechanics/CLI/items/torch.md), a set of [common clothes](2-Mechanics/CLI/items/common-clothes.md), a belt [pouch](2-Mechanics/CLI/items/pouch.md) containing 10 gp (a mix of Azorius and Boros 1-zino coins), and a bottle of sweet, red juice  
...
Rakdos performance styles typically fuse standard circus-style acrobatics with fire, wrought-iron spikes and hooks, and monsters. You can roll a `dice:d8|noform|avg` (`d8`) or choose from the options in the Performance Options table to determine your preferred style of performance.
...
| Spell Level | Spells |
|-------------|--------|
| Cantrip | [fire bolt](2-Mechanics/CLI/spells/fire-bolt.md), [vicious mockery](2-Mechanics/CLI/spells/vicious-mockery.md) |
| 1st | [burning hands](2-Mechanics/CLI/spells/burning-hands.md), [dissonant whispers](2-Mechanics/CLI/spells/dissonant-whispers.md), [hellish rebuke](2-Mechanics/CLI/spells/hellish-rebuke.md) |
| 2nd | [crown of madness](2-Mechanics/CLI/spells/crown-of-madness.md), [enthrall](2-Mechanics/CLI/spells/enthrall.md), [flaming sphere](2-Mechanics/CLI/spells/flaming-sphere.md) |
| 3rd | [fear](2-Mechanics/CLI/spells/fear.md), [haste](2-Mechanics/CLI/spells/haste.md) |
| 4th | [confusion](2-Mechanics/CLI/spells/confusion.md), [wall of fire](2-Mechanics/CLI/spells/wall-of-fire.md) |
| 5th | [dominate person](2-Mechanics/CLI/spells/dominate-person.md) |
^rakdos-guild-spells
