...
- **Equipment.** One set of artisan's tools, [merchant's scale](2-Mechanics/CLI/items/merchants-scale.md), a set of [fine clothes](2-Mechanics/CLI/items/fine-clothes.md), and a belt [pouch](2-Mechanics/CLI/items/pouch.md) containing 10 gp  
