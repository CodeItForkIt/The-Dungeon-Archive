...
- **Skill Proficiencies.** [Arcana](2-Mechanics/CLI/rules/skills.md#Arcana), [Investigation](2-Mechanics/CLI/rules/skills.md#Investigation)  
- **Tool Proficiencies.** One type of artisan's tools  
- **Languages.** Choose one of Draconic, Goblin, or Vedalken  
- **Equipment.** An Izzet insignia, one set of artisan's tools, the charred and twisted remains of a failed experiment, a [hammer](2-Mechanics/CLI/items/hammer.md), a [block and tackle](2-Mechanics/CLI/items/block-and-tackle.md), a set of [common clothes](2-Mechanics/CLI/items/common-clothes.md), and a belt [pouch](2-Mechanics/CLI/items/pouch.md) containing 5 gp (Azorius 1-zino coins)  
...
| Spell Level | Spells |
|-------------|--------|
| Cantrip | [produce flame](2-Mechanics/CLI/spells/produce-flame.md), [shocking grasp](2-Mechanics/CLI/spells/shocking-grasp.md) |
| 1st | [chaos bolt](2-Mechanics/CLI/spells/chaos-bolt-xge.md), [create or destroy water](2-Mechanics/CLI/spells/create-or-destroy-water.md), [unseen servant](2-Mechanics/CLI/spells/unseen-servant.md) |
| 2nd | [heat metal](2-Mechanics/CLI/spells/heat-metal.md), [rope trick](2-Mechanics/CLI/spells/rope-trick.md) |
| 3rd | [call lightning](2-Mechanics/CLI/spells/call-lightning.md), [elemental weapon](2-Mechanics/CLI/spells/elemental-weapon.md), [glyph of warding](2-Mechanics/CLI/spells/glyph-of-warding.md) |
| 4th | [conjure minor elementals](2-Mechanics/CLI/spells/conjure-minor-elementals.md), [divination](2-Mechanics/CLI/spells/divination.md), [Otiluke's resilient sphere](2-Mechanics/CLI/spells/otilukes-resilient-sphere.md) |
| 5th | [animate objects](2-Mechanics/CLI/spells/animate-objects.md), [conjure elemental](2-Mechanics/CLI/spells/conjure-elemental.md) |
^izzet-guild-spells

Your spells tend to be loud, flashy, or explosive, even when the effect is unremarkable. For example, when you open the portal of a [rope trick](2-Mechanics/CLI/spells/rope-trick.md) spell, the portal might be outlined by harmless, showy sparkles.

If you use an arcane focus, it probably takes the form of an intricate device that could include metal gauntlets, glass canisters, copper tubing, and leather straps attaching it to your body. The [mizzium apparatus](2-Mechanics/CLI/items/mizzium-apparatus-ggr.md) described in "chapter 5" is a magical version of this gear.

The [chaos bolt](2-Mechanics/CLI/spells/chaos-bolt-xge.md) spell is a favorite of Izzet spellcasters because of its unpredictable nature.
