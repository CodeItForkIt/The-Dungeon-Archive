...
A creature that collides with another creature or an object during this trajectory takes `dice:1d6|noform|avg|text(3)` (`1d6`) bludgeoning damage for every 10 feet away from the gnomeflinger it is.
```
^statblock