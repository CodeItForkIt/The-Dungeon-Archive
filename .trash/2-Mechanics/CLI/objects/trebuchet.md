...
```ad-statblock
title: Trebuchet
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/objects/tokens/DMG/Trebuchet.webp#token)
*Huge Siege weapon*
...
***Trebuchet Stone.*** *Ranged Weapon Attack:* `dice:1d20+5|noform|text(+5)` to hit, range 300/1,200 ft. (can't hit targets within 60 feet of it), one target. *Hit:* 44 (`dice:8d10|noform|avg` (`8d10`)) bludgeoning damage.
```
^statblock