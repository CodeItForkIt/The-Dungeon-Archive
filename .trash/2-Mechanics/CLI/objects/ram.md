...
```ad-statblock
title: Ram
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/objects/tokens/DMG/Ram.webp#token)
*Large Siege weapon*
...
***Ram.*** *Melee Weapon Attack:* `dice:1d20+8|noform|text(+8)` to hit, reach 5 ft., one object. *Hit:* 16 (`dice:3d10|noform|avg` (`3d10`)) bludgeoning damage.
```
^statblock