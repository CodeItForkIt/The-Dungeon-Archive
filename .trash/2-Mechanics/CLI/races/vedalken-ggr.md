...
You are proficient in one of the following skills of your choice: [Arcana](2-Mechanics/CLI/rules/skills.md#Arcana), [History](2-Mechanics/CLI/rules/skills.md#History), [Investigation](2-Mechanics/CLI/rules/skills.md#Investigation), [Medicine](2-Mechanics/CLI/rules/skills.md#Medicine), [Performance](2-Mechanics/CLI/rules/skills.md#Performance), or [Sleight of Hand](2-Mechanics/CLI/rules/skills.md#Sleight%20of%20Hand). You are also proficient with one "tool" of your choice.

Whenever you make an ability check with the chosen skill or tool, roll a `dice:d4|noform|avg` (`d4`) and add the number rolled to the check's total.
