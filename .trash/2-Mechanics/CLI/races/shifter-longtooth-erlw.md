...
While shifted, you can use your elongated fangs to make an unarmed strike as a bonus action. If you hit with your fangs, you can deal piercing damage equal to `dice:1d6|noform|avg` (`1d6`) + your Strength modifier, instead of the bludgeoning damage normal for an unarmed strike.
