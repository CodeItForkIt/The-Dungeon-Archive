...
You have advantage on Intelligence ([Investigation](2-Mechanics/CLI/rules/skills.md#Investigation)) and Wisdom ([Insight](2-Mechanics/CLI/rules/skills.md#Insight)) checks.

### Blessing of the Moon Weaver

You know the [light](2-Mechanics/CLI/spells/light.md) cantrip. When you reach 3rd level, you can cast the [sleep](2-Mechanics/CLI/spells/sleep.md) spell once with this trait and regain the ability to do so when you finish a long rest. When you reach 5th level, you can cast the [invisibility](2-Mechanics/CLI/spells/invisibility.md) spell (targeting yourself only) once with this trait and regain the ability to do so when you finish a long rest. Casting these spells with this trait doesn't require material components. Wisdom is your spellcasting ability for these spells.
