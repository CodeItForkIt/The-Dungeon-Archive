...
You have advantage on saving throws against being [charmed](2-Mechanics/CLI/rules/conditions.md#Charmed) or [frightened](2-Mechanics/CLI/rules/conditions.md#Frightened).
...
Thanks to your sensitive trunk, you have advantage on Wisdom ([Perception](2-Mechanics/CLI/rules/skills.md#Perception)), Wisdom ([Survival](2-Mechanics/CLI/rules/skills.md#Survival)), and Intelligence ([Investigation](2-Mechanics/CLI/rules/skills.md#Investigation)) checks that involve smell.
