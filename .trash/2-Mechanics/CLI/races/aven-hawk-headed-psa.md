...
Following the example of Oketra, hawk-headed aven often focus on the techniques of long-range combat. Most prefer [javelins](2-Mechanics/CLI/items/javelin.md), but some are skilled with bows, [spears](2-Mechanics/CLI/items/spear.md), and [throwing axes](2-Mechanics/CLI/items/handaxe.md).
