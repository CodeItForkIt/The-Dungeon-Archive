...
You have a set of large, strong antlers that can be used to make devastating charge attacks. You can use your unarmed strike to gore opponents, dealing `dice:1d6|noform|avg` (`1d6`) + your Strength Modifier piercing damage on a hit.
