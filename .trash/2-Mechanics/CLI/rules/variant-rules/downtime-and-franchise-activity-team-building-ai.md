...
Each character and staff member then makes a Wisdom ([Insight](2-Mechanics/CLI/rules/skills.md#Insight)) check. With the DM's approval, different ability checks and skills might be allowed if they relate to the specifics of the team building exercise. A participant has advantage on their check if the DM decides the story connection was particularly clever or well roleplayed. All checks gain a +1 bonus if one of the characters taking part in the activity is a decisionist.
...
The most potent personal changes inspired by team building can last a lifetime. Or at least an encounter. A character who earns a team building memory gains an extraordinary ability that can be used once. As a bonus action, the character gains one effect of the [enhance ability](2-Mechanics/CLI/spells/enhance-ability.md) spell for 10 minutes (no [concentration](2-Mechanics/CLI/rules/conditions.md#Concentration) required).
...
> [!quote] A quote from [Môrgæn](2-Mechanics/CLI/bestiary/npc/morgn-ai.md)  
> 
