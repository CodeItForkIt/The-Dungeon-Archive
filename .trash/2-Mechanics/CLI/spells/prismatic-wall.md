...
The creature takes `dice:10d6|noform|avg` (`10d6`) poison damage on a failed save, or half as much damage on a successful one. A [passwall](2-Mechanics/CLI/spells/passwall.md) spell, or another spell of equal or greater level that can open a portal on a solid surface, destroys this layer.
