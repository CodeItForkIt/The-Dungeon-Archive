...
While [restrained](2-Mechanics/CLI/rules/conditions.md#Restrained) by this spell, the target takes `dice:1d6|noform|avg` (`1d6`) piercing damage at the start of each of its turns. A creature [restrained](2-Mechanics/CLI/rules/conditions.md#Restrained) by the vines or one that can touch the creature can use its action to make a Strength check against your spell save DC. On a success, the target is freed.
