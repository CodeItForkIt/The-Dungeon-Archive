...
Whenever you end your turn with 0 hit points, the docent can make a Wisdom ([Medicine](2-Mechanics/CLI/rules/skills.md#Medicine)) check with a +6 bonus. If this check succeeds, the docent stabilizes you.
...
**Skills**. The docent has a +7 bonus to one of the following skills (roll a `dice:d4|noform|avg` (`d4`)): (1) [Arcana](2-Mechanics/CLI/rules/skills.md#Arcana), (2) [History](2-Mechanics/CLI/rules/skills.md#History), (3) [Investigation](2-Mechanics/CLI/rules/skills.md#Investigation), or (4) [Nature](2-Mechanics/CLI/rules/skills.md#Nature).

**Spells**. The docent knows one of the following spells and can cast it at will, requiring no components (roll a `dice:d6|noform|avg` (`d6`)): (1–2) [detect evil and good](2-Mechanics/CLI/spells/detect-evil-and-good.md) or (3–6) [detect magic](2-Mechanics/CLI/spells/detect-magic.md). The docent decides when to cast the spell.
