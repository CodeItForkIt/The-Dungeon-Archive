...
As an action, you can invoke the staff's rune to cast either [hold person](2-Mechanics/CLI/spells/hold-person.md) (save DC 12) or [speak with plants](2-Mechanics/CLI/spells/speak-with-plants.md) with the staff. When you cast [hold person](2-Mechanics/CLI/spells/hold-person.md) using the staff, the target is wreathed in spectral vines.
