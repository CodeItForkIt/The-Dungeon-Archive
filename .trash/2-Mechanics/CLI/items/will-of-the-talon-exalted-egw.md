...
- The saving throw DC for the war pick's Breath Weapon property increases to 17, and that property deals `dice:5d6|noform|avg` (`5d6`) damage on a failed save, or half as much damage on a successful one.  
