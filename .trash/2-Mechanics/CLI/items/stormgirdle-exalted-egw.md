...
- Your Storm Avatar's lightning strike deals `dice:5d6|noform|avg` (`5d6`) lightning damage (instead of `dice:3d6|noform|avg` (`3d6`)).  
- You can cast the [control weather](2-Mechanics/CLI/spells/control-weather.md) spell from the girdle. This property can't be used again until the next dawn.  
