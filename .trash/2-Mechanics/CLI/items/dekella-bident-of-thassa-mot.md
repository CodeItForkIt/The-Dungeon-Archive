...
---
# Dekella, Bident of Thassa
*Weapon ([trident](2-Mechanics/CLI/items/trident.md)), artifact (requires attunement)*  
...
Thassa's signature weapon thrums with the icy currents of the deep ocean. This weapon functions as a trident that grants a +3 bonus to attack and damage rolls made with it. When you hit with an attack using the bident, the target takes an extra `dice:2d10|noform|avg` (`2d10`) cold damage.
