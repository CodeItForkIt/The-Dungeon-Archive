...
- The prosthetic is a magic melee weapon with which you're proficient. It deals `dice:1d8|noform|avg` (`1d8`) force damage on a hit and has the thrown property, with a normal range of 20 feet and a long range of 60 feet. When thrown, the prosthetic detaches and flies at the target of the attack, then immediately returns to you and reattaches.  
