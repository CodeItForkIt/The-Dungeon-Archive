...
This magic warhammer grants a +3 bonus to attack and damage rolls made with it. When you hit with an attack using it, the target takes an extra `dice:3d10|noform|avg` (`3d10`) fire damage.
