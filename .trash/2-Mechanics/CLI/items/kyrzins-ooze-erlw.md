...
While attuned to Kyrzin's ooze, you have resistance to poison and acid damage, and you're immune to the [poisoned](2-Mechanics/CLI/rules/conditions.md#Poisoned) condition.
...
As an action, you can exhale acid in a 30-foot line that is 5 feet wide. Each creature in that line must make a DC 15 Dexterity saving throw, taking `dice:8d8|noform|avg|text(36)` (`8d8`) acid damage on a failed save, or half as much damage on a successful one. Once you use this property, it can't be used again until the next dawn.
...
If you die while the ooze is inside you, it bursts out and engulfs you, turning your corpse into a [black pudding](2-Mechanics/CLI/bestiary/ooze/black-pudding.md) allied with the daelkyr.
