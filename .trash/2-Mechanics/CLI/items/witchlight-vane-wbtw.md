...
---
# Witchlight Vane
*Melee weapon ([mace](2-Mechanics/CLI/items/mace.md)), legendary (requires attunement by a mister light or his handpicked successor)*  
...
In the hands of one who is attuned to it, the vane can be wielded as a magic mace that grants a +3 bonus to attack and damage rolls made with it. In addition, the vane deals an extra `dice:1d8|noform|avg` (`1d8`) radiant damage on a hit.
