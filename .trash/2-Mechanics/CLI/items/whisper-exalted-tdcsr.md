...
- The weapon's bonus to attack and damage rolls increases to +3, and the extra psychic damage it deals increases to `dice:1d8|noform|avg` (`1d8`).  
- The DC to resist being [frightened](2-Mechanics/CLI/rules/conditions.md#Frightened) from a critical hit increases to 17.  
