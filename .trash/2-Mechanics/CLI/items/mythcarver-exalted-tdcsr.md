...
---
# Mythcarver (Exalted)
*Weapon ([longsword](2-Mechanics/CLI/items/longsword.md)), legendary (requires attunement by a bard)*  

- **Damage**:
  - One-handed: 1d8 S
  - Two-handed: 1d10 S
- **Properties**: [Finesse](2-Mechanics/CLI/rules/item-properties.md#Finesse), [Versatile](2-Mechanics/CLI/rules/item-properties.md#Versatile), [Vestige of Divergence](2-Mechanics/CLI/rules/item-properties.md#Vestige%20of%20Divergence)
- **Weight**: 3.0 lbs.
...
- The weapon's bonus to attack and damage rolls increases to +2. Additionally, when you hit with an attack using this weapon, the target takes an extra `dice:1d6|noform|avg` (`1d6`) force damage.  
...
- As an action, you let the spirit of the sword overtake your body and guide your strikes. You make 4 melee attacks with the sword, then gain 1 level of [exhaustion](2-Mechanics/CLI/rules/conditions.md#Exhaustion). Once this property is used, it can't be used again until you finish a long rest.  
