...
A bronze horn summons `dice:4d4+4|noform|avg` (`4d4 + 4`) [berserkers](2-Mechanics/CLI/bestiary/humanoid/berserker.md). To use the bronze horn, you must be proficient with medium armor.
