...
- When you have fewer hit points than half your hit point maximum, the warhammer deals an extra `dice:2d6|noform|avg` (`2d6`) bludgeoning damage on a hit. You can burrow through solid rock at half your burrowing speed and leave a 5-foot-diameter tunnel in your wake.  
- As an action, you can use the warhammer to cast one of the following spells from it (save DC 17): [earthquake](2-Mechanics/CLI/spells/earthquake.md), [meld into stone](2-Mechanics/CLI/spells/meld-into-stone.md), or [stone shape](2-Mechanics/CLI/spells/stone-shape.md). Once a spell has been cast using the warhammer, that spell can't be cast from the warhammer again until the next dawn.  
