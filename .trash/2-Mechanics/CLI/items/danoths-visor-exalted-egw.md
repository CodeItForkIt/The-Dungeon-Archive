...
- As an action, you can cast the [antimagic field](2-Mechanics/CLI/spells/antimagic-field.md) spell from the visor. This property can't be used again until the next dawn.  
