...
| 26-45 | `dice:2d4\\|noform\\|avg` (`2d4`) [imps](2-Mechanics/CLI/bestiary/fiend/imp.md) and `dice:2d4\\|noform\\|avg` (`2d4`) [quasits](2-Mechanics/CLI/bestiary/fiend/quasit.md) appear. |
| 46-60 | `dice:1d8\\|noform\\|avg` (`1d8`) [succubi](2-Mechanics/CLI/bestiary/fiend/succubus.md)/[incubi](2-Mechanics/CLI/bestiary/fiend/incubus.md) appear. |
| 61-70 | `dice:1d10\\|noform\\|avg` (`1d10`) [barbed devils](2-Mechanics/CLI/bestiary/fiend/barbed-devil.md) and `dice:1d10\\|noform\\|avg` (`1d10`) [vrocks](2-Mechanics/CLI/bestiary/fiend/vrock.md) appear. |
