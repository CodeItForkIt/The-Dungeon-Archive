...
The horn summons `dice:3d4+3|noform|avg` (`3d4 + 3`) [berserkers](2-Mechanics/CLI/bestiary/humanoid/berserker.md). To use the horn, you must be proficient with all simple weapons.
