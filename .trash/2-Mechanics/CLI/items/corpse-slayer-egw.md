...
When you hit an undead creature with an attack using this weapon, the attack deals an extra `dice:1d8|noform|avg` (`1d8`) damage of the weapon's type, and the creature has disadvantage on saving throws against effects that turn undead until the start of your next turn.
