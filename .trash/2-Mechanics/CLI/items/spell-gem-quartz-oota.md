...
A quartz spell gem can store up to 2nd level spells. Spells cast from the spell gem have a save DC of 13 and an attack bonus of `dice:1d20+5|noform|text(+5)`.
