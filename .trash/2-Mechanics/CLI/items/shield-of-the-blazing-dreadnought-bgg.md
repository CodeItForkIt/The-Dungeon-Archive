...
---
# Shield of the Blazing Dreadnought
*Armor ([shield](2-Mechanics/CLI/items/shield.md)), legendary (requires attunement)*  
...
When you take the [Attack](2-Mechanics/CLI/rules/actions.md#Attack) action on your turn, you can replace one of your attacks with a shield bash, targeting one creature you can see within 5 feet of yourself. The target must make a Strength saving throw (DC equals 8 + your proficiency bonus + your Strength modifier). On a failed save, the target takes `dice:3d6|noform|avg` (`3d6`) bludgeoning damage plus `dice:3d6|noform|avg` (`3d6`) fire damage and is knocked prone. On a successful save, the target takes half as much damage only. You can use Shield Bash only once per turn.
