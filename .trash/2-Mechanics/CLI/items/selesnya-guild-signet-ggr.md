...
This ring, adorned with the symbol of Selesnya, allows you to cast [charm person](2-Mechanics/CLI/spells/charm-person.md). A guild signet is sometimes awarded to a guild member whose renown score in that guild is 5 or higher, as a reward for performing special services for the guild. Aside from its magical properties, the ring is also an indicator of Selesnya's recognition and favor.
