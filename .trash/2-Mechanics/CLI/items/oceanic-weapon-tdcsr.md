...
Additionally, while you hold the weapon, you can use an action to cast the [water breathing](2-Mechanics/CLI/spells/water-breathing.md) spell. Once this property is used, it can't be used again until the next dawn.
