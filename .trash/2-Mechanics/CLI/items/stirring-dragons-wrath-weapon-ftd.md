...
You gain a +1 bonus to attack and damage rolls made using the weapon. On a hit, the weapon deals an extra `dice:1d6|noform|avg` (`1d6`) damage of the type dealt by the dragon's breath weapon.
