...
- (a) a [mace](Mechanics/items/mace.md) or (b) a [warhammer](Mechanics/items/warhammer.md) (if proficient)  
- (a) [scale mail](Mechanics/items/scale-mail.md), (b) [leather armor](Mechanics/items/leather-armor.md), or (c) [chain mail](Mechanics/items/chain-mail.md) (if proficient)  
...
- A [shield](Mechanics/items/shield.md) and a [holy symbol](Mechanics/items/holy-symbol.md)  
...
You can make a cleric quickly by following these suggestions. First, Wisdom should be your highest ability score, followed by Strength or Constitution. Second, choose the [acolyte](Mechanics/backgrounds/acolyte.md) background.
...
You can use a [holy symbol](Mechanics/items/holy-symbol.md) as a spellcasting focus for your cleric spells.
...
*2nd-level cleric [optional class features](Mechanics/Rules/variant-rules/optional-class-features-tce.md)*
...
*4th-level cleric [optional class features](Mechanics/Rules/variant-rules/optional-class-features-tce.md)*
