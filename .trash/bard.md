...
- **Tools**: three [musical instruments](Mechanics/items/musical-instrument.md) of your choice
...
- (a) a [rapier](Mechanics/items/rapier.md), (b) a [longsword](Mechanics/items/longsword.md), or (c) any simple weapon  
- (a) a [diplomat's pack](Mechanics/items/diplomats-pack.md) or (b) an [entertainer's pack](Mechanics/items/entertainers-pack.md)  
- (a) a [lute](Mechanics/items/lute.md) or (b) any other musical instrument  
- [Leather armor](Mechanics/items/leather-armor.md), and a [dagger](Mechanics/items/dagger.md)  
...
- **Armor**: light
- **Weapons**: none
- **Tools**: one [musical instrument](Mechanics/items/musical-instrument.md) of your choice
...
You can make a bard quickly by following these suggestions. First, Charisma should be your highest ability score, followed by Dexterity. Second, choose the [entertainer](Mechanics/backgrounds/entertainer.md) background. Third, choose the [dancing lights](Mechanics/spells/dancing-lights.md) and [vicious mockery](Mechanics/spells/vicious-mockery.md) cantrips, along with the following 1st-level spells: [charm person](Mechanics/spells/charm-person.md), [detect magic](Mechanics/spells/detect-magic.md), [healing word](Mechanics/spells/healing-word.md), and [thunderwave](Mechanics/spells/thunderwave.md).
...
| 2 | A mithral [horn](Mechanics/items/horn.md) made by elves |
| 3 | A zither made with drow spider silk |
| 4 | An orcish [drum](Mechanics/items/drum.md) |
...
| 6 | When you sat on your [lute](Mechanics/items/lute.md) by mistake during the final stanza of "Starlight Serenade" |
^embarrassment
...
For example, if you know the 1st-level spell [cure wounds](Mechanics/spells/cure-wounds.md) and have a 1st-level and a 2nd-level spell slot available, you can cast [cure wounds](Mechanics/spells/cure-wounds.md) using either slot.
...
You can use a [musical instrument](Mechanics/items/musical-instrument.md) as a spellcasting focus for your bard spells.
...
*2nd-level bard [optional class features](Mechanics/Rules/variant-rules/optional-class-features-tce.md)*
...
*4th-level bard [optional class features](Mechanics/Rules/variant-rules/optional-class-features-tce.md)*
...
At 6th level, you gain the ability to use musical notes or words of power to disrupt mind-influencing effects. As an action, you can start a performance that lasts until the end of your next turn. During that time, you and any friendly creatures within 30 feet of you have advantage on saving throws against being [frightened](Mechanics/Rules/conditions.md#Frightened) or [charmed](Mechanics/Rules/conditions.md#Charmed). A creature must be able to hear you to gain this benefit. The performance ends early if you are [incapacitated](Mechanics/Rules/conditions.md#Incapacitated) or silenced or if you voluntarily end it (no action required).
